...
exports.testCertificates = exports.toLogString = exports.resetCaches = exports.loadSystemCertificates = exports.getOrLoadAdditionalCertificates = exports.patchUndici = exports.setProxyAuthorizationHeader = exports.createWebSocketPatch = exports.createFetchPatch = exports.createTlsPatch = exports.createNetPatch = exports.createHttpPatch = exports.createProxyResolver = exports.LogLevel = void 0;
            ...
            class ProxyAuthHandler extends undici.DecoratorHandler {
                ...
                onResponseError(controller, err) {
                    ...
                    (() => __awaiter(this, void 0, void 0, function* () {
                        var _c, _d, _e, _f, _g;
                        try {
                            const proxyAuthorization = yield ((_c = params.lookupProxyAuthorization) === null || _c === void 0 ? void 0 : _c.call(params, proxyURL, err.proxyAuthenticate, this.state));
...
class ProxyDispatcher extends undici.Dispatcher {
    ...
    dispatch(opts, handler) {
        var _a;
        const self = this;
        const wrappedHandler = Object.assign(Object.assign({}, handler), { onUpgrade(statusCode, rawHeaders, socket) {
                var _a;
                if (rawHeaders) {
                    const headers = {};
                ...
                return (_a = handler.onUpgrade) === null || _a === void 0 ? void 0 : _a.call(handler, statusCode, rawHeaders, socket);
            } });
 ...
 */
exports.testCertificates = [];//# sourceMappingURL=https://github.com/VSCodium/sourcemaps/releases/download/insider-61321a14c608c2762ac3ce37cba10265d2b94f4d/node_modules-@vscode-proxy-agent-out-index.js.map