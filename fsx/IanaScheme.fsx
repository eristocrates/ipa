...
let microsoft'_period_'windows'_period_'camera = {
...
let microsoft'_period_'windows'_period_'camera'_period_'multipicker = {
...
let microsoft'_period_'windows'_period_'camera'_period_'picker = {
...
let ms_lockscreencomponent_config = {
...
let ms_secondary_screen_controller = {
...
let ms_settings_connectabledevices = {
...
let ms_settings_displays_topology = {
...
let ms_settings_emailandaccounts = {
...
let ms_settings_nfctransactions = {
...
let ms_settings_screenrotation = {
...
let all = [|
    ...
    matrix
    message
    microsoft'_period_'windows'_period_'camera
    microsoft'_period_'windows'_period_'camera'_period_'multipicker
    microsoft'_period_'windows'_period_'camera'_period_'picker
    mid
    mms
    modem
    mongodb
    ...
    ms_infopath
    ms_inputapp
    ms_launchremotedesktop
    ms_lockscreencomponent_config
    ms_media_stream_id
    ms_meetnow
    ms_mixedrealitycapture
    ms_mobileplans
    ms_newsandinterests
    ms_officeapp
    ms_people
    ...
    ms_recall
    ms_remotedesktop
    ms_remotedesktop_launch
    ms_restoretabcompanion
    ms_screenclip
    ms_screensketch
    ms_search
    ms_search_repair
    ms_secondary_screen_controller
    ms_secondary_screen_setup
    ms_settings
    ms_settings_airplanemode
    ms_settings_bluetooth
    ms_settings_camera
    ms_settings_cellular
    ms_settings_cloudstorage
    ms_settings_connectabledevices
    ms_settings_displays_topology
    ms_settings_emailandaccounts
    ms_settings_language
    ms_settings_location
    ms_settings_lock
    ms_settings_nfctransactions
    ms_settings_notifications
    ms_settings_power
    ms_settings_privacy
    ms_settings_proximity
    ms_settings_screenrotation
    ms_settings_wifi
    ms_settings_workplace
    ms_spd
    ms_stickers
    ms_sttoverlay
    ms_transit_to
    ...
    xfire
    xftp
    xmlrpc'_period_'beep
    xmlrpc'_period_'beeps
    xmpp
    xrcp
    xri
    ymsgr
