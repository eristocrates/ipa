...
[Project Reference and Release Notes](https://github.com/FolkerKinzel/Strings/releases/tag/v9.5.0)

## .NET library that contains extension methods and helper classes for character-based data types.

Very high code coverage of the unit tests and the consistent avoidance of unsafe code blocks are main design principles of this library.
