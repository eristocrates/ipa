...
module sd =
    let _prefixId = PrefixId.fromNamespaceLabel "http://www.w3.org/ns/sparql-service-description#" "sd"
    ...
    /// </summary>
    let defaultSupportedEntailmentProfile = _prefixId.prefix "defaultSupportedEntailmentProfile"
