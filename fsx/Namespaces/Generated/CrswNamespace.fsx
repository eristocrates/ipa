...
module crsw =
    let _prefixId = PrefixId.fromNamespaceLabel "http://courseware.rkbexplorer.com/ontologies/courseware#" "crsw"
    ...
    /// </summary>
    let has_infrastructure_requirement = _prefixId.prefix "has-infrastructure-requirement"
