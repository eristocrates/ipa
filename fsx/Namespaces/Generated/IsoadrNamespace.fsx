...
module isoadr =
    let _prefixId = PrefixId.fromNamespaceLabel "http://reference.data.gov.au/def/ont/iso19160-1-address#" "isoadr"
    ...
    /// </summary>
    let Address'_period_'addressComponent = _prefixId.prefix "Address.addressComponent"
    /// <summary>
    ...
    /// </summary>
    let Address'_period_'business_branch = _prefixId.prefix "Address.business_branch"
    ...
    /// </summary>
    let Address'_period_'business_headOffice = _prefixId.prefix "Address.business_headOffice"
    ...
    /// </summary>
    let Address'_period_'childAddress = _prefixId.prefix "Address.childAddress"
    /// <summary>
    ...
    /// </summary>
    let Address'_period_'class = _prefixId.prefix "Address.class"
    /// <summary>
    ...
    /// </summary>
    let Address'_period_'client = _prefixId.prefix "Address.client"
    /// <summary>
    ...
    /// </summary>
    let Address'_period_'employee = _prefixId.prefix "Address.employee"
    /// <summary>
    ...
    /// </summary>
    let Address'_period_'id = _prefixId.prefix "Address.id"
    /// <summary>
    ...
    /// </summary>
    let Address'_period_'lifecycleStage = _prefixId.prefix "Address.lifecycleStage"
    /// <summary>
    ...
    /// </summary>
    let Address'_period_'lifespan = _prefixId.prefix "Address.lifespan"
    /// <summary>
    ...
    /// </summary>
    let Address'_period_'locale = _prefixId.prefix "Address.locale"
    /// <summary>
    ///   <para>http://def.isotc211.org/iso19150/-2/2012/base#associationName : parent^^xsd:string</para>
    ...
    /// </summary>
    let Address'_period_'parentAddress = _prefixId.prefix "Address.parentAddress"
    /// <summary>
    ...
    /// </summary>
    let Address'_period_'position = _prefixId.prefix "Address.position"
    /// <summary>
    ...
    /// </summary>
    let Address'_period_'preferenceLevel = _prefixId.prefix "Address.preferenceLevel"
    /// <summary>
    ...
    /// </summary>
    let Address'_period_'provenance = _prefixId.prefix "Address.provenance"
    /// <summary>
    ...
    /// </summary>
    let Address'_period_'specification = _prefixId.prefix "Address.specification"
    /// <summary>
    ...
    /// </summary>
    let Address'_period_'status = _prefixId.prefix "Address.status"
    /// <summary>
    ...
    /// </summary>
    let Address'_period_'theAddressAlias = _prefixId.prefix "Address.theAddressAlias"
    ...
    /// </summary>
    let Address'_period_'theAddressedPeriod = _prefixId.prefix "Address.theAddressedPeriod"
    ...
    /// </summary>
    let AddressAlias'_period_'address = _prefixId.prefix "AddressAlias.address"
    ...
    /// </summary>
    let AddressAlias'_period_'aliasAddress = _prefixId.prefix "AddressAlias.aliasAddress"
    ...
    /// </summary>
    let AddressAlias'_period_'type = _prefixId.prefix "AddressAlias.type"
    /// <summary>
    ...
    /// </summary>
    let AddressClassSpecification'_period_'class = _prefixId.prefix "AddressClassSpecification.class"
    ...
    /// </summary>
    let AddressClassSpecification'_period_'component = _prefixId.prefix "AddressClassSpecification.component"
    ...
    /// </summary>
    let AddressClassSpecification'_period_'typology = _prefixId.prefix "AddressClassSpecification.typology"
    ...
    /// </summary>
    let AddressComponent'_period_'id = _prefixId.prefix "AddressComponent.id"
    ...
    /// </summary>
    let AddressComponent'_period_'lifecycleStage = _prefixId.prefix "AddressComponent.lifecycleStage"
    ...
    /// </summary>
    let AddressComponent'_period_'lifespan = _prefixId.prefix "AddressComponent.lifespan"
    ...
    /// </summary>
    let AddressComponent'_period_'locale = _prefixId.prefix "AddressComponent.locale"
    ...
    /// </summary>
    let AddressComponent'_period_'provenance = _prefixId.prefix "AddressComponent.provenance"
    ...
    /// </summary>
    let AddressComponent'_period_'referenceObject = _prefixId.prefix "AddressComponent.referenceObject"
    ...
    /// </summary>
    let AddressComponent'_period_'scopeComponent = _prefixId.prefix "AddressComponent.scopeComponent"
    ...
    /// </summary>
    let AddressComponent'_period_'type = _prefixId.prefix "AddressComponent.type"
    ...
    /// </summary>
    let AddressComponent'_period_'valueComponent = _prefixId.prefix "AddressComponent.valueComponent"
    ...
    /// </summary>
    let AddressComponent'_period_'valueInformation = _prefixId.prefix "AddressComponent.valueInformation"
    ...
    /// </summary>
    let AddressComponentValue'_period_'locale = _prefixId.prefix "AddressComponentValue.locale"
    ...
    /// </summary>
    let AddressComponentValue'_period_'preferenceLevel = _prefixId.prefix "AddressComponentValue.preferenceLevel"
    ...
    /// </summary>
    let AddressComponentValue'_period_'type = _prefixId.prefix "AddressComponentValue.type"
    ...
    /// </summary>
    let AddressComponentValue'_period_'value = _prefixId.prefix "AddressComponentValue.value"
    ...
    /// </summary>
    let AddressPosition'_period_'geometry = _prefixId.prefix "AddressPosition.geometry"
    /// <summary>
    ...
    /// </summary>
    let AddressPosition'_period_'type = _prefixId.prefix "AddressPosition.type"
    /// <summary>
    ...
    /// </summary>
    let AddressProvenance'_period_'authority = _prefixId.prefix "AddressProvenance.authority"
    ...
    /// </summary>
    let AddressProvenance'_period_'lineage = _prefixId.prefix "AddressProvenance.lineage"
    ...
    /// </summary>
    let AddressProvenance'_period_'owner = _prefixId.prefix "AddressProvenance.owner"
    /// <summary>
    ...
    /// </summary>
    let AddressSpecification'_period_'addressSpecificationCitation = _prefixId.prefix "AddressSpecification.addressSpecificationCitation"
    ...
    /// </summary>
    let AddressSpecification'_period_'classSpecification = _prefixId.prefix "AddressSpecification.classSpecification"
    ...
    /// </summary>
    let AddressableObject'_period_'childAddressableObject = _prefixId.prefix "AddressableObject.childAddressableObject"
    ...
    /// </summary>
    let AddressableObject'_period_'id = _prefixId.prefix "AddressableObject.id"
    ...
    /// </summary>
    let AddressableObject'_period_'lifecycleStage = _prefixId.prefix "AddressableObject.lifecycleStage"
    ...
    /// </summary>
    let AddressableObject'_period_'lifespan = _prefixId.prefix "AddressableObject.lifespan"
    ...
    /// </summary>
    let AddressableObject'_period_'parentAddressableObject = _prefixId.prefix "AddressableObject.parentAddressableObject"
    ...
    /// </summary>
    let AddressableObject'_period_'position = _prefixId.prefix "AddressableObject.position"
    ...
    /// </summary>
    let AddressableObject'_period_'theAddressedPeriod = _prefixId.prefix "AddressableObject.theAddressedPeriod"
    ...
    /// </summary>
    let AddressableObject'_period_'type = _prefixId.prefix "AddressableObject.type"
    ...
    /// </summary>
    let AddressableObjectLifecycleStage = _prefixId.prefix "AddressableObjectLifecycleStage"
    ...
    /// </summary>
    let AddressedPeriod'_period_'address = _prefixId.prefix "AddressedPeriod.address"
    ...
    /// </summary>
    let AddressedPeriod'_period_'addressedFrom = _prefixId.prefix "AddressedPeriod.addressedFrom"
    ...
    /// </summary>
    let AddressedPeriod'_period_'addressedObject = _prefixId.prefix "AddressedPeriod.addressedObject"
    ...
    /// </summary>
    let AddressedPeriod'_period_'addressedTo = _prefixId.prefix "AddressedPeriod.addressedTo"
    ...
    /// </summary>
    let Lifespan'_period_'closeRecord = _prefixId.prefix "Lifespan.closeRecord"
    /// <summary>
    ...
    /// </summary>
    let Lifespan'_period_'openRecord = _prefixId.prefix "Lifespan.openRecord"
    /// <summary>
    ...
    /// </summary>
    let Lifespan'_period_'validFrom = _prefixId.prefix "Lifespan.validFrom"
    /// <summary>
    ...
    /// </summary>
    let Lifespan'_period_'validTo = _prefixId.prefix "Lifespan.validTo"
    /// <summary>
    ...
    /// </summary>
    let Lifespan'_period_'version = _prefixId.prefix "Lifespan.version"
    /// <summary>
    ///   <para>rdfs:isDefinedBy : http://standards.iso.org/iso/19160/-1/ed-1/en/^^xsd:string</para>
    ...
    /// </summary>
    let ReferenceObject'_period_'addressComponent = _prefixId.prefix "ReferenceObject.addressComponent"
    ...
    /// </summary>
    let ReferenceObject'_period_'geometry = _prefixId.prefix "ReferenceObject.geometry"
    /// <summary>
    ...
    /// </summary>
    let ReferenceObject'_period_'id = _prefixId.prefix "ReferenceObject.id"
    /// <summary>
    ...
    /// </summary>
    let ReferenceObject'_period_'type = _prefixId.prefix "ReferenceObject.type"
    /// <summary>
