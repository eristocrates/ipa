...
module ``mdo-calc`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://w3id.org/mdo/calculation/" "mdo-calc"
    ...
    /// </summary>
    let ExchangeCorrelationEnergyFunctional = _prefixId.prefix "ExchangeCorrelationEnergyFunctional"
    ...
    /// </summary>
    let GeneralizedGradientApproximation = _prefixId.prefix "GeneralizedGradientApproximation"
    ...
    /// </summary>
    let HybridGeneralizedGradientApproximation = _prefixId.prefix "HybridGeneralizedGradientApproximation"
    ...
    /// </summary>
    let HybridmetaGeneralizedGradientApproximation = _prefixId.prefix "HybridmetaGeneralizedGradientApproximation"
    ...
    /// </summary>
    let metaGeneralizedGradientApproximation = _prefixId.prefix "metaGeneralizedGradientApproximation"
