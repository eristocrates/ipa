...
module ``ludo-xapi`` =
    let _prefixId = PrefixId.fromNamespaceLabel "http://ns.inria.fr/ludo/v1/xapi#" "ludo-xapi"
    ...
    /// </summary>
    let hasActivityDefinitionDescription = _prefixId.prefix "hasActivityDefinitionDescription"
    ...
    /// </summary>
    let hasInteractionComponentDescription = _prefixId.prefix "hasInteractionComponentDescription"
    ...
    /// </summary>
    let hasInteractionCorrectResponsesPattern = _prefixId.prefix "hasInteractionCorrectResponsesPattern"
    ...
    /// </summary>
    let hasInverseFunctionalIdentifier = _prefixId.prefix "hasInverseFunctionalIdentifier"
