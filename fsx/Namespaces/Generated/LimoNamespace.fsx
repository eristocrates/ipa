...
module limo =
    let _prefixId = PrefixId.fromNamespaceLabel "http://purl.org/limo-ontology/limo#" "limo"
    ...
    let ``Information%20Systems%20Lab%20%28ISLab%29`` = _prefixId.prefix "Information%20Systems%20Lab%20%28ISLab%29"
