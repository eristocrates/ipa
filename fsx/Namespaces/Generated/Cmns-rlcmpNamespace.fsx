...
module ``cmns-rlcmp`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/RolesAndCompositions/" "cmns-rlcmp"
    ...
    ///   <para>omg-ann:usageNote : The properties hasConstituent and hasRole are included in value restrictions rather than via number restrictions to facilitate their use in complex property chains and other axioms as needed for some applications.^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO 21298:2017(en), Health informatics - Functional and structural roles, clause 3.9^^xsd:stringomg-ann:adaptedFrom : ISO/IEC 19763-8:2015(en), Information technology - Metamodel framework for interoperability (MFI) - Part 8: Metamodel for role and goal model registration, clause 3.1.2^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO 12651-2:2014(en), Electronic document management - Vocabulary - Part 2: Workflow management, clause 3.33^^xsd:stringomg-ann:adaptedFrom : ISO 18629-1:2004(en), Industrial automation systems and integration - Process specification language - Part 1: Overview and basic principles^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO/IEC 19763-8:2015(en), Information technology - Metamodel framework for interoperability (MFI) - Part 8: Metamodel for role and goal model registration, clause 3.1.7^^xsd:string</para>
    ...
    ///   <para>dcterms:source : ISO 21298:2017(en), Health informatics - Functional and structural roles, clause 3.26^^xsd:string</para>
