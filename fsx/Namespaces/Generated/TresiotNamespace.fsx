...
module tresiot =
    let _prefixId = PrefixId.fromNamespaceLabel "https://liidr.org/trust-recommendation-in-social-internet-of-things/" "tresiot"

    let _namespaceIri = _prefixId.prefix ""
    let _1'_period_'0'_period_'0 = _prefixId.prefix "1.0.0"
    /// <summary>
    ...
    /// </summary>
    let Domain_specific_Trust_Recommendation = _prefixId.prefix "Domain-specific_Trust_Recommendation"
    ...
    /// </summary>
    let Relationship_Existance_Recommendation = _prefixId.prefix "Relationship_Existance_Recommendation"
    ...
    /// </summary>
    let Relationship_Labeling_Recommendation = _prefixId.prefix "Relationship_Labeling_Recommendation"
    ...
    /// </summary>
    let Situation_Dependent_Trust_Settings_Recommendation = _prefixId.prefix "Situation-Dependent_Trust_Settings_Recommendation"
    ...
    /// </summary>
    let Trust_Decision_Setting_Recommendation = _prefixId.prefix "Trust_Decision_Setting_Recommendation"
    ...
    /// </summary>
    let Trust_Metric_Evaluation_Recommendation = _prefixId.prefix "Trust_Metric_Evaluation_Recommendation"
    ...
    /// </summary>
    let Trust_Threshold_Recommendation = _prefixId.prefix "Trust_Threshold_Recommendation"
    ...
    /// </summary>
    let Trust_Weight_Adaption_Recommendation = _prefixId.prefix "Trust_Weight_Adaption_Recommendation"
