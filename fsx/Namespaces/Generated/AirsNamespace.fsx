...
module airs =
    let _prefixId = PrefixId.fromNamespaceLabel "https://raw.githubusercontent.com/airs-linked-data/lov/latest/src/airs_vocabulary.ttl#" "airs"
    ...
    let explanationForNoPhysicalAddess = _prefixId.prefix "explanationForNoPhysicalAddess"
