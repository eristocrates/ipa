...
module rdai =
    let _prefixId = PrefixId.fromNamespaceLabel "http://rdaregistry.info/Elements/i/" "rdai"
    ...
    let accompaniedByItem'_period_'en = _prefixId.prefix "accompaniedByItem.en"

    let accompanyingItemRelationship'_period_'en = _prefixId.prefix "accompanyingItemRelationship.en"

    let analysedInItem'_period_'en = _prefixId.prefix "analysedInItem.en"
    ...
    let commentaryInItem'_period_'en = _prefixId.prefix "commentaryInItem.en"
    let containedInItem'_period_'en = _prefixId.prefix "containedInItem.en"
    let containerOfItem'_period_'en = _prefixId.prefix "containerOfItem.en"
    let critiquedInItem'_period_'en = _prefixId.prefix "critiquedInItem.en"
    let curator'_period_'en = _prefixId.prefix "curator.en"
    let currentOwner'_period_'en = _prefixId.prefix "currentOwner.en"

    let custodialHistoryOfItem'_period_'en = _prefixId.prefix "custodialHistoryOfItem.en"

    let custodian'_period_'en = _prefixId.prefix "custodian.en"
    let dedicateeOfItem'_period_'en = _prefixId.prefix "dedicateeOfItem.en"
    let depositor'_period_'en = _prefixId.prefix "depositor.en"
    let describedInItem'_period_'en = _prefixId.prefix "describedInItem.en"
    let digitalTransferItem'_period_'en = _prefixId.prefix "digitalTransferItem.en"
    let digitalTransferOfItem'_period_'en = _prefixId.prefix "digitalTransferOfItem.en"
    let donor'_period_'en = _prefixId.prefix "donor.en"

    let electronicReproductionItem'_period_'en = _prefixId.prefix "electronicReproductionItem.en"

    let electronicReproductionOfItem'_period_'en = _prefixId.prefix "electronicReproductionOfItem.en"

    let equivalentItem'_period_'en = _prefixId.prefix "equivalentItem.en"

    let equivalentItemRelationship'_period_'en = _prefixId.prefix "equivalentItemRelationship.en"

    let evaluatedInItem'_period_'en = _prefixId.prefix "evaluatedInItem.en"
    let facsimileItem'_period_'en = _prefixId.prefix "facsimileItem.en"
    let facsimileOfItem'_period_'en = _prefixId.prefix "facsimileOfItem.en"
    let filmedWithItem'_period_'en = _prefixId.prefix "filmedWithItem.en"
    let formerOwner'_period_'en = _prefixId.prefix "formerOwner.en"
    let honoureeOfItem'_period_'en = _prefixId.prefix "honoureeOfItem.en"
    let identifierForTheItem'_period_'en = _prefixId.prefix "identifierForTheItem.en"
    ...
    let manifestationExemplified'_period_'en = _prefixId.prefix "manifestationExemplified.en"

    let noteOnDimensionsOfItem'_period_'en = _prefixId.prefix "noteOnDimensionsOfItem.en"

    let noteOnExtentOfItem'_period_'en = _prefixId.prefix "noteOnExtentOfItem.en"
    let noteOnItem'_period_'en = _prefixId.prefix "noteOnItem.en"

    let noteOnItemSpecificCarrierCharacteristic'_period_'en = _prefixId.prefix "noteOnItemSpecificCarrierCharacteristic.en"

    let onDiscWithItem'_period_'en = _prefixId.prefix "onDiscWithItem.en"
    let otherPFCItem'_period_'en = _prefixId.prefix "otherPFCItem.en"
    let owner'_period_'en = _prefixId.prefix "owner.en"

    let preservationFacsimileItem'_period_'en = _prefixId.prefix "preservationFacsimileItem.en"

    let preservationFacsimileOfItem'_period_'en = _prefixId.prefix "preservationFacsimileOfItem.en"

    let relatedItemOfItem'_period_'en = _prefixId.prefix "relatedItemOfItem.en"
    let reprintOfItem'_period_'en = _prefixId.prefix "reprintOfItem.en"
    let reprintedAsItem'_period_'en = _prefixId.prefix "reprintedAsItem.en"
    let reproducedAsItem'_period_'en = _prefixId.prefix "reproducedAsItem.en"
    let reproductionOfItem'_period_'en = _prefixId.prefix "reproductionOfItem.en"
    let restorationist'_period_'en = _prefixId.prefix "restorationist.en"

    let restrictionsOnAccessToItem'_period_'en = _prefixId.prefix "restrictionsOnAccessToItem.en"

    let restrictionsOnUseOfItem'_period_'en = _prefixId.prefix "restrictionsOnUseOfItem.en"

    let reviewedInItem'_period_'en = _prefixId.prefix "reviewedInItem.en"
    let seller'_period_'en = _prefixId.prefix "seller.en"
    let subjectOfItem'_period_'en = _prefixId.prefix "subjectOfItem.en"

    let wholePartItemRelationship'_period_'en = _prefixId.prefix "wholePartItemRelationship.en"
