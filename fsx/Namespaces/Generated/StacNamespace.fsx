...
module stac =
    let _prefixId = PrefixId.fromNamespaceLabel "http://securitytoolbox.appspot.com/stac#" "stac"
    ...
    /// <summary>
    ///   <para>dc11:description : See Paper: Malicious actions against the GPRS technology [Xenakis 2006]</para>
    ...
    /// <summary>
    ///   <para>dc11:description : See Paper: A study of information security for M2M and IoT [Jiang et al. 2010]</para>
    ...
    /// <summary>
    ///   <para>dc11:description : See Paper: Survey of Security and Privacy Issues of Internet of Things [Borgohain et al. 2015]</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Key management protocols are fundamental requirements to develop a secure application. These protocols are used to set up and distribute various kinds of cryptographic keys to nodes in the network.</para>
    ...
    /// </summary>
    let NetworkManagementSecurityMechanism = _prefixId.prefix "NetworkManagementSecurityMechanism"
    ...
    /// </summary>
    let OperatingSystemSecurityMechanism = _prefixId.prefix "OperatingSystemSecurityMechanism"
    ...
    /// </summary>
    let ProgrammingLanguageSecurityMechanism = _prefixId.prefix "ProgrammingLanguageSecurityMechanism"
    ...
    /// <summary>
    ///   <para>dc11:description : Security Mechanisms are processes that are used to detect, prevent and recover from security attacks.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Sensor nodes have very limited computationnal power, and traditional security and encryption techniques are not-well suitd to this domain.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : See Paper: Malicious actions against the GPRS technology [Xenakis 2006], Paper: Survey of Security and Privacy Issues of Internet of Things [Borgohain et al. 2015]</para>
