...
module tvc =
    let _prefixId = PrefixId.fromNamespaceLabel "http://www.essepuntato.it/2012/04/tvc/" "tvc"

    /// <summary>
    ///   <para>dc11:description : Having the role "graduate student" in a specific time (e.g., now) and context (e.g., "University of Bologna").</para>
