...
module poder =
    let _prefixId = PrefixId.fromNamespaceLabel "http://dev.poderopedia.com/vocab/" "poder"
    ...
    let FinancierAssociationConnection = _prefixId.prefix "FinancierAssociationConnection"
    ...
    let MembershipAssociationConnection = _prefixId.prefix "MembershipAssociationConnection"
    ...
    /// </summary>
    let SentimentalRelationshipConnection = _prefixId.prefix "SentimentalRelationshipConnection"
    ...
    let SympathizerAssociationConnection = _prefixId.prefix "SympathizerAssociationConnection"
    ...
    /// </summary>
    let hasEconomicOrganizationParticipant = _prefixId.prefix "hasEconomicOrganizationParticipant"
