...
module mexalgo =
    let _prefixId = PrefixId.fromNamespaceLabel "http://mex.aksw.org/mex-algo#" "mexalgo"
    ...
    /// </summary>
    let AutoregressiveIntegratedMovingAverage = _prefixId.prefix "AutoregressiveIntegratedMovingAverage"
    ...
    /// </summary>
    let AverageOneDependenceEstimators = _prefixId.prefix "AverageOneDependenceEstimators"
    ...
    let MonteCarloMachineLearningLibrary = _prefixId.prefix "MonteCarloMachineLearningLibrary"
    ...
    let hasAlgorithmParameterCollection = _prefixId.prefix "hasAlgorithmParameterCollection"
    ...
    let isAlgorithmParameterCollectionOf = _prefixId.prefix "isAlgorithmParameterCollectionOf"
