...
module cito =
    ...
    ///   <para>dc11:description : Derived from the article 'A Small World of Citations? The Influence of Collaboration Networks on Citation Practices' by Matthew L. Wallace, Vincent Larivière and Yves Gingras, published in PLOS One (https://doi.org/10.1371/journal.pone.0033339).</para>
    ...
    ///   <para>dc11:description : Derived from the blog post 'What do we know about journal citation cartels? A call for information' by Philippe Mongeon, Ludo Waltman and Sarah de Rijcke (https://www.cwts.nl/blog?article=n-q2w2b4).</para>
    ...
    ///   <para>dc11:description : Derived from the blog post 'Journal self-citations are increasingly biased toward impact factor years' by Ludo Waltman and Caspar Chorus (https://www.cwts.nl/blog?article=n-q2x264).</para>
    ...
    ///   <para>dc11:description : Example: We share Galileo's opinion: the Earth moves [X].</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Example: Newton asserted that we are like dwarfs standing on the shoulders of giants [X].</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Example: Italy has more than ten thousand kilometers of shoreline: see [X].</para>
    ...
    ///   <para>dc11:description : Example: We found an unquestionable demonstration of our hypothesis in [X].</para>
    ...
    ///   <para>dc11:description : Example: Basic bibliographic, entity and project metadata relating to this article, recorded in a structured machine-readable form, is available as an additional file [X] accompanying this paper.</para>
    ...
    ///   <para>dc11:description : Example: This risk could be avoided using the approach shown in [X].</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Example: To our knowledge, [X] is the best source of exercises about UML, making it a valuable proposal for beginners.</para>
    ...
    ///   <para>dc11:description : Example: An analysis similar to what we proposed here is presented in [X].</para>
    ...
    ///   <para>dc11:description : Example: Several sections of this work are based on our literature review of the topic published as journal article [X].</para>
    ...
    ///   <para>dc11:description : Example: The grammar of Pascal was introduced in [X].</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Note: This property has been imported from the CiTO4Data ontology, usage of which has been deprecated.dc11:description : Example: This book gathers interviews with academic researchers of several disciplines [X].</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Example: Our findings are similar to those published in [X].</para>
    ...
    ///   <para>dc11:description : Example: We think that to stand on the top of giants [X] is a valuable principle to follow for our own research.</para>
    ...
    ///   <para>dc11:description : Example: The result published in [X] is partially wrong, the correct result is 42.</para>
    ...
    ///   <para>dc11:description : Example: Galileo was the first to observe Jupiter's satellites [X].</para>
    ...
    ///   <para>dc11:description : Example: The ideas presented in [X] are badly substantantiated.</para>
    ...
    ///   <para>dc11:description : Example: The ideas published in [X] are incredibly stupid.</para>
    ...
    ///   <para>dc11:description : Example: Galileo's book [X] is a dialog among three scientists about Copernicus' eliocentric theory.</para>
    ...
    ///   <para>dc11:description : Example: We do not share Galileo's opinion [X]: the Earth does not move.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Example: We now examine if Galileo is right when he writes [X] that the Earth moves.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Example: We doubt that Galileo is right when he writes [X] that the Earth moves.</para>
    ...
    ///   <para>dc11:description : Example: Herein we report in detail the complete set of ontological rules defined in the Overlapping Ontology [X].</para>
    ...
    ///   <para>dc11:description : Example: We add to Galileo's findings concerning the Earth [X] that also the Moon moves.</para>
    ...
    ///   <para>dc11:description : A quotation is a repetition of what someone has said, and is presented "within quotation marks", for example:
    ///
    /// On June 4th 1940, Winston Churchill made a speech on the radio that has since become famous, that included the words: " . . . we shall fight on the beaches, we shall fight on the landing grounds, we shall fight in the fields and in the streets, we shall fight in the hills; we shall never surrender . . ."dc11:description : Example: As Newton wrote in [X]: "We are like dwarfs standing on the shoulders of giants".</para>
    ...
    ///   <para>dc11:description : Note: This property has been imported from the CiTO4Data ontology, usage of which has been deprecated.</para>
    ...
    ///   <para>dc11:description : Example: The BioSharing registry (https://biosharing.org) can be of use as it describes the standards in detail, including versions where applicable.</para>
    ///   <a href="http://purl.org/spar/cito/linksTo">cito:linksTo</a>
    /// </summary>
    let linksTo = _prefixId.prefix "linksTo"
    /// <summary>
    ///   <para>dc11:description : Example: There is a need for more observational studies and studies using narrative causation to describe the potential contribution of information in problem-solving and decision-making [X]; our work addresses these needs.</para>
    ...
    ///   <para>dc11:description : Example: Our ideas were also shared by Doe et al. [X].</para>
    ...
    ///   <para>dc11:description : Example: We act as giants on the shoulders of dwarfs [X]!</para>
    ...
    ///   <para>dc11:description : Example: The conclusion of our dissertation can be summarised by the following motto, we created specifically for this purpose: we are like dwarfs standing on the shoulders of giants.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Example: Galileo's masterpiece 'Dialogo sopra i due massimi sistemi del mondo' [X] is formally a dialog and substantially a scientific pamphlet.</para>
    ...
    ///   <para>dc11:description : Example: We do not think that all their arguments in favour of their own and against the other strategies are equally convincing [X].</para>
    ...
    ///   <para>dc11:description : Example: We will not investigate the issues of the approach proposed in [X] here, but rather we introduce yet another alternative.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Example: We wrote that the Earth moves in [X]; we now retire such statement.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Example: This paper discusses Toulmin's methodology in modelling argumentation [X], focussing on highlighting advantages and drawbacks of the application of such a methodology in the Social Web.</para>
    ...
    ///   <para>dc11:description : Example: Galileo said that the Earth "moves" [X]; really? And where is it going?</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Example: We believe that if Galileo believed that Earth goes around the Sun [X], he also should believe that Moon goes around Earth.</para>
    ...
    ///   <para>dc11:description : Example: We support Galileo's statement [X], that Earth moves.</para>
    ...
    ///   <para>dc11:description : Example: Earth moves, said Galileo [X]; in addition, we can say now it moves very fast.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Example: Building upon Galileo's findings [X], we discovered that all the planets move.</para>
    ...
    ///   <para>dc11:description : Example: Using the information collected from our recent study [X], we can estimate that there are tens of millions of HTML forms with potentially useful deep-web content.</para>
    ///   <a href="http://purl.org/spar/cito/usesDataFrom">cito:usesDataFrom</a>
    /// </summary>
    let usesDataFrom = _prefixId.prefix "usesDataFrom"
    /// <summary>
    ///   <para>dc11:description : Example: We follow [X] in using design patterns for testing.</para>
