...
module ``cmns-doc`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/Documents/" "cmns-doc"
    ...
    ///   <para>omg-ann:adaptedFrom : ISO 5127 - Information and documentation - Foundation and vocabulary, Second edition, 2017-05, clause 3.1.1.38^^xsd:string</para>
    ///   <para>omg-ann:explanatoryNote : A certificate may or may not also be a legal document, depending on the issuing authority and how it can be used.^^xsd:stringomg-ann:explanatoryNote : Certificates, such as electronic certificates, including public keys, may be issued by some certificate authority.^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : 'Functional Requirements for Bibliographic Records', Final Report, IFLA (International Federation of Library Associations and Institutions) Study Group on the Functional Requirements for Bibliographic Records, September 1997 - see https://repository.ifla.org/bitstream/123456789/811/2/ifla-functional-requirements-for-bibliographic-records-frbr.pdf^^xsd:stringomg-ann:adaptedFrom : ISO 5127 - Information and documentation - Foundation and vocabulary, Second edition, 2017-05, clause 3.1.1.38^^xsd:string</para>
    ///   <para>omg-ann:explanatoryNote : A document, especially a legal document, may serve to establish one or several facts, and can be relied upon as a proof thereof.^^xsd:string</para>
    ///   <para>omg-ann:usageNote : This definition of document corresponds to a subclass of expression in FRBR. The notion of being a unitary expression is the differentiator between an FRBR expression and document in this sense.^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO 5127 - Information and documentation - Foundation and vocabulary, Second edition, 2017-05, clause 3.4.6.02^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO 5127 - Information and documentation - Foundation and vocabulary, Second edition, 2017-05^^xsd:string</para>
    ...
    ///   <para>omg-ann:explanatoryNote : In linguistics, a reference characterizes, provides context for, or specifies the relationship of one linguistic expression to another, i.e., provides the information necessary to interpret the dependent expression.^^xsd:stringomg-ann:explanatoryNote : References may be rendered in the form of a document, but may also take other forms, such as reference materials, scientific equations, and constants, including in some cases physical things, used as the basis for units of measure.^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO/IEC 11179-3 Information technology - Metadata registries (MDR) - Part 3: Registry metamodel and basic attributes, Third edition, 2013-02-15^^xsd:string</para>
    ///   <para>omg-ann:explanatoryNote : A reference document is typically one that provides pertinent details for consultation about a subject.^^xsd:string</para>
    ...
    ///   <para>omg-ann:abbreviation : spec</para>
    ///   <para>omg-ann:adaptedFrom : ISO 6707-2:2017 Buildings and civil engineering works - Vocabulary - Part 2: Contract and communication terms, clause 3.2.22^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO 10795:2019 Space systems - Programme management and quality - Vocabulary, clause 3.238^^xsd:stringomg-ann:adaptedFrom : ISO 6707-2:2017 Buildings and civil engineering works - Vocabulary - Part 2: Contract and communication terms, clause 3.2.22^^xsd:string</para>
    ///   <para>omg-ann:explanatoryNote : A technical specification is a specification expressing technical requirements, such as one for designing and developing a solution to be implemented.^^xsd:string</para>
    ///   <a href="https://www.omg.org/spec/Commons/Documents/TechnicalSpecificationDocument">cmns-doc:TechnicalSpecificationDocument</a>
    /// </summary>
    let TechnicalSpecificationDocument = _prefixId.prefix "TechnicalSpecificationDocument"
    ...
    ///   <para>omg-ann:usageNote : Although in many cases an annotation property, such as dct:source, is sufficient for this purpose, there are occasions when a more complete description of a source is required, such as to meet data lineage requirements, for which this property may be used.^^xsd:string</para>
    ...
    ///   <para>omg-ann:explanatoryNote : Specifies may be used to refer to a requirement, fact, or set of facts.^^xsd:string</para>
