...
module ``cmns-col`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/Collections/" "cmns-col"
    ...
    ///   <para>omg-ann:usageNote : Users should use either comprises or hasPart, or one of their respective subproperties, to include things in a collection.^^xsd:string</para>
    ...
    ///   <para>omg-ann:usageNote : Users should use either isIncludedIn or isPartOf, or one of their respective subproperties, to include a constituent in a collection.^^xsd:string</para>
    ...
    ///   <para>omg-ann:usageNote : Users should use the hasMethod property on arrangement to describe the methodology for structuring the collection.^^xsd:string</para>
    ...
    ///   <para>omg-ann:usageNote : This property is disjoint with hasMember, and should be used in cases where the constituents of something are not considered discrete elements of whatever they are included in, such as a substance or composite.^^xsd:string</para>
    ...
    ///   <para>omg-ann:usageNote : This property is useful in cases where one is interested in the direct relationships between parts of things, for example to build a tree view.^^xsd:string</para>
    ...
    ///   <para>dcterms:source : Stanford Encyclopedia of Philosophy at http://plato.stanford.edu/entries/mereology/^^xsd:string</para>
