...
module ``cmns-cxtid`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/ContextualIdentifiers/" "cmns-cxtid"
    ...
    /// </summary>
    let ContextualIdentificationScheme = _prefixId.prefix "ContextualIdentificationScheme"
