...
module eem =
    ...
    let associatedWithTransformationEvent = _prefixId.prefix "associatedWithTransformationEvent"
    ...
    let disassociatedWithAggregationID = _prefixId.prefix "disassociatedWithAggregationID"
