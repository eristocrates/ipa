...
module rb =
    let _prefixId = PrefixId.fromNamespaceLabel "https://w3id.org/riverbench/schema/metadata#" "rb"
    ...
    /// </summary>
    let DatatypeLiteralCountStatistics = _prefixId.prefix "DatatypeLiteralCountStatistics"
    ...
    /// </summary>
    let LanguageLiteralCountStatistics = _prefixId.prefix "LanguageLiteralCountStatistics"
    ...
    /// </summary>
    let StatementCountStreamElementSplit = _prefixId.prefix "StatementCountStreamElementSplit"
    ...
    /// </summary>
    let conformsToRdfStarDraft_20211217 = _prefixId.prefix "conformsToRdfStarDraft_20211217"
