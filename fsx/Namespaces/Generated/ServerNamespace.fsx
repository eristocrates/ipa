...
module server =
    ...
    let YangLibrary1'_period_'0Capability = _prefixId.prefix "YangLibrary1.0Capability"
    let YangLibrary1'_period_'1Capability = _prefixId.prefix "YangLibrary1.1Capability"
    /// <summary>
