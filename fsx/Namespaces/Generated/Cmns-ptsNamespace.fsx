...
module ``cmns-pts`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/PartiesAndSituations/" "cmns-pts"
    ...
    ///   <para>omg-ann:adaptedFrom : ISO 14813-1:2015(en), Intelligent transport systems - Reference model architecture(s) for the ITS sector - Part 1: ITS service domains, service groups and services, clause 3.1^^xsd:stringomg-ann:adaptedFrom : ISO 23234:2021(en), Buildings and civil engineering works - Security - Planning of security measures in the built environment, clause 3.4^^xsd:stringomg-ann:adaptedFrom : ISO/TR 21965:2019(en), Information and documentation - Records management in enterprise architecture, clause 3.2.1^^xsd:string</para>
    ///   <para>omg-ann:explanatoryNote : The concept of actor here is in a more linguistic sense, from core semantic theories reflecting actor/undergoer/null roles of an argument in an expression.^^xsd:string</para>
    ...
    ///   <para>omg-ann:directSource : http://www.omg.org/techprocess/meetings/schedule/AMP.html^^xsd:anyURI</para>
    ...
    ///   <para>dcterms:source : ISO/IEC TR 29119-11:2020(en), Software and systems engineering - Software testing - Part 11: Guidelines on the testing of AI-based systems, clause 3.1.73^^xsd:string</para>
    ...
    ///   <para>omg-ann:usageNote : This property is intended as an abstract property, whose subproperties may or may not be symmetric, but could be inverses of one another.^^xsd:string</para>
    ...
    /// </summary>
    let playsActiveRoleThatDirectlyAffects = _prefixId.prefix "playsActiveRoleThatDirectlyAffects"
