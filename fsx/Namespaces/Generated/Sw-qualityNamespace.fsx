...
module ``sw-quality`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://w3id.org/squap/SoftwareQuality/" "sw-quality"
    ...
    /// </summary>
    let AppropriatenessRecognisability = _prefixId.prefix "AppropriatenessRecognisability"
    ...
    /// </summary>
    let PerformanceEfficiencyCompliance = _prefixId.prefix "PerformanceEfficiencyCompliance"
