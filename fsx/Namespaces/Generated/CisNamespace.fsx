...
module cis =
    let _prefixId = PrefixId.fromNamespaceLabel "http://dati.beniculturali.it/cis/" "cis"
    ...
    ///   <para>dc11:description : This class is used for representing the access conditions associated with a 'Cultural Institute or Site' or an 'Event'.
    ...
    /// &lt;/pre&gt;dc11:description : Questa classe è utilizzata per rappresentare le condizioni di accesso associate a un "Istituto e luogo della Culrura" o a un "Evento": Le condizione di accesso sono individui delle seguenti classi:
    ///  * Orari di apertura
    ///  * Chiusara Temporanea
    ...
    ///   <para>dc11:description : Individuals of the class Site are associated with individual of the class Address by means of the object property hasAddress.
    ...
    ///       cis:postCode "00185" .
    ///
    /// &lt;/pre&gt;dc11:description : Individui della classe Address sono connessi ad invididui della classe Site attraverso la proprietà che collega Site ad Address hasAddress.
    ...
    ///   <para>dc11:description : Individui di questa classe identificano i possibili tipi di politiche di accesso che possono essere applicate agli orari di apertura di un luogo e istituto della cultura.
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Individuals of this class identify the possible admission types (in terms of access policies) that can be applied to the opening hours specifications of a Cultural Institute or Site (CIS).
    ///
    ...
    ///   <para>dc11:description : An Agent is described by means of its name and a set of properties that allows modeling its role in time and, in case of physical persons, his/her belonging relationship to the public or private organization.
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un agente è descritto mediante il suo nome e da una serie di proprietà che consentono di modellare il suo ruolo nel tempo e, nel caso di persone fisiche, di appartenenza a una certa organizzazione, pubblica o privata.
    ///
    ...
    /// <summary>
    ///   <para>dc11:description : An example of usage of the class cis:ArchaeologicalArea is the following:
    ///
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di uso della classe cis:ArchaeologicalArea è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Museo_delle_navi_romane_di_Nemi
    ...
    ///   <para>dc11:description : Un esempio di utilizzo della classe cis:ArchaeologicalPark è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : An example of usage of the class cis:ArchaeologicalPark is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Parco_archeologico_di_Liternum
    ...
    ///   <para>dc11:description : An example of usage of the class cis:Attribute is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// attribute:Shelving
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe cis:Attribute è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// attribute:Shelving
    ...
    ///   <para>owl:versionInfo : stabileowl:versionInfo : stable</para>
    ///   <para>dc11:description : An example of usage of the class cis:AudioObject is the following:
    ///
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe cis:AudioObject è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// audio:Audio_Tour_Parco_archeologico_di_Liternum
    ...
    ///   <para>owl:versionInfo : stabileowl:versionInfo : stable</para>
    ///   <para>dc11:description : An example of usage of the class cis:Booking is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// booking:Mandatory
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di uso della classe cis:Booking è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// booking:Mandatory
    ...
    ///   <para>dc11:description : An example of usage of the class cis:Card is the following:
    ///
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe cis:Card  è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// card:Parco_archeologico_di_Liternum_Card
    ...
    /// <summary>
    ///   <para>dc11:description : A catalogue is always associated with an individual of the class 'CulturalInstituteOrSite' (CIS) by means of the object property hasCatalogue (with domain CulturalInstituteOrSite and range Catalogue).
    ///
    ...
    /// &lt;/pre&gt;dc11:description : Un catalogo è sempre associato a un individuo della classe "Istitute e luogo della cultura" attraverso la proprietà ha catalogo (che ha dominio CulturaInstituteOrSite e codominio Catalogue).
    ///
    ...
    ///   <para>dc11:description : An example of usage of the class cis:Cinema is the following:
    ///
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe cis:Cinema è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Cinema_Storico_Alberto_Sordi
    ...
    /// <summary>
    ///   <para>dc11:description : Un esempio di utilizzo della classe cis:ClericalAdministrativeArea è il seguente
    ///
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : An example of usage of the class cis:ClericalAdministrativeArea èil the following:
    ///
    /// &lt;pre&gt;
    ///
    /// caa:Diocesi_di_San_Marco_Argentano-Scalea
    ...
    /// <summary>
    ///   <para>dc11:description : Individuals of this class represent cultural heritage included in a Cultural Institute or Site.
    ///
    ...
    ///
    ///
    /// &lt;/pre&gt;dc11:description : Individui di questa classe rappresentano il patrimonio culturale incluso in un Istituto e luogo della cultural.
    ///
    ...
    ///   <para>dc11:description : Gli individui delle classi Istituto e Luogo della Cultura, Evento e Sede possono avere dei punti di contatto, i.e., un numero di telefono, un indirizzo email, un fax, ecc. che sono utilizzati come riferimenti.
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Individuals of the classes CulturalInstituteOrSite, Event and Site may have a "contact point", i.e., a phone number, email address, fax, etc. that is used a reference contact.
    ///
    ...
    /// <summary>
    ///   <para>dc11:description : An example of usage of the class cis:CultReseachCenter is the following:
    ///
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe cis:CultReseachCenter è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// crc:Fondazione_Arnaldo_Pomodoro
    ...
    ///   <para>owl:versionInfo : stabileowl:versionInfo : stable</para>
    ///   <para>dc11:description : Un esempio di utilizzo della classe cis:CulturalHeritageObject iè il seguente:
    ///
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : An example of usage of the class cis:CulturalHeritageObject is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// culturalheritageobject:Nascita_di_Venere
    ...
    /// <summary>
    ///   <para>dc11:description : An example of usage of the class 'Cultural Institute or Site' is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Biblioteca_nazionale_centrale
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe "Istituto e Luogo della Cultura" è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Biblioteca_nazionale_centrale
    ...
    ///   <para>owl:versionInfo : versione non definitivaowl:versionInfo : unstable</para>
    ///   <para>dc11:description : An example of usage of the class cis:CulturalLandscapeAsset is the following:
    ///
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe cis:CulturalLandscapeAsset è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Costiera_Amalfitana
    ...
    ///   <para>dc11:description : Individuals of the this class represent currency instances (e.g., Euro, US Dollar, Pound, Australian Dollar, etc.); they are always associated with individuals of the class 'Price Specification'.
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Individui di questa classe rappresentano le istanze di valuta (e.g., euro, dollaro americano, sterlina, ecc) e sono sempre associati a individui della classe "Prezzo".
    ///
    ...
    ///   <para>owl:versionInfo : unstableowl:versionInfo : versione non definitiva</para>
    ///   <para>dc11:description : An example of usage of the class cis:DayOfTheWeek is the following:
    ///
    /// &lt;pre&gt;
    ///
    ...
    /// &lt;/pre&gt;
    ///
    /// For the complete example see the class cis:OpeningHoursSpecificationdc11:description : Un esempio di utilizzo della classe cis:DayOfTheWeek è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// orari:Orari_di_apertura_di_Biblioteca_nazionale_centrale_di_Roma_giovedi
    ...
    ///   <para>dc11:description : An example of usage of the class cis:Equipment is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// equ:Photocopier
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe cis:Equipment è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// equ:Photocopier
    ...
    /// <summary>
    ///   <para>owl:versionInfo : stabileowl:versionInfo : stable</para>
    ///   <para>dc11:description : Un esempio di utilizzo della classe cis:Event è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// event:Vincenzo_Gemito_al_Museo_di_Capodimonte
    ...
    ///     cis:isInSite site:Museo_di_Capodimonte .
    ///
    /// &lt;/pre&gt;dc11:description : An example of usage of the class cis:Event is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// event:Vincenzo_Gemito_al_Museo_di_Capodimonte
    ...
    ///   <para>dc11:description : Questa classe consente di descrivere un'area geografica.
    ///
    ...
    ///       geo:long "12.504962" .
    ///
    /// &lt;/pre&gt;dc11:description : This class allows describing a geographical area.
    ...
    ///   <para>owl:versionInfo : stableowl:versionInfo : stabile</para>
    ///   <para>dc11:description : An example of usage of the class cis:Geometry is the following:
    /// &lt;pre&gt;
    ///
    ...
    /// &lt;/pre&gt;
    ///
    /// For a complete example refer to the class cis:GeographicalFeaturedc11:description : Un esempio di utilizzo della classe cis:Geomery è il seguente:
    /// &lt;pre&gt;
    ///
    /// geometry:Museo_di_Capodimonte_Geometry
    ///       a       cis:Geometry ;
    ...
    ///   <para>dc11:description : Un esempio di utilizzo della classe cis:GovernamentalAdministrativeArea è il seguente:
    /// &lt;pre&gt;
    ///
    /// gaa:Lazio
    ...
    ///     cis:hasISTATCode "12" .
    ///
    /// &lt;/pre&gt;dc11:description : An example of usage of the class cis:GovernamentalAdministrativeArea is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// gaa:Lazio
    ...
    /// </summary>
    let GovernamentalAdministrativeArea = _prefixId.prefix "GovernamentalAdministrativeArea"
    ...
    ///   <para>dc11:description : Un esempio di utilizzo della classe cis:HolderOfArchive è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : An example of usage of the class cis:HolderOfArchive is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Archivio_di_Stato_di_Oristano
    ...
    ///   <para>dc11:description : Un esempio dell'utilizzo della classe cis:ImageObject è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : An example of the usage of the class cis:ImageObject is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// image:Poster_Evento_Vincenzo_Gemito_al_Museo_di_Capodimonte
    ...
    ///   <para>dc11:description : Individuals of this class expresses a definite magnitude of physical quantities.
    ///
    ...
    /// cis:Day a cis:MeasurementUnit
    ///
    /// &lt;/pre&gt;dc11:description : Individui di questa classe rappresentano un insieme definito di quantità fisiche.
    ///
    ...
    ///   <para>owl:versionInfo : stabileowl:versionInfo : stable</para>
    ///   <para>dc11:description : An example of usage of the class cis:MonumentalArea is the following:
    ///
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe cis:MonumentalArea è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:COMPLESSO_MONUMENTALE_DI_VICOPISANO_ROCCA_DEL_BRUNELLESCHI_E_PALAZZO_PRETORIO
    ...
    ///   <para>owl:versionInfo : stableowl:versionInfo : stabile</para>
    ///   <para>dc11:description : An example of usage of the class cis:Museum is the following:
    ///
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe cis:Museum è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Museo_di_Capodimonte
    ...
    /// <summary>
    ///   <para>dc11:description : An example of usage of the class cis:NameInTime is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Museo_di_Capodimonte
    ...
    ///     cis:startDate "1957" .
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe cis:NameInTime è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Museo_di_Capodimonte
    ...
    /// <summary>
    ///   <para>dc11:description : Any fare is expressed within the ontology by using instances of the class Offer.
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Qualsiasi tariffa è rappresentata nell'ontologia attraverso istanze della classe "Offerta".
    ///
    ...
    /// <summary>
    ///   <para>owl:versionInfo : stableowl:versionInfo : stabile</para>
    ///   <para>dc11:description : Individui di questa classe specificano particolari condizioni di accesso ai luoghi della cultura o eventi, i.e., gli orari di apertura dei luoghi o degli eventi.
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Individuals of this class specify a particula access conditions, i.e., the opening hours of a 'Cultural Institute or Site' or an 'Event'.
    ///
    ...
    ///   <para>dc11:description : Un prezzo fornisce informazioni sul costo di un offerta necessaria per entrare in un luogo della cultura o accedere a un evento.
    ///
    ...
    ///
    ///
    /// &lt;/pre&gt;dc11:description : A price specification provides the information about the cost of an offer for entering a Cultural Institute or Site.
    ///
    ...
    ///   <para>dc11:description : Un esempio di uso della classe cis:Project è il seguente:
    /// &lt;pre&gt;
    ///
    /// cissite:Museo_di_Capodimonte
    ///     a cis:CulturalInstituteOrSite, cis:Museum ;
    ...
    ///
    /// &lt;/pre&gt;dc11:description : An example of usage of the class cis:Project is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Museo_di_Capodimonte
    ...
    ///   <para>dc11:description : An example of usage of the class cis:QuantitativeValue is the following:
    ///
    /// &lt;pre&gt;
    ///
    ...
    /// cis:Day a cis:MeasurementUnit .
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe cis:QuantitativeValue è il seguente:
    /// &lt;pre&gt;
    ///
    /// qv:Parco_archeologico_di_Liternum_Card_Validity_Duration
    ///     a cis:QuantitativeValue ;
    ...
    ///   <para>dc11:description : Un esempio di utilizzo della classe cis:Role è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// role:Director
    ...
    ///
    /// &lt;/pre&gt;dc11:description : An example of usage of the class cis:Role is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// role:Director
    ...
    ///   <para>dc11:description : Un esempio di utilizzo della classe cis:RoleInTime è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// agent:Andrea_De_Pasquale
    ...
    ///     cis:name ";Director"@en .
    ///
    /// &lt;/pre&gt;dc11:description : An example of usage of the class cis:RoleInTime is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// agent:Andrea_De_Pasquale
    ...
    ///   <para>owl:versionInfo : stabileowl:versionInfo : stable</para>
    ///   <para>dc11:description : Un istituto della cultura può offrire una serie di servizi (e.g., Wi-Fi, accesso ai disabili, caffetteria, ecc.).
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : A Cultural Institute or Site (CIS) might offer a variety of services (e.g., Wi-Fi Handicapped access, cafeteria, etc.).
    ///
    ...
    /// <summary>
    ///   <para>owl:versionInfo : stableowl:versionInfo : stabile</para>
    ///   <para>dc11:description : Una sede è sempre associata agli individui della classe "Istituto e Luogo della Cultura" attraverso la proprietà ha sede.
    ///
    ...
    ///       cis:hasSite site:Sede_di_Biblioteca_nazionale_centrale_di_Roma .
    ///
    /// &lt;/pre&gt;dc11:description : A site is always associated with an individual of the class 'Cultural Institute or Site' (CIS) by means of the object property hasSite.
    ///
    ...
    /// <summary>
    ///   <para>dc11:description : An example of usage of the class cis:SiteDescription is the following:
    /// &lt;pre&gt;
    ///
    /// site:Sede_di_Biblioteca_nazionale_centrale_di_Roma
    ///       a       cis:Site ;
    ...
    ///     cis:description ";La dimensione di uno scaffale in metri lineari (es. 3 metri)"@it .
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe cis:SiteDescription è il seguente:
    /// &lt;pre&gt;
    ///
    /// site:Sede_di_Biblioteca_nazionale_centrale_di_Roma
    ///       a       cis:Site ;
    ...
    /// <summary>
    ///   <para>dc11:description : Un esempio di utilizzo della classe cis:SubjectDiscipline è il seguente:
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : An example of usage of the class cis:SubjectDiscipline is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Museo_archeologico_statale
    ...
    /// <summary>
    ///   <para>dc11:description : A temporary closure is a subclass of 'AccessCondition' whose individuals provide information about a temporary closure.
    ...
    /// &lt;/pre&gt;dc11:description : La chiusura temporanea è una sottoclasse di Condizioni di accesso i cui individui forniscono informazioni sulla chiusura temporanea.
    ///
    ...
    /// <summary>
    ///   <para>dc11:description : An example of usage of the class cis:TemporaryClosureType is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Biblioteca_nazionale_centrale
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe cis:TemporaryClosureType è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Biblioteca_nazionale_centrale
    ...
    ///   <para>dc11:description : Un esempio di utilizzo della classe cis:Theatre è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    ...
    ///
    /// &lt;/pre&gt;dc11:description : An example of usage of the class cis:Theatre is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// cissite:Teatro_Olimpico
    ...
    ///   <para>owl:versionInfo : stableowl:versionInfo : stabile</para>
    ///   <para>dc11:description : An example of usage of the class cis:Ticket is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// offer:Biblioteca_Nazionale_Centrale_base_offer
    ...
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio dell'utilizzo della classe cis:Ticket è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// offer:Biblioteca_Nazionale_Centrale_base_offer
    ...
    ///   <para>dc11:description : Un esempio di utilizzo della classe cis:TimeInterval è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// timeInteval:Andrea_De_Pasquale_DirectorOfBibliotecaNazionaleCentrale_20130101_20161231
    ...
    ///     cis:endDate "2016-12-31"^^xsd:dateTime .
    ///
    /// &lt;/pre&gt;dc11:description : An example of usage of the class cis:TimeInterval is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// timeInteval:Andrea_De_Pasquale_DirectorOfBibliotecaNazionaleCentrale_20130101_20161231
    ...
    /// <summary>
    ///   <para>dc11:description : An example of usage of the class cis:UserType is the following:
    ///
    /// &lt;pre&gt;
    /// userType:Under18
    ///    a cis:UserType ;
    ...
    ///    cis:description "Persone con età inferiore ai 18 anni"@it  .
    ///
    /// &lt;/pre&gt;dc11:description : Un esempio di utilizzo della classe cis:UserType è il seguente:
    ///
    /// &lt;pre&gt;
    /// userType:Under18
    ///    a cis:UserType ;
    ...
    ///   <para>dc11:description : Un esempio di utilizzo della classe cis:Validity è il seguente:
    ///
    /// &lt;pre&gt;
    ///
    /// validity:Parco_archeologico_di_Liternum_Card_Validity
    ...
    ///     cis:hasValue "2"^^xsd:positiveInteger .
    ///
    /// &lt;/pre&gt;dc11:description : An example of usage of the class cis:Validity is the following:
    ///
    /// &lt;pre&gt;
    ///
    /// validity:Parco_archeologico_di_Liternum_Card_Validity
