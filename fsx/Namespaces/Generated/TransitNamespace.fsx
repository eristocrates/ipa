...
module transit =
    let _prefixId = PrefixId.fromNamespaceLabel "http://vocab.org/transit/terms/" "transit"

    let _namespaceIri = _prefixId.prefix ""
    let _'_period_'html = _prefixId.prefix ".html"
    let _'_period_'json = _prefixId.prefix ".json"
    let _'_period_'rdf = _prefixId.prefix ".rdf"
    let _'_period_'turtle = _prefixId.prefix ".turtle"
    /// <summary>
