...
module eclap =
    let _prefixId = PrefixId.fromNamespaceLabel "http://www.eclap.eu/schema/eclap/" "eclap"
    ...
    /// </summary>
    let artisticMovementAndActingStyle = _prefixId.prefix "artisticMovementAndActingStyle"
