...
module aos =
    let _prefixId = PrefixId.fromNamespaceLabel "http://rdf.muninn-project.org/ontologies/appearances#" "aos"
    ...
    let EyeColorGrieveMorantMoreBlueGreyThanBrown = _prefixId.prefix "EyeColorGrieveMorantMoreBlueGreyThanBrown"

    let EyeColorGrieveMorantMoreBrownThanBlueGrey = _prefixId.prefix "EyeColorGrieveMorantMoreBrownThanBlueGrey"
    ...
    let EyeColorMartinSchultzLightBlue = _prefixId.prefix "EyeColorMartinSchultzLightBlue"
    ...
    let EyeColorNebraskaDMVDichromatic = _prefixId.prefix "EyeColorNebraskaDMVDichromatic"
    ...
    let HairColorAtlasBlondLightMedium = _prefixId.prefix "HairColorAtlasBlondLightMedium"
    ...
    let HairColorAtlasDarkOpaqueGrayBrown = _prefixId.prefix "HairColorAtlasDarkOpaqueGrayBrown"
    ...
    let HairColorAtlasLightGoldenBrown = _prefixId.prefix "HairColorAtlasLightGoldenBrown"

    let HairColorAtlasLightGrayBrown = _prefixId.prefix "HairColorAtlasLightGrayBrown"

    let HairColorAtlasLightMediumBrown = _prefixId.prefix "HairColorAtlasLightMediumBrown"

    let HairColorAtlasLightMediumGoldenBrown = _prefixId.prefix "HairColorAtlasLightMediumGoldenBrown"

    let HairColorAtlasLightMediumGrayBrown = _prefixId.prefix "HairColorAtlasLightMediumGrayBrown"

    let HairColorAtlasLightMediumRed = _prefixId.prefix "HairColorAtlasLightMediumRed"

    let HairColorAtlasLightMediumRedBrown = _prefixId.prefix "HairColorAtlasLightMediumRedBrown"
    ...
    let HairColorAtlasMediumDarkGoldenBrown = _prefixId.prefix "HairColorAtlasMediumDarkGoldenBrown"

    let HairColorAtlasMediumDarkGrayBrown = _prefixId.prefix "HairColorAtlasMediumDarkGrayBrown"

    let HairColorAtlasMediumDarkRed = _prefixId.prefix "HairColorAtlasMediumDarkRed"

    let HairColorAtlasMediumDarkRedBrown = _prefixId.prefix "HairColorAtlasMediumDarkRedBrown"
    ...
    let HairColorRCMPLightStrawberryRed = _prefixId.prefix "HairColorRCMPLightStrawberryRed"
    ...
    /// </summary>
    let hasKneeLengthMeasurementInches = _prefixId.prefix "hasKneeLengthMeasurementInches"
    ...
    /// </summary>
    let hasKneeLengthMeasurementMeters = _prefixId.prefix "hasKneeLengthMeasurementMeters"
    ...
    /// </summary>
    let hasPantLengthMeasurementInches = _prefixId.prefix "hasPantLengthMeasurementInches"
    ...
    /// </summary>
    let hasPantLengthMeasurementMeters = _prefixId.prefix "hasPantLengthMeasurementMeters"
