...
module dqc =
    let _prefixId = PrefixId.fromNamespaceLabel "http://semwebquality.org/ontologies/dq-constraints#" "dqc"
    ...
    let ExclusiveFunctionalDependencyAll = _prefixId.prefix "ExclusiveFunctionalDependencyAll"

    let ExclusiveFunctionalDependencyClass = _prefixId.prefix "ExclusiveFunctionalDependencyClass"

    let FiveDigitNumericAll = _prefixId.prefix "FiveDigitNumericAll"

    let FunctionalDependencyConstraints = _prefixId.prefix "FunctionalDependencyConstraints"

    let FunctionalDependencyTrustedReferenceAll = _prefixId.prefix "FunctionalDependencyTrustedReferenceAll"

    let FunctionalDependencyTrustedReferenceClass = _prefixId.prefix "FunctionalDependencyTrustedReferenceClass"

    let FunctionalDependencyTrustedReference_ClassOverBlankNode = _prefixId.prefix "FunctionalDependencyTrustedReference_ClassOverBlankNode"

    let FunctionalDependentEmptyValueAll = _prefixId.prefix "FunctionalDependentEmptyValueAll"
    ...
    let ListedLegalValueClassOverBlankNode = _prefixId.prefix "ListedLegalValueClassOverBlankNode"
