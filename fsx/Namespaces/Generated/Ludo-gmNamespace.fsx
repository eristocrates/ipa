...
module ``ludo-gm`` =
    let _prefixId = PrefixId.fromNamespaceLabel "http://ns.inria.fr/ludo/v1/gamemodel#" "ludo-gm"
    ...
    /// </summary>
    let hasInteractionRuleOutcomeOperation = _prefixId.prefix "hasInteractionRuleOutcomeOperation"
