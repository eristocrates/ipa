...
module s4city =
    let _prefixId = PrefixId.fromNamespaceLabel "https://saref.etsi.org/saref4city/" "s4city"
    ...
    /// </summary>
    let KeyPerformanceIndicatorAssessment = _prefixId.prefix "KeyPerformanceIndicatorAssessment"
