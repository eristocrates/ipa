...
module dcite =
    ...
    let datacite'_period_'png = _prefixId.prefix "datacite.png"
    ...
    let local_funder_identifier_scheme = _prefixId.prefix "local-funder-identifier-scheme"

    let local_organization_identifier_scheme = _prefixId.prefix "local-organization-identifier-scheme"

    let local_personal_identifier_scheme = _prefixId.prefix "local-personal-identifier-scheme"

    let local_resource_identifier_scheme = _prefixId.prefix "local-resource-identifier-scheme"
