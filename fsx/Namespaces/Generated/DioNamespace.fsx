...
module dio =
    ...
    /// <summary>
    ///   <para>dc11:description : An entity representing the proposed solution.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A reason presented against a proposed solution.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : The assumption on which a proposed solution is based.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A comment made by an agent in response to an argument, a justification or another comment^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A constraint that underlies the proposed solution.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A design is a specification of an object, manifested by an agent, intended to accomplish goals, in a particular environment, using a set of  components, satisfying a set of requirements, subject to constraints.^^xsd:string</para>
    ///   <para>rdfs:label : Design^^xsd:string</para>
    ///   <a href="https://w3id.org/dio#Design">dio:Design</a>
    /// </summary>
    let Design = _prefixId.prefix "Design"
    /// <summary>
    ///   <para>dc11:description : The final design decision made based on the various alternative solutions proposed. A design decision is driven by a mandated solution.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An entity representing the problem, goal, question or issue the design intent aims to address.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A entity defining the notion of a design intent, i.e., the rationale underpinning the choices that are made from the alternatives available during various phases of the overall design lifecycle.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An entity representing any artifact that plays a part in capturing the design intent. The minimum ontological commitment required for this entity is a brief description of the artifact, the version info and the date.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An entity capturing the requirements that result in the design intent^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An entity representing the evaluation that supports the solution.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An entity representing an evidence that supports a proposed solution.^^xsd:stringdc11:description : Evidence^^xsd:string</para>
    ///   <a href="https://w3id.org/dio#Evidence">dio:Evidence</a>
    /// </summary>
    let Evidence = _prefixId.prefix "Evidence"
    /// <summary>
    ///   <para>dc11:description : An entity representing the requirements to be fulfilled for realising the solution^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An entity representing the solution accepted as a result of the design deliberation process.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An entity representing the methodology used to capture the design intent artifact^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An entity representing the status of a design issue.^^xsd:string</para>
