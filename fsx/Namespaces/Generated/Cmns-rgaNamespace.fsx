...
module ``cmns-rga`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/RegulatoryAgencies/" "cmns-rga"
    ...
    ///   <para>omg-ann:adaptedFrom : https://www.law.cornell.edu/wex/jurisdiction^^xsd:string</para>
    ...
    ///   <para>omg-ann:explanatoryNote : Typically, a regulatory agency is chartered to protect some constituancy, (e.g., investors in the financial industry, consumers with respect to product safety), to ensure the fairness and integrity of some market, and fair and safe business practices among the service providers in that market.^^xsd:string</para>
    ///   <para>omg-ann:synonym : regulator^^xsd:stringomg-ann:synonym : regulatory authority^^xsd:stringomg-ann:synonym : regulatory body^^xsd:string</para>
    ...
    ///   <para>omg-ann:explanatoryNote : Such a report may be needed for licensing, monitoring, taxation, or for other purposes that demonstrate the integrity, fairness, safety, or other capacity of a given industry, organization, or product.^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : http://www.merriam-webster.com/dictionary/regulate^^xsd:string</para>
