...
module atm =
    let _prefixId = PrefixId.fromNamespaceLabel "https://data.nasa.gov/ontologies/atmonto/ATM#" "atm"
    ...
    /// </summary>
    let planGapAfterSequenceElementNumber = _prefixId.prefix "planGapAfterSequenceElementNumber"
