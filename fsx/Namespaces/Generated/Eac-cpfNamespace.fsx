...
module ``eac-cpf`` =
    let _prefixId = PrefixId.fromNamespaceLabel "http://archivi.ibc.regione.emilia-romagna.it/ontology/eac-cpf/" "eac-cpf"
    ...
    let eac_cpf'_period_'rdf = _prefixId.prefix "eac-cpf.rdf"
    /// <summary>
