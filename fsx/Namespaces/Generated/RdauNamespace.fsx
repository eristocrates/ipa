...
module rdau =
    let _prefixId = PrefixId.fromNamespaceLabel "http://rdaregistry.info/Elements/u/" "rdau"
    ...
    let abridgedAs'_period_'en = _prefixId.prefix "abridgedAs.en"
    let abridgementOf'_period_'en = _prefixId.prefix "abridgementOf.en"
    let abridger'_period_'en = _prefixId.prefix "abridger.en"
    let abridgerOf'_period_'en = _prefixId.prefix "abridgerOf.en"
    let absorbedBy'_period_'en = _prefixId.prefix "absorbedBy.en"
    let absorbedInPartBy'_period_'en = _prefixId.prefix "absorbedInPartBy.en"
    let absorptionInPartOf'_period_'en = _prefixId.prefix "absorptionInPartOf.en"
    let absorptionOf'_period_'en = _prefixId.prefix "absorptionOf.en"
    let abstractOf'_period_'en = _prefixId.prefix "abstractOf.en"
    let abstractedAs'_period_'en = _prefixId.prefix "abstractedAs.en"
    let abstractedIn'_period_'en = _prefixId.prefix "abstractedIn.en"
    let abstractsFor'_period_'en = _prefixId.prefix "abstractsFor.en"
    let academicDegree'_period_'en = _prefixId.prefix "academicDegree.en"
    let accessibilityContent'_period_'en = _prefixId.prefix "accessibilityContent.en"
    let accompaniedBy'_period_'en = _prefixId.prefix "accompaniedBy.en"

    let accompanyingResourceRelationshipWith'_period_'en = _prefixId.prefix "accompanyingResourceRelationshipWith.en"

    let actor'_period_'en = _prefixId.prefix "actor.en"
    let actorOf'_period_'en = _prefixId.prefix "actorOf.en"
    let adaptationOf'_period_'en = _prefixId.prefix "adaptationOf.en"
    let adaptedAs'_period_'en = _prefixId.prefix "adaptedAs.en"

    let adaptedAsAMotionPicture'_period_'en = _prefixId.prefix "adaptedAsAMotionPicture.en"

    let adaptedAsAMotionPictureScreenplay'_period_'en = _prefixId.prefix "adaptedAsAMotionPictureScreenplay.en"

    let adaptedAsARadioProgram'_period_'en = _prefixId.prefix "adaptedAsARadioProgram.en"

    let adaptedAsARadioScript'_period_'en = _prefixId.prefix "adaptedAsARadioScript.en"
    let adaptedAsAScreenplay'_period_'en = _prefixId.prefix "adaptedAsAScreenplay.en"

    let adaptedAsATelevisionProgram'_period_'en = _prefixId.prefix "adaptedAsATelevisionProgram.en"

    let adaptedAsATelevisionScreenplay'_period_'en = _prefixId.prefix "adaptedAsATelevisionScreenplay.en"

    let adaptedAsAVideo'_period_'en = _prefixId.prefix "adaptedAsAVideo.en"

    let adaptedAsAVideoScreenplay'_period_'en = _prefixId.prefix "adaptedAsAVideoScreenplay.en"

    let adaptedAsChoreography'_period_'en = _prefixId.prefix "adaptedAsChoreography.en"
    let adaptedAsGraphicNovel'_period_'en = _prefixId.prefix "adaptedAsGraphicNovel.en"
    let adaptedAsLibretto'_period_'en = _prefixId.prefix "adaptedAsLibretto.en"

    let adaptedAsMusicalTheatre'_period_'en = _prefixId.prefix "adaptedAsMusicalTheatre.en"

    let adaptedAsNovel'_period_'en = _prefixId.prefix "adaptedAsNovel.en"
    let adaptedAsOpera'_period_'en = _prefixId.prefix "adaptedAsOpera.en"
    let adaptedAsOratorio'_period_'en = _prefixId.prefix "adaptedAsOratorio.en"
    let adaptedAsVideoGame'_period_'en = _prefixId.prefix "adaptedAsVideoGame.en"
    let adaptedInVerseAs'_period_'en = _prefixId.prefix "adaptedInVerseAs.en"
    let addenda'_period_'en = _prefixId.prefix "addenda.en"
    let addendaTo'_period_'en = _prefixId.prefix "addendaTo.en"

    let additionalScaleInformation'_period_'en = _prefixId.prefix "additionalScaleInformation.en"

    let addressOfTheAgent'_period_'en = _prefixId.prefix "addressOfTheAgent.en"
    let addressee'_period_'en = _prefixId.prefix "addressee.en"
    let addresseeOf'_period_'en = _prefixId.prefix "addresseeOf.en"
    let affiliation'_period_'en = _prefixId.prefix "affiliation.en"
    let agentHistory'_period_'en = _prefixId.prefix "agentHistory.en"
    let alsoIssuedAs'_period_'en = _prefixId.prefix "alsoIssuedAs.en"
    let alternateIdentity'_period_'en = _prefixId.prefix "alternateIdentity.en"
    ...
    let analysedIn'_period_'en = _prefixId.prefix "analysedIn.en"
    let analysisOf'_period_'en = _prefixId.prefix "analysisOf.en"
    let animator'_period_'en = _prefixId.prefix "animator.en"
    let animatorOf'_period_'en = _prefixId.prefix "animatorOf.en"
    let annotator'_period_'en = _prefixId.prefix "annotator.en"
    let annotatorOf'_period_'en = _prefixId.prefix "annotatorOf.en"
    let appellant'_period_'en = _prefixId.prefix "appellant.en"
    let appellantOf'_period_'en = _prefixId.prefix "appellantOf.en"
    let appellee'_period_'en = _prefixId.prefix "appellee.en"
    let appelleeOf'_period_'en = _prefixId.prefix "appelleeOf.en"
    let appendix'_period_'en = _prefixId.prefix "appendix.en"
    let appendixTo'_period_'en = _prefixId.prefix "appendixTo.en"
    ...
    let architectOf'_period_'en = _prefixId.prefix "architectOf.en"
    let arrangedAs'_period_'en = _prefixId.prefix "arrangedAs.en"
    let arrangementOf'_period_'en = _prefixId.prefix "arrangementOf.en"
    let arrangerOfMusic'_period_'en = _prefixId.prefix "arrangerOfMusic.en"
    let arrangerOfMusicOf'_period_'en = _prefixId.prefix "arrangerOfMusicOf.en"
    let artDirector'_period_'en = _prefixId.prefix "artDirector.en"
    let artDirectorOf'_period_'en = _prefixId.prefix "artDirectorOf.en"
    let artist'_period_'en = _prefixId.prefix "artist.en"
    let artistOf'_period_'en = _prefixId.prefix "artistOf.en"
    let aspectRatio'_period_'en = _prefixId.prefix "aspectRatio.en"
    let associatedInstitution'_period_'en = _prefixId.prefix "associatedInstitution.en"
    let augmentationOf'_period_'en = _prefixId.prefix "augmentationOf.en"
    let augmentedBy'_period_'en = _prefixId.prefix "augmentedBy.en"
    let author'_period_'en = _prefixId.prefix "author.en"
    let authorOf'_period_'en = _prefixId.prefix "authorOf.en"
    let autographer'_period_'en = _prefixId.prefix "autographer.en"
    let autographerOf'_period_'en = _prefixId.prefix "autographerOf.en"
    let award'_period_'en = _prefixId.prefix "award.en"
    let baseMaterial'_period_'en = _prefixId.prefix "baseMaterial.en"
    let basedOn'_period_'en = _prefixId.prefix "basedOn.en"
    let binder'_period_'en = _prefixId.prefix "binder.en"
    let binderOf'_period_'en = _prefixId.prefix "binderOf.en"

    let biographicalInformation'_period_'en = _prefixId.prefix "biographicalInformation.en"

    let bookArtist'_period_'en = _prefixId.prefix "bookArtist.en"
    let bookArtistOf'_period_'en = _prefixId.prefix "bookArtistOf.en"
    let bookDesigner'_period_'en = _prefixId.prefix "bookDesigner.en"
    let bookDesignerOf'_period_'en = _prefixId.prefix "bookDesignerOf.en"
    let bookFormat'_period_'en = _prefixId.prefix "bookFormat.en"
    let boundWith'_period_'en = _prefixId.prefix "boundWith.en"
    let brailleEmbosser'_period_'en = _prefixId.prefix "brailleEmbosser.en"
    let brailleEmbosserOf'_period_'en = _prefixId.prefix "brailleEmbosserOf.en"
    ...
    let broadcasterOf'_period_'en = _prefixId.prefix "broadcasterOf.en"

    let broaderAffiliatedAgent'_period_'en = _prefixId.prefix "broaderAffiliatedAgent.en"

    let cadenza'_period_'en = _prefixId.prefix "cadenza.en"
    let cadenzaComposedFor'_period_'en = _prefixId.prefix "cadenzaComposedFor.en"
    let calligrapher'_period_'en = _prefixId.prefix "calligrapher.en"
    let calligrapherOf'_period_'en = _prefixId.prefix "calligrapherOf.en"
    let carrierType'_period_'en = _prefixId.prefix "carrierType.en"
    let cartographer'_period_'en = _prefixId.prefix "cartographer.en"
    let cartographerOf'_period_'en = _prefixId.prefix "cartographerOf.en"
    let caster'_period_'en = _prefixId.prefix "caster.en"
    let casterOf'_period_'en = _prefixId.prefix "casterOf.en"
    let catalogue'_period_'en = _prefixId.prefix "catalogue.en"
    let catalogueOf'_period_'en = _prefixId.prefix "catalogueOf.en"
    let choralConductor'_period_'en = _prefixId.prefix "choralConductor.en"
    let choralConductorOf'_period_'en = _prefixId.prefix "choralConductorOf.en"
    let choreographer'_period_'en = _prefixId.prefix "choreographer.en"
    let choreographerOf'_period_'en = _prefixId.prefix "choreographerOf.en"

    let choreographicAdaptationOf'_period_'en = _prefixId.prefix "choreographicAdaptationOf.en"

    let choreography'_period_'en = _prefixId.prefix "choreography.en"
    let choreographyFor'_period_'en = _prefixId.prefix "choreographyFor.en"
    ...
    let collectionRegistrar'_period_'en = _prefixId.prefix "collectionRegistrar.en"
    let collectionRegistrarOf'_period_'en = _prefixId.prefix "collectionRegistrarOf.en"
    let collector'_period_'en = _prefixId.prefix "collector.en"
    let collectorOf'_period_'en = _prefixId.prefix "collectorOf.en"
    let collotyper'_period_'en = _prefixId.prefix "collotyper.en"
    let collotyperOf'_period_'en = _prefixId.prefix "collotyperOf.en"
    let colourContent'_period_'en = _prefixId.prefix "colourContent.en"
    let colourist'_period_'en = _prefixId.prefix "colourist.en"
    let colouristOf'_period_'en = _prefixId.prefix "colouristOf.en"
    ...
    let commentaryIn'_period_'en = _prefixId.prefix "commentaryIn.en"
    let commentaryOn'_period_'en = _prefixId.prefix "commentaryOn.en"
    let commentator'_period_'en = _prefixId.prefix "commentator.en"
    let commentatorOf'_period_'en = _prefixId.prefix "commentatorOf.en"
    let commissioningBody'_period_'en = _prefixId.prefix "commissioningBody.en"
    let commissioningBodyOf'_period_'en = _prefixId.prefix "commissioningBodyOf.en"
    let compiler'_period_'en = _prefixId.prefix "compiler.en"
    let compilerOf'_period_'en = _prefixId.prefix "compilerOf.en"
    let complementedBy'_period_'en = _prefixId.prefix "complementedBy.en"
    let componentOfAMerger'_period_'en = _prefixId.prefix "componentOfAMerger.en"
    let composer'_period_'en = _prefixId.prefix "composer.en"
    let composerOf'_period_'en = _prefixId.prefix "composerOf.en"
    let concordance'_period_'en = _prefixId.prefix "concordance.en"
    let concordanceTo'_period_'en = _prefixId.prefix "concordanceTo.en"
    let conductor'_period_'en = _prefixId.prefix "conductor.en"
    let conductorOf'_period_'en = _prefixId.prefix "conductorOf.en"
    ...
    let consultantOf'_period_'en = _prefixId.prefix "consultantOf.en"
    let contactInformation'_period_'en = _prefixId.prefix "contactInformation.en"
    let containedIn'_period_'en = _prefixId.prefix "containedIn.en"
    let containerOf'_period_'en = _prefixId.prefix "containerOf.en"
    let contentType'_period_'en = _prefixId.prefix "contentType.en"
    let continuationInPartOf'_period_'en = _prefixId.prefix "continuationInPartOf.en"
    let continuationOf'_period_'en = _prefixId.prefix "continuationOf.en"
    let continuedBy'_period_'en = _prefixId.prefix "continuedBy.en"
    let continuedInPartBy'_period_'en = _prefixId.prefix "continuedInPartBy.en"
    let contributor'_period_'en = _prefixId.prefix "contributor.en"
    let contributorOf'_period_'en = _prefixId.prefix "contributorOf.en"
    ...
    let costumeDesigner'_period_'en = _prefixId.prefix "costumeDesigner.en"
    let costumeDesignerOf'_period_'en = _prefixId.prefix "costumeDesignerOf.en"

    let countryAssociatedWithThePerson'_period_'en = _prefixId.prefix "countryAssociatedWithThePerson.en"

    let courtGoverned'_period_'en = _prefixId.prefix "courtGoverned.en"
    let courtGovernedOf'_period_'en = _prefixId.prefix "courtGovernedOf.en"
    let courtReporter'_period_'en = _prefixId.prefix "courtReporter.en"
    let courtReporterOf'_period_'en = _prefixId.prefix "courtReporterOf.en"
    ...
    let creatorOf'_period_'en = _prefixId.prefix "creatorOf.en"
    let critiqueOf'_period_'en = _prefixId.prefix "critiqueOf.en"
    let critiquedIn'_period_'en = _prefixId.prefix "critiquedIn.en"
    let curator'_period_'en = _prefixId.prefix "curator.en"
    let curatorOf'_period_'en = _prefixId.prefix "curatorOf.en"
    let currentOwner'_period_'en = _prefixId.prefix "currentOwner.en"
    let currentOwnerOf'_period_'en = _prefixId.prefix "currentOwnerOf.en"

    let custodialHistoryOfResource'_period_'en = _prefixId.prefix "custodialHistoryOfResource.en"

    let custodian'_period_'en = _prefixId.prefix "custodian.en"
    let custodianOf'_period_'en = _prefixId.prefix "custodianOf.en"
    let dancer'_period_'en = _prefixId.prefix "dancer.en"
    let dancerOf'_period_'en = _prefixId.prefix "dancerOf.en"

    let dateAssociatedWithTheAgent'_period_'en = _prefixId.prefix "dateAssociatedWithTheAgent.en"

    let dateOfBirth'_period_'en = _prefixId.prefix "dateOfBirth.en"
    let dateOfCapture'_period_'en = _prefixId.prefix "dateOfCapture.en"
    let dateOfConferenceEtc'_period_'en = _prefixId.prefix "dateOfConferenceEtc.en"
    let dateOfDeath'_period_'en = _prefixId.prefix "dateOfDeath.en"
    let dateOfDistribution'_period_'en = _prefixId.prefix "dateOfDistribution.en"
    let dateOfEstablishment'_period_'en = _prefixId.prefix "dateOfEstablishment.en"
    ...
    let dateOfResource'_period_'en = _prefixId.prefix "dateOfResource.en"
    let dateOfTermination'_period_'en = _prefixId.prefix "dateOfTermination.en"
    let dateOfUsage'_period_'en = _prefixId.prefix "dateOfUsage.en"
    let dedicatee'_period_'en = _prefixId.prefix "dedicatee.en"
    let dedicateeOf'_period_'en = _prefixId.prefix "dedicateeOf.en"
    let dedicator'_period_'en = _prefixId.prefix "dedicator.en"
    let dedicatorOf'_period_'en = _prefixId.prefix "dedicatorOf.en"
    let defendant'_period_'en = _prefixId.prefix "defendant.en"
    let defendantOf'_period_'en = _prefixId.prefix "defendantOf.en"
    let degreeCommitteeMember'_period_'en = _prefixId.prefix "degreeCommitteeMember.en"

    let degreeCommitteeMemberOf'_period_'en = _prefixId.prefix "degreeCommitteeMemberOf.en"

    let degreeGrantingInstitution'_period_'en = _prefixId.prefix "degreeGrantingInstitution.en"

    let degreeGrantingInstitutionOf'_period_'en = _prefixId.prefix "degreeGrantingInstitutionOf.en"

    let degreeSupervisor'_period_'en = _prefixId.prefix "degreeSupervisor.en"
    let degreeSupervisorOf'_period_'en = _prefixId.prefix "degreeSupervisorOf.en"
    let depositor'_period_'en = _prefixId.prefix "depositor.en"
    let depositorOf'_period_'en = _prefixId.prefix "depositorOf.en"
    let derivative'_period_'en = _prefixId.prefix "derivative.en"

    let derivativeResourceRelationshipWith'_period_'en = _prefixId.prefix "derivativeResourceRelationshipWith.en"

    let describedIn'_period_'en = _prefixId.prefix "describedIn.en"
    let descriptionOf'_period_'en = _prefixId.prefix "descriptionOf.en"
    ...
    let designerOf'_period_'en = _prefixId.prefix "designerOf.en"

    let detailsOfAppliedMaterial'_period_'en = _prefixId.prefix "detailsOfAppliedMaterial.en"

    let detailsOfAspectRatio'_period_'en = _prefixId.prefix "detailsOfAspectRatio.en"
    ...
    let detailsOfColourContent'_period_'en = _prefixId.prefix "detailsOfColourContent.en"
    ...
    let detailsOfDuration'_period_'en = _prefixId.prefix "detailsOfDuration.en"
    ...
    let detailsOfFormOfMusicalNotation'_period_'en = _prefixId.prefix "detailsOfFormOfMusicalNotation.en"

    let detailsOfFormOfNotatedMovement'_period_'en = _prefixId.prefix "detailsOfFormOfNotatedMovement.en"

    let detailsOfFormOfTactileNotation'_period_'en = _prefixId.prefix "detailsOfFormOfTactileNotation.en"

    let detailsOfFormatOfNotatedMusic'_period_'en = _prefixId.prefix "detailsOfFormatOfNotatedMusic.en"
    ...
    let detailsOfIllustrativeContent'_period_'en = _prefixId.prefix "detailsOfIllustrativeContent.en"
    ...
    let detailsOfScript'_period_'en = _prefixId.prefix "detailsOfScript.en"
    ...
    let digestOf'_period_'en = _prefixId.prefix "digestOf.en"
    let digestedAs'_period_'en = _prefixId.prefix "digestedAs.en"
    ...
    let digitalTransfer'_period_'en = _prefixId.prefix "digitalTransfer.en"
    let digitalTransferOf'_period_'en = _prefixId.prefix "digitalTransferOf.en"
    ...
    let directorOf'_period_'en = _prefixId.prefix "directorOf.en"
    let directorOfPhotography'_period_'en = _prefixId.prefix "directorOfPhotography.en"

    let directorOfPhotographyOf'_period_'en = _prefixId.prefix "directorOfPhotographyOf.en"
    ...
    let distributorOf'_period_'en = _prefixId.prefix "distributorOf.en"
    let distributorsName'_period_'en = _prefixId.prefix "distributorsName.en"
    let donor'_period_'en = _prefixId.prefix "donor.en"
    let donorOf'_period_'en = _prefixId.prefix "donorOf.en"
    let draftsman'_period_'en = _prefixId.prefix "draftsman.en"
    let draftsmanOf'_period_'en = _prefixId.prefix "draftsmanOf.en"
    let dramatizationOf'_period_'en = _prefixId.prefix "dramatizationOf.en"
    let dramatizedAs'_period_'en = _prefixId.prefix "dramatizedAs.en"
    let dubbedVersion'_period_'en = _prefixId.prefix "dubbedVersion.en"
    let dubbedVersionOf'_period_'en = _prefixId.prefix "dubbedVersionOf.en"
    let duration'_period_'en = _prefixId.prefix "duration.en"
    ...
    let editor'_period_'en = _prefixId.prefix "editor.en"
    let editorOf'_period_'en = _prefixId.prefix "editorOf.en"

    let editorOfMovingImageResource'_period_'en = _prefixId.prefix "editorOfMovingImageResource.en"

    let editorOfMovingImageResourceOf'_period_'en = _prefixId.prefix "editorOfMovingImageResourceOf.en"

    let electronicReproduction'_period_'en = _prefixId.prefix "electronicReproduction.en"

    let electronicReproductionOf'_period_'en = _prefixId.prefix "electronicReproductionOf.en"

    let employee'_period_'en = _prefixId.prefix "employee.en"
    let employer'_period_'en = _prefixId.prefix "employer.en"
    ...
    let enactingJurisdictionOf'_period_'en = _prefixId.prefix "enactingJurisdictionOf.en"
    ...
    let engraverOf'_period_'en = _prefixId.prefix "engraverOf.en"
    ...
    let equivalent'_period_'en = _prefixId.prefix "equivalent.en"

    let equivalentResourceRelationshipWith'_period_'en = _prefixId.prefix "equivalentResourceRelationshipWith.en"

    let errata'_period_'en = _prefixId.prefix "errata.en"
    let errataTo'_period_'en = _prefixId.prefix "errataTo.en"
    let etcher'_period_'en = _prefixId.prefix "etcher.en"
    let etcherOf'_period_'en = _prefixId.prefix "etcherOf.en"
    let evaluatedIn'_period_'en = _prefixId.prefix "evaluatedIn.en"
    let evaluationOf'_period_'en = _prefixId.prefix "evaluationOf.en"
    let expandedAs'_period_'en = _prefixId.prefix "expandedAs.en"
    let expandedVersionOf'_period_'en = _prefixId.prefix "expandedVersionOf.en"
    let extent'_period_'en = _prefixId.prefix "extent.en"
    let facsimile'_period_'en = _prefixId.prefix "facsimile.en"
    ...
    let facsimileOf'_period_'en = _prefixId.prefix "facsimileOf.en"
    let fieldOfActivity'_period_'en = _prefixId.prefix "fieldOfActivity.en"
    ...
    let filmDirectorOf'_period_'en = _prefixId.prefix "filmDirectorOf.en"
    let filmDistributor'_period_'en = _prefixId.prefix "filmDistributor.en"
    let filmDistributorOf'_period_'en = _prefixId.prefix "filmDistributorOf.en"
    let filmProducer'_period_'en = _prefixId.prefix "filmProducer.en"
    let filmProducerOf'_period_'en = _prefixId.prefix "filmProducerOf.en"
    let filmedWith'_period_'en = _prefixId.prefix "filmedWith.en"
    let filmmaker'_period_'en = _prefixId.prefix "filmmaker.en"
    let filmmakerOf'_period_'en = _prefixId.prefix "filmmakerOf.en"
    let findingAid'_period_'en = _prefixId.prefix "findingAid.en"
    let findingAidFor'_period_'en = _prefixId.prefix "findingAidFor.en"
    let fontSize'_period_'en = _prefixId.prefix "fontSize.en"
    let formOfMusicalNotation'_period_'en = _prefixId.prefix "formOfMusicalNotation.en"
    let formOfNotatedMovement'_period_'en = _prefixId.prefix "formOfNotatedMovement.en"
    let formOfNotation'_period_'en = _prefixId.prefix "formOfNotation.en"
    let formOfResource'_period_'en = _prefixId.prefix "formOfResource.en"
    let formOfTactileNotation'_period_'en = _prefixId.prefix "formOfTactileNotation.en"
    let formatOfNotatedMusic'_period_'en = _prefixId.prefix "formatOfNotatedMusic.en"
    let formerOwner'_period_'en = _prefixId.prefix "formerOwner.en"
    let formerOwnerOf'_period_'en = _prefixId.prefix "formerOwnerOf.en"
    let foundedEntity'_period_'en = _prefixId.prefix "foundedEntity.en"
    let founder'_period_'en = _prefixId.prefix "founder.en"
    let freeTranslationOf'_period_'en = _prefixId.prefix "freeTranslationOf.en"
    let freelyTranslatedAs'_period_'en = _prefixId.prefix "freelyTranslatedAs.en"
    let frequency'_period_'en = _prefixId.prefix "frequency.en"
    let fullerFormOfName'_period_'en = _prefixId.prefix "fullerFormOfName.en"
    let gender'_period_'en = _prefixId.prefix "gender.en"
    ...
    let graduate'_period_'en = _prefixId.prefix "graduate.en"
    let graduateOf'_period_'en = _prefixId.prefix "graduateOf.en"

    let grantingInstitutionOrFaculty'_period_'en = _prefixId.prefix "grantingInstitutionOrFaculty.en"

    let graphicNovelizationOf'_period_'en = _prefixId.prefix "graphicNovelizationOf.en"
    let grooveCharacteristic'_period_'en = _prefixId.prefix "grooveCharacteristic.en"
    let guide'_period_'en = _prefixId.prefix "guide.en"
    let guideTo'_period_'en = _prefixId.prefix "guideTo.en"
    let hereditaryTitle'_period_'en = _prefixId.prefix "hereditaryTitle.en"

    let hierarchicalSubordinate'_period_'en = _prefixId.prefix "hierarchicalSubordinate.en"

    let hierarchicalSuperior'_period_'en = _prefixId.prefix "hierarchicalSuperior.en"
    let historyOfTheResource'_period_'en = _prefixId.prefix "historyOfTheResource.en"
    let honouree'_period_'en = _prefixId.prefix "honouree.en"
    let honoureeOf'_period_'en = _prefixId.prefix "honoureeOf.en"

    let horizontalScaleOfCartographicContent'_period_'en = _prefixId.prefix "horizontalScaleOfCartographicContent.en"

    let host'_period_'en = _prefixId.prefix "host.en"
    let hostInstitution'_period_'en = _prefixId.prefix "hostInstitution.en"
    let hostInstitutionOf'_period_'en = _prefixId.prefix "hostInstitutionOf.en"
    let hostOf'_period_'en = _prefixId.prefix "hostOf.en"
    let identifierForTheAgent'_period_'en = _prefixId.prefix "identifierForTheAgent.en"

    let identifierForTheResource'_period_'en = _prefixId.prefix "identifierForTheResource.en"

    let illuminator'_period_'en = _prefixId.prefix "illuminator.en"
    let illuminatorOf'_period_'en = _prefixId.prefix "illuminatorOf.en"
    let illustrations'_period_'en = _prefixId.prefix "illustrations.en"
    let illustrationsFor'_period_'en = _prefixId.prefix "illustrationsFor.en"
    let illustrativeContent'_period_'en = _prefixId.prefix "illustrativeContent.en"
    let illustrator'_period_'en = _prefixId.prefix "illustrator.en"
    let illustratorOf'_period_'en = _prefixId.prefix "illustratorOf.en"
    let imitatedAs'_period_'en = _prefixId.prefix "imitatedAs.en"
    let imitationOf'_period_'en = _prefixId.prefix "imitationOf.en"

    let immediateSourceOfAcquisitionOfItem'_period_'en = _prefixId.prefix "immediateSourceOfAcquisitionOfItem.en"

    let inSeries'_period_'en = _prefixId.prefix "inSeries.en"
    let incidentalMusic'_period_'en = _prefixId.prefix "incidentalMusic.en"
    let incidentalMusicFor'_period_'en = _prefixId.prefix "incidentalMusicFor.en"
    let incumbent'_period_'en = _prefixId.prefix "incumbent.en"
    let index'_period_'en = _prefixId.prefix "index.en"
    let indexTo'_period_'en = _prefixId.prefix "indexTo.en"
    let indexedIn'_period_'en = _prefixId.prefix "indexedIn.en"
    let indexingFor'_period_'en = _prefixId.prefix "indexingFor.en"
    let inscriber'_period_'en = _prefixId.prefix "inscriber.en"
    let inscriberOf'_period_'en = _prefixId.prefix "inscriberOf.en"
    ...
    let instrumentalConductor'_period_'en = _prefixId.prefix "instrumentalConductor.en"

    let instrumentalConductorOf'_period_'en = _prefixId.prefix "instrumentalConductorOf.en"

    let instrumentalist'_period_'en = _prefixId.prefix "instrumentalist.en"
    let instrumentalistOf'_period_'en = _prefixId.prefix "instrumentalistOf.en"
    ...
    let intervieweeOf'_period_'en = _prefixId.prefix "intervieweeOf.en"
    let interviewer'_period_'en = _prefixId.prefix "interviewer.en"
    let interviewerOf'_period_'en = _prefixId.prefix "interviewerOf.en"
    let inventor'_period_'en = _prefixId.prefix "inventor.en"
    let inventorOf'_period_'en = _prefixId.prefix "inventorOf.en"
    ...
    let issuingBodyOf'_period_'en = _prefixId.prefix "issuingBodyOf.en"
    let judge'_period_'en = _prefixId.prefix "judge.en"
    let judgeOf'_period_'en = _prefixId.prefix "judgeOf.en"
    let jurisdictionGoverned'_period_'en = _prefixId.prefix "jurisdictionGoverned.en"

    let jurisdictionGovernedOf'_period_'en = _prefixId.prefix "jurisdictionGovernedOf.en"
    ...
    let landscapeArchitectOf'_period_'en = _prefixId.prefix "landscapeArchitectOf.en"
    let languageOfTheAgent'_period_'en = _prefixId.prefix "languageOfTheAgent.en"
    let languageOfTheContent'_period_'en = _prefixId.prefix "languageOfTheContent.en"
    let laterTitleProper'_period_'en = _prefixId.prefix "laterTitleProper.en"
    let layout'_period_'en = _prefixId.prefix "layout.en"
    let letterer'_period_'en = _prefixId.prefix "letterer.en"
    let lettererOf'_period_'en = _prefixId.prefix "lettererOf.en"
    let librettist'_period_'en = _prefixId.prefix "librettist.en"
    let librettistOf'_period_'en = _prefixId.prefix "librettistOf.en"
    let libretto'_period_'en = _prefixId.prefix "libretto.en"
    let librettoBasedOn'_period_'en = _prefixId.prefix "librettoBasedOn.en"
    let librettoFor'_period_'en = _prefixId.prefix "librettoFor.en"
    let lightingDesigner'_period_'en = _prefixId.prefix "lightingDesigner.en"
    let lightingDesignerOf'_period_'en = _prefixId.prefix "lightingDesignerOf.en"
    let lithographer'_period_'en = _prefixId.prefix "lithographer.en"
    let lithographerOf'_period_'en = _prefixId.prefix "lithographerOf.en"
    let localAffiliate'_period_'en = _prefixId.prefix "localAffiliate.en"

    let locationOfConferenceEtc'_period_'en = _prefixId.prefix "locationOfConferenceEtc.en"

    let locationOfHeadquarters'_period_'en = _prefixId.prefix "locationOfHeadquarters.en"
    ...
    let lyricistOf'_period_'en = _prefixId.prefix "lyricistOf.en"
    let makeUpArtist'_period_'en = _prefixId.prefix "makeUpArtist.en"
    let makeUpArtistOf'_period_'en = _prefixId.prefix "makeUpArtistOf.en"
    ...
    let manufacturerOf'_period_'en = _prefixId.prefix "manufacturerOf.en"
    ...
    let mediumOf'_period_'en = _prefixId.prefix "mediumOf.en"
    let mediumOfPerformance'_period_'en = _prefixId.prefix "mediumOfPerformance.en"

    let mediumOfPerformanceOfMusicalContent'_period_'en = _prefixId.prefix "mediumOfPerformanceOfMusicalContent.en"

    let member'_period_'en = _prefixId.prefix "member.en"
    let memberOf'_period_'en = _prefixId.prefix "memberOf.en"
    let mergedToForm'_period_'en = _prefixId.prefix "mergedToForm.en"
    let mergee'_period_'en = _prefixId.prefix "mergee.en"
    let mergerOf'_period_'en = _prefixId.prefix "mergerOf.en"
    let minuteTaker'_period_'en = _prefixId.prefix "minuteTaker.en"
    let minuteTakerOf'_period_'en = _prefixId.prefix "minuteTakerOf.en"
    ...
    let moderator'_period_'en = _prefixId.prefix "moderator.en"
    let moderatorOf'_period_'en = _prefixId.prefix "moderatorOf.en"
    let modifiedByVariationAs'_period_'en = _prefixId.prefix "modifiedByVariationAs.en"

    let motionPictureAdaptationOf'_period_'en = _prefixId.prefix "motionPictureAdaptationOf.en"

    let motionPictureMusic'_period_'en = _prefixId.prefix "motionPictureMusic.en"

    let motionPictureScreenplay'_period_'en = _prefixId.prefix "motionPictureScreenplay.en"

    let motionPictureScreenplayBasedOn'_period_'en = _prefixId.prefix "motionPictureScreenplayBasedOn.en"

    let mount'_period_'en = _prefixId.prefix "mount.en"
    let music'_period_'en = _prefixId.prefix "music.en"
    let musicFor'_period_'en = _prefixId.prefix "musicFor.en"
    let musicForMotionPicture'_period_'en = _prefixId.prefix "musicForMotionPicture.en"
    let musicForRadioProgram'_period_'en = _prefixId.prefix "musicForRadioProgram.en"

    let musicForTelevisionProgram'_period_'en = _prefixId.prefix "musicForTelevisionProgram.en"

    let musicForVideo'_period_'en = _prefixId.prefix "musicForVideo.en"
    let musicalDirector'_period_'en = _prefixId.prefix "musicalDirector.en"
    let musicalDirectorOf'_period_'en = _prefixId.prefix "musicalDirectorOf.en"
    let musicalSettingOf'_period_'en = _prefixId.prefix "musicalSettingOf.en"

    let musicalTheatreAdaptationOf'_period_'en = _prefixId.prefix "musicalTheatreAdaptationOf.en"

    let nameOfTheAgent'_period_'en = _prefixId.prefix "nameOfTheAgent.en"
    let nameOfThePlace'_period_'en = _prefixId.prefix "nameOfThePlace.en"
    let narrator'_period_'en = _prefixId.prefix "narrator.en"
    let narratorOf'_period_'en = _prefixId.prefix "narratorOf.en"
    ...
    let noteOnChangesInContentCharacteristics'_period_'en = _prefixId.prefix "noteOnChangesInContentCharacteristics.en"

    let noteOnCopyrightDate'_period_'en = _prefixId.prefix "noteOnCopyrightDate.en"

    let noteOnDimensionsOfResource'_period_'en = _prefixId.prefix "noteOnDimensionsOfResource.en"
    ...
    let noteOnExtentOfResource'_period_'en = _prefixId.prefix "noteOnExtentOfResource.en"
    ...
    let noteOnResource'_period_'en = _prefixId.prefix "noteOnResource.en"

    let noteOnResourceSpecificCarrierCharacteristic'_period_'en = _prefixId.prefix "noteOnResourceSpecificCarrierCharacteristic.en"
    ...
    let novelizationOf'_period_'en = _prefixId.prefix "novelizationOf.en"

    let numberOfAConferenceEtc'_period_'en = _prefixId.prefix "numberOfAConferenceEtc.en"
    ...
    let numericDesignationOfAMusicalResource'_period_'en = _prefixId.prefix "numericDesignationOfAMusicalResource.en"

    let officiatedAgent'_period_'en = _prefixId.prefix "officiatedAgent.en"
    let onDiscWith'_period_'en = _prefixId.prefix "onDiscWith.en"
    let onScreenParticipant'_period_'en = _prefixId.prefix "onScreenParticipant.en"
    let onScreenParticipantOf'_period_'en = _prefixId.prefix "onScreenParticipantOf.en"
    let onScreenPresenter'_period_'en = _prefixId.prefix "onScreenPresenter.en"
    let onScreenPresenterOf'_period_'en = _prefixId.prefix "onScreenPresenterOf.en"
    let operaAdaptationOf'_period_'en = _prefixId.prefix "operaAdaptationOf.en"
    let oratorioAdaptationOf'_period_'en = _prefixId.prefix "oratorioAdaptationOf.en"
    let organizer'_period_'en = _prefixId.prefix "organizer.en"
    let organizerOf'_period_'en = _prefixId.prefix "organizerOf.en"

    let otherAgentAssociatedWithAResource'_period_'en = _prefixId.prefix "otherAgentAssociatedWithAResource.en"

    let otherAgentAssociatedWithAResourceOf'_period_'en = _prefixId.prefix "otherAgentAssociatedWithAResourceOf.en"

    let otherDesignationAssociatedWithTheAgent'_period_'en = _prefixId.prefix "otherDesignationAssociatedWithTheAgent.en"

    let otherDetailsOfCartographicContent'_period_'en = _prefixId.prefix "otherDetailsOfCartographicContent.en"

    let otherDistinguishingCharacteristicOfTheResource'_period_'en = _prefixId.prefix "otherDistinguishingCharacteristicOfTheResource.en"
    ...
    let owner'_period_'en = _prefixId.prefix "owner.en"
    let ownerOf'_period_'en = _prefixId.prefix "ownerOf.en"
    let panelist'_period_'en = _prefixId.prefix "panelist.en"
    let panelistOf'_period_'en = _prefixId.prefix "panelistOf.en"
    let papermaker'_period_'en = _prefixId.prefix "papermaker.en"
    let papermakerOf'_period_'en = _prefixId.prefix "papermakerOf.en"
    ...
    let paraphraseOf'_period_'en = _prefixId.prefix "paraphraseOf.en"
    let paraphrasedAs'_period_'en = _prefixId.prefix "paraphrasedAs.en"
    let parodiedAs'_period_'en = _prefixId.prefix "parodiedAs.en"
    let parodyOf'_period_'en = _prefixId.prefix "parodyOf.en"
    let participantInATreaty'_period_'en = _prefixId.prefix "participantInATreaty.en"

    let participantInATreatyOf'_period_'en = _prefixId.prefix "participantInATreatyOf.en"

    let performer'_period_'en = _prefixId.prefix "performer.en"
    let performerOf'_period_'en = _prefixId.prefix "performerOf.en"

    let periodOfActivityOfTheAgent'_period_'en = _prefixId.prefix "periodOfActivityOfTheAgent.en"

    let photographer'_period_'en = _prefixId.prefix "photographer.en"
    let photographerOf'_period_'en = _prefixId.prefix "photographerOf.en"
    let placeAndDateOfCapture'_period_'en = _prefixId.prefix "placeAndDateOfCapture.en"

    let placeAssociatedWithTheAgent'_period_'en = _prefixId.prefix "placeAssociatedWithTheAgent.en"

    let placeOfBirth'_period_'en = _prefixId.prefix "placeOfBirth.en"
    let placeOfCapture'_period_'en = _prefixId.prefix "placeOfCapture.en"
    let placeOfDeath'_period_'en = _prefixId.prefix "placeOfDeath.en"
    ...
    let placeOfOriginOfTheResource'_period_'en = _prefixId.prefix "placeOfOriginOfTheResource.en"
    ...
    let placeOfResidenceEtc'_period_'en = _prefixId.prefix "placeOfResidenceEtc.en"
    let plaintiff'_period_'en = _prefixId.prefix "plaintiff.en"
    let plaintiffOf'_period_'en = _prefixId.prefix "plaintiffOf.en"
    ...
    let platemakerOf'_period_'en = _prefixId.prefix "platemakerOf.en"
    ...
    let praesesOf'_period_'en = _prefixId.prefix "praesesOf.en"
    let precededBy'_period_'en = _prefixId.prefix "precededBy.en"
    let predecessor'_period_'en = _prefixId.prefix "predecessor.en"
    let predecessorOfSplit'_period_'en = _prefixId.prefix "predecessorOfSplit.en"
    let preferredCitation'_period_'en = _prefixId.prefix "preferredCitation.en"

    let preferredNameForTheAgent'_period_'en = _prefixId.prefix "preferredNameForTheAgent.en"

    let preferredNameForThePlace'_period_'en = _prefixId.prefix "preferredNameForThePlace.en"

    let preferredTitleForTheResource'_period_'en = _prefixId.prefix "preferredTitleForTheResource.en"
    ...
    let presenter'_period_'en = _prefixId.prefix "presenter.en"
    let presenterOf'_period_'en = _prefixId.prefix "presenterOf.en"
    let preservationFacsimile'_period_'en = _prefixId.prefix "preservationFacsimile.en"

    let preservationFacsimileOf'_period_'en = _prefixId.prefix "preservationFacsimileOf.en"

    let printer'_period_'en = _prefixId.prefix "printer.en"
    let printerOf'_period_'en = _prefixId.prefix "printerOf.en"
    let printmaker'_period_'en = _prefixId.prefix "printmaker.en"
    let printmakerOf'_period_'en = _prefixId.prefix "printmakerOf.en"
    let producer'_period_'en = _prefixId.prefix "producer.en"
    let producerOf'_period_'en = _prefixId.prefix "producerOf.en"

    let producerOfAnUnpublishedResource'_period_'en = _prefixId.prefix "producerOfAnUnpublishedResource.en"

    let producerOfAnUnpublishedResourceOf'_period_'en = _prefixId.prefix "producerOfAnUnpublishedResourceOf.en"

    let producersName'_period_'en = _prefixId.prefix "producersName.en"
    let productOfAMerger'_period_'en = _prefixId.prefix "productOfAMerger.en"
    let productOfASplit'_period_'en = _prefixId.prefix "productOfASplit.en"
    let productionCompany'_period_'en = _prefixId.prefix "productionCompany.en"
    let productionCompanyOf'_period_'en = _prefixId.prefix "productionCompanyOf.en"
    let productionDesigner'_period_'en = _prefixId.prefix "productionDesigner.en"
    let productionDesignerOf'_period_'en = _prefixId.prefix "productionDesignerOf.en"
    ...
    let professionOrOccupation'_period_'en = _prefixId.prefix "professionOrOccupation.en"

    let programmer'_period_'en = _prefixId.prefix "programmer.en"
    let programmerOf'_period_'en = _prefixId.prefix "programmerOf.en"
    ...
    let projectionOfCartographicContent'_period_'en = _prefixId.prefix "projectionOfCartographicContent.en"

    let projectionSpeed'_period_'en = _prefixId.prefix "projectionSpeed.en"

    let prominentMemberOfTheFamily'_period_'en = _prefixId.prefix "prominentMemberOfTheFamily.en"
    ...
    let publisherOf'_period_'en = _prefixId.prefix "publisherOf.en"
    ...
    let puppeteer'_period_'en = _prefixId.prefix "puppeteer.en"
    let puppeteerOf'_period_'en = _prefixId.prefix "puppeteerOf.en"
    let radioAdaptationOf'_period_'en = _prefixId.prefix "radioAdaptationOf.en"
    let radioDirector'_period_'en = _prefixId.prefix "radioDirector.en"
    let radioDirectorOf'_period_'en = _prefixId.prefix "radioDirectorOf.en"
    let radioProducer'_period_'en = _prefixId.prefix "radioProducer.en"
    let radioProducerOf'_period_'en = _prefixId.prefix "radioProducerOf.en"
    let radioProgramMusic'_period_'en = _prefixId.prefix "radioProgramMusic.en"
    let radioScript'_period_'en = _prefixId.prefix "radioScript.en"
    let radioScriptBasedOn'_period_'en = _prefixId.prefix "radioScriptBasedOn.en"
    let rapporteur'_period_'en = _prefixId.prefix "rapporteur.en"
    let rapporteurOf'_period_'en = _prefixId.prefix "rapporteurOf.en"
    let realIdentity'_period_'en = _prefixId.prefix "realIdentity.en"
    let recordingEngineer'_period_'en = _prefixId.prefix "recordingEngineer.en"
    let recordingEngineerOf'_period_'en = _prefixId.prefix "recordingEngineerOf.en"
    let recordingMedium'_period_'en = _prefixId.prefix "recordingMedium.en"
    let recordist'_period_'en = _prefixId.prefix "recordist.en"
    let recordistOf'_period_'en = _prefixId.prefix "recordistOf.en"
    let reductionRatio'_period_'en = _prefixId.prefix "reductionRatio.en"

    let referentialResourceRelationship'_period_'en = _prefixId.prefix "referentialResourceRelationship.en"

    let regionalEncoding'_period_'en = _prefixId.prefix "regionalEncoding.en"
    let relatedAgent'_period_'en = _prefixId.prefix "relatedAgent.en"
    let relatedResource'_period_'en = _prefixId.prefix "relatedResource.en"
    let remadeAs'_period_'en = _prefixId.prefix "remadeAs.en"
    let remakeOf'_period_'en = _prefixId.prefix "remakeOf.en"
    let replacedBy'_period_'en = _prefixId.prefix "replacedBy.en"
    let replacedInPartBy'_period_'en = _prefixId.prefix "replacedInPartBy.en"
    let replacementInPartOf'_period_'en = _prefixId.prefix "replacementInPartOf.en"
    let replacementOf'_period_'en = _prefixId.prefix "replacementOf.en"
    let reprintOf'_period_'en = _prefixId.prefix "reprintOf.en"
    let reprintedAs'_period_'en = _prefixId.prefix "reprintedAs.en"
    let reproducedAs'_period_'en = _prefixId.prefix "reproducedAs.en"
    let reproductionOf'_period_'en = _prefixId.prefix "reproductionOf.en"
    let researchOf'_period_'en = _prefixId.prefix "researchOf.en"
    ...
    let respondentOf'_period_'en = _prefixId.prefix "respondentOf.en"
    let restorationist'_period_'en = _prefixId.prefix "restorationist.en"
    let restorationistOf'_period_'en = _prefixId.prefix "restorationistOf.en"
    let restrictionsOnAccess'_period_'en = _prefixId.prefix "restrictionsOnAccess.en"
    let restrictionsOnUse'_period_'en = _prefixId.prefix "restrictionsOnUse.en"
    let reviewOf'_period_'en = _prefixId.prefix "reviewOf.en"
    let reviewedIn'_period_'en = _prefixId.prefix "reviewedIn.en"
    let revisedAs'_period_'en = _prefixId.prefix "revisedAs.en"
    let revisionOf'_period_'en = _prefixId.prefix "revisionOf.en"

    let rightAscensionAndDeclination'_period_'en = _prefixId.prefix "rightAscensionAndDeclination.en"

    let scale'_period_'en = _prefixId.prefix "scale.en"

    let scaleOfStillImageOrThreeDimensionalForm'_period_'en = _prefixId.prefix "scaleOfStillImageOrThreeDimensionalForm.en"

    let scopeOfUsage'_period_'en = _prefixId.prefix "scopeOfUsage.en"
    let screenplay'_period_'en = _prefixId.prefix "screenplay.en"
    let screenplayBasedOn'_period_'en = _prefixId.prefix "screenplayBasedOn.en"
    let screenplayFor'_period_'en = _prefixId.prefix "screenplayFor.en"

    let screenplayForTheMotionPicture'_period_'en = _prefixId.prefix "screenplayForTheMotionPicture.en"

    let screenplayForTheTelevisionProgram'_period_'en = _prefixId.prefix "screenplayForTheTelevisionProgram.en"

    let screenplayForTheVideo'_period_'en = _prefixId.prefix "screenplayForTheVideo.en"
    let screenwriter'_period_'en = _prefixId.prefix "screenwriter.en"
    let screenwriterOf'_period_'en = _prefixId.prefix "screenwriterOf.en"
    let script'_period_'en = _prefixId.prefix "script.en"

    let scriptForTheRadioProgram'_period_'en = _prefixId.prefix "scriptForTheRadioProgram.en"

    let sculptor'_period_'en = _prefixId.prefix "sculptor.en"
    let sculptorOf'_period_'en = _prefixId.prefix "sculptorOf.en"
    let seller'_period_'en = _prefixId.prefix "seller.en"
    let sellerOf'_period_'en = _prefixId.prefix "sellerOf.en"
    let separatedFrom'_period_'en = _prefixId.prefix "separatedFrom.en"
    let sequel'_period_'en = _prefixId.prefix "sequel.en"
    let sequelTo'_period_'en = _prefixId.prefix "sequelTo.en"

    let sequentialResourceRelationshipWith'_period_'en = _prefixId.prefix "sequentialResourceRelationshipWith.en"
    ...
    let setToMusicAs'_period_'en = _prefixId.prefix "setToMusicAs.en"
    let singer'_period_'en = _prefixId.prefix "singer.en"
    let singerOf'_period_'en = _prefixId.prefix "singerOf.en"
    let softwareDeveloper'_period_'en = _prefixId.prefix "softwareDeveloper.en"
    let softwareDeveloperOf'_period_'en = _prefixId.prefix "softwareDeveloperOf.en"
    let soundCharacteristic'_period_'en = _prefixId.prefix "soundCharacteristic.en"
    let soundContent'_period_'en = _prefixId.prefix "soundContent.en"
    let soundDesigner'_period_'en = _prefixId.prefix "soundDesigner.en"
    let soundDesignerOf'_period_'en = _prefixId.prefix "soundDesignerOf.en"
    let speaker'_period_'en = _prefixId.prefix "speaker.en"
    let speakerOf'_period_'en = _prefixId.prefix "speakerOf.en"

    let specialEffectsProvider'_period_'en = _prefixId.prefix "specialEffectsProvider.en"

    let specialEffectsProviderOf'_period_'en = _prefixId.prefix "specialEffectsProviderOf.en"
    ...
    let splitInto'_period_'en = _prefixId.prefix "splitInto.en"
    let sponsor'_period_'en = _prefixId.prefix "sponsor.en"
    let sponsoredEntity'_period_'en = _prefixId.prefix "sponsoredEntity.en"
    let sponsoringBody'_period_'en = _prefixId.prefix "sponsoringBody.en"
    let sponsoringBodyOf'_period_'en = _prefixId.prefix "sponsoringBodyOf.en"
    let stageDirector'_period_'en = _prefixId.prefix "stageDirector.en"
    let stageDirectorOf'_period_'en = _prefixId.prefix "stageDirectorOf.en"
    ...
    let storyteller'_period_'en = _prefixId.prefix "storyteller.en"
    let storytellerOf'_period_'en = _prefixId.prefix "storytellerOf.en"

    let stringsOfCoordinatePairs'_period_'en = _prefixId.prefix "stringsOfCoordinatePairs.en"

    let subject'_period_'en = _prefixId.prefix "subject.en"
    let subjectOf'_period_'en = _prefixId.prefix "subjectOf.en"
    let subseries'_period_'en = _prefixId.prefix "subseries.en"
    let subseriesOf'_period_'en = _prefixId.prefix "subseriesOf.en"
    let succeededBy'_period_'en = _prefixId.prefix "succeededBy.en"
    let successor'_period_'en = _prefixId.prefix "successor.en"

    let summarizationOfTheContent'_period_'en = _prefixId.prefix "summarizationOfTheContent.en"

    let summarizedAs'_period_'en = _prefixId.prefix "summarizedAs.en"
    let summaryOf'_period_'en = _prefixId.prefix "summaryOf.en"
    let supplement'_period_'en = _prefixId.prefix "supplement.en"
    let supplementTo'_period_'en = _prefixId.prefix "supplementTo.en"
    let supplementaryContent'_period_'en = _prefixId.prefix "supplementaryContent.en"
    let surveyor'_period_'en = _prefixId.prefix "surveyor.en"
    let surveyorOf'_period_'en = _prefixId.prefix "surveyorOf.en"
    ...
    let teacher'_period_'en = _prefixId.prefix "teacher.en"
    let teacherOf'_period_'en = _prefixId.prefix "teacherOf.en"

    let televisionAdaptationOf'_period_'en = _prefixId.prefix "televisionAdaptationOf.en"

    let televisionDirector'_period_'en = _prefixId.prefix "televisionDirector.en"
    let televisionDirectorOf'_period_'en = _prefixId.prefix "televisionDirectorOf.en"
    let televisionProducer'_period_'en = _prefixId.prefix "televisionProducer.en"
    let televisionProducerOf'_period_'en = _prefixId.prefix "televisionProducerOf.en"

    let televisionProgramMusic'_period_'en = _prefixId.prefix "televisionProgramMusic.en"

    let televisionScreenplay'_period_'en = _prefixId.prefix "televisionScreenplay.en"

    let televisionScreenplayBasedOn'_period_'en = _prefixId.prefix "televisionScreenplayBasedOn.en"
    ...
    let titleOfTheAgent'_period_'en = _prefixId.prefix "titleOfTheAgent.en"
    let titleOfTheResource'_period_'en = _prefixId.prefix "titleOfTheResource.en"
    ...
    let transcriber'_period_'en = _prefixId.prefix "transcriber.en"
    let transcriberOf'_period_'en = _prefixId.prefix "transcriberOf.en"
    let translatedAs'_period_'en = _prefixId.prefix "translatedAs.en"
    let translationOf'_period_'en = _prefixId.prefix "translationOf.en"
    let translator'_period_'en = _prefixId.prefix "translator.en"
    let translatorOf'_period_'en = _prefixId.prefix "translatorOf.en"
    let typeOfAgent'_period_'en = _prefixId.prefix "typeOfAgent.en"
    let typeOfRecording'_period_'en = _prefixId.prefix "typeOfRecording.en"

    let undifferentiatedNameIndicator'_period_'en = _prefixId.prefix "undifferentiatedNameIndicator.en"

    let uniformResourceLocator'_period_'en = _prefixId.prefix "uniformResourceLocator.en"

    let variantNameForTheAgent'_period_'en = _prefixId.prefix "variantNameForTheAgent.en"

    let variantTitle'_period_'en = _prefixId.prefix "variantTitle.en"
    let variationsBasedOn'_period_'en = _prefixId.prefix "variationsBasedOn.en"
    let verseAdaptationOf'_period_'en = _prefixId.prefix "verseAdaptationOf.en"

    let verticalScaleOfCartographicContent'_period_'en = _prefixId.prefix "verticalScaleOfCartographicContent.en"

    let videoAdaptationOf'_period_'en = _prefixId.prefix "videoAdaptationOf.en"
    ...
    let videoGameAdaptationOf'_period_'en = _prefixId.prefix "videoGameAdaptationOf.en"
    let videoMusic'_period_'en = _prefixId.prefix "videoMusic.en"
    let videoScreenplay'_period_'en = _prefixId.prefix "videoScreenplay.en"

    let videoScreenplayBasedOn'_period_'en = _prefixId.prefix "videoScreenplayBasedOn.en"

    let visualEffectsProvider'_period_'en = _prefixId.prefix "visualEffectsProvider.en"

    let visualEffectsProviderOf'_period_'en = _prefixId.prefix "visualEffectsProviderOf.en"

    let voiceActor'_period_'en = _prefixId.prefix "voiceActor.en"
    let voiceActorOf'_period_'en = _prefixId.prefix "voiceActorOf.en"

    let wholePartResourceRelationshipWith'_period_'en = _prefixId.prefix "wholePartResourceRelationshipWith.en"

    let writerOfAddedCommentary'_period_'en = _prefixId.prefix "writerOfAddedCommentary.en"

    let writerOfAddedCommentaryOf'_period_'en = _prefixId.prefix "writerOfAddedCommentaryOf.en"

    let writerOfAddedLyrics'_period_'en = _prefixId.prefix "writerOfAddedLyrics.en"
    let writerOfAddedLyricsOf'_period_'en = _prefixId.prefix "writerOfAddedLyricsOf.en"
    let writerOfAddedText'_period_'en = _prefixId.prefix "writerOfAddedText.en"
    let writerOfAddedTextOf'_period_'en = _prefixId.prefix "writerOfAddedTextOf.en"
    let writerOfAfterword'_period_'en = _prefixId.prefix "writerOfAfterword.en"
    let writerOfAfterwordOf'_period_'en = _prefixId.prefix "writerOfAfterwordOf.en"
    let writerOfForeword'_period_'en = _prefixId.prefix "writerOfForeword.en"
    let writerOfForewordOf'_period_'en = _prefixId.prefix "writerOfForewordOf.en"
    let writerOfIntroduction'_period_'en = _prefixId.prefix "writerOfIntroduction.en"

    let writerOfIntroductionOf'_period_'en = _prefixId.prefix "writerOfIntroductionOf.en"

    let writerOfPostface'_period_'en = _prefixId.prefix "writerOfPostface.en"
    let writerOfPostfaceOf'_period_'en = _prefixId.prefix "writerOfPostfaceOf.en"
    let writerOfPreface'_period_'en = _prefixId.prefix "writerOfPreface.en"
    let writerOfPrefaceOf'_period_'en = _prefixId.prefix "writerOfPrefaceOf.en"

    let writerOfSupplementaryTextualContent'_period_'en = _prefixId.prefix "writerOfSupplementaryTextualContent.en"

    let writerOfSupplementaryTextualContentOf'_period_'en = _prefixId.prefix "writerOfSupplementaryTextualContentOf.en"
