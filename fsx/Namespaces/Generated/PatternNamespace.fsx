...
module pattern =
    let _prefixId = PrefixId.fromNamespaceLabel "http://www.essepuntato.it/2008/12/pattern#" "pattern"
    ...
    /// </summary>
    let canContainHeteronymousElements = _prefixId.prefix "canContainHeteronymousElements"
