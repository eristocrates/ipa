...
module chameo =
    let _prefixId = PrefixId.fromNamespaceLabel "https://w3id.org/emmo/domain/characterisation-methodology/chameo#" "chameo"
    ...
    /// </summary>
    let AdsorptiveStrippingVoltammetry = _prefixId.prefix "AdsorptiveStrippingVoltammetry"
    ...
    /// </summary>
    let CharacterisationDataValidation = _prefixId.prefix "CharacterisationDataValidation"
    ...
    /// </summary>
    let CharacterisationEnvironmentProperty = _prefixId.prefix "CharacterisationEnvironmentProperty"
    ...
    /// </summary>
    let CharacterisationHardwareManufacturer = _prefixId.prefix "CharacterisationHardwareManufacturer"
    ...
    /// </summary>
    let CharacterisationHardwareSpecification = _prefixId.prefix "CharacterisationHardwareSpecification"
    ...
    /// </summary>
    let CharacterisationMeasurementProcess = _prefixId.prefix "CharacterisationMeasurementProcess"
    ...
    /// </summary>
    let CharacterisationMeasurementTask = _prefixId.prefix "CharacterisationMeasurementTask"
    ...
    /// </summary>
    let CharacterisationProcedureValidation = _prefixId.prefix "CharacterisationProcedureValidation"
    ...
    /// </summary>
    let CriticalAndSupercriticalChromatography = _prefixId.prefix "CriticalAndSupercriticalChromatography"
    ...
    /// </summary>
    let DataProcessingThroughCalibration = _prefixId.prefix "DataProcessingThroughCalibration"
    ...
    /// </summary>
    let DielectricAndImpedanceSpectroscopy = _prefixId.prefix "DielectricAndImpedanceSpectroscopy"
    ...
    /// </summary>
    let DifferentialLinearPulseVoltammetry = _prefixId.prefix "DifferentialLinearPulseVoltammetry"
    ...
    /// </summary>
    let DifferentialScanningCalorimetry = _prefixId.prefix "DifferentialScanningCalorimetry"
    ...
    /// </summary>
    let DifferentialStaircasePulseVoltammetry = _prefixId.prefix "DifferentialStaircasePulseVoltammetry"
    ...
    /// </summary>
    let DirectCoulometryAtControlledCurrent = _prefixId.prefix "DirectCoulometryAtControlledCurrent"
    ...
    /// </summary>
    let DirectCoulometryAtControlledPotential = _prefixId.prefix "DirectCoulometryAtControlledPotential"
    ...
    /// </summary>
    let ElectrochemicalImpedanceSpectroscopy = _prefixId.prefix "ElectrochemicalImpedanceSpectroscopy"
    ...
    /// </summary>
    let ElectrochemicalPiezoelectricMicrogravimetry = _prefixId.prefix "ElectrochemicalPiezoelectricMicrogravimetry"
    ...
    /// </summary>
    let ElectronBackscatterDiffraction = _prefixId.prefix "ElectronBackscatterDiffraction"
    ...
    /// </summary>
    let EnvironmentalScanningElectronMicroscopy = _prefixId.prefix "EnvironmentalScanningElectronMicroscopy"
    ...
    /// </summary>
    let FieldEmissionScanningElectronMicroscopy = _prefixId.prefix "FieldEmissionScanningElectronMicroscopy"
    ...
    /// </summary>
    let FreezingPointDepressionOsmometry = _prefixId.prefix "FreezingPointDepressionOsmometry"
    ...
    /// </summary>
    let PotentiometricStrippingAnalysis = _prefixId.prefix "PotentiometricStrippingAnalysis"
    ...
    /// </summary>
    let ScanningAugerElectronMicroscopy = _prefixId.prefix "ScanningAugerElectronMicroscopy"
    ...
    /// </summary>
    let TransmissionElectronMicroscopy = _prefixId.prefix "TransmissionElectronMicroscopy"
    ...
    /// </summary>
    let VaporPressureDepressionOsmometry = _prefixId.prefix "VaporPressureDepressionOsmometry"
    ...
    /// </summary>
    let VoltammetryAtARotatingDiskElectrode = _prefixId.prefix "VoltammetryAtARotatingDiskElectrode"
    ...
    /// </summary>
    let characterisationProcedureHasSubProcedure = _prefixId.prefix "characterisationProcedureHasSubProcedure"
    ...
    /// </summary>
    let hasCharacterisationEnvironment = _prefixId.prefix "hasCharacterisationEnvironment"
    ...
    /// </summary>
    let hasCharacterisationEnvironmentProperty = _prefixId.prefix "hasCharacterisationEnvironmentProperty"
    ...
    /// </summary>
    let hasCharacterisationProcedureValidation = _prefixId.prefix "hasCharacterisationProcedureValidation"
    ...
    /// </summary>
    let hasDataProcessingThroughCalibration = _prefixId.prefix "hasDataProcessingThroughCalibration"
    ...
    /// </summary>
    let hasSampleBeforeSamplePreparation = _prefixId.prefix "hasSampleBeforeSamplePreparation"
