...
module pay =
    let _prefixId = PrefixId.fromNamespaceLabel "http://reference.data.gov.uk/def/payment#" "pay"
    ...
    let payments_with_expenditure_structure = _prefixId.prefix "payments-with-expenditure-structure"
