...
module frapo =
    ...
    /// <summary>
    ///   <para>dc11:description : May also be described as a data archive, or as a database.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : May also be described as a document archive, or a digital library.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : For the documents supporting a funding application, use fabio:GrantApplicationDocument and fabio:CaseForSupportDocument.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : owl:equivalentClass cerif:InfrastructureEntity .</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Equivalent class in ISA-RDF: 'Investigation'.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Ontology terms and definitions for most publishable project outputs are given as 'Expression' classes in FaBiO, the FRBR-aligned Bibliographic Ontology, e.g. fabio:JournalArticle, fabio:DataSet.  For 'deliverables', use frapo:Deliverable.  For material outputs, use frapo:MaterialOutput.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : May also be described as an archive, or as a database.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Range constraints have been removed from this object property to permit it to be used in unforeseen ways.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : This property should not be used for the other meaning of 'employ', meaning to use something, e.g. 'He employed great skill . . .'/</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Domain and range constraints have been removed from this object property to permit it to be used in unforeseen ways.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : owl:equivalentProperty fabio:hasApplicationDeadline .</para>
    ...
    /// <summary>
    ///   <para>dc11:description : This same data property appears in FaBiO, the FRBR-aligned Bibliographic Ontology (http://purl.org/spar/fabio/).</para>
    ...
    /// <summary>
    ///   <para>dc11:description : owl:equivalentProperty &lt;http://purl.org/spar/scoro/hasORCID&gt; .</para>
    ...
    /// <summary>
    ///   <para>dc11:description : owl:equivalentProperty &lt;http://purl.org/spar/datacite/hasPersonalIdentifier&gt; .^^xsd:stringdc11:description : owl:equivalentProperty &lt;http://purl.org/spar/scoro/hasPersonalIdentifier&gt; .</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Domain constraints have been removed from this object property to permit it to be used in unforeseen ways.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : This property should not be used for the other meaning of 'employ', meaning to use something, e.g. 'Great skill is employed by master craftsmen . . .'/</para>
    ...
    /// <summary>
    ///   <para>dc11:description : This property is not intended for use to describe mechanical or physical support, as in 'The statue is supported by the plinth'. </para>
    ...
    let ``owl:sameAs`` = _prefixId.prefix "owl:sameAs"
    /// <summary>
    ...
    /// </summary>
    let providesFractionOfTotalFunding = _prefixId.prefix "providesFractionOfTotalFunding"
    ...
    /// <summary>
    ///   <para>dc11:description : Domain and range constraints on this object property have been relaxed to permit it to be used in unforeseen ways.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Domain constraints on this object property have been relaxed to permit it to be used in unforeseen ways.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : This property is not intended for use to describe mechanical or physical support, as in 'The plinth supports the statue'. </para>
