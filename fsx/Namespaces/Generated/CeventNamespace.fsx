...
module cevent =
    let _prefixId = PrefixId.fromNamespaceLabel "https://w3id.org/arco/ontology/cultural-event/" "cevent"
    ...
    /// </summary>
    let hasAgentRelatedToCulturalEvent = _prefixId.prefix "hasAgentRelatedToCulturalEvent"
    ...
    /// </summary>
    let isAgentRelatedToCulturalEventOf = _prefixId.prefix "isAgentRelatedToCulturalEventOf"
