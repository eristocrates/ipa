...
module mvco =
    let _prefixId = PrefixId.fromNamespaceLabel "http://purl.oclc.org/NET/mvco.owl#" "mvco"
    ...
    /// </summary>
    let MakeAdaptationManifestationCopy = _prefixId.prefix "MakeAdaptationManifestationCopy"
