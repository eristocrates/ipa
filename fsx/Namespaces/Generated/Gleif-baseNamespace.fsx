...
module ``gleif-base`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.gleif.org/ontology/Base/" "gleif-base"
    ...
    let EntityExpirationReasonCorporateAction = _prefixId.prefix "EntityExpirationReasonCorporateAction"

    let EntityExpirationReasonDissolved = _prefixId.prefix "EntityExpirationReasonDissolved"
    ...
    /// </summary>
    let hasAddressNumberWithinBuilding = _prefixId.prefix "hasAddressNumberWithinBuilding"
