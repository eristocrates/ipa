...
module lom =
    let _prefixId = PrefixId.fromNamespaceLabel "http://data.opendiscoveryspace.eu/lom_ontology_ods.owl#" "lom"
    ...
    let educationalTypicalLearningTime = _prefixId.prefix "educationalTypicalLearningTime"
