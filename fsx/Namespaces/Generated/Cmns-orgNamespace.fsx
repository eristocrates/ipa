...
module ``cmns-org`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/Organizations/" "cmns-org"
    ...
    ///   <para>omg-ann:adaptedFrom : Business Architecture Core Metamodel, https://www.omg.org/spec/BACM^^xsd:stringomg-ann:adaptedFrom : The TOGAF Standard, https://pubs.opengroup.org/togaf-standard/business-architecture/business-capability-planning.html^^xsd:stringomg-ann:adaptedFrom : Value Delivery Modeling Language Specification, https://www.omg.org/spec/VDML^^xsd:string</para>
    ...
    ///   <para>omg-ann:explanatoryNote : In contrast with capability, the concept of capacity is constrained by upper limits on resources including time and within some context, in addition to having the ability to do so if circumstances allow.^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : https://www.w3.org/TR/vocab-org/#class-formalorganization^^xsd:anyURI</para>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO 17442, Financial services - Legal Entity Identifier (LEI), first edition, 2012-06-01, section 3.1^^xsd:string</para>
    ///   <para>omg-ann:synonym : artificial person^^xsd:stringomg-ann:synonym : juridical entity^^xsd:stringomg-ann:synonym : juridical person^^xsd:stringomg-ann:synonym : juristic person^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO/IEC 6523-1:1998 Information technology — Structure for the identification of organizations and organization parts — Part 1: Identification of organization identification schemes, https://www.iso.org/obp/ui/#iso:std:iso-iec:6523:-1:ed-1:v1:en^^xsd:string</para>
    ...
    /// </summary>
    let OrganizationIdentificationScheme = _prefixId.prefix "OrganizationIdentificationScheme"
    ...
    ///   <para>omg-ann:abbreviation : OPI^^xsd:string</para>
    ///   <para>omg-ann:adaptedFrom : ISO/IEC 6523-1:1998 Information technology — Structure for the identification of organizations and organization parts — Part 1: Identification of organization identification schemes, https://www.iso.org/obp/ui/#iso:std:iso-iec:6523:-1:ed-1:v1:en^^xsd:string</para>
    ///   <para>omg-ann:synonym : organization part identifier^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO/IEC 6523-1:1998 Information technology — Structure for the identification of organizations and organization parts — Part 1: Identification of organization identification schemes, https://www.iso.org/obp/ui/#iso:std:iso-iec:6523:-1:ed-1:v1:en^^xsd:string</para>
    ///   <para>omg-ann:explanatoryNote : In other words, it is not a legal entity in its own right.^^xsd:string</para>
    ///   <para>omg-ann:synonym : organization part^^xsd:string</para>
    ...
    ///   <para>omg-ann:explanatoryNote : This property is intended to cover assigning a job or role to someone, selecting or designating someone to fill an office or a position, and fixing or setting by authority or by mutual agreement.^^xsd:string</para>
    ...
    ///   <para>omg-ann:synonym : has uniform resource locator^^xsd:string</para>
