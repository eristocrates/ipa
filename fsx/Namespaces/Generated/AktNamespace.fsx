...
module akt =
    let _prefixId = PrefixId.fromNamespaceLabel "http://www.aktors.org/ontology/portal#" "akt"
    ...
    let Article_In_A_Composite_Publication = _prefixId.prefix "Article-In-A-Composite-Publication"

    let Article_Reference = _prefixId.prefix "Article-Reference"

    let Artificial_Intelligence_Research_Area = _prefixId.prefix "Artificial-Intelligence-Research-Area"
    ...
    let Cognitive_Modelling_Research_Area = _prefixId.prefix "Cognitive-Modelling-Research-Area"
    ...
    let Conference_Proceedings_Reference = _prefixId.prefix "Conference-Proceedings-Reference"
    ...
    /// </summary>
    let Generalised_Means_Of_Transport = _prefixId.prefix "Generalised-Means-Of-Transport"
    ...
    let Higher_Educational_Organization = _prefixId.prefix "Higher-Educational-Organization"
    ...
    let R_And_D_Institute_Within_Larger_Institute = _prefixId.prefix "R-And-D-Institute-Within-Larger-Institute"
    ...
    let Research_Assistant_In_Academia = _prefixId.prefix "Research-Assistant-In-Academia"
    ...
    let Senior_Research_Fellow_In_Academia = _prefixId.prefix "Senior-Research-Fellow-In-Academia"
    ...
    /// </summary>
    let Small_Or_Medium_Sized_Organization = _prefixId.prefix "Small-Or-Medium-Sized-Organization"
    ...
    let Specification_Or_Computing_Language = _prefixId.prefix "Specification-Or-Computing-Language"
    ...
    let Workshop_Proceedings_Reference = _prefixId.prefix "Workshop-Proceedings-Reference"
    ...
    let addresses_generic_area_of_interest = _prefixId.prefix "addresses-generic-area-of-interest"
    ...
    let information_object_being_transferred = _prefixId.prefix "information-object-being-transferred"

    let information_transfer_medium_used = _prefixId.prefix "information-transfer-medium-used"
    ...
    let organization_unit_being_visited = _prefixId.prefix "organization-unit-being-visited"
    ...
    /// </summary>
    let project_involves_organization_unit = _prefixId.prefix "project-involves-organization-unit"
    ...
    let requires_hardware_platform_on_client_side = _prefixId.prefix "requires-hardware-platform-on-client-side"

    let requires_hardware_platform_on_server_side = _prefixId.prefix "requires-hardware-platform-on-server-side"

    let requires_software_technology = _prefixId.prefix "requires-software-technology"

    let requires_software_technology_on_client_side = _prefixId.prefix "requires-software-technology-on-client-side"

    let requires_software_technology_on_server_side = _prefixId.prefix "requires-software-technology-on-server-side"

    let runs_on_operating_system = _prefixId.prefix "runs-on-operating-system"

    let runs_on_operating_system_on_client_side = _prefixId.prefix "runs-on-operating-system-on-client-side"

    let runs_on_operating_system_on_server_side = _prefixId.prefix "runs-on-operating-system-on-server-side"
