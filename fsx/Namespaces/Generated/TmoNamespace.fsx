...
module tmo =
    let _prefixId = PrefixId.fromNamespaceLabel "http://www.w3.org/2001/sw/hcls/ns/transmed/" "tmo"

    /// <summary>
    ///   <para>http://www.geneontology.org/formats/oboInOwl#hasDbXref : HL7V3.0:ACTI^^xsd:string</para>
    ///   <para>dc11:description : An active ingredient is a pharmaceutical ingredient that has the disposition to treat a certain disease.</para>
    ...
    ///   <para>dc11:description : A formulated pharmaceutical is a chemical substance whose granular parts include an active ingredient, an excipient, and possibly a stability regulator for the active ingredient.</para>
    ...
    ///   <para>dc11:description : A pharmaceutical product is a formulated pharmaceutical that has been approved to treat patients.</para>
    ...
    ///   <para>dc11:description : An inactive ingredient is a pharmaceutical ingredient that is part of a pharmaceutical formulation but does not have the disposition to treat a certain disease.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An absent phenotype is a phenotype that represents the notable absence of a characteristic.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A genetic description is a description of the genetic composition of some entity.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A role played by a material entity it being the subject of a study.</para>
    ...
    ///   <para>dc11:description : A prognosis is a hypothesis about the likely course of a disease, the chance of recovery or recurrence.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A patient role is a role played a human subject that receives medical attention, care or treatment or who is registered with a medical institution with the purpose of receiving medical care when necessary.</para>
    ...
    ///   <para>dc11:description : An medical expert role is a role played by a human in a clinical context who is involved in the assessment or administration of treatment or its results.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A biomedical measure is an information content entity that describes or is a measure of biomedically relevant entities.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A molecular structure description is a description of a molecule in terms of its composition and connectivity.</para>
    ...
    ///   <para>dc11:description : A patent is an information entity granted by a patent office which confers upon the patenter the sole right to make, use and sell an invention for a set period of time.</para>
    ...
    ///   <para>dc11:description : An exclusion criterion for clinical trial is a clinical trial criterion which, if satisfied, supports the exclusion of candidate patients.</para>
    ...
    /// <summary>
    ///   <para>http://www.geneontology.org/formats/oboInOwl#hasDbXref : IAO:0000124^^xsd:string</para>
    ///   <para>dc11:description : A inclusion criterion for clinical trial is a clinical trial criterion which, if satisfied, supports the inclusion of candidate patients.</para>
    ...
    /// <summary>
    ///   <para>http://www.geneontology.org/formats/oboInOwl#hasDbXref : IAO:0000124^^xsd:string</para>
    ///   <para>dc11:description : A diagnostic result is a medical measure of determining the nature of a  problem or illness through medical procedure.</para>
    ...
    /// <summary>
    ///   <para>http://www.geneontology.org/formats/oboInOwl#hasDbXref : IAO:0000124^^xsd:string</para>
    ///   <para>dc11:description : A clinical protocol is a directive information entity about the objective(s), design, methodology, statistical considerations, and organization of a clinical procedure.</para>
    ...
    ///   <para>dc11:description : Evidence is a group of indicators that are relevant in some decision-making process.</para>
    ...
    ///   <para>dc11:description : An environmental description is a description concerning some aspect of a physical environment.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A phenotype is an observable characteristic of an organism.</para>
    ...
    ///   <para>dc11:description : A personal medical history is a medical record consisting of a collection of information obtained from the patient and from other sources concerning the patient's health.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A clinical trial protocol is a clinical protocol about the objective(s), design, methodology, statistical considerations, and organization of a clinical trial.</para>
    ...
    ///   <para>dc11:description : A quality of a patient, a material entity that is part of a patient, or a processual entity that a patient participates in, any one of which is observed in a physical examination and is deemed by the clinician to be of clinical significance.</para>
    ...
    ///   <para>dc11:description : A quality of a patient that is observed by the patient or a processual entity experienced by the patient, either of which is hypothesized by the patient to be a realization of a disease.</para>
    ///   <para>obo:IAO_0000119 : Richard Scheuermann, Werner Ceusters, Barry Smith in "Toward an Ontological Treatment of Disease and Diagnosis"^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A medical measure is a measure that describes or is a measure of medically relevant entities.</para>
    ...
    ///   <para>dc11:description : An institution is an entity created by legislation or by practice which acts legally in the same way as a person.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A regulatory authority is an institution created by legislation which acts to control what treatments can be prescribed.</para>
    ...
    ///   <para>dc11:description : A study is a planned process that consists of planning, study execution, documentation and the production of conclusion(s).</para>
    ...
    ///   <para>dc11:description : An intervention is a study in which a substance is administered to a subject or group of subjects.</para>
    ...
    ///   <para>obo:IAO_0000119 : NCI thesaurus^^xsd:string</para>
    ///   <para>dc11:description : A diagnosis is a study composed of investigation, analysis and recognition of the presence and nature of disease, condition, or injury from expressed signs and symptoms; also, the scientific determination of any kind; the concise results of such an investigation.</para>
    ...
    ///   <para>dc11:description : A clinical trial is a study to assess the efficacy of a substance for the treatment of a condition.</para>
    ///   <a href="http://www.w3.org/2001/sw/hcls/ns/transmed/TMO_0032">tmo:TMO_0032</a>
    /// </summary>
    let TMO_0032 = _prefixId.prefix "TMO_0032"
    /// <summary>
    ///   <para>dc11:description : A drug measure is a biomedical measure that describes or is a measure of drugs or their activies.</para>
    ...
    ///   <para>dc11:description : Any constitutionally or isotopically distinct atom, molecule, ion, ion pair, radical, radical ion, complex, conformer etc., identifiable as a separately distinguishable entity.</para>
    ...
    ///   <para>dc11:description : A biological macromolecule that is composed of amino acids linked in a linear sequence (a polypeptide chain).</para>
    ...
    ///   <para>dc11:description : A cell line is a material entity that consists of a population of cells cultured in vitro that are descended through one or more generations (and possible sub-cultures) from a single primary culture which was originally derived from part of an organism.</para>
    ...
    ///   <para>dc11:description : A gene is a part of DNA that encodes information about other molecular entities.</para>
    ...
    ///   <para>dc11:description : A genotype with a single-nucleotide polymorphism (SNP). A SNP is a variation at a single nucleotide locus in the genomes of members of a species. For a variation to be considered a SNP, it must occur in at least 1% of the population.</para>
    ...
    ///   <para>dc11:description : A genotype of which variants with a different number of copies of a sequence identifical region exist.</para>
    ...
    ///   <para>dc11:description : A drug-drug interaction is a drug interaction in which two drugs interact in such a way to produce an abnormal phenotypic event.</para>
    ...
    ///   <para>dc11:description : The mechanism of action is a description of processes and behaviour of a biologically active molecule in its administration into a living system.</para>
    ...
    ///   <para>obo:IAO_0000119 : NCI Thesaurus^^xsd:string</para>
    ///   <para>dc11:description : A pathway is a representation of a set or series of interactions, often forming a network, which biologists have found useful to group together for organizational, historic, biophysical, or other reasons.</para>
    ...
    ///   <para>dc11:description : A population is a collection of organisms.</para>
    ...
    ///   <para>dc11:description : An arm of clinical study is a population that participates in a clinical trial and is subject to some intervention.</para>
    ...
    ///   <para>dc11:description : A quality of an organism which predisposes it to undergo pathological processes because of one or more disorders in that organism.</para>
    ///   <para>obo:IAO_0000119 : Richard Scheuermann, Werner Ceusters, Barry Smith in "Toward an Ontological Treatment of Disease and Diagnosis"^^xsd:string</para>
    ...
    ///   <para>dc11:description : An allele is a specific variant of a gene.</para>
    ...
    ///   <para>dc11:description : A metabolite role is the role played by a material entity that is a metabolic substrate, intermediate or product.</para>
    ...
    /// <summary>
    ///   <para>http://www.geneontology.org/formats/oboInOwl#hasDbXref : IAO:0000124^^xsd:string</para>
    ///   <para>dc11:description : Drug efficacy is a measure of the capabilty of a drug to produce an intended effect as a function of its concentration.</para>
    ...
    /// <summary>
    ///   <para>http://www.geneontology.org/formats/oboInOwl#hasDbXref : IAO:0000124^^xsd:string</para>
    ///   <para>dc11:description : Treatment safety is a condition that refers to an absence of harmful side effects resulting from use of the product and may be assessed by laboratory testing of biological samples, special tests and procedures, psychiatric evaluation, and/or physical examination of subjects.</para>
    ///   <para>obo:IAO_0000119 : NCI Thesaurus^^xsd:string</para>
    ...
    ///   <para>dc11:description : A biomarker is a characteristic of a material entity that is objectively measured and evaluated as an indicator of normal biological processes, pathogenic processes, or pharmacologic responses to a therapeutic intervention.</para>
    ...
    ///   <para>dc11:description : Comparative effectiveness is a drug measure that provides information about which treatment works best, for whom, and under what circumstances.</para>
    ...
    ///   <para>dc11:description : Lifestyle is a description about an individual`s manner of living.</para>
    ...
    ///   <para>dc11:description : A health outcome is a medical measure of health or loss of health.</para>
    ...
    ///   <para>dc11:description : Toxicity is a quality of a chemical substance which indicates the capacity to cause injury to an organism in a dose dependent manner.</para>
    ...
    ///   <para>dc11:description : Dosage is the amount of a chemical administered to, or taken by, an organism and expressed as some function of the organism and of time (mg/kg body weight/day).</para>
    ...
    ///   <para>dc11:description : A syndrome is a group of signs and symptoms that characterize a particular abnormality.</para>
    ...
    ///   <para>dc11:description : A hypothesis is an information content entity that describes a possible correlation between two or more variables.</para>
    ...
    ///   <para>dc11:description : A clinical subject role is the role played by an organism who is the subject of a clinical procedure or assessment.</para>
    ...
    ///   <para>dc11:description : A side effect is an effect of an intervention, whether therapeutic or adverse, that is secondary to the intended effect of the intervention.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A pharmaceutical ingredient role is a role played by a chemical substance that is part of a pharmaceutical formulation.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A chemical substance is a material entity consisting of many chemical entities and typically has connected boundaries.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An active ingredient role is a role played by a chemical substance which has the disposition to treat a certain disease and is part of a pharmaceutical formulation.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An inactive ingredient role is a role played by a chemical substance which is part of a pharmaceutical formulation but does not have the disposition to treat a certain disease.</para>
    ...
    ///   <para>dc11:description : A molecular target is a molecular entity that is the target of a transformation process.</para>
    ...
    /// <summary>
    ///   <para>http://www.geneontology.org/formats/oboInOwl#hasDbXref : IAO:0000124^^xsd:string</para>
    ///   <para>dc11:description : A diagnostic criterion is a directive information entity for consideration during a diagnosis which, if satisfied, contributes to a diagnostic result</para>
    ...
    /// <summary>
    ///   <para>http://www.geneontology.org/formats/oboInOwl#hasDbXref : IAO:0000124^^xsd:string</para>
    ///   <para>dc11:description : A diagnostic inclusion criterion is a diagnostic criterion for consideration during a diagnosis which, if satisfied, supports a diagnostic result.</para>
    ...
    /// <summary>
    ///   <para>http://www.geneontology.org/formats/oboInOwl#hasDbXref : IAO:0000124^^xsd:string</para>
    ///   <para>dc11:description : A diagnostic exclusion criterion is a diagnostic criterion for consideration during a diagnosis which, if satisfied, excludes a diagnostic result.</para>
    ...
    ///   <para>dc11:description : A pharmaceutical ingredient is a chemical substance that is part of a formulated pharmaceutical that bears a pharmaceutical ingredient role.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A molecular target role is a role played by a chemical entity in which it is a specific target of an intervention that aims to change it behavior.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A chemical entity role is a role played by a chemical entity.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An expert role is a role played by a knowledgeable person.</para>
    ...
    ///   <para>dc11:description : A planned process is a process in which specific objectives are realized in a plan designed by some agent.</para>
    ...
    ///   <para>dc11:description : An assay is a planned process with the objective to obtain information about a material entity.</para>
    ///   <a href="http://www.w3.org/2001/sw/hcls/ns/transmed/TMO_0076">tmo:TMO_0076</a>
    /// </summary>
    let TMO_0076 = _prefixId.prefix "TMO_0076"
    /// <summary>
    ///   <para>dc11:description : A clinical trial criterion is a directive information entity which, if satisfied, contributes to the inclusion or exclusion of candidate patients.</para>
    ...
    ///   <para>dc11:description : An enzyme is a protein that catalyzes (increases the rate of) a chemical reaction.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A haplotype a variant DNA region which contains several smaller variant DNA regions which tend to be inherited together.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A gene variant is a variant of another gene based on some difference in sequence (composition and connectivity)</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Ethinicity is the quality of an organism that describes membership in a social group based on a common heritage.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Age is the temporal quality of an organism that refers to the length of time elapsed since it came into existence. For most animals and humans, age refers to the length of time elapsed since birth.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Sex is an quality that inheres in an organism for which sexual differentiation is required for sexual reproduction.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Male is a sex quality for which sex organs contain only male gametes</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Female is a sex quality for which sex organs contain only female gametes</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A measure is an information content entity that describes or quantifies some thing.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A quantity is a quantitative measure of some feature.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A functional quantity is a quantity obtained as a result of a function involving one or more parameters.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An enumerated numerical quantity is a numerical quantity selected from a discrete set of quantities.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A multitude numerical quantity is a numerical quantity that indicates the number of individuals.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A magnitude of a genetic marker refers to the the significance of some genetic marker</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An indicator is an entity for which its observation/detection is used in some objective.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A sequence position is a identifier for an item in a sequence of items and whose numeric value relates to the position of the item from the start of the sequence.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A chromosomal nucleotide sequence position is an ordinal number which reflects the position of a nucleotide in relation to the first nucleotide of the same chromosome.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An amino acid sequence position indicates the position of an amino acid residue in relation to the start of the peptide chain.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A nucleotide sequence position indicates the position of a nucleotide residue in relation to the start of the nucleic acid.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A dexoyribonucleotide sequence position is an ordinal number which reflects the position of a deoxyribonucleotide in relation to the first deoxyribonucleotide of the same deoxyribonucleic acid (DNA).</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A ribonucleotide sequence position is an ordinal number which reflects the position of a ribonucleotide in relation to the first ribonucleotide of the same ribonucleic acid (RNA).</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A sequence is an ordered list of objects of a specified type.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An amino acid sequence is a sequence of amino acids in which a word (1 more more sequence of characters) represents an amino acid and their adjacency indicates their connectivity.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A nucleotide sequence is a sequence of nucleotides in which a word (1 more more sequence of characters) represents a nucleotide and their adjacency indicates their connectivity.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : a DNA sequence is a sequence of characters that represents the composition and connectivity of a a DNA molecule.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An identifier is an information content entity which consists of one or more symbols in order to identify some entity.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A genomic sequence is the collection of sequences that make up an individual's genetic matter.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A collection of humans</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A collection of humans from a particular region.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A reference genomic sequence is a genomic sequence that serves as a standard or reference, and may be composed by the consensus of the genomes of a number of individuals or parts thereof.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A chromosome number is an identifier for a chromosome that identifies it from a collection of chromosomes for a given organism.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An item in a collection identifier is an identifier for an entity that is a member of a collection.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An item in a collection identifier is an identifier for an entity that is a member of an ordered sequence of items (based on some attribute).</para>
    ...
    /// <summary>
    ///   <para>dc11:description : In a group of allelic variants in a population, the ancestral allele is the allele from which all other allelic variants are believed to have descended from during phylogeny.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Smoker status is a medical descriptor of the tobacco smoking behaviour of a person.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A short acronym identifying a sample population that was examined by the HapMap project.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A genotype of which variants exist that differ though an insertion, deletion or a combination thereof.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A genotype with a multiple-nucleotide polymorphism (MNP). An MNP is a variation of several adjacent nucleotides in the genomes of members of a species. For a variation to be considered an MNP, it must occur in at least 1% of the population.</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A genotype containing one matching allele on each chromosome (e.g., CYP2C9*1/*3)</para>
    ...
    ///   <para>dc11:description : A drug interaction is a process in which a drug interacts with a living system in such a way that it affects its behaviour.</para>
