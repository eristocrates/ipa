...
module lslife =
    let _prefixId = PrefixId.fromNamespaceLabel "http://ontology.cybershare.utep.edu/ELSEWeb/elseweb-lifemapper.owl#" "lslife"
    ...
    /// </summary>
    let ExecutableExperimentSpecification = _prefixId.prefix "ExecutableExperimentSpecification"
    ...
    /// </summary>
    let ExecutedExperimentSpecification = _prefixId.prefix "ExecutedExperimentSpecification"
    ...
    /// </summary>
    let InputWCSDatasetExperimentSpecification = _prefixId.prefix "InputWCSDatasetExperimentSpecification"
    ...
    /// </summary>
    let hasJSONExperimentSpecificationURL = _prefixId.prefix "hasJSONExperimentSpecificationURL"
