...
module ``gleif-L2`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.gleif.org/ontology/L2/" "gleif-L2"
    ...
    let AccountingStandardOtherAccountingStandard = _prefixId.prefix "AccountingStandardOtherAccountingStandard"
    ...
    /// </summary>
    let InternationalBranchRelationship = _prefixId.prefix "InternationalBranchRelationship"
    ...
    /// </summary>
    let RelationshipValidationDocumentsKind = _prefixId.prefix "RelationshipValidationDocumentsKind"

    let RelationshipValidationDocumentsKindAccountsFiling = _prefixId.prefix "RelationshipValidationDocumentsKindAccountsFiling"

    let RelationshipValidationDocumentsKindContracts = _prefixId.prefix "RelationshipValidationDocumentsKindContracts"

    let RelationshipValidationDocumentsKindOtherOfficialDocuments = _prefixId.prefix "RelationshipValidationDocumentsKindOtherOfficialDocuments"

    let RelationshipValidationDocumentsKindRegulatoryFiling = _prefixId.prefix "RelationshipValidationDocumentsKindRegulatoryFiling"

    let RelationshipValidationDocumentsKindSupportingDocuments = _prefixId.prefix "RelationshipValidationDocumentsKindSupportingDocuments"
