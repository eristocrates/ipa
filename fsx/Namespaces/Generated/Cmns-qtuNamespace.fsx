...
module ``cmns-qtu`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/QuantitiesAndUnits/" "cmns-qtu"

    let _namespaceIri = _prefixId.prefix ""
    /// <summary>
    ///   <para>rdfs:label : arbitrary unit^^xsd:string</para>
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.1^^xsd:string</para>
    ...
    ///   <para>omg-ann:synonym : base quantity^^xsd:stringomg-ann:synonym : simple quantity kind^^xsd:string</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.3^^xsd:stringdcterms:source : ISO 80000-1:2009 Quantities and units - Part 1: General, clause 3.10^^xsd:stringdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
    ...
    ///   <para>omg-ann:synonym : simple unit^^xsd:string</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.4^^xsd:stringdcterms:source : ISO 80000-1:2009 Quantities and units - Part 1: General, clause 3.12^^xsd:string</para>
    ...
    ///   <para>dcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.6^^xsd:stringdcterms:source : ISO 80000-1:2009 Quantities and units - Part 1: General, clause 3.24^^xsd:string</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.7^^xsd:stringdcterms:source : ISO 80000-1:2009 Quantities and units - Part 1: General, clause 3.5^^xsd:stringdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.8^^xsd:stringdcterms:source : ISO 80000-1:2009 Quantities and units - Part 1: General, clause 3.11^^xsd:stringdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.10^^xsd:stringdcterms:source : ISO 80000-1:2009 Quantities and units - Part 1: General, clause 3.8^^xsd:stringdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
    ...
    ///   <para>omg-ann:synonym : quantity of dimension one^^xsd:string</para>
    ...
    let InternationalSystemOfQuantities = _prefixId.prefix "InternationalSystemOfQuantities"

    let InternationalSystemOfUnits = _prefixId.prefix "InternationalSystemOfUnits"
    /// <summary>
    ///   <para>rdfs:label : interval scale^^xsd:string</para>
    ///   <para>dcterms:source : https://plato.stanford.edu/entries/measurement-science/^^xsd:anyURIdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURIdcterms:source : https://www.statista.com/statistics-glossary/definition/320/interval_scale/^^xsd:anyURI</para>
    ...
    ///   <para>dcterms:source : https://en.wikipedia.org/wiki/Logarithmic_scale/^^xsd:anyURIdcterms:source : https://plato.stanford.edu/entries/measurement-science/^^xsd:anyURIdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.14^^xsd:string</para>
    ...
    ///   <para>dcterms:source : https://stats.oecd.org/glossary/detail.asp?ID=7062^^xsd:anyURI</para>
    ...
    ///   <para>omg-ann:abbreviation : SOP^^xsd:string</para>
    ///   <para>omg-ann:adaptedFrom : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.16^^xsd:string</para>
    ///   <para>omg-ann:synonym : standard operating procedure^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : International Vocabulary of Metrology - Basic and General Concepts and Associated Terms (VIM), Third Edition, JCGM 200:2012, available at https://www.bipm.org/documents/20126/2071204/JCGM_200_2012.pdf^^xsd:string</para>
    ...
    ///   <para>dcterms:source : ISO 80000-1:2009 Quantities and units - Part 1: General, clause 3.27^^xsd:stringdcterms:source : https://plato.stanford.edu/entries/measurement-science/^^xsd:anyURIdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
    ...
    ///   <para>omg-ann:synonym : quantity-value scale^^xsd:string</para>
    ...
    ///   <para>omg-ann:synonym : unit of measurement^^xsd:string</para>
    ...
    ///   <para>dcterms:source : https://plato.stanford.edu/entries/measurement-science/^^xsd:anyURIdcterms:source : https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4589638/^^xsd:anyURI</para>
    ...
    ///   <para>dcterms:source : ISO 80000-1:2009 Quantities and units - Part 1: General, clause 3.28^^xsd:stringdcterms:source : https://plato.stanford.edu/entries/measurement-science/^^xsd:anyURIdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
    ...
    ///   <para>omg-ann:synonym : ordinal quantity-value scale^^xsd:stringomg-ann:synonym : ordinal value scale^^xsd:string</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.21^^xsd:string</para>
    ...
    ///   <para>omg-ann:synonym : physical unit of measurement^^xsd:string</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.22^^xsd:string</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.9^^xsd:stringdcterms:source : ISO 80000-1:2009 Quantities and units - Part 1: General, clause 3.7^^xsd:stringdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
    ...
    ///   <para>omg-ann:synonym : dimension^^xsd:stringomg-ann:synonym : dimension of a quantity^^xsd:string</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.12^^xsd:stringdcterms:source : ISO 80000-1:2009 Quantities and units - Part 1: General, clause 3.2^^xsd:stringdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
    ...
    ///   <para>omg-ann:synonym : kind of quantity^^xsd:string</para>
    ...
    ///   <para>dcterms:source : https://stats.oecd.org/glossary/detail.asp?ID=6688^^xsd:anyURIdcterms:source : https://www150.statcan.gc.ca/n1/edu/power-pouvoir/glossary-glossaire/5214842-eng.htm#r^^xsd:anyURI</para>
    ...
    ///   <para>omg-ann:synonym : rate^^xsd:string</para>
    ...
    ///   <para>dcterms:source : https://plato.stanford.edu/entries/measurement-science/^^xsd:anyURIdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
    ...
    /// </summary>
    let RatioScaleWithAdditionalLimitValues = _prefixId.prefix "RatioScaleWithAdditionalLimitValues"

    /// <summary>
    ///   <para>rdfs:label : reference material^^xsd:string</para>
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.26^^xsd:string</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.24^^xsd:stringdcterms:source : ISO 80000-1:2009 Quantities and units - Part 1: General, clause 3.1^^xsd:stringdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clauses 3.1.19, 3.1.25^^xsd:stringdcterms:source : ISO 80000-1:2009 Quantities and units - Part 1: General, clause 3.19^^xsd:stringdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
    ...
    ///   <para>omg-ann:synonym : measurement^^xsd:stringomg-ann:synonym : value of a quantity^^xsd:string</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.29^^xsd:stringdcterms:source : ISO 80000-1:2009 Quantities and units - Part 1: General, clause 3.3^^xsd:stringdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
    ...
    ///   <para>dcterms:source : ISO 11240 Health informatics - Identification of medicinal products - Data elements and structures for the unique identification and exchange of units of measurement, clause 3.1.30^^xsd:stringdcterms:source : ISO 80000-1:2009 Quantities and units - Part 1: General, clause 3.13^^xsd:stringdcterms:source : https://www.omg.org/spec/SysML/^^xsd:anyURI</para>
