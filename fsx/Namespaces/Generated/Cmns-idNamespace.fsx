...
module ``cmns-id`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/Identifiers/" "cmns-id"
    ...
    ///   <para>dcterms:source : ISO/IEC 11179-3 Information technology - Metadata registries (MDR) - Part 3: Registry metamodel and basic attributes, Third edition, 2013-02-15, clause 3.1.1^^xsd:string</para>
