...
module ``cmns-dt`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/DatesAndTimes/" "cmns-dt"
    ...
    ///   <para>omg-ann:synonym : time stamp^^xsd:string</para>
    ...
    ///   <para>dcterms:source : https://www.w3.org/TR/owl-time/#time:ProperInterval^^xsd:anyURI</para>
    ...
    ///   <para>omg-ann:adaptedFrom : https://www.omg.org/spec/DTV/^^xsd:anyURIomg-ann:adaptedFrom : https://www.w3.org/TR/owl-time/#time:Instant^^xsd:anyURI</para>
    ///   <para>omg-ann:synonym : instant in time^^xsd:stringomg-ann:synonym : time point^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : https://www.omg.org/spec/DTV/^^xsd:anyURIomg-ann:adaptedFrom : https://www.w3.org/TR/owl-time/#time:Interval^^xsd:anyURI</para>
    ...
    ///   <para>omg-ann:usageNote : Use of the property 'hasTimeValue' as a property of the TimeOfDay to record the actual time, or use either the DateTime or DateTimeStamp class with the date zeroed out if the date is not relevant but with the time included.^^xsd:string</para>
    ...
    ///   <para>dcterms:source : ISO 1087 Terminology work and terminology science - Vocabulary, Second edition, 2019-09, clause 3.2.24^^xsd:string</para>
