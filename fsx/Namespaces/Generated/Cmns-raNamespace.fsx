...
module ``cmns-ra`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/RegistrationAuthorities/" "cmns-ra"
    ...
    ///   <para>omg-ann:adaptedFrom : Barron's Dictionary of Business and Economic Terms, Fifth Edition, 2012^^xsd:stringomg-ann:adaptedFrom : ISO/IEC 11179-3:2023, Information technology - Metadata registries (MDR) - Part 3: Metamodel for registry common facilities, Fourth edition, 2023^^xsd:string</para>
    ...
    ///   <para>omg-ann:abbreviation : RA^^xsd:string</para>
    ///   <para>omg-ann:adaptedFrom : ISO/IEC 11179-3:2023, Information technology - Metadata registries (MDR) - Part 3: Metamodel for registry common facilities, Fourth edition, 2023^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO/IEC 11179-3:2023, Information technology - Metadata registries (MDR) - Part 3: Metamodel for registry common facilities, Fourth edition, 2023^^xsd:string</para>
    ///   <para>omg-ann:explanatoryNote : Electronic registries typically contain a unique identifier for each entry, so that individual records can be referenced from other documents and registries.^^xsd:string</para>
    ...
    ///   <para>omg-ann:synonym : registry item^^xsd:string</para>
