...
module sri =
    ...
    let adaptTheirOperationToTheNeedsOfTheOccupant = _prefixId.prefix "adaptTheirOperationToTheNeedsOfTheOccupant"
    ...
    let energy_flexibility_and_storage = _prefixId.prefix "energy_flexibility_and_storage"
    ...
    let health_well_being_and_accessibility = _prefixId.prefix "health_well_being_and_accessibility"
    ...
    let maintenance_and_fault_prediction = _prefixId.prefix "maintenance_and_fault_prediction"
    ...
    let optimiseEnergyEfficiencyAndOverallIn_UsePerformance = _prefixId.prefix "optimiseEnergyEfficiencyAndOverallIn-UsePerformance"
