...
module cpmeta =
    let _prefixId = PrefixId.fromNamespaceLabel "http://meta.icos-cp.eu/ontologies/cpmeta/" "cpmeta"
    ...
    let asciiEtcHalfHourlyProductTimeSer = _prefixId.prefix "asciiEtcHalfHourlyProductTimeSer"
