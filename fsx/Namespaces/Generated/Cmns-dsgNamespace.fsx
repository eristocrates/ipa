...
module ``cmns-dsg`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/Designators/" "cmns-dsg"
    ...
    ///   <para>omg-ann:adaptedFrom : ISO 1087 Terminology work and terminology science - Vocabulary, Second edition, 2019-09, clause 3.4.1^^xsd:stringomg-ann:adaptedFrom : ISO 704 Terminology work - Principles and methods, Fourth edition, 2022-07, Figure 1^^xsd:string</para>
    ///   <para>omg-ann:synonym : designator^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO/IEC 11179-3 Information technology - Metadata registries (MDR) - Registry metamodel and basic attributes, Third edition, 2013-02-15, clause 3.2.83^^xsd:string</para>
    ///   <para>omg-ann:explanatoryNote : Note that unlike symbols and other designations, a name is explicitly not linguistically neutral.^^xsd:string</para>
    ...
    ///   <para>omg-ann:usageNote : This property is a data property, rather than an annotation such as dct:description, enabling it to be used for mapping controlled vocabularies and other literals that are explicit, required attributes of other models.^^xsd:string</para>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO 639:2023 Code for individual languages and language groups, Second edition, 2023-11^^xsd:string</para>
