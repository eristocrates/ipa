...
module nsl =
    let _prefixId = PrefixId.fromNamespaceLabel "http://purl.org/ontology/storyline/" "nsl"

    let _0'_period_'2 = _prefixId.prefix "0.2"
    let _0'_period_'3 = _prefixId.prefix "0.3"
    /// <summary>
