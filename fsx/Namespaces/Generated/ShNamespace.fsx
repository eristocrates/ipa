...
module sh =
    ...
    let ClassConstraintComponent_class = _prefixId.prefix "ClassConstraintComponent-class"

    let ClosedConstraintComponent = _prefixId.prefix "ClosedConstraintComponent"

    let ClosedConstraintComponent_closed = _prefixId.prefix "ClosedConstraintComponent-closed"

    let ClosedConstraintComponent_ignoredProperties = _prefixId.prefix "ClosedConstraintComponent-ignoredProperties"
    ...
    let DatatypeConstraintComponent_datatype = _prefixId.prefix "DatatypeConstraintComponent-datatype"

    let DisjointConstraintComponent = _prefixId.prefix "DisjointConstraintComponent"

    let DisjointConstraintComponent_disjoint = _prefixId.prefix "DisjointConstraintComponent-disjoint"

    let EqualsConstraintComponent = _prefixId.prefix "EqualsConstraintComponent"

    let EqualsConstraintComponent_equals = _prefixId.prefix "EqualsConstraintComponent-equals"

    let ExpressionConstraintComponent = _prefixId.prefix "ExpressionConstraintComponent"

    let ExpressionConstraintComponent_expression = _prefixId.prefix "ExpressionConstraintComponent-expression"
    ...
    let HasValueConstraintComponent_hasValue = _prefixId.prefix "HasValueConstraintComponent-hasValue"
    ...
    let LanguageInConstraintComponent_languageIn = _prefixId.prefix "LanguageInConstraintComponent-languageIn"

    let LessThanConstraintComponent = _prefixId.prefix "LessThanConstraintComponent"

    let LessThanConstraintComponent_lessThan = _prefixId.prefix "LessThanConstraintComponent-lessThan"

    let LessThanOrEqualsConstraintComponent = _prefixId.prefix "LessThanOrEqualsConstraintComponent"

    let LessThanOrEqualsConstraintComponent_lessThanOrEquals = _prefixId.prefix "LessThanOrEqualsConstraintComponent-lessThanOrEquals"

    let Literal = _prefixId.prefix "Literal"
    let MaxCountConstraintComponent = _prefixId.prefix "MaxCountConstraintComponent"

    let MaxCountConstraintComponent_maxCount = _prefixId.prefix "MaxCountConstraintComponent-maxCount"

    let MaxExclusiveConstraintComponent = _prefixId.prefix "MaxExclusiveConstraintComponent"

    let MaxExclusiveConstraintComponent_maxExclusive = _prefixId.prefix "MaxExclusiveConstraintComponent-maxExclusive"

    let MaxInclusiveConstraintComponent = _prefixId.prefix "MaxInclusiveConstraintComponent"

    let MaxInclusiveConstraintComponent_maxInclusive = _prefixId.prefix "MaxInclusiveConstraintComponent-maxInclusive"

    let MaxLengthConstraintComponent = _prefixId.prefix "MaxLengthConstraintComponent"

    let MaxLengthConstraintComponent_maxLength = _prefixId.prefix "MaxLengthConstraintComponent-maxLength"

    let MinCountConstraintComponent = _prefixId.prefix "MinCountConstraintComponent"

    let MinCountConstraintComponent_minCount = _prefixId.prefix "MinCountConstraintComponent-minCount"

    let MinExclusiveConstraintComponent = _prefixId.prefix "MinExclusiveConstraintComponent"

    let MinExclusiveConstraintComponent_minExclusive = _prefixId.prefix "MinExclusiveConstraintComponent-minExclusive"

    let MinInclusiveConstraintComponent = _prefixId.prefix "MinInclusiveConstraintComponent"

    let MinInclusiveConstraintComponent_minInclusive = _prefixId.prefix "MinInclusiveConstraintComponent-minInclusive"

    let MinLengthConstraintComponent = _prefixId.prefix "MinLengthConstraintComponent"

    let MinLengthConstraintComponent_minLength = _prefixId.prefix "MinLengthConstraintComponent-minLength"
    ...
    let NodeKindConstraintComponent_nodeKind = _prefixId.prefix "NodeKindConstraintComponent-nodeKind"
    ...
    let PatternConstraintComponent_flags = _prefixId.prefix "PatternConstraintComponent-flags"

    let PatternConstraintComponent_pattern = _prefixId.prefix "PatternConstraintComponent-pattern"
    ...
    let PropertyConstraintComponent_property = _prefixId.prefix "PropertyConstraintComponent-property"
    ...
    let QualifiedMaxCountConstraintComponent = _prefixId.prefix "QualifiedMaxCountConstraintComponent"

    let QualifiedMaxCountConstraintComponent_qualifiedMaxCount = _prefixId.prefix "QualifiedMaxCountConstraintComponent-qualifiedMaxCount"

    let QualifiedMaxCountConstraintComponent_qualifiedValueShape = _prefixId.prefix "QualifiedMaxCountConstraintComponent-qualifiedValueShape"

    let QualifiedMaxCountConstraintComponent_qualifiedValueShapesDisjoint = _prefixId.prefix "QualifiedMaxCountConstraintComponent-qualifiedValueShapesDisjoint"

    let QualifiedMinCountConstraintComponent = _prefixId.prefix "QualifiedMinCountConstraintComponent"

    let QualifiedMinCountConstraintComponent_qualifiedMinCount = _prefixId.prefix "QualifiedMinCountConstraintComponent-qualifiedMinCount"

    let QualifiedMinCountConstraintComponent_qualifiedValueShape = _prefixId.prefix "QualifiedMinCountConstraintComponent-qualifiedValueShape"

    let QualifiedMinCountConstraintComponent_qualifiedValueShapesDisjoint = _prefixId.prefix "QualifiedMinCountConstraintComponent-qualifiedValueShapesDisjoint"
    ...
    let SPARQLConstraintComponent_sparql = _prefixId.prefix "SPARQLConstraintComponent-sparql"
    ...
    let UniqueLangConstraintComponent_uniqueLang = _prefixId.prefix "UniqueLangConstraintComponent-uniqueLang"
