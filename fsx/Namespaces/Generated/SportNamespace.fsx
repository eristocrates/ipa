...
module sport =
    let _prefixId = PrefixId.fromNamespaceLabel "http://www.bbc.co.uk/ontologies/sport/" "sport"

    let _2'_period_'0 = _prefixId.prefix "2.0"
    let _2'_period_'11 = _prefixId.prefix "2.11"
    ...
    /// </summary>
    let CompetitiveSportingOrganisation = _prefixId.prefix "CompetitiveSportingOrganisation"
    ...
    /// </summary>
    let MultiDisciplineRecurringCompetition = _prefixId.prefix "MultiDisciplineRecurringCompetition"
    ...
    /// </summary>
    let isCompetitiveSportingOrganisationOf = _prefixId.prefix "isCompetitiveSportingOrganisationOf"
