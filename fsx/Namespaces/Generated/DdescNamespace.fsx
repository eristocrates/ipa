...
module ddesc =
    let _prefixId = PrefixId.fromNamespaceLabel "https://w3id.org/arco/ontology/denotative-description/" "ddesc"
    ...
    /// <summary>
    ///   <para>dc11:description : Un esempio d'uso di una delle sottoclassi della classe "Elemento apposto su bene culturale" è il seguente:
    ...
    ///         language:hasLanguage resource:Language/latino .dc11:description : An example of usage of one of the subclasses of the class 'Affixed element' is the following:
    /// resource:Inscription/1200865151-inscription-1
    ///         a   dd:Inscription ;
    ...
    /// <summary>
    ///   <para>dc11:description : Un esempio d'uso della classe "Stato di conservazione" è il seguente:
    ...
    ///         tiapit:time   "2014" .dc11:description : An example of usage of the class 'Conservation status' is the following:
    /// resource:ConservationStatus/0900750201-conservation-status-1
    ...
    /// </summary>
    let CulturalEntityTechnicalDescription = _prefixId.prefix "CulturalEntityTechnicalDescription"

    /// <summary>
    ///   <para>owl:versionInfo : stableowl:versionInfo : stabile</para>
    ///   <para>dc11:description : An example of usage of the class 'Cultural entity technical status' is the following:
    ...
    ///         a-dd:isClassifiedBy  a-dd:MaterialOrTechnique .dc11:description : Un esempio d'uso della classe "Stato tecnico di entità culturale" è il seguente:
    /// resource:CulturalEntityTechnicalStatus/0900281817-4
    ///         a           a-dd:CulturalEntityTechnicalStatus ;
    ...
    let IconographicAndDecorativeApparatus = _prefixId.prefix "IconographicAndDecorativeApparatus"
    ...
    /// </summary>
    let IconographicOrDecorativeApparatus = _prefixId.prefix "IconographicOrDecorativeApparatus"
    ...
    /// </summary>
    let IconographicOrDecorativeApparatusType = _prefixId.prefix "IconographicOrDecorativeApparatusType"
    ...
    ///   <para>dc11:description : Un esempio d'uso della classe "Misura" è il seguente:
    ...
    ///         dd:hasValue resource:Value/0500212021-1-height-795 .dc11:description : An example of usage of the class 'Measurement' is the following:
    /// resource:Measurement/0500212021-1-height
    ///         a  dd:Measurement ;
    ...
    ///   <para>dc11:description : An example of usage of the class 'Measurement collection' is the following:
    ...
    ///         dd:hasMeasurement resource:Measurement/1200865132-1-width , resource:Measurement/1200865132-1-height , resource:Measurement/1200865132-1-depth .dc11:description : Un esempio d'uso della classe "Collezione di misure" è il seguente:
    /// resource:MeasurementCollection/1200865132-1
    ///         a  dd:MeasurementCollection ;
    ...
    /// </summary>
    let anthropologicalMaterialMorphology = _prefixId.prefix "anthropologicalMaterialMorphology"
    ...
    /// </summary>
    let hasCulturalPropertyAccessibility = _prefixId.prefix "hasCulturalPropertyAccessibility"
    ...
    /// </summary>
    let hasCulturalPropertyAvailability = _prefixId.prefix "hasCulturalPropertyAvailability"
    ...
    /// </summary>
    let hasCulturalPropertySpecification = _prefixId.prefix "hasCulturalPropertySpecification"
    ...
    /// </summary>
    let hasIconographicOrDecorativeApparatus = _prefixId.prefix "hasIconographicOrDecorativeApparatus"
    ...
    /// </summary>
    let hasIconographicOrDecorativeApparatusType = _prefixId.prefix "hasIconographicOrDecorativeApparatusType"
    ...
    /// </summary>
    let hasVolumetricDimensionsMeasurement = _prefixId.prefix "hasVolumetricDimensionsMeasurement"
    ...
    /// </summary>
    let includesTechnicalCharacteristic = _prefixId.prefix "includesTechnicalCharacteristic"
    ...
    /// </summary>
    let isCulturalPropertyAccessibilityOf = _prefixId.prefix "isCulturalPropertyAccessibilityOf"
    ...
    /// </summary>
    let isCulturalPropertyAvailabilityOf = _prefixId.prefix "isCulturalPropertyAvailabilityOf"
    ...
    /// </summary>
    let isCulturalPropertyDefinitionOf = _prefixId.prefix "isCulturalPropertyDefinitionOf"
    ...
    /// </summary>
    let isCulturalPropertySpecificationOf = _prefixId.prefix "isCulturalPropertySpecificationOf"
    ...
    /// </summary>
    let isIconographicOrDecorativeApparatusOf = _prefixId.prefix "isIconographicOrDecorativeApparatusOf"
    ...
    /// </summary>
    let isIconographicOrDecorativeApparatusTypeOf = _prefixId.prefix "isIconographicOrDecorativeApparatusTypeOf"
    ...
    /// </summary>
    let isStorageMethodOrColourDepthOf = _prefixId.prefix "isStorageMethodOrColourDepthOf"
    ...
    /// </summary>
    let isTechnicalDescriptionSatisfiedBy = _prefixId.prefix "isTechnicalDescriptionSatisfiedBy"
    ...
    /// </summary>
    let isVolumetricDimensionsMeasurementIn = _prefixId.prefix "isVolumetricDimensionsMeasurementIn"
    ...
    /// </summary>
    let positionInComplexCulturalProperty = _prefixId.prefix "positionInComplexCulturalProperty"
