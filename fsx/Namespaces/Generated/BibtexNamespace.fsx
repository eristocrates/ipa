...
module bibtex =
    let _prefixId = PrefixId.fromNamespaceLabel "http://purl.org/net/nknouf/ns/bibtex#" "bibtex"
    ...
    /// <summary>
    ///   <para>dc11:description : Again, the same issues that arose with the "hasAuthor" property apply here.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : This could be an object property that refers to an external set of institution instances.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : This could optionally be an object property, whereby the range would refer to an external set of journal instances, thus providing standardized abbreviations for different bibliographic styles.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : This is a case where an ObjectProperty might be a better choice, where the range is some set of publisher names defined in another ontology.  That would allow all of the metadata for the publisher to be incorporated as needed.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : As with "hasPublisher", this could be an ObjectProperty that refers to an external set of school instances.^^xsd:string</para>
