...
module esco =
    let _prefixId = PrefixId.fromNamespaceLabel "http://data.europa.eu/esco/model#" "esco"
    ...
    /// </summary>
    let relatedLegallyRequiredQualification = _prefixId.prefix "relatedLegallyRequiredQualification"
