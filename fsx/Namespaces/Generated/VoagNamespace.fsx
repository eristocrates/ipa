...
module voag =
    let _prefixId = PrefixId.fromNamespaceLabel "http://voag.linkedmodel.org/voag#" "voag"
    ...
    /// <summary>
    ///   <para>dc11:description : An event that is associated with the admistration aspect of governance. Typically these are curation events.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An 'Attribution' specifies how credit should be given when citing the creators of a piece of work. Attribution must use the specified attribution text and optionally use logos that are provided in the attribution details below., with the names of points of contact.^^xsd:stringdc11:description : The name, url and other details of an attribution.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A "Governance Process".^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A Governance Event.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : the legal jurisdiction of a license</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An action that may or may not be allowed or desired</para>
    ...
    /// <summary>
    ///   <para>dc11:description : something you may be asked not to do</para>
    ...
    /// <summary>
    ///   <para>dc11:description : an action that may or may not be requested of you</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A potentially copyrightable work</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A "Archival Event".^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A "Assigned Role" with the following instance(s): "Assurer", "Project Management", "Resource &amp; Process Policy", "Technical Definitions", "User", "Verifier".^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : The base class in LMC for enumerated values^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A "Process".^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A "Role" with the following instance(s): "authorizer", "steward", "submitter".^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : captures issues such as raising of an issue related to a particular entity in a registry^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : The status of an issue: "Closed", "Deferred", "Non issue", "Open", "Resolved".^^xsd:string</para>
    ...
    ///   <para>dc11:description : The origin or source of something. The primary purpose of provenance is to capture the time, place, and if appropriate the person responsible, for the creation, production or provisioning of some information object.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A Stakeholder Group is a party of people who have common interests and concerns.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An object property used in governance that refers a resource to the party that is accountable for it.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An object property that specifies that a party governs the approval of a resource.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A short description, typically used on a table or a figure.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : The property 'voag:curatedGraphURI' provides a means to specify the base URI of the specific version of the onotlogy that is being documented.  In each versioned graph the 'vaem:namespace' carries a URI without a version number.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An object propoert that denotes the state of a governance issue.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : The property 'vaem:documentedAt' is intended for general use as the name implies.  In some cases the property could have scalar values and in other cases may need to refer to a first class concept that holds more information about a documentation resource.  For this reason, the  type of this property is set as 'rdf:Property' and the property is rangeless.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An object property that specifies what a party may need to give consent, in the form of agreement, either written or verbally for in the approval of some govenance concern. This is the inverse property of 'mayNeedConcurrenceFrom' and, as such, may be deprecated in the future.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A super-property of governance properties: 'approves', 'gives concurrence for', 'reviews' and 'witness to'.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A document that is of help to application of the subject matter. Documents include specifications, models, standards, guidelines, handbooks and other special publications.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An object property that specifies a process that is used for approval in a 'Governance Protocol'.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An object property that referes to an enumerated value that denotes the state of an approval.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An object property that specifies a process that is used for managing change in a 'Governance Protocol'.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An object property that specifies a level of confidentiality. Typicall the range of this property will be 'voag:Confidentiality'.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An event associated with governance processes.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A pointer to an issue that exists on a subject of interest.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A property to reference an image that is used as a logo.^^xsd:string</para>
    ...
    /// </summary>
    let hasOntologyArchitectureDiagram = _prefixId.prefix "hasOntologyArchitectureDiagram"
    ...
    /// <summary>
    ///   <para>dc11:description : A reference to a description about the pedigree of something.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A reference to a process description.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A pointer to a record that holds governance information for one or more governed entities. Often governance can be shared across entities.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A pointer to a provenance record that details the source, version and time of some subject of interest.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A pointer to the person that is a curator.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Height is typically used to specify an image's height attribute.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : The property 'vaem:image' points  to an image using a URL.^^xsd:string</para>
    ///   <para>rdfs:label : image^^xsd:string</para>
    ///   <a href="http://voag.linkedmodel.org/voag#image">voag:image</a>
    /// </summary>
    let image = _prefixId.prefix "image"
    ...
    /// <summary>
    ///   <para>dc11:description : References to which parties approve an entity.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A boolean property to specify whether or not software is free or open source. Free and open-source software (F/OSS, FOSS) or free/libre/open-source software (FLOSS) is software that is liberally licensed to grant the right of users to use, study, change, and improve its design through the availability of its source code.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A pointer to who is responsible for the governance of some entity of interest. This is a two-way reference with the inverse property 'governs'.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A pointer to parties who have an interest in an entity. This is a two-way reference with the inverse property 'interestIn'.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : An object property that specifies that a party may need to give consent, in the form of agreement, either written or verbally to the approval of some govenance concern.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A boolean flag to indicate if an information asset is propretary.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : References to which parties review a data or information asset.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A pointer to one or more 'GovernedEntities' that replace this entity.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : A pointer to one or more 'GovernedEntities' that are replaced by this entity.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Used to refer to a an RDF XML representation of an ontology^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Used to refer to a Turtle (N3) representation of an ontology^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : The property 'usedBy' is a general property to record a dependency. One use is in stating how a schema or a vocabulary is used by another ontology graph.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:description : Width is typically used to specify an image's width attribute.^^xsd:string</para>
