...
module kees =
    let _prefixId = PrefixId.fromNamespaceLabel "http://linkeddata.center/kees/v1#" "kees"
    ...
    /// <summary>
    ///   <para>dc11:description : How to manage errors during learning phase: is default  dropDataset </para>
    ...
    /// </summary>
    let hasIngestionActivityReportGraph = _prefixId.prefix "hasIngestionActivityReportGraph"
