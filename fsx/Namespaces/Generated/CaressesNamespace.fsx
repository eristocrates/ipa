...
module caresses =
    let _prefixId = PrefixId.fromNamespaceLabel "http://caressesrobot.org/ontology#" "caresses"
    ...
    /// </summary>
    let TopicOneCanHavePreferenceAbout = _prefixId.prefix "TopicOneCanHavePreferenceAbout"
