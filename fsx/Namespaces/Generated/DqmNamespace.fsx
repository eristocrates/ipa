...
module dqm =
    let _prefixId = PrefixId.fromNamespaceLabel "http://purl.org/dqm-vocabulary/v1/dqm#" "dqm"
    ...
    /// </summary>
    let ConditionalPropertyCompletenessRule = _prefixId.prefix "ConditionalPropertyCompletenessRule"
