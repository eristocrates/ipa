...
module aws =
    let _prefixId = PrefixId.fromNamespaceLabel "http://purl.oclc.org/NET/ssnx/meteo/aws#" "aws"

    /// <summary>
    ///   <para>dc11:source : skos:closeMatch albedometer [GAMP 2.3.1.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch aneroid displacement transducer [CIMO Guide 3.3.1] http://www.wmo.int/pages/prog/www/IMOP/publications/CIMO-Guide/CIMO%20Guide%207th%20Edition,%202008/Part%20I/Chapter%203.pdf^^xsd:string</para>
    ...
    /// </summary>
    let AtmometerOrSmallSurfaceEvaporimeter = _prefixId.prefix "AtmometerOrSmallSurfaceEvaporimeter"
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Automatic sunshine recorder [GAMP 2.4.1.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Campbell-Stokes sunshine meter [GAMP 2.4.1.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    ///   <para>dc11:source : skos:closeMatch capacitance sensor [ET-AWS] http://www.hydrometeoindustry.org/Meetings2010/ET-AWS-6/Doc8[1]-AWS-MetadataCatalogues.pdf^^xsd:string</para>
    ...
    ///   <para>dc11:source : skos:closeMatch Capacitive bead [ET-AWS] http://www.hydrometeoindustry.org/Meetings2010/ET-AWS-6/Doc8[1]-AWS-MetadataCatalogues.pdf^^xsd:string</para>
    ...
    ///   <para>dc11:source : chilled-mirror hygrometer [ET-AWS] http://www.hydrometeoindustry.org/Meetings2010/ET-AWS-6/Doc8[1]-AWS-MetadataCatalogues.pdf^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Chilled mirror system [ET-AWS] http://www.hydrometeoindustry.org/Meetings2010/ET-AWS-6/Doc8[1]-AWS-MetadataCatalogues.pdf^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Cup anemometer [GAMP 2.4.1.5] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch cylindrical resonator barometer [CIMO Guide 3.3.1] http://www.wmo.int/pages/prog/www/IMOP/publications/CIMO-Guide/CIMO%20Guide%207th%20Edition,%202008/Part%20I/Chapter%203.pdf^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : dew cell [ET-AWS] http://www.hydrometeoindustry.org/Meetings2010/ET-AWS-6/Doc8[1]-AWS-MetadataCatalogues.pdf^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Dewcel system [ET-AWS] http://www.hydrometeoindustry.org/Meetings2010/ET-AWS-6/Doc8[1]-AWS-MetadataCatalogues.pdf^^xsd:string</para>
    ...
    ///   <para>dc11:source : skos:closeMatch Differential expansion thermometer [GAMP 2.4.1.2] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ///   <a href="http://purl.oclc.org/NET/ssnx/meteo/aws#DifferentialExpansionThermometer">aws:DifferentialExpansionThermometer</a>
    /// </summary>
    let DifferentialExpansionThermometer = _prefixId.prefix "DifferentialExpansionThermometer"

    /// <summary>
    ///   <para>dc11:source : skos:closeMatch digital piezo-resistive barometer [CIMO Guide 3.3.1] http://www.wmo.int/pages/prog/www/IMOP/publications/CIMO-Guide/CIMO%20Guide%207th%20Edition,%202008/Part%20I/Chapter%203.pdf^^xsd:string</para>
    ...
    /// </summary>
    let DigitalPiezoResistiveBarometer = _prefixId.prefix "DigitalPiezoResistiveBarometer"
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Drop counters [ET-AWS] http://www.hydrometeoindustry.org/Meetings2010/ET-AWS-6/Doc8[1]-AWS-MetadataCatalogues.pdf^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch electric sensor, which exploits the conductivity variation as a function of wetness [GAMP 2.4.1.6.3] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// </summary>
    let ElectricSensorWhichExploitsTheConductivityVariationAsAFunctionOfWetness = _prefixId.prefix "ElectricSensorWhichExploitsTheConductivityVariationAsAFunctionOfWetness"

    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Electrical resistance block [GAMP 2.4.1.6.2] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    ///   <para>dc11:source : skos:closeMatch electrical resistance humidity sensor [ET-AWS] http://www.hydrometeoindustry.org/Meetings2010/ET-AWS-6/Doc8[1]-AWS-MetadataCatalogues.pdf^^xsd:string</para>
    ///   <a href="http://purl.oclc.org/NET/ssnx/meteo/aws#ElectricalResistanceHumiditySensor">aws:ElectricalResistanceHumiditySensor</a>
    /// </summary>
    let ElectricalResistanceHumiditySensor = _prefixId.prefix "ElectricalResistanceHumiditySensor"

    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Resistance thermometer [GAMP 2.4.1.2] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// </summary>
    let ElectricalResistanceThermometer = _prefixId.prefix "ElectricalResistanceThermometer"
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Frequency domain reflectometry (capacitance).................................................... [Soil Water Monitoring] http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.118.567&amp;rep=rep1&amp;type=pdf^^xsd:string</para>
    ...
    /// </summary>
    let FrequencyDomainReflectometryCapacitance = _prefixId.prefix "FrequencyDomainReflectometryCapacitance"

    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Gamma absorption [GAMP 2.4.1.6.2] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Hot-bead anemometer [GAMP 2.4.1.5] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Hot-wire anemometer [GAMP 2.4.1.5] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// </summary>
    let HydraulicLysimeterMoreRobustWeighingType = _prefixId.prefix "HydraulicLysimeterMoreRobustWeighingType"

    /// <summary>
    ///   <para>rdfs:label : Impact disdrometer^^xsd:string</para>
    ///   <para>dc11:source : skos:closeMatch Impact disdrometer [IOM-99_FI-RI 2.2.2b] http://www.wmo.int/pages/prog/www/IMOP/publications/IOM-99_FI-RI.pdf^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Infra-red gas analyzer hygrometer [GAMP 2.4.1.6.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Kata thermometer [GAMP 2.4.1.2] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Laser [ET-AWS] http://www.hydrometeoindustry.org/Meetings2010/ET-AWS-6/Doc8[1]-AWS-MetadataCatalogues.pdf^^xsd:string</para>
    ...
    ///   <para>dc11:source : skos:closeMatch Level measurement rain gauge (LRG) [IOM-99_FI-RI 2.2.1e] http://www.wmo.int/pages/prog/www/IMOP/publications/IOM-99_FI-RI.pdf^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch lysimeter [GAMP 2.4.1.8.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ///   <para>rdfs:comment : Lysimeters are used for measurement of evaporation, transpiration, evapotranspiration (ET), effective rainfall, drainage, chemical contents of drainage water, to study climatic effects of ET on the performance of crops.^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch conventional aneroid barometer [CIMO Guide 3.4] http://www.wmo.int/pages/prog/www/IMOP/publications/CIMO-Guide/CIMO%20Guide%207th%20Edition,%202008/Part%20I/Chapter%203.pdf^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch mechanical hygrometer [GAMP 2.4.1.6.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch mechanical sensor with recorder [GAMP 2.4.1.6.3] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Mercury barometer [CIMO Guide 3.2] http://www.wmo.int/pages/prog/www/IMOP/publications/CIMO-Guide/CIMO%20Guide%207th%20Edition,%202008/Part%20I/Chapter%203.pdf^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Microwave radar disdrometer [IOM-99_FI-RI 2.2.2c] http://www.wmo.int/pages/prog/www/IMOP/publications/IOM-99_FI-RI.pdf^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Net radiometers or net pyrradiometers or net exchange radiometers or balancemeters [GAMP 2.4.1.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// </summary>
    let NetRadiometerOrNetPyrradiometerOrNetExchangeRadiometerOrBalancemeter = _prefixId.prefix "NetRadiometerOrNetPyrradiometerOrNetExchangeRadiometerOrBalancemeter"

    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Neutron probe [GAMP 2.4.1.6.2] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Optical/Capacitive sensor [IOM-99_FI-RI 2.2.2d] http://www.wmo.int/pages/prog/www/IMOP/publications/IOM-99_FI-RI.pdf^^xsd:string</para>
    ...
    ///   <para>dc11:source : skos:closeMatch Optical disdrometer [IOM-99_FI-RI 2.2.2a] http://www.wmo.int/pages/prog/www/IMOP/publications/IOM-99_FI-RI.pdf^^xsd:string</para>
    ...
    /// </summary>
    let PopoffLysimeterCombinedDrainageAndWeighingType = _prefixId.prefix "PopoffLysimeterCombinedDrainageAndWeighingType"

    /// <summary>
    ///   <para>dc11:source : skos:closeMatch portable aspirated and shielded psychrometer [GAMP 2.4.1.6.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// </summary>
    let PortableAspiratedAndShieldedPsychrometer = _prefixId.prefix "PortableAspiratedAndShieldedPsychrometer"
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Pressure tube anemometer [GAMP 2.4.1.5] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Propeller and vane anemometer [GAMP 2.4.1.5] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch psychrometer equipped with mercury-in-glass thermometer [GAMP 2.4.1.6.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// </summary>
    let PsychrometerEquippedWithMercuryInGlassThermometer = _prefixId.prefix "PsychrometerEquippedWithMercuryInGlassThermometer"

    /// <summary>
    ///   <para>dc11:source : skos:closeMatch solarimeter (pyranometer) [GAMP 2.3.1.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ///   <para>rdfs:comment : total solar irradiance on a horizontal surface^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:broaderMatch solarimeter (pyranometer) [GAMP 2.3.1.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch pyrgeometer [GAMP 2.4.1.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch quantum sensor [GAMP 2.4.1.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch screened and open pan evaporimeter [GAMP 2.4.1.8.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// </summary>
    let ScreenedAndOpenPanEvaporimeter = _prefixId.prefix "ScreenedAndOpenPanEvaporimeter"
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Single or double-junction peltier psychrometer [GAMP 2.4.1.6.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// </summary>
    let SingleOrDoubleJunctionPeltierPsychrometer = _prefixId.prefix "SingleOrDoubleJunctionPeltierPsychrometer"

    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Snow gauge [GAMP 2.4.1.7] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Snow pillow [ET-AWS] http://www.hydrometeoindustry.org/Meetings2010/ET-AWS-6/Doc8[1]-AWS-MetadataCatalogues.pdf^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Sonic ranging [ET-AWS] http://www.hydrometeoindustry.org/Meetings2010/ET-AWS-6/Doc8[1]-AWS-MetadataCatalogues.pdf^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch surface temperature radiometer [GAMP 2.4.1.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Tensiometer [GAMP 2.4.1.6.2] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    ///   <para>dc11:source : skos:closeMatch Thermistor [GAMP 2.4.1.2] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    ///   <para>dc11:source : skos:closeMatch Thermocouple [GAMP 2.4.1.2] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    /// </summary>
    let ThornthwaiteLysimeterDrainageType = _prefixId.prefix "ThornthwaiteLysimeterDrainageType"

    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Time Domain Reflectometry [GAMP 2.4.1.6.2] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    ///   <para>dc11:source : skos:closeMatch Tipping bucket rain gauge [IOM-99_FI-RI 2.2.1a-d] http://www.wmo.int/pages/prog/www/IMOP/publications/IOM-99_FI-RI.pdf^^xsd:string</para>
    ...
    /// </summary>
    let TippingBucketRainGaugeTbrgWithoutCorrection = _prefixId.prefix "TippingBucketRainGaugeTbrgWithoutCorrection"
    ...
    /// </summary>
    let TippingBucketRainGaugeWithCorrectionAlgorithmTbrgSc = _prefixId.prefix "TippingBucketRainGaugeWithCorrectionAlgorithmTbrgSc"
    ...
    /// </summary>
    let TippingBucketRainGaugeWithExtraPulseCorrectionTbrgPc = _prefixId.prefix "TippingBucketRainGaugeWithExtraPulseCorrectionTbrgPc"
    ...
    /// </summary>
    let TippingBucketRainGaugeWithMechanicalCorrectionTbrgMc = _prefixId.prefix "TippingBucketRainGaugeWithMechanicalCorrectionTbrgMc"

    /// <summary>
    ///   <para>dc11:source : skos:closeMatch tube solarimeter [GAMP 2.4.1.1] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    ///   <para>dc11:source : skos:closeMatch Ultrasonic Sensor (virtual temperature) [ET-AWS] http://www.hydrometeoindustry.org/Meetings2010/ET-AWS-6/Doc8[1]-AWS-MetadataCatalogues.pdf^^xsd:string</para>
    ///   <a href="http://purl.oclc.org/NET/ssnx/meteo/aws#UltrasonicSensorVirtualTemperature">aws:UltrasonicSensorVirtualTemperature</a>
    /// </summary>
    let UltrasonicSensorVirtualTemperature = _prefixId.prefix "UltrasonicSensorVirtualTemperature"

    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Sonic anemometer [GAMP 2.4.1.5] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
    ...
    ///   <para>dc11:source : skos:closeMatch Weighing rain gauge (WG) [IOM-99_FI-RI 2.2.1g-h] http://www.wmo.int/pages/prog/www/IMOP/publications/IOM-99_FI-RI.pdf^^xsd:string</para>
    ...
    /// </summary>
    let WeighingRainGaugeWithPressureMeasurement = _prefixId.prefix "WeighingRainGaugeWithPressureMeasurement"

    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Wet-bulb temperature measurement system [ET-AWS] http://www.hydrometeoindustry.org/Meetings2010/ET-AWS-6/Doc8[1]-AWS-MetadataCatalogues.pdf^^xsd:string</para>
    ...
    /// </summary>
    let WetBulbTemperatureMeasurementSystem = _prefixId.prefix "WetBulbTemperatureMeasurementSystem"

    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Wetting front detection [Soil Water Monitoring] http://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.118.567&amp;rep=rep1&amp;type=pdf^^xsd:string</para>
    ...
    /// <summary>
    ///   <para>dc11:source : skos:closeMatch Wind Vane [GAMP 2.4.1.5] http://www.wmo.int/pages/prog/wcp/agm/gamp/gamp_en.html^^xsd:string</para>
