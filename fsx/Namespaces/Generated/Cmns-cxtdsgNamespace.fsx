...
module ``cmns-cxtdsg`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/ContextualDesignators/" "cmns-cxtdsg"

    let _namespaceIri = _prefixId.prefix ""
    /// <summary>
    ///   <para>rdfs:label : context^^xsd:string</para>
    ///   <para>dcterms:source : ISO 1087 Terminology work and terminology science - Vocabulary, Second edition, 2019-09, clause 3.6.5^^xsd:stringdcterms:source : ISO/IEC 11179-3 Information technology - Metadata registries (MDR) - Part 3: Registry metamodel and basic attributes, Third edition, 2013-02-15^^xsd:string</para>
