...
module bbccms =
    let _prefixId = PrefixId.fromNamespaceLabel "http://www.bbc.co.uk/ontologies/cms/" "bbccms"

    let _3'_period_'6 = _prefixId.prefix "3.6"
    let _3'_period_'7 = _prefixId.prefix "3.7"
    /// <summary>
