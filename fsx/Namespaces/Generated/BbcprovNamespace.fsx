...
module bbcprov =
    let _prefixId = PrefixId.fromNamespaceLabel "http://www.bbc.co.uk/ontologies/provenance/" "bbcprov"

    let _1'_period_'8 = _prefixId.prefix "1.8"
    let _1'_period_'9 = _prefixId.prefix "1.9"
    /// <summary>
