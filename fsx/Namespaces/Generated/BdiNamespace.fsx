...
module bdi =
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/BeliefProcess">bdi:BeliefProcess</a>
    /// </summary>
    let BeliefProcess = _prefixId.prefix "BeliefProcess"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : Desire</para>
    ///   <para>rdfs:comment : The Desire class represents a motivational mental state of an agent, encapsulating what the agent wishes or aspires to bring about in the world. Desires are expressions of preferences or goals, but unlike intentions, they do not imply a commitment to act. Desires serve as the driving force behind an agent’s decision-making process, often interacting with beliefs and intentions to influence behaviour.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/Desire">bdi:Desire</a>
    /// </summary>
    let Desire = _prefixId.prefix "Desire"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : Desire Formation</para>
    ///   <para>rdfs:comment : DesireFormation is the mental process by which an agent generates, modifies, or updates desires based on internal motivations, contextual changes, or interactions with external information sources. This process helps agents structure goal-oriented behaviour before intentions are formed.
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/Goal">bdi:Goal</a>
    /// </summary>
    let Goal = _prefixId.prefix "Goal"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : Goal Process</para>
    ///   <para>rdfs:comment : GoalProcess is the mental process by which an agent generates, refines, or revises goals based on its current desires, beliefs, and contextual conditions. This process bridges the motivational layer of the agent, where desires express general preferences, and the deliberative layer, where  intentions represent committed courses of action. By elaborating and prioritising goals, the GoalProcess determines which desired outcomes are worth pursuing and prepares them for adoption as actionable intentions.
    ///
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/GoalProcess">bdi:GoalProcess</a>
    /// </summary>
    let GoalProcess = _prefixId.prefix "GoalProcess"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : Intention</para>
    ///   <para>rdfs:comment : The Intention class represents a deliberative mental state of an agent, characterised by the agent’s commitment to achieving a specific goal or executing a plan. Unlike a desire, which expresses a motivational preference, an intention reflects a higher degree of resolve, where the agent actively decides to pursue the desired outcome.
    ///
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/Intention">bdi:Intention</a>
    /// </summary>
    let Intention = _prefixId.prefix "Intention"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : Intention Formation</para>
    ///   <para>rdfs:comment : IntentionFormation is the process by which an agent selects, commits to, and refines intentions based on its desires, available resources, and deliberative reasoning. It determines which desires are pursued as actionable commitments and adapts them as new information emerges.
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/addresses">bdi:addresses</a>
    /// </summary>
    let addresses = _prefixId.prefix "addresses"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : affects</para>
    ///   <para>rdfs:comment : The object property affects links a MentalProcess to the MentalState(s)
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/affects">bdi:affects</a>
    /// </summary>
    let affects = _prefixId.prefix "affects"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : at time</para>
    ///   <para>rdfs:comment : The 'at time' property represents the relationship between a mental entity (such as a belief, desire, or intention) and the temporal entity it produces  or influences. This property is used to model how mental states give rise to time-bound events, processes, or commitments.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/atTime">bdi:atTime</a>
    /// </summary>
    let atTime = _prefixId.prefix "atTime"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : begins with</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/beginsWith">bdi:beginsWith</a>
    /// </summary>
    let beginsWith = _prefixId.prefix "beginsWith"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : brings about</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/bringsAbout">bdi:bringsAbout</a>
    /// </summary>
    let bringsAbout = _prefixId.prefix "bringsAbout"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : cognises</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/cognises">bdi:cognises</a>
    /// </summary>
    let cognises = _prefixId.prefix "cognises"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : defines</para>
    ///   <para>rdfs:comment : Relates a Planning entity to one or more Plans, defining the structured actions an agent intends to execute to fulfill its intentions.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/defines">bdi:defines</a>
    /// </summary>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/endsWith">bdi:endsWith</a>
    /// </summary>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/executes">bdi:executes</a>
    /// </summary>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/follows">bdi:follows</a>
    /// </summary>
    let follows = _prefixId.prefix "follows"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : fulfills</para>
    ///   <para>rdfs:comment : The fulfills property links an entity, such as an intention or a plan, to the goal it is designed to achieve. It represents the relationship between an agent's commitment or strategy and the desired outcome.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/fulfills">bdi:fulfills</a>
    /// </summary>
    let fulfills = _prefixId.prefix "fulfills"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : generates</para>
    ///   <para>rdfs:comment : The object property generates is a subproperty of :affects and captures
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/generates">bdi:generates</a>
    /// </summary>
    let generates = _prefixId.prefix "generates"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : has belief</para>
    ///   <para>rdfs:comment : The hasBelief property links an agent to the belief(s) they hold, representing the agent’s informational state about the world.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/hasBelief">bdi:hasBelief</a>
    /// </summary>
    let hasBelief = _prefixId.prefix "hasBelief"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/hasBeliefProcess">bdi:hasBeliefProcess</a>
    /// </summary>
    let hasBeliefProcess = _prefixId.prefix "hasBeliefProcess"
    /// <summary>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/hasComponent">bdi:hasComponent</a>
    /// </summary>
    let hasComponent = _prefixId.prefix "hasComponent"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : has desire</para>
    ///   <para>rdfs:comment : The hasDesire property links an agent to the desire(s) they aspire to achieve, representing the agent’s motivational preferences.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/hasDesire">bdi:hasDesire</a>
    /// </summary>
    let hasDesire = _prefixId.prefix "hasDesire"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/hasDesireProcess">bdi:hasDesireProcess</a>
    /// </summary>
    let hasDesireProcess = _prefixId.prefix "hasDesireProcess"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : has end time</para>
    ///   <para>rdfs:comment : Defines the temporal istant by specifying when a TimeInterval concludes. This is essential for modeling the execution timeframe of an agent’s plans, actions, or mental states.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/hasEndTime">bdi:hasEndTime</a>
    /// </summary>
    let hasEndTime = _prefixId.prefix "hasEndTime"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : has intention</para>
    ///   <para>rdfs:comment : The hasIntention property links an agent to the intention(s) they commit to, representing the agent’s deliberative state for action.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/hasIntention">bdi:hasIntention</a>
    /// </summary>
    let hasIntention = _prefixId.prefix "hasIntention"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/hasIntentionProcess">bdi:hasIntentionProcess</a>
    /// </summary>
    let hasIntentionProcess = _prefixId.prefix "hasIntentionProcess"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : has mental process</para>
    ///   <para>rdfs:comment : "The hasMentalProcess property is an object property that links an agent to one or more of its mental process, such as beliefs formation, desires formation, or intentions formation. It establishes a relationship between the agent (as the holder of mental process) and the abstract representations of those states, enabling changing the agent's mental state.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/hasMentalProcess">bdi:hasMentalProcess</a>
    /// </summary>
    let hasMentalProcess = _prefixId.prefix "hasMentalProcess"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:comment : has mental staterdfs:comment : The hasMentalState property is an object property that links an agent to one or more of its mental states, such as beliefs, desires, or intentions. It establishes a relationship between the agent (as the holder of mental states) and the abstract representations of those states, enabling reasoning about the agent's internal cognitive or motivational processes.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/hasMentalState">bdi:hasMentalState</a>
    /// </summary>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/hasPart">bdi:hasPart</a>
    /// </summary>
    let hasPart = _prefixId.prefix "hasPart"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/hasPlanning">bdi:hasPlanning</a>
    /// </summary>
    let hasPlanning = _prefixId.prefix "hasPlanning"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : has start time</para>
    ///   <para>rdfs:comment : Defines the temporal istant by specifying when a TimeInterval starts. This is essential for modeling the execution timeframe of an agent’s plans, actions, or mental states.^^xsd:string</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/hasStartTime">bdi:hasStartTime</a>
    /// </summary>
    let hasStartTime = _prefixId.prefix "hasStartTime"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : has temporal validity</para>
    ///   <para>rdfs:comment : The hasValidity property links an entity to a TemporalEntity during which it is valid, active, or applicable. This property represents the temporal scope or extent of the entity's relevance or operation.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/hasValidity">bdi:hasValidity</a>
    /// </summary>
    let hasValidity = _prefixId.prefix "hasValidity"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is addressed by</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isAddressedBy">bdi:isAddressedBy</a>
    /// </summary>
    let isAddressedBy = _prefixId.prefix "isAddressedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is affected by</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isAffectedBy">bdi:isAffectedBy</a>
    /// </summary>
    let isAffectedBy = _prefixId.prefix "isAffectedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is belief of</para>
    ///   <para>rdfs:comment : The isBeliefOf property links a belief to the agent that holds it.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isBeliefOf">bdi:isBeliefOf</a>
    /// </summary>
    let isBeliefOf = _prefixId.prefix "isBeliefOf"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isBeliefProcessOf">bdi:isBeliefProcessOf</a>
    /// </summary>
    let isBeliefProcessOf = _prefixId.prefix "isBeliefProcessOf"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is cognised by</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isCognisedBy">bdi:isCognisedBy</a>
    /// </summary>
    let isCognisedBy = _prefixId.prefix "isCognisedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isComponentOf">bdi:isComponentOf</a>
    /// </summary>
    let isComponentOf = _prefixId.prefix "isComponentOf"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is defined by</para>
    ///   <para>rdfs:comment : Indicates that a Plan instance is defined by a specific Planning entity.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isDefinedBy">bdi:isDefinedBy</a>
    /// </summary>
    let isDefinedBy = _prefixId.prefix "isDefinedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is desire of</para>
    ///   <para>rdfs:comment : The isDesireOf property links a desire to the agent that holds it.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isDesireOf">bdi:isDesireOf</a>
    /// </summary>
    let isDesireOf = _prefixId.prefix "isDesireOf"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isDesireProcessOf">bdi:isDesireProcessOf</a>
    /// </summary>
    let isDesireProcessOf = _prefixId.prefix "isDesireProcessOf"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isExecutedBy">bdi:isExecutedBy</a>
    /// </summary>
    let isExecutedBy = _prefixId.prefix "isExecutedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:comment : is fulfilled byrdfs:comment : The isFulfilledBy property is the inverse of fulfills. It links a goal to the intention(s) or plan(s) that are committed to or designed to achieve it. This property enables reasoning from the perspective of goals to identify the entities working toward their fulfilment.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isFulfilledBy">bdi:isFulfilledBy</a>
    /// </summary>
    let isFulfilledBy = _prefixId.prefix "isFulfilledBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isGeneratedBy">bdi:isGeneratedBy</a>
    /// </summary>
    let isGeneratedBy = _prefixId.prefix "isGeneratedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is intention of</para>
    ///   <para>rdfs:comment : The isIntentionOf property links an intention to the agent that holds it.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isIntentionOf">bdi:isIntentionOf</a>
    /// </summary>
    let isIntentionOf = _prefixId.prefix "isIntentionOf"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isIntentionProcessOf">bdi:isIntentionProcessOf</a>
    /// </summary>
    let isIntentionProcessOf = _prefixId.prefix "isIntentionProcessOf"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is justified by</para>
    ///   <para>rdfs:comment : The isJustifiedBy property is the inverse of justifies. It links a mental entity to the justification(s) that support it, enabling reasoning about the basis for the mental entity.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isJustifiedBy">bdi:isJustifiedBy</a>
    /// </summary>
    let isJustifiedBy = _prefixId.prefix "isJustifiedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is mental process of</para>
    ///   <para>rdfs:comment : The isMentalProcessOf property is the inverse object property of hasMentalProcess. It links a mental priocess (such as a belief formation, desire formation, or intentio formationn) to the agent that holds it. This property allows for reasoning and querying in the opposite direction, starting from a mental process and identifying the associated agent.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isMentalProcessOf">bdi:isMentalProcessOf</a>
    /// </summary>
    let isMentalProcessOf = _prefixId.prefix "isMentalProcessOf"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is mental state of</para>
    ///   <para>rdfs:comment : The isMentalStateOf property is the inverse object property of hasMentalState. It links a mental state (such as a belief, desire, or intention) to the agent that holds it. This property allows for reasoning and querying in the opposite direction, starting from a mental state and identifying the associated agent.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isMentalStateOf">bdi:isMentalStateOf</a>
    /// </summary>
    let isMentalStateOf = _prefixId.prefix "isMentalStateOf"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is modified by</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isModifiedBy">bdi:isModifiedBy</a>
    /// </summary>
    let isModifiedBy = _prefixId.prefix "isModifiedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is desire motivated by</para>
    ///   <para>rdfs:comment : The isDesireMotivatedBy property is the inverse of motivatesDesire. It links a desire to the belief(s) that provide the motivational basis for its formation. This property captures the relationship where a belief influences an agent to form or hold a specific desire.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isMotivatedBy">bdi:isMotivatedBy</a>
    /// </summary>
    let isMotivatedBy = _prefixId.prefix "isMotivatedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is part of</para>
    ///   <para>rdfs:comment : The object property isPartOf represents the inverse of hasPart,
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isPartOf">bdi:isPartOf</a>
    /// </summary>
    let isPartOf = _prefixId.prefix "isPartOf"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is perceived by</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isPerceivedBy">bdi:isPerceivedBy</a>
    /// </summary>
    let isPerceivedBy = _prefixId.prefix "isPerceivedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isPlanningOf">bdi:isPlanningOf</a>
    /// </summary>
    let isPlanningOf = _prefixId.prefix "isPlanningOf"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is processed by</para>
    ///   <para>rdfs:comment : Indicates that a MentalProcess is performed or carried out by a specific Agent as part of its cognitive activities^^xsd:string</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isProcessedBy">bdi:isProcessedBy</a>
    /// </summary>
    let isProcessedBy = _prefixId.prefix "isProcessedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is reasoned upon by</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isReasonedUponBy">bdi:isReasonedUponBy</a>
    /// </summary>
    let isReasonedUponBy = _prefixId.prefix "isReasonedUponBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is referred by</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isReferredBy">bdi:isReferredBy</a>
    /// </summary>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isSatisfiedBy">bdi:isSatisfiedBy</a>
    /// </summary>
    let isSatisfiedBy = _prefixId.prefix "isSatisfiedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is specified by</para>
    ///   <para>rdfs:comment : The isSpecifiedBy property is the inverse of specifiesPlan. It links a plan to the intention it is designed to fulfil, enabling reasoning about the motivational context behind the plan.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isSpecifiedBy">bdi:isSpecifiedBy</a>
    /// </summary>
    let isSpecifiedBy = _prefixId.prefix "isSpecifiedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is intention supported by</para>
    ///   <para>rdfs:comment : The isIntentionSupportedBy property is the inverse of supportsIntention. It links an intention to the belief(s) that justify or support the agent’s decision to pursue it.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isSupportedBy">bdi:isSupportedBy</a>
    /// </summary>
    let isSupportedBy = _prefixId.prefix "isSupportedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is suppressed by</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isSuppressedBy">bdi:isSuppressedBy</a>
    /// </summary>
    let isSuppressedBy = _prefixId.prefix "isSuppressedBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is temporal validity of</para>
    ///   <para>rdfs:comment : The isTemporalValidityOf property is the inverse of hasTemporalValidity. It links a TimeInterval to the entity it defines the temporal validity for, specifying the time period during which the entity is active or applicable.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isTemporalValidityOf">bdi:isTemporalValidityOf</a>
    /// </summary>
    let isTemporalValidityOf = _prefixId.prefix "isTemporalValidityOf"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : is triggered by</para>
    ///   <para>rdfs:comment : Indicates that a MentalProcess is initiated or caused by a specific mental entity, leading to a modification in the agent’s cognitive state.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/isTriggeredBy">bdi:isTriggeredBy</a>
    /// </summary>
    let isTriggeredBy = _prefixId.prefix "isTriggeredBy"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : justifies</para>
    ///   <para>rdfs:comment : The justifies property links a justification to the mental entity it supports, providing the rationale, evidence, or explanation for why the mental entity is held.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/justifies">bdi:justifies</a>
    /// </summary>
    let justifies = _prefixId.prefix "justifies"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : modifies</para>
    ///   <para>rdfs:comment : The object property modifies is a subproperty of :affects and describes
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/modifies">bdi:modifies</a>
    /// </summary>
    let modifies = _prefixId.prefix "modifies"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : motivates desire</para>
    ///   <para>rdfs:comment : Beliefs often influence or motivate the formation of desires. For example, if an agent believes that exercising improves health, this belief may motivate a desire to exercise.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/motivates">bdi:motivates</a>
    /// </summary>
    let motivates = _prefixId.prefix "motivates"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : perceives</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/perceives">bdi:perceives</a>
    /// </summary>
    let perceives = _prefixId.prefix "perceives"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/precedes">bdi:precedes</a>
    /// </summary>
    let precedes = _prefixId.prefix "precedes"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : processes</para>
    ///   <para>rdfs:comment : Represents the relationship where an Agent actively engages in a MentalProcess, such as evaluating beliefs, forming desires, or adopting intentions, as part of its cognitive functioning within a BDI framework.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/processes">bdi:processes</a>
    /// </summary>
    let processes = _prefixId.prefix "processes"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : reasons upon</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/reasonsUpon">bdi:reasonsUpon</a>
    /// </summary>
    let reasonsUpon = _prefixId.prefix "reasonsUpon"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/refersTo">bdi:refersTo</a>
    /// </summary>
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/satisfies">bdi:satisfies</a>
    /// </summary>
    let satisfies = _prefixId.prefix "satisfies"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : specifies</para>
    ///   <para>rdfs:comment : The specifies property links an intention to the plan that operationalises it. This property represents how an agent’s commitment to achieving a goal (intention) is translated into a structured sequence of actions (plan).</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/specifies">bdi:specifies</a>
    /// </summary>
    let specifies = _prefixId.prefix "specifies"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : supports intention</para>
    ///   <para>rdfs:comment : The supportsIntention property links a belief to the intention it provides justification or epistemic support for, representing the reasoning or evidence behind the agent’s commitment to act.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/supports">bdi:supports</a>
    /// </summary>
    let supports = _prefixId.prefix "supports"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : suppresses</para>
    ///   <para>rdfs:comment : The object property suppresses is a subproperty of :affects and models
    ...
    ///   <a href="https://w3id.org/fossr/ontology/bdi/suppresses">bdi:suppresses</a>
    /// </summary>
    let suppresses = _prefixId.prefix "suppresses"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : time</para>
    ///   <para>rdfs:comment : Specifies the value of a temporal entity.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/time">bdi:time</a>
    /// </summary>
    let time = _prefixId.prefix "time"
    /// <summary>
    ///   <para>vs:term_status : stable^^xsd:string</para>
    ///   <para>rdfs:label : triggers</para>
    ///   <para>rdfs:comment : Defines a causal relationship where a Mental Entity triggers a MentalProcess, leading to a change in the agent’s internal state, such as updating beliefs, forming new desires, or adopting intentions.</para>
    ///   <a href="https://w3id.org/fossr/ontology/bdi/triggers">bdi:triggers</a>
    /// </summary>
