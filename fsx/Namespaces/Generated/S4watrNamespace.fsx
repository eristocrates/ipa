...
module s4watr =
    let _prefixId = PrefixId.fromNamespaceLabel "https://saref.etsi.org/saref4watr/" "s4watr"
    ...
    let PolycyclicAromaticHydrocarbons = _prefixId.prefix "PolycyclicAromaticHydrocarbons"
