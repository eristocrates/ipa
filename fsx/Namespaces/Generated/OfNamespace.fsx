...
module ``of`` =
    let _prefixId = PrefixId.fromNamespaceLabel "http://owlrep.eu01.aws.af.cm/fridge#" "of"
    ...
    /// </summary>
    let observationPropertyFillingLevel = _prefixId.prefix "observationPropertyFillingLevel"
    ...
    /// </summary>
    let observationPropertyNumberOfOpening = _prefixId.prefix "observationPropertyNumberOfOpening"
    ...
    /// </summary>
    let observationPropertyRoomTemperature = _prefixId.prefix "observationPropertyRoomTemperature"
    ...
    /// </summary>
    let observationPropertyTemperature = _prefixId.prefix "observationPropertyTemperature"
