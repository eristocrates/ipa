...
module cold =
    let _prefixId = PrefixId.fromNamespaceLabel "http://purl.org/configurationontology#" "cold"
    ...
    /// </summary>
    let CompletelyDefinedConfiguration = _prefixId.prefix "CompletelyDefinedConfiguration"
