...
module scoro =
    ...
    /// <summary>
    ///   <para>dc11:description : A contribution situation describes always:
    ...
    let builds_and_or_maintains_instruments = _prefixId.prefix "builds-and-or-maintains-instruments"
    ...
    let creates_novel_organisms_or_cells = _prefixId.prefix "creates-novel-organisms-or-cells"
    ...
    ///   <para>dc11:description : owl:equivalentProperty &lt;http://purl.org/spar/frapo/hasORCID&gt; .</para>
    ///   <a href="http://purl.org/spar/scoro/hasORCID">scoro:hasORCID</a>
    /// </summary>
    let hasORCID = _prefixId.prefix "hasORCID"
    /// <summary>
    ///   <para>dc11:description :  owl:equivalentProperty &lt;http://purl.org/spar/frapo/hasPersonalIdentifier&gt; .dc11:description :  owl:equivalentProperty &lt;http://purl.org/spar/datacite/hasPersonalIdentifier&gt; .</para>
    ...
    /// </summary>
    let isEqualToContributionSituation = _prefixId.prefix "isEqualToContributionSituation"
    ...
    /// </summary>
    let isRelatedToContributionSituation = _prefixId.prefix "isRelatedToContributionSituation"
    ...
    let obtains_and_or_prepares_specimens = _prefixId.prefix "obtains-and-or-prepares-specimens"
    ...
    let prepares_supplementary_information = _prefixId.prefix "prepares-supplementary-information"
    ...
    let provides_administrative_support = _prefixId.prefix "provides-administrative-support"
    ...
    let provides_reagents_specimens_or_materials = _prefixId.prefix "provides-reagents-specimens-or-materials"
    ...
    let provides_tools_equipment_or_facilities = _prefixId.prefix "provides-tools-equipment-or-facilities"
    ...
    let scoro'_period_'png = _prefixId.prefix "scoro.png"
