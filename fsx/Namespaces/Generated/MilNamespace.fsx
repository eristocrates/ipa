...
module mil =
    let _prefixId = PrefixId.fromNamespaceLabel "http://rdf.muninn-project.org/ontologies/military#" "mil"
    ...
    let _1AIFRankCompanyQuartermasterSergeant = _prefixId.prefix "1AIFRankCompanyQuartermasterSergeant"
    ...
    let _1AIFRankRegimentalQuartermasterSergeant = _prefixId.prefix "1AIFRankRegimentalQuartermasterSergeant"

    let _1AIFRankRegimentalSergeantMajor = _prefixId.prefix "1AIFRankRegimentalSergeantMajor"
    ...
    let RankAbleSeaman_Commonwealth_of_Nations = _prefixId.prefix "RankAbleSeaman_Commonwealth_of_Nations"

    let RankBandsmanArmyCanada'_plus_' = _prefixId.prefix "RankBandsmanArmyCanada+"

    let RankBatterySergeantMajorArmyCanada = _prefixId.prefix "RankBatterySergeantMajorArmyCanada"
    ...
    let RankBrigadierGeneralArmyCanada = _prefixId.prefix "RankBrigadierGeneralArmyCanada"
    ...
    let RankClerkArmyCanada'_plus_' = _prefixId.prefix "RankClerkArmyCanada+"
    ...
    let RankCombatMilitaryRank_Soviet_Union = _prefixId.prefix "RankCombatMilitaryRank_Soviet_Union"

    let RankCommandant = _prefixId.prefix "RankCommandant"
    let RankCommandant_France = _prefixId.prefix "RankCommandant_France"

    let RankCommandant_Republic_of_Ireland = _prefixId.prefix "RankCommandant_Republic_of_Ireland"

    let RankCompanyQuarterMasterSergeantArmyCanada'_plus_' = _prefixId.prefix "RankCompanyQuarterMasterSergeantArmyCanada+"

    let RankCompanySergeantMajor = _prefixId.prefix "RankCompanySergeantMajor"

    let RankCompanySergeantMajorArmyCanada = _prefixId.prefix "RankCompanySergeantMajorArmyCanada"

    let RankConductorArmyCanada = _prefixId.prefix "RankConductorArmyCanada"
    let RankCorporalArmyCanada'_plus_' = _prefixId.prefix "RankCorporalArmyCanada+"
    ...
    let RankLanceSergeantArmyCanada'_plus_' = _prefixId.prefix "RankLanceSergeantArmyCanada+"
    ...
    let RankLieutenantColonelArmyCanada = _prefixId.prefix "RankLieutenantColonelArmyCanada"

    let RankLieutenantColonelArmyCanada'_plus_' = _prefixId.prefix "RankLieutenantColonelArmyCanada+"

    let RankLieutenantGeneralArmyCanada = _prefixId.prefix "RankLieutenantGeneralArmyCanada"
    ...
    let RankOrderlyRoomSergeantArmyCanada = _prefixId.prefix "RankOrderlyRoomSergeantArmyCanada"
    ...
    let RankQuartermasterSergeantArmyCanada = _prefixId.prefix "RankQuartermasterSergeantArmyCanada"

    let RankQuartermasterSergeantMajorArmyCanada = _prefixId.prefix "RankQuartermasterSergeantMajorArmyCanada"

    let RankRegimentalSergeantMajorArmyCanada = _prefixId.prefix "RankRegimentalSergeantMajorArmyCanada"
    ...
    let RankSecondLieutenantArmyCanada = _prefixId.prefix "RankSecondLieutenantArmyCanada"
    ...
    let RankSquadronSergeantMajorArmyCanada'_plus_' = _prefixId.prefix "RankSquadronSergeantMajorArmyCanada+"
    ...
    let Rank_Admiral_of_the_Fleet_Russia = _prefixId.prefix "Rank_Admiral_of_the_Fleet_Russia"

    let Rank_Admiral_of_the_Fleet_Russia_Russia = _prefixId.prefix "Rank_Admiral_of_the_Fleet_Russia_Russia"

    let Rank_Admiral_of_the_Fleet_Russia_Soviet_Union = _prefixId.prefix "Rank_Admiral_of_the_Fleet_Russia_Soviet_Union"

    let Rank_Admiral_of_the_fleet_EnglishTradition = _prefixId.prefix "Rank_Admiral_of_the_fleet_EnglishTradition"
    ...
    let Rank_Agha_Septinsular_Republic = _prefixId.prefix "Rank_Agha_Septinsular_Republic"

    let Rank_Air_chief_marshal = _prefixId.prefix "Rank_Air_chief_marshal"

    let Rank_Air_chief_marshal_Australia = _prefixId.prefix "Rank_Air_chief_marshal_Australia"

    let Rank_Air_chief_marshal_Australia_Australia = _prefixId.prefix "Rank_Air_chief_marshal_Australia_Australia"

    let Rank_Air_chief_marshal_Canada = _prefixId.prefix "Rank_Air_chief_marshal_Canada"

    let Rank_Air_chief_marshal_Commonwealth_of_Nations = _prefixId.prefix "Rank_Air_chief_marshal_Commonwealth_of_Nations"

    let Rank_Air_commodore_EnglishTradition = _prefixId.prefix "Rank_Air_commodore_EnglishTradition"

    let Rank_Air_marshal_EnglishTradition = _prefixId.prefix "Rank_Air_marshal_EnglishTradition"

    let Rank_Air_vice_marshal = _prefixId.prefix "Rank_Air_vice-marshal"

    let Rank_Air_vice_marshal_Australia = _prefixId.prefix "Rank_Air_vice-marshal_Australia"

    let Rank_Air_vice_marshal_Canada = _prefixId.prefix "Rank_Air_vice-marshal_Canada"

    let Rank_Air_vice_marshal_Commonwealth_of_Nations = _prefixId.prefix "Rank_Air_vice-marshal_Commonwealth_of_Nations"

    let Rank_Aircraftman_EnglishTradition = _prefixId.prefix "Rank_Aircraftman_EnglishTradition"
    ...
    let Rank_Anthypolochagos_Official_Timocracy_of_Sapinetia = _prefixId.prefix "Rank_Anthypolochagos_Official_Timocracy_of_Sapinetia"

    let Rank_Antisyntagmatarchis = _prefixId.prefix "Rank_Antisyntagmatarchis"

    let Rank_Antisyntagmatarchis_Greece = _prefixId.prefix "Rank_Antisyntagmatarchis_Greece"

    let Rank_Antisyntagmatarchis_Official_Timocracy_of_Sapinetia = _prefixId.prefix "Rank_Antisyntagmatarchis_Official_Timocracy_of_Sapinetia"
    ...
    let Rank_Army_General_Russia_Russia = _prefixId.prefix "Rank_Army_General_Russia_Russia"

    let Rank_Army_General_Russia_Soviet_Union = _prefixId.prefix "Rank_Army_General_Russia_Soviet_Union"
    ...
    let Rank_Birinci_Ferik_Cossack_Hetmanate = _prefixId.prefix "Rank_Birinci_Ferik_Cossack_Hetmanate"

    let Rank_Birinci_Ferik_Ottoman_Empire = _prefixId.prefix "Rank_Birinci_Ferik_Ottoman_Empire"

    let Rank_Birinci_Ferik_Septinsular_Republic = _prefixId.prefix "Rank_Birinci_Ferik_Septinsular_Republic"
    ...
    let Rank_Bombardier_Commonwealth_of_Nations = _prefixId.prefix "Rank_Bombardier_Commonwealth_of_Nations"
    ...
    let Rank_Brigade_General_Australia = _prefixId.prefix "Rank_Brigade_General_Australia"

    let Rank_Brigade_General_Canada = _prefixId.prefix "Rank_Brigade_General_Canada"

    let Rank_Brigadier_EnglishTradition = _prefixId.prefix "Rank_Brigadier_EnglishTradition"

    let Rank_Brigadier_general = _prefixId.prefix "Rank_Brigadier_general"

    let Rank_Brigadier_general_Australia = _prefixId.prefix "Rank_Brigadier_general_Australia"
    ...
    let Rank_Buffer_Navy_Commonwealth_of_Nations = _prefixId.prefix "Rank_Buffer_Navy_Commonwealth_of_Nations"

    let Rank_Captain = _prefixId.prefix "Rank_Captain"

    let ``Rank_Captain_(naval)_EnglishTradition`` = _prefixId.prefix "Rank_Captain_(naval)_EnglishTradition"
    ...
    let Rank_Captain_Lieutenant_Germany = _prefixId.prefix "Rank_Captain_Lieutenant_Germany"

    let Rank_Captain_Lieutenant_Russia = _prefixId.prefix "Rank_Captain_Lieutenant_Russia"

    let Rank_Captain_Lieutenant_Soviet_Union = _prefixId.prefix "Rank_Captain_Lieutenant_Soviet_Union"

    let Rank_Captain_Republic_of_Ireland = _prefixId.prefix "Rank_Captain_Republic_of_Ireland"
    ...
    let Rank_Chief_Marshal_Soviet_Union = _prefixId.prefix "Rank_Chief_Marshal_Soviet_Union"

    let Rank_Chief_petty_officer = _prefixId.prefix "Rank_Chief_petty_officer"

    let ``Rank_Chief_petty_officer,_1st_class`` = _prefixId.prefix "Rank_Chief_petty_officer,_1st_class"

    let ``Rank_Chief_petty_officer,_1st_class_Canada`` = _prefixId.prefix "Rank_Chief_petty_officer,_1st_class_Canada"

    let ``Rank_Chief_petty_officer,_2nd_class`` = _prefixId.prefix "Rank_Chief_petty_officer,_2nd_class"

    let ``Rank_Chief_petty_officer,_2nd_class_Canada`` = _prefixId.prefix "Rank_Chief_petty_officer,_2nd_class_Canada"

    let Rank_Chief_petty_officer_Australia = _prefixId.prefix "Rank_Chief_petty_officer_Australia"

    let Rank_Chief_petty_officer_Canada = _prefixId.prefix "Rank_Chief_petty_officer_Canada"

    let Rank_Chief_petty_officer_Commonwealth_of_Nations = _prefixId.prefix "Rank_Chief_petty_officer_Commonwealth_of_Nations"
    ...
    let Rank_Chiliarch_Byzantine_Empire = _prefixId.prefix "Rank_Chiliarch_Byzantine_Empire"
    ...
    let Rank_Chiliarch_Official_Timocracy_of_Sapinetia = _prefixId.prefix "Rank_Chiliarch_Official_Timocracy_of_Sapinetia"

    let Rank_Chorbaji = _prefixId.prefix "Rank_Chorbaji"

    let Rank_Chorbaji_Cossack_Hetmanate = _prefixId.prefix "Rank_Chorbaji_Cossack_Hetmanate"

    let Rank_Chorbaji_Ottoman_Empire = _prefixId.prefix "Rank_Chorbaji_Ottoman_Empire"

    let Rank_Chorbaji_Septinsular_Republic = _prefixId.prefix "Rank_Chorbaji_Septinsular_Republic"
    ...
    let ``Rank_Commandant_(rank)_EnglishTradition`` = _prefixId.prefix "Rank_Commandant_(rank)_EnglishTradition"

    let Rank_Commander_EnglishTradition = _prefixId.prefix "Rank_Commander_EnglishTradition"
    ...
    let ``Rank_Commodore_(rank)_EnglishTradition`` = _prefixId.prefix "Rank_Commodore_(rank)_EnglishTradition"

    let Rank_Company_Quartermaster_Sergeant = _prefixId.prefix "Rank_Company_Quartermaster_Sergeant"

    let Rank_Company_Quartermaster_Sergeant_Commonwealth_of_Nations = _prefixId.prefix "Rank_Company_Quartermaster_Sergeant_Commonwealth_of_Nations"

    let Rank_Company_Quartermaster_Sergeant_England = _prefixId.prefix "Rank_Company_Quartermaster_Sergeant_England"

    let Rank_Company_Quartermaster_Sergeant_Republic_of_Ireland = _prefixId.prefix "Rank_Company_Quartermaster_Sergeant_Republic_of_Ireland"

    let Rank_Company_Quartermaster_Sergeant_Scotland = _prefixId.prefix "Rank_Company_Quartermaster_Sergeant_Scotland"

    let Rank_Company_Quartermaster_Sergeant_Wales = _prefixId.prefix "Rank_Company_Quartermaster_Sergeant_Wales"

    let Rank_Company_sergeant_major = _prefixId.prefix "Rank_Company_sergeant_major"

    let Rank_Company_sergeant_major_Australia = _prefixId.prefix "Rank_Company_sergeant_major_Australia"

    let Rank_Company_sergeant_major_Canada = _prefixId.prefix "Rank_Company_sergeant_major_Canada"

    let Rank_Company_sergeant_major_Commonwealth_of_Nations = _prefixId.prefix "Rank_Company_sergeant_major_Commonwealth_of_Nations"

    let Rank_Company_sergeant_major_England = _prefixId.prefix "Rank_Company_sergeant_major_England"

    let Rank_Company_sergeant_major_Scotland = _prefixId.prefix "Rank_Company_sergeant_major_Scotland"

    let Rank_Company_sergeant_major_Singapore = _prefixId.prefix "Rank_Company_sergeant_major_Singapore"

    let Rank_Company_sergeant_major_Wales = _prefixId.prefix "Rank_Company_sergeant_major_Wales"
    ...
    let Rank_Corporal_EnglishTradition = _prefixId.prefix "Rank_Corporal_EnglishTradition"
    ...
    let Rank_Divisional_Admiral_Belgium = _prefixId.prefix "Rank_Divisional_Admiral_Belgium"
    ...
    let Rank_Divisional_General_France = _prefixId.prefix "Rank_Divisional_General_France"

    let Rank_Divisional_General_Poland = _prefixId.prefix "Rank_Divisional_General_Poland"

    let Rank_Drum_Major_General = _prefixId.prefix "Rank_Drum_Major_General"

    let Rank_Drum_Major_General_Commonwealth_of_Nations = _prefixId.prefix "Rank_Drum_Major_General_Commonwealth_of_Nations"

    let Rank_Drum_Major_General_England = _prefixId.prefix "Rank_Drum_Major_General_England"

    let Rank_Drum_Major_General_Scotland = _prefixId.prefix "Rank_Drum_Major_General_Scotland"
    ...
    let Rank_Drum_major_Commonwealth_of_Nations = _prefixId.prefix "Rank_Drum_major_Commonwealth_of_Nations"
    ...
    let ``Rank_Ensign_(rank)_EnglishTradition`` = _prefixId.prefix "Rank_Ensign_(rank)_EnglishTradition"

    let Rank_Epihipparch = _prefixId.prefix "Rank_Epihipparch"

    let Rank_Epihipparch_Achaean_League = _prefixId.prefix "Rank_Epihipparch_Achaean_League"
    ...
    let Rank_Ferik_Septinsular_Republic = _prefixId.prefix "Rank_Ferik_Septinsular_Republic"

    let Rank_Field_marshal_EnglishTradition = _prefixId.prefix "Rank_Field_marshal_EnglishTradition"
    ...
    let Rank_Flight_lieutenant_EnglishTradition = _prefixId.prefix "Rank_Flight_lieutenant_EnglishTradition"

    let Rank_Flight_sergeant = _prefixId.prefix "Rank_Flight_sergeant"

    let Rank_Flight_sergeant_Australia = _prefixId.prefix "Rank_Flight_sergeant_Australia"

    let Rank_Flight_sergeant_Canada = _prefixId.prefix "Rank_Flight_sergeant_Canada"

    let Rank_Flight_sergeant_Commonwealth_of_Nations = _prefixId.prefix "Rank_Flight_sergeant_Commonwealth_of_Nations"

    let Rank_Flight_sergeant_Republic_of_Ireland = _prefixId.prefix "Rank_Flight_sergeant_Republic_of_Ireland"

    let Rank_Flying_officer_EnglishTradition = _prefixId.prefix "Rank_Flying_officer_EnglishTradition"

    let Rank_Garrison_Sergeant_Major = _prefixId.prefix "Rank_Garrison_Sergeant_Major"

    let Rank_Garrison_Sergeant_Major_England = _prefixId.prefix "Rank_Garrison_Sergeant_Major_England"

    let Rank_Garrison_Sergeant_Major_Scotland = _prefixId.prefix "Rank_Garrison_Sergeant_Major_Scotland"

    let Rank_Garrison_Sergeant_Major_Wales = _prefixId.prefix "Rank_Garrison_Sergeant_Major_Wales"
    ...
    let Rank_General_in_Chief_Soviet_Union = _prefixId.prefix "Rank_General-in-Chief_Soviet_Union"
    ...
    let Rank_General_Admiral_Soviet_Union = _prefixId.prefix "Rank_General_Admiral_Soviet_Union"

    let Rank_General_officer_EnglishTradition = _prefixId.prefix "Rank_General_officer_EnglishTradition"

    let Rank_Group_captain_EnglishTradition = _prefixId.prefix "Rank_Group_captain_EnglishTradition"
    ...
    let Rank_Hipparchus_Cavalry_Achaean_League = _prefixId.prefix "Rank_Hipparchus_Cavalry_Achaean_League"

    let Rank_Hipparchus_Cavalry_Macedonia = _prefixId.prefix "Rank_Hipparchus_Cavalry_Macedonia"
    ...
    let Rank_Junior_sergeant_Republic_of_Estonia_1920_1940 = _prefixId.prefix "Rank_Junior_sergeant_Republic_of_Estonia_1920-1940"
    ...
    let Rank_Kapudan_Pasha_Cossack_Hetmanate = _prefixId.prefix "Rank_Kapudan_Pasha_Cossack_Hetmanate"

    let Rank_Kapudan_Pasha_Ottoman_Empire = _prefixId.prefix "Rank_Kapudan_Pasha_Ottoman_Empire"

    let Rank_Kapudan_Pasha_Septinsular_Republic = _prefixId.prefix "Rank_Kapudan_Pasha_Septinsular_Republic"

    let Rank_Kindral = _prefixId.prefix "Rank_Kindral"
    let Rank_Kindral_Estonia = _prefixId.prefix "Rank_Kindral_Estonia"

    let Rank_Kindral_Republic_of_Estonia_1920_1940 = _prefixId.prefix "Rank_Kindral_Republic_of_Estonia_1920-1940"

    let Rank_Kolagasi = _prefixId.prefix "Rank_Kolagasi"

    let Rank_Kolagasi_Cossack_Hetmanate = _prefixId.prefix "Rank_Kolagasi_Cossack_Hetmanate"

    let Rank_Kolagasi_Ottoman_Empire = _prefixId.prefix "Rank_Kolagasi_Ottoman_Empire"

    let Rank_Kolagasi_Septinsular_Republic = _prefixId.prefix "Rank_Kolagasi_Septinsular_Republic"
    ...
    let Rank_Kolonel_Republic_of_Estonia_1920_1940 = _prefixId.prefix "Rank_Kolonel_Republic_of_Estonia_1920-1940"

    let Rank_Lance_corporal_of_horse = _prefixId.prefix "Rank_Lance-corporal_of_horse"

    let Rank_Lance_corporal_of_horse_England = _prefixId.prefix "Rank_Lance-corporal_of_horse_England"

    let Rank_Lance_corporal_of_horse_Scotland = _prefixId.prefix "Rank_Lance-corporal_of_horse_Scotland"

    let Rank_Lance_corporal_of_horse_Wales = _prefixId.prefix "Rank_Lance-corporal_of_horse_Wales"
    ...
    let Rank_Lance_corporal_Commonwealth_of_Nations = _prefixId.prefix "Rank_Lance_corporal_Commonwealth_of_Nations"
    ...
    let Rank_Lance_sergeant_Commonwealth_of_Nations = _prefixId.prefix "Rank_Lance_sergeant_Commonwealth_of_Nations"
    ...
    let Rank_Leading_aircraftman_Australia = _prefixId.prefix "Rank_Leading_aircraftman_Australia"

    let Rank_Leading_aircraftman_Canada = _prefixId.prefix "Rank_Leading_aircraftman_Canada"

    let Rank_Leading_aircraftman_Commonwealth_of_Nations = _prefixId.prefix "Rank_Leading_aircraftman_Commonwealth_of_Nations"

    let Rank_Leading_seaman_EnglishTradition = _prefixId.prefix "Rank_Leading_seaman_EnglishTradition"

    let ``Rank_Lieutenant_(navy)_EnglishTradition`` = _prefixId.prefix "Rank_Lieutenant_(navy)_EnglishTradition"

    let Rank_Lieutenant_EnglishTradition = _prefixId.prefix "Rank_Lieutenant_EnglishTradition"

    let Rank_Lieutenant_colonel_EnglishTradition = _prefixId.prefix "Rank_Lieutenant_colonel_EnglishTradition"

    let Rank_Lieutenant_commander_EnglishTradition = _prefixId.prefix "Rank_Lieutenant_commander_EnglishTradition"
    ...
    let Rank_Lochagos_Official_Timocracy_of_Sapinetia = _prefixId.prefix "Rank_Lochagos_Official_Timocracy_of_Sapinetia"

    let Rank_Lord_High_Admiral_of_the_Wash = _prefixId.prefix "Rank_Lord_High_Admiral_of_the_Wash"

    let Rank_Lord_High_Admiral_of_the_Wash_England = _prefixId.prefix "Rank_Lord_High_Admiral_of_the_Wash_England"

    let Rank_Lord_High_Admiral_of_the_Wash_Scotland = _prefixId.prefix "Rank_Lord_High_Admiral_of_the_Wash_Scotland"

    let Rank_Lord_High_Admiral_of_the_Wash_Wales = _prefixId.prefix "Rank_Lord_High_Admiral_of_the_Wash_Wales"
    ...
    let Rank_Marshal_of_the_Soviet_Union = _prefixId.prefix "Rank_Marshal_of_the_Soviet_Union"

    let Rank_Marshal_of_the_Soviet_Union_Soviet_Union = _prefixId.prefix "Rank_Marshal_of_the_Soviet_Union_Soviet_Union"

    let Rank_Marshal_of_the_air_force_EnglishTradition = _prefixId.prefix "Rank_Marshal_of_the_air_force_EnglishTradition"

    let Rank_Master_warrant_officer = _prefixId.prefix "Rank_Master_warrant_officer"

    let Rank_Master_warrant_officer_Canada = _prefixId.prefix "Rank_Master_warrant_officer_Canada"

    let Rank_Master_warrant_officer_Singapore = _prefixId.prefix "Rank_Master_warrant_officer_Singapore"

    let Rank_Midshipman_EnglishTradition = _prefixId.prefix "Rank_Midshipman_EnglishTradition"

    let Rank_Mirliva = _prefixId.prefix "Rank_Mirliva"

    let Rank_Mirliva_Cossack_Hetmanate = _prefixId.prefix "Rank_Mirliva_Cossack_Hetmanate"

    let Rank_Mirliva_Ottoman_Empire = _prefixId.prefix "Rank_Mirliva_Ottoman_Empire"

    let Rank_Mirliva_Septinsular_Republic = _prefixId.prefix "Rank_Mirliva_Septinsular_Republic"
    ...
    let Rank_Musir_Septinsular_Republic = _prefixId.prefix "Rank_Musir_Septinsular_Republic"
    ...
    let Rank_Navarch_Official_Timocracy_of_Sapinetia = _prefixId.prefix "Rank_Navarch_Official_Timocracy_of_Sapinetia"
    ...
    let Rank_Obergefreiter_Switzerland = _prefixId.prefix "Rank_Obergefreiter_Switzerland"
    ...
    let Rank_Oberst_Kingdom_of_Denmark = _prefixId.prefix "Rank_Oberst_Kingdom_of_Denmark"
    ...
    let Rank_Officer_cadet_EnglishTradition = _prefixId.prefix "Rank_Officer_cadet_EnglishTradition"

    let Rank_Ordinary_seaman_rating = _prefixId.prefix "Rank_Ordinary_seaman_rating"

    let Rank_Ordinary_seaman_rating_Australia = _prefixId.prefix "Rank_Ordinary_seaman_rating_Australia"

    let Rank_Ordinary_seaman_rating_Canada = _prefixId.prefix "Rank_Ordinary_seaman_rating_Canada"

    let Rank_Ordinary_seaman_rating_Commonwealth_of_Nations = _prefixId.prefix "Rank_Ordinary_seaman_rating_Commonwealth_of_Nations"

    let Rank_Petty_officer_EnglishTradition = _prefixId.prefix "Rank_Petty_officer_EnglishTradition"

    let Rank_Phrourarch = _prefixId.prefix "Rank_Phrourarch"

    let Rank_Phrourarch_Achaean_League = _prefixId.prefix "Rank_Phrourarch_Achaean_League"
    ...
    let Rank_Phrourarch_Official_Timocracy_of_Sapinetia = _prefixId.prefix "Rank_Phrourarch_Official_Timocracy_of_Sapinetia"

    let Rank_Pilot_officer_EnglishTradition = _prefixId.prefix "Rank_Pilot_officer_EnglishTradition"

    let Rank_Pipe_Major = _prefixId.prefix "Rank_Pipe_Major"

    let Rank_Pipe_Major_Commonwealth_of_Nations = _prefixId.prefix "Rank_Pipe_Major_Commonwealth_of_Nations"
    ...
    let Rank_Podpolkovnik_Soviet_Union = _prefixId.prefix "Rank_Podpolkovnik_Soviet_Union"
    ...
    let Rank_Podpraporshchik_Soviet_Union = _prefixId.prefix "Rank_Podpraporshchik_Soviet_Union"
    ...
    let Rank_Praporshchik_Soviet_Union = _prefixId.prefix "Rank_Praporshchik_Soviet_Union"
    ...
    let Rank_Private_Republic_of_Ireland = _prefixId.prefix "Rank_Private_Republic_of_Ireland"
    ...
    let Rank_Regimental_Quartermaster_Sergeant = _prefixId.prefix "Rank_Regimental_Quartermaster_Sergeant"

    let Rank_Regimental_Quartermaster_Sergeant_Australia = _prefixId.prefix "Rank_Regimental_Quartermaster_Sergeant_Australia"

    let Rank_Regimental_Quartermaster_Sergeant_Canada = _prefixId.prefix "Rank_Regimental_Quartermaster_Sergeant_Canada"

    let Rank_Regimental_Quartermaster_Sergeant_Commonwealth_of_Nations = _prefixId.prefix "Rank_Regimental_Quartermaster_Sergeant_Commonwealth_of_Nations"

    let Rank_Regimental_Quartermaster_Sergeant_England = _prefixId.prefix "Rank_Regimental_Quartermaster_Sergeant_England"

    let Rank_Regimental_Quartermaster_Sergeant_Republic_of_Ireland = _prefixId.prefix "Rank_Regimental_Quartermaster_Sergeant_Republic_of_Ireland"

    let Rank_Regimental_Quartermaster_Sergeant_Scotland = _prefixId.prefix "Rank_Regimental_Quartermaster_Sergeant_Scotland"

    let Rank_Regimental_Quartermaster_Sergeant_Wales = _prefixId.prefix "Rank_Regimental_Quartermaster_Sergeant_Wales"

    let Rank_Regimental_sergeant_major = _prefixId.prefix "Rank_Regimental_sergeant_major"

    let Rank_Regimental_sergeant_major_Australia = _prefixId.prefix "Rank_Regimental_sergeant_major_Australia"

    let Rank_Regimental_sergeant_major_Commonwealth_of_Nations = _prefixId.prefix "Rank_Regimental_sergeant_major_Commonwealth_of_Nations"

    let Rank_Regimental_sergeant_major_Singapore = _prefixId.prefix "Rank_Regimental_sergeant_major_Singapore"
    ...
    let Rank_Schout_bij_nacht_Netherlands = _prefixId.prefix "Rank_Schout-bij-nacht_Netherlands"

    let Rank_Schout_bij_nacht_Russia = _prefixId.prefix "Rank_Schout-bij-nacht_Russia"

    let Rank_Schout_bij_nacht_Soviet_Union = _prefixId.prefix "Rank_Schout-bij-nacht_Soviet_Union"
    ...
    let Rank_Second_lieutenant_EnglishTradition = _prefixId.prefix "Rank_Second_lieutenant_EnglishTradition"

    let Rank_Sergeant = _prefixId.prefix "Rank_Sergeant"

    let Rank_Sergeant_EnglishTradition = _prefixId.prefix "Rank_Sergeant_EnglishTradition"

    let Rank_Sergeant_Major_Instructor = _prefixId.prefix "Rank_Sergeant_Major_Instructor"

    let Rank_Sergeant_Major_Instructor_England = _prefixId.prefix "Rank_Sergeant_Major_Instructor_England"

    let Rank_Sergeant_Major_Instructor_Scotland = _prefixId.prefix "Rank_Sergeant_Major_Instructor_Scotland"

    let Rank_Sergeant_Major_Instructor_Wales = _prefixId.prefix "Rank_Sergeant_Major_Instructor_Wales"
    ...
    let Rank_Sergeant_Pilot_Commonwealth_of_Nations = _prefixId.prefix "Rank_Sergeant_Pilot_Commonwealth_of_Nations"
    ...
    let Rank_Sergeant_major_EnglishTradition = _prefixId.prefix "Rank_Sergeant_major_EnglishTradition"

    let Rank_Skeuophoros = _prefixId.prefix "Rank_Skeuophoros"

    let Rank_Skeuophoros_Achaean_League = _prefixId.prefix "Rank_Skeuophoros_Achaean_League"
    ...
    let Rank_Somatophylakes_Achaean_League = _prefixId.prefix "Rank_Somatophylakes_Achaean_League"
    ...
    let Rank_Squadron_leader_EnglishTradition = _prefixId.prefix "Rank_Squadron_leader_EnglishTradition"
    ...
    let Rank_Staabikapten_Republic_of_Estonia_1920_1940 = _prefixId.prefix "Rank_Staabikapten_Republic_of_Estonia_1920-1940"
    ...
    let Rank_Stabskapitan_Soviet_Union = _prefixId.prefix "Rank_Stabskapitan_Soviet_Union"

    let Rank_Stabskapitanleutnant = _prefixId.prefix "Rank_Stabskapitanleutnant"

    let Rank_Stabskapitanleutnant_Germany = _prefixId.prefix "Rank_Stabskapitanleutnant_Germany"
    ...
    let Rank_Staff_Sergeant_Major_England = _prefixId.prefix "Rank_Staff_Sergeant_Major_England"

    let Rank_Staff_Sergeant_Major_Scotland = _prefixId.prefix "Rank_Staff_Sergeant_Major_Scotland"

    let Rank_Staff_Sergeant_Major_Wales = _prefixId.prefix "Rank_Staff_Sergeant_Major_Wales"
    ...
    let Rank_Staff_sergeant_Commonwealth_of_Nations = _prefixId.prefix "Rank_Staff_sergeant_Commonwealth_of_Nations"
    ...
    let Rank_Stratarches_Byzantine_Empire = _prefixId.prefix "Rank_Stratarches_Byzantine_Empire"

    let Rank_Stratarches_Greece = _prefixId.prefix "Rank_Stratarches_Greece"

    let Rank_Stratarches_Official_Timocracy_of_Sapinetia = _prefixId.prefix "Rank_Stratarches_Official_Timocracy_of_Sapinetia"
    ...
    let Rank_Strategos_Byzantine_Empire = _prefixId.prefix "Rank_Strategos_Byzantine_Empire"
    ...
    let Rank_Strategos_Official_Timocracy_of_Sapinetia = _prefixId.prefix "Rank_Strategos_Official_Timocracy_of_Sapinetia"

    let Rank_Strategos_autokrator = _prefixId.prefix "Rank_Strategos_autokrator"

    let Rank_Strategos_autokrator_Byzantine_Empire = _prefixId.prefix "Rank_Strategos_autokrator_Byzantine_Empire"

    let Rank_Sub_lieutenant_EnglishTradition = _prefixId.prefix "Rank_Sub-lieutenant_EnglishTradition"
    ...
    let Rank_Subasi_Septinsular_Republic = _prefixId.prefix "Rank_Subasi_Septinsular_Republic"

    let Rank_Syntagmatarchis = _prefixId.prefix "Rank_Syntagmatarchis"

    let Rank_Syntagmatarchis_Achaean_League = _prefixId.prefix "Rank_Syntagmatarchis_Achaean_League"

    let Rank_Syntagmatarchis_Greece = _prefixId.prefix "Rank_Syntagmatarchis_Greece"

    let Rank_Syntagmatarchis_Macedonia = _prefixId.prefix "Rank_Syntagmatarchis_Macedonia"

    let Rank_Syntagmatarchis_Official_Timocracy_of_Sapinetia = _prefixId.prefix "Rank_Syntagmatarchis_Official_Timocracy_of_Sapinetia"

    let Rank_Tagmatarchis = _prefixId.prefix "Rank_Tagmatarchis"

    let Rank_Tagmatarchis_Achaean_League = _prefixId.prefix "Rank_Tagmatarchis_Achaean_League"
    ...
    let Rank_Tagmatarchis_Official_Timocracy_of_Sapinetia = _prefixId.prefix "Rank_Tagmatarchis_Official_Timocracy_of_Sapinetia"
    ...
    let Rank_Taxiarch_Byzantine_Empire = _prefixId.prefix "Rank_Taxiarch_Byzantine_Empire"
    ...
    let Rank_Taxiarch_Official_Timocracy_of_Sapinetia = _prefixId.prefix "Rank_Taxiarch_Official_Timocracy_of_Sapinetia"
    ...
    let Rank_Trooper_Commonwealth_of_Nations = _prefixId.prefix "Rank_Trooper_Commonwealth_of_Nations"

    let Rank_Trumpet_Major = _prefixId.prefix "Rank_Trumpet_Major"

    let Rank_Trumpet_Major_Commonwealth_of_Nations = _prefixId.prefix "Rank_Trumpet_Major_Commonwealth_of_Nations"
    ...
    let Rank_Under_Officer_Commonwealth_of_Nations = _prefixId.prefix "Rank_Under_Officer_Commonwealth_of_Nations"
    ...
    let Rank_Veebel_Republic_of_Estonia_1920_1940 = _prefixId.prefix "Rank_Veebel_Republic_of_Estonia_1920-1940"

    let Rank_Vice_Admiral_of_the_Coast = _prefixId.prefix "Rank_Vice-Admiral_of_the_Coast"

    let Rank_Vice_Admiral_of_the_Coast_England = _prefixId.prefix "Rank_Vice-Admiral_of_the_Coast_England"

    let Rank_Vice_Admiral_of_the_Coast_Scotland = _prefixId.prefix "Rank_Vice-Admiral_of_the_Coast_Scotland"

    let Rank_Vice_Admiral_of_the_Coast_Wales = _prefixId.prefix "Rank_Vice-Admiral_of_the_Coast_Wales"

    let Rank_Vice_Admiral_of_the_West = _prefixId.prefix "Rank_Vice-Admiral_of_the_West"

    let Rank_Vice_Admiral_of_the_West_England = _prefixId.prefix "Rank_Vice-Admiral_of_the_West_England"

    let Rank_Vice_Admiral_of_the_West_Scotland = _prefixId.prefix "Rank_Vice-Admiral_of_the_West_Scotland"

    let Rank_Vice_Admiral_of_the_West_Wales = _prefixId.prefix "Rank_Vice-Admiral_of_the_West_Wales"
    ...
    let Rank_Vice_admiral_Australia_Australia = _prefixId.prefix "Rank_Vice_admiral_Australia_Australia"
    ...
    let Rank_Wachtmeister_Soviet_Union = _prefixId.prefix "Rank_Wachtmeister_Soviet_Union"

    let Rank_Warrant_officer_EnglishTradition = _prefixId.prefix "Rank_Warrant_officer_EnglishTradition"

    let Rank_Warrant_officer_United_Kingdom = _prefixId.prefix "Rank_Warrant_officer_United_Kingdom"

    let Rank_Warrant_officer_United_Kingdom_Australia = _prefixId.prefix "Rank_Warrant_officer_United_Kingdom_Australia"

    let Rank_Warrant_officer_United_Kingdom_Canada = _prefixId.prefix "Rank_Warrant_officer_United_Kingdom_Canada"

    let Rank_Warrant_officer_United_Kingdom_Commonwealth_of_Nations = _prefixId.prefix "Rank_Warrant_officer_United_Kingdom_Commonwealth_of_Nations"

    let Rank_Warrant_officer_United_Kingdom_England = _prefixId.prefix "Rank_Warrant_officer_United_Kingdom_England"

    let Rank_Warrant_officer_United_Kingdom_Scotland = _prefixId.prefix "Rank_Warrant_officer_United_Kingdom_Scotland"

    let Rank_Warrant_officer_United_Kingdom_Wales = _prefixId.prefix "Rank_Warrant_officer_United_Kingdom_Wales"

    let Rank_Wing_commander = _prefixId.prefix "Rank_Wing_commander"

    let ``Rank_Wing_commander_(rank)_EnglishTradition`` = _prefixId.prefix "Rank_Wing_commander_(rank)_EnglishTradition"
    ...
    let Rank_Wing_commander_Commonwealth_of_Nations = _prefixId.prefix "Rank_Wing_commander_Commonwealth_of_Nations"
    ...
    let Rank_Ypolochagos_Official_Timocracy_of_Sapinetia = _prefixId.prefix "Rank_Ypolochagos_Official_Timocracy_of_Sapinetia"
