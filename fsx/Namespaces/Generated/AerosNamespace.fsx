...
module aeros =
    let _prefixId = PrefixId.fromNamespaceLabel "https://w3id.org/aerOS/continuum#" "aeros"
    ...
    /// </summary>
    let InfrastructureElementRequirements = _prefixId.prefix "InfrastructureElementRequirements"
    ...
    let UntrustedInfrastructureElement = _prefixId.prefix "UntrustedInfrastructureElement"
