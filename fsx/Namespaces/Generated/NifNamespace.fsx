...
module nif =
    let _prefixId = PrefixId.fromNamespaceLabel "http://persistence.uni-leipzig.org/nlp2rdf/ontologies/nif-core#" "nif"
    ...
    let NormalizedCollectionOccurrence = _prefixId.prefix "NormalizedCollectionOccurrence"
