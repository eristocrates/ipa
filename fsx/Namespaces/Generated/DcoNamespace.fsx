...
module dco =
    ...
    ///   <para>dc11:description : Represent the given name of a building.^^xsd:string</para>
    ...
    /// </summary>
    let ClosedLoopEnergyEfficiencyService = _prefixId.prefix "ClosedLoopEnergyEfficiencyService"
