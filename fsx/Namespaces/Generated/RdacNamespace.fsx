...
module rdac =
    let _prefixId = PrefixId.fromNamespaceLabel "http://rdaregistry.info/Elements/c/" "rdac"

    let _namespaceIri = _prefixId.prefix ""
    let Agent'_period_'en = _prefixId.prefix "Agent.en"
    /// <summary>
    ...
    let CorporateBody'_period_'en = _prefixId.prefix "CorporateBody.en"
    let Expression'_period_'en = _prefixId.prefix "Expression.en"
    let Family'_period_'en = _prefixId.prefix "Family.en"
    let Item'_period_'en = _prefixId.prefix "Item.en"
    let Manifestation'_period_'en = _prefixId.prefix "Manifestation.en"
    let Person'_period_'en = _prefixId.prefix "Person.en"
    let Work'_period_'en = _prefixId.prefix "Work.en"
