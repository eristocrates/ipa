...
module cdtype =
    ...
    ///   <para>dc11:description : There may, in the individual records, be information about collections but that is not the focus of the catalogue. AnalyticFindingAids are typically created with significant human input.</para>
