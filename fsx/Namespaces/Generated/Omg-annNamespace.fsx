...
module ``omg-ann`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/AnnotationVocabulary/" "omg-ann"
    ...
    ///   <para>omg-ann:adaptedFrom : ISO 1087 Terminology work and terminology science - Vocabulary, Second edition, 2019-09^^xsd:stringomg-ann:adaptedFrom : ISO 31-0 Quantities and units - General principles^^xsd:string</para>
    ...
    ///   <para>omg-ann:usageNote : Note that any SPARQL or other query using entailment for the rdfs:label on any construct will return not only the rdfs:label but all labels that are specified using subproperties of rdfs:label, such as abbreviation.^^xsd:string</para>
    ///   <a href="https://www.omg.org/spec/Commons/AnnotationVocabulary/abbreviation">omg-ann:abbreviation</a>
    /// </summary>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO 1087 Terminology work and terminology science - Vocabulary, Second edition, 2019-09^^xsd:string</para>
    ///   <para>omg-ann:usageNote : Note that any SPARQL or other query using entailment for the rdfs:label on any construct will return not only the rdfs:label but all labels that are specified using subproperties of rdfs:label, such as acronym.^^xsd:string</para>
    ///   <a href="https://www.omg.org/spec/Commons/AnnotationVocabulary/acronym">omg-ann:acronym</a>
    /// </summary>
    ...
    ///   <para>omg-ann:usageNote : This annotation should be used to indicate that a reference was used, for example, as input to the development of a definition or term but would not be considered infringing on a copyright.^^xsd:string</para>
    ///   <a href="https://www.omg.org/spec/Commons/AnnotationVocabulary/adaptedFrom">omg-ann:adaptedFrom</a>
    /// </summary>
    ...
    ///   <para>omg-ann:usageNote : This annotation is typically used to describe an artifact such as a controlled vocabulary, ontology, or other similar resource.^^xsd:string</para>
    ///   <a href="https://www.omg.org/spec/Commons/AnnotationVocabulary/copyright">omg-ann:copyright</a>
    /// </summary>
    ...
    ///   <a href="https://www.omg.org/spec/Commons/AnnotationVocabulary/directSource">omg-ann:directSource</a>
    /// </summary>
    ...
    ///   <a href="https://www.omg.org/spec/Commons/AnnotationVocabulary/explanatoryNote">omg-ann:explanatoryNote</a>
    /// </summary>
    ...
    ///   <a href="https://www.omg.org/spec/Commons/AnnotationVocabulary/logicalDefinition">omg-ann:logicalDefinition</a>
    /// </summary>
    ...
    ///   <para>omg-ann:usageNote : Note that any SPARQL or other query using entailment for the rdfs:label on any construct will return not only the rdfs:label but all labels that are specified using subproperties of rdfs:label, such as symbol.^^xsd:string</para>
    ///   <a href="https://www.omg.org/spec/Commons/AnnotationVocabulary/symbol">omg-ann:symbol</a>
    /// </summary>
    ...
    ///   <para>omg-ann:adaptedFrom : ISO 1087 Terminology work and terminology science - Vocabulary, Second edition, 2019-09^^xsd:string</para>
    ///   <para>omg-ann:usageNote : Note that any SPARQL or other query using entailment for the rdfs:label on any construct will return not only the rdfs:label but all labels that are specified using subproperties of rdfs:label, such as synonym.^^xsd:string</para>
    ///   <a href="https://www.omg.org/spec/Commons/AnnotationVocabulary/synonym">omg-ann:synonym</a>
    /// </summary>
    ...
    ///   <a href="https://www.omg.org/spec/Commons/AnnotationVocabulary/usageNote">omg-ann:usageNote</a>
    /// </summary>
