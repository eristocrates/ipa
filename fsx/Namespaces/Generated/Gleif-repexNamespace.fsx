...
module ``gleif-repex`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.gleif.org/ontology/ReportingException/" "gleif-repex"
    ...
    /// </summary>
    let DirectConsolidationReportingException = _prefixId.prefix "DirectConsolidationReportingException"
    ...
    let ExceptionReasonKindBindingLegalCommitments = _prefixId.prefix "ExceptionReasonKindBindingLegalCommitments"

    let ExceptionReasonKindConsentNotObtained = _prefixId.prefix "ExceptionReasonKindConsentNotObtained"

    let ExceptionReasonKindDetrimentNotExcluded = _prefixId.prefix "ExceptionReasonKindDetrimentNotExcluded"

    let ExceptionReasonKindDisclosureDetrimental = _prefixId.prefix "ExceptionReasonKindDisclosureDetrimental"

    let ExceptionReasonKindLegalCommitments = _prefixId.prefix "ExceptionReasonKindLegalCommitments"

    let ExceptionReasonKindLegalObstacles = _prefixId.prefix "ExceptionReasonKindLegalObstacles"

    let ExceptionReasonKindNaturalPersons = _prefixId.prefix "ExceptionReasonKindNaturalPersons"

    let ExceptionReasonKindNoKnownPerson = _prefixId.prefix "ExceptionReasonKindNoKnownPerson"

    let ExceptionReasonKindNoLEI = _prefixId.prefix "ExceptionReasonKindNoLEI"

    let ExceptionReasonKindNonConsolidating = _prefixId.prefix "ExceptionReasonKindNonConsolidating"
    ...
    /// </summary>
    let UltimateConsolidationReportingException = _prefixId.prefix "UltimateConsolidationReportingException"
