...
module cgov =
    let _prefixId = PrefixId.fromNamespaceLabel "http://reference.data.gov.uk/def/central-government/" "cgov"
    ...
    /// </summary>
    let DevolvedGovernmentOrganisation = _prefixId.prefix "DevolvedGovernmentOrganisation"
    ...
    /// </summary>
    let MachineryOfGovernmentChangeEvent = _prefixId.prefix "MachineryOfGovernmentChangeEvent"
    ...
    /// </summary>
    let SeniorAssistantParliamentaryCounsel = _prefixId.prefix "SeniorAssistantParliamentaryCounsel"
