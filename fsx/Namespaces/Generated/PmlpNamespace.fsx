...
module pmlp =
    let _prefixId = PrefixId.fromNamespaceLabel "http://inference-web.org/2.0/pml-provenance.owl#" "pmlp"
    ...
    /// </summary>
    let hasDataCollectionStartDateTime = _prefixId.prefix "hasDataCollectionStartDateTime"
