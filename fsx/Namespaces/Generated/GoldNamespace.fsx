...
module gold =
    let _prefixId = PrefixId.fromNamespaceLabel "http://purl.org/linguistics/gold/" "gold"
    ...
    /// </summary>
    let ConditionalPhysicalAbilitiveModality = _prefixId.prefix "ConditionalPhysicalAbilitiveModality"
