...
module hr =
    let _prefixId = PrefixId.fromNamespaceLabel "http://iserve.kmi.open.ac.uk/ns/hrests#" "hr"
    ...
    /// </summary>
    let automaticallyExtractedDescription = _prefixId.prefix "automaticallyExtractedDescription"
