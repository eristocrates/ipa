...
module ``cmns-cls`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/Classifiers/" "cmns-cls"
    ...
    ///   <para>omg-ann:synonym : characteristic^^xsd:string</para>
    ...
    ///   <para>dcterms:source : ISO/IEC 11179-3 Information technology - Metadata registries (MDR) - Part 3: Registry metamodel and basic attributes, Third edition, 2013-02-15^^xsd:string</para>
    ...
    ///   <para>omg-ann:usageNote : This does not exclude classification by other classifiers from other schemes. It is simply a hint to users that whatever is classified by a classifier in this scheme should be classified by at most one of the classifiers in the scheme.^^xsd:string</para>
