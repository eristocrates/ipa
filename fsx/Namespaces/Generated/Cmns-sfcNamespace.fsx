...
module ``cmns-sfc`` =
    let _prefixId = PrefixId.fromNamespaceLabel "https://www.omg.org/spec/Commons/SitesAndFacilities/" "cmns-sfc"
    ...
    ///   <para>omg-ann:explanatoryNote : A physical site has certain characteristics that contribute to the context it provides, including area, shape, accessibility, and in the case of a geographic site, landforms, soil and ground conditions, climate, and so forth.^^xsd:string</para>
    ...
    ///   <para>omg-ann:explanatoryNote : Something may be situated at some site, or in some setting, situation, or context.^^xsd:string</para>
