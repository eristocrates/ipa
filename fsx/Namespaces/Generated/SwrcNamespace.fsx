...
module swrc =
    let _prefixId = PrefixId.fromNamespaceLabel "http://swrc.ontoware.org/ontology#" "swrc"
    ...
    /// </summary>
    let UndergraduateIntermediateClass = _prefixId.prefix "UndergraduateIntermediateClass"
