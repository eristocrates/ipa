...
module ``san-lod`` =
    let _prefixId = PrefixId.fromNamespaceLabel "http://dati.san.beniculturali.it/SAN/" "san-lod"
    ...
    /// </summary>
    let altraDenominazioneProfiloIstituzionale = _prefixId.prefix "altraDenominazioneProfiloIstituzionale"
    ...
    /// </summary>
    let formaAutorizzataProfiloIstituzionale = _prefixId.prefix "formaAutorizzataProfiloIstituzionale"
    ...
    /// </summary>
    let has_qualificazioniRelazioniCpf = _prefixId.prefix "has_qualificazioniRelazioniCpf"
