...
module bag =
    let _prefixId = PrefixId.fromNamespaceLabel "http://bag.basisregistraties.overheid.nl/def/bag#" "bag"
    ...
    /// </summary>
    let VerblijfsobjectBijeenkomstfunctie = _prefixId.prefix "VerblijfsobjectBijeenkomstfunctie"
    ...
    /// </summary>
    let VerblijfsobjectGezondheidszorgfunctie = _prefixId.prefix "VerblijfsobjectGezondheidszorgfunctie"
    ...
    /// </summary>
    let VerblijfsobjectIndustriefunctie = _prefixId.prefix "VerblijfsobjectIndustriefunctie"
    ...
    /// </summary>
    let VerblijfsobjectOnderwijsfunctie = _prefixId.prefix "VerblijfsobjectOnderwijsfunctie"
    ...
    /// </summary>
    let VerblijfsobjectOverigeGebruiksfunctie = _prefixId.prefix "VerblijfsobjectOverigeGebruiksfunctie"
