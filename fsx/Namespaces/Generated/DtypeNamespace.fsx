...
module dtype =
    let _prefixId = PrefixId.fromNamespaceLabel "http://www.linkedmodel.org/schema/dtype#" "dtype"
    ...
    ///   <para>dc11:description : The base class for datatypes that have values that are restriced to a set of literals or tokens. The members of the restriction may themselve be restriced by facets that apply to scalar data types.^^xsd:string</para>
