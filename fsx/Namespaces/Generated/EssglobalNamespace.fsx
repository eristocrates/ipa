...
module essglobal =
    let _prefixId = PrefixId.fromNamespaceLabel "http://purl.org/essglobal/vocab/" "essglobal"
    ...
    /// </summary>
    let quantityPerProductOrServiceUnit = _prefixId.prefix "quantityPerProductOrServiceUnit"
