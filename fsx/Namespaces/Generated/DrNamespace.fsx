...
module dr =
    let _prefixId = PrefixId.fromNamespaceLabel "http://purl.org/swan/2.0/discourse-relationships/" "dr"
    ...
    /// </summary>
    let referencesAsInconsistentEvidence = _prefixId.prefix "referencesAsInconsistentEvidence"
    ...
    /// </summary>
    let referencesAsSupportiveEvidence = _prefixId.prefix "referencesAsSupportiveEvidence"
