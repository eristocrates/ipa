...
module ishi =
    let _prefixId = PrefixId.fromNamespaceLabel "https://w3id.org/ishikawa-diagram-ontology#" "ishi"
    ...
    let productProcessClassificationDiagram = _prefixId.prefix "productProcessClassificationDiagram"
