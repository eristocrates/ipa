...
module nyon =
    ...
    /// </summary>
    let ``Judicial_Magistrate_Court(First_Class)`` = _prefixId.prefix "Judicial_Magistrate_Court(First_Class)"
    ...
    /// </summary>
    let ``Judicial_Magistrate_Court(Second_Class)`` = _prefixId.prefix "Judicial_Magistrate_Court(Second_Class)"
    ...
    /// </summary>
    let Metropolitan_Magistrate_Courts = _prefixId.prefix "Metropolitan_Magistrate_Courts"
