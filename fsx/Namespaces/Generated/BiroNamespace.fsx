...
module biro =
    ...
    ///   <para>dc11:description : A bibliographic collection is composed only of items containing bibliographic records.  Moreover, it cannot be part of other bibliographic collections, and it is realized only by bibliographic lists.</para>
    ...
    ///   <para>dc11:description : A bibliographic list is composed only of items containing bibliographic references.  Moreover, it is always a realization of a bibliographic collection.</para>
    ...
    ///   <para>dc11:description : A bibliographic record is realized only through bibliographic references.</para>
    ...
    ///   <para>dc11:description : A bibliographic reference is a realization of a bibliographic record. Moreover, it can contain only items referring to elements contained by the bibliographic record it realizes.</para>
