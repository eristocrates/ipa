...
module lexinfo =
    let _prefixId = PrefixId.fromNamespaceLabel "http://www.lexinfo.net/ontology/2.0/lexinfo#" "lexinfo"
    ...
    let AccusativePostPositiveArgument = _prefixId.prefix "AccusativePostPositiveArgument"
    ...
    /// </summary>
    let AdjectiveAccusativePostPositiveFrame = _prefixId.prefix "AdjectiveAccusativePostPositiveFrame"
    ...
    /// </summary>
    let AdjectiveDativePostPositiveFrame = _prefixId.prefix "AdjectiveDativePostPositiveFrame"
    ...
    /// </summary>
    let AdjectiveGenitivePostPositiveFrame = _prefixId.prefix "AdjectiveGenitivePostPositiveFrame"
    ...
    /// </summary>
    let DitransitiveDoubleAccusativeFrame = _prefixId.prefix "DitransitiveDoubleAccusativeFrame"
    ...
    /// </summary>
    let IntransitiveAdjectivalComplementFrame = _prefixId.prefix "IntransitiveAdjectivalComplementFrame"
    ...
    /// </summary>
    let IntransitiveAdverbialComplementFrame = _prefixId.prefix "IntransitiveAdverbialComplementFrame"
    ...
    /// </summary>
    let IntransitiveInterrogativeFrame = _prefixId.prefix "IntransitiveInterrogativeFrame"
    ...
    /// </summary>
    let IntransitiveInterrogativeInfinitiveFrame = _prefixId.prefix "IntransitiveInterrogativeInfinitiveFrame"
    ...
    /// </summary>
    let IntransitiveNominalComplementFrame = _prefixId.prefix "IntransitiveNominalComplementFrame"
    ...
    /// </summary>
    let IntransitivePPDeclarativeFrame = _prefixId.prefix "IntransitivePPDeclarativeFrame"
    ...
    let PrepositionalInterrogativeFrame = _prefixId.prefix "PrepositionalInterrogativeFrame"
    ...
    /// </summary>
    let ReflexiveDativeTransitiveFrame = _prefixId.prefix "ReflexiveDativeTransitiveFrame"
    ...
    /// </summary>
    let SubjectlessIntransitivePPFrame = _prefixId.prefix "SubjectlessIntransitivePPFrame"
    ...
    /// </summary>
    let TransitiveAdjectivalComplementFrame = _prefixId.prefix "TransitiveAdjectivalComplementFrame"
    ...
    /// </summary>
    let TransitiveAdverbialComplementFrame = _prefixId.prefix "TransitiveAdverbialComplementFrame"
    ...
    /// </summary>
    let TransitiveInterrogativeInfinitiveFrame = _prefixId.prefix "TransitiveInterrogativeInfinitiveFrame"
    ...
    /// </summary>
    let TransitiveNominalComplementFrame = _prefixId.prefix "TransitiveNominalComplementFrame"
    ...
    let indefiniteMultiplicativeNumeral = _prefixId.prefix "indefiniteMultiplicativeNumeral"
    ...
    let interrogativeMultiplicativeNumeral = _prefixId.prefix "interrogativeMultiplicativeNumeral"
    ...
    let prepositionalInterrogativeClause = _prefixId.prefix "prepositionalInterrogativeClause"
