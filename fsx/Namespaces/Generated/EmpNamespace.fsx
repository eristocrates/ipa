...
module emp =
    let _prefixId = PrefixId.fromNamespaceLabel "http://purl.org/ctic/empleo/oferta#" "emp"
    ...
    let esquemaCategorias_administracion = _prefixId.prefix "esquemaCategorias-administracion"

    let esquemaCategorias_agricultura_alimentacion = _prefixId.prefix "esquemaCategorias-agricultura_alimentacion"

    let esquemaCategorias_almacenes = _prefixId.prefix "esquemaCategorias-almacenes"

    let esquemaCategorias_arquitectura_diseño = _prefixId.prefix "esquemaCategorias-arquitectura_diseño"

    let esquemaCategorias_comercial_ventas = _prefixId.prefix "esquemaCategorias-comercial_ventas"

    let esquemaCategorias_comunicacion_cultura = _prefixId.prefix "esquemaCategorias-comunicacion_cultura"

    let esquemaCategorias_construccion = _prefixId.prefix "esquemaCategorias-construccion"

    let esquemaCategorias_derecho_psicologia = _prefixId.prefix "esquemaCategorias-derecho_psicologia"

    let esquemaCategorias_directivos = _prefixId.prefix "esquemaCategorias-directivos"

    let esquemaCategorias_educacion_serviciossociales = _prefixId.prefix "esquemaCategorias-educacion_serviciossociales"

    let esquemaCategorias_electricidad_energia = _prefixId.prefix "esquemaCategorias-electricidad_energia"
    ...
    let esquemaCategorias_informatica_telecomunicaciones = _prefixId.prefix "esquemaCategorias-informatica_telecomunicaciones"

    let esquemaCategorias_ingenieria_ciencias = _prefixId.prefix "esquemaCategorias-ingenieria_ciencias"

    let esquemaCategorias_limpieza_cuidadopersonas = _prefixId.prefix "esquemaCategorias-limpieza_cuidadopersonas"

    let esquemaCategorias_metal_mecanica = _prefixId.prefix "esquemaCategorias-metal_mecanica"

    let esquemaCategorias_peluqueria_estetica = _prefixId.prefix "esquemaCategorias-peluqueria_estetica"

    let esquemaCategorias_primer_empleo = _prefixId.prefix "esquemaCategorias-primer_empleo"

    let esquemaCategorias_salud_deporte = _prefixId.prefix "esquemaCategorias-salud_deporte"

    let esquemaCategorias_transporte = _prefixId.prefix "esquemaCategorias-transporte"

    let esquemaCategorias_turismo_hosteleria = _prefixId.prefix "esquemaCategorias-turismo_hosteleria"

    let esquemaCategorias_vigilancia_servicios = _prefixId.prefix "esquemaCategorias-vigilancia_servicios"

    let esquemaTiposContrato = _prefixId.prefix "esquemaTiposContrato"

    let esquemaTiposContrato_laboral_indefinido = _prefixId.prefix "esquemaTiposContrato-laboral_indefinido"

    let esquemaTiposContrato_laboral_temporal = _prefixId.prefix "esquemaTiposContrato-laboral_temporal"

    let esquemaTiposContrato_mercantil = _prefixId.prefix "esquemaTiposContrato-mercantil"
    ...
    ///   <a href="http://purl.org/ctic/empleo/oferta#requisito-informática">emp:requisito-informática</a>
    /// </summary>
    let requisito_informática = _prefixId.prefix "requisito-informática"
    /// <summary>
    ///   <para>dcterms:issued : 2012-09-01^^xsd:string</para>
