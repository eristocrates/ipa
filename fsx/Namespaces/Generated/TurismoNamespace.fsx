...
module turismo =
    let _prefixId = PrefixId.fromNamespaceLabel "http://idi.fundacionctic.org/cruzar/turismo#" "turismo"

    let Accesibilidad_completa = _prefixId.prefix "Accesibilidad-completa"

    let Accesibilidad_con_acompanyante = _prefixId.prefix "Accesibilidad-con-acompanyante"
    ...
    /// </summary>
    let Accesibilidad_de_movilidad_reducida = _prefixId.prefix "Accesibilidad-de-movilidad-reducida"
    ...
    let Grupo_con_personas_con_discapacidad = _prefixId.prefix "Grupo-con-personas-con-discapacidad"
    ...
    let Interes_en_estilo_contemporaneo = _prefixId.prefix "Interes-en-estilo-contemporaneo"
    ...
    let Interes_en_estilo_renacentista = _prefixId.prefix "Interes-en-estilo-renacentista"
