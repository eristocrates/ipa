...
module oad =
    ...
    /// </summary>
    let AdministrativeBiographicalHistory = _prefixId.prefix "AdministrativeBiographicalHistory"
    ...
    /// </summary>
    let appraisalDestructionAndSchedulingInformation = _prefixId.prefix "appraisalDestructionAndSchedulingInformation"
    ...
    /// </summary>
    let conditionsGoverningReproduction = _prefixId.prefix "conditionsGoverningReproduction"
    ...
    ///   <para>owl:deprecated : true^^xsd:booelan</para>
    ///   <para>dc11:description : Le classi production e custody sono state inserite per descrivere il rapporto tra una risorsa archivistica e una entità (CPF), volendo esplicitare anche le date di relazione verso un soggetto produttore o un conservatore, gestendo in questo modo ad esempio anche i cambi di custodia</para>
    ...
    /// </summary>
    let existenceAndLocationOfOriginals = _prefixId.prefix "existenceAndLocationOfOriginals"
    ...
    ///   <para>dc11:description : Le informazioni sottoforma di stringa di testo sulla consistenza vengono descritte attraverso la proprietà dc:format^^xsd:string</para>
    ...
    /// </summary>
    let hasAdministrativeBiographicalHistory = _prefixId.prefix "hasAdministrativeBiographicalHistory"
    ...
    /// </summary>
    let immediateSourceOfAcquisitionOrTransfer = _prefixId.prefix "immediateSourceOfAcquisitionOrTransfer"
    ...
    /// </summary>
    let physicalCharacteristicsAndTechnicalRequirements = _prefixId.prefix "physicalCharacteristicsAndTechnicalRequirements"
