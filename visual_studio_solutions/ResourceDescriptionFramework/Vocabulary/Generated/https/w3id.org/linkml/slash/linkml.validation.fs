namespace Linkml.validation.Namespace
module validation =
    let _prefixID = Communication.Internet.Standard.Resource.Identifier.Internationalized.inhabitant "https://w3id.org/linkml/" (Some "https://github.com/linkml/linkml/raw/refs/heads/main/packages/linkml_runtime/src/linkml_runtime/linkml_model/rdf/validation.ttl") (Some "linkml.validation") None
