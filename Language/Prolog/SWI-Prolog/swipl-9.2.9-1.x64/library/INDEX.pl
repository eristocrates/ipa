...
index((apply_macros_sentinel), 0, apply_macros, apply_macros).
...
index((call_cleanup), 3, backward_compatibility, backcomp).
...
index((git_current_branch), 2, git, git).
index((git_tags), 2, git, git).
...
index((macro_position), 1, macros, macros).
index((expand_macros), 5, macros, macros).
index((include_macros), 3, macros, macros).
...
index((cli_debug_opt_type), 3, prolog_main, main).
index((cli_debug_opt_help), 2, prolog_main, main).
index((cli_debug_opt_meta), 2, prolog_main, main).
...
index((prolog_config), 2, prolog_config, prolog_config).
index((coverage), 1, prolog_coverage, prolog_coverage).
index((coverage), 2, prolog_coverage, prolog_coverage).
index((show_coverage), 1, prolog_coverage, prolog_coverage).
index((show_coverage), 2, prolog_coverage, prolog_coverage).
index((cov_save_data), 2, prolog_coverage, prolog_coverage).
index((cov_load_data), 2, prolog_coverage, prolog_coverage).
index((cov_reset), 0, prolog_coverage, prolog_coverage).
index((cov_property), 1, prolog_coverage, prolog_coverage).
...
index((evaluable_property), 2, prolog_evaluable, prolog_evaluable).
...
index((pack_list), 2, prolog_pack, prolog_pack).
...
index((pack_install_local), 3, prolog_pack, prolog_pack).
...
index((pack_remove), 2, prolog_pack, prolog_pack).
index((pack_publish), 2, prolog_pack, prolog_pack).
index((pack_property), 2, prolog_pack, prolog_pack).
index((profile), 1, prolog_profile, prolog_profile).
index((profile), 2, prolog_profile, prolog_profile).
index((show_profile), 1, prolog_profile, prolog_profile).
index((profile_data), 1, prolog_profile, prolog_profile).
index((profile_procedure_data), 2, prolog_profile, prolog_profile).
...
index((list_tracing), 0, prolog_trace, prolog_trace).
index((notraceall), 0, prolog_trace, prolog_trace).
index((require_prolog_version), 2, prolog_versions, prolog_versions).
index((require_version), 3, prolog_versions, prolog_versions).
index((cmp_versions), 3, prolog_versions, prolog_versions).
...
index((with_rwlock), 3, rwlocks, rwlocks).
index((with_rwlock), 4, rwlocks, rwlocks).
...
index((ugraph_layers), 2, ugraphs, ugraphs).
