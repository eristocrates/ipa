...
index((reply_html_partial), 1, html_write, html_write).
...
index((reply_htmx), 1, htmx, htmx).
index((reply_htmx), 2, htmx, htmx).
index((htmx_oob), 4, htmx, htmx).
...
index((server_health), 1, http_server_health, http_server_health).
...
index((http_is_chunked), 1, http_stream, http_stream).
index((http_chunked_flush), 2, http_stream, http_stream).
index((http_chunked_add_trailer), 3, http_stream, http_stream).
