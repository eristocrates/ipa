...
# build directory.
TCL_BUILD_LIB_SPEC='-L/root/64bit/tcl8.6.17/win -ltcl86'
...
# compiled.
TCL_SRC_DIR='/root/64bit/tcl8.6.17'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/root/64bit/tcl8.6.17/win -ltclstub86'
...
TCL_BUILD_STUB_LIB_PATH='/root/64bit/tcl8.6.17/win/libtclstub86.a'
