...
# build directory.
TK_BUILD_LIB_SPEC='-L/root/64bit/tk8.6.17/win -ltk86'
...
# compiled.
TK_SRC_DIR='/root/64bit/tk8.6.17'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/root/64bit/tk8.6.17/win -ltkstub86'
...
TK_BUILD_STUB_LIB_PATH='/root/64bit/tk8.6.17/win/libtkstub86.a'
