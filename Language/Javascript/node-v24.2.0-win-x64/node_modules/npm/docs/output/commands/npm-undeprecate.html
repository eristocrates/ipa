...
<p>This command will update the npm registry entry for a package, removing any
deprecation warnings that currently exist.</p>
<p>It works in the same way as <a href="../commands/npm-deprecate.html">npm deprecate</a>, except
that this command removes deprecation warnings instead of adding them.</p>
