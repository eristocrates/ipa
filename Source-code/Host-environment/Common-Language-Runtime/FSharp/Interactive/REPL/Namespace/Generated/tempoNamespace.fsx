...
module tempo =
    let _prefixId = PrefixId.fromNamespaceLabel "http://purl.org/tempo/" "tempo"
    let _namespaceIri = _prefixId.prefix ""
    /// <summary>
    ///   <para>rdfs:label : Temporal Constraint</para>
    ///   <para>rdfs:comment : Temporal constraint box to capture a consistent set of validity and efficacy intervals.
    ///
    ...
    ///   <a href="http://purl.org/tempo/TemporalConstraint">tempo:TemporalConstraint</a>
    /// </summary>
    let TemporalConstraint = _prefixId.prefix "TemporalConstraint"
    /// <summary>
    ///   <para>rdfs:label : constrained by</para>
    ///   <para>rdfs:comment : A temporal constraint associated with this resource.</para>
    ///   <a href="http://purl.org/tempo/constrainedBy">tempo:constrainedBy</a>
    /// </summary>
    let constrainedBy = _prefixId.prefix "constrainedBy"
    /// <summary>
    ///   <para>rdfs:label : efficacious from</para>
    ///   <para>rdfs:comment : The date or time when this resource becomes efficacious.
    ///
    ...
    ///   <a href="http://purl.org/tempo/efficaciousFrom">tempo:efficaciousFrom</a>
    /// </summary>
    let efficaciousFrom = _prefixId.prefix "efficaciousFrom"
    /// <summary>
    ///   <para>rdfs:label : efficacious till</para>
    ///   <para>rdfs:comment : The date or time when this resource becomes inefficacious.
    ///
    ...
    ///   <a href="http://purl.org/tempo/efficaciousTill">tempo:efficaciousTill</a>
    /// </summary>
    let efficaciousTill = _prefixId.prefix "efficaciousTill"
    let rdf = _prefixId.prefix "rdf"
    let ttl = _prefixId.prefix "ttl"
    /// <summary>
    ///   <para>rdfs:label : valid from</para>
    ///   <para>rdfs:comment : The date or time when this resource becomes valid.
    ///
    ...
    /// is discouraged.
    /// </para>
    ///   <a href="http://purl.org/tempo/validFrom">tempo:validFrom</a>
    /// </summary>
    let validFrom = _prefixId.prefix "validFrom"
    /// <summary>
    ///   <para>rdfs:label : valid till</para>
    ///   <para>rdfs:comment : The date or time when this resource becomes invalid.
    ///
    ...
    /// is discouraged.
    /// </para>
    ///   <a href="http://purl.org/tempo/validTill">tempo:validTill</a>
    /// </summary>
    let validTill = _prefixId.prefix "validTill"
