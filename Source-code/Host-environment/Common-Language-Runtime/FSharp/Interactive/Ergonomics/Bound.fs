// https://github.com/brianberns/FRange/blob/master/FRange/Bound.fs
...
module private BoundDir =
    ...
    let sortProjection tieBreaker boundDir =
        ...
        | Unbounded -> int boundDir.Direction, None, 0, tieBreaker
        | Inclusive value -> 0, Some value, int boundDir.Direction, tieBreaker
        | Exclusive value -> 0, Some value, -1 * int boundDir.Direction, tieBreaker
