...
[<Literal>]
let exeDirectoryPathString =
    @"C:\Repositories\eristocrates\ipa\Language\Python\python-full-3.13.4-windows-x86_64\Scripts"
...
|> Array.Parallel.iter (fun stem ->
    ...
    let exeFilePath = Path.Combine(exeDirectoryPathString, $"{stem}.exe")
