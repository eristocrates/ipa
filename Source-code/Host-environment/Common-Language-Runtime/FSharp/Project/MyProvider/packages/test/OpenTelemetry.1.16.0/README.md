...
started](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.16.0/src/OpenTelemetry/../../README.md#getting-started). For additional details about
initialization patterns see: [Initialize the
SDK](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.16.0/src/OpenTelemetry/../../docs/README.md#initialize-the-sdk).
