...
module swap_set =
    ...
    ///     and the objet is the union of the sets in the object</para>
    ...
    ///     and the objet is the difference of the sets in the object</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>The subject is a list of sets,
    ///     and the objet is the intersection of the sets in the object</para>
    ...
    ///     Cwm will bind the object to each of the members of the suject.</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>The subject is a list of sets,
    ///     and the objet is the symmetricDifference of the sets in the object</para>
    /// labels<para>symmetric difference</para></remarks>
