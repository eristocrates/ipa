...
module cto =
    ...
    let InspectionTask =
        Namespaced_IRI.parse _namespace_name "InspectionTask" |> NamespacedName
    ...
    let InstallmentTask =
        Namespaced_IRI.parse _namespace_name "InstallmentTask" |> NamespacedName
    ...
    let ModificationTask =
        Namespaced_IRI.parse _namespace_name "ModificationTask" |> NamespacedName
    ...
    let RemovalTask =
        Namespaced_IRI.parse _namespace_name "RemovalTask" |> NamespacedName
    ...
    let RepairTask = Namespaced_IRI.parse _namespace_name "RepairTask" |> NamespacedName
    ...
    let TaskContext =
        Namespaced_IRI.parse _namespace_name "TaskContext" |> NamespacedName
    ...
    let TaskMethod = Namespaced_IRI.parse _namespace_name "TaskMethod" |> NamespacedName
    ...
    let afterFinishedTask =
        Namespaced_IRI.parse _namespace_name "afterFinishedTask" |> NamespacedName
    ...
    let hasComplexTaskMethodDescription =
        Namespaced_IRI.parse _namespace_name "hasComplexTaskMethodDescription" |> NamespacedName
    ...
    let hasSimpleTaskMethodDescription =
        Namespaced_IRI.parse _namespace_name "hasSimpleTaskMethodDescription" |> NamespacedName
    ...
    let hasTaskContext =
        Namespaced_IRI.parse _namespace_name "hasTaskContext" |> NamespacedName
    ...
    let hasTaskMethod =
        Namespaced_IRI.parse _namespace_name "hasTaskMethod" |> NamespacedName
    ...
    let isSubjectOfTask =
        Namespaced_IRI.parse _namespace_name "isSubjectOfTask" |> NamespacedName
    ...
    let resultsInAddedStatement =
        Namespaced_IRI.parse _namespace_name "resultsInAddedStatement" |> NamespacedName
    ...
    let resultsInStatement =
        Namespaced_IRI.parse _namespace_name "resultsInStatement" |> NamespacedName
    ...
    let resultsInDeletedStatement =
        Namespaced_IRI.parse _namespace_name "resultsInDeletedStatement" |> NamespacedName
