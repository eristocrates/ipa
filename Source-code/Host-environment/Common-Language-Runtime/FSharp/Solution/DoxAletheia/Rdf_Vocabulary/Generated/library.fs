...
module library =
    ...
    ///   <para>"This is the number of identifiable "library" collections that "hold" one or more exemplars (aka copies or "Items")."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"holdings count"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
