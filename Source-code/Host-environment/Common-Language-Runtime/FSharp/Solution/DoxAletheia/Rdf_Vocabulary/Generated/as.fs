...
module as_ =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>The actor is moving the object. The target specifies where the object is moving to. The origin specifies where the object is moving from.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>The actor is traveling to the target. The origin specifies where the actor is traveling from.</para>
