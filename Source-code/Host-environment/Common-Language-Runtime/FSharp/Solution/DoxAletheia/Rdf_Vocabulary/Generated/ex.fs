...
module ex =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A class represents one example."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>"Has an example code of an RDF/XML statements that use the schema. Content may be CDATA section or rdf:parseType="Literal"."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>"The subject has an Example. Use to include example(s) in a term definition."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Example"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://purl.org/net/ns/ex#example">http://purl.org/net/ns/ex#example</seealso>
    let example = Prefixed_Name(ex, "example") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"The subject is an example of the object vocabulary."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"主語は目的語語彙の用例である。"</para>
    /// labels<para>"Example of"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>"A pointer to an image that helps to understand the vocabulary."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>"A prefix used in the example to represent the schema namespace. A rendaring application may use this value to distinguish target terms in the example."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>"A pointer to a real example or a trial page."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
