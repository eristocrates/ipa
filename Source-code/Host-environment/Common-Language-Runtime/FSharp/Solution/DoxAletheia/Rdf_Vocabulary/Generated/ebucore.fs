...
module ebucore =
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>Metadata track</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>Key career event</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>Key personal event</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has related event</para></remarks>
    ...
    ///             timestamp in audiovisual MediaResources.</para>
    ...
    ///             time.</para>
    /// labels<para>Duration (time)</para></remarks>
    ...
    ///             rate.</para>
    /// labels<para>Duration (edit units)</para></remarks>
    ...
    ///             timecode.</para>
    /// labels<para>Duration (timecode)</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The duration of an event.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>A link to a an BusinessObject or a Resource preceding the current BusinessObject or Resource in an ordered sequence</para>
    ...
    /// labels<para>Encoder</para></remarks>
    ...
    /// labels<para>Related resource</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>Career event</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>Personal event</para></remarks>
    ...
    /// labels<para>Object/asset type</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has publication history</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>agent nationality</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>agent picture id locator</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>Bibliographical object</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has document format</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>Id picture</para></remarks>
    ...
    /// labels<para>Broadcast date</para></remarks>
    ...
    ///             using the isRelatedTo property.</para>
    ...
    ///             or Radio Series are composed of Episodes.</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>A track with timecode information.</para>
    /// labels<para>Timecode track</para></remarks>
    ...
    /// labels<para>License expiration date</para></remarks>
    ...
    /// labels<para>Audio track configuration</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>You tube video</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>adult content</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The age of a Contact/Person</para>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>agent country of residence</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>A link to a an BusinessObject or a Resource following the current BusinessObject or Resource in an ordered sequence</para>
    ...
    ///             related to the media resource or being the media resource itself</para>
    /// labels<para>Image</para></remarks>
    ...
    /// labels<para>Creation date/time</para></remarks>
    ...
    /// labels<para>Digitisation date/time</para></remarks>
    ...
    /// labels<para>Distribution date</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>The date when the resource was removed from institutional holdings.</para>
    /// labels<para>Ingest date</para></remarks>
    ...
    /// labels<para>Publication date/time</para></remarks>
    ...
    /// labels<para>License start date</para></remarks>
    ...
    /// labels<para>Migration date</para></remarks>
    ...
    /// labels<para>Modification date/time</para></remarks>
    ...
    /// labels<para>Normalization date</para></remarks>
    ...
    /// labels<para>Validation date</para></remarks>
