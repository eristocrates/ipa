...
module opmv =
    ...
    let wasEncodedBy =
        Namespaced_IRI.parse _namespace_name "wasEncodedBy" |> NamespacedName
    ...
    let wasEndedAt = Namespaced_IRI.parse _namespace_name "wasEndedAt" |> NamespacedName
    ...
    let wasGeneratedAt =
        Namespaced_IRI.parse _namespace_name "wasGeneratedAt" |> NamespacedName
    ...
    let wasStartedAt =
        Namespaced_IRI.parse _namespace_name "wasStartedAt" |> NamespacedName
    ...
    let wasUsedAt = Namespaced_IRI.parse _namespace_name "wasUsedAt" |> NamespacedName
    ...
    let withRespectOf =
        Namespaced_IRI.parse _namespace_name "withRespectOf" |> NamespacedName
