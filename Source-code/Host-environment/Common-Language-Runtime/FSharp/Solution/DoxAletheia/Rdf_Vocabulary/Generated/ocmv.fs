...
module ocmv =
    ...
    let OntologyType = _prefix "OntologyType"
    /// <summary>
    ...
    let OntologyDevelopmentContext = _prefix "OntologyDevelopmentContext"
    /// <summary>
    ...
    let ConceptualClarification = _prefix "ConceptualClarification"
    /// <summary>
    ...
    let OntologyPurpose = _prefix "OntologyPurpose"
    /// <summary>
    ...
    let DataPublication = _prefix "DataPublication"
    /// <summary>
    ...
    let LanguageEngineering = _prefix "LanguageEngineering"
    /// <summary>
    ...
    let MetadataElement = _prefix "MetadataElement"
    /// <summary>
    ...
    let OntologicalAnalysis = _prefix "OntologicalAnalysis"
    /// <summary>
    ...
    let OntologyRepresentationStyle = _prefix "OntologyRepresentationStyle"
    /// <summary>
    ...
    let OntoumlStyle = _prefix "OntoumlStyle"
    /// <summary>
    ...
    let conformsToSchema = _prefix "conformsToSchema"
    /// <summary>
    ...
    let representationStyle = _prefix "representationStyle"
    /// <summary>
    ...
    let storageUrl = _prefix "storageUrl"
