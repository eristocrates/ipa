...
module saref4envi =
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"A measurement fucntion, in case of complex measurement like time series, has frequency measurement, i.e. the frequency in which it makes measurements."</para>
