...
module uiot =
    ...
    /// labels<para>prenotazione utilizzata</para><para>reservation used</para></remarks>
    ...
    /// labels<para>utilizza risorsa</para><para>uses resource</para></remarks>
    ...
    /// labels<para>numero seriale</para><para>serial number</para></remarks>
    ...
    /// labels<para>associated business</para><para>business associato</para></remarks>
    ...
    /// labels<para>rende disponibile</para><para>makes available</para></remarks>
    ...
    /// labels<para>sessione effettuata da</para><para>session performed by</para></remarks>
    ...
    /// labels<para>deregistration date</para><para>data di disdetta</para></remarks>
    ...
    /// labels<para>fixed amount</para><para>costo fisso</para></remarks>
    ...
    /// labels<para>utente abilitato da</para><para>user enabled by</para></remarks>
    ...
    /// labels<para>registers record</para><para>registra record</para></remarks>
    ...
    /// labels<para>Utente Privato del Servizio</para><para>Service Private User</para></remarks>
    ...
    /// labels<para>Stazione di Mobilità</para><para>Mobility Station</para></remarks>
    ...
    /// labels<para>Risorsa del Servizio</para><para>Service Resource</para></remarks>
    ...
    /// labels<para>Utente Business del Servizio</para><para>Service Business User</para></remarks>
    ...
    /// labels<para>Utente del Servizio</para><para>Service User</para></remarks>
    ...
    /// labels<para>abilita sessione</para><para>enables session</para></remarks>
    ...
    /// labels<para>latest record</para><para>ultimo record</para></remarks>
    ...
    /// labels<para>contiene campionamento</para><para>contains observation</para></remarks>
    ...
    /// labels<para>campionamento in</para><para>observation in</para></remarks>
    ...
    /// labels<para>inclusa nella stazione di mobilità</para><para>included in mobility station</para></remarks>
    ...
    /// labels<para>resa disponibile da</para><para>made available by</para></remarks>
