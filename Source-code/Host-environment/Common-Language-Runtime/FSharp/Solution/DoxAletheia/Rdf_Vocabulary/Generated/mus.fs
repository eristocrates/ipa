...
module mus =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M12 Opus Number"</para><para>"M12 Numéro d'opus"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M167 Publication expression fragment"</para><para>"M167 Fragment d'expression de publication"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M16 Maintenance"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M170 Binding"</para><para>"M170 Reliure"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M173 Playing speed"</para><para>"M173 Vitesse de lecture"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M175 Music format"</para><para>"M175 Format musical"</para></remarks>
    ...
    /// labels<para>"M17 Controlled Access Point Creator"</para><para>"M17 Point d'accès contrôlé créateur"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M19 Style"</para></remarks>
    ...
    /// labels<para>"M1 Catalogue Statement"</para><para>"M1 Mention de catalogue"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M20 Music Group Formation"</para><para>"M20 Type de formation musicale ou vocale"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M21 Harmonic Structure"</para><para>"M21 Structure Harmonique"</para></remarks>
    ...
    /// labels<para>"M23 Casting Detail"</para><para>"M23 Détail de la distribution"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M24 Track"</para><para>"M24 Piste"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M25 Foreseen Activity"</para><para>"M25 Activité prévisionnelle"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M26 Foreseen Performance"</para><para>"M26 Performance prévisionnelle"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M28 Individual Performance"</para><para>"M28 Performance individuelle"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M30 Ambitus"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M31 Actor's Function"</para><para>"M31 Fonction de l'agent"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M32 Actor's Responsibility"</para><para>"M32 Responsabilité de l'agent"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M34 Award Assignment"</para><para>"M34 Attribution de récompense"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M35 Representative Publication Assignment"</para><para>"M35 Attribution d'Expression publicationnelle représentative"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M36 Award"</para><para>"M36 Récompense"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M38 Figure Rythmique"</para><para>"M38 Rhythmic Pattern"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M39 Derivation Type Assignment"</para><para>"M39 Attribution de type de dérivation"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M3 Order Number"</para><para>"M3 Numéro d'ordre"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M42 Performed Expression Creation"</para><para>"M42 Création d'Expression interprétée"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M43 Performed Expression"</para><para>"M43 Expression interprétée"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M44 Performed Work"</para><para>"M44 Oeuvre interprétée"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M45 Descriptive Expression Assignment"</para><para>"M45 Attribution d'Expression Descriptive"</para></remarks>
    ...
    /// labels<para>"M46 Set of Tracks"</para><para>"M46 Ensemble de Pistes"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M49 Performer status"</para><para>"M49 Statut de l'interprète"</para></remarks>
    ...
    /// labels<para>"M4 Key"</para><para>"M4 Tonalité"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M50 Performance mode"</para><para>"M50 Mode de performance"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M51 Type of recording equipment"</para><para>"M51 Type d'équipement d'enregistrement"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M52 Equalization technique"</para><para>"M52 Technique d'équalisation"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M53 Noise reduction  technique"</para><para>"M53 Technique de réduction de bruit"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M55 Condition of performance"</para><para>"M55 Condition de la performance"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M57 Vocal or instrumental technique"</para><para>"M57 Technique vocale ou instrumentale"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M58 Programming Work"</para><para>"M58 Oeuvre de programmation"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M5 Genre"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M60 Public visé"</para><para>"M60 Intended audience"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M61 Work type"</para><para>"M61 Type d'oeuvre"</para></remarks>
    ...
    /// labels<para>"M7 Linguistic Appellation"</para><para>"M7 Appellation linguistique"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M8 Tempo"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"M9 Derivation Type"</para><para>"M9 Type de dérivation"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"U38 has descriptive expression"</para><para>"U38 a pour expression descriptive"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"U3 forees use of specific object"</para><para>"U3 utilisation prévue de l'objet spécifique"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"U4 a pour édition princeps"</para><para>"U4 had princeps publication"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"U67 has subtitle"</para><para>"U67 a pour sous-titre"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"U69 has WoO number"</para><para>"U69 a pour numéro de WoO"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"U71 has uniform title"</para><para>"U71 a pour titre uniforme"</para></remarks>
    ...
    /// labels<para>"U78 durée estimée"</para><para>"U78 estimated duration"</para></remarks>
    ...
    ///   <para>"see also http://en.wikipedia.org/wiki/Relative_key"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>"see also http://en.wikipedia.org/wiki/Parallel_key"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>"see also http://en.wikipedia.org/wiki/Closely_related_key"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
