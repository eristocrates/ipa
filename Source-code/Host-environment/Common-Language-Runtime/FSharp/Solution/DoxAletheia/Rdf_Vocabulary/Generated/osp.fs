...
module osp =
    ...
    ///   <para>owl:Class</para>
    ///   <para>Le gouvernement est un des organes issus de la séparation des pouvoirs</para>
    /// labels<para>Gouvernment</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Classe décrivant une adresse postale</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>L'administration est dans le prolongement de l'administration. Elle est chargée de régler les affaires courantes</para>
    /// labels<para>Administration</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>Numéro de fax</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>propriété instaurant la hiérarchie entre un organisme et un service. Ne pas confondre avec des sous ensemble d'un même service</para>
    /// labels<para>Sous l'autorite de</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété définissant quel type de tribunal il s'agit. Ex : tribunal d'instance, TGI ...</para>
    /// labels<para>type du tribunal</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété liant un juge à sa fonction au sein du tribunal.</para>
    /// labels<para>compétence d'un juge</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Bâtiment officiel de l'Etat français où réside le maire et le conseil municipal. Il fait partit de l'administration décentralisée.</para>
    /// labels<para>Mairie</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Ambassade</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>Classe décrivant le chef d'Etat. La réalité de son pouvoir n'est pas le critère retenu mais ce qui apparait dans les textes. Ex : La reine d'Angleterre.</para>
    /// labels<para>chef d'Etat</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Le tribunal est un bâtiment public où la justice y est rendu par des juges.</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>La classe Juge représente la fonction de juge au sein d'un tribunal</para>
    /// labels<para>Juge</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Regroupe les structure qui ne correspondent pas à un niveau étatique mais inter étatique ou extra étatique (ex : les ONG)</para>
    /// labels<para>Organisation publique</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>La classe stateservice a pour but de différencier un Etat ou une organisation d'Etat d'une entreprise privée.</para>
    /// labels<para>Organisation Etatique</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>Il existe bien un secretary of state dans les autres pays mais n'a rien à voir avec la qualification de secretaire d'Etat en France</para>
    /// labels<para>Secretaire d'Etat</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Classe décrivant une personne ayant un rôle de ministre dans un gouvernement.</para>
    /// labels<para>Ministre</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>Branche judiciaire d'une organisation étatique</para>
    /// labels<para>Pouvoir judiciaire</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>Définie la fonction législative d'un pays</para>
    /// labels<para>Pouvoir législatif</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété liant quelque chose à un département. Inverse de arrondissementDe.</para>
    /// labels<para>aArrondissement</para></remarks>
    ...
    /// Le ministère de l'éducation exerce une autorité sur les écoles.</para>
    /// labels<para>a autorité sur</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Les chambres divisent un tribunal, souvent de façon thématique (droit de la construction, droit de la co-propriété)</para>
    /// labels<para>a chambre</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété permettant de lier quelque chose à un évènement tel qu'il est définie dans l'ontologie ical.</para>
    /// labels<para>A evenement</para></remarks>
    ...
    /// sameAs hashtag oegov</para>
    /// labels<para>a initiales</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété établissant un lien entre quelque chose et une commune</para>
    /// labels<para>a commune</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Le système juridictionnel français est composé de 2 degrés et d'une haute juridiction. La haute juridiction n'est pas un degre. Nous l'a comptons néanmoins ainsi pour simplifier l'utilisation pour d'autres systèmes. 1er degré, 2nd degré ou haute juridiction</para>
    /// labels<para>a degre</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété permettant la hiérarchisation du terrain couvert par un organisme. Généralement : régional, national, international.</para>
    /// labels<para>A Competence Territoriale</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété liant quelque chose à une région</para>
    /// labels<para>aRegion</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété liant un arrondissement à quelque chose</para>
    /// labels<para>arrondissementDe</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Une personne à la tête du gouvernement</para>
    /// labels<para>chef du gouvernement</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété apportant la distinction entre ordre administratif ou judiciaire pour un tribunal</para>
    /// labels<para>A ordre de juridiction</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Les chambres d'un tribunal sont décomposées en section</para>
    /// labels<para>a section</para></remarks>
    ...
    /// Ex : propriété intellectuelle, mer ...</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété définissant le chef d'Etat d'un pays</para>
    /// labels<para>has head of state</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété désignant la matière civile ou pénale que le tribunal revêt.</para>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>Adresse d'un établissement de service public</para></remarks>
    /// <seealso href="http://data.lirmm.fr/ontologies/osp#adresse">http://data.lirmm.fr/ontologies/osp#adresse</seealso>
    let adresse = Prefixed_Name(osp, "adresse") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété établissant un lien entre une commune et quelque chose.</para>
    /// labels<para>Commune de</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété définissant qu'un tribunal a un président</para>
    /// labels<para>has president of tribunal</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Correspond au lien vers un évènement particulier</para>
    /// labels<para>hyperlien Evenement</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété liant une personne au rôle de chef de l'Etat.</para>
    /// labels<para>est Chef d'Etat</para></remarks>
    /// <seealso href="http://data.lirmm.fr/ontologies/osp#chefDEtat">http://data.lirmm.fr/ontologies/osp#chefDEtat</seealso>
    let chefDEtat = Prefixed_Name(osp, "chefDEtat") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété liant un département à quelque chose</para>
    /// labels<para>departementDe</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Un service ou un pays à, dans un gouvernement démocratique, un chef de gouvernement</para>
    /// labels<para>has head of gov</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété liant quelque chose à ses initiales.</para>
    /// labels<para>Initiales de</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>Ligne pour une adresse (ex: rue, numéro)</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>ordre de juridiction</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Propriété liant une région à quelque chose</para>
    /// labels<para>regionDe</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Le pouvoir exécutif a pour charge d'exécuter les décisions de justice issues du pouvoir judiciaire et d'appliquer les lois votées par le pouvoir législatif.</para>
    /// labels<para>pouvoir exécutif</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>Classe décrivant un chef de gouvernement</para>
    /// labels<para>Chef du gouvernement</para></remarks>
    /// <seealso href="http://data.lirmm.fr/ontologies/osp#ChefDuGouvernement">http://data.lirmm.fr/ontologies/osp#ChefDuGouvernement</seealso>
    let ChefDuGouvernement = Prefixed_Name(osp, "ChefDuGouvernement") |> PrefixedName
