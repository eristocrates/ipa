...
module lifecycle =
    ...
    ///   <para>Once a transition is completed the state of the resource should change to the state specified as the resulting state.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The state property relates any resource with the state that it is currently in.</para>
    /// labels<para>state</para></remarks>
    /// <seealso href="http://purl.org/vocab/lifecycle/schema#state">http://purl.org/vocab/lifecycle/schema#state</seealso>
    let state = Prefixed_Name(lifecycle, "state") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The 'state of' property is the inverse of the state property, relating a state to all of the resources currently in that state.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>provides a simple ordering relationship to allow tasks to be ordered in user interfaces.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The possible state property is used to identify the states that occur within a given lifecycle and are thus the possible states of a resource going through that lifecycle.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>This uses a boolean to represent if an action has been completed. This is a simple alternative to the taskProgress property.</para>
    /// labels<para>completed</para></remarks>
    /// <seealso href="http://purl.org/vocab/lifecycle/schema#completed">http://purl.org/vocab/lifecycle/schema#completed</seealso>
    let completed = Prefixed_Name(lifecycle, "completed") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Sepcifies if a task is mandatory or optional.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>When in a state there may be many possible transitions.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The resource on which the action being taken. This is a resource that is being processed through a lifecycle.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>A task related to this transition.</para>
    /// labels<para>task</para></remarks>
    /// <seealso href="http://purl.org/vocab/lifecycle/schema#task">http://purl.org/vocab/lifecycle/schema#task</seealso>
    let task = Prefixed_Name(lifecycle, "task") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>A task group related to this transition.</para>
    /// labels<para>task group</para></remarks>
    /// <seealso href="http://purl.org/vocab/lifecycle/schema#taskGroup">http://purl.org/vocab/lifecycle/schema#taskGroup</seealso>
    let taskGroup = Prefixed_Name(lifecycle, "taskGroup") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The current progress on this task. Some resources are defined in this ontology for this, but you are free to define your own.</para>
