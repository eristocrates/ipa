...
module gc =
    ...
    ///
    /// labels<para>KML-Format</para></remarks>
    ...
    ///   <para>gc:DataFormat</para>
    ///
    /// labels<para>KMZ Format</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>The name, url and other details of an attribution.</para>
    ...
    ///   <para>gc:DataFormat</para>
    ///
    /// labels<para>CVS Format</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Political system</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>sub category</para></remarks>
    ...
    ///   <para>gc:DataFormat</para>
    ///
    /// labels<para>HTML Format</para></remarks>
    ...
    ///   <para>gc:DataFormat</para>
    ///
    /// labels<para>OWL Format</para></remarks>
    ...
    ///   <para>gc:DataFormat</para>
    ///
    /// labels<para>RDF Fomat</para></remarks>
    ...
    ///   <para>gc:DataFormat</para>
    ///
    /// labels<para>Unstructured Data Format</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>archive URL</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>founded on</para></remarks>
    ...
    ///   <para>gc:DataFormat</para>
    ///
    /// labels<para>Shapefile Format</para></remarks>
    ...
    ///   <para>gc:DataFormat</para>
    ///
    /// labels<para>RSS Format</para></remarks>
    ...
    ///   <para>gc:DataFormat</para>
    ///
    /// labels<para>Text Format</para></remarks>
    ...
    ///   <para>gc:DataFormat</para>
    ///
    /// labels<para>XML Format</para></remarks>
    ...
    ///   <para>gc:DataFormat</para>
    ///
    /// labels<para>XSL Format</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>cessation date</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>released date</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>submission date</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hashtag</para></remarks>
