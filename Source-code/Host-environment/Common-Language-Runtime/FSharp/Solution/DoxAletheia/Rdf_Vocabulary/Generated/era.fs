...
module era =
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>Radio Legacy Systems</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>The union of TemporalDuration that represents a time extent and TemporalEntity that represents a temporal interval or instant.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The numeric code for the subsidiary location</para>
    ...
    /// labels<para>organisation code</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>Vehicle length</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>Network statements characteristic</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>TSI Compliance of rules on sand characteristics. Deprecated according to the amendment to the Regulation (EU) 2019/777.</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>Indication of max. percentage of contact strip material Impregnated Carbon permitted to be used.</para>
