...
module wai =
    ...
    let atContext = Namespaced_IRI.parse _namespace_name "atContext" |> NamespacedName
    /// <summary>
    ...
    let personalizes =
        Namespaced_IRI.parse _namespace_name "personalizes" |> NamespacedName
    ...
    let profiles = Namespaced_IRI.parse _namespace_name "profiles" |> NamespacedName
