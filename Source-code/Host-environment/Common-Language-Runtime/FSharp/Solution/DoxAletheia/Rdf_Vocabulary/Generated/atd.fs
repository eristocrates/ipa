...
module atd =
    ...
    let IntervalData =
        Namespaced_IRI.parse _namespace_name "IntervalData" |> NamespacedName
    ...
    let METARreportingStation =
        Namespaced_IRI.parse _namespace_name "METARreportingStation" |> NamespacedName
    ...
    let ASPMmeteorologicalCondition =
        Namespaced_IRI.parse _namespace_name "ASPMmeteorologicalCondition" |> NamespacedName
    ...
    let MeteorologicalCondition =
        Namespaced_IRI.parse _namespace_name "MeteorologicalCondition" |> NamespacedName
    ...
    let AirportData =
        Namespaced_IRI.parse _namespace_name "AirportData" |> NamespacedName
    ...
    let aspmFlightRules =
        Namespaced_IRI.parse _namespace_name "aspmFlightRules" |> NamespacedName
    ...
    let CloudLayer = Namespaced_IRI.parse _namespace_name "CloudLayer" |> NamespacedName
    /// <summary>
    ...
    let cloudType = Namespaced_IRI.parse _namespace_name "cloudType" |> NamespacedName
    /// <summary>
    ...
    let CloudLayerProfile =
        Namespaced_IRI.parse _namespace_name "CloudLayerProfile" |> NamespacedName
    ...
    let FixCapacity =
        Namespaced_IRI.parse _namespace_name "FixCapacity" |> NamespacedName
    ...
    let FixFlow = Namespaced_IRI.parse _namespace_name "FixFlow" |> NamespacedName
    ...
    let METARreport =
        Namespaced_IRI.parse _namespace_name "METARreport" |> NamespacedName
    ...
    let metarReportType =
        Namespaced_IRI.parse _namespace_name "metarReportType" |> NamespacedName
    ...
    let metarReportModifier =
        Namespaced_IRI.parse _namespace_name "metarReportModifier" |> NamespacedName
    ...
    let MetCondition =
        Namespaced_IRI.parse _namespace_name "MetCondition" |> NamespacedName
    ...
    let meteorologicalConditionStatus =
        Namespaced_IRI.parse _namespace_name "meteorologicalConditionStatus" |> NamespacedName
    ...
    let RunwayReport =
        Namespaced_IRI.parse _namespace_name "RunwayReport" |> NamespacedName
    ...
    let RunwayStatusData =
        Namespaced_IRI.parse _namespace_name "RunwayStatusData" |> NamespacedName
    ...
    let runwayStatus =
        Namespaced_IRI.parse _namespace_name "runwayStatus" |> NamespacedName
    ...
    let SectorCapacity =
        Namespaced_IRI.parse _namespace_name "SectorCapacity" |> NamespacedName
    ...
    let SectorFlow = Namespaced_IRI.parse _namespace_name "SectorFlow" |> NamespacedName
    ...
    let SkyCondition =
        Namespaced_IRI.parse _namespace_name "SkyCondition" |> NamespacedName
    ...
    let SurfaceWindCondition =
        Namespaced_IRI.parse _namespace_name "SurfaceWindCondition" |> NamespacedName
    ...
    let surfaceWindDirectionStatus =
        Namespaced_IRI.parse _namespace_name "surfaceWindDirectionStatus" |> NamespacedName
    ...
    let TAFmeteorologicalCondition =
        Namespaced_IRI.parse _namespace_name "TAFmeteorologicalCondition" |> NamespacedName
    ...
    let rapidityOfWeatherChange =
        Namespaced_IRI.parse _namespace_name "rapidityOfWeatherChange" |> NamespacedName
    ...
    let TAFreport = Namespaced_IRI.parse _namespace_name "TAFreport" |> NamespacedName
    ...
    let tafReportType =
        Namespaced_IRI.parse _namespace_name "tafReportType" |> NamespacedName
    ...
    let VisibilityCondition =
        Namespaced_IRI.parse _namespace_name "VisibilityCondition" |> NamespacedName
    ...
    let WITIproperty =
        Namespaced_IRI.parse _namespace_name "WITIproperty" |> NamespacedName
    ...
    let weatherQualifier =
        Namespaced_IRI.parse _namespace_name "weatherQualifier" |> NamespacedName
    ...
    let weatherIntensity =
        Namespaced_IRI.parse _namespace_name "weatherIntensity" |> NamespacedName
    ...
    let weatherProximity =
        Namespaced_IRI.parse _namespace_name "weatherProximity" |> NamespacedName
    ...
    let airportArrivalRate =
        Namespaced_IRI.parse _namespace_name "airportArrivalRate" |> NamespacedName
    ...
    let airportDepartureRate =
        Namespaced_IRI.parse _namespace_name "airportDepartureRate" |> NamespacedName
    ...
    let arrivalDemand =
        Namespaced_IRI.parse _namespace_name "arrivalDemand" |> NamespacedName
    ...
    let associatedMETARreportingStation =
        Namespaced_IRI.parse _namespace_name "associatedMETARreportingStation" |> NamespacedName
    ...
    let hasMETARreport =
        Namespaced_IRI.parse _namespace_name "hasMETARreport" |> NamespacedName
    ...
    let baseAltitude =
        Namespaced_IRI.parse _namespace_name "baseAltitude" |> NamespacedName
    ...
    let dataIntervalEndDay =
        Namespaced_IRI.parse _namespace_name "dataIntervalEndDay" |> NamespacedName
    ...
    let dataIntervalEndTime =
        Namespaced_IRI.parse _namespace_name "dataIntervalEndTime" |> NamespacedName
    ...
    let dataIntervalStartDay =
        Namespaced_IRI.parse _namespace_name "dataIntervalStartDay" |> NamespacedName
    ...
    let dataIntervalStartTime =
        Namespaced_IRI.parse _namespace_name "dataIntervalStartTime" |> NamespacedName
    ...
    let departureDemand =
        Namespaced_IRI.parse _namespace_name "departureDemand" |> NamespacedName
    ...
    let edctArrivalHold =
        Namespaced_IRI.parse _namespace_name "edctArrivalHold" |> NamespacedName
    ...
    let edctDepartureHold =
        Namespaced_IRI.parse _namespace_name "edctDepartureHold" |> NamespacedName
    ...
    let etmsArrivals =
        Namespaced_IRI.parse _namespace_name "etmsArrivals" |> NamespacedName
    ...
    let etmsDepartures =
        Namespaced_IRI.parse _namespace_name "etmsDepartures" |> NamespacedName
    ...
    let forecastIssueTime =
        Namespaced_IRI.parse _namespace_name "forecastIssueTime" |> NamespacedName
    ...
    let forecastingAirport =
        Namespaced_IRI.parse _namespace_name "forecastingAirport" |> NamespacedName
    ...
    let hasTAFreport =
        Namespaced_IRI.parse _namespace_name "hasTAFreport" |> NamespacedName
    ...
    let hasASPMmetCondition =
        Namespaced_IRI.parse _namespace_name "hasASPMmetCondition" |> NamespacedName
    ...
    let hasAirportData =
        Namespaced_IRI.parse _namespace_name "hasAirportData" |> NamespacedName
    ...
    let hasCloudLayerProfile =
        Namespaced_IRI.parse _namespace_name "hasCloudLayerProfile" |> NamespacedName
    ...
    let hasSkyCondition =
        Namespaced_IRI.parse _namespace_name "hasSkyCondition" |> NamespacedName
    ...
    let hasSurfaceWindCondition =
        Namespaced_IRI.parse _namespace_name "hasSurfaceWindCondition" |> NamespacedName
    ...
    let hasVisibilityCondition =
        Namespaced_IRI.parse _namespace_name "hasVisibilityCondition" |> NamespacedName
    ...
    let highWindWITIdaily =
        Namespaced_IRI.parse _namespace_name "highWindWITIdaily" |> NamespacedName
    ...
    let highWindWITIhourly =
        Namespaced_IRI.parse _namespace_name "highWindWITIhourly" |> NamespacedName
    ...
    let hourlyPrecipitation =
        Namespaced_IRI.parse _namespace_name "hourlyPrecipitation" |> NamespacedName
    ...
    let limitedVisibilityDistance =
        Namespaced_IRI.parse _namespace_name "limitedVisibilityDistance" |> NamespacedName
    ...
    let unlimitedVisibility =
        Namespaced_IRI.parse _namespace_name "unlimitedVisibility" |> NamespacedName
    ...
    let lowCeilingWITIdaily =
        Namespaced_IRI.parse _namespace_name "lowCeilingWITIdaily" |> NamespacedName

    /// <summary>
    /// The low ceiling weather impacted traffic index (WITI) computed for the airport during the specified timeframe (hourly). WITI is an estimate of the number of flights potentially impacted due to inclement weather based on the scheduled traffic demand for a defined geographic region of the air traffic system (in this case, an airport). If the ceiling at the airport is below a set threshold, then the low ceiling WITI is set to the number of scheduled arrivals for that timeframe.
    /// <see href="https://data.nasa.gov/ontologies/atmonto/data#lowCeilingWITIhourly"></see></summary>
    let lowCeilingWITIhourly =
        Namespaced_IRI.parse _namespace_name "lowCeilingWITIhourly" |> NamespacedName
    ...
    let lowVisibilityWITIdaily =
        Namespaced_IRI.parse _namespace_name "lowVisibilityWITIdaily" |> NamespacedName

    /// <summary>
    /// The low visibility weather impacted traffic index (WITI) computed for the airport during the specified timeframe (hourly). WITI is an estimate of the number of flights potentially impacted due to inclement weather based on the scheduled traffic demand for a defined geographic region of the air traffic system (in this case, an airport). If the visibility at the airport is below a set threshold, then the low visibility WITI is set to the number of scheduled arrivals for that timeframe.
    /// <see href="https://data.nasa.gov/ontologies/atmonto/data#lowVisibilityWITIhourly"></see></summary>
    let lowVisibilityWITIhourly =
        Namespaced_IRI.parse _namespace_name "lowVisibilityWITIhourly" |> NamespacedName
    ...
    let metConditionProbability =
        Namespaced_IRI.parse _namespace_name "metConditionProbability" |> NamespacedName

    /// <summary>
    /// Entire text of METAR report.
    /// <see href="https://data.nasa.gov/ontologies/atmonto/data#metarReportString"></see></summary>
    let metarReportString =
        Namespaced_IRI.parse _namespace_name "metarReportString" |> NamespacedName
    ...
    let metarStationHasPrecipitationSensor =
        Namespaced_IRI.parse _namespace_name "metarStationHasPrecipitationSensor" |> NamespacedName
    ...
    let oagArrivalDelay =
        Namespaced_IRI.parse _namespace_name "oagArrivalDelay" |> NamespacedName
    ...
    let oagGateDepartureDelay =
        Namespaced_IRI.parse _namespace_name "oagGateDepartureDelay" |> NamespacedName
    ...
    let runwayReportedOn =
        Namespaced_IRI.parse _namespace_name "runwayReportedOn" |> NamespacedName
    ...
    let runwaySurfaceFriction =
        Namespaced_IRI.parse _namespace_name "runwaySurfaceFriction" |> NamespacedName
    ...
    let runwayVisibleRange =
        Namespaced_IRI.parse _namespace_name "runwayVisibleRange" |> NamespacedName
    ...
    let scheduledArrivals =
        Namespaced_IRI.parse _namespace_name "scheduledArrivals" |> NamespacedName
    ...
    let scheduledDepartures =
        Namespaced_IRI.parse _namespace_name "scheduledDepartures" |> NamespacedName
    ...
    let seaLevelPressure =
        Namespaced_IRI.parse _namespace_name "seaLevelPressure" |> NamespacedName
    ...
    let surfaceGustSpeed =
        Namespaced_IRI.parse _namespace_name "surfaceGustSpeed" |> NamespacedName
    ...
    let totalAirborneDelay =
        Namespaced_IRI.parse _namespace_name "totalAirborneDelay" |> NamespacedName
    ...
    let windDirectionFixed =
        Namespaced_IRI.parse _namespace_name "windDirectionFixed" |> NamespacedName
    ...
    let windDirectionLower =
        Namespaced_IRI.parse _namespace_name "windDirectionLower" |> NamespacedName
    ...
    let windDirectionUpper =
        Namespaced_IRI.parse _namespace_name "windDirectionUpper" |> NamespacedName
    ...
    let windShearHeight =
        Namespaced_IRI.parse _namespace_name "windShearHeight" |> NamespacedName
