...
module aws =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"pair of upward and downward facing solarimeters"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"albedometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"The aneroid displacement transducer contains a sensor with electrical properties (resistance or capacitance) that changes as the atmospheric pressure changes."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"aneroid displacement transducer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Atmometer or small surface evaporimeter"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Atmospheric pressure"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"time during which direct radiation (on a plane perpendicular to the Sun’s beam) is larger than 120 Wm-2."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Automatic sunshine recorder"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"total solar irradiance on a horizontal surface"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Bimetallic actinograph"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"World standard abolished in 1989"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Campbell-Stokes sunshine meter"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"certain materials interact with water vapour and undergo a change in capacitance, in relation to ambient humidity."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"capacitance sensor"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"certain materials interact with water vapour and undergo a change in capacitance, in relation to ambient humidity."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Capacitive - aluminum oxide"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"The aneroid displacement transducer contains a sensor with electrical properties (resistance or capacitance) that changes as the atmospheric pressure changes."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Capacitive aneroid"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Capacitive bead"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"certain materials interact with water vapour and undergo a change in capacitance, in relation to ambient humidity."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Capacitive - thin film polymer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"condensation is detected on the surface of a small polished metal reflecting surface (a mirror), using optical means. The temperature at which condensation is formed is the dew point."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"chilled-mirror hygrometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Chilled mirror system"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"the angular velocity of the cup is directly proportional to the component of the wind speed parallel to the axis of rotation."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Cup anemometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A cylindrical resonator barometer (or vibrating cylinder air-pressure transducer) is designed to measure absolute air pressure using the vibrating element principle, providing a frequency output from which pressure is computed."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"cylindrical resonator barometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A dew cell heats a salt solution until its equilibrium vapour pressure equals to the ambient vapour pressure, and maintains this equilibrium The temperature when this occurs is measured and it provides a measure of the ambient vapour pressure"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"dew cell"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Dewcel system"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"differential expansion thermometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"digital piezo-resistive barometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"total solar irradiance on a horizontal surface"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Dirmhirm-Sauberer pyranometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Counting the number of uniform droplets corresponding to a fixed volume of water"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Drop counters"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"electric sensor, which exploits the conductivity variation as a function of wetness"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Electrical resistance block"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"certain materials interact with water vapour and undergo a change in electrical resistance, in relation to ambient humidity."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"electrical resistance humidity sensor"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"For small temperature changes, the increase in resistance of pure metals is proportional to the change in temperature. Often made in Platinum."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Electrical resistance thermometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"total solar irradiance on a horizontal surface"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Eppley pyranometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Fiber-glass block"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Frequency domain reflectometry (capacitance)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Gamma absorption"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Gypsum block"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Hot-bead anemometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Hot-wire anemometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Lysimeters are used for measurement of evaporation, transpiration, evapotranspiration (ET), effective rainfall, drainage, chemical contents of drainage water, to study climatic effects of ET on the performance of crops."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"hydraulic lysimeter (more robust weighing type)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Impact of precipitation particles on a plastic or metal membrane"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Impact disdrometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Infra-red gas analyzer hygrometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Kata thermometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"emits modulated visible laser light and determines the distance to an object by comparing phase information"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Laser"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Measuring the water level in a tube"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Level measurement rain gauge"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Lysimeters are used for measurement of evaporation, transpiration, evapotranspiration (ET), effective rainfall, drainage, chemical contents of drainage water, to study climatic effects of ET on the performance of crops."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"lysimeter"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Mechanical Aneroid barometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"mechanical hygrometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"mechanical sensor with recorder"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Mercury barometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Lysimeters are used for measurement of evaporation, transpiration, evapotranspiration (ET), effective rainfall, drainage, chemical contents of drainage water, to study climatic effects of ET on the performance of crops."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Microlysimeter"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Backscatter (intensity of backscattered signal related to the number of particles and/or their water content)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Microwave radar disdrometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"total solar irradiance on a horizontal surface"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Moll-Gorczynki pyranometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Net all-wave radiation (net flux of downward and upward total radiation i.e. solar, terrestrial and atmospheric)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Net radiometer or net pyrradiometer or net exchange radiometer or balancemeter"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Neutron probe"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Nylon units"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Optical/Capacitive sensor"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Thin laser light sheets crossing the measuring volume: particle volume, speed (forward scatter)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Optical disdrometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Lysimeters are used for measurement of evaporation, transpiration, evapotranspiration (ET), effective rainfall, drainage, chemical contents of drainage water, to study climatic effects of ET on the performance of crops."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Popoff lysimeter (combined drainage and weighing type)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Artificially ventilated psychrometers, such as the Assmann type, the aspirated screen type, and the whirling type,"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"portable aspirated and shielded psychrometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Precipitation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Pressure tube anemometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"the angular velocity of the propeller rotor is directly proportional to the component of the wind speed parallel to the axis of rotation."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Propeller anemometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"psychrometer equipped with mercury-in-glass thermometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"total solar irradiance on a horizontal surface"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"pyranometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"pyranometer with shade ring"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"measurement of long-wave radiation from the earth"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Pyrgeometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"measure the PAR directly in the range 0.4 to 0.7 micrometers"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Quantum sensor"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"The aneroid displacement transducer contains a sensor with electrical properties (resistance or capacitance) that changes as the atmospheric pressure changes."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Resistive aneroid"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"screened and open pan evaporimeter"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Shaded Piche evaporimeter"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Single or double-junction peltier psychrometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Snow gauge"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Tensiometric sensors detect the hydrostatic pressure caused by the layer of snow on top of the pillow"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Snow pillow"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"measure the elapsed time between emission and return of an ultrasonic pulse sent vertically down to the snow covered ground surface"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Sonic ranging"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"measurements of infra-red radiation emitted from near or remote surfaces"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Surface temperature radiometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Tensiometer"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Based on the variation of resistance of a semiconductor with a relatively large temperature coefficient of resistance, either positive (PTC) or negative (NTC) depending upon the actual material"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Thermistor"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Based on the generation of an electromotive force at the junction between two metals in contact, which is function of the temperature of the two metals"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Thermocouple"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Lysimeters are used for measurement of evaporation, transpiration, evapotranspiration (ET), effective rainfall, drainage, chemical contents of drainage water, to study climatic effects of ET on the performance of crops."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Thornthwaite lysimeter (drainage type)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Time domain reflectometry (TDR) and time delay transmission"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Time Domain Reflectometry"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Tipping balance of two buckets"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Tipping bucket rain gauge"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Tipping balance of two buckets"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Tipping-bucket rain gauge (TBRG) without correction"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Tipping balance of two buckets"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Tipping-bucket rain gauge with correction algorithm (TBRG-SC)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Tipping balance of two buckets"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Tipping-bucket rain gauge with extra pulse correction (TBRG-PC)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Tipping balance of two buckets"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Tipping-bucket rain gauge with mechanical correction (TBRG-MC)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Tube solarimeter"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Ultrasonic Sensor (virtual temperature)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A sonic signal is emitted by sensor transducers"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Ultrasonic Wind sensor"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Lysimeters are used for measurement of evaporation, transpiration, evapotranspiration (ET), effective rainfall, drainage, chemical contents of drainage water, to study climatic effects of ET on the performance of crops."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"weighing lysimeter"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Weighing of precipitation accumulated in a storage container"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Weighing rain gauge"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Weighing of precipitation accumulated in a storage container"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Weighing rain gauge with pressure measurement"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Wet-bulb temperature measurement system"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Wetting front detection"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Wind"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"The signal generator is a shaft angle transducer: potentiometers, alternating and direct current synchros, digital angle-encoder disks, direct reading dials, and rotary switches"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"Sensor that takes wind direction measurements"</para>
    /// labels<para>"Wind Vane"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <summary>
    ///   <para>aws:air_temperature</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://purl.oclc.org/NET/ssnx/meteo/aws#air_temperature">http://purl.oclc.org/NET/ssnx/meteo/aws#air_temperature</seealso>
    let air_temperature = Prefixed_Name(aws, "air_temperature") |> PrefixedName
