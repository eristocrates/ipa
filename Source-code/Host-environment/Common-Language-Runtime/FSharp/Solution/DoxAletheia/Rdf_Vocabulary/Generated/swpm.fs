...
module swpm =
    ...
    /// labels<para>"The CodeWorkProduct entity"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///    valor para terceros."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"The DeliverableProduct entity"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"Clase que representa un documento técnico de trabajo."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"The DocumentaryWorkProduct entity"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///    o de código."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"The InternalProduct entity"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///    lenguaje de modelado."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"The Model entity"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///    un proyecto."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///    determinado documento generado durante el proyecto."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///    fuente basado en algún lenguaje de programación."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"The SourcePackage entity"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///    aspecto del proyecto software."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"The Specification entity"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///    entregables o internos."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"The WorkProduct entity"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>"Descripción de un proyecto, producto de trabajo, sección, modelo, especificación o paquete de código fuente"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Secciones incluidas dentro de una sección de un producto de trabajo documental"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Productos de trabajo incluidos dentro de un producto entregable"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"The embeddedWorkproducts reference"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Modelos de Ingeniería del Software incluidos dentro de una sección de un producto de trabajo documental"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"The models reference"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Orden de la sección dentro de un producto de trabajo de tipo documental"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Paquetes existentes en un producto de trabajo de código fuente"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Secciones dentro de un producto de trabajo documental"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Especificaciones, no basadas en modelos, incluidas dentro de una sección de un producto de trabajo documental"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"The specifications reference"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Tipo de un modelo, especificación, producto entregable o paquete de código fuente"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Productos de trabajo asociados a un proyecto"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"The workproducts reference"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
