...
module tmo =
    ...
    /// involved.</para>
    /// labels<para>AbilityCarrier</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>StateTypeRole is an abstract class which subsumes various other classes which represent "states" or roles e.g. in role based modelling conpetualisations.</para>
    /// labels<para>StateTypeRole</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>AgentAbilityCarrier</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>AttachmentRoles further specify the type of how an attachment relates to a task. Example instances  of AttachmentRoles are e.g. "desired_request", "required" and "used".</para>
    /// labels<para>AttachmentRole</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>PersonInvolvement  realizes n-ary associations to Persons which are realtedd to an task. The involvement is further characterized by an PersonTaskRole.</para>
    /// labels<para>PersonInvolvement</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>Examples instances  of AbilityCarrirRoles are e.g. "requested", "required" and "used" which further specify the type a person was involved in.</para>
    /// labels<para>AbilityCarrierRole</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>AssociationDependency</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>contextTask</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Endusers can clarify why they created a depedency.</para>
    /// labels<para>dependencyDescription</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>dependencyOrderNumber</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>indexPosition</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>lastReviewDate</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>logEntry</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>receiveDateTime</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>sendDateTime</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>superTask</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Ordering of the subtasks listed in the tmo:subTasks property of this Task. This is only for ordering/sorting in GUIs, the semantic relation is defined in subTasks, and if this and subTasks differ, subTasks is the correct list.</para>
    /// labels<para>subTaskOrdering</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>targetCompletion</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>targetEndTime</para></remarks>
    ...
    /// Technology considerations: Informal descriptions allow for text similarity processing, a formal description allows for applying case based similarity measures.</para>
    /// labels<para>taskDescription</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>taskGoal</para></remarks>
    ...
    ///   <para>tmo:Importance</para>
    ///
    /// labels<para>TMO_Instance_Importance_02</para></remarks>
    ...
    ///   <para>tmo:Importance</para>
    ///
    /// labels<para>TMO_Instance_Importance_05</para></remarks>
    ...
    ///   <para>tmo:Importance</para>
    ///
    /// labels<para>TMO_Instance_Importance_09</para></remarks>
    ...
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Creator</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Initiator</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Owner</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Related</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>By means of the TransmissionType one can distinguish several different types which might imply a different business logic. e.g. delegation can mean that the results of the task fulfillment care to be reported back to the sender of the task.</para>
    /// labels<para>TransmissionType</para></remarks>
    ...
    ///
    /// labels<para>TMO_Instance_Urgency_03</para></remarks>
    ...
    ///   <para>tmo:Urgency</para>
    ///
    /// labels<para>TMO_Instance_Urgency_07</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>The tmo:task is the central entitiey of the tmo. Task can range from vague things to be possibly done in e distant future to concrete things to be done in a precise forseeable manner. It is not unrealisitc to assume that knowledge worker have hundred or more tasks a day.</para>
    ...
    /// information is transferred in the "task space" of the participating persons.</para>
    /// labels<para>TaskTransmission</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>abilityCarrierInvolvement</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>actualCompletion</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>actualEndTime</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>actualTime</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>actualStartTime</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>connects a Task with an Attachment object. Attachments are associations of Things.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Inverse of attachment, connects an Attachment Association to the associated Task. Is required for every instance of Attachment.</para>
    /// labels<para>attachmentTask</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>The class AbilityCarrier_Involvement ties together an AbilityCarrier with an AbilityCarrier_Role. This is a role based modelling approach. An n-ary relation is realized.</para>
    /// labels<para>AbilityCarrierInvolvement</para></remarks>
    /// <seealso href="http://www.semanticdesktop.org/ontologies/2008/05/20/tmo#AbilityCarrierInvolvement">http://www.semanticdesktop.org/ontologies/2008/05/20/tmo#AbilityCarrierInvolvement</seealso>
    let AbilityCarrierInvolvement =
        Prefixed_Name(tmo, "AbilityCarrierInvolvement") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>dateTime subsumes various properties with Range XMLSchema:dateTime. If possible they are further grouped by "abstract" properties.</para>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>attachmentReference</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>containsTask</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>contextThread</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>delegability</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The semantic of this relation is defined in the sublclass of undirected Dependency on which this property is stated. (The subject of the statment where this property is expressed)</para>
    /// labels<para>dependencyMemberA</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>taskReference</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>dependencyType</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>dueDate</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>involvedPersonRole</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>involvedPersonTask</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>nextReviewIntervall</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>subTask</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>targetTime</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>targetStartTime</para></remarks>
    ...
    /// The Task Identifier is automatically generated during the creation of a task. The generation of identifiers (IDs) is a Nepomuk architecture issue (Wp2000/WP6000).</para>
    /// labels<para>taskId</para></remarks>
    ...
    /// This separation may arise as a general Nepomuk issue and may therefore be handled in conjunction with a privacy preserving SSD architecture.</para>
    /// labels<para>taskPrivacyState</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>here can be stated from which sources a task was derived. e.g from another task or from an task pattern</para>
    /// labels<para>taskSource</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>taskStateChangesFrom</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>taskStateChangesTo</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>transmissionTask</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>transmissionStateChangesFrom</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>transmissionStateChangesTo</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>transmissionTo</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>A symmetric relations between task.</para>
    /// labels<para>UndirectedDependency</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>Interdependence</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>The semantic of this relation is defined in the sublclass of undirected Dependency on which this property is stated. (The subject of the statment where this property is expressed)</para>
    /// labels<para>dependencyMemberB</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>involvedPersons</para></remarks>
    ...
    /// Examples instances  of AttachmentRoles are e.g.</para>
    /// labels<para>PersonInvolvementRole</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>In a  PredecessorDependency the dependencyMemberA is the task which is to be executed before dependencyMemberB.</para>
    /// labels<para>PredecessorDependency</para></remarks>
    ...
    ///
    /// A dependency relation is characterized by the type of the relation and by an additional description. There are different possibilities for dependency relations between tasks.</para>
    /// labels<para>TaskDependency</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>examples: Architect, Developer, ...</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>examples are e.g. technologies like Java, XML,  ...</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>The PredecessorSuccessorDependency enables a directed relation between task. By means of the concrete sublcasses one can further distinguish from which point of view this relation is created.</para>
    /// labels<para>PredecessorSuccessorDependency</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>SimilarityDependence</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>In a SuccessorrDependency the dependencyMemberA is the task which is to be executed after dependencyMemberB.</para>
    /// labels<para>SuccessorDependency</para></remarks>
    ...
    ///   <para>tmo:AbilityCarrierRole</para>
    ///
    /// labels<para>TMO_Instance_AbilityCarrierRole_Required</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>urgency</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The Task Name helps the user to identify a task in a list. It should be expressive enough to give a meaningful recognition. Details should be written in the description attribute instead. A name attribute is not allowed to contain line breaks.</para>
    /// labels<para>taskName</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The task state describes the current state of the task as described in Section 5.2.7.</para>
    /// labels<para>taskState</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>transmissionFrom</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>By means of the SuperSubTaskDependency one can further describe the subtask-supertask relation .e.g by an descriptin. This enables an n-ary relation between subtask and supertask.</para>
    /// labels<para>SuperSubTaskDependency</para></remarks>
    ...
    ///   <para>tmo:AbilityCarrierRole</para>
    ///
    /// labels<para>TMO_Instance_AbilityCarrierRole_Used</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>transmissionState</para></remarks>
    ...
    ///   <para>tmo:AttachmentRole</para>
    ///
    /// labels<para>TMO_Instance_AttachmentRole_Required</para></remarks>
    ...
    ///   <para>tmo:Delegability</para>
    ///
    /// labels<para>TMO_Instance_Delegability_Never</para></remarks>
    ...
    ///   <para>tmo:Delegability</para>
    ///
    /// labels<para>TMO_Instance_Delegability_High</para></remarks>
    ...
    ///   <para>tmo:Importance</para>
    ///
    /// labels<para>TMO_Instance_Importance_01</para></remarks>
    ...
    ///   <para>tmo:Delegability</para>
    ///
    /// labels<para>TMO_Instance_Delegability_Medium</para></remarks>
    ...
    ///   <para>tmo:Importance</para>
    ///
    /// labels<para>TMO_Instance_Importance_06</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Analyst</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Observer</para></remarks>
    ...
    ///   <para>tmo:Importance</para>
    ///
    /// labels<para>TMO_Instance_Importance_03</para></remarks>
    ...
    ///   <para>tmo:Importance</para>
    ///
    /// labels<para>TMO_Instance_Importance_10</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Controller</para></remarks>
    ...
    ///   <para>tmo:Importance</para>
    ///
    /// labels<para>TMO_Instance_Importance_08</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Collaborator</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Executor</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Delegate</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Receiver</para></remarks>
    ...
    ///   <para>tmo:Priority</para>
    ///
    /// labels<para>TMO_Instance_Priority_High</para></remarks>
    ...
    ///
    /// labels<para>TMO_Instance_TaskContainer_activetasks</para></remarks>
    ...
    ///   <para>tmo:TaskPrivacyState</para>
    ///
    /// labels<para>TMO_Instance_TaskPrivacy_Professional</para></remarks>
    ...
    ///   <para>tmo:TaskState</para>
    ///
    /// labels<para>TMO_Instance_TaskState_Finalized</para></remarks>
    ...
    ///   <para>tmo:TaskState</para>
    ///
    /// labels<para>TMO_Instance_TaskState_Suspended</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>States a task can go through during transmission of an task.</para>
    /// labels<para>TransmissionState</para></remarks>
    /// <seealso href="http://www.semanticdesktop.org/ontologies/2008/05/20/tmo#TransmissionState">http://www.semanticdesktop.org/ontologies/2008/05/20/tmo#TransmissionState</seealso>
    let TransmissionState = Prefixed_Name(tmo, "TransmissionState") |> PrefixedName
    ...
    ///   <para>tmo:TransmissionState</para>
    ///
    /// labels<para>TMO_Instance_TransmissionState_Rejected_NotTransmitted</para></remarks>
    ...
    ///   <para>tmo:TransmissionType</para>
    ///
    /// labels<para>TMO_Instance_TransmissionType_Delegation</para></remarks>
    ...
    ///   <para>tmo:Urgency</para>
    ///
    /// labels<para>TMO_Instance_Urgency_09</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>abilityCarrierTask</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_InternalObserver</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Reviewer</para></remarks>
    ...
    ///   <para>tmo:Priority</para>
    ///
    /// labels<para>TMO_Instance_Priority_Low</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>TaskContainer</para></remarks>
    ...
    ///   <para>tmo:TaskContainer</para>
    ///
    /// labels<para>TMO_Instance_TaskContainer_trashtasks</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Suggested</para></remarks>
    ...
    ///   <para>tmo:Priority</para>
    ///
    /// labels<para>TMO_Instance_Priority_Medium</para></remarks>
    ...
    ///   <para>tmo:TaskContainer</para>
    ///
    /// labels<para>TMO_Instance_TaskContainer_archive</para></remarks>
    ...
    ///   <para>tmo:TaskContainer</para>
    ///
    /// labels<para>TMO_Instance_TaskContainer_outbox</para></remarks>
    ...
    ///   <para>tmo:TaskPrivacyState</para>
    ///
    /// labels<para>TMO_Instance_TaskPrivacy_Private</para></remarks>
    ...
    ///   <para>tmo:TaskState</para>
    ///
    /// labels<para>TMO_Instance_TaskState_Deleted</para></remarks>
    ...
    ///   <para>tmo:TaskContainer</para>
    ///
    /// labels<para>TMO_Instance_TaskContainer_inbox</para></remarks>
    ...
    ///   <para>tmo:TaskState</para>
    ///
    /// labels<para>TMO_Instance_TaskState_Completed</para></remarks>
    ...
    ///   <para>tmo:TaskState</para>
    ///
    /// labels<para>TMO_Instance_TaskState_New</para></remarks>
    ...
    ///   <para>tmo:TaskState</para>
    ///
    /// labels<para>TMO_Instance_TaskState_Archived</para></remarks>
    ...
    ///   <para>tmo:TaskState</para>
    ///
    /// labels<para>TMO_Instance_TaskState_Running</para></remarks>
    ...
    ///   <para>tmo:TransmissionState</para>
    ///
    /// labels<para>TMO_Instance_TransmissionState_Accepted_NotTransmitted</para></remarks>
    ...
    ///   <para>tmo:TransmissionState</para>
    ///
    /// labels<para>TMO_Instance_TransmissionState_Rejected_Transmitted</para></remarks>
    ...
    ///   <para>tmo:TransmissionType</para>
    ///
    /// labels<para>TMO_Instance_TransmissionType_Join</para></remarks>
    ...
    ///   <para>tmo:Urgency</para>
    ///
    /// labels<para>TMO_Instance_Urgency_02</para></remarks>
    ...
    ///   <para>tmo:Urgency</para>
    ///
    /// labels<para>TMO_Instance_Urgency_05</para></remarks>
    ...
    ///   <para>tmo:Urgency</para>
    ///
    /// labels<para>TMO_Instance_Urgency_08</para></remarks>
    ...
    ///   <para>tmo:TransmissionState</para>
    ///
    /// labels<para>TMO_Instance_TransmissionState_Accepted_Transmitted</para></remarks>
    ...
    ///   <para>tmo:TransmissionType</para>
    ///
    /// labels<para>TMO_Instance_TransmissionType_Transfer</para></remarks>
    ...
    ///   <para>tmo:Urgency</para>
    ///
    /// labels<para>TMO_Instance_Urgency_06</para></remarks>
    ...
    ///   <para>tmo:Urgency</para>
    ///
    /// labels<para>TMO_Instance_Urgency_10</para></remarks>
    ...
    ///   <para>tmo:TaskState</para>
    ///
    /// labels<para>TMO_Instance_TaskState_Terminated</para></remarks>
    ...
    ///   <para>tmo:TransmissionState</para>
    ///
    /// labels<para>TMO_Instance_TransmissionState_NotTransmitted</para></remarks>
    ...
    ///   <para>tmo:TransmissionState</para>
    ///
    /// labels<para>TMO_Instance_TransmissionState_Transmitted</para></remarks>
    ...
    ///   <para>tmo:Urgency</para>
    ///
    /// labels<para>TMO_Instance_Urgency_01</para></remarks>
    ...
    ///   <para>tmo:Urgency</para>
    ///
    /// labels<para>TMO_Instance_Urgency_04</para></remarks>
    ...
    ///   <para>tmo:AbilityCarrierRole</para>
    ///
    /// labels<para>TMO_Instance_AbilityCarrierRole_Requested</para></remarks>
    ...
    ///   <para>tmo:AttachmentRole</para>
    ///
    /// labels<para>TMO_Instance_AttachmentRole_Desired_Requested</para></remarks>
    ...
    ///   <para>tmo:AttachmentRole</para>
    ///
    /// labels<para>TMO_Instance_AttachmentRole_Related</para></remarks>
    ...
    ///   <para>tmo:AttachmentRole</para>
    ///
    /// labels<para>TMO_Instance_AttachmentRole_Used</para></remarks>
    ...
    ///   <para>tmo:Delegability</para>
    ///
    /// labels<para>TMO_Instance_Delegability_Low</para></remarks>
    ...
    ///   <para>tmo:Delegability</para>
    ///
    /// labels<para>TMO_Instance_Delegability_Unrestricted</para></remarks>
    ...
    ///   <para>tmo:Importance</para>
    ///
    /// labels<para>TMO_Instance_Importance_04</para></remarks>
    ...
    ///   <para>tmo:Importance</para>
    ///
    /// labels<para>TMO_Instance_Importance_07</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Co-worker</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_ExternalObserver</para></remarks>
    ...
    ///   <para>tmo:PersonInvolvementRole</para>
    ///
    /// labels<para>TMO_Instance_PersonInvolvementRole_Involved</para></remarks>
