...
module drm =
    ...
    ///   <para>owl:Class</para>
    ///   <para>Requests for data services, such as a query of a Data Asset.  These requests are supported by Data Access Services</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The frequency at which the exchange occurs.</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Example: The “SSN” Attribute of a “Person” Entity may have a Data Type of “string” (if hyphens are included with the SSN) or “integer” (if hyphens are not included).</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>The term “data asset” is synonymous with “data source”</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>A Digital Data Resource containing structured data. This data can be accessed in a uniform manner, independent of data values, once the Data Schema is known.</para>
    /// labels<para>Structured data resource</para></remarks>
    ...
    /// labels<para>Digital data resource</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>An abstraction for a person, place, object, event, or concept described (or characterized) by common Attributes. For example, “Person” and “Agency” are Entities. An instance of an Entity represents one particular occurrence of the Entity, such as a specific person or a specific agency.</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>An entity (person or organization) that consumes data that is supplied by a Supplier.</para>
    /// labels<para>Consumer</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>A person responsible for managing a Data Asset.</para>
    /// labels<para>Data steward</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>A constraint on the type of data that an instance of an Attribute may hold (e.g. "string" or "integer").</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Example: A specific message set expressed as an XML schema or an EDI transaction set that contains information about a “Person” entity.</para>
    /// labels<para>Payload definition</para></remarks>
    ...
    /// labels<para>Exchange package</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>This is the data schema described using DRM built-in concepts</para>
    /// labels<para>Internal data schema</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>An endpoint that provides an interface for accessing and querying a Data Asset. A concrete representation of a Query Point may be a specific URL at which a query Web Service may be invoked.</para>
    /// labels<para>Query point</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>Describes the relationship between two Entities.</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>This is a schema not described using DRM built-in concepts, but just pointed to. For example, XML Schema file</para>
    /// labels<para>External data schema</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>A Digital Data Resource containing semi-structured data. This will generally consist in part of structured data and in part of unstructured data.</para>
    /// labels<para>Semistructured data resource</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>The concept of managing a data resource</para>
    /// labels<para>Stewardship</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>An entity (person or organization) that supplies data to a Consumer.</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>A Digital Data Resource containing unstructured data. Unstructured data is collection of data values that are likely to be processed only by specialized application programs.</para>
    /// labels<para>Unstructured data resource</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Reference model acronym.</para>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>categorized by</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The security classification for an Exchange Package.</para>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>employee iD</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>disseminated to</para></remarks>
    ...
    ///   <para>Designates whether or not the Data Asset supports or provides Geospatial data.</para>
    /// labels<para>geospatial enabled</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>This relationship is not explicitly stated in the DRM document. It has been created because there was a need to connect the schema with the entities, relationships, etc.</para>
    /// labels<para>has schema element</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>queries</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>This is a link to location of a digital resource</para>
    /// labels<para>location pointer</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>provides management context</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>represented as</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has stewardship</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>The date that the Data Steward became associated with the Data Asset.</para>
    /// labels<para>initial date</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>refers to entity</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>refers to payload</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>returns result set specified in</para></remarks>
