...
module vag =
    ...
    let ApplicabilityContext =
        Namespaced_IRI.parse _namespace_name "ApplicabilityContext" |> NamespacedName
    ...
    let DescriptionOfNonVagueness =
        Namespaced_IRI.parse _namespace_name "DescriptionOfNonVagueness" |> NamespacedName
    ...
    let DescriptionOfVagueness =
        Namespaced_IRI.parse _namespace_name "DescriptionOfVagueness" |> NamespacedName
    ...
    let DimensionInContext =
        Namespaced_IRI.parse _namespace_name "DimensionInContext" |> NamespacedName
    ...
    let VaguenessAnnotation =
        Namespaced_IRI.parse _namespace_name "VaguenessAnnotation" |> NamespacedName
    ...
    let VaguenessType =
        Namespaced_IRI.parse _namespace_name "VaguenessType" |> NamespacedName
    ...
    let ``qualitative-vagueness`` =
        Namespaced_IRI.parse _namespace_name "qualitative-vagueness" |> NamespacedName
    ...
    let ``quantitative-vagueness`` =
        Namespaced_IRI.parse _namespace_name "quantitative-vagueness" |> NamespacedName
    ...
    let hasVaguenessType =
        Namespaced_IRI.parse _namespace_name "hasVaguenessType" |> NamespacedName
    ...
    let hasLogicFormula =
        Namespaced_IRI.parse _namespace_name "hasLogicFormula" |> NamespacedName
    ...
    let hasNaturalLanguageText =
        Namespaced_IRI.parse _namespace_name "hasNaturalLanguageText" |> NamespacedName
    ...
    let withDimension =
        Namespaced_IRI.parse _namespace_name "withDimension" |> NamespacedName
    ...
    let hasApplicabilityContext =
        Namespaced_IRI.parse _namespace_name "hasApplicabilityContext" |> NamespacedName
    ...
    let hasDimensionInContext =
        Namespaced_IRI.parse _namespace_name "hasDimensionInContext" |> NamespacedName
    ...
    let isApplicabilityContextOf =
        Namespaced_IRI.parse _namespace_name "isApplicabilityContextOf" |> NamespacedName
    ...
    let isDimensionIn =
        Namespaced_IRI.parse _namespace_name "isDimensionIn" |> NamespacedName
    ...
    let isDimensionInContextOf =
        Namespaced_IRI.parse _namespace_name "isDimensionInContextOf" |> NamespacedName
    ...
    let isDimensionOf =
        Namespaced_IRI.parse _namespace_name "isDimensionOf" |> NamespacedName
    ...
    let isEntityOf = Namespaced_IRI.parse _namespace_name "isEntityOf" |> NamespacedName
    ...
    let isJustificationOf =
        Namespaced_IRI.parse _namespace_name "isJustificationOf" |> NamespacedName
    ...
    let isLogicFormulaOf =
        Namespaced_IRI.parse _namespace_name "isLogicFormulaOf" |> NamespacedName
    ...
    let isVaguenessTypeOf =
        Namespaced_IRI.parse _namespace_name "isVaguenessTypeOf" |> NamespacedName
