...
module bbcsport =
    ...
    /// labels<para>CompetesForRole</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Legacy property used to associate a team with the country flag it represented during the olympics</para>
    /// </remarks>
    ...
    ///   <para>Division relates a DivisionalCompetition to a competition which is a division of that DivisionalCompetition. Used for the olympics</para>
    /// </remarks>
