...
module nif =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>" cf. https://www.google.de/search?q=Linked-Data+Aware+URI+Schemes+for+Referencing+Text"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>"For each string you can include a snippet (e.g. 10-40 characters of text), that occurs immediately after the subject string."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"The string, which the URI is representing as an RDF Literal. Some use cases require this property, as it is necessary for certain sparql queries. "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"For each string you can include a snippet (e.g. 10-40 characters of text), that occurs immediately before the subject string."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"confidence of annotation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"dependency relation type"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///     Requirement (2): The index of the subject string MUST be calculated relative to the nif:referenceContext of the subject. If available, this is the rdf:Literal of the nif:isString property."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// 	"</para>
    /// labels<para>"language of the string"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///     "</para>
    /// labels<para>"Confidence of OLiA tag"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"Provenance of OLiA tag"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// 	"</para>
    /// labels<para>"predominant language"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"sentiment value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:TransitiveProperty</para>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"see nif:subStringTrans"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
