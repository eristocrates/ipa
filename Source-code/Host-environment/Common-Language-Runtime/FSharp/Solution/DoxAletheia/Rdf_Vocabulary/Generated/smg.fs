...
module smg =
    ...
    ///   <para>ServiceSupplier (Utility) utilising this usage point to deliver a service.</para>
    /// labels<para>ServiceSupplier</para></remarks>
    ...
    ///   <para>Usage point is equipped with an AMI capable meter that is not yet currently equipped with a communications module.</para>
    /// labels<para>amiCapable</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:AmiBillingReadyKind</para>
    ///   <para>Usage point is not currently equipped with a meter.</para>
    /// labels<para>nonMetered</para></remarks>
    ...
    ///   <para>Value of this reading.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Interval between two date and time points.</para>
    /// labels<para>DateTimeInterval</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Location described by this position point.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Physical asset that performs the metering role of the usage point. Used for measuring consumption and detection of events.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>All multipliers applied at this meter.</para>
    /// labels<para>MeterMultipliers</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>All meter readings provided by this meter.</para>
    /// labels<para>MeterReadings</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:AmiBillingReadyKind</para>
    ///   <para>Usage point is equipped with an AMI capable meter having communications capability.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Start and end of the period for those readings whose type has a time attribute such as 'billing', seasonal' or 'forTheSpecifiedPeriod'.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Primary email address.</para>
    /// labels<para>email1</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Address on local area network.</para>
    /// labels<para>lan</para></remarks>
    ...
    ///   <para>Test constant.</para>
    /// labels<para>kE</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:MeterMultiplierKind</para>
    ///   <para>Product of the CT ratio and PT ratio.</para>
    /// labels<para>transformerRatio</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>All reading values contained within this meter reading.</para>
    /// labels<para>Readings</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Date and time interval of the data items contained within this meter reading.</para>
    /// labels<para>valuesInterval</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>All meter readings (sets of values) containing this reading value.</para>
    /// labels<para>MeterReadings</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>All meter readings obtained from this usage point.</para>
    /// labels<para>MeterReadings</para></remarks>
    ...
    /// <remarks>
    ///   <para>&lt;http://langdale.com.au/2005/UML#Package&gt;</para>
    ///   <para>Top package for IEC 61970.</para>
    /// labels<para>IEC61970</para></remarks>
    ...
    /// Currently, normative parts of the model support the needs of information exchange defined in IEC 61968-3, IEC 61968-4, IEC 61968-9 and in IEC 61968-13.</para>
    /// labels<para>IEC61968</para></remarks>
    ...
    /// <remarks>
    ///   <para>&lt;http://langdale.com.au/2005/UML#Package&gt;</para>
    ///   <para>This package is an extension of the Metering package and contains the information classes that support specialised applications such as prepayment metering. These classes are generally associated with the collection and control of revenue from the customer for a delivered service.</para>
    /// labels<para>PaymentMetering</para></remarks>
    ...
    ///   <para>&lt;http://langdale.com.au/2005/UML#Package&gt;</para>
    ///
    /// labels<para>Global</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>(if applicable) Z axis position.</para>
    /// labels<para>zPosition</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Zero-relative sequence number of this point within a series of points.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Type information for this reading value.</para>
    /// labels<para>ReadingType</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Accumulation behaviour of a reading over time, usually 'measuringPeriod', to be used with individual endpoints (as opposed to 'macroPeriod' and 'aggregate' that are used to describe aggregations of data from individual endpoints).</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Commodity being measured.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Flow direction for a reading where the direction of flow of the commodity is important (for electricity measurements this includes current, energy, power, and demand).</para>
    /// labels<para>flowDirection</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Salient attribute of the reading data aggregated from individual endpoints. This is mainly used to define a mathematical operation carried out over 'macroPeriod', but may also be used to describe an attribute of the data when the 'macroPeriod' is not defined.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Metering-specific unit.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Kind of service.</para>
    /// labels<para>ServiceKind</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:ServiceKind</para>
    ///   <para>Heat service.</para>
    /// labels<para>heat</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:ServiceKind</para>
    ///   <para>Other kind of service.</para>
    ...
    /// <remarks>
    ///   <para>smg:ServiceKind</para>
    ///   <para>Rates (e.g. tax, charge, toll, duty, tariff, etc.) service.</para>
    ...
    /// <remarks>
    ///   <para>smg:ServiceKind</para>
    ///   <para>Refuse (waster) service.</para>
    /// labels<para>refuse</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:ServiceKind</para>
    ///   <para>Sewerage service.</para>
    /// labels<para>sewerage</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:ServiceKind</para>
    ///   <para>TV license service.</para>
    /// labels<para>tvLicence</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Kind of supplier.</para>
    /// labels<para>SupplierKind</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Unique transaction reference prefix number issued to an entity by the International Standards Organisation for the purpose of tagging onto electronic financial transactions, as defined in ISO/IEC 7812-1 and ISO/IEC 7812-2.</para>
    /// labels<para>issuerIdentificationNumber</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Simple end device function distinguished by 'kind'. Use this class for instances that cannot be represented by another end device function specialisations.</para>
    /// labels<para>SimpleEndDeviceFunction</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Date and time for which status 'value' applies.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Pertinent information regarding the current 'value', as free form text.</para>
    /// labels<para>remark</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Status value at 'dateTime'; prior status changes may have been kept in instances of activity records associated with the object to which this status applies.</para>
    /// labels<para>value</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Reason code or explanation for why an object went to the current status 'value'.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Town detail.</para>
    /// labels<para>townDetail</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Street detail.</para>
    /// labels<para>streetDetail</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Street details, in the context of address.</para>
    /// labels<para>StreetDetail</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Town details, in the context of address.</para>
    /// labels<para>TownDetail</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Type of street. Examples include: street, circle, boulevard, avenue, road, drive, etc.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Number of the apartment or suite.</para>
    /// labels<para>suiteNumber</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>True if this street is within the legal geographical boundaries of the specified town (default).</para>
    /// labels<para>withinTownLimits</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>(if applicable) Utilities often make use of external reference systems, such as those of the town-planner's department or surveyor general's mapping system, that allocate global reference codes to streets.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Additional address information, for example a mailstop.</para>
    /// labels<para>addressGeneral</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Designator of the specific location on the street.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Prefix to the street name. For example: North, South, East, West.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>(if applicable) In certain cases the physical location of the place of interest does not have a direct point of entry from the street, but may be located inside a larger structure such as a building, complex, office block, apartment, etc.</para>
    /// labels<para>buildingName</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Suffix to the street name. For example: North, South, East, West.</para>
    ...
    /// <remarks>
    ///   <para>smg:SupplierKind</para>
    ///   <para>Other kind of supplier.</para>
    /// labels<para>other</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:SupplierKind</para>
    ///   <para>Entity that sells the service, but does not deliver to the customer; applies to the deregulated markets.</para>
    /// labels<para>retailer</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Area or region code.</para>
    /// labels<para>areaCode</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>(if applicable) City code.</para>
    /// labels<para>cityCode</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Main (local) part of this telephone number.</para>
    /// labels<para>localNumber</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>(if applicable) Extension for this telephone number.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Kind of end device function.</para>
    /// labels<para>EndDeviceFunctionKind</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:EndDeviceFunctionKind</para>
    ///   <para>Electricity metering.</para>
    /// labels<para>electricMetering</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:EndDeviceFunctionKind</para>
    ///   <para>Gas metering.</para>
    /// labels<para>gasMetering</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:EndDeviceFunctionKind</para>
    ///   <para>Detection and monitoring of reverse flow.</para>
    /// labels<para>reverseFlow</para></remarks>
    ...
    /// For CIMXML data files in RDF syntax, the mRID is mapped to rdf:ID or rdf:about attributes that identify CIM object elements.</para>
    /// labels<para>mRID</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:EndDeviceFunctionKind</para>
    ///   <para>Support for one or more relays that may be programmable in the meter (and tied to TOU, time pulse, load control or other functions).</para>
    /// labels<para>relaysProgramming</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:EndDeviceFunctionKind</para>
    ///   <para>Water metering.</para>
    /// labels<para>waterMetering</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Service category for this agreement.</para>
    /// labels<para>ServiceCategory</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Main address of the location.</para>
    /// labels<para>mainAddress</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Current status information relevant to an entity.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>User ID needed to log in, which can be for an individual person, an organisation, a location, etc.</para>
    /// labels<para>userID</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Alternate email address.</para>
    /// labels<para>email2</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>(could be deprecated in the future) Customer agreement for this meter reading.</para>
    /// labels<para>CustomerAgreement</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Usage point from which this meter reading (set of values) has been obtained.</para>
    /// labels<para>UsagePoint</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Specific value measured by a meter or other asset, or calculated by a system. Each Reading is associated with a specific ReadingType.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Coordinate reference system.</para>
    /// labels<para>CoordinateSystem</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>X axis position.</para>
    /// labels<para>xPosition</para></remarks>
    ...
    /// Some devices may use an optical port that conforms to the ANSI C12.18 standard for communications.</para>
    /// labels<para>EndDevice</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Usage point to which this end device belongs.</para>
    /// labels<para>UsagePoint</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Function performed by an end device such as a meter, communication equipment, controllers, etc.</para>
    /// labels<para>EndDeviceFunction</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Installation code.</para>
    /// labels<para>installCode</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>If true, there is no physical device. As an example, a virtual meter can be defined to aggregate the consumption for two or more physical meters. Otherwise, this is a physical hardware device.</para>
    /// labels<para>isVirtual</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Logical or physical point in the network to which readings or events may be attributed. Used at the place where a physical or virtual meter may be located; however, it is not required that a meter be present.</para>
    /// labels<para>UsagePoint</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Y axis position.</para>
    /// labels<para>yPosition</para></remarks>
    ...
    /// <remarks>
    ///   <para>&lt;http://langdale.com.au/2005/UML#Package&gt;</para>
    ///   <para>Top package for IEC TC57 CIM.</para>
    /// labels<para>TC57CIM</para></remarks>
    ...
    /// A profile should limit this code to a set of allowed URNs agreed to by all sending and receiving parties.</para>
    /// labels<para>crsUrn</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>End device that performs this function.</para>
    /// labels<para>EndDevice</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>All end device functions this end device performs.</para>
    /// labels<para>EndDeviceFunctions</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Identifies a way in which an organisation may participate in the utility enterprise (e.g., customer, manufacturer, etc).</para>
    /// labels<para>OrganisationRole</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Organisation receiving services from service supplier.</para>
    ...
    /// <remarks>
    ///   <para>&lt;http://langdale.com.au/2005/UML#Package&gt;</para>
    ///   <para>This package contains the core information classes that support customer billing applications.</para>
    /// labels<para>Customers</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Kind of customer.</para>
    /// labels<para>CustomerKind</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The description is a free human readable text describing or naming the object. It may be non unique and may not correlate to a naming hierarchy.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Time sequence of readings of the same reading type. Contained interval readings may need conversion through the application of an offset and a scalar defined in associated pending.</para>
    /// labels<para>IntervalBlock</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Meter reading containing this interval block.</para>
    /// labels<para>MeterReading</para></remarks>
    ...
    /// Note: Interval Data is sometimes also called "Interval Data Readings" (IDR).</para>
    /// labels<para>IntervalReading</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Interval reading contained in this block.</para>
    /// labels<para>IntervalReadings</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Type information for interval reading values contained in this block.</para>
    /// labels<para>ReadingType</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>All blocks containing this interval reading.</para>
    /// labels<para>IntervalBlocks</para></remarks>
    ...
    /// labels<para>electronicAddress</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Additional phone number.</para>
    /// labels<para>phone2</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Secondary address of the location. For example, PO Box address may have different ZIP code than that in the 'mainAddress'.</para>
    /// labels<para>secondaryAddress</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>(if applicable) Reference to geographical information source, often external to the utility.</para>
    /// labels<para>geoInfoReference</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Status of this location.</para>
    /// labels<para>status</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Classification by utility's corporate standards and practices, relative to the location itself (e.g., geographical, functional accounting, etc., not a given property that happens to exist at that location).</para>
    /// labels<para>type</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>General purpose street address information.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Agreement between the customer and the service supplier to pay for service at a specific service location. It records certain billing information about the type of service provided at the service location and is used during charge creation to determine the type of service.</para>
    /// labels<para>CustomerAgreement</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Customer for this agreement.</para>
    /// labels<para>Customer</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Set of values obtained from the meter.</para>
    /// labels<para>MeterReading</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Kind of this function.</para>
    /// labels<para>kind</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Service supplier for this customer agreement.</para>
    /// labels<para>ServiceSupplier</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Category of service provided to the customer.</para>
    /// labels<para>ServiceCategory</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Organisation that provides services to customers.</para>
    /// labels<para>ServiceSupplier</para></remarks>
    ...
    /// labels<para>phone1</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Sequence of position points describing this location, expressed in coordinate system 'Location.CoordinateSystem'.</para>
    /// labels<para>PositionPoints</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:CustomerKind</para>
    ///   <para>Commercial industrial customer.</para>
    /// labels<para>commercialIndustrial</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:CustomerKind</para>
    ///   <para>Customer as energy service supplier.</para>
    /// labels<para>energyServiceSupplier</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:CustomerKind</para>
    ///   <para>Internal use customer.</para>
    /// labels<para>internalUse</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:CustomerKind</para>
    ///   <para>Residential and commercial customer.</para>
    /// labels<para>residentialAndCommercial</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:CustomerKind</para>
    ///   <para>Residential streetlight or other related customer.</para>
    /// labels<para>residentialStreetlightOthers</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Meter applying this multiplier.</para>
    /// labels<para>Meter</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Meter providing this reading.</para>
    /// labels<para>Meter</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Kind of meter multiplier.</para>
    /// labels<para>MeterMultiplierKind</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:MeterMultiplierKind</para>
    ///   <para>Current transformer ratio used to convert associated quantities to real measurements.</para>
    /// labels<para>ctRatio</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:MeterMultiplierKind</para>
    ///   <para>Meter kh (watthour) constant. The number of watthours that must be applied to the meter to cause one disk revolution for an electromechanical meter or the number of watthours represented by one increment pulse for an electronic meter.</para>
    /// labels<para>kH</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:MeterMultiplierKind</para>
    ///   <para>Register multiplier. The number to multiply the register reading by in order to get kWh.</para>
    /// labels<para>kR</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:MeterMultiplierKind</para>
    ///   <para>Potential transformer ratio used to convert associated quantities to real measurements.</para>
    /// labels<para>ptRatio</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Town section. For example, it is common for there to be 36 sections per township.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Customer agreement regulating this service delivery point.</para>
    /// labels<para>CustomerAgreement</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Tracks the lifecycle of the metering installation at a usage point with respect to readiness for billing via advanced metering infrastructure reads.</para>
    /// labels<para>amiBillingReady</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Location of an individual usage point.</para>
    /// labels<para>UsagePointLocation</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Service category delivered by this usage point.</para>
    /// labels<para>ServiceCategory</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:CustomerKind</para>
    ///   <para>Customer as energy service scheduler.</para>
    /// labels<para>energyServiceScheduler</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:CustomerKind</para>
    ///   <para>Pumping load customer.</para>
    /// labels<para>pumpingLoad</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:CustomerKind</para>
    ///   <para>Residential and streetlight customer.</para>
    /// labels<para>residentialAndStreetlight</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:CustomerKind</para>
    ///   <para>Other kind of customer.</para>
    /// labels<para>other</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:CustomerKind</para>
    ///   <para>Wind machine customer.</para>
    /// labels<para>windMachine</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>End date and time of this interval.</para>
    ...
    /// <remarks>
    ///   <para>smg:CustomerKind</para>
    ///   <para>Residential customer.</para>
    /// labels<para>residential</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:CustomerKind</para>
    ///   <para>Residential farm service customer.</para>
    /// labels<para>residentialFarmService</para></remarks>
    ...
    /// &amp;lt;&amp;lt;Compound&amp;gt;&amp;gt; A composite of Primitive, enumeration, CIMDatatype or othe Compound classes, as long as the Compound classes do not recurse.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Start date and time of this interval.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Electronic address information.</para>
    /// labels<para>ElectronicAddress</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>World wide web address.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>MAC (Media Access Control) address.</para>
    /// labels<para>mac</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Password needed to log in.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>If true, this usage point is a service delivery point, i.e., a usage point where the ownership of the service changes hands.</para>
    /// labels<para>isSdp</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Location of this usage point.</para>
    /// labels<para>UsagePointLocation</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Meter form designation per ANSI C12.10 or other applicable standard. An alphanumeric designation denoting the circuit arrangement for which the meter is applicable and its specific terminal arrangement.</para>
    /// labels<para>formNumber</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Multiplier applied at the meter.</para>
    /// labels<para>MeterMultiplier</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:SupplierKind</para>
    ///   <para>Entity that delivers the service to the customer.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Name of the state or province.</para>
    /// labels<para>stateOrProvince</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Lifecycle states of the metering installation at a usage point with respect to readiness for billing via advanced metering infrastructure reads.</para>
    /// labels<para>AmiBillingReadyKind</para></remarks>
    ...
    /// <remarks>
    ///   <para>&lt;http://langdale.com.au/2005/UML#Package&gt;</para>
    ///   <para>This package contains the core information classes that support end device applications with specialized classes for metering and premise are network devices, and remote reading functions. These classes are generally associated with the point where a service is delivered to the customer.</para>
    /// labels<para>Metering</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:AmiBillingReadyKind</para>
    ///   <para>Usage point is equipped with an AMI capable meter; however, the AMI functionality has been disabled or is not being used.</para>
    /// labels<para>amiDisabled</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:AmiBillingReadyKind</para>
    ///   <para>Usage point is equipped with an operating AMI capable meter and accuracy has been certified for billing purposes.</para>
    /// labels<para>billingApproved</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:AmiBillingReadyKind</para>
    ///   <para>Usage point is equipped with a non AMI capable meter.</para>
    /// labels<para>nonAmi</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:AmiBillingReadyKind</para>
    ///   <para>Usage point is equipped with an AMI capable meter that is functioning and communicating with the AMI network.</para>
    /// labels<para>operable</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Common representation for reading values. Note that a reading value may have multiple qualities, as produced by various systems ('ReadingQuality.source').</para>
    /// labels<para>BaseReading</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>System that originally supplied the reading (e.g., customer, AMI system, handheld reading system, another enterprise system, etc.).</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>This is a root class to provide common identification for all classes needing identification and naming attributes.</para>
    /// labels<para>IdentifiedObject</para></remarks>
    ...
    /// <remarks>
    ///   <para>&lt;http://langdale.com.au/2005/UML#Package&gt;</para>
    ///   <para>This package contains the information classes that support distribution management in general.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>All locations described with position points in this coordinate system.</para>
    /// labels<para>Location</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>The place, scene, or point of something where someone or something has been, is, and/or will be at a given moment in time. It can be defined with one or more postition points (coordinates) in a given coordinate system.</para>
    /// labels<para>Location</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Coordinate system used to describe position points of this location.</para>
    /// labels<para>CoordinateSystem</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:EndDeviceFunctionKind</para>
    ///   <para>Autonomous application of daylight savings time (DST).</para>
    /// labels<para>autonomousDst</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:EndDeviceFunctionKind</para>
    ///   <para>Demand response functions.</para>
    /// labels<para>demandResponse</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:EndDeviceFunctionKind</para>
    ///   <para>Presentation of metered values to a user or another system (always a function of a meter, but might not be supported by a load control unit).</para>
    ...
    /// <remarks>
    ///   <para>smg:EndDeviceFunctionKind</para>
    ///   <para>On-request reads.</para>
    /// labels<para>onRequestRead</para></remarks>
    ...
    /// <remarks>
    ///   <para>smg:EndDeviceFunctionKind</para>
    ///   <para>Reporting historical power interruption data.</para>
    /// labels<para>outageHistory</para></remarks>
    ...
    /// The attribute aliasName is retained because of backwards compatibility between CIM relases. It is however recommended to replace aliasName with the Name class as aliasName is planned for retirement at a future time.</para>
    /// labels<para>aliasName</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The name is any free human readable and possibly non unique text naming the object.</para>
    /// labels<para>name</para></remarks>
