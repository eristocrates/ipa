...
module nao =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Represents a desktop icon as defined in the FreeDesktop Icon Naming Standard (http://standards.freedesktop.org/icon-naming-spec/icon-naming-spec-latest.html).</para>
    /// labels<para>freedesktopicon</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>A privacy level as defined for a resource. Allowed values range from 0 (private) to 1 (public).</para>
    /// labels<para>privacy level</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An agent is the artificial counterpart to nao:Party. It can be a software component or some service.</para>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>A non-technical textual annotation for a resource</para>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>Specifies the engineering tool used to generate the graph</para>
    /// labels<para>engineering tool</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>An alternative label alongside the preferred label for a resource</para>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>Generic annotation for a resource</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>An alternative symbol representation for a resource</para>
    /// labels<para>alternative symbol</para></remarks>
    ...
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Refers to a single or a group of individuals that contributed to a resource</para>
    ...
    ///   <para>States the creation, or first modification time for a resource</para>
    ...
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>States the modification time for a resource</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Annotation for a resource in the form of a visual representation. Typically the symbol is a double-typed image file or a nao:FreeDesktopIcon.</para>
    ...
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Refers to the single or group of individuals that created the resource</para>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>A direct trust value assigned to an agent, either manually by a user or semi-/automatically by a system. Allowed values range from 0 (no trust) to 1 (very high trust).</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Signifies social endorsment of a resource by a specific agent. Endorsement includes social actions like favouriting, liking, voting for, starring a resource.</para>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>A generalised trust level assigned to an agent, based on a combination of direct and network trust values it possesses. Allowed values range from 0 (no trust) to 1 (very high trust).</para>
    /// labels<para>trust level</para></remarks>
    ...
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>An external identifier for a resource that has been retreived from an external source.</para>
    /// labels<para>external identifier</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Links a resource to the graph which contains its metadata. Its typical usage would be to link the file resource to the graph containing its extracted file metadata. This allows for easy maintenance later on. Inverse property of nao:isDataGraphFor.</para>
    /// labels<para>has data graph</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>Defines the default static namespace abbreviation for a graph</para>
    /// labels<para>has default namespace abbreviation</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Defines a relationship between a resource and one or more super resources</para>
    /// labels<para>has Superresource</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Signifies social endorsment by an agent, by way of marking the resource as a favourite.</para>
    /// labels<para>favourited by</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Links a named graph to the resource for which it contains metadata. Its typical usage would be to link the graph containing extracted file metadata to the file resource. This allows for easy maintenance later on. Inverse property of nao:hasDataGraph.</para>
    /// labels<para>is data graph for</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>Defines the default static namespace for a graph</para>
    ...
    /// labels<para>has Subresource</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>States which resources a tag is associated with</para>
    ...
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Defines a name for a FreeDesktop Icon as defined in the FreeDesktop Icon Naming Standard</para>
    /// labels<para>iconname</para></remarks>
    ...
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>Defines an annotation for a resource in the form of a relationship between the subject resource and another resource</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Defines a relationship between two resources, where the object is a topic of the subject</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Defines a relationship between two resources, where the subject is a topic of the object</para>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>The agent that maintains this resource, ie. created it and knows what to do with it.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>States the last modification time for a resource</para>
    /// labels<para>last modified at</para></remarks>
    ...
    /// labels<para>numeric rating</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>Defines a personal string identifier for a resource</para>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>Annotation for a resource in the form of an unrestricted rating</para>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>The plural form of the preferred label for a resource</para>
    /// labels<para>preferred label plural form</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A unique preferred symbol representation for a resource</para>
    ...
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>An authoritative score for an item valued between 0 and 1</para>
    ...
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>States the serialization language for a named graph that is represented within a document</para>
    /// labels<para>serialization language</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Mark a property, class, or even resource as user visible or not. Non-user-visible entities should never be presented to the user. By default everything is user-visible.</para>
    /// labels<para>user visible</para></remarks>
    ...
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Specifies the version of a graph, in numeric format</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>A marker property to mark selected properties which are input to a mathematical algorithm to generate scores for resources. Properties are marked by being defined as subproperties of this property</para>
    /// labels<para>scoreparameter</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>Specifies the status of a graph, stable, unstable or testing</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Represents a symbol, a visual representation of a resource. Typically a local or remote file would be double-typed to be used as a symbol. An alternative is nao:FreeDesktopIcon.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Represents a single or a group of individuals</para>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>A network-derived trust value assigned to an agent, based on the shared direct trust values for the same agent, as set by participating agents in a network. Allowed values range from 0 (no trust) to 1 (very high trust).</para>
    /// labels<para>network trust</para></remarks>
