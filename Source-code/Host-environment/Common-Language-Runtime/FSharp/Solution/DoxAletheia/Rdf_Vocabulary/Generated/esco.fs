...
module esco =
    ...
    /// </para>
    /// labels<para>thesaurus concept and label editorial status type</para></remarks>
    ...
    /// labels<para>Member concept</para></remarks>
    ...
    /// labels<para>thesaurus concept and label publaction status type</para></remarks>
    ...
    /// labels<para>term status type</para></remarks>
