...
module dolce =
    ...
    let ``spatial-location_q`` = _prefix "spatial-location_q"
    /// <summary>
    ///   <see href="http://www.loa-cnr.it/ontologies/DOLCE-Lite.owl#has-quality"></see>
    /// </summary>
    let ``has-quality`` = _prefix "has-quality"
    /// <summary>
    ...
    let ``temporal-location_q`` = _prefix "temporal-location_q"
    /// <summary>
    ...
    let perdurant = _prefix "perdurant"
    /// <summary>
    ...
    let ``abstract-location`` = _prefix "abstract-location"
    /// <summary>
    ...
    let ``non-physical-endurant`` = _prefix "non-physical-endurant"
    /// <summary>
    ...
    let ``abstract-region`` = _prefix "abstract-region"
    /// <summary>
    ...
    let ``abstract-quality`` = _prefix "abstract-quality"
    /// <summary>
    ...
    let ``q-location`` = _prefix "q-location"
    /// <summary>
    ...
    let ``inherent-in`` = _prefix "inherent-in"
    /// <summary>
    ...
    /// </summary>
    let ``q-location-of`` = _prefix "q-location-of"
    /// <summary>
    ...
    let ``temporal-region`` = _prefix "temporal-region"
    /// <summary>
    ...
    let accomplishment = _prefix "accomplishment"
    /// <summary>
    ...
    let ``amount-of-matter`` = _prefix "amount-of-matter"
    /// <summary>
    ...
    let ``physical-endurant`` = _prefix "physical-endurant"
    /// <summary>
    ...
    let ``arbitrary-sum`` = _prefix "arbitrary-sum"
    /// <summary>
    ...
    let ``proper-part`` = _prefix "proper-part"
    /// <summary>
    ...
    let ``boundary-of`` = _prefix "boundary-of"
    /// <summary>
    ///   <see href="http://www.loa-cnr.it/ontologies/DOLCE-Lite.owl#proper-part-of"></see>
    /// </summary>
    let ``proper-part-of`` = _prefix "proper-part-of"
    /// <summary>
    ...
    let ``constant-participant`` = _prefix "constant-participant"
    /// <summary>
    ...
    /// </summary>
    let ``constant-participant-in`` = _prefix "constant-participant-in"
    /// <summary>
    ///   <see href="http://www.loa-cnr.it/ontologies/DOLCE-Lite.owl#participant-in"></see>
    /// </summary>
    let ``participant-in`` = _prefix "participant-in"
    /// <summary>
    ...
    let ``dependent-place`` = _prefix "dependent-place"
    /// <summary>
    ...
    let ``specific-constant-constituent`` = _prefix "specific-constant-constituent"
    /// <summary>
    ...
    let ``spatio-temporal-particular`` = _prefix "spatio-temporal-particular"
    /// <summary>
    ...
    let ``generic-location`` = _prefix "generic-location"
    /// <summary>
    ///   <see href="http://www.loa-cnr.it/ontologies/DOLCE-Lite.owl#generic-location-of"></see>
    /// </summary>
    let ``generic-location-of`` = _prefix "generic-location-of"
    /// <summary>
    ...
    let ``generic-constituent`` = _prefix "generic-constituent"
    /// <summary>
    ...
    let ``generic-dependent`` = _prefix "generic-dependent"
    /// <summary>
    ///   <see href="http://www.loa-cnr.it/ontologies/DOLCE-Lite.owl#generically-dependent-on"></see>
    /// </summary>
    let ``generically-dependent-on`` = _prefix "generically-dependent-on"
    /// <summary>
    ...
    let ``mediated-relation`` = _prefix "mediated-relation"
    /// <summary>
    /// A relation that composes other relations. For example, a participation relation composed with a representation relation. Composed relation cannot be directly expressed in OWL-DL, then (at least some) compositions are expressed as class or restriction axioms.
    /// <see href="http://www.loa-cnr.it/ontologies/DOLCE-Lite.owl#mediated-relation-i"></see></summary>
    let ``mediated-relation-i`` = _prefix "mediated-relation-i"
    /// <summary>
    ...
    let ``has-quale`` = _prefix "has-quale"
    /// <summary>
    /// An atomic region.
    ...
    let ``t-inherent-in`` = _prefix "t-inherent-in"
    ...
    let ``specifically-constantly-dependent-on`` =
        _prefix "specifically-constantly-dependent-on"

    /// <summary>
    ///   <see href="http://www.loa-cnr.it/ontologies/DOLCE-Lite.owl#host-of"></see>
    /// </summary>
    let ``host-of`` = _prefix "host-of"
    /// <summary>
    ...
    let ``specific-constant-dependent`` = _prefix "specific-constant-dependent"
    /// <summary>
    ...
    let ``identity-c`` = _prefix "identity-c"
    /// <summary>
    ...
    let ``identity-n`` = _prefix "identity-n"
    /// <summary>
    ...
    let ``mereologically-coincides`` = _prefix "mereologically-coincides"
    /// <summary>
    ...
    let ``temporary-part`` = _prefix "temporary-part"
    /// <summary>
    ...
    let ``non-physical-object`` = _prefix "non-physical-object"
    /// <summary>
    ...
    let ``physical-quality`` = _prefix "physical-quality"
    /// <summary>
    ...
    let ``physical-location`` = _prefix "physical-location"
    /// <summary>
    ...
    let ``physical-region`` = _prefix "physical-region"
    /// <summary>
    ///   <see href="http://www.loa-cnr.it/ontologies/DOLCE-Lite.owl#physical-location-of"></see>
    /// </summary>
    let ``physical-location-of`` = _prefix "physical-location-of"
    /// <summary>
    ...
    let ``physical-object`` = _prefix "physical-object"
    /// <summary>
    ...
    let ``q-present-at`` = _prefix "q-present-at"
    /// <summary>
    ...
    /// </summary>
    let ``time-of-q-presence-of`` = _prefix "time-of-q-presence-of"
    /// <summary>
    ...
    let ``quality-space`` = _prefix "quality-space"
    /// <summary>
    ...
    let ``r-location`` = _prefix "r-location"
    /// <summary>
    ///   <see href="http://www.loa-cnr.it/ontologies/DOLCE-Lite.owl#r-location-of"></see>
    /// </summary>
    let ``r-location-of`` = _prefix "r-location-of"
    /// <summary>
    ...
    let ``relevant-part`` = _prefix "relevant-part"
    /// <summary>
    /// A mathematical set.
    ...
    let ``sibling-part`` = _prefix "sibling-part"
    /// <summary>
    ...
    let ``space-region`` = _prefix "space-region"
    /// <summary>
    ///   <see href="http://www.loa-cnr.it/ontologies/DOLCE-Lite.owl#spatio-temporal-presence-of"></see>
    /// </summary>
    let ``spatio-temporal-presence-of`` = _prefix "spatio-temporal-presence-of"
    /// <summary>
    ...
    let ``spatio-temporal-region`` = _prefix "spatio-temporal-region"
    /// <summary>
    ///   <see href="http://www.loa-cnr.it/ontologies/DOLCE-Lite.owl#spatio-temporally-present-at"></see>
    /// </summary>
    let ``spatio-temporally-present-at`` = _prefix "spatio-temporally-present-at"
    ...
    let ``specific-constant-constituent-of`` =
        _prefix "specific-constant-constituent-of"
    ...
    let ``strong-connection`` = _prefix "strong-connection"
    /// <summary>
    ...
    let ``temporary-atomic-part`` = _prefix "temporary-atomic-part"
    /// <summary>
    ...
    let ``temporary-participant`` = _prefix "temporary-participant"
    /// <summary>
    ...
    let ``temporary-participant-in`` = _prefix "temporary-participant-in"
    /// <summary>
    ...
    let ``total-constant-participant`` = _prefix "total-constant-participant"
    /// <summary>
    ///   <see href="http://www.loa-cnr.it/ontologies/DOLCE-Lite.owl#total-constant-participant-in"></see>
    /// </summary>
    let ``total-constant-participant-in`` = _prefix "total-constant-participant-in"
    /// <summary>
    ...
    let ``total-temporary-participant`` = _prefix "total-temporary-participant"
    /// <summary>
    ///   <see href="http://www.loa-cnr.it/ontologies/DOLCE-Lite.owl#total-temporary-participant-in"></see>
    /// </summary>
    let ``total-temporary-participant-in`` = _prefix "total-temporary-participant-in"
    /// <summary>
    ...
    let ``weak-connection`` = _prefix "weak-connection"
