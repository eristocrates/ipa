...
module chord =
    ...
    ///   <para>"Two or more notes played together."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Chord"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"A chord being played."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"ChordEvent"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"An interval above the root of a chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"A modifier applied to a note to change its pitch."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Modifier"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"One of the seven natural notes of the Western music system."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Natural"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"FIXME"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"An interval in the root scale, made up of the degree of the scale and optional modifier."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"ScaleInterval"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"A semitone interval."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"SemitoneInterval"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"An augmented chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"aug"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// 			For example, a C7 chord might have chord:Cmaj as its base chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"base_chord"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"The bass note of the chord (indicates the inversion)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"The chord associated with a chord event."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"chord"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://purl.org/ontology/chord/chord">http://purl.org/ontology/chord/chord</seealso>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"The degree of an interval based on the root of a chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A diminished chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"dim"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A diminished seventh chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"dim7"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:Modifier</para>
    ///
    /// labels<para>"double flat"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:Modifier</para>
    ///
    /// labels<para>"double sharp"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:Modifier</para>
    ///
    /// labels<para>"flat"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A half-diminished seventh chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"hdim7"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"An interval from the root which is part of the chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"interval"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://purl.org/ontology/chord/interval">http://purl.org/ontology/chord/interval</seealso>
    let interval = Prefixed_Name(chord, "interval") |> PrefixedName
    /// <summary>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A major chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"maj"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A major sixth chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"maj6"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A major seventh chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"maj7"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A major ninth chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"maj9"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A minor chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A minor sixth chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"min6"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A minor seventh chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"min7"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A minor ninth chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"min9"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A minor (major 7th) chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"minmaj7"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:Class</para>
    ///   <para>"A modification to a note's pitch."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"modifier"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://purl.org/ontology/chord/modifier">http://purl.org/ontology/chord/modifier</seealso>
    let modifier = Prefixed_Name(chord, "modifier") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"The natural from which this note is derived."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"natural"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://purl.org/ontology/chord/natural">http://purl.org/ontology/chord/natural</seealso>
    let natural = Prefixed_Name(chord, "natural") |> PrefixedName
    /// <summary>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A ninth chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"9"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>chord:Chord</para>
    ///   <para>"Indicates that no chord is played."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"noChord"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:Natural</para>
    ///
    /// labels<para>"A"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:Note</para>
    ///
    /// labels<para>"Ab"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:Note</para>
    ///
    /// labels<para>"Bb"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:Note</para>
    ///
    /// labels<para>"Cb"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:Natural</para>
    ///
    /// labels<para>"D"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:Note</para>
    ///
    /// labels<para>"Db"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:Natural</para>
    ///
    /// labels<para>"E"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:Note</para>
    ///
    /// labels<para>"Eb"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:Note</para>
    ///
    /// labels<para>"Fb"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:Note</para>
    ///
    /// labels<para>"Gb"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"The root note of the chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"An interval measured in semitones."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"semitone_interval"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A seventh chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"7"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:Modifier</para>
    ///
    /// labels<para>"sharp"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>chord:Chord</para>
    ///   <para>"A suspended fourth chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"sus2"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>chord:ScaleInterval</para>
    ///   <para>"A suspended fourth chord."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"sus4"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"A degree of the scale expected in the chord but not actually present here."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"without_interval"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
