...
module sao =
    ...
    ///
    /// labels<para>CitationContext</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>hasCitationKey</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>pointsTo</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>hasCitationContext</para></remarks>
