...
module doco =
    ...
    let ListOfAuthors =
        Namespaced_IRI.parse _namespace_name "ListOfAuthors" |> NamespacedName
    ...
    let ListOfContributors =
        Namespaced_IRI.parse _namespace_name "ListOfContributors" |> NamespacedName
    ...
    let ListOfOrganizations =
        Namespaced_IRI.parse _namespace_name "ListOfOrganizations" |> NamespacedName
    ...
    let SimpleRunInQuotation =
        Namespaced_IRI.parse _namespace_name "SimpleRunInQuotation" |> NamespacedName
    ...
    let BodyMatter = Namespaced_IRI.parse _namespace_name "BodyMatter" |> NamespacedName
    ...
    let CaptionedBox =
        Namespaced_IRI.parse _namespace_name "CaptionedBox" |> NamespacedName
    ...
    let ComplexRunInQuotation =
        Namespaced_IRI.parse _namespace_name "ComplexRunInQuotation" |> NamespacedName
    ...
    let Footnote = Namespaced_IRI.parse _namespace_name "Footnote" |> NamespacedName
    /// <summary>
    ...
    let FormulaBox = Namespaced_IRI.parse _namespace_name "FormulaBox" |> NamespacedName
    ...
    let Afterword = Namespaced_IRI.parse _namespace_name "Afterword" |> NamespacedName
    /// <summary>
    ...
    let Colophon = Namespaced_IRI.parse _namespace_name "Colophon" |> NamespacedName
    /// <summary>
    ...
    let Foreword = Namespaced_IRI.parse _namespace_name "Foreword" |> NamespacedName
    /// <summary>
    ...
    let ListOfFigures =
        Namespaced_IRI.parse _namespace_name "ListOfFigures" |> NamespacedName
    ...
    let ListOfTables =
        Namespaced_IRI.parse _namespace_name "ListOfTables" |> NamespacedName
    ...
    let Preface = Namespaced_IRI.parse _namespace_name "Preface" |> NamespacedName
    ...
    let BibliographicReferenceList =
        Namespaced_IRI.parse _namespace_name "BibliographicReferenceList" |> NamespacedName
    ...
    let ListOfReferences =
        Namespaced_IRI.parse _namespace_name "ListOfReferences" |> NamespacedName
    ...
    let BlockQuotation =
        Namespaced_IRI.parse _namespace_name "BlockQuotation" |> NamespacedName
    ...
    let ChapterLabel =
        Namespaced_IRI.parse _namespace_name "ChapterLabel" |> NamespacedName
    ...
    let SectionLabel =
        Namespaced_IRI.parse _namespace_name "SectionLabel" |> NamespacedName

    /// <summary>
    /// The subtitle of a chapter.
    /// <see href="http://purl.org/spar/doco/ChapterSubtitle"></see></summary>
    let ChapterSubtitle =
        Namespaced_IRI.parse _namespace_name "ChapterSubtitle" |> NamespacedName

    /// <summary>
    /// The subtitle of a section.
    /// <see href="http://purl.org/spar/doco/SectionSubtitle"></see></summary>
    let SectionSubtitle =
        Namespaced_IRI.parse _namespace_name "SectionSubtitle" |> NamespacedName

    /// <summary>
    /// The title of a chapter.
    /// <see href="http://purl.org/spar/doco/ChapterTitle"></see></summary>
    let ChapterTitle =
        Namespaced_IRI.parse _namespace_name "ChapterTitle" |> NamespacedName

    /// <summary>
    /// The title of a section.
    /// <see href="http://purl.org/spar/doco/SectionTitle"></see></summary>
    let SectionTitle =
        Namespaced_IRI.parse _namespace_name "SectionTitle" |> NamespacedName
    ...
    let FigureBox = Namespaced_IRI.parse _namespace_name "FigureBox" |> NamespacedName
    /// <summary>
    /// A space within a document that contains a table and its caption.
    /// <see href="http://purl.org/spar/doco/TableBox"></see></summary>
    let TableBox = Namespaced_IRI.parse _namespace_name "TableBox" |> NamespacedName
    ...
    let FigureLabel =
        Namespaced_IRI.parse _namespace_name "FigureLabel" |> NamespacedName
    ...
    let ListOfAgents =
        Namespaced_IRI.parse _namespace_name "ListOfAgents" |> NamespacedName
    ...
    let TableLabel = Namespaced_IRI.parse _namespace_name "TableLabel" |> NamespacedName
    /// <summary>
