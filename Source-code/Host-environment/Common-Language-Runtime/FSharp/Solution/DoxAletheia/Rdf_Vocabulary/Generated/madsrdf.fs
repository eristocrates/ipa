...
module madsrdf =
    ...
    ///       label is a non-jurisdictional geographic entity."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       label."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Describes a resource whose
    ///       label is an inhabited place incorporated as a city, town, etc."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       street."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Describes a resource whose
    ///       label represents a conference name."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       America, South America, Australia, and Antarctica."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       entities."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Describes a resource whose
    ///       label is a country, i.e. a political entity considered a country. "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       England."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       Element"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"A former
    ///       Authority."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Deprecated
    ///       Authority"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       describe the various parts of labels."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       system, and a planet, including a geographic feature of an individual planet."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Describes a resource whose
    ///       label represents a family name."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Fullname Element"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       to record identifiers for a resource in the absence of URIs."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Other Identifier"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       separate country. "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Language Element"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       madsrdf:Authority descriptions or other madsrdf:MADSCollection resources."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"MADS Collection"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"MADS Type"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Non-sort Element"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Describes a resource whose
    ///       label represents an occcupation."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Describes a resource whose
    ///       label represents a personal name."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Describes a resource whose
    ///       label is a first order political division, e.g. Ontario, within a country, e.g. Canada. "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       madsrdf:Authority or madsrdf:DeprecatedAuthority."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Real World
    ///       Object"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       first level jurisdiction. "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       citation."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       U.S."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Subtitle Element"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Describes a resource whose
    ///       label represents a time-based notion."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Temporal Element"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Describes a resource whose
    ///       label represents a title."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"Describes a resource whose
    ///       label represents a topic."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       ceased to be affiliated with an organization."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Affiliation
    ///       Ended"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"The date an individual
    ///       established an affiliation with an organization."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Affiliation
    ///       Started"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       expressed. "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Associated
    ///       Language"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       expressions."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Associated Locale"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       9.3.2.1)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Birth Date"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       state, and/or country in which a person was born."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       historical notation once used to uniquely identify a concept."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       associated madsrdf:ComplexType resource."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Component List"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       address."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Ending date of the date range for which the beginning date is recorded in madsrdf:creationDateStart."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"For a work, earliest date (normally the year) associated with a work; that date may be the date the work was created or first published or released. For an expression, the earliest date (normally the year) associated with an expression; that date may be the date of the earliest known manifestation of that expression. In both cases the date may be the starting date of a range or a single date."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Work begun"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       9.3.3.1)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Death Date"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"The town, city, province,
    ///       state, and/or country in which a person died."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Place of Death"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       deletion of a resource."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Deletion Note"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       authoritative (controlled and curated) but which is no longer."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Deprecated Label"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"A note pertaining to the
    ///       management of the label associated with the resource."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Editorial Note"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Element Value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       not already defined.Or "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Entity
    ///       Descriptor"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///     "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Established"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       resource might be used."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Example Note"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       needed."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Extended Address"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       associated with an individual."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Field of
    ///       Activity"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       distinguish a person from another person with the same preferred name."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Fuller Name"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       person identifies. "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       Variant"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       has been affiliated."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Has Affiliation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       organization with which an individual is associated."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Has Affiliation
    ///       Address"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///     "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Other characteristic"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       defined."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Has Parent
    ///       Organization"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       Of"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       Form"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       a madsrdf:Identifier."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       Member"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"Creates a direct
    ///       relationship between an Authority and one that is more narrowly defined."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       relationship must be shared."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       that is at the top of the hierarchy of authorities within the MADS Scheme."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Has Top Member of MADS
    ///       Scheme"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       represents a translation of that of the authoritative label."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       discovery purposes but not shown."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Hidden Label"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"A note pertaining to the
    ///       history of the resource."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"History Note"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       religious vocation."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Honorary Title"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Hours"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       is a LC Control Number."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       conforming to the Identifier Scheme syntax."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Identifier Value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       label."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Identifies RWO"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       Object with its Authority description."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       which the Authority is at the top of the hierarchy."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       might be appropriate."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Nature of
    ///       Affiliation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       in which the person works or has worked."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       with which an individual is associated."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Organization or
    ///       Group"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       Code"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       is a member of the family."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:AnnotationProperty</para>
    ///
    /// labels<para>"Scope Note"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       original resource."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"See Also"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       an address."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///       second line, use madsrdf:extendedAddress."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///     "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Terminated"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       Traditional "USE FOR" reference."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Use For"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       Instead." Traditional "USE" reference."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Use Instead"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///       of an authoritative label."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Variant Label"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"The country or other territorial jurisdiction from which a work originated."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Work locale"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
