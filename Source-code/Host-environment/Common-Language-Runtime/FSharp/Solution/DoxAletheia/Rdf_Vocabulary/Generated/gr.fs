...
module gr =
    ...
    /// labels<para>Offering</para></remarks>
    ...
    /// </para>
    /// labels<para>Business entity</para></remarks>
    ...
    /// labels<para>Price specification</para></remarks>
    ...
    /// labels<para>value added tax included (0..1)</para></remarks>
    ...
    /// labels<para>has price specification (0..*)</para></remarks>
    ...
    /// labels<para>has currency (1..1)</para></remarks>
    ...
    ///
    /// Using gr:hasCurrencyValue sets the upper and lower bounds to the same given value, i.e., x gr:hasCurrencyValue y implies x gr:hasMinCurrencyValue y, x gr:hasMaxCurrencyValue y.</para>
    /// labels<para>has currency value (0..1)</para></remarks>
