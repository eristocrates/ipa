...
module fabio =
    ...
    /// labels<para>intranet</para></remarks>
    ...
    /// labels<para>compact disk</para><para>CD</para></remarks>
    ...
    /// labels<para>random access memory</para><para>RAM</para></remarks>
    ...
    /// labels<para>World Wide Web</para><para>Web</para><para>WWW</para></remarks>
    ...
    /// labels<para>cloud</para></remarks>
    ...
    /// labels<para>digital versatile disc</para><para>digital video disc</para><para>DVD</para></remarks>
    ...
    /// labels<para>call for applications</para></remarks>
    ...
    /// labels<para>clinical guideline</para></remarks>
    ...
    /// labels<para>erratum</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A metadata standard specifying items to be included when creating metadata describing a dataset of a particular type, or when creating a structured summary of the main findings of an article or report in a particular domain of interest, thereby ensuring adequate descriptive information is recorded for subsequent resource discovery and/or interpretation of the information described.  [See also fabio:ReportingStandard.]</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A precise sequential set of pre-defined logical rules or computational operations to be employed for solving a particular problem in a finite number of steps.</para>
