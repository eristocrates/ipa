...
module gso =
    ...
    ///     many different Content-Types."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Content-Type-generic resource"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// 		same Internet media type, or 'Content-Type'."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Content-Type-specific resource"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// 	    change under any circumstances."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"fixed resource"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// 	    the WWW."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///         maight be expressed."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"language-generic resource"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>"A resource of which all representations are in the
    /// 		same natural language."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"language-specific resource"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///     and therfore representations of the resource at different times may vary."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Time-generic resource"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///                 expected to be the same."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// labels<para>"Content-Type generic"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://www.w3.org/2006/gen/ont#contentTypeGeneric">http://www.w3.org/2006/gen/ont#contentTypeGeneric</seealso>
    let contentTypeGeneric = Prefixed_Name(gso, "contentTypeGeneric") |> PrefixedName
    /// <summary>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Content-Type specific"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///     which is an everything-specific version of it."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Content-Type specific"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://www.w3.org/2006/gen/ont#fixedResource">http://www.w3.org/2006/gen/ont#fixedResource</seealso>
    let fixedResource = Prefixed_Name(gso, "fixedResource") |> PrefixedName
    /// <summary>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"language generic"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"language specific"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///             specific or generic along various axes."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"same work as"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///             the representation."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"time generic"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
