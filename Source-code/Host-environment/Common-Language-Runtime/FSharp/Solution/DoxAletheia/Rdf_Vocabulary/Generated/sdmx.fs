...
module sdmx =
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"Denotes an SDMX concept, used in the particular SDMX terminological sense, which is in principle narrower than skos:Concept"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
