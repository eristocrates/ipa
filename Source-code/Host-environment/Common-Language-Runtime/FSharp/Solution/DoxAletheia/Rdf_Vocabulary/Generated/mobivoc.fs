...
module mobivoc =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Plug Type"</para><para>"Tipo di Presa"</para></remarks>
    /// <seealso href="http://schema.mobivoc.org/#PlugType">http://schema.mobivoc.org/#PlugType</seealso>
    let ``_#PlugType`` = Prefixed_Name(mobivoc, "#PlugType") |> PrefixedName
    /// <summary>
    ///   <para>mobivoc:AS_3112_Type_I</para>
    /// </summary>
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"AS/NZS 3112 are the harmonised Australian and New Zealand standards for AC Plugs and Socket-Outlets."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"Zugangsbedingung"</para><para>"Access condition"</para></remarks>
    ...
    /// labels<para>"Action"</para><para>"Aktion"</para></remarks>
    ...
    /// labels<para>"Angle parking"</para><para>"Schrägaufstellung"</para></remarks>
    ...
    /// labels<para>"Aufstellart"</para><para>"Arrangement pattern"</para></remarks>
    ...
    /// labels<para>"Automatisches Parkhaus"</para><para>"Automated parking garage"</para></remarks>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"13 A plugs socket-outlets adaptors and connection units is a British Standard which specifies the most common type of single-phase AC power plugs and sockets that are used in the United Kingdom."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"Fahrrad"</para><para>"Vélo"</para><para>"Bicycle"</para></remarks>
    ...
    ///   <para>"Parking facilities for bicycles with connection to public transport."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Bike and Ride"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"CEE 7-Pin 32A / 400V Socket."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"The CEE 7/16 standard sheet appears in Supplement 2 (June 1962) to the 1951 edition of CEE 7. The CEE 7/16 unearthed plug is used for low power Class II applications, it has two round 4 by 19 mm (0.157 by 0.748 in) pins, rated at 2.5 A. There are two variants."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"CHAdeMO is the trade name of a quick charging method for battery electric vehicles delivering up to 62.5 kW of direct current (500 V, 125 A[1]) via a special electrical connector."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"Capacity"</para><para>"Kapazität"</para></remarks>
    ...
    /// labels<para>"Voiture"</para><para>"Car"</para><para>"Auto"</para></remarks>
    ...
    /// <remarks>
    ///   <para>mobivoc:ParkingFacilityConnection</para>
    ///   <para>"Parking facility used for carpooling or ridesharing."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Parken und Mitfahren"</para><para>"Carpooling"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"Car club users"</para><para>"Carsharing users"</para><para>"Carsharing-Nutzer"</para><para>"Utilisateurs de l'autopartage"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"Component of a charging point used to charge electric vehicles. A charging point can have one or more chargers."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"Civic structure that supplies electric energy for the recharging of electric vehicles."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Ladestation"</para><para>"Charging point"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"Status information of a civic structure."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:CivicStructureStatus</para>
    ///   <para>"The parking facility is closed."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:CivicStructureStatus</para>
    ///   <para>"The parking facility has parking spaces available."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"Families"</para><para>"Familien"</para></remarks>
    ...
    /// <remarks>
    ///   <para>mobivoc:CivicStructureStatus</para>
    ///   <para>"The parking facility is not operating normally."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:CivicStructureStatus</para>
    ///   <para>"The parking facility is completely occupied."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"IEC 60309 (formerly IEC 309 and CEE 17, also published by CENELEC as EN 60309) is an international standard from the International Electrotechnical Commission (IEC) for "plugs, socket-outlets and couplers for industrial purposes". The blue P+N+E, 6h (180°) plug is a single phase connector. In particular this smallest (16 A) variant has become especially common in camping vehicles and sockets found in caravan parks and marinas throughout Europe."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"IEC 60309 (formerly IEC 309 and CEE 17, also published by CENELEC as EN 60309) is an international standard from the International Electrotechnical Commission (IEC) for "plugs, socket-outlets and couplers for industrial purposes". 3-Pin connector."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"IEC 60309 (formerly IEC 309 and CEE 17, also published by CENELEC as EN 60309) is an international standard from the International Electrotechnical Commission (IEC) for "plugs, socket-outlets and couplers for industrial purposes". 5-Pin connector."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"The type 3A is derived from the Scame charging connectors adding the IEC 62196 pins which is suited for single-phase charging – the connector builds on the experience with the Scame connector for charging of light vehicles (electric motorcycles and scooters)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"Anwohner"</para><para>"Inhabitants"</para></remarks>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"The IEC 62196 Type 2 connector (commonly referred to as Mennekes) is used for charging electric cars within Europe. The connector is circular in shape, with a flattened top edge and originally specified for charging battery electric vehicles at 3–120 kilowatts."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"NEMA connectors are power plugs and receptacles used for AC mains electricity in North America and other countries that use the standards set by the US National Electrical Manufacturers Association. The NEMA 14 devices are four-wire grounding devices (hot-hot-neutral-ground) available in ratings from 15 to 60 A. The voltage rating is 250 V. Rated for 60A."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"NEMA connectors are power plugs and receptacles used for AC mains electricity in North America and other countries that use the standards set by the US National Electrical Manufacturers Association. All NEMA 5 devices are three-wire grounding devices (hot-neutral-ground) rated for 125 V maximum."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// All NEMA 6 devices are three-wire grounding devices (hot-hot-ground) used for 208 and 240 V circuits and rated for 250 V maximum. The 6-15 resembles the 5-15, but with collinear horizontal pins"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"NEMA connectors are power plugs and receptacles used for AC mains electricity in North America and other countries that use the standards set by the US National Electrical Manufacturers Association.
    /// All NEMA 6 devices are three-wire grounding devices (hot-hot-ground) used for 208 and 240 V circuits and rated for 250 V maximum. The 20 A plug has a blade rotated 90°."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:CivicStructureStatus</para>
    ///   <para>"No park and ride information will be available until the specified time."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:CivicStructureStatus</para>
    ///   <para>"No parking allowed until the specified time."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Parken verboten"</para><para>"No parking allowed"</para></remarks>
    ...
    /// <remarks>
    ///   <para>mobivoc:CivicStructureStatus</para>
    ///   <para>"Parking information is not available until a specified time."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:CivicStructureStatus</para>
    ///   <para>"The parking restrictions that normally apply in the specified location have been temporarily lifted."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Normal parking restrictions lifted"</para><para>"Normale Parkbeschränkungen aufgehoben"</para></remarks>
    ...
    /// <remarks>
    ///   <para>mobivoc:CivicStructureStatus</para>
    ///   <para>"The parking facility has 95% or greater occupancy."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Nur noch wenige Stellplätze frei"</para><para>"Only a few parking spaces available"</para></remarks>
    ...
    /// <remarks>
    ///   <para>mobivoc:CivicStructureStatus</para>
    ///   <para>"The facility is operational."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:ParkingFacilityConnection</para>
    ///   <para>"Connection to airport."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Parken und Fliegen"</para><para>"Park &amp; Fly"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>mobivoc:ParkingFacilityConnection</para>
    ///   <para>"Connection to railway station."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Park and Rail"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>mobivoc:ParkingFacilityConnection</para>
    ///   <para>"Connection to public transport."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Park &amp; Ride"</para><para>"Parken und Reisen"</para></remarks>
    ...
    /// <remarks>
    ///   <para>mobivoc:CivicStructureStatus</para>
    ///   <para>"Park and ride services are not operating until the specified time."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:CivicStructureStatus</para>
    ///   <para>"Park and ride services are operating until the specified time."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"Parkschranke"</para><para>"Parking barrier"</para></remarks>
    ...
    /// labels<para>"Parkeinrichtung"</para><para>"Parking facility"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"Transport connections available at the parking facility (e.g. Park &amp; Ride)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"Features of the parking facility (e.g. parking for disabled people)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"A single level or multilevel parking building to park at."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"Parking area on a single groundfloor level that is usually located outdoor."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Parkplatz"</para><para>"Parking lot"</para></remarks>
    ...
    /// labels<para>"Stellplatz"</para><para>"Parking space"</para></remarks>
    ...
    /// labels<para>"Pay station"</para><para>"Kassenautomat"</para></remarks>
    ...
    /// labels<para>"Senkrechtaufstellung"</para><para>"Perpendicular parking"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"Component of a charger to connect an electric vehicle. There are different plug types used for charging electric vehicles."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Plug"</para><para>"Anschluss"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"Type of a plug that is used to connect electric vehicles."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Plug type"</para><para>"Steckertyp"</para></remarks>
    /// <seealso href="http://schema.mobivoc.org/PlugType">http://schema.mobivoc.org/PlugType</seealso>
    ...
    /// labels<para>"Restrict"</para><para>"Beschränken"</para></remarks>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"The Combined Charging System is a quick charging method for battery electric vehicles delivering high-voltage direct current via a special electrical connector derived from the SAE J1772 (IEC Type 1)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"SAE J1772 (IEC Type 1) is a North American standard for electrical connectors for electric vehicles maintained by the SAE International and has the formal title "SAE Surface Vehicle Recommended Practice J1772, SAE Electric Vehicle Conductive Charge Coupler"."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///     The SAE J1772-2009 connector specification has been added to the international IEC 62196-2 standard."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"The Swiss standard, also used in Liechtenstein, is SN SEV 1011:2009 Plugs and socket-outlets for household and similar purposes. The standard defines a hierarchical system of plugs and sockets with two, three and five pins, and 10 A or 16 A ratings. Sockets will accept plugs with the same or fewer pins and the same or lower ratings."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:CivicStructureStatus</para>
    ///   <para>"Parking restrictions, other than those that normally apply, are in force in a specified area."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>mobivoc:CivicStructureStatus</para>
    ///   <para>"The status of the parking facility is unknown."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Status unknown"</para><para>"Status unbekannt"</para></remarks>
    ...
    /// labels<para>"Bewacht durch Personal"</para><para>"surveillance by security guards"</para></remarks>
    ...
    /// labels<para>"Taxifahrer"</para><para>"Taxi drivers"</para></remarks>
    ...
    /// <remarks>
    ///   <para>mobivoc:PlugType</para>
    ///   <para>"The Tesla Supercharger network is a system of 480-volt DC fast-charging stations built by American vehicle manufacturer Tesla Inc. to allow longer journeys for their all-electric manufactured vehicles (Model S, 3 and X), through quick charging of the vehicle's battery packs."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"Zeitspezifikation"</para><para>"Time specification"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"Parking facility with one or more levels below the surface and none above ground."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"User group"</para><para>"Nutzergruppe"</para></remarks>
    ...
    /// labels<para>"Videoüberwachung"</para><para>"Video surveillance"</para></remarks>
    ...
    /// labels<para>"Women"</para><para>"Frauen"</para></remarks>
    ...
    /// labels<para>"additional information"</para><para>"zusätzliche Information"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Indicates in which pattern a parking space is arranged."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Indicates the brand of a charger."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"brand"</para><para>"Marke"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Indicates whether the plug has a cable."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"cable available"</para><para>"Kabel verfügbar"</para></remarks>
    ...
    /// labels<para>"has capacity"</para><para>"hat Kapazität"</para></remarks>
    /// <seealso href="http://schema.mobivoc.org/capacity">http://schema.mobivoc.org/capacity</seealso>
    let capacity = Prefixed_Name(mobivoc, "capacity") |> PrefixedName
    /// <summary>
    ///   <para>mobivoc:charger</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Describes the charger available at a charging point. A charging point can have more than one charger."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Indicates the amount of chargers available at the charging point."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Indicates whether charging points are available."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"hat Ladestation"</para><para>"has charging point"</para></remarks>
    /// <seealso href="http://schema.mobivoc.org/chargingPoint">http://schema.mobivoc.org/chargingPoint</seealso>
    let chargingPoint = Prefixed_Name(mobivoc, "chargingPoint") |> PrefixedName
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Indicates the current status of the civil structure."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Indicates the transport connections available."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"connected to"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>owl:Class</para>
    ///   <para>"Indicates the current of a charger or plug in ampere."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Indicates the current type (AC/DC) of the plug."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"due for time"</para><para>"fällig für Zeitdauer"</para></remarks>
    ...
    /// labels<para>"employee of"</para><para>"Mitarbeiter von"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Indicates the energy source used for the charging point i.e. renewable etc."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Describes the exit of a parking facility."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"exit"</para><para>"hat Ausfahrt"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"The rate at which vehicles are exiting the parking facility."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Indicates which feature the parking facility provides."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"The rate at which vehicles are entering the parking facility."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Indicates that the usage of the civic structure is for free."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"kostenlos"</para><para>"free of charge"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"ID of the entity."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Indicates that the charger is able to fast charge."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"erlaubt Schnellladen"</para><para>"is fast charge capable"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Indicates the charger model of the charging point."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Name of the civic structure or facility."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"Anzahl Ebenen"</para><para>"number of levels"</para></remarks>
    ...
    ///   <para>"The OpenChargeMap ID used for the Connection / Plug."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Indicates that a time period overnight is possible."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"overnight"</para><para>"über Nacht"</para></remarks>
    ...
    /// labels<para>"Bild"</para><para>"picture"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Indicates the plugs available at a charger."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Indicates the type of a plug."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Indicates the power of a charger or plug in kilowatts."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"The current queuing time (duration) for entering the parking facility."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Indicates the percentage value of parking spaces occupied in a parking facility."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Belegungsrate"</para><para>"rate of occupancy"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:Class</para>
    ///   <para>"Indicates whether three-phased current is available."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Indicates the end value of a time period."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Endzeit"</para><para>"time end value"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Indicates the start value of a time period."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Anfangszeit"</para><para>"time start value"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Indicates the time unit a value is specified for."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Indicates the total number of parking spaces of a parking facility."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Indicates that a charge has to be paid for the usage of the civic structure."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Indicates the height limit in meter for vehicles using the parking facility."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"vechicle height limit"</para><para>"Höhenbegrenzung für Fahrzeuge"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Indicates the length limit in meter for vehicles using the parking facility."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"vehicle length limit"</para><para>"Längenbegrenzung für Fahrzeuge"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Indicates the width limit in meter for vehicles using the parking facility."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"vehicle width limit"</para><para>"Breitenbegrenzung für Fahrzeuge"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Indicates the voltage of a charger or plug in volt."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
