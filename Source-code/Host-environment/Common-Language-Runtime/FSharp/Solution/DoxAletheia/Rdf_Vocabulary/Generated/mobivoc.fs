...
module mobivoc =
    ...
    /// labels<para>price</para><para>Preis</para></remarks>
    ...
    /// labels<para>Defekt</para><para>Faulty</para></remarks>
    ...
    /// labels<para>Echtzeit Kapazität</para><para>Real time capacity</para></remarks>
