...
module obsm =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A form of Pitfall Trap that uses a barrier wall that directs arthropods into one of two pitfall traps at either end.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Usually a suction-based trap that collects arthropods attracted to light and CO2 (carbon dioxide)</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Suction based traps, usually for flying insects. Often combined with an attractant.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Method of arthropod collection for soil and litter samples</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Manual collection of insects and other arthropods that bite humans using an aspirator. Usually used to collect mosquitoes or other blood feeding insects.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A cup-like trap, place in the ground that captures terrestrial wandering arthropods which fall in.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A large, often back-mounted vacuum device to collect arthropods from vegetation.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Usually a suction-based trap that collects arthropods attracted to light and CO2.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Collection method based using a sticky substance that traps insects and other arthropods, usually in the form of a card with a sticky glue-like substance on one side. Often colored yellow or blue.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A handheld device operated by suction from the lungs of the collector or a vacuum fan, used to collect arthropods.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Ground base traps that arthropods fall into.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Collection by hand, usually into a jar or container</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Similar to an Aerial net, but constructed of stronger fabric for sweeping through vegetation.</para>
    /// </remarks>
