...
module ru =
    ...
    ///   <para>"A link to a UMLS semantic Type CUI."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"This residual category holds deleted classes"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"This residual category holds yet to be classified (mass-)imported terms as a simple list."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A temporal store for classes that are being worked on."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"A common accepted abbreviation for the RU-name. A word formed from the initials of one or more words describing the name, that is pronounceable like a normal word."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"A common accepted acronyn for the RU-name."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"A description of a task / action for the RU editor to solve an issue related to the RU."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"An alternative definition. Usually the non-aristotelian natural language definition initially provided by domain specialists."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"An alternative superclass assertion. Used to capture multiple parenthood."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"General axioms to be fulfilled by instances of the class can be captured in an informal way in natural language here."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// Might become RU specific, i.e. cls_change_note AND prpty_change_note"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"Allows to state the reason why a RU has been deleted."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"A prototypical example subclass for the class."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"A unique Identifyer for the class, consisting of a groups prefix, underscore and unique number."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"Any name of the class. ??? Will change according to Synonym implementation..."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// A database cross reference. ???"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"The main usage contexts can be stated, e.g. for text mining purposes or translation purposes."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"The date when a RU was first created. (Will be provided automatically by Protege 4)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"The status (stability level) of the class. Specifies tracking information. E.g. unstable, experimental, stable."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"The arestotelian, formalized and normalized class definition layed out according to IFOMIS-best practice, explanaining the meaning of a class."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"The definition provenance (was: Defsource). It can be a source publication, a database or ontology entry, a group or person name or a URL (dbxref in obo)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <summary>
    ///   <para>ru:definition</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    /// </remarks>
    /// <seealso href="http://purl.org/imbi/ru-meta.owl#definition">http://purl.org/imbi/ru-meta.owl#definition</seealso>
    let definition = Prefixed_Name(ru, "definition") |> PrefixedName
    /// <summary>
    ///   <para>ru:del_date</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"The date a RU was deleted."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"The name of a specific editior/curator who is responsible for and edits this RU."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"A note related to the RU intended for its editor."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"A name for the class that is formaly controlled through linguistical rules and axioms. E.G. OBOL normalized ones that adhere to defined principles of word/morpheme/affix order and form. ???"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"An example  value or instance for the class or Database entry which will be annotated through this RU."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"The date on which the RU was last modified."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"State wheather a class was defined or primitive when deleted."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"For deleted classes state their last position within the ontology, state the old superclasses."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"For deleted classes state their last position within the ontology, state the old subclasses."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"To mark from where on in the Class-hierarchy we want to import / refer to a complete subclass hierarchy from an other ontology (was: refer to) ??? Maybe better: cls_imp"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"The preferred name for a class, usually the one used to display in the Hierarchy-browser. As now captured in the rdf:label ???"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"The preferred name for a class, usually the one used to display in the Hierarchy-browser."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"State the reason why a property was deleted, analogously as for cla_del."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"A prototypic example od a sub-property of this property )when property hierarchies are allowed."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"A unique formal identifyer for the property, analogously to the cls_id."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"A name of the property, analogously as a cls_name."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"When a class has been refactored into more atomic classes, then the original compound class is made obsolete and this deleted source class which gave birth to the new atomic child classes is mentioned here for all new atomic classes."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"When a new RU-name replaces an old one, state here which one was replaced. ???"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"Any general formless remark or note about the scope of the RU (was: rem, note)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"A short class name suitable for graph visualisations etc."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"A shortproperty name suitable for graph visualisations etc."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// Do we need this separately for diff RUs? Eg. cls_src, prprty_src,…?"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"An alternative name for the RU used as synonym (can be used in the same manner as the name in different contexts)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"Indicates definitions which need to be refined."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>"An important problematic issue that has to be tackled by the editors."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
