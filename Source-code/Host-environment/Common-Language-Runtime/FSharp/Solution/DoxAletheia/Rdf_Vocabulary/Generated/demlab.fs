...
module demlab =
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A ClinicalRecord contains a ClinicalAssessment</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The status of a semi-directed activity</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>MeasuredData is the root concept that groups the measurement types that are collected during the Tasks.</para>
    /// </remarks>
    /// <seealso href="http://www.demcare.eu/ontologies/demlab.owl#MeasuredData">http://www.demcare.eu/ontologies/demlab.owl#MeasuredData</seealso>
    let MeasuredData = Prefixed_Name(demlab, "MeasuredData") |> PrefixedName
