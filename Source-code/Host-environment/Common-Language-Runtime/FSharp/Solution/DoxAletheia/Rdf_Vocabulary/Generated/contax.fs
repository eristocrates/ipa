...
module contax =
    ...
    let ConstructionComponent = _prefix "ConstructionComponent"
    /// <summary>
    ...
    let ConstructionSubComponent = _prefix "ConstructionSubComponent"
    /// <summary>
    ...
    let isRootOfTaxonomy = _prefix "isRootOfTaxonomy"
    /// <summary>
    ...
    /// </summary>
    let PropertyContext = _prefix "PropertyContext"
    /// <summary>
    ...
    let containsConcept = _prefix "containsConcept"
    /// <summary>
    ...
    let containsGuideTerm = _prefix "containsGuideTerm"
    /// <summary>
    ...
    let domainOrSubjectIncludes = _prefix "domainOrSubjectIncludes"
    /// <summary>
    ...
    /// </summary>
    let hasPropertyContext = _prefix "hasPropertyContext"
    /// <summary>
    ///   <see href="https://w3id.org/con-tax#isDerivedFromProperty"></see>
    /// </summary>
    let isDerivedFromProperty = _prefix "isDerivedFromProperty"
    /// <summary>
    ///   <see href="https://w3id.org/con-tax#isDerivedFromPropertyState"></see>
    /// </summary>
    let isDerivedFromPropertyState = _prefix "isDerivedFromPropertyState"
    /// <summary>
    ...
    let potentialInterventionType = _prefix "potentialInterventionType"
    /// <summary>
    ...
    let potentialSubComponent = _prefix "potentialSubComponent"
    /// <summary>
    ...
    let property_DP = _prefix "property_DP"
    /// <summary>
    ...
    let property_OP = _prefix "property_OP"
    /// <summary>
    ...
    let rangeOrObjectIncludes = _prefix "rangeOrObjectIncludes"
