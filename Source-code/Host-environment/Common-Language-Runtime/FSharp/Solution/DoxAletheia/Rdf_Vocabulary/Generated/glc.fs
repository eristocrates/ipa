...
module glc =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Represents any AggregatedMeasurement, by using an AggregatedFunction, a time interval and time step resolution.</para>
    /// labels<para>AggregatedMeasurement</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It represents an energy resource</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It represents an energy resource that generates power</para>
    /// labels<para>Energy Power Generation Resource</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>For representing the HardConstraints of a Task.</para>
    /// labels<para>HardConstraint</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It represents any WorkProducingResource that can perform Measurements.</para>
    /// labels<para>MeasuringResource</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Represents any Measurement, e.g., for energy.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It describes any Task that has Constraints and a Status.</para>
    ...
    ///   <para>The date and time of a Status.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The end time of a Status of any Class.</para>
    ...
    ///   <para>For keeping information about the Composition of the SoftConstraints of a Task.</para>
    /// labels<para>hasComposition</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It describes the Aspect of a Contstraint, e.g., time, power consumption.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An AssignedTask that will be performed by using some Resources and will be based on some Constraints.</para>
    /// labels<para>AssignedTask</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>For representing the Constraint(s) of a Task.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The starting interval time of an AggregatedMeasurement.</para>
    /// labels<para>startingInterval</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The status code of a Status.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A triggered event relationship about Rescheduling from a Monitor.</para>
    /// labels<para>triggersReschedule</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A generic Class for the GLACIATION project</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It represents an electrical grid</para>
    /// labels<para>Electrical Grid</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It represents any WorkProducingResource, e.g., a node, a CPU, etc.</para>
    /// labels<para>WorkProducingResource</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Represents an entity that monitors an AssignedTask.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Represents a MeasurementProperty, e.g., allocated CPU, energy, etc.</para>
    /// labels<para>MeasurementProperty</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Represents a MeasurementUnit, e.g., Kwh.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It represents any NonWorkProducingResource (e.g., dataset).</para>
    /// labels<para>NonWorkProducingResource</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Responsible for Scheduling a SubmittedTask and for managing the Resources.</para>
    /// labels<para>Scheduler</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Submitted Task that will be processed by a Scheduler.</para>
    /// labels<para>SubmittedTask</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It represents any Resource.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It represents any Site, e.g., a location, an island, etc.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It describes the composition of SoftConstraints, e.g., the order of soft constraings according to a given preference priority, Pareto, Pareto optimal, etc.</para>
    /// labels<para>SoftConstraintComposition</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>For representing the SoftConstraints of a Task.</para>
    /// labels<para>SoftConstraint</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Represents information about a specific Status over a given time interval.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>For keeping information about the SoftConstraints that are included in a Composition.</para>
    /// labels<para>composedBy</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The grid where a work producing resource consumes energy from</para>
    /// labels<para>consumesEnergyFrom</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The ending interval time of an AggregatedMeasurement.</para>
    /// labels<para>endingInterval</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The AggregatedFunction of an AggregatedMeasurement.</para>
    /// labels<para>hasAggregatedFuntion</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The Configuration of any instance of a Class, e.g., Task, Resource, etc.</para>
    /// labels<para>hasConfiguration</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The ID of any entity.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relationship between a Task and a Measurement.</para>
    /// labels<para>hasTaskMeasurement</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relationship for recording the RealizedMeasurements (actual measurements) of a Task.</para>
    /// labels<para>hasTaskRealizedMeasurement</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The date and time of a Measurement.</para>
    /// labels<para>hasTimestamp</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The Value of a Measurement.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relationship between a Scheduler and a Resource.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>For recording which Monitor tracks an AssignedTask.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>For keeping information about the production Resource, e.g., the output, of an AssignedTask.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>For keeping information about the Constraint that each Measurement relates to.</para>
    /// labels<para>relatesToConstraint</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relationship between a Scheduler and an AssignedTask.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A property for recording the Resource(s) of each AssignedTask.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>For keeping information about the Aspect of each Constraint, e.g., time, power consumption.</para>
    /// labels<para>hasAspect</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The Description of any entity.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relationship between a Resource and a Measurement.</para>
    /// labels<para>hasResourceMeasurement</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Relationships for recording the SubResource(s) of each Resource (e.g, the hardware of a node).</para>
    /// labels<para>hasSubResource</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relationship for recording the PredictedMeasurements of a Task.</para>
    /// labels<para>hasTaskPredictedMeasurement</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relationship for recording all the Constraints of a Task.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relationship between any Class and its Status.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The location of a Work Producing Resource</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>For recording the MeasurimentUnit of each Measurement.</para>
    /// labels<para>measuredIn</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relationship between a MeasuringResource and a Measurement.</para>
    /// labels<para>makesMeasurement</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>For recording the MeasurementProperty of each Measurement.</para>
    /// labels<para>relatesToMeasurementProperty</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relationship between a Scheduler and an AssignedTask that concerns rescheduling.</para>
    /// labels<para>reschedules</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relationship between a SubmittedTask and a Scheduler.</para>
    /// labels<para>scheduledBy</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The time step resolution of an AggregatedMeasurement.</para>
    /// labels<para>timeStepResolution</para></remarks>
