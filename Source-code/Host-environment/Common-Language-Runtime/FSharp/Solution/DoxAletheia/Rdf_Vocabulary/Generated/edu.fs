...
module edu =
    ...
    /// labels<para>"Hoiak"</para><para>"Attitude"</para></remarks>
    ...
    /// labels<para>"Õppekava"</para><para>"Curriculum"</para></remarks>
    ...
    /// labels<para>"Teadmine"</para><para>"Knowledge"</para></remarks>
