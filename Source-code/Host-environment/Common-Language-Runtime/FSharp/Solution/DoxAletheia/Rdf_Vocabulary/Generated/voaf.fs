...
module voaf =
    ...
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://purl.org/vocommons/voaf#">http://purl.org/vocommons/voaf#</seealso>
    let _prefix_iri = Prefixed_Name(voaf, "") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"Dataset occurrences"</para><para>"Occurrences dans un jeu de données"</para></remarks>
    ...
    ///   <para>"A vocabulary used in the linked data cloud. An instance of voaf:Vocabulary relies on or is used by at least another instance of voaf:Vocabulary."</para>
    /// labels<para>"Vocabulary"</para><para>"Vocabulaire"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A vocabulary space defines any relevant grouping of vocabularies
    /// e.g., designed for similar purposes or domains, or designed by the same publisher or the same project, etc.
    ///     A vocabulary can belong to zero, one or more vocabulary spaces."</para>
    ...
    ///   <para>"Dublin Core properties isPartOf and hasPart are used to link a vocabulary to a
    /// vocabulary space"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"généralise"</para><para>"generalizes"</para></remarks>
    ...
    /// labels<para>"has equivalences with"</para><para>"a des équivalences avec"</para></remarks>
    ...
    /// labels<para>"occurrences"</para></remarks>
    ...
    /// <summary>
    ///   <para>voaf:preferredNamespacePrefix</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://purl.org/vocommons/voaf#preferredNamespacePrefix">http://purl.org/vocommons/voaf#preferredNamespacePrefix</seealso>
    let preferredNamespacePrefix =
        Prefixed_Name(voaf, "preferredNamespacePrefix") |> PrefixedName

    /// <summary>
    ///   <para>voaf:preferredNamespaceUri</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://purl.org/vocommons/voaf#preferredNamespaceUri">http://purl.org/vocommons/voaf#preferredNamespaceUri</seealso>
    let preferredNamespaceUri =
        Prefixed_Name(voaf, "preferredNamespaceUri") |> PrefixedName
    ...
    /// labels<para>"number of properties"</para><para>"nombre de propriétés"</para></remarks>
    ...
    /// labels<para>"relies on"</para><para>"réutilise"</para></remarks>
    ...
    /// labels<para>"reused by datasets"</para><para>"réutilisé par des jeux de données"</para></remarks>
    ...
    /// labels<para>"spécialise"</para><para>"specializes"</para></remarks>
