...
module spcm =
    ...
    ///   </para>
    /// labels<para>The Milestone entity</para></remarks>
    ...
    ///    necesaria para conseguir los objetivos del proyecto.</para>
    /// labels<para>The Task entity</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Roles asignados a un proyecto</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Rol responsable de realizar una determinada tarea</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Categorías definidas para las tareas de un proyecto</para>
    /// labels<para>The taskCategories reference</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Categoría de una tarea dada</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Tareas asociadas a un determinado hito del proyecto</para>
    /// labels<para>The tasks reference</para></remarks>
    ...
    ///    de aplicación.</para>
    /// labels<para>The TaskCategory entity</para></remarks>
    ...
    ///    dependencia entre dos tareas concretas.</para>
    /// labels<para>The TaskDependency entity</para></remarks>
    ...
    ///   <para>Descripción de un proyecto, un hito o una tarea</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Conjunto de milestones o hitos de un proyecto</para>
    /// labels<para>The milestones reference</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>Habilidades específicas de un determinado rol.</para>
    /// labels<para>The skills attribute</para></remarks>
