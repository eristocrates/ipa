...
module rico =
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Machine-readable quantity.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Connects a Record Resource or Instantiation to an Extent</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Connects an Extent to a Record Resource or Instantiation</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Categorization of the extent that is being measured</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Connects an Extent to a Unit Of Measurement</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Inverse of 'has unit of measurement' object property</para>
    ...
    ///             units used in the archival context like number of boxes, pages or words.</para>
