...
module oad =
    ...
    /// labels<para>Has administrative / biographical history</para><para>Ha storia amministrativa / biografica</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>Entità collegata</para><para>Has Entity</para></remarks>
    ...
    /// labels<para>Immediate source of acquisition or transfer</para><para>Modalità di acquisizione o versamento</para></remarks>
    ...
    /// labels<para>Ambiti e contenuto</para><para>Scope and content</para></remarks>
    ...
    /// labels<para>Ha scheda descrittiva collegata</para><para>Has related instance</para></remarks>
    ...
    /// labels<para>Is produced by</para><para>È prodotta da</para></remarks>
