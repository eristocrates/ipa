...
module owls =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"See comments above"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"
    ...
    ///   "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"See comments above"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"ServiceGrounding"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"See comments above"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"ServiceModel"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"See comments above"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"ServiceProfile"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
