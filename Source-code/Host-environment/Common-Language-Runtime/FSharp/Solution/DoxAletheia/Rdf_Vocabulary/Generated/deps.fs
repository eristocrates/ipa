...
module deps =
    ...
    ///   <para>"an extension to DOAP for describing a project's requirements"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"DOAP Dependencies"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>"A module name, optionally followed by a space character and a version."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"Examples: `Moose::Role` or `Moose::Role 2.0600`"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"CPAN Identifier"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>deps:IdentifierScheme</para>
    ///   <para>"Examples: `libmoose-perl` or `libmoose-perl (&gt;= 2.0600-1)`"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"Note that architecture-specific modifiers (in square brackets) are not supported yet."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Debian Package Identifier"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A condition to be met"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>deps:IdentifierScheme</para>
    ///   <para>"Examples: `log4r` or `log4r &gt;= 1.0.5` or `log4r &gt;= 1.0.5, &lt; 2.0.0`"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"A module name, optionally followed by one or more operator, version number pairs."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Gem Identifier"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Historic Dependency"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>deps:IdentifierScheme</para>
    ///   <para>"Example 'org.clojure/clojure 1.5.1-SNAPSHOT'"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"A fully qualified Maven artefact name: 'groupID/artefactID version[-classifier]'"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Maven Identifier"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>deps:IdentifierScheme</para>
    ///   <para>"Example: `html5lib==0.95`"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"A single line from a requirements.txt file, minus the line break."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Pip Identifier"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>deps:IdentifierScheme</para>
    ///   <para>"Examples: `perl-Moose` or `perl-Moose &gt;= 2.0600-1`"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"RPM Package Identifier"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// labels<para>"build recommendation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"build requirement"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"build suggestion"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"configure recommendation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"configure requirement"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"configure suggestion"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"development recommendation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"development requirement"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"development suggestion"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>"the range of this property is a little woolly; a doap:Project is certainly fine, as is a literal which acts as an identifier, provided it's qualified with a datatype indicating what scheme it's an identifier in"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"runtime recommendation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"runtime requirement"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"runtime suggestion"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"test recommendation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"test requirement"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"test suggestion"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
