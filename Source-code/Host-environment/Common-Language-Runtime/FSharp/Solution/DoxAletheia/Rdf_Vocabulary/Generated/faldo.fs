...
module faldo =
    ...
    let BagOfRegions =
        Namespaced_IRI.parse _namespace_name "BagOfRegions" |> NamespacedName
    ...
    let CollectionOfRegions =
        Namespaced_IRI.parse _namespace_name "CollectionOfRegions" |> NamespacedName
    ...
    let BothStrandsPosition =
        Namespaced_IRI.parse _namespace_name "BothStrandsPosition" |> NamespacedName
    ...
    let StrandedPosition =
        Namespaced_IRI.parse _namespace_name "StrandedPosition" |> NamespacedName
    ...
    let ForwardStrandPosition =
        Namespaced_IRI.parse _namespace_name "ForwardStrandPosition" |> NamespacedName
    ...
    let ReverseStrandPosition =
        Namespaced_IRI.parse _namespace_name "ReverseStrandPosition" |> NamespacedName
    ...
    let ``C-TerminalPosition`` =
        Namespaced_IRI.parse _namespace_name "C-TerminalPosition" |> NamespacedName

    /// <summary>
    /// A position that is exactly known.
    /// <see href="http://biohackathon.org/resource/faldo#ExactPosition"></see></summary>
    let ExactPosition =
        Namespaced_IRI.parse _namespace_name "ExactPosition" |> NamespacedName
    ...
    let ``N-TerminalPosition`` =
        Namespaced_IRI.parse _namespace_name "N-TerminalPosition" |> NamespacedName
    ...
    let InBetweenPosition =
        Namespaced_IRI.parse _namespace_name "InBetweenPosition" |> NamespacedName
    ...
    let InRangePosition =
        Namespaced_IRI.parse _namespace_name "InRangePosition" |> NamespacedName
    ...
    let OneOfPosition =
        Namespaced_IRI.parse _namespace_name "OneOfPosition" |> NamespacedName
    ...
    let FuzzyPosition =
        Namespaced_IRI.parse _namespace_name "FuzzyPosition" |> NamespacedName
    ...
    let ListOfRegions =
        Namespaced_IRI.parse _namespace_name "ListOfRegions" |> NamespacedName
    ...
    let beginOf = Namespaced_IRI.parse _namespace_name "beginOf" |> NamespacedName
    /// <summary>
    ...
    let endOf = Namespaced_IRI.parse _namespace_name "endOf" |> NamespacedName
    /// <summary>
