...
module quantitykind =
    ...
    ///   <para>Applicable units are those of quantitykind:Density</para>
    ...
    let ``_/AbsoluteHumidity`` =
        Prefixed_Name(quantitykind, "/AbsoluteHumidity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Absorptance</para>
    ...
    let ``_/Absorptance`` = Prefixed_Name(quantitykind, "/Absorptance") |> PrefixedName
    ...
    let ``_/BinaryLogarithmicMedianInformationFlow`` =
        Prefixed_Name(quantitykind, "/BinaryLogarithmicMedianInformationFlow") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:BindingFraction</para>
    ...
    let ``_/BindingFraction`` =
        Prefixed_Name(quantitykind, "/BindingFraction") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Dimensionless</para>
    ...
    let ``_/CharacteristicNumber`` =
        Prefixed_Name(quantitykind, "/CharacteristicNumber") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Velocity</para>
    ...
    let ``_/CharacteristicVelocity`` =
        Prefixed_Name(quantitykind, "/CharacteristicVelocity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ChemicalAffinity</para>
    ...
    let ``_/ChemicalAffinity`` =
        Prefixed_Name(quantitykind, "/ChemicalAffinity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificVolume</para>
    ...
    let ``_/ChemicalConsumptionPerMass`` =
        Prefixed_Name(quantitykind, "/ChemicalConsumptionPerMass") |> PrefixedName
    ...
    let ``_/SpecificVolume`` =
        Prefixed_Name(quantitykind, "/SpecificVolume") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricChargePerArea</para>
    ...
    let ``_/ElectricDisplacement`` =
        Prefixed_Name(quantitykind, "/ElectricDisplacement") |> PrefixedName
    ...
    let ``_/ElectricDisplacementField`` =
        Prefixed_Name(quantitykind, "/ElectricDisplacementField") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Energy</para>
    ...
    let ``_/GapEnergy`` = Prefixed_Name(quantitykind, "/GapEnergy") |> PrefixedName
    /// <summary>
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>gas leak rate</para><para>gas leak rate</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/GasLeakRate">http://qudt.org/vocab/quantitykind/GasLeakRate</seealso>
    let ``_/GasLeakRate`` = Prefixed_Name(quantitykind, "/GasLeakRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ForcePerArea</para>
    ...
    let ``_/GaugePressure`` =
        Prefixed_Name(quantitykind, "/GaugePressure") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:GeneFamilyAbundance</para>
    ...
    let ``_/GeneFamilyAbundance`` =
        Prefixed_Name(quantitykind, "/GeneFamilyAbundance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Kerma</para>
    ...
    let ``_/Kerma`` = Prefixed_Name(quantitykind, "/Kerma") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/KermaRate</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:KermaRate</para>
    ...
    let ``_/KermaRate`` = Prefixed_Name(quantitykind, "/KermaRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MomentOfInertia</para>
    ...
    let ``_/MOMENT_OF_INERTIA_Y`` =
        Prefixed_Name(quantitykind, "/MOMENT-OF-INERTIA_Y") |> PrefixedName
    ...
    let ``_/MomentOfInertia_Y`` =
        Prefixed_Name(quantitykind, "/MomentOfInertia_Y") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Ratio</para>
    ...
    let ``_/Ratio`` = Prefixed_Name(quantitykind, "/Ratio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RatioOfSpecificHeatCapacities</para>
    ...
    let ``_/RatioOfSpecificHeatCapacities`` =
        Prefixed_Name(quantitykind, "/RatioOfSpecificHeatCapacities") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DimensionlessRatio</para>
    ...
    let ``_/SpeedRatio`` = Prefixed_Name(quantitykind, "/SpeedRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LuminousFluxPerArea</para>
    ...
    let ``_/SphericalIlluminance`` =
        Prefixed_Name(quantitykind, "/SphericalIlluminance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AngularMomentum</para>
    /// labels<para>اسپین/چرخش</para><para>لف مغزلي</para><para>スピン角運動量</para><para>espín</para><para>Spin</para><para>spin</para><para>spin</para><para>Spin</para><para>spin</para><para>spin</para><para>spin</para><para>spin</para><para>Spin</para><para>Spin</para><para>spin</para><para>Спин</para><para>自旋</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Spin">http://qudt.org/vocab/quantitykind/Spin</seealso>
    let ``_/Spin`` = Prefixed_Name(quantitykind, "/Spin") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TotalMassStoppingPower</para>
    ...
    let ``_/TotalMassStoppingPower`` =
        Prefixed_Name(quantitykind, "/TotalMassStoppingPower") |> PrefixedName
    ...
    let ``_/TotalPressure`` =
        Prefixed_Name(quantitykind, "/TotalPressure") |> PrefixedName
    ...
    let ``_/TotalRadiance`` =
        Prefixed_Name(quantitykind, "/TotalRadiance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:APIGravity</para>
    ...
    let ``_/APIGravity`` = Prefixed_Name(quantitykind, "/APIGravity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InverseVolume</para>
    ...
    let ``_/InverseVolume`` =
        Prefixed_Name(quantitykind, "/InverseVolume") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AbsorbedDoseRate</para>
    ...
    let ``_/AbsorbedDoseRate`` =
        Prefixed_Name(quantitykind, "/AbsorbedDoseRate") |> PrefixedName
    ...
    let ``_/ThermodynamicEnergy`` =
        Prefixed_Name(quantitykind, "/ThermodynamicEnergy") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Energy</para>
    /// labels<para>кинетическая энергия</para><para>energia kinetyczna</para><para>kinetische Energie</para><para>kinetická energie</para><para>énergie cinétique</para><para>energia cinetica</para><para>Energie cinetică</para><para>energía cinética</para><para>energia cinética</para><para>Kinetik enerji</para><para>kinetic energy</para><para>Tenaga kinetik</para><para>انرژی جنبشی</para><para>طاقة حركية</para><para>गतिज ऊर्जा</para><para>運動エネルギー</para><para>动能</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/EnergyKinetic">http://qudt.org/vocab/quantitykind/EnergyKinetic</seealso>
    let ``_/EnergyKinetic`` =
        Prefixed_Name(quantitykind, "/EnergyKinetic") |> PrefixedName
    ...
    let ``_/EnergyLevel`` = Prefixed_Name(quantitykind, "/EnergyLevel") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EnergyPerArea</para>
    ...
    let ``_/EnergyPerArea`` =
        Prefixed_Name(quantitykind, "/EnergyPerArea") |> PrefixedName
    ...
    let ``_/EnergyPerMagneticFluxDensity_Squared`` =
        Prefixed_Name(quantitykind, "/EnergyPerMagneticFluxDensity_Squared") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EnergyPerSquareMagneticFluxDensity</para>
    /// labels<para>Energy Per Square Magnetic Flux Density</para></remarks>
    ...
    let ``_/EnergyPerSquareMagneticFluxDensity`` =
        Prefixed_Name(quantitykind, "/EnergyPerSquareMagneticFluxDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EnergyPerMassAmountOfSubstance</para>
    ...
    let ``_/EnergyPerMassAmountOfSubstance`` =
        Prefixed_Name(quantitykind, "/EnergyPerMassAmountOfSubstance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EnergyPerTemperature</para>
    ...
    let ``_/EnergyPerTemperature`` =
        Prefixed_Name(quantitykind, "/EnergyPerTemperature") |> PrefixedName
    ...
    let ``_/Energy_Squared`` =
        Prefixed_Name(quantitykind, "/Energy_Squared") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:GFactorOfNucleus</para>
    ...
    let ``_/GFactorOfNucleus`` =
        Prefixed_Name(quantitykind, "/GFactorOfNucleus") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Mass</para>
    ...
    let ``_/GROSS_LIFT_OFF_WEIGHT`` =
        Prefixed_Name(quantitykind, "/GROSS-LIFT-OFF-WEIGHT") |> PrefixedName
    ...
    let ``_/Gain`` = Prefixed_Name(quantitykind, "/Gain") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:IonicStrength</para>
    ...
    let ``_/IonicStrength`` =
        Prefixed_Name(quantitykind, "/IonicStrength") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:IsentropicExponent</para>
    /// labels<para>Coefficiente di dilatazione adiabatica</para><para>Coeficient de transformare adiabatică</para><para>Coeficiente de dilatación adiabática</para><para>ısı sığası oranı; adyabatik indeks</para><para>Coeficiente de expansão adiabática</para><para>exposant isoentropique</para><para>Poissonova konstanta</para><para>isentropic exponent</para><para>نسبة السعة الحرارية</para><para>adiabatni eksponent</para><para>Показатель адиабаты</para><para>Isentropenexponent</para><para>Wykładnik adiabaty</para><para>绝热指数</para><para>比熱比</para></remarks>
    ...
    let ``_/IsentropicExponent`` =
        Prefixed_Name(quantitykind, "/IsentropicExponent") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ModulusOfSubgradeReaction</para>
    ...
    let ``_/ModulusOfSubgradeReaction`` =
        Prefixed_Name(quantitykind, "/ModulusOfSubgradeReaction") |> PrefixedName
    ...
    let ``_/PayloadRatio`` =
        Prefixed_Name(quantitykind, "/PayloadRatio") |> PrefixedName
    ...
    let ``_/PeltierCoefficient`` =
        Prefixed_Name(quantitykind, "/PeltierCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Period</para>
    ...
    let ``_/Period`` = Prefixed_Name(quantitykind, "/Period") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RateOfChange</para>
    ...
    let ``_/RateOfChange`` =
        Prefixed_Name(quantitykind, "/RateOfChange") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>rate of rise of voltage</para></remarks>
    ...
    let ``_/RateOfRiseOfVoltage`` =
        Prefixed_Name(quantitykind, "/RateOfRiseOfVoltage") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>spectral radiant energy density in terms of wavelength</para></remarks>
    ...
    let ``_/SpectralRadiantEnergyDensityInTermsOfWavelength`` =
        Prefixed_Name(quantitykind, "/SpectralRadiantEnergyDensityInTermsOfWavelength") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpeedOfLight</para>
    /// labels<para>vitesse de la lumière</para><para>Lichtgeschwindigkeit</para><para>velocidad de la luz</para><para>velocità della luce</para><para>Velocidade da luz</para><para>Prędkość światła</para><para>Hitrost svetlobe</para><para>Rychlost světla</para><para>Kelajuan cahaya</para><para>Viteza luminii</para><para>speed of light</para><para>Скорость света</para><para>प्रकाश का वेग</para><para>سرعة الضوء</para><para>Işık hızı</para><para>سرعت نور</para><para>光速</para><para>光速</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/SpeedOfLight">http://qudt.org/vocab/quantitykind/SpeedOfLight</seealso>
    let ``_/SpeedOfLight`` =
        Prefixed_Name(quantitykind, "/SpeedOfLight") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Area</para>
    ...
    let ``_/TotalCrossSection`` =
        Prefixed_Name(quantitykind, "/TotalCrossSection") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TotalCurrent</para>
    ...
    let ``_/TotalCurrent`` =
        Prefixed_Name(quantitykind, "/TotalCurrent") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TotalCurrentDensity</para>
    ...
    let ``_/TotalCurrentDensity`` =
        Prefixed_Name(quantitykind, "/TotalCurrentDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TotalIonization</para>
    ...
    let ``_/TotalIonization`` =
        Prefixed_Name(quantitykind, "/TotalIonization") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarAttenuationCoefficient</para>
    ...
    let ``_/MolarAttenuationCoefficient`` =
        Prefixed_Name(quantitykind, "/MolarAttenuationCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Length</para>
    ...
    let ``_/PositionVector`` =
        Prefixed_Name(quantitykind, "/PositionVector") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CO2Equivalent</para>
    /// labels<para>CO2Equivalent</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/CO2Equivalent">http://qudt.org/vocab/quantitykind/CO2Equivalent</seealso>
    let ``_/CO2Equivalent`` =
        Prefixed_Name(quantitykind, "/CO2Equivalent") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Mass</para>
    /// labels<para>Mass Equivalent</para></remarks>
    ...
    let ``_/MassEquivalent`` =
        Prefixed_Name(quantitykind, "/MassEquivalent") |> PrefixedName
    ...
    let ``_/CONTRACT_END_ITEM_SPECIFICATION_MASS`` =
        Prefixed_Name(quantitykind, "/CONTRACT-END-ITEM-SPECIFICATION-MASS") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Emissivity</para>
    ...
    let ``_/Emissivity`` = Prefixed_Name(quantitykind, "/Emissivity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearTorque</para>
    ...
    let ``_/LinearTorque`` =
        Prefixed_Name(quantitykind, "/LinearTorque") |> PrefixedName
    ...
    let ``_/LinearVoltageCoefficient`` =
        Prefixed_Name(quantitykind, "/LinearVoltageCoefficient") |> PrefixedName
    ...
    let ``_/LineicCharge`` =
        Prefixed_Name(quantitykind, "/LineicCharge") |> PrefixedName
    ...
    let ``_/LineicDataVolume`` =
        Prefixed_Name(quantitykind, "/LineicDataVolume") |> PrefixedName
    ...
    let ``_/LineicMass`` = Prefixed_Name(quantitykind, "/LineicMass") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/LineicPower</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LineicPower</para>
    ...
    let ``_/LineicPower`` = Prefixed_Name(quantitykind, "/LineicPower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LineicResolution</para>
    ...
    let ``_/LineicResolution`` =
        Prefixed_Name(quantitykind, "/LineicResolution") |> PrefixedName
    ...
    let ``_/Log10FrequencyInterval`` =
        Prefixed_Name(quantitykind, "/Log10FrequencyInterval") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LogOctanolAirPartitionCoefficient</para>
    ...
    let ``_/LogOctanolAirPartitionCoefficient`` =
        Prefixed_Name(quantitykind, "/LogOctanolAirPartitionCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LogOctanolWaterPartitionCoefficient</para>
    ...
    let ``_/LogOctanolWaterPartitionCoefficient`` =
        Prefixed_Name(quantitykind, "/LogOctanolWaterPartitionCoefficient") |> PrefixedName
    ...
    let ``_/LogarithmRatioToBase10`` =
        Prefixed_Name(quantitykind, "/LogarithmRatioToBase10") |> PrefixedName
    ...
    let ``_/LogarithmicFrequencyIntervalToBase10`` =
        Prefixed_Name(quantitykind, "/LogarithmicFrequencyIntervalToBase10") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassFractionOfDryMatter</para>
    ...
    let ``_/MassFractionOfDryMatter`` =
        Prefixed_Name(quantitykind, "/MassFractionOfDryMatter") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassFractionOfWater</para>
    ...
    let ``_/MassFractionOfWater`` =
        Prefixed_Name(quantitykind, "/MassFractionOfWater") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricField</para>
    ...
    let ``_/RF_Power`` = Prefixed_Name(quantitykind, "/RF-Power") |> PrefixedName
    ...
    let ``_/SignalStrength`` =
        Prefixed_Name(quantitykind, "/SignalStrength") |> PrefixedName
    ...
    let ``_/RadialDistance`` =
        Prefixed_Name(quantitykind, "/RadialDistance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Radiance</para>
    ...
    let ``_/Radiance`` = Prefixed_Name(quantitykind, "/Radiance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PowerPerArea</para>
    ...
    let ``_/SoundIntensity`` =
        Prefixed_Name(quantitykind, "/SoundIntensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Acceleration</para>
    ...
    let ``_/SoundParticleAcceleration`` =
        Prefixed_Name(quantitykind, "/SoundParticleAcceleration") |> PrefixedName
    ...
    let ``_/SoundParticleDisplacement`` =
        Prefixed_Name(quantitykind, "/SoundParticleDisplacement") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VentilationRatePerFloorArea</para>
    ...
    let ``_/VentilationRatePerFloorArea`` =
        Prefixed_Name(quantitykind, "/VentilationRatePerFloorArea") |> PrefixedName
    ...
    let ``_/VerticalVelocity`` =
        Prefixed_Name(quantitykind, "/VerticalVelocity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VideoFrameRate</para>
    ...
    let ``_/VideoFrameRate`` =
        Prefixed_Name(quantitykind, "/VideoFrameRate") |> PrefixedName
    ...
    let ``_/VisibleRadiantEnergy`` =
        Prefixed_Name(quantitykind, "/VisibleRadiantEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VoltageRatio</para>
    ...
    let ``_/VoltageRatio`` =
        Prefixed_Name(quantitykind, "/VoltageRatio") |> PrefixedName
    ...
    let ``_/VolumeDensityOfCharge`` =
        Prefixed_Name(quantitykind, "/VolumeDensityOfCharge") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VolumePerTime</para>
    ...
    let ``_/VolumePerTime`` =
        Prefixed_Name(quantitykind, "/VolumePerTime") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:NumberDensity</para>
    ...
    let ``_/AcceptorDensity`` =
        Prefixed_Name(quantitykind, "/AcceptorDensity") |> PrefixedName
    ...
    let ``_/AcceptorIonizationEnergy`` =
        Prefixed_Name(quantitykind, "/AcceptorIonizationEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricCurrent</para>
    /// labels<para>intensité de courant électrique</para><para>Ένταση ηλεκτρικού ρεύματος</para><para>Сила электрического тока</para><para>elektrische Stromstärke</para><para>elektromos áramerősség</para><para>corriente eléctrica</para><para>corrente elettrica</para><para>corrente elétrica</para><para>Elektrický proud</para><para>prąd elektryczny</para><para>Електрически ток</para><para>electric current</para><para>fluxio electrica</para><para>curent electric</para><para>جریان الکتریکی</para><para>elektrik akımı</para><para>električni tok</para><para>Arus elektrik</para><para>विद्युत धारा</para><para>تيار كهربائي</para><para>זרם חשמלי</para><para>电流</para><para>電流</para></remarks>
    ...
    let ``_/ElectricCurrent`` =
        Prefixed_Name(quantitykind, "/ElectricCurrent") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Voltage</para>
    ...
    let ``_/Voltage`` = Prefixed_Name(quantitykind, "/Voltage") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Frequency</para>
    /// labels<para>imaginary part of complex frequency</para></remarks>
    ...
    let ``_/ComplexFrequency_Imaginary`` =
        Prefixed_Name(quantitykind, "/ComplexFrequency_Imaginary") |> PrefixedName
    ...
    let ``_/ExposureOfIonizingRadiation`` =
        Prefixed_Name(quantitykind, "/ExposureOfIonizingRadiation") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ExposureRate</para>
    ...
    let ``_/ExposureRate`` =
        Prefixed_Name(quantitykind, "/ExposureRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ExtentOfReaction</para>
    ...
    let ``_/ExtentOfReaction`` =
        Prefixed_Name(quantitykind, "/ExtentOfReaction") |> PrefixedName
    ...
    let ``_/MolecularViscosity`` =
        Prefixed_Name(quantitykind, "/MolecularViscosity") |> PrefixedName
    ...
    let ``_/KinematicViscosityOrDiffusionConstantOrThermalDiffusivity`` =
        Prefixed_Name(quantitykind, "/KinematicViscosityOrDiffusionConstantOrThermalDiffusivity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VolumeFlowRate</para>
    ...
    let ``_/VolumeFlowRate`` =
        Prefixed_Name(quantitykind, "/VolumeFlowRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolalityOfSolute</para>
    ...
    let ``_/MolalityOfSolute`` =
        Prefixed_Name(quantitykind, "/MolalityOfSolute") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarConductivity</para>
    ...
    let ``_/MolarConductivity`` =
        Prefixed_Name(quantitykind, "/MolarConductivity") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ForcePerArea</para>
    /// labels<para>Planar Force</para><para>Flächenlast</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/PlanarForce">http://qudt.org/vocab/quantitykind/PlanarForce</seealso>
    let ``_/PlanarForce`` = Prefixed_Name(quantitykind, "/PlanarForce") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/Reflectance</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Reflectance</para>
    ...
    let ``_/Reflectance`` = Prefixed_Name(quantitykind, "/Reflectance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ReflectanceFactor</para>
    ...
    let ``_/ReflectanceFactor`` =
        Prefixed_Name(quantitykind, "/ReflectanceFactor") |> PrefixedName
    ...
    let ``_/StagePropellantMass`` =
        Prefixed_Name(quantitykind, "/StagePropellantMass") |> PrefixedName
    ...
    let ``_/StageStructuralMass`` =
        Prefixed_Name(quantitykind, "/StageStructuralMass") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:StandardAbsoluteActivity</para>
    ...
    let ``_/StandardAbsoluteActivity`` =
        Prefixed_Name(quantitykind, "/StandardAbsoluteActivity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarEnergy</para>
    ...
    let ``_/StandardChemicalPotential`` =
        Prefixed_Name(quantitykind, "/StandardChemicalPotential") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Turbidity</para>
    ...
    let ``_/Turbidity`` = Prefixed_Name(quantitykind, "/Turbidity") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/Turns</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Turns</para>
    ...
    let ``_/Turns`` = Prefixed_Name(quantitykind, "/Turns") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AreaThermalExpansion</para>
    ...
    let ``_/AreaThermalExpansion`` =
        Prefixed_Name(quantitykind, "/AreaThermalExpansion") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AreaTimeTemperature</para>
    ...
    let ``_/AreaTimeTemperature`` =
        Prefixed_Name(quantitykind, "/AreaTimeTemperature") |> PrefixedName
    ...
    let ``_/AreicEnergyFlow`` =
        Prefixed_Name(quantitykind, "/AreicEnergyFlow") |> PrefixedName
    ...
    let ``_/VoltagePhasor`` =
        Prefixed_Name(quantitykind, "/VoltagePhasor") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PlaneAngle</para>
    ...
    let ``_/CompoundPlaneAngle`` =
        Prefixed_Name(quantitykind, "/CompoundPlaneAngle") |> PrefixedName
    ...
    let ``_/CompressibilityFactor`` =
        Prefixed_Name(quantitykind, "/CompressibilityFactor") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Conductance</para>
    ...
    let ``_/Conductance`` = Prefixed_Name(quantitykind, "/Conductance") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/Speed</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Speed</para>
    ...
    let ``_/Speed`` = Prefixed_Name(quantitykind, "/Speed") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:HeatFlowRate</para>
    ...
    let ``_/ConductiveHeatTransferRate`` =
        Prefixed_Name(quantitykind, "/ConductiveHeatTransferRate") |> PrefixedName
    ...
    let ``_/HeatFlowRate`` =
        Prefixed_Name(quantitykind, "/HeatFlowRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Conductivity</para>
    ...
    let ``_/Conductivity`` =
        Prefixed_Name(quantitykind, "/Conductivity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ConductivityVariance</para>
    ...
    let ``_/ConductivityVariance`` =
        Prefixed_Name(quantitykind, "/ConductivityVariance") |> PrefixedName
    ...
    let ``_/ConductivityVariance_NEON`` =
        Prefixed_Name(quantitykind, "/ConductivityVariance_NEON") |> PrefixedName
    ...
    let ``_/ConvectiveHeatTransfer`` =
        Prefixed_Name(quantitykind, "/ConvectiveHeatTransfer") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CoolingPerformanceRatio</para>
    ...
    let ``_/CoolingPerformanceRatio`` =
        Prefixed_Name(quantitykind, "/CoolingPerformanceRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CorrelatedColorTemperature</para>
    ...
    let ``_/CorrelatedColorTemperature`` =
        Prefixed_Name(quantitykind, "/CorrelatedColorTemperature") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Duv</para>
    ...
    let ``_/Duv`` = Prefixed_Name(quantitykind, "/Duv") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/CostPerArea</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CostPerArea</para>
    /// labels<para>Kosten pro Fläche</para><para>cost per area</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/CostPerArea">http://qudt.org/vocab/quantitykind/CostPerArea</seealso>
    let ``_/CostPerArea`` = Prefixed_Name(quantitykind, "/CostPerArea") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CostPerEnergy</para>
    ...
    let ``_/CostPerEnergy`` =
        Prefixed_Name(quantitykind, "/CostPerEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CostPerMass</para>
    ...
    let ``_/CostPerMass`` = Prefixed_Name(quantitykind, "/CostPerMass") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CostPerPower</para>
    ...
    let ``_/CostPerPower`` =
        Prefixed_Name(quantitykind, "/CostPerPower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:FrictionCoefficient</para>
    ...
    let ``_/FrictionCoefficient`` =
        Prefixed_Name(quantitykind, "/FrictionCoefficient") |> PrefixedName
    ...
    let ``_/DynamicPressure`` =
        Prefixed_Name(quantitykind, "/DynamicPressure") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DynamicViscosity</para>
    /// labels<para>گرانروی دینامیکی/ویسکوزیته دینامیکی</para><para>dynamische Viskosität</para><para>динамическую вязкость</para><para>dinamična viskoznost</para><para>viscosidade dinâmica</para><para>Viscozitate dinamică</para><para>viscosité dynamique</para><para>viscosidad dinámica</para><para>viscosità dinamica</para><para>lepkość dynamiczna</para><para>Kelikatan dinamik</para><para>dynamic viscosity</para><para>dinamik akmazlık</para><para>viskozita</para><para>श्यानता</para><para>لزوجة</para><para>动力粘度</para><para>粘度</para></remarks>
    ...
    let ``_/DynamicViscosity`` =
        Prefixed_Name(quantitykind, "/DynamicViscosity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Viscosity</para>
    ...
    let ``_/Viscosity`` = Prefixed_Name(quantitykind, "/Viscosity") |> PrefixedName
    ...
    let ``_/EarthClosestApproachVehicleVelocity`` =
        Prefixed_Name(quantitykind, "/EarthClosestApproachVehicleVelocity") |> PrefixedName
    ...
    let ``_/VehicleVelocity`` =
        Prefixed_Name(quantitykind, "/VehicleVelocity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EarthquakeMagnitude</para>
    /// labels<para>earthquake magnitude</para></remarks>
    ...
    let ``_/EarthquakeMagnitude`` =
        Prefixed_Name(quantitykind, "/EarthquakeMagnitude") |> PrefixedName
    ...
    let ``_/EccentricityOfOrbit`` =
        Prefixed_Name(quantitykind, "/EccentricityOfOrbit") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Energy</para>
    /// labels<para>पूर्ण ऊष्मा</para><para>محتوى حراري</para><para>entalpija</para><para>enthalpie</para><para>Enthalpie</para><para>энтальпия</para><para>entalpía</para><para>entalpie</para><para>entalpia</para><para>Entalpie</para><para>entalpia</para><para>entalpia</para><para>enthalpy</para><para>Entalpi</para><para>Entalpi</para><para>آنتالپی</para><para>エンタルピー</para><para>焓</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Enthalpy">http://qudt.org/vocab/quantitykind/Enthalpy</seealso>
    let ``_/Enthalpy`` = Prefixed_Name(quantitykind, "/Enthalpy") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/Entropy</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Entropy</para>
    /// labels<para>entropija</para><para>एन्ट्रॉपी</para><para>Энтропия</para><para>entropia</para><para>entropia</para><para>entropie</para><para>entropía</para><para>entropie</para><para>إنتروبيا</para><para>entropia</para><para>entropie</para><para>Entropie</para><para>entropy</para><para>آنتروپی</para><para>entropi</para><para>Entropi</para><para>エントロピー</para><para>熵</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Entropy">http://qudt.org/vocab/quantitykind/Entropy</seealso>
    let ``_/Entropy`` = Prefixed_Name(quantitykind, "/Entropy") |> PrefixedName
    /// <summary>
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Energy</para>
    /// labels<para>energia libera di Gibbs</para><para>Gibbsova volná energie</para><para>energia livre de Gibbs</para><para>Gibbs Serbest Enerjisi</para><para>entalpia swobodna</para><para>Prosta entalpija</para><para>Energía de Gibbs</para><para>طاقة غيبس الحرة</para><para>Entalpie liberă</para><para>انرژی آزاد گیبس</para><para>enthalpie libre</para><para>freie Enthalpie</para><para>энергия Гиббса</para><para>Gibbs energy</para><para>Tenaga Gibbs</para><para>ギブズエネルギー</para><para>吉布斯自由能</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/GibbsEnergy">http://qudt.org/vocab/quantitykind/GibbsEnergy</seealso>
    let ``_/GibbsEnergy`` = Prefixed_Name(quantitykind, "/GibbsEnergy") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Energy</para>
    /// labels<para>свободная энергия Гельмгольца</para><para>energia livre de Helmholtz</para><para>energia libera di Helmholz</para><para>Helmholtzova volná energie</para><para>Energía de Helmholtz</para><para>طاقة هلمهولتز الحرة</para><para>انرژی آزاد هلمولتز</para><para>Helmholtz enerjisi</para><para>Helmholtz energy</para><para>energia swobodna</para><para>Tenaga Helmholtz</para><para>Prosta energija</para><para>ヘルムホルツの自由エネルギー</para><para>énergie libre</para><para>freie Energie</para><para>亥姆霍兹自由能</para></remarks>
    ...
    let ``_/HelmholtzEnergy`` =
        Prefixed_Name(quantitykind, "/HelmholtzEnergy") |> PrefixedName
    ...
    let ``_/InternalEnergy`` =
        Prefixed_Name(quantitykind, "/InternalEnergy") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Energy</para>
    /// labels<para>lucru mecanic</para><para>trabalho</para><para>travail</para><para>trabajo</para><para>Arbeit</para><para>lavoro</para><para>praca</para><para>कार्य</para><para>kerja</para><para>práce</para><para>delo</para><para>work</para><para>仕事量</para><para>کار</para><para>iş</para><para>功</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Work">http://qudt.org/vocab/quantitykind/Work</seealso>
    let ``_/Work`` = Prefixed_Name(quantitykind, "/Work") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Energy</para>
    /// labels<para>energy content</para><para>energy content</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/EnergyContent">http://qudt.org/vocab/quantitykind/EnergyContent</seealso>
    let ``_/EnergyContent`` =
        Prefixed_Name(quantitykind, "/EnergyContent") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EnergyDensity</para>
    ...
    let ``_/EnergyDensity`` =
        Prefixed_Name(quantitykind, "/EnergyDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Inductance</para>
    ...
    let ``_/MutualInductance`` =
        Prefixed_Name(quantitykind, "/MutualInductance") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>Inductance based time constant</para></remarks>
    ...
    let ``_/InductanceBasedTimeConstant`` =
        Prefixed_Name(quantitykind, "/InductanceBasedTimeConstant") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>information content</para></remarks>
    ...
    let ``_/InformationContent`` =
        Prefixed_Name(quantitykind, "/InformationContent") |> PrefixedName
    ...
    let ``_/InformationContentExpressedAsALogarithmToBase10`` =
        Prefixed_Name(quantitykind, "/InformationContentExpressedAsALogarithmToBase10") |> PrefixedName
    ...
    let ``_/InformationContentExpressedAsALogarithmToBase2`` =
        Prefixed_Name(quantitykind, "/InformationContentExpressedAsALogarithmToBase2") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InformationEntropy</para>
    ...
    let ``_/InformationEntropy`` =
        Prefixed_Name(quantitykind, "/InformationEntropy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ExpansionRatio</para>
    ...
    let ``_/InitialExpansionRatio`` =
        Prefixed_Name(quantitykind, "/InitialExpansionRatio") |> PrefixedName
    ...
    let ``_/InitialNozzleThroatDiameter`` =
        Prefixed_Name(quantitykind, "/InitialNozzleThroatDiameter") |> PrefixedName
    ...
    let ``_/NozzleThroatDiameter`` =
        Prefixed_Name(quantitykind, "/NozzleThroatDiameter") |> PrefixedName
    ...
    let ``_/InitialVehicleMass`` =
        Prefixed_Name(quantitykind, "/InitialVehicleMass") |> PrefixedName
    ...
    let ``_/InitialVelocity`` =
        Prefixed_Name(quantitykind, "/InitialVelocity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InternalConversionFactor</para>
    ...
    let ``_/InternalConversionFactor`` =
        Prefixed_Name(quantitykind, "/InternalConversionFactor") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Dimensionless</para>
    /// labels<para>loudness level</para><para>loudness level</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/LoudnessLevel">http://qudt.org/vocab/quantitykind/LoudnessLevel</seealso>
    let ``_/LoudnessLevel`` =
        Prefixed_Name(quantitykind, "/LoudnessLevel") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticFluxDensity</para>
    ...
    let ``_/LowerCriticalMagneticFluxDensity`` =
        Prefixed_Name(quantitykind, "/LowerCriticalMagneticFluxDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LuminousEfficacy</para>
    ...
    let ``_/LuminousEfficacy`` =
        Prefixed_Name(quantitykind, "/LuminousEfficacy") |> PrefixedName
    ...
    let ``_/LuminousEmittance`` =
        Prefixed_Name(quantitykind, "/LuminousEmittance") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Energy</para>
    /// labels<para>energia promienista</para><para>énergie rayonnante</para><para>Strahlungsenergie</para><para>энергия излучения</para><para>energia radiante</para><para>energía radiante</para><para>energia radiante</para><para>energie záření</para><para>radiant energy</para><para>Tenaga sinaran</para><para>Işınım erkesi</para><para>विकिरण ऊर्जा</para><para>طاقة إشعاعية</para><para>انرژی تابشی</para><para>放射エネルギー</para><para>辐射能</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/RadiantEnergy">http://qudt.org/vocab/quantitykind/RadiantEnergy</seealso>
    let ``_/RadiantEnergy`` =
        Prefixed_Name(quantitykind, "/RadiantEnergy") |> PrefixedName
    ...
    let ``_/LuminousExitance`` =
        Prefixed_Name(quantitykind, "/LuminousExitance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LuminousExposure</para>
    ...
    let ``_/LuminousExposure`` =
        Prefixed_Name(quantitykind, "/LuminousExposure") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LuminousFluxRatio</para>
    ...
    let ``_/LuminousFluxRatio`` =
        Prefixed_Name(quantitykind, "/LuminousFluxRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LuminousIntensity</para>
    /// labels<para>Интензитет на светлината</para><para>Keamatan berluminositi</para><para>intensitate luminoasă</para><para>intensidade luminosa</para><para>intensidad luminosa</para><para>intensité lumineuse</para><para>Ένταση Φωτεινότητας</para><para>intensitas luminosa</para><para>intensità luminosa</para><para>luminous intensity</para><para>प्रकाशीय तीव्रता</para><para>ışık şiddeti</para><para>fényerősség</para><para>شدة الإضاءة</para><para>Lichtstärke</para><para>Сила света</para><para>svetilnost</para><para>עוצמת הארה</para><para>Svítivost</para><para>światłość</para><para>شدت نور</para><para>发光强度</para><para>光度</para></remarks>
    ...
    let ``_/LuminousIntensity`` =
        Prefixed_Name(quantitykind, "/LuminousIntensity") |> PrefixedName
    ...
    let ``_/MaximumOperatingPressure`` =
        Prefixed_Name(quantitykind, "/MaximumOperatingPressure") |> PrefixedName
    ...
    let ``_/MeanEnergyImparted`` =
        Prefixed_Name(quantitykind, "/MeanEnergyImparted") |> PrefixedName
    ...
    let ``_/MeanFreePath`` =
        Prefixed_Name(quantitykind, "/MeanFreePath") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Time</para>
    ...
    let ``_/MeanLifetime`` =
        Prefixed_Name(quantitykind, "/MeanLifetime") |> PrefixedName
    ...
    let ``_/MeanLinearRange`` =
        Prefixed_Name(quantitykind, "/MeanLinearRange") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MeanMassRange</para>
    ...
    let ``_/MeanMassRange`` =
        Prefixed_Name(quantitykind, "/MeanMassRange") |> PrefixedName
    ...
    let ``_/MechanicalEnergy`` =
        Prefixed_Name(quantitykind, "/MechanicalEnergy") |> PrefixedName
    ...
    let ``_/MechanicalImpedance`` =
        Prefixed_Name(quantitykind, "/MechanicalImpedance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MechanicalMobility</para>
    ...
    let ``_/MechanicalMobility`` =
        Prefixed_Name(quantitykind, "/MechanicalMobility") |> PrefixedName
    ...
    let ``_/MechanicalSurfaceImpedance`` =
        Prefixed_Name(quantitykind, "/MechanicalSurfaceImpedance") |> PrefixedName
    ...
    let ``_/MechanicalTension`` =
        Prefixed_Name(quantitykind, "/MechanicalTension") |> PrefixedName
    ...
    let ``_/MigrationArea`` =
        Prefixed_Name(quantitykind, "/MigrationArea") |> PrefixedName
    ...
    let ``_/MigrationLength`` =
        Prefixed_Name(quantitykind, "/MigrationLength") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MobilityRatio</para>
    ...
    let ``_/MobilityRatio`` =
        Prefixed_Name(quantitykind, "/MobilityRatio") |> PrefixedName
    ...
    let ``_/ModulusOfAdmittance`` =
        Prefixed_Name(quantitykind, "/ModulusOfAdmittance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ModulusOfElasticity</para>
    ...
    let ``_/ModulusOfElasticity`` =
        Prefixed_Name(quantitykind, "/ModulusOfElasticity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ModulusOfImpedance</para>
    ...
    let ``_/ModulusOfImpedance`` =
        Prefixed_Name(quantitykind, "/ModulusOfImpedance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ModulusOfLinearSubgradeReaction</para>
    ...
    let ``_/ModulusOfLinearSubgradeReaction`` =
        Prefixed_Name(quantitykind, "/ModulusOfLinearSubgradeReaction") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ModulusOfRotationalSubgradeReaction</para>
    ...
    let ``_/ModulusOfRotationalSubgradeReaction`` =
        Prefixed_Name(quantitykind, "/ModulusOfRotationalSubgradeReaction") |> PrefixedName
    ...
    let ``_/MoistureDiffusivity`` =
        Prefixed_Name(quantitykind, "/MoistureDiffusivity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PermeabilityRatio</para>
    ...
    let ``_/PermeabilityRatio`` =
        Prefixed_Name(quantitykind, "/PermeabilityRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Permeance</para>
    ...
    let ``_/Permeance`` = Prefixed_Name(quantitykind, "/Permeance") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/Reluctance</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Reluctance</para>
    ...
    let ``_/Reluctance`` = Prefixed_Name(quantitykind, "/Reluctance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Permittivity</para>
    ...
    let ``_/Permittivity`` =
        Prefixed_Name(quantitykind, "/Permittivity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PermittivityRatio</para>
    ...
    let ``_/PermittivityRatio`` =
        Prefixed_Name(quantitykind, "/PermittivityRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PhaseCoefficient</para>
    ...
    let ``_/PhaseCoefficient`` =
        Prefixed_Name(quantitykind, "/PhaseCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Angle</para>
    /// labels<para>Phasenverschiebungswinkel</para><para>différence de phase</para><para>sfasamento angolare</para><para>przesunięcie fazowe</para><para>diferencia de fase</para><para>diferença de fase</para><para>phase difference</para><para>اختلاف طور</para><para>位相差</para></remarks>
    ...
    let ``_/PhaseDifference`` =
        Prefixed_Name(quantitykind, "/PhaseDifference") |> PrefixedName
    ...
    let ``_/PhononMeanFreePath`` =
        Prefixed_Name(quantitykind, "/PhononMeanFreePath") |> PrefixedName
    ...
    let ``_/PhotoThresholdOfAwarenessFunction`` =
        Prefixed_Name(quantitykind, "/PhotoThresholdOfAwarenessFunction") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PhotonIntensity</para>
    ...
    let ``_/PhotonIntensity`` =
        Prefixed_Name(quantitykind, "/PhotonIntensity") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>photon luminance</para><para>photon luminance</para></remarks>
    ...
    let ``_/PhotonLuminance`` =
        Prefixed_Name(quantitykind, "/PhotonLuminance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PhotonRadiance</para>
    ...
    let ``_/PhotonRadiance`` =
        Prefixed_Name(quantitykind, "/PhotonRadiance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PhotosyntheticPhotonFlux</para>
    ...
    let ``_/PhotosyntheticPhotonFlux`` =
        Prefixed_Name(quantitykind, "/PhotosyntheticPhotonFlux") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PhotosyntheticPhotonFluxDensity</para>
    ...
    let ``_/PhotosyntheticPhotonFluxDensity`` =
        Prefixed_Name(quantitykind, "/PhotosyntheticPhotonFluxDensity") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>picture element</para><para>picture element</para></remarks>
    ...
    let ``_/PictureElement`` =
        Prefixed_Name(quantitykind, "/PictureElement") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Reactivity</para>
    ...
    let ``_/Reactivity`` = Prefixed_Name(quantitykind, "/Reactivity") |> PrefixedName
    ...
    let ``_/ReactorTimeConstant`` =
        Prefixed_Name(quantitykind, "/ReactorTimeConstant") |> PrefixedName
    ...
    let ``_/ReciprocalElectricResistance`` =
        Prefixed_Name(quantitykind, "/ReciprocalElectricResistance") |> PrefixedName
    ...
    let ``_/ReciprocalEnergy`` =
        Prefixed_Name(quantitykind, "/ReciprocalEnergy") |> PrefixedName
    ...
    let ``_/ReciprocalPlaneAngle`` =
        Prefixed_Name(quantitykind, "/ReciprocalPlaneAngle") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ReciprocalVoltage</para>
    ...
    let ``_/ReciprocalVoltage`` =
        Prefixed_Name(quantitykind, "/ReciprocalVoltage") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RecombinationCoefficient</para>
    ...
    let ``_/RecombinationCoefficient`` =
        Prefixed_Name(quantitykind, "/RecombinationCoefficient") |> PrefixedName
    ...
    let ``_/Reflectivity`` =
        Prefixed_Name(quantitykind, "/Reflectivity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RefractiveIndex</para>
    /// labels<para>Показатель преломления</para><para>Współczynnik załamania</para><para>índice de refracción</para><para>indice di rifrazione</para><para>indice de réfraction</para><para>Indice de refracție</para><para>índice refrativo</para><para>refractive index</para><para>kırılma indeksi</para><para>معامل الانكسار</para><para>Indeks biasan</para><para>Index lomu</para><para>अपवर्तनांक</para><para>ضریب شکست</para><para>Brechzahl</para><para>屈折率</para><para>折射率</para></remarks>
    ...
    let ``_/RefractiveIndex`` =
        Prefixed_Name(quantitykind, "/RefractiveIndex") |> PrefixedName
    ...
    let ``_/RelativeAtomicMass`` =
        Prefixed_Name(quantitykind, "/RelativeAtomicMass") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RelativePartialPressure</para>
    ...
    let ``_/RelativePartialPressure`` =
        Prefixed_Name(quantitykind, "/RelativePartialPressure") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RelativeMassConcentrationOfVapour</para>
    ...
    let ``_/RelativeMassConcentrationOfVapour`` =
        Prefixed_Name(quantitykind, "/RelativeMassConcentrationOfVapour") |> PrefixedName
    ...
    let ``_/RelativeMassDefect`` =
        Prefixed_Name(quantitykind, "/RelativeMassDefect") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RelativeMassDensity</para>
    ...
    let ``_/RelativeMassDensity`` =
        Prefixed_Name(quantitykind, "/RelativeMassDensity") |> PrefixedName
    ...
    let ``_/RelativeMolecularMass`` =
        Prefixed_Name(quantitykind, "/RelativeMolecularMass") |> PrefixedName
    ...
    let ``_/RelativePermittivity`` =
        Prefixed_Name(quantitykind, "/RelativePermittivity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RelativePressureCoefficient</para>
    ...
    let ``_/RelativePressureCoefficient`` =
        Prefixed_Name(quantitykind, "/RelativePressureCoefficient") |> PrefixedName
    ...
    let ``_/RelaxationTIme`` =
        Prefixed_Name(quantitykind, "/RelaxationTIme") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Repetency</para>
    /// labels<para>repetency</para><para>repetency</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Repetency">http://qudt.org/vocab/quantitykind/Repetency</seealso>
    let ``_/Repetency`` = Prefixed_Name(quantitykind, "/Repetency") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ResidualResistivity</para>
    ...
    let ``_/ResidualResistivity`` =
        Prefixed_Name(quantitykind, "/ResidualResistivity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ResistanceRatio</para>
    ...
    let ``_/ResistanceRatio`` =
        Prefixed_Name(quantitykind, "/ResistanceRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Resistivity</para>
    ...
    let ``_/Resistivity`` = Prefixed_Name(quantitykind, "/Resistivity") |> PrefixedName
    ...
    let ``_/ResonanceEnergy`` =
        Prefixed_Name(quantitykind, "/ResonanceEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ResonanceEscapeProbability</para>
    ...
    let ``_/ResonanceEscapeProbability`` =
        Prefixed_Name(quantitykind, "/ResonanceEscapeProbability") |> PrefixedName
    ...
    let ``_/ResonanceEscapeProbabilityForFission`` =
        Prefixed_Name(quantitykind, "/ResonanceEscapeProbabilityForFission") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RespiratoryRate</para>
    ...
    let ``_/RespiratoryRate`` =
        Prefixed_Name(quantitykind, "/RespiratoryRate") |> PrefixedName
    ...
    let ``_/RestEnergy`` = Prefixed_Name(quantitykind, "/RestEnergy") |> PrefixedName
    /// <summary>
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Mass</para>
    /// labels<para>инвариантная масса</para><para>massa de repouso</para><para>dinlenme kütlesi</para><para>Klidová hmotnost</para><para>निश्चर द्रव्यमान</para><para>masa spoczynkowa</para><para>masa invariantă</para><para>masa invariante</para><para>massa a riposo</para><para>masse au repos</para><para>Mirovna masa</para><para>Jisim rehat</para><para>كتلة ساكنة</para><para>Ruhemasse</para><para>rest mass</para><para>جرم سکون</para><para>静止质量</para><para>不変質量</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/RestMass">http://qudt.org/vocab/quantitykind/RestMass</seealso>
    let ``_/RestMass`` = Prefixed_Name(quantitykind, "/RestMass") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:StoichiometricNumber</para>
    ...
    let ``_/StoichiometricNumber`` =
        Prefixed_Name(quantitykind, "/StoichiometricNumber") |> PrefixedName
    ...
    let ``_/StrainEnergyDensity`` =
        Prefixed_Name(quantitykind, "/StrainEnergyDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:StrainEnergyReleaseRate</para>
    ...
    let ``_/StrainEnergyReleaseRate`` =
        Prefixed_Name(quantitykind, "/StrainEnergyReleaseRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:StressIntensityFactor</para>
    ...
    let ``_/StressIntensityFactor`` =
        Prefixed_Name(quantitykind, "/StressIntensityFactor") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:StressOpticCoefficient</para>
    ...
    let ``_/StressOpticCoefficient`` =
        Prefixed_Name(quantitykind, "/StressOpticCoefficient") |> PrefixedName
    ...
    let ``_/StructuralEfficiency`` =
        Prefixed_Name(quantitykind, "/StructuralEfficiency") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:StructureFactor</para>
    ...
    let ``_/StructureFactor`` =
        Prefixed_Name(quantitykind, "/StructureFactor") |> PrefixedName
    ...
    let ``_/DonorIonizationEnergy`` =
        Prefixed_Name(quantitykind, "/DonorIonizationEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Acidity</para>
    ...
    let ``_/Acidity`` = Prefixed_Name(quantitykind, "/Acidity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassPerAreaTime</para>
    ...
    let ``_/MassPerAreaTime`` =
        Prefixed_Name(quantitykind, "/MassPerAreaTime") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Action</para>
    ...
    let ``_/Action`` = Prefixed_Name(quantitykind, "/Action") |> PrefixedName
    /// <summary>
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Time</para>
    /// labels<para>Χρόνος</para><para>tempus</para><para>tiempo</para><para>Време</para><para>zaman</para><para>tempo</para><para>Время</para><para>temps</para><para>tempo</para><para>Zeit</para><para>Masa</para><para>czas</para><para>timp</para><para>time</para><para>زمان</para><para>زمن</para><para>זמן</para><para>čas</para><para>Čas</para><para>समय</para><para>idő</para><para>时间</para><para>時間</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Time">http://qudt.org/vocab/quantitykind/Time</seealso>
    let ``_/Time`` = Prefixed_Name(quantitykind, "/Time") |> PrefixedName
    ...
    let ``_/ActiveEnergy`` =
        Prefixed_Name(quantitykind, "/ActiveEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassPerArea</para>
    ...
    let ``_/MassPerArea`` = Prefixed_Name(quantitykind, "/MassPerArea") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AreaPerLength</para>
    /// labels<para>Fläche pro Längeneinheit</para><para>area per length</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/AreaPerLength">http://qudt.org/vocab/quantitykind/AreaPerLength</seealso>
    let ``_/AreaPerLength`` =
        Prefixed_Name(quantitykind, "/AreaPerLength") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AreaPerTime</para>
    ...
    let ``_/AreaPerTime`` = Prefixed_Name(quantitykind, "/AreaPerTime") |> PrefixedName
    ...
    let ``_/BucklingFactor`` =
        Prefixed_Name(quantitykind, "/BucklingFactor") |> PrefixedName
    ...
    let ``_/Dimensionless`` =
        Prefixed_Name(quantitykind, "/Dimensionless") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:BulkModulus</para>
    ...
    let ``_/BulkModulus`` = Prefixed_Name(quantitykind, "/BulkModulus") |> PrefixedName
    /// <summary>
    ...
    let ``_/BurnRate`` = Prefixed_Name(quantitykind, "/BurnRate") |> PrefixedName
    /// <summary>
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Velocity</para>
    /// labels<para>Geschwindigkeit</para><para>velocidade</para><para>سرعت/تندی</para><para>velocidad</para><para>Επιφάνεια</para><para>velocitas</para><para>Ско́рость</para><para>prędkość</para><para>velocità</para><para>Rychlost</para><para>velocity</para><para>hitrost</para><para>vitesse</para><para>السرعة</para><para>Halaju</para><para>viteză</para><para>מהירות</para><para>गति</para><para>hız</para><para>速力</para><para>速度</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Velocity">http://qudt.org/vocab/quantitykind/Velocity</seealso>
    let ``_/Velocity`` = Prefixed_Name(quantitykind, "/Velocity") |> PrefixedName
    /// <summary>
    ...
    let ``_/BurnTime`` = Prefixed_Name(quantitykind, "/BurnTime") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Count</para>
    ...
    let ``_/ByteDataVolume`` =
        Prefixed_Name(quantitykind, "/ByteDataVolume") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ByteRate</para>
    /// labels<para>byte rate</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/ByteRate">http://qudt.org/vocab/quantitykind/ByteRate</seealso>
    let ``_/ByteRate`` = Prefixed_Name(quantitykind, "/ByteRate") |> PrefixedName
    ...
    let ``_/ByteTransmissionRate`` =
        Prefixed_Name(quantitykind, "/ByteTransmissionRate") |> PrefixedName
    ...
    let ``_/CENTER_OF_GRAVITY_X`` =
        Prefixed_Name(quantitykind, "/CENTER-OF-GRAVITY_X") |> PrefixedName
    ...
    let ``_/CenterOfGravity_X`` =
        Prefixed_Name(quantitykind, "/CenterOfGravity_X") |> PrefixedName
    ...
    let ``_/CENTER_OF_GRAVITY_Y`` =
        Prefixed_Name(quantitykind, "/CENTER-OF-GRAVITY_Y") |> PrefixedName
    ...
    let ``_/CenterOfGravity_Y`` =
        Prefixed_Name(quantitykind, "/CenterOfGravity_Y") |> PrefixedName
    ...
    let ``_/CENTER_OF_GRAVITY_Z`` =
        Prefixed_Name(quantitykind, "/CENTER-OF-GRAVITY_Z") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CountRate</para>
    ...
    let ``_/CountRate`` = Prefixed_Name(quantitykind, "/CountRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CouplingFactor</para>
    /// labels<para>constante de acoplamiento</para><para>Константа взаимодействия</para><para>fattore di accoppiamento</para><para>constante de couplage</para><para>Constantă de cuplaj</para><para>Çiftlenim sabiti</para><para>stała sprzężenia</para><para>coupling factor</para><para>結合定数</para><para>耦合常數</para></remarks>
    ...
    let ``_/CouplingFactor`` =
        Prefixed_Name(quantitykind, "/CouplingFactor") |> PrefixedName
    ...
    let ``_/CrossSection`` =
        Prefixed_Name(quantitykind, "/CrossSection") |> PrefixedName
    ...
    let ``_/CrossSectionalArea`` =
        Prefixed_Name(quantitykind, "/CrossSectionalArea") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CubicElectricDipoleMomentPerSquareEnergy</para>
    ...
    let ``_/CubicElectricDipoleMomentPerSquareEnergy`` =
        Prefixed_Name(quantitykind, "/CubicElectricDipoleMomentPerSquareEnergy") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ExpansionRatio</para>
    /// labels<para>współczynnik rozszerzalności objętościowej</para><para>coefficiente di dilatazione volumica</para><para>coefficient de dilatation volumique</para><para>coeficiente de dilatação volúmica</para><para>coeficiente de dilatación cúbica</para><para>Volumenausdehnungskoeffizient</para><para>cubic expansion coefficient</para><para>Температурный коэффициент</para><para>kübik genleşme katsayısı</para><para>معامل التمدد الحجمى</para><para>ضریب انبساط گرمایی</para><para>Вълново число</para><para>Κυματαριθμός</para><para>Hullámszám</para><para>מספר גל</para><para>線膨張係数</para><para>体膨胀系数</para></remarks>
    ...
    let ``_/CubicExpansionCoefficient`` =
        Prefixed_Name(quantitykind, "/CubicExpansionCoefficient") |> PrefixedName
    ...
    let ``_/ExpansionRatio`` =
        Prefixed_Name(quantitykind, "/ExpansionRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Temperature</para>
    /// labels<para>température de Curie</para><para>temperatura de Curie</para><para>temperatura de Curie</para><para>Curie temperature</para><para>temperatura Curie</para><para>Curie-Temperatur</para><para>Curieova teplota</para><para>درجة حرارة كوري</para><para>Curie sıcaklığı</para><para>punto di Curie</para><para>Punct Curie</para><para>क्यूरी ताप</para><para>Точка Кюри</para><para>Suhu Curie</para><para>نقطه کوری</para><para>キュリー温度</para><para>居里点</para></remarks>
    ...
    let ``_/CurieTemperature`` =
        Prefixed_Name(quantitykind, "/CurieTemperature") |> PrefixedName
    ...
    let ``_/NeelTemperature`` =
        Prefixed_Name(quantitykind, "/NeelTemperature") |> PrefixedName
    ...
    let ``_/SuperconductionTransitionTemperature`` =
        Prefixed_Name(quantitykind, "/SuperconductionTransitionTemperature") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Currency</para>
    ...
    let ``_/Currency`` = Prefixed_Name(quantitykind, "/Currency") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CurrencyPerFlight</para>
    ...
    let ``_/CurrencyPerFlight`` =
        Prefixed_Name(quantitykind, "/CurrencyPerFlight") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CurrentLinkage</para>
    ...
    let ``_/CurrentLinkage`` =
        Prefixed_Name(quantitykind, "/CurrentLinkage") |> PrefixedName
    ...
    let ``_/CurrentOfTheAmountOfSubstance`` =
        Prefixed_Name(quantitykind, "/CurrentOfTheAmountOfSubstance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Curvature</para>
    ...
    let ``_/Curvature`` = Prefixed_Name(quantitykind, "/Curvature") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricChargeVolumeDensity</para>
    ...
    let ``_/ElectricChargeVolumeDensity`` =
        Prefixed_Name(quantitykind, "/ElectricChargeVolumeDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricConductivity</para>
    /// labels<para>رسانايى الکتريکى/هدایت الکتریکی</para><para>elektrische Leitfähigkeit</para><para>conductivité électrique</para><para>conductividad eléctrica</para><para>conducibilità elettrica</para><para>condutividade elétrica</para><para>electric conductivity</para><para>Kekonduksian elektrik</para><para>električna prevodnost</para><para>elektrik iletkenliği</para><para>电导率</para></remarks>
    ...
    let ``_/ElectricConductivity`` =
        Prefixed_Name(quantitykind, "/ElectricConductivity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InverseEnergy</para>
    ...
    let ``_/InverseEnergy`` =
        Prefixed_Name(quantitykind, "/InverseEnergy") |> PrefixedName
    ...
    let ``_/InverseEnergy_Squared`` =
        Prefixed_Name(quantitykind, "/InverseEnergy_Squared") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InverseSquareEnergy</para>
    /// labels<para>Inverse Square Energy</para></remarks>
    ...
    let ``_/InverseSquareEnergy`` =
        Prefixed_Name(quantitykind, "/InverseSquareEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InverseLengthTemperature</para>
    ...
    let ``_/InverseLengthTemperature`` =
        Prefixed_Name(quantitykind, "/InverseLengthTemperature") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InverseMagneticFlux</para>
    ...
    let ``_/InverseMagneticFlux`` =
        Prefixed_Name(quantitykind, "/InverseMagneticFlux") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InverseMass</para>
    /// labels<para>reciprocal mass</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/InverseMass">http://qudt.org/vocab/quantitykind/InverseMass</seealso>
    let ``_/InverseMass`` = Prefixed_Name(quantitykind, "/InverseMass") |> PrefixedName
    ...
    let ``_/InverseMass_Squared`` =
        Prefixed_Name(quantitykind, "/InverseMass_Squared") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InverseSquareMass</para>
    /// labels<para>Inverse Square Mass</para></remarks>
    ...
    let ``_/InverseSquareMass`` =
        Prefixed_Name(quantitykind, "/InverseSquareMass") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InversePermittivity</para>
    ...
    let ``_/InversePermittivity`` =
        Prefixed_Name(quantitykind, "/InversePermittivity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InversePressure</para>
    ...
    let ``_/InversePressure`` =
        Prefixed_Name(quantitykind, "/InversePressure") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:IsothermalCompressibility</para>
    /// labels<para>изотермический коэффициент сжимаемости</para><para>معامل الانضغاط عند ثبوت درجة الحرارة</para><para>compressibilidade isotérmica</para><para>compresibilidad isotérmica</para><para>isothermal compressibility</para><para>isotherme Kompressibilität</para><para>comprimibilità isotermica</para><para>compressibilité isotherme</para><para>Ketermampatan isotermik</para><para>ściśliwość izotermiczna</para><para>ضریب تراکم‌پذیری همدما</para><para>objemová stlačitelnost</para><para>Izotermna stisljivost</para><para>等温圧縮率</para><para>等温压缩率</para></remarks>
    ...
    let ``_/IsothermalCompressibility`` =
        Prefixed_Name(quantitykind, "/IsothermalCompressibility") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassPerLength</para>
    ...
    let ``_/MassPerLength`` =
        Prefixed_Name(quantitykind, "/MassPerLength") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassPerTime</para>
    ...
    let ``_/MassPerTime`` = Prefixed_Name(quantitykind, "/MassPerTime") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassRatioOfWaterToDryMatter</para>
    ...
    let ``_/MassRatioOfWaterToDryMatter`` =
        Prefixed_Name(quantitykind, "/MassRatioOfWaterToDryMatter") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassRatioOfWaterVapourToDryGas</para>
    ...
    let ``_/MassRatioOfWaterVapourToDryGas`` =
        Prefixed_Name(quantitykind, "/MassRatioOfWaterVapourToDryGas") |> PrefixedName
    ...
    let ``_/MassRelatedElectricalCurrent`` =
        Prefixed_Name(quantitykind, "/MassRelatedElectricalCurrent") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassSpecificBiogeochemicalRate</para>
    ...
    let ``_/MassSpecificBiogeochemicalRate`` =
        Prefixed_Name(quantitykind, "/MassSpecificBiogeochemicalRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassStoppingPower</para>
    /// labels<para>mass stopping power</para></remarks>
    ...
    let ``_/MassStoppingPower`` =
        Prefixed_Name(quantitykind, "/MassStoppingPower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassicElectricCurrent</para>
    /// labels<para>massic electric current</para></remarks>
    ...
    let ``_/MassicElectricCurrent`` =
        Prefixed_Name(quantitykind, "/MassicElectricCurrent") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassicHeatCapacity</para>
    /// labels<para>massic heat capacity</para><para>massic heat capacity</para></remarks>
    ...
    let ``_/MassicHeatCapacity`` =
        Prefixed_Name(quantitykind, "/MassicHeatCapacity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificPower</para>
    /// labels<para>massic power</para><para>massic power</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/MassicPower">http://qudt.org/vocab/quantitykind/MassicPower</seealso>
    let ``_/MassicPower`` = Prefixed_Name(quantitykind, "/MassicPower") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>massic torque</para><para>massic torque</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/MassicTorque">http://qudt.org/vocab/quantitykind/MassicTorque</seealso>
    let ``_/MassicTorque`` =
        Prefixed_Name(quantitykind, "/MassicTorque") |> PrefixedName
    ...
    let ``_/MassieuFunction`` =
        Prefixed_Name(quantitykind, "/MassieuFunction") |> PrefixedName
    ...
    let ``_/PlanckFunction`` =
        Prefixed_Name(quantitykind, "/PlanckFunction") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificEnergy</para>
    ...
    let ``_/SpecificEnthalpy`` =
        Prefixed_Name(quantitykind, "/SpecificEnthalpy") |> PrefixedName
    ...
    let ``_/SpecificGibbsEnergy`` =
        Prefixed_Name(quantitykind, "/SpecificGibbsEnergy") |> PrefixedName
    ...
    let ``_/SpecificHelmholtzEnergy`` =
        Prefixed_Name(quantitykind, "/SpecificHelmholtzEnergy") |> PrefixedName
    ...
    let ``_/SpecificInternalEnergy`` =
        Prefixed_Name(quantitykind, "/SpecificInternalEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Force</para>
    ...
    let ``_/MaxExpectedOperatingThrust`` =
        Prefixed_Name(quantitykind, "/MaxExpectedOperatingThrust") |> PrefixedName
    ...
    let ``_/MaxOperatingThrust`` =
        Prefixed_Name(quantitykind, "/MaxOperatingThrust") |> PrefixedName
    ...
    let ``_/Thrust`` = Prefixed_Name(quantitykind, "/Thrust") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Max Sea Level thrust (Mlbf) </para>
    ///   <para>Applicable units are those of quantitykind:Force</para>
    ...
    let ``_/MaxSeaLevelThrust`` =
        Prefixed_Name(quantitykind, "/MaxSeaLevelThrust") |> PrefixedName
    ...
    let ``_/MaximumBeta_ParticleEnergy`` =
        Prefixed_Name(quantitykind, "/MaximumBeta-ParticleEnergy") |> PrefixedName
    ...
    let ``_/MaximumExpectedOperatingPressure`` =
        Prefixed_Name(quantitykind, "/MaximumExpectedOperatingPressure") |> PrefixedName
    ...
    let ``_/ProductOfInertia_Y`` =
        Prefixed_Name(quantitykind, "/ProductOfInertia_Y") |> PrefixedName
    ...
    let ``_/PRODUCT_OF_INERTIA_Z`` =
        Prefixed_Name(quantitykind, "/PRODUCT-OF-INERTIA_Z") |> PrefixedName
    ...
    let ``_/ProductOfInertia_Z`` =
        Prefixed_Name(quantitykind, "/ProductOfInertia_Z") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Pace</para>
    ...
    let ``_/Pace`` = Prefixed_Name(quantitykind, "/Pace") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PackingFraction</para>
    ...
    let ``_/PackingFraction`` =
        Prefixed_Name(quantitykind, "/PackingFraction") |> PrefixedName
    ...
    let ``_/PartialPressure`` =
        Prefixed_Name(quantitykind, "/PartialPressure") |> PrefixedName
    ...
    let ``_/ParticleCurrent`` =
        Prefixed_Name(quantitykind, "/ParticleCurrent") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>particle current density</para><para>particle current density</para></remarks>
    ...
    let ``_/ParticleCurrentDensity`` =
        Prefixed_Name(quantitykind, "/ParticleCurrentDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ParticleFluence</para>
    ...
    let ``_/ParticleFluence`` =
        Prefixed_Name(quantitykind, "/ParticleFluence") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ParticleFluenceRate</para>
    ...
    let ``_/ParticleFluenceRate`` =
        Prefixed_Name(quantitykind, "/ParticleFluenceRate") |> PrefixedName
    ...
    let ``_/SpecificEnergyImparted`` =
        Prefixed_Name(quantitykind, "/SpecificEnergyImparted") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificEntropy</para>
    ...
    let ``_/SpecificEntropy`` =
        Prefixed_Name(quantitykind, "/SpecificEntropy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificHeatCapacityAtConstantPressure</para>
    ...
    let ``_/SpecificHeatCapacityAtConstantPressure`` =
        Prefixed_Name(quantitykind, "/SpecificHeatCapacityAtConstantPressure") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificHeatCapacityAtConstantVolume</para>
    ...
    let ``_/SpecificHeatCapacityAtConstantVolume`` =
        Prefixed_Name(quantitykind, "/SpecificHeatCapacityAtConstantVolume") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificHeatCapacityAtSaturation</para>
    ...
    let ``_/SpecificHeatCapacityAtSaturation`` =
        Prefixed_Name(quantitykind, "/SpecificHeatCapacityAtSaturation") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificHeatPressure</para>
    ...
    let ``_/SpecificHeatPressure`` =
        Prefixed_Name(quantitykind, "/SpecificHeatPressure") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificHeatVolume</para>
    ...
    let ``_/SpecificHeatVolume`` =
        Prefixed_Name(quantitykind, "/SpecificHeatVolume") |> PrefixedName
    ...
    let ``_/SpecificImpulseByMass`` =
        Prefixed_Name(quantitykind, "/SpecificImpulseByMass") |> PrefixedName
    ...
    let ``_/SpecificImpulseByWeight`` =
        Prefixed_Name(quantitykind, "/SpecificImpulseByWeight") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificModulus</para>
    ...
    let ``_/SpecificModulus`` =
        Prefixed_Name(quantitykind, "/SpecificModulus") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>specific optical rotational ability</para><para>specific optical rotational ability</para></remarks>
    ...
    let ``_/SpecificOpticalRotationalAbility`` =
        Prefixed_Name(quantitykind, "/SpecificOpticalRotationalAbility") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificOpticalRotatoryPower</para>
    ...
    let ``_/SpecificOpticalRotatoryPower`` =
        Prefixed_Name(quantitykind, "/SpecificOpticalRotatoryPower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificSurfaceArea</para>
    ...
    let ``_/SpecificSurfaceArea`` =
        Prefixed_Name(quantitykind, "/SpecificSurfaceArea") |> PrefixedName
    ...
    let ``_/SpecificThrust`` =
        Prefixed_Name(quantitykind, "/SpecificThrust") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpectralAngularCrossSection</para>
    ...
    let ``_/SpectralAngularCrossSection`` =
        Prefixed_Name(quantitykind, "/SpectralAngularCrossSection") |> PrefixedName
    ...
    let ``_/SpectralConcentrationOfRadiantEnergyDensity`` =
        Prefixed_Name(quantitykind, "/SpectralConcentrationOfRadiantEnergyDensity") |> PrefixedName
    ...
    let ``_/SpectralConcentrationOfVibrationalModes`` =
        Prefixed_Name(quantitykind, "/SpectralConcentrationOfVibrationalModes") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpectralDensityOfVibrationalModes</para>
    /// labels<para>spectral density of vibrational modes</para></remarks>
    ...
    let ``_/SpectralDensityOfVibrationalModes`` =
        Prefixed_Name(quantitykind, "/SpectralDensityOfVibrationalModes") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>Measurement Unit of Spectral Emittance</para></remarks>
    ...
    let ``_/SpectralEmittance`` =
        Prefixed_Name(quantitykind, "/SpectralEmittance") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>Measurement Unit of Spectral Irradiance</para></remarks>
    ...
    let ``_/SpectralIrradiance`` =
        Prefixed_Name(quantitykind, "/SpectralIrradiance") |> PrefixedName
    ...
    let ``_/SpectralLuminousEfficiency`` =
        Prefixed_Name(quantitykind, "/SpectralLuminousEfficiency") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpectralRadiance</para>
    /// labels<para>Measurement Unit of Spectral Radiance</para></remarks>
    ...
    let ``_/SpectralRadiance`` =
        Prefixed_Name(quantitykind, "/SpectralRadiance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpectralRadiantEnergyDensity</para>
    ...
    let ``_/SpectralRadiantEnergyDensity`` =
        Prefixed_Name(quantitykind, "/SpectralRadiantEnergyDensity") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>torque constant</para><para>torque constant</para></remarks>
    ...
    let ``_/TorqueConstant`` =
        Prefixed_Name(quantitykind, "/TorqueConstant") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TorquePerLength</para>
    ...
    let ``_/TorquePerLength`` =
        Prefixed_Name(quantitykind, "/TorquePerLength") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>torsional rigidity</para></remarks>
    ...
    let ``_/TorsionalRigidity`` =
        Prefixed_Name(quantitykind, "/TorsionalRigidity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TorsionalSpringConstant</para>
    ...
    let ``_/TorsionalSpringConstant`` =
        Prefixed_Name(quantitykind, "/TorsionalSpringConstant") |> PrefixedName
    ...
    let ``_/TotalAngularMomentum`` =
        Prefixed_Name(quantitykind, "/TotalAngularMomentum") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TotalAngularMomentumQuantumNumber</para>
    ...
    let ``_/TotalAngularMomentumQuantumNumber`` =
        Prefixed_Name(quantitykind, "/TotalAngularMomentumQuantumNumber") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TotalAtomicStoppingPower</para>
    ...
    let ``_/TotalAtomicStoppingPower`` =
        Prefixed_Name(quantitykind, "/TotalAtomicStoppingPower") |> PrefixedName
    ...
    let ``_/WorkFunction`` =
        Prefixed_Name(quantitykind, "/WorkFunction") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Area</para>
    /// labels<para>pole powierzchni</para><para>क्षेत्रफल</para><para>Ταχύτητα</para><para>površina</para><para>Keluasan</para><para>Площадь</para><para>Fläche</para><para>plocha</para><para>مساحت</para><para>مساحة</para><para>area</para><para>aire</para><para>área</para><para>area</para><para>Площ</para><para>alan</para><para>arie</para><para>área</para><para>שטח</para><para>面積</para><para>面积</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Area">http://qudt.org/vocab/quantitykind/Area</seealso>
    let ``_/Area`` = Prefixed_Name(quantitykind, "/Area") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/AreaAngle</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AreaAngle</para>
    ...
    let ``_/AreaAngle`` = Prefixed_Name(quantitykind, "/AreaAngle") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AreaBitDensity</para>
    /// labels<para>areic bit density</para></remarks>
    ...
    let ``_/AreaBitDensity`` =
        Prefixed_Name(quantitykind, "/AreaBitDensity") |> PrefixedName
    ...
    let ``_/ElectricChargePerArea`` =
        Prefixed_Name(quantitykind, "/ElectricChargePerArea") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AreaPerPower</para>
    ...
    let ``_/AreaPerPower`` =
        Prefixed_Name(quantitykind, "/AreaPerPower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AreaRatio</para>
    ...
    let ``_/AreaRatio`` = Prefixed_Name(quantitykind, "/AreaRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AreaTemperature</para>
    ...
    let ``_/AreaTemperature`` =
        Prefixed_Name(quantitykind, "/AreaTemperature") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AreaTime</para>
    ...
    let ``_/AreaTime`` = Prefixed_Name(quantitykind, "/AreaTime") |> PrefixedName
    ...
    let ``_/AreicChargeDensityOrElectricFluxDensityOrElectricPolarization`` =
        Prefixed_Name(quantitykind, "/AreicChargeDensityOrElectricFluxDensityOrElectricPolarization") |> PrefixedName
    ...
    let ``_/PowerPerArea`` =
        Prefixed_Name(quantitykind, "/PowerPerArea") |> PrefixedName
    ...
    let ``_/AreicHeatFlowRate`` =
        Prefixed_Name(quantitykind, "/AreicHeatFlowRate") |> PrefixedName
    ...
    let ``_/AreicMass`` = Prefixed_Name(quantitykind, "/AreicMass") |> PrefixedName
    /// <summary>
    ...
    let ``_/AreicTorque`` = Prefixed_Name(quantitykind, "/AreicTorque") |> PrefixedName
    /// <summary>
    ...
    let ``_/Asset`` = Prefixed_Name(quantitykind, "/Asset") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AtmosphericHydroxylationRate</para>
    ...
    let ``_/AtmosphericHydroxylationRate`` =
        Prefixed_Name(quantitykind, "/AtmosphericHydroxylationRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SecondOrderReactionRateConstant</para>
    ...
    let ``_/SecondOrderReactionRateConstant`` =
        Prefixed_Name(quantitykind, "/SecondOrderReactionRateConstant") |> PrefixedName
    ...
    let ``_/AtmosphericPressure`` =
        Prefixed_Name(quantitykind, "/AtmosphericPressure") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AtomScatteringFactor</para>
    ...
    let ``_/AtomScatteringFactor`` =
        Prefixed_Name(quantitykind, "/AtomScatteringFactor") |> PrefixedName
    ...
    let ``_/AtomicAttenuationCoefficient`` =
        Prefixed_Name(quantitykind, "/AtomicAttenuationCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricCharge</para>
    ...
    let ``_/AtomicCharge`` =
        Prefixed_Name(quantitykind, "/AtomicCharge") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricCharge</para>
    /// labels<para>विद्युत आवेग या विद्युत बहाव</para><para>Электрический заряд</para><para>ładunek elektryczny</para><para>elektrische Ladung</para><para>Електрически заряд</para><para>Charge électrique</para><para>sarcină electrică</para><para>الشحنة الكهربائية</para><para>elektromos töltés</para><para>carica elettrica</para><para>Elektrický náboj</para><para>električni naboj</para><para>Ηλεκτρικό φορτίο</para><para>onus electricum</para><para>electric charge</para><para>carga eléctrica</para><para>carga elétrica</para><para>elektrik yükü</para><para>Cas elektrik</para><para>بار الکتریکی</para><para>מטען חשמלי</para><para>电荷</para><para>電荷</para></remarks>
    ...
    let ``_/ElectricCharge`` =
        Prefixed_Name(quantitykind, "/ElectricCharge") |> PrefixedName
    ...
    let ``_/AtomicEnergy`` =
        Prefixed_Name(quantitykind, "/AtomicEnergy") |> PrefixedName
    ...
    let ``_/AtomicMass`` = Prefixed_Name(quantitykind, "/AtomicMass") |> PrefixedName
    /// <summary>
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Mass</para>
    /// labels<para>Hmotnost</para><para>massa</para><para>kütle</para><para>massa</para><para>masse</para><para>Jisim</para><para>Masse</para><para>Масса</para><para>tömeg</para><para>massa</para><para>mass</para><para>كتلة</para><para>masa</para><para>masa</para><para>Маса</para><para>masa</para><para>Μάζα</para><para>masă</para><para>भार</para><para>מסה</para><para>جرم</para><para>質量</para><para>质量</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Mass">http://qudt.org/vocab/quantitykind/Mass</seealso>
    let ``_/Mass`` = Prefixed_Name(quantitykind, "/Mass") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AtomicNumber</para>
    ...
    let ``_/AtomicNumber`` =
        Prefixed_Name(quantitykind, "/AtomicNumber") |> PrefixedName
    ...
    let ``_/Count`` = Prefixed_Name(quantitykind, "/Count") |> PrefixedName
    ...
    let ``_/AtomicStoppingPower`` =
        Prefixed_Name(quantitykind, "/AtomicStoppingPower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AttenuationCoefficient</para>
    ...
    let ``_/AttenuationCoefficient`` =
        Prefixed_Name(quantitykind, "/AttenuationCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SoundPowerLevel</para>
    ...
    let ``_/AuditoryThresholds`` =
        Prefixed_Name(quantitykind, "/AuditoryThresholds") |> PrefixedName
    ...
    let ``_/SoundPowerLevel`` =
        Prefixed_Name(quantitykind, "/SoundPowerLevel") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticFieldStrength</para>
    ...
    let ``_/AuxillaryMagneticField`` =
        Prefixed_Name(quantitykind, "/AuxillaryMagneticField") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticFieldStrength</para>
    /// labels<para>intensidade de campo magnético</para><para>intensidad de campo magnético</para><para>intensité de champ magnétique</para><para>intensità di campo magnetico</para><para>Kekuatan medan magnetik</para><para>magnetic field strength</para><para>jakost magnetnega polja</para><para>magnetische Feldstärke</para><para>شدت میدان مغناطیسی</para><para>pole magnetyczne</para><para>Magnetické pole</para><para>Магнитное поле</para><para>Manyetik alan</para><para>Câmp magnetic</para><para>حقل مغناطيسي</para><para>磁場</para><para>磁場</para></remarks>
    ...
    let ``_/MagneticFieldStrength`` =
        Prefixed_Name(quantitykind, "/MagneticFieldStrength") |> PrefixedName
    ...
    let ``_/AverageEnergyLossPerElementaryChargeProduced`` =
        Prefixed_Name(quantitykind, "/AverageEnergyLossPerElementaryChargeProduced") |> PrefixedName
    ...
    let ``_/AverageHeadEndPressure`` =
        Prefixed_Name(quantitykind, "/AverageHeadEndPressure") |> PrefixedName
    ...
    let ``_/HeadEndPressure`` =
        Prefixed_Name(quantitykind, "/HeadEndPressure") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AverageLogarithmicEnergyDecrement</para>
    ...
    let ``_/AverageLogarithmicEnergyDecrement`` =
        Prefixed_Name(quantitykind, "/AverageLogarithmicEnergyDecrement") |> PrefixedName
    ...
    let ``_/SpecificImpulse`` =
        Prefixed_Name(quantitykind, "/SpecificImpulse") |> PrefixedName
    ...
    let ``_/AverageVacuumThrust`` =
        Prefixed_Name(quantitykind, "/AverageVacuumThrust") |> PrefixedName
    ...
    let ``_/VacuumThrust`` =
        Prefixed_Name(quantitykind, "/VacuumThrust") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>bandwidth distance product</para></remarks>
    ...
    let ``_/BandwidthDistanceProduct`` =
        Prefixed_Name(quantitykind, "/BandwidthDistanceProduct") |> PrefixedName
    ...
    let ``_/BandwidthLengthProduct`` =
        Prefixed_Name(quantitykind, "/BandwidthLengthProduct") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:BatteryCapacity</para>
    /// labels<para>battery capacity</para><para>battery capacity</para></remarks>
    ...
    let ``_/BatteryCapacity`` =
        Prefixed_Name(quantitykind, "/BatteryCapacity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Torque</para>
    ...
    let ``_/BendingMomentOfForce`` =
        Prefixed_Name(quantitykind, "/BendingMomentOfForce") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Torque</para>
    /// labels<para>momento de torção</para><para>moment obrotowy</para><para>Torsionmoment</para><para>عزم محورى</para><para>torque</para><para>coppia</para><para>couple</para><para>トルク</para><para>par</para><para>转矩</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Torque">http://qudt.org/vocab/quantitykind/Torque</seealso>
    let ``_/Torque`` = Prefixed_Name(quantitykind, "/Torque") |> PrefixedName
    ...
    let ``_/BetaDisintegrationEnergy`` =
        Prefixed_Name(quantitykind, "/BetaDisintegrationEnergy") |> PrefixedName
    ...
    let ``_/BevelGearPitchAngle`` =
        Prefixed_Name(quantitykind, "/BevelGearPitchAngle") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:BioconcentrationFactor</para>
    ...
    let ``_/BioconcentrationFactor`` =
        Prefixed_Name(quantitykind, "/BioconcentrationFactor") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:BiodegredationHalfLife</para>
    ...
    let ``_/BiodegredationHalfLife`` =
        Prefixed_Name(quantitykind, "/BiodegredationHalfLife") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:BiogeochemicalRate</para>
    ...
    let ``_/BiogeochemicalRate`` =
        Prefixed_Name(quantitykind, "/BiogeochemicalRate") |> PrefixedName
    ...
    let ``_/BitDataVolume`` =
        Prefixed_Name(quantitykind, "/BitDataVolume") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:BitRate</para>
    ...
    let ``_/BitTransmissionRate`` =
        Prefixed_Name(quantitykind, "/BitTransmissionRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:BloodGlucoseLevel</para>
    ...
    let ``_/BloodGlucoseLevel`` =
        Prefixed_Name(quantitykind, "/BloodGlucoseLevel") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassBasedBloodGlucoseLevel</para>
    ...
    let ``_/MassBasedBloodGlucoseLevel`` =
        Prefixed_Name(quantitykind, "/MassBasedBloodGlucoseLevel") |> PrefixedName
    ...
    let ``_/BloodGlucoseLevel_Mass`` =
        Prefixed_Name(quantitykind, "/BloodGlucoseLevel_Mass") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:BodyMassIndex</para>
    ...
    let ``_/BodyMassIndex`` =
        Prefixed_Name(quantitykind, "/BodyMassIndex") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:BoilingPoint</para>
    ...
    let ``_/BoilingPoint`` =
        Prefixed_Name(quantitykind, "/BoilingPoint") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CoefficientOfHeatTransfer</para>
    ...
    let ``_/CoefficientOfHeatTransfer`` =
        Prefixed_Name(quantitykind, "/CoefficientOfHeatTransfer") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CoefficientOfPerformance</para>
    ...
    let ``_/CoefficientOfPerformance`` =
        Prefixed_Name(quantitykind, "/CoefficientOfPerformance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Coercivity</para>
    ...
    let ``_/Coercivity`` = Prefixed_Name(quantitykind, "/Coercivity") |> PrefixedName
    ...
    let ``_/CoherenceLength`` =
        Prefixed_Name(quantitykind, "/CoherenceLength") |> PrefixedName
    ...
    let ``_/ColdReceptorThreshold`` =
        Prefixed_Name(quantitykind, "/ColdReceptorThreshold") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CombinedNonEvaporativeHeatTransferCoefficient</para>
    ...
    let ``_/CombinedNonEvaporativeHeatTransferCoefficient`` =
        Prefixed_Name(quantitykind, "/CombinedNonEvaporativeHeatTransferCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermodynamicTemperature</para>
    ...
    let ``_/CombustionChamberTemperature`` =
        Prefixed_Name(quantitykind, "/CombustionChamberTemperature") |> PrefixedName
    ...
    let ``_/CommonLogarithmicMedianInformationFlow`` =
        Prefixed_Name(quantitykind, "/CommonLogarithmicMedianInformationFlow") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DecayConstant</para>
    ...
    let ``_/DecayConstant`` =
        Prefixed_Name(quantitykind, "/DecayConstant") |> PrefixedName
    ...
    let ``_/InverseTime`` = Prefixed_Name(quantitykind, "/InverseTime") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DegreeOfDissociation</para>
    ...
    let ``_/DegreeOfDissociation`` =
        Prefixed_Name(quantitykind, "/DegreeOfDissociation") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassDensity</para>
    /// labels<para>Ketumpatan jisim</para><para>Massendichte</para><para>mass density</para><para>плотность</para><para>densidade</para><para>densitate</para><para>densidad</para><para>yoğunluk</para><para>الكثافة</para><para>densité</para><para>gęstość</para><para>Gostôta</para><para>hustota</para><para>densità</para><para>چگالی</para><para>घनत्व</para><para>密度</para><para>密度</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/MassDensity">http://qudt.org/vocab/quantitykind/MassDensity</seealso>
    let ``_/MassDensity`` = Prefixed_Name(quantitykind, "/MassDensity") |> PrefixedName
    ...
    let ``_/DensityInCombustionChamber`` =
        Prefixed_Name(quantitykind, "/DensityInCombustionChamber") |> PrefixedName
    ...
    let ``_/DensityOfStates`` =
        Prefixed_Name(quantitykind, "/DensityOfStates") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VibrationalDensityOfStates</para>
    ...
    let ``_/VibrationalDensityOfStates`` =
        Prefixed_Name(quantitykind, "/VibrationalDensityOfStates") |> PrefixedName
    ...
    let ``_/DensityOfTheExhaustGases`` =
        Prefixed_Name(quantitykind, "/DensityOfTheExhaustGases") |> PrefixedName
    ...
    let ``_/Depth`` = Prefixed_Name(quantitykind, "/Depth") |> PrefixedName
    ...
    let ``_/DewPointTemperature`` =
        Prefixed_Name(quantitykind, "/DewPointTemperature") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Length</para>
    /// labels<para>Durchmesser</para><para>diâmetro</para><para>średnica</para><para>diametro</para><para>diámetro</para><para>diamètre</para><para>diameter</para><para>диаметр</para><para>premer</para><para>průměr</para><para>çap</para><para>قطر</para><para>قطر</para><para>直径</para><para>直径</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Diameter">http://qudt.org/vocab/quantitykind/Diameter</seealso>
    let ``_/Diameter`` = Prefixed_Name(quantitykind, "/Diameter") |> PrefixedName
    ...
    let ``_/DiastolicBloodPressure`` =
        Prefixed_Name(quantitykind, "/DiastolicBloodPressure") |> PrefixedName
    ...
    let ``_/SystolicBloodPressure`` =
        Prefixed_Name(quantitykind, "/SystolicBloodPressure") |> PrefixedName
    ...
    let ``_/DiffusionArea`` =
        Prefixed_Name(quantitykind, "/DiffusionArea") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DiffusionCoefficient</para>
    /// labels<para>coefficiente di diffusione</para><para>coefficient de diffusion</para><para>coeficiente de difusión</para><para>coeficiente de difusão</para><para>difuzijski koeficient</para><para>Diffusionskoeffizient</para><para>diffusion coefficient</para></remarks>
    ...
    let ``_/DiffusionCoefficient`` =
        Prefixed_Name(quantitykind, "/DiffusionCoefficient") |> PrefixedName
    ...
    let ``_/DiffusionCoefficientForFluenceRate`` =
        Prefixed_Name(quantitykind, "/DiffusionCoefficientForFluenceRate") |> PrefixedName
    ...
    let ``_/DiffusionLength`` =
        Prefixed_Name(quantitykind, "/DiffusionLength") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DigitRate</para>
    /// labels<para>digit rate</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/DigitRate">http://qudt.org/vocab/quantitykind/DigitRate</seealso>
    let ``_/DigitRate`` = Prefixed_Name(quantitykind, "/DigitRate") |> PrefixedName
    ...
    let ``_/Displacement`` =
        Prefixed_Name(quantitykind, "/Displacement") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DisplacementCurrent</para>
    ...
    let ``_/DisplacementCurrent`` =
        Prefixed_Name(quantitykind, "/DisplacementCurrent") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricChargePerArea</para>
    /// labels<para>campo de deslocamento elétrico</para><para>Densidad de flujo eléctrico</para><para>Ketumpatan fluks elektrik</para><para>elektrische Flussdichte</para><para>elektrik akı yoğunluğu</para><para>Электрическая индукция</para><para>spostamento elettrico</para><para>electric flux density</para><para>Induction électrique</para><para>Indukcja elektryczna</para><para>چگالی شار الکتریکی</para><para>Elektrická indukce</para><para>Inducție electrică</para><para>إزاحة كهربائية</para><para>電束密度</para><para>電位移</para></remarks>
    ...
    let ``_/ElectricFluxDensity`` =
        Prefixed_Name(quantitykind, "/ElectricFluxDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DisplacementCurrentDensity</para>
    ...
    let ``_/DisplacementCurrentDensity`` =
        Prefixed_Name(quantitykind, "/DisplacementCurrentDensity") |> PrefixedName
    ...
    let ``_/DisplacementVectorOfIon`` =
        Prefixed_Name(quantitykind, "/DisplacementVectorOfIon") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Dissipance</para>
    ...
    let ``_/Dissipance`` = Prefixed_Name(quantitykind, "/Dissipance") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/Distance</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Distance</para>
    /// labels<para>Entfernung</para><para>Vzdálenost</para><para>distancia</para><para>distância</para><para>distance</para><para>distance</para><para>distanza</para><para>uzaklık</para><para>مسافت</para><para>Jarak</para><para>距离</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Distance">http://qudt.org/vocab/quantitykind/Distance</seealso>
    let ``_/Distance`` = Prefixed_Name(quantitykind, "/Distance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DoseEquivalent</para>
    ...
    let ``_/DoseEquivalent`` =
        Prefixed_Name(quantitykind, "/DoseEquivalent") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DoseEquivalentQualityFactor</para>
    ...
    let ``_/DoseEquivalentQualityFactor`` =
        Prefixed_Name(quantitykind, "/DoseEquivalentQualityFactor") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>dose equivalent rate</para></remarks>
    ...
    let ``_/DoseEquivalentRate`` =
        Prefixed_Name(quantitykind, "/DoseEquivalentRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DotsPerInch</para>
    /// labels<para>dots per inch</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/DotsPerInch">http://qudt.org/vocab/quantitykind/DotsPerInch</seealso>
    let ``_/DotsPerInch`` = Prefixed_Name(quantitykind, "/DotsPerInch") |> PrefixedName
    ...
    let ``_/DragCoefficient`` =
        Prefixed_Name(quantitykind, "/DragCoefficient") |> PrefixedName
    ...
    let ``_/DragForce`` = Prefixed_Name(quantitykind, "/DragForce") |> PrefixedName
    /// <summary>
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Force</para>
    /// labels<para>وحدة القوة في نظام متر كيلوغرام ثانية</para><para>kuvvet</para><para>fuerza</para><para>Δύναμη</para><para>forza</para><para>força</para><para>force</para><para>Kraft</para><para>forță</para><para>force</para><para>Síla</para><para>نیرو</para><para>сила</para><para>siła</para><para>Сила</para><para>sila</para><para>Daya</para><para>vis</para><para>כוח</para><para>erő</para><para>बल</para><para>力</para><para>力</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Force">http://qudt.org/vocab/quantitykind/Force</seealso>
    let ``_/Force`` = Prefixed_Name(quantitykind, "/Force") |> PrefixedName
    ...
    let ``_/DryBulbTemperature`` =
        Prefixed_Name(quantitykind, "/DryBulbTemperature") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DryVolume</para>
    ...
    let ``_/DryVolume`` = Prefixed_Name(quantitykind, "/DryVolume") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricalConductance</para>
    /// labels<para>electrical conductance</para><para>electrical conductance</para></remarks>
    ...
    let ``_/ElectricalConductance`` =
        Prefixed_Name(quantitykind, "/ElectricalConductance") |> PrefixedName
    ...
    let ``_/ElectricalPowerToMassRatio`` =
        Prefixed_Name(quantitykind, "/ElectricalPowerToMassRatio") |> PrefixedName
    ...
    let ``_/SpecificPower`` =
        Prefixed_Name(quantitykind, "/SpecificPower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricalResistance</para>
    ...
    let ``_/ElectricalResistance`` =
        Prefixed_Name(quantitykind, "/ElectricalResistance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectrolyticConductivity</para>
    ...
    let ``_/ElectrolyticConductivity`` =
        Prefixed_Name(quantitykind, "/ElectrolyticConductivity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectromagneticEnergyDensity</para>
    ...
    let ``_/ElectromagneticEnergyDensity`` =
        Prefixed_Name(quantitykind, "/ElectromagneticEnergyDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VolumicElectromagneticEnergy</para>
    ...
    let ``_/VolumicElectromagneticEnergy`` =
        Prefixed_Name(quantitykind, "/VolumicElectromagneticEnergy") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticFluxDensity</para>
    /// labels<para>densidade de fluxo magnético</para><para>densità di flusso magnetico</para><para>Densidad de flujo magnético</para><para>Densité de flux magnétique</para><para>gostota magnetnega pretoka</para><para>densitas fluxus magnetici</para><para>Ketumpatan fluks magnet</para><para>magnetische Flussdichte</para><para>manyetik akı yoğunluğu</para><para>magnetic flux density</para><para>magnetic flux density</para><para>indukcja magnetyczna</para><para>Магнитная индукция</para><para>Magnetická indukce</para><para>چگالی شار مغناطیسی</para><para>inducție magnetică</para><para>المجال المغناطيسي</para><para>Магнитна индукция</para><para>mágneses indukció</para><para>चुम्बकीय क्षेत्र</para><para>צפיפות שטף מגנטי</para><para>磁通量密度</para><para>磁束密度</para></remarks>
    ...
    let ``_/MagneticFluxDensity`` =
        Prefixed_Name(quantitykind, "/MagneticFluxDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectromagneticPermeability</para>
    ...
    let ``_/ElectromagneticPermeability`` =
        Prefixed_Name(quantitykind, "/ElectromagneticPermeability") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Permeability</para>
    /// labels<para>Permeability</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Permeability">http://qudt.org/vocab/quantitykind/Permeability</seealso>
    let ``_/Permeability`` =
        Prefixed_Name(quantitykind, "/Permeability") |> PrefixedName
    ...
    let ``_/ElectronAffinity`` =
        Prefixed_Name(quantitykind, "/ElectronAffinity") |> PrefixedName
    ...
    let ``_/ElectronDensity`` =
        Prefixed_Name(quantitykind, "/ElectronDensity") |> PrefixedName
    ...
    let ``_/ElectronMeanFreePath`` =
        Prefixed_Name(quantitykind, "/ElectronMeanFreePath") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Mobility</para>
    /// labels<para>electron mobility</para></remarks>
    ...
    let ``_/ElectronMobility`` =
        Prefixed_Name(quantitykind, "/ElectronMobility") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Mobility</para>
    /// labels<para>قابلية التحرك</para><para>Beweglichkeit</para><para>mobilidade</para><para>mobilność</para><para>movilidad</para><para>mobilité</para><para>mobilità</para><para>mobility</para><para>迁移率</para><para>移動度</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Mobility">http://qudt.org/vocab/quantitykind/Mobility</seealso>
    let ``_/Mobility`` = Prefixed_Name(quantitykind, "/Mobility") |> PrefixedName
    ...
    let ``_/ElectronRadius`` =
        Prefixed_Name(quantitykind, "/ElectronRadius") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Height measurement relative to the Normaal Amsterdams Peil (NAP) (en: Amsterdam Ordnance System). Being a form of gravity related height</para>
    ///   <para>Applicable units are those of quantitykind:ElevationRelativeToNAP</para>
    /// labels<para>Hoogte ten opzichte van NAP</para><para>Elevation relative to NAP</para></remarks>
    ...
    let ``_/ElevationRelativeToNAP`` =
        Prefixed_Name(quantitykind, "/ElevationRelativeToNAP") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:HenrysLawVolatilityConstant</para>
    ...
    let ``_/HenrysLawVolatilityConstant`` =
        Prefixed_Name(quantitykind, "/HenrysLawVolatilityConstant") |> PrefixedName
    ...
    let ``_/HoleDensity`` = Prefixed_Name(quantitykind, "/HoleDensity") |> PrefixedName
    ...
    let ``_/HorizontalVelocity`` =
        Prefixed_Name(quantitykind, "/HorizontalVelocity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:HydraulicPermeability</para>
    ...
    let ``_/HydraulicPermeability`` =
        Prefixed_Name(quantitykind, "/HydraulicPermeability") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:HyperfineStructureQuantumNumber</para>
    ...
    let ``_/HyperfineStructureQuantumNumber`` =
        Prefixed_Name(quantitykind, "/HyperfineStructureQuantumNumber") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:QuantumNumber</para>
    ...
    let ``_/QuantumNumber`` =
        Prefixed_Name(quantitykind, "/QuantumNumber") |> PrefixedName
    ...
    let ``_/INERT_MASS`` = Prefixed_Name(quantitykind, "/INERT-MASS") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearDensity</para>
    ...
    let ``_/LinearDensity`` =
        Prefixed_Name(quantitykind, "/LinearDensity") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>lineic electric charge</para></remarks>
    ...
    let ``_/LinearElectricCharge`` =
        Prefixed_Name(quantitykind, "/LinearElectricCharge") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearElectricCurrentDensity</para>
    ...
    let ``_/LinearElectricCurrent`` =
        Prefixed_Name(quantitykind, "/LinearElectricCurrent") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearEnergyTransfer</para>
    ...
    let ``_/LinearEnergyTransfer`` =
        Prefixed_Name(quantitykind, "/LinearEnergyTransfer") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearExpansionCoefficient</para>
    /// labels<para>współczynnik liniowej rozszerzalności cieplnej</para><para>coeficiente de expansión térmica lineal</para><para>coeficiente de dilatação térmica linear</para><para>coefficiente di dilatazione lineare</para><para>coefficient de dilatation linéique</para><para>linearer Ausdehnungskoeffizient</para><para>linear expansion coefficient</para><para>معدل التمدد الحراري الخطي</para><para>线性热膨胀系数</para><para>線熱膨張係数</para></remarks>
    ...
    let ``_/LinearExpansionCoefficient`` =
        Prefixed_Name(quantitykind, "/LinearExpansionCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ForcePerLength</para>
    ...
    let ``_/LinearForce`` = Prefixed_Name(quantitykind, "/LinearForce") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearLogarithmicRatio</para>
    ...
    let ``_/LinearLogarithmicRatio`` =
        Prefixed_Name(quantitykind, "/LinearLogarithmicRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearMass</para>
    /// labels<para>lineic mass</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/LinearMass">http://qudt.org/vocab/quantitykind/LinearMass</seealso>
    let ``_/LinearMass`` = Prefixed_Name(quantitykind, "/LinearMass") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearMomentum</para>
    ...
    let ``_/LinearMomentum`` =
        Prefixed_Name(quantitykind, "/LinearMomentum") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Momentum</para>
    /// labels<para>cantidad de movimiento</para><para>quantité de mouvement</para><para>gibalna količina</para><para>quantità di moto</para><para>momento linear</para><para>زخم الحركة</para><para>momentum</para><para>Momentum</para><para>Momentum</para><para>импульс</para><para>hybnost</para><para>impuls</para><para>Impuls</para><para>تکانه</para><para>運動量</para><para>pęd</para><para>动量</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Momentum">http://qudt.org/vocab/quantitykind/Momentum</seealso>
    let ``_/Momentum`` = Prefixed_Name(quantitykind, "/Momentum") |> PrefixedName
    /// <summary>
    ...
    let ``_/LinearPower`` = Prefixed_Name(quantitykind, "/LinearPower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearResistance</para>
    ...
    let ``_/LinearResistance`` =
        Prefixed_Name(quantitykind, "/LinearResistance") |> PrefixedName
    ...
    let ``_/LinearStiffness`` =
        Prefixed_Name(quantitykind, "/LinearStiffness") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LengthRatio</para>
    ...
    let ``_/LinearStrain`` =
        Prefixed_Name(quantitykind, "/LinearStrain") |> PrefixedName
    ...
    let ``_/Strain`` = Prefixed_Name(quantitykind, "/Strain") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearThermalExpansion</para>
    ...
    let ``_/LinearThermalExpansion`` =
        Prefixed_Name(quantitykind, "/LinearThermalExpansion") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassPerAreaTime</para>
    /// labels<para>mass flux density</para><para>mass flux density</para></remarks>
    ...
    let ``_/MassFluxDensity`` =
        Prefixed_Name(quantitykind, "/MassFluxDensity") |> PrefixedName
    ...
    let ``_/NeutralRatio`` =
        Prefixed_Name(quantitykind, "/NeutralRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:NeutronDiffusionCoefficient</para>
    /// labels<para>coefficiente di diffusione</para><para>coefficient de diffusion</para><para>coeficiente de difusión</para><para>coeficiente de difusão</para><para>difuzijski koeficient</para><para>diffusion coefficient</para><para>Diffusionskoeffizient</para></remarks>
    ...
    let ``_/NeutronDiffusionCoefficient`` =
        Prefixed_Name(quantitykind, "/NeutronDiffusionCoefficient") |> PrefixedName
    ...
    let ``_/NeutronDiffusionLength`` =
        Prefixed_Name(quantitykind, "/NeutronDiffusionLength") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:NeutronNumber</para>
    /// labels<para>número de neutrons</para><para>Nombre de neutrons</para><para>liczba neutronowa</para><para>número neutrónico</para><para>numero neutronico</para><para>nötron snumarası</para><para>Neutronové číslo</para><para>число нейтронов</para><para>عدد النيوترونات</para><para>neutron number</para><para>Nombor neutron</para><para>Neutronenzahl</para><para>عدد نوترون</para><para>中子數</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/NeutronNumber">http://qudt.org/vocab/quantitykind/NeutronNumber</seealso>
    let ``_/NeutronNumber`` =
        Prefixed_Name(quantitykind, "/NeutronNumber") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:NeutronYieldPerAbsorption</para>
    ...
    let ``_/NeutronYieldPerAbsorption`` =
        Prefixed_Name(quantitykind, "/NeutronYieldPerAbsorption") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:NeutronYieldPerFission</para>
    ...
    let ``_/NeutronYieldPerFission`` =
        Prefixed_Name(quantitykind, "/NeutronYieldPerFission") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Non-LeakageProbability</para>
    ...
    let ``_/Non_LeakageProbability`` =
        Prefixed_Name(quantitykind, "/Non-LeakageProbability") |> PrefixedName
    ...
    let ``_/NonNegativeLength`` =
        Prefixed_Name(quantitykind, "/NonNegativeLength") |> PrefixedName
    ...
    let ``_/NormalStress`` =
        Prefixed_Name(quantitykind, "/NormalStress") |> PrefixedName
    ...
    let ``_/Stress`` = Prefixed_Name(quantitykind, "/Stress") |> PrefixedName
    ...
    let ``_/NormalizedDimensionlessRatio`` =
        Prefixed_Name(quantitykind, "/NormalizedDimensionlessRatio") |> PrefixedName
    ...
    let ``_/NozzleThroatCrossSectionalArea`` =
        Prefixed_Name(quantitykind, "/NozzleThroatCrossSectionalArea") |> PrefixedName
    ...
    let ``_/NozzleThroatPressure`` =
        Prefixed_Name(quantitykind, "/NozzleThroatPressure") |> PrefixedName
    ...
    let ``_/NozzleWallsThrustReaction`` =
        Prefixed_Name(quantitykind, "/NozzleWallsThrustReaction") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:NuclearQuadrupoleMoment</para>
    ...
    let ``_/NuclearQuadrupoleMoment`` =
        Prefixed_Name(quantitykind, "/NuclearQuadrupoleMoment") |> PrefixedName
    ...
    let ``_/NuclearRadius`` =
        Prefixed_Name(quantitykind, "/NuclearRadius") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:NuclearSpinQuantumNumber</para>
    ...
    let ``_/NuclearSpinQuantumNumber`` =
        Prefixed_Name(quantitykind, "/NuclearSpinQuantumNumber") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:NucleonNumber</para>
    /// labels<para>nükleon numarası</para><para>número de massa</para><para>numero di massa</para><para>nombre de masse</para><para>Nukleové číslo</para><para>nucleon number</para><para>Nombor nukleon</para><para>Nukleonenzahl</para><para>número másico</para><para>liczba masowa</para><para>عدد كتلي</para><para>عدد جرمی</para><para>質量数</para><para>质量数</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/NucleonNumber">http://qudt.org/vocab/quantitykind/NucleonNumber</seealso>
    let ``_/NucleonNumber`` =
        Prefixed_Name(quantitykind, "/NucleonNumber") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PressureRatio</para>
    ...
    let ``_/PressureRatio`` =
        Prefixed_Name(quantitykind, "/PressureRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Prevalence</para>
    ...
    let ``_/Prevalence`` = Prefixed_Name(quantitykind, "/Prevalence") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PropagationCoefficient</para>
    ...
    let ``_/PropagationCoefficient`` =
        Prefixed_Name(quantitykind, "/PropagationCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PropellantBurnRate</para>
    ...
    let ``_/PropellantBurnRate`` =
        Prefixed_Name(quantitykind, "/PropellantBurnRate") |> PrefixedName
    ...
    let ``_/PropellantMeanBulkTemperature`` =
        Prefixed_Name(quantitykind, "/PropellantMeanBulkTemperature") |> PrefixedName
    ...
    let ``_/PropellantTemperature`` =
        Prefixed_Name(quantitykind, "/PropellantTemperature") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>quantity of light</para><para>quantity of light</para></remarks>
    ...
    let ``_/QuantityOfLight`` =
        Prefixed_Name(quantitykind, "/QuantityOfLight") |> PrefixedName
    ...
    let ``_/RESERVE_MASS`` =
        Prefixed_Name(quantitykind, "/RESERVE-MASS") |> PrefixedName
    ...
    let ``_/SolidStateDiffusionLength`` =
        Prefixed_Name(quantitykind, "/SolidStateDiffusionLength") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Concentration</para>
    ...
    let ``_/Solubility_Water`` =
        Prefixed_Name(quantitykind, "/Solubility_Water") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:WaterSolubility</para>
    /// labels<para>Water Solubility</para></remarks>
    ...
    let ``_/WaterSolubility`` =
        Prefixed_Name(quantitykind, "/WaterSolubility") |> PrefixedName
    ...
    let ``_/SoundEnergyDensity`` =
        Prefixed_Name(quantitykind, "/SoundEnergyDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SoundExposure</para>
    ...
    let ``_/SoundExposure`` =
        Prefixed_Name(quantitykind, "/SoundExposure") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SoundExposureLevel</para>
    ...
    let ``_/SoundExposureLevel`` =
        Prefixed_Name(quantitykind, "/SoundExposureLevel") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TemperatureVariance</para>
    ...
    let ``_/TemperatureVariance`` =
        Prefixed_Name(quantitykind, "/TemperatureVariance") |> PrefixedName
    ...
    let ``_/TemperatureVariance_NEON`` =
        Prefixed_Name(quantitykind, "/TemperatureVariance_NEON") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TemporalSummationFunction</para>
    ...
    let ``_/TemporalSummationFunction`` =
        Prefixed_Name(quantitykind, "/TemporalSummationFunction") |> PrefixedName
    ...
    let ``_/Tension`` = Prefixed_Name(quantitykind, "/Tension") |> PrefixedName
    ...
    let ``_/ThermalAdmittance`` =
        Prefixed_Name(quantitykind, "/ThermalAdmittance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermalCapacitance</para>
    /// labels<para>thermal capacitance</para><para>thermal capacitance</para></remarks>
    ...
    let ``_/ThermalCapacitance`` =
        Prefixed_Name(quantitykind, "/ThermalCapacitance") |> PrefixedName
    ...
    let ``_/ThermalCoefficientOfLinearExpansion`` =
        Prefixed_Name(quantitykind, "/ThermalCoefficientOfLinearExpansion") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermalConductance</para>
    ...
    let ``_/ThermalConductance`` =
        Prefixed_Name(quantitykind, "/ThermalConductance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermalConductivity</para>
    ...
    let ``_/ThermalConductivity`` =
        Prefixed_Name(quantitykind, "/ThermalConductivity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermalDiffusionFactor</para>
    ...
    let ``_/ThermalDiffusionFactor`` =
        Prefixed_Name(quantitykind, "/ThermalDiffusionFactor") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermalDiffusionRatio</para>
    ...
    let ``_/ThermalDiffusionRatio`` =
        Prefixed_Name(quantitykind, "/ThermalDiffusionRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermalDiffusionRatioCoefficient</para>
    ...
    let ``_/ThermalDiffusionRatioCoefficient`` =
        Prefixed_Name(quantitykind, "/ThermalDiffusionRatioCoefficient") |> PrefixedName
    ...
    let ``_/ThermalDiffusivity`` =
        Prefixed_Name(quantitykind, "/ThermalDiffusivity") |> PrefixedName
    ...
    let ``_/ThermalEfficiency`` =
        Prefixed_Name(quantitykind, "/ThermalEfficiency") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermalEnergyLength</para>
    ...
    let ``_/ThermalEnergyLength`` =
        Prefixed_Name(quantitykind, "/ThermalEnergyLength") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermalExpansionCoefficient</para>
    ...
    let ``_/ThermalExpansionCoefficient`` =
        Prefixed_Name(quantitykind, "/ThermalExpansionCoefficient") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>Measurement Unit of Thermal Inertia</para></remarks>
    ...
    let ``_/ThermalInertia`` =
        Prefixed_Name(quantitykind, "/ThermalInertia") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermalResistance</para>
    /// labels<para>thermischer Widerstand</para><para>résistance thermique</para><para>resistência térmica</para><para>resistencia térmica</para><para>thermal resistance</para><para>resistenza termica</para><para>مقاومة حرارية</para><para>opór cieplny</para><para>熱抵抗</para><para>热阻</para></remarks>
    ...
    let ``_/ThermalResistance`` =
        Prefixed_Name(quantitykind, "/ThermalResistance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermalResistivity</para>
    ...
    let ``_/ThermalResistivity`` =
        Prefixed_Name(quantitykind, "/ThermalResistivity") |> PrefixedName
    ...
    let ``_/ThermalTransmittance`` =
        Prefixed_Name(quantitykind, "/ThermalTransmittance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermalUtilizationFactor</para>
    ...
    let ``_/ThermalUtilizationFactor`` =
        Prefixed_Name(quantitykind, "/ThermalUtilizationFactor") |> PrefixedName
    ...
    let ``_/ThermalUtilizationFactorForFission`` =
        Prefixed_Name(quantitykind, "/ThermalUtilizationFactorForFission") |> PrefixedName
    ...
    let ``_/ThermodynamicCriticalMagneticFluxDensity`` =
        Prefixed_Name(quantitykind, "/ThermodynamicCriticalMagneticFluxDensity") |> PrefixedName
    ...
    let ``_/VolumeOrSectionModulus`` =
        Prefixed_Name(quantitykind, "/VolumeOrSectionModulus") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VolumePerArea</para>
    ...
    let ``_/VolumePerArea`` =
        Prefixed_Name(quantitykind, "/VolumePerArea") |> PrefixedName
    ...
    let ``_/VolumeStrain`` =
        Prefixed_Name(quantitykind, "/VolumeStrain") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VolumeThermalExpansion</para>
    ...
    let ``_/VolumeThermalExpansion`` =
        Prefixed_Name(quantitykind, "/VolumeThermalExpansion") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VolumetricBitDensity</para>
    /// labels<para>volumic bit density</para></remarks>
    ...
    let ``_/VolumetricBitDensity`` =
        Prefixed_Name(quantitykind, "/VolumetricBitDensity") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>volumic electric charge</para></remarks>
    ...
    let ``_/VolumetricElectricCharge`` =
        Prefixed_Name(quantitykind, "/VolumetricElectricCharge") |> PrefixedName
    ...
    let ``_/VolumetricEntityDensity`` =
        Prefixed_Name(quantitykind, "/VolumetricEntityDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VolumetricFlux</para>
    ...
    let ``_/VolumetricFlux`` =
        Prefixed_Name(quantitykind, "/VolumetricFlux") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricChargePerArea</para>
    /// labels<para>areic charge density</para></remarks>
    ...
    let ``_/AreaChargeDensity`` =
        Prefixed_Name(quantitykind, "/AreaChargeDensity") |> PrefixedName
    ...
    let ``_/AreaMass`` = Prefixed_Name(quantitykind, "/AreaMass") |> PrefixedName
    ...
    let ``_/IsothermalMoistureCapacity`` =
        Prefixed_Name(quantitykind, "/IsothermalMoistureCapacity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ParticleSourceDensity</para>
    ...
    let ``_/ParticleSourceDensity`` =
        Prefixed_Name(quantitykind, "/ParticleSourceDensity") |> PrefixedName
    ...
    let ``_/SpecificHeatsRatio`` =
        Prefixed_Name(quantitykind, "/SpecificHeatsRatio") |> PrefixedName
    ...
    let ``_/Tilt`` = Prefixed_Name(quantitykind, "/Tilt") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>water vapour permeability</para><para>water vapour permeability</para></remarks>
    ...
    let ``_/WaterVapourPermeability`` =
        Prefixed_Name(quantitykind, "/WaterVapourPermeability") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RelativeHumidity</para>
    ...
    let ``_/RelativeHumidity`` =
        Prefixed_Name(quantitykind, "/RelativeHumidity") |> PrefixedName
    ...
    let ``_/Density`` = Prefixed_Name(quantitykind, "/Density") |> PrefixedName
    ...
    let ``_/CENTER_OF_MASS`` =
        Prefixed_Name(quantitykind, "/CENTER-OF-MASS") |> PrefixedName
    ...
    let ``_/EllipticalOrbitPerigeeVelocity`` =
        Prefixed_Name(quantitykind, "/EllipticalOrbitPerigeeVelocity") |> PrefixedName
    ...
    let ``_/IgnitionIntervalTime`` =
        Prefixed_Name(quantitykind, "/IgnitionIntervalTime") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LuminousFluxPerArea</para>
    /// labels<para>natężenie oświetlenia</para><para>הארה (שטף ליחידת שטח)</para><para>éclairement lumineux</para><para>Intenzita osvětlení</para><para>Beleuchtungsstärke</para><para>aydınlanma şiddeti</para><para>illuminamento</para><para>Освещённость</para><para>megvilágítás</para><para>iluminamento</para><para>osvetljenost</para><para>illuminance</para><para>Pencahayaan</para><para>luminosidad</para><para>شدت روشنایی</para><para>Осветеност</para><para>iluminare</para><para>شدة الضوء</para><para>प्रदीपन</para><para>照度</para><para>照度</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Illuminance">http://qudt.org/vocab/quantitykind/Illuminance</seealso>
    let ``_/Illuminance`` = Prefixed_Name(quantitykind, "/Illuminance") |> PrefixedName
    /// <summary>
    ...
    let ``_/MassExcess`` = Prefixed_Name(quantitykind, "/MassExcess") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassFlowRate</para>
    ...
    let ``_/MassFlowRate`` =
        Prefixed_Name(quantitykind, "/MassFlowRate") |> PrefixedName
    ...
    let ``_/PressureBasedAmountOfSubstanceConcentration`` =
        Prefixed_Name(quantitykind, "/PressureBasedAmountOfSubstanceConcentration") |> PrefixedName
    ...
    let ``_/PressureBasedDensity`` =
        Prefixed_Name(quantitykind, "/PressureBasedDensity") |> PrefixedName
    ...
    let ``_/PressureBasedKinematicViscosity`` =
        Prefixed_Name(quantitykind, "/PressureBasedKinematicViscosity") |> PrefixedName
    ...
    let ``_/PressureBasedLength`` =
        Prefixed_Name(quantitykind, "/PressureBasedLength") |> PrefixedName
    ...
    let ``_/PressureBasedMass`` =
        Prefixed_Name(quantitykind, "/PressureBasedMass") |> PrefixedName
    ...
    let ``_/PressureBasedVelocity`` =
        Prefixed_Name(quantitykind, "/PressureBasedVelocity") |> PrefixedName
    ...
    let ``_/PressureBasedVolume`` =
        Prefixed_Name(quantitykind, "/PressureBasedVolume") |> PrefixedName
    ...
    let ``_/PressureBasedVolumeFlow`` =
        Prefixed_Name(quantitykind, "/PressureBasedVolumeFlow") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TemperatureAmountOfSubstance</para>
    ...
    let ``_/TemperatureAmountOfSubstance`` =
        Prefixed_Name(quantitykind, "/TemperatureAmountOfSubstance") |> PrefixedName
    ...
    let ``_/TemperatureBasedAmountOfSubstanceConcentration`` =
        Prefixed_Name(quantitykind, "/TemperatureBasedAmountOfSubstanceConcentration") |> PrefixedName
    ...
    let ``_/TemperatureBasedDensity`` =
        Prefixed_Name(quantitykind, "/TemperatureBasedDensity") |> PrefixedName
    ...
    let ``_/AreicDataVolume`` =
        Prefixed_Name(quantitykind, "/AreicDataVolume") |> PrefixedName
    ...
    let ``_/BurgersVector`` =
        Prefixed_Name(quantitykind, "/BurgersVector") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricCurrentPhasor</para>
    ...
    let ``_/ElectricCurrentPhasor`` =
        Prefixed_Name(quantitykind, "/ElectricCurrentPhasor") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Compressibility</para>
    ...
    let ``_/Compressibility`` =
        Prefixed_Name(quantitykind, "/Compressibility") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Incidence</para>
    /// labels<para>failure rate</para><para>failure rate</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/FailureRate">http://qudt.org/vocab/quantitykind/FailureRate</seealso>
    let ``_/FailureRate`` = Prefixed_Name(quantitykind, "/FailureRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:HamiltonFunction</para>
    ...
    let ``_/HamiltonFunction`` =
        Prefixed_Name(quantitykind, "/HamiltonFunction") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Landau-GinzburgNumber</para>
    ...
    let ``_/Landau_GinzburgNumber`` =
        Prefixed_Name(quantitykind, "/Landau-GinzburgNumber") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticDipoleMoment</para>
    ...
    let ``_/MagneticDipoleMoment`` =
        Prefixed_Name(quantitykind, "/MagneticDipoleMoment") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PlasmaLevel</para>
    ...
    let ``_/PlasmaLevel`` = Prefixed_Name(quantitykind, "/PlasmaLevel") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PoissonRatio</para>
    ...
    let ``_/PoissonRatio`` =
        Prefixed_Name(quantitykind, "/PoissonRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RelativeMassExcess</para>
    ...
    let ``_/RelativeMassExcess`` =
        Prefixed_Name(quantitykind, "/RelativeMassExcess") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RelativeMassRatioOfVapour</para>
    ...
    let ``_/RelativeMassRatioOfVapour`` =
        Prefixed_Name(quantitykind, "/RelativeMassRatioOfVapour") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:StandardGravitationalParameter</para>
    ...
    let ``_/StandardGravitationalParameter`` =
        Prefixed_Name(quantitykind, "/StandardGravitationalParameter") |> PrefixedName
    ...
    let ``_/StateDensity`` =
        Prefixed_Name(quantitykind, "/StateDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Unbalance</para>
    /// labels<para>unbalance</para><para>unbalance</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Unbalance">http://qudt.org/vocab/quantitykind/Unbalance</seealso>
    let ``_/Unbalance`` = Prefixed_Name(quantitykind, "/Unbalance") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/Unknown</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Unknown</para>
    ...
    let ``_/Unknown`` = Prefixed_Name(quantitykind, "/Unknown") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ActivityConcentration</para>
    ...
    let ``_/ActivityConcentration`` =
        Prefixed_Name(quantitykind, "/ActivityConcentration") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ConductionSpeed</para>
    ...
    let ``_/ConductionSpeed`` =
        Prefixed_Name(quantitykind, "/ConductionSpeed") |> PrefixedName
    ...
    let ``_/DistanceTraveledDuringBurn`` =
        Prefixed_Name(quantitykind, "/DistanceTraveledDuringBurn") |> PrefixedName
    ...
    let ``_/DonorDensity`` =
        Prefixed_Name(quantitykind, "/DonorDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LengthEnergy</para>
    ...
    let ``_/LengthEnergy`` =
        Prefixed_Name(quantitykind, "/LengthEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LengthMass</para>
    ...
    let ``_/LengthMass`` = Prefixed_Name(quantitykind, "/LengthMass") |> PrefixedName
    ...
    let ``_/MolarFluxDensityVariance_NEON`` =
        Prefixed_Name(quantitykind, "/MolarFluxDensityVariance_NEON") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarHeatCapacity</para>
    ...
    let ``_/MolarHeatCapacity`` =
        Prefixed_Name(quantitykind, "/MolarHeatCapacity") |> PrefixedName
    ...
    let ``_/PolarMomentOfInertia`` =
        Prefixed_Name(quantitykind, "/PolarMomentOfInertia") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Polarizability</para>
    /// labels<para>Polarizability</para><para>polarisability</para></remarks>
    ...
    let ``_/Polarizability`` =
        Prefixed_Name(quantitykind, "/Polarizability") |> PrefixedName
    ...
    let ``_/ResistanceBasedInductance`` =
        Prefixed_Name(quantitykind, "/ResistanceBasedInductance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:StatisticalWeight</para>
    ...
    let ``_/StatisticalWeight`` =
        Prefixed_Name(quantitykind, "/StatisticalWeight") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:BurstFactor</para>
    /// labels<para>burst factor</para><para>burst factor</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/BurstFactor">http://qudt.org/vocab/quantitykind/BurstFactor</seealso>
    let ``_/BurstFactor`` = Prefixed_Name(quantitykind, "/BurstFactor") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricCurrentDensity</para>
    /// labels<para>densidade de corrente elétrica</para><para>densità di corrente elettrica</para><para>Hustota elektrického proudu</para><para>Gęstość prądu elektrycznego</para><para>gostota električnega toka</para><para>Ketumpatan arus elektrik</para><para>electric current density</para><para>elektrische Stromdichte</para><para>densidad de corriente</para><para>چگالی جریان الکتریکی</para><para>Densitate de curent</para><para>densité de courant</para><para>плотность тока</para><para>Akım yoğunluğu</para><para>كثافة التيار</para><para>धारा घनत्व</para><para>電流密度</para><para>电流密度</para></remarks>
    ...
    let ``_/ElectricCurrentDensity`` =
        Prefixed_Name(quantitykind, "/ElectricCurrentDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricFieldStrength</para>
    /// labels<para>Напряженность электрического поля</para><para>intensidade de campo elétrico</para><para>intensité de champ électrique</para><para>intensidad de campo eléctrico</para><para>natężenie pola elektrycznego</para><para>intensità di campo elettrico</para><para>jakost električnega polja</para><para>elektriksel alan kuvveti</para><para>Kekuatan medan elektrik</para><para>electric field strength</para><para>elektrische Feldstärke</para><para>شدة المجال الكهربائي</para><para>شدت میدان الکتریکی</para><para>विद्युत्-क्षेत्र</para><para>Електрично поле</para><para>elektrické pole</para><para>Elektromos mező</para><para>Ηλεκτρικό πεδίο</para><para>câmp electric</para><para>שדה חשמלי</para><para>電界強度</para><para>電場</para></remarks>
    ...
    let ``_/ElectricFieldStrength`` =
        Prefixed_Name(quantitykind, "/ElectricFieldStrength") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Constringence</para>
    ...
    let ``_/Constringence`` =
        Prefixed_Name(quantitykind, "/Constringence") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DutyCycle</para>
    ...
    let ``_/DutyCycle`` = Prefixed_Name(quantitykind, "/DutyCycle") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectromagneticPermeabilityRatio</para>
    ...
    let ``_/ElectromagneticPermeabilityRatio`` =
        Prefixed_Name(quantitykind, "/ElectromagneticPermeabilityRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectromagneticWavePhaseSpeed</para>
    ...
    let ``_/ElectromagneticWavePhaseSpeed`` =
        Prefixed_Name(quantitykind, "/ElectromagneticWavePhaseSpeed") |> PrefixedName
    ...
    let ``_/HeatFluxDensity`` =
        Prefixed_Name(quantitykind, "/HeatFluxDensity") |> PrefixedName
    ...
    let ``_/HeatingValue`` =
        Prefixed_Name(quantitykind, "/HeatingValue") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearBitDensity</para>
    /// labels<para>lineic bit density</para></remarks>
    ...
    let ``_/LinearBitDensity`` =
        Prefixed_Name(quantitykind, "/LinearBitDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearCompressibility</para>
    ...
    let ``_/LinearCompressibility`` =
        Prefixed_Name(quantitykind, "/LinearCompressibility") |> PrefixedName
    ...
    let ``_/MassDefect`` = Prefixed_Name(quantitykind, "/MassDefect") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MomentOfForce</para>
    ...
    let ``_/MomentOfForce`` =
        Prefixed_Name(quantitykind, "/MomentOfForce") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RotationalMass</para>
    ...
    let ``_/RotationalMass`` =
        Prefixed_Name(quantitykind, "/RotationalMass") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MomentumPerAngle</para>
    ...
    let ``_/MomentumPerAngle`` =
        Prefixed_Name(quantitykind, "/MomentumPerAngle") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MorbidityRate</para>
    ...
    let ``_/MorbidityRate`` =
        Prefixed_Name(quantitykind, "/MorbidityRate") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>motor constant</para><para>motor constant</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/MotorConstant">http://qudt.org/vocab/quantitykind/MotorConstant</seealso>
    let ``_/MotorConstant`` =
        Prefixed_Name(quantitykind, "/MotorConstant") |> PrefixedName
    ...
    let ``_/NOMINAL_ASCENT_PROPELLANT_MASS`` =
        Prefixed_Name(quantitykind, "/NOMINAL-ASCENT-PROPELLANT-MASS") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:NapierianAbsorbance</para>
    ...
    let ``_/NapierianAbsorbance`` =
        Prefixed_Name(quantitykind, "/NapierianAbsorbance") |> PrefixedName
    ...
    let ``_/PressureBasedDynamicViscosity`` =
        Prefixed_Name(quantitykind, "/PressureBasedDynamicViscosity") |> PrefixedName
    ...
    let ``_/PressureBasedElectricCurrent`` =
        Prefixed_Name(quantitykind, "/PressureBasedElectricCurrent") |> PrefixedName
    ...
    let ``_/PressureBasedElectricVoltage`` =
        Prefixed_Name(quantitykind, "/PressureBasedElectricVoltage") |> PrefixedName
    ...
    let ``_/PressureBasedMassFlow`` =
        Prefixed_Name(quantitykind, "/PressureBasedMassFlow") |> PrefixedName
    ...
    let ``_/PressureBasedMolality`` =
        Prefixed_Name(quantitykind, "/PressureBasedMolality") |> PrefixedName
    ...
    let ``_/PressureBasedQuantity`` =
        Prefixed_Name(quantitykind, "/PressureBasedQuantity") |> PrefixedName
    ...
    let ``_/PressureBasedTemperature`` =
        Prefixed_Name(quantitykind, "/PressureBasedTemperature") |> PrefixedName
    ...
    let ``_/PressureBurningRateConstant`` =
        Prefixed_Name(quantitykind, "/PressureBurningRateConstant") |> PrefixedName
    ...
    let ``_/PressureBurningRateIndex`` =
        Prefixed_Name(quantitykind, "/PressureBurningRateIndex") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PressureCoefficient</para>
    ...
    let ``_/PressureCoefficient`` =
        Prefixed_Name(quantitykind, "/PressureCoefficient") |> PrefixedName
    ...
    let ``_/PressureInRelationToVolumeFlow`` =
        Prefixed_Name(quantitykind, "/PressureInRelationToVolumeFlow") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PressureInRelationToVolumeFlowRate</para>
    /// labels<para>pressure in relation to volume flow rate</para></remarks>
    ...
    let ``_/PressureInRelationToVolumeFlowRate`` =
        Prefixed_Name(quantitykind, "/PressureInRelationToVolumeFlowRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PressureLossPerLength</para>
    ...
    let ``_/PressureLossPerLength`` =
        Prefixed_Name(quantitykind, "/PressureLossPerLength") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Slowing-DownDensity</para>
    ...
    let ``_/Slowing_DownDensity`` =
        Prefixed_Name(quantitykind, "/Slowing-DownDensity") |> PrefixedName
    ...
    let ``_/Slowing_DownLength`` =
        Prefixed_Name(quantitykind, "/Slowing-DownLength") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SoilAdsorptionCoefficient</para>
    ...
    let ``_/SoilAdsorptionCoefficient`` =
        Prefixed_Name(quantitykind, "/SoilAdsorptionCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SolidAngle</para>
    /// labels<para>katı cisimdeki açı</para><para>Пространствен ъгъл</para><para>angulus solidus</para><para>Prostorový úhel</para><para>prostorski kot</para><para>الزاوية الصلبة</para><para>angolo solido</para><para>ângulo sólido</para><para>Телесный угол</para><para>ángulo sólido</para><para>Στερεά γωνία</para><para>זווית מרחבית</para><para>angle solide</para><para>solid angle</para><para>kąt bryłowy</para><para>زاویه فضایی</para><para>unghi solid</para><para>Sudut padu</para><para>Raumwinkel</para><para>térszög</para><para>आयतन</para><para>立体角度</para><para>立体角</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/SolidAngle">http://qudt.org/vocab/quantitykind/SolidAngle</seealso>
    let ``_/SolidAngle`` = Prefixed_Name(quantitykind, "/SolidAngle") |> PrefixedName
    ...
    let ``_/TemperaturePerTime_Squared`` =
        Prefixed_Name(quantitykind, "/TemperaturePerTime_Squared") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TemperaturePerTime</para>
    ...
    let ``_/TemperatureRateOfChange`` =
        Prefixed_Name(quantitykind, "/TemperatureRateOfChange") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TemperatureRatio</para>
    ...
    let ``_/TemperatureRatio`` =
        Prefixed_Name(quantitykind, "/TemperatureRatio") |> PrefixedName
    ...
    let ``_/TemperatureRelatedMolarMass`` =
        Prefixed_Name(quantitykind, "/TemperatureRelatedMolarMass") |> PrefixedName
    ...
    let ``_/TemperatureRelatedVolume`` =
        Prefixed_Name(quantitykind, "/TemperatureRelatedVolume") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Length</para>
    /// labels<para>absolute typographic measurement</para></remarks>
    ...
    let ``_/AbsoluteTypographicMeasurement`` =
        Prefixed_Name(quantitykind, "/AbsoluteTypographicMeasurement") |> PrefixedName
    ...
    let ``_/AbsorbedDose`` =
        Prefixed_Name(quantitykind, "/AbsorbedDose") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CanonicalPartitionFunction</para>
    ...
    let ``_/CanonicalPartitionFunction`` =
        Prefixed_Name(quantitykind, "/CanonicalPartitionFunction") |> PrefixedName
    ...
    let ``_/Capacity`` = Prefixed_Name(quantitykind, "/Capacity") |> PrefixedName
    ...
    let ``_/CarrierLifetime`` =
        Prefixed_Name(quantitykind, "/CarrierLifetime") |> PrefixedName
    ...
    let ``_/LineicLogarithmicRatio`` =
        Prefixed_Name(quantitykind, "/LineicLogarithmicRatio") |> PrefixedName
    ...
    let ``_/LineicQuantity`` =
        Prefixed_Name(quantitykind, "/LineicQuantity") |> PrefixedName
    ...
    let ``_/LineicResistance`` =
        Prefixed_Name(quantitykind, "/LineicResistance") |> PrefixedName
    ...
    let ``_/LineicTorque`` =
        Prefixed_Name(quantitykind, "/LineicTorque") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticFlux</para>
    ...
    let ``_/LinkedFlux`` = Prefixed_Name(quantitykind, "/LinkedFlux") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticFlux</para>
    /// labels<para>Flux d'induction magnétique</para><para>flux de inducție magnetică</para><para>strumień magnetyczny</para><para>التدفق المغناطيسي</para><para>fluxus magneticus</para><para>magnetischer Flux</para><para>flusso magnetico</para><para>fluxo magnético</para><para>mágneses fluxus</para><para>flujo magnético</para><para>magnetni pretok</para><para>Магнитный поток</para><para>Магнитен поток</para><para>Magnetický tok</para><para>चुम्बकीय बहाव</para><para>magnetic flux</para><para>Fluks magnet</para><para>manyetik akı</para><para>شار مغناطیسی</para><para>שטף מגנטי</para><para>磁通量</para><para>磁束</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/MagneticFlux">http://qudt.org/vocab/quantitykind/MagneticFlux</seealso>
    let ``_/MagneticFlux`` =
        Prefixed_Name(quantitykind, "/MagneticFlux") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LiquidVolume</para>
    ...
    let ``_/LiquidVolume`` =
        Prefixed_Name(quantitykind, "/LiquidVolume") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>logarithmic ratio to base 10</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Log10Ratio">http://qudt.org/vocab/quantitykind/Log10Ratio</seealso>
    let ``_/Log10Ratio`` = Prefixed_Name(quantitykind, "/Log10Ratio") |> PrefixedName
    /// <summary>
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>logarithmic ratio to base e</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/LogERatio">http://qudt.org/vocab/quantitykind/LogERatio</seealso>
    let ``_/LogERatio`` = Prefixed_Name(quantitykind, "/LogERatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassFraction</para>
    ...
    let ``_/MassFraction`` =
        Prefixed_Name(quantitykind, "/MassFraction") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:NumberOfElectricalPhases</para>
    ...
    let ``_/NumberOfElectricalPhases`` =
        Prefixed_Name(quantitykind, "/NumberOfElectricalPhases") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RadianceFactor</para>
    ...
    let ``_/RadianceFactor`` =
        Prefixed_Name(quantitykind, "/RadianceFactor") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SoundParticleVelocity</para>
    /// labels<para>velocidade acústica de uma partícula</para><para>velocidad acústica de una partícula</para><para>vitesse  acoustique d‘une particule</para><para>velocità di spostamento</para><para>sound particle velocity</para><para>prędkość akustyczna</para><para>Schallschnelle</para><para>سرعة جسيم</para><para>粒子速度</para></remarks>
    ...
    let ``_/SoundParticleVelocity`` =
        Prefixed_Name(quantitykind, "/SoundParticleVelocity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Power</para>
    /// labels<para>puissance acoustique</para><para>potência acústica</para><para>звуковая мощность</para><para>potencie acústica</para><para>potenza sonora</para><para>Schallleistung</para><para>moc akustyczna</para><para>القدرة الصوتية</para><para>sound power</para><para>音源の音響出力</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/SoundPower">http://qudt.org/vocab/quantitykind/SoundPower</seealso>
    let ``_/SoundPower`` = Prefixed_Name(quantitykind, "/SoundPower") |> PrefixedName
    ...
    let ``_/SoundPressure`` =
        Prefixed_Name(quantitykind, "/SoundPressure") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SoundPressureLevel</para>
    /// labels<para>niveau de pression acoustique</para><para>livello di pressione sonora</para><para>miary wielkości ilorazowych</para><para>уровень звукового давления</para><para>nível de pressão acústica</para><para>Hladina akustického tlaku</para><para>nivel de presión sonora</para><para>gerilim veya akım oranı</para><para>سطح یک کمیت توان-ریشه</para><para>sound pressure level</para><para>Schalldruckpegel</para><para>كمية جذر الطاقة</para><para>Tahap medan</para><para>声压级</para><para>利得</para></remarks>
    ...
    let ``_/SoundPressureLevel`` =
        Prefixed_Name(quantitykind, "/SoundPressureLevel") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SoundReductionIndex</para>
    ...
    let ``_/SoundReductionIndex`` =
        Prefixed_Name(quantitykind, "/SoundReductionIndex") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SoundVolumeVelocity</para>
    ...
    let ``_/SoundVolumeVelocity`` =
        Prefixed_Name(quantitykind, "/SoundVolumeVelocity") |> PrefixedName
    ...
    let ``_/SourceVoltage`` =
        Prefixed_Name(quantitykind, "/SourceVoltage") |> PrefixedName
    ...
    let ``_/SourceVoltageBetweenSubstances`` =
        Prefixed_Name(quantitykind, "/SourceVoltageBetweenSubstances") |> PrefixedName
    ...
    let ``_/SpatialSummationFunction`` =
        Prefixed_Name(quantitykind, "/SpatialSummationFunction") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificAcousticImpedance</para>
    ...
    let ``_/SpecificAcousticImpedance`` =
        Prefixed_Name(quantitykind, "/SpecificAcousticImpedance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificActivity</para>
    ...
    let ``_/SpecificActivity`` =
        Prefixed_Name(quantitykind, "/SpecificActivity") |> PrefixedName
    ...
    let ``_/VolumicAmountOfSubstance`` =
        Prefixed_Name(quantitykind, "/VolumicAmountOfSubstance") |> PrefixedName
    ...
    let ``_/VolumicDataQuantity`` =
        Prefixed_Name(quantitykind, "/VolumicDataQuantity") |> PrefixedName
    ...
    let ``_/VolumicOutput`` =
        Prefixed_Name(quantitykind, "/VolumicOutput") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AngularVelocity</para>
    ...
    let ``_/Vorticity`` = Prefixed_Name(quantitykind, "/Vorticity") |> PrefixedName
    ...
    let ``_/WarmReceptorThreshold`` =
        Prefixed_Name(quantitykind, "/WarmReceptorThreshold") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:WarpingConstant</para>
    ...
    let ``_/WarpingConstant`` =
        Prefixed_Name(quantitykind, "/WarpingConstant") |> PrefixedName
    ...
    let ``_/DynamicFriction`` =
        Prefixed_Name(quantitykind, "/DynamicFriction") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EnergyPerElectricCharge</para>
    /// labels<para>elektromotorische Kraft</para><para>Elektromotorické napětí</para><para>siła elektromotoryczna</para><para>force électromotrice</para><para>forza elettromotrice</para><para>forță electromotoare</para><para>fuerza electromotriz</para><para>электродвижущая сила</para><para>Daya gerak elektrik</para><para>Elektromotor kuvvet</para><para>نیروی محرک الکتریکی</para><para>elektromotorna sila</para><para>electromotive force</para><para>força eletromotriz</para><para>قوة محركة كهربائية</para><para>विद्युतवाहक बल</para><para>起電力</para><para>電動勢</para></remarks>
    ...
    let ``_/ElectromotiveForce`` =
        Prefixed_Name(quantitykind, "/ElectromotiveForce") |> PrefixedName
    ...
    let ``_/FissionFuelUtilizationFactor`` =
        Prefixed_Name(quantitykind, "/FissionFuelUtilizationFactor") |> PrefixedName
    ...
    let ``_/FissionMultiplicationFactor`` =
        Prefixed_Name(quantitykind, "/FissionMultiplicationFactor") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Length</para>
    /// labels<para>Ketinggian</para><para>yükseklik</para><para>Înălțime</para><para>hauteur</para><para>altezza</para><para>height</para><para>ارتفاع</para><para>altura</para><para>высота</para><para>altura</para><para>Výška</para><para>Höhe</para><para>高度</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Height">http://qudt.org/vocab/quantitykind/Height</seealso>
    let ``_/Height`` = Prefixed_Name(quantitykind, "/Height") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearAttenuationCoefficient</para>
    ...
    let ``_/LinearAttenuationCoefficient`` =
        Prefixed_Name(quantitykind, "/LinearAttenuationCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PowerArea</para>
    ...
    let ``_/PowerArea`` = Prefixed_Name(quantitykind, "/PowerArea") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PowerAreaPerSolidAngle</para>
    ...
    let ``_/PowerAreaPerSolidAngle`` =
        Prefixed_Name(quantitykind, "/PowerAreaPerSolidAngle") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Rotary-TranslatoryMotionConversion</para>
    /// labels<para>rotary-translatory motion conversion</para></remarks>
    ...
    let ``_/Rotary_TranslatoryMotionConversion`` =
        Prefixed_Name(quantitykind, "/Rotary-TranslatoryMotionConversion") |> PrefixedName
    ...
    let ``_/RotaryShock`` = Prefixed_Name(quantitykind, "/RotaryShock") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ReactiveCharge</para>
    ...
    let ``_/ReactiveCharge`` =
        Prefixed_Name(quantitykind, "/ReactiveCharge") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TotalLinearStoppingPower</para>
    ...
    let ``_/TotalLinearStoppingPower`` =
        Prefixed_Name(quantitykind, "/TotalLinearStoppingPower") |> PrefixedName
    ...
    let ``_/CenterOfGravity_Z`` =
        Prefixed_Name(quantitykind, "/CenterOfGravity_Z") |> PrefixedName
    ...
    let ``_/Friction`` = Prefixed_Name(quantitykind, "/Friction") |> PrefixedName
    ...
    let ``_/DynamicFrictionCoefficient`` =
        Prefixed_Name(quantitykind, "/DynamicFrictionCoefficient") |> PrefixedName
    ...
    let ``_/EllipticalOrbitApogeeVelocity`` =
        Prefixed_Name(quantitykind, "/EllipticalOrbitApogeeVelocity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:FlashPoint</para>
    ...
    let ``_/FlashPoint`` = Prefixed_Name(quantitykind, "/FlashPoint") |> PrefixedName
    ...
    let ``_/FlightPathAngle`` =
        Prefixed_Name(quantitykind, "/FlightPathAngle") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:FloatingPointCalculationCapability</para>
    /// labels<para>floating point calculation capability</para></remarks>
    ...
    let ``_/FloatingPointCalculationCapability`` =
        Prefixed_Name(quantitykind, "/FloatingPointCalculationCapability") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Fluidity</para>
    /// labels<para>fluidity</para><para>fluidity</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Fluidity">http://qudt.org/vocab/quantitykind/Fluidity</seealso>
    let ``_/Fluidity`` = Prefixed_Name(quantitykind, "/Fluidity") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/Flux</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Flux</para>
    ...
    let ``_/Flux`` = Prefixed_Name(quantitykind, "/Flux") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearIonization</para>
    ...
    let ``_/LinearIonization`` =
        Prefixed_Name(quantitykind, "/LinearIonization") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SectionModulus</para>
    ...
    let ``_/SectionModulus`` =
        Prefixed_Name(quantitykind, "/SectionModulus") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>surge impedance of the medium</para><para>surge impedance of the medium</para></remarks>
    ...
    let ``_/SurgeImpedanceOfTheMedium`` =
        Prefixed_Name(quantitykind, "/SurgeImpedanceOfTheMedium") |> PrefixedName
    ...
    let ``_/Concentration`` =
        Prefixed_Name(quantitykind, "/Concentration") |> PrefixedName
    ...
    let ``_/EffectiveExhaustVelocity`` =
        Prefixed_Name(quantitykind, "/EffectiveExhaustVelocity") |> PrefixedName
    ...
    let ``_/EffectiveMass`` =
        Prefixed_Name(quantitykind, "/EffectiveMass") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MultiplicationFactor</para>
    ...
    let ``_/MultiplicationFactor`` =
        Prefixed_Name(quantitykind, "/MultiplicationFactor") |> PrefixedName
    ...
    let ``_/InfiniteMultiplicationFactor`` =
        Prefixed_Name(quantitykind, "/InfiniteMultiplicationFactor") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DimensionlessRatio</para>
    /// labels<para>коэффициент полезного действия</para><para>Wirkungsgrad</para><para>rendimiento</para><para>eficiência</para><para>efficienza</para><para>efficiency</para><para>sprawność</para><para>rendement</para><para>كفاءة</para><para>效率</para><para>効率</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Efficiency">http://qudt.org/vocab/quantitykind/Efficiency</seealso>
    let ``_/Efficiency`` = Prefixed_Name(quantitykind, "/Efficiency") |> PrefixedName
    ...
    let ``_/EnergyExpenditure`` =
        Prefixed_Name(quantitykind, "/EnergyExpenditure") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EnergyFluence</para>
    ...
    let ``_/EnergyFluence`` =
        Prefixed_Name(quantitykind, "/EnergyFluence") |> PrefixedName
    ...
    let ``_/ForceMagnitude`` =
        Prefixed_Name(quantitykind, "/ForceMagnitude") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ForcePerAngle</para>
    ...
    let ``_/ForcePerAngle`` =
        Prefixed_Name(quantitykind, "/ForcePerAngle") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ForcePerAreaTime</para>
    ...
    let ``_/ForcePerAreaTime`` =
        Prefixed_Name(quantitykind, "/ForcePerAreaTime") |> PrefixedName
    ...
    let ``_/LogarithmRatioToBaseE`` =
        Prefixed_Name(quantitykind, "/LogarithmRatioToBaseE") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LogarithmicFrequencyInterval</para>
    /// labels<para>intervalle de fréquence logarithmique</para><para>intervallo logaritmico di frequenza</para><para>intervalo logarítmico de frequência</para><para>logarithmic frequency interval</para><para>Interval měření frekvence ?</para><para>Selang kekerapan logaritma</para><para>logaritmik frekans aralığı</para><para>فاصله فرکانس لگاریتمی</para><para>Frequenzmaßintervall</para><para>частотный интервал</para><para>对数频率间隔</para></remarks>
    ...
    let ``_/LogarithmicFrequencyInterval`` =
        Prefixed_Name(quantitykind, "/LogarithmicFrequencyInterval") |> PrefixedName
    ...
    let ``_/LogarithmicMedianInformationFlow_SourceToBase10`` =
        Prefixed_Name(quantitykind, "/LogarithmicMedianInformationFlow_SourceToBase10") |> PrefixedName
    ...
    let ``_/LogarithmicMedianInformationFlow_SourceToBase2`` =
        Prefixed_Name(quantitykind, "/LogarithmicMedianInformationFlow_SourceToBase2") |> PrefixedName
    ...
    let ``_/LogarithmicMedianInformationFlow_SourceToBaseE`` =
        Prefixed_Name(quantitykind, "/LogarithmicMedianInformationFlow_SourceToBaseE") |> PrefixedName
    ...
    let ``_/NaturalLogarithmicMedianInformationFlow`` =
        Prefixed_Name(quantitykind, "/NaturalLogarithmicMedianInformationFlow") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Long-RangeOrderParameter</para>
    ...
    let ``_/Long_RangeOrderParameter`` =
        Prefixed_Name(quantitykind, "/Long-RangeOrderParameter") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LorenzCoefficient</para>
    ...
    let ``_/LorenzCoefficient`` =
        Prefixed_Name(quantitykind, "/LorenzCoefficient") |> PrefixedName
    ...
    let ``_/LossAngle`` = Prefixed_Name(quantitykind, "/LossAngle") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/LossFactor</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LossFactor</para>
    ...
    let ``_/LossFactor`` = Prefixed_Name(quantitykind, "/LossFactor") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:QualityFactor</para>
    ...
    let ``_/QualityFactor`` =
        Prefixed_Name(quantitykind, "/QualityFactor") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Reactance</para>
    ...
    let ``_/Reactance`` = Prefixed_Name(quantitykind, "/Reactance") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/Resistance</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Resistance</para>
    ...
    let ``_/Resistance`` = Prefixed_Name(quantitykind, "/Resistance") |> PrefixedName
    /// <summary>
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Dimensionless</para>
    /// labels<para>loudness</para><para>loudness</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Loudness">http://qudt.org/vocab/quantitykind/Loudness</seealso>
    let ``_/Loudness`` = Prefixed_Name(quantitykind, "/Loudness") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassPerElectricCharge</para>
    ...
    let ``_/MassPerElectricCharge`` =
        Prefixed_Name(quantitykind, "/MassPerElectricCharge") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassPerEnergy</para>
    ...
    let ``_/MassPerEnergy`` =
        Prefixed_Name(quantitykind, "/MassPerEnergy") |> PrefixedName
    ...
    let ``_/OrbitalRadialDistance`` =
        Prefixed_Name(quantitykind, "/OrbitalRadialDistance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:OrderOfReflection</para>
    ...
    let ``_/OrderOfReflection`` =
        Prefixed_Name(quantitykind, "/OrderOfReflection") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:OsmoticCoefficient</para>
    ...
    let ``_/OsmoticCoefficient`` =
        Prefixed_Name(quantitykind, "/OsmoticCoefficient") |> PrefixedName
    ...
    let ``_/RadiantExposure`` =
        Prefixed_Name(quantitykind, "/RadiantExposure") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RadiantFluence</para>
    ...
    let ``_/RadiantFluence`` =
        Prefixed_Name(quantitykind, "/RadiantFluence") |> PrefixedName
    ...
    let ``_/ThermodynamicEntropy`` =
        Prefixed_Name(quantitykind, "/ThermodynamicEntropy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VolumetricHeatCapacity</para>
    ...
    let ``_/VolumetricHeatCapacity`` =
        Prefixed_Name(quantitykind, "/VolumetricHeatCapacity") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>volumic output power</para></remarks>
    ...
    let ``_/VolumetricOutputPower`` =
        Prefixed_Name(quantitykind, "/VolumetricOutputPower") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Length</para>
    /// labels<para>comprimento</para><para>lunghezza</para><para>longitudo</para><para>longitud</para><para>longueur</para><para>uzunluk</para><para>lungime</para><para>długość</para><para>dolžina</para><para>Дължина</para><para>Panjang</para><para>लम्बाई</para><para>length</para><para>Μήκος</para><para>Délka</para><para>hossz</para><para>Länge</para><para>Длина</para><para>אורך</para><para>طول</para><para>طول</para><para>长度</para><para>長さ</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Length">http://qudt.org/vocab/quantitykind/Length</seealso>
    let ``_/Length`` = Prefixed_Name(quantitykind, "/Length") |> PrefixedName
    ...
    let ``_/LuminousFluxPerArea`` =
        Prefixed_Name(quantitykind, "/LuminousFluxPerArea") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Impulse</para>
    /// labels<para>impulse</para><para>impulse</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Impulse">http://qudt.org/vocab/quantitykind/Impulse</seealso>
    let ``_/Impulse`` = Prefixed_Name(quantitykind, "/Impulse") |> PrefixedName
    ...
    let ``_/IncidenceProportion`` =
        Prefixed_Name(quantitykind, "/IncidenceProportion") |> PrefixedName
    ...
    let ``_/IncidenceRate`` =
        Prefixed_Name(quantitykind, "/IncidenceRate") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Inductance</para>
    /// labels<para>Inductance électrique</para><para>المحاثة (التحريض)</para><para>Индуктивность</para><para>Induktivität</para><para>induktivitás</para><para>Индуктивност</para><para>インダクタンス・誘導係数</para><para>indukcyjność</para><para>induktivnost</para><para>inductantia</para><para>inductancia</para><para>Indukstans</para><para>induttanza</para><para>inductance</para><para>Indukčnost</para><para>inductanță</para><para>indutância</para><para>İndüktans</para><para>प्रेरकत्व</para><para>القاوری</para><para>השראות</para><para>电感</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Inductance">http://qudt.org/vocab/quantitykind/Inductance</seealso>
    let ``_/Inductance`` = Prefixed_Name(quantitykind, "/Inductance") |> PrefixedName
    ...
    let ``_/NonActivePower`` =
        Prefixed_Name(quantitykind, "/NonActivePower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PressureGradient</para>
    /// labels<para>pressure gradient</para><para>pressure gradient</para></remarks>
    ...
    let ``_/PressureGradient`` =
        Prefixed_Name(quantitykind, "/PressureGradient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassRatio</para>
    ...
    let ``_/SingleStageLauncherMassRatio`` =
        Prefixed_Name(quantitykind, "/SingleStageLauncherMassRatio") |> PrefixedName
    ...
    let ``_/Slowing_DownArea`` =
        Prefixed_Name(quantitykind, "/Slowing-DownArea") |> PrefixedName
    ...
    let ``_/TemperaturePerTime`` =
        Prefixed_Name(quantitykind, "/TemperaturePerTime") |> PrefixedName
    ...
    let ``_/CONTROL_MASS`` =
        Prefixed_Name(quantitykind, "/CONTROL-MASS") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearVelocity</para>
    ...
    let ``_/LinearVelocity`` =
        Prefixed_Name(quantitykind, "/LinearVelocity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassEnergyTransferCoefficient</para>
    ...
    let ``_/MassEnergyTransferCoefficient`` =
        Prefixed_Name(quantitykind, "/MassEnergyTransferCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MortalityRate</para>
    ...
    let ``_/MortalityRate`` =
        Prefixed_Name(quantitykind, "/MortalityRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SurfaceDensity</para>
    ...
    let ``_/SurfaceDensity`` =
        Prefixed_Name(quantitykind, "/SurfaceDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SurfaceRelatedVolumeFlow</para>
    ...
    let ``_/SurfaceRelatedVolumeFlow`` =
        Prefixed_Name(quantitykind, "/SurfaceRelatedVolumeFlow") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Capacitance</para>
    ...
    let ``_/Capacitance`` = Prefixed_Name(quantitykind, "/Capacitance") |> PrefixedName
    ...
    let ``_/CartesianArea`` =
        Prefixed_Name(quantitykind, "/CartesianArea") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EnergyDensityOfStates</para>
    ...
    let ``_/EnergyDensityOfStates`` =
        Prefixed_Name(quantitykind, "/EnergyDensityOfStates") |> PrefixedName
    ...
    let ``_/ForcePerArea`` =
        Prefixed_Name(quantitykind, "/ForcePerArea") |> PrefixedName
    ...
    let ``_/InformationContentExpressedAsALogarithmToBaseE`` =
        Prefixed_Name(quantitykind, "/InformationContentExpressedAsALogarithmToBaseE") |> PrefixedName
    ...
    let ``_/LondonPenetrationDepth`` =
        Prefixed_Name(quantitykind, "/LondonPenetrationDepth") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassNumber</para>
    ...
    let ``_/MassNumber`` = Prefixed_Name(quantitykind, "/MassNumber") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:NumberOfParticles</para>
    ...
    let ``_/NumberOfParticles`` =
        Prefixed_Name(quantitykind, "/NumberOfParticles") |> PrefixedName
    ...
    let ``_/RadiantEmmitance`` =
        Prefixed_Name(quantitykind, "/RadiantEmmitance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RadiantEnergyDensity</para>
    ...
    let ``_/RadiantEnergyDensity`` =
        Prefixed_Name(quantitykind, "/RadiantEnergyDensity") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>radiant energy exposure</para></remarks>
    ...
    let ``_/RadiantEnergyExposure`` =
        Prefixed_Name(quantitykind, "/RadiantEnergyExposure") |> PrefixedName
    ...
    let ``_/ThermalInsulation`` =
        Prefixed_Name(quantitykind, "/ThermalInsulation") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VolumeFraction</para>
    ...
    let ``_/VolumeFraction`` =
        Prefixed_Name(quantitykind, "/VolumeFraction") |> PrefixedName
    ...
    let ``_/SpecificEnergy`` =
        Prefixed_Name(quantitykind, "/SpecificEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricChargeDensity</para>
    ...
    let ``_/ElectricChargeDensity`` =
        Prefixed_Name(quantitykind, "/ElectricChargeDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricChargeLineDensity</para>
    ...
    let ``_/ElectricChargeLineDensity`` =
        Prefixed_Name(quantitykind, "/ElectricChargeLineDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricChargeLinearDensity</para>
    ...
    let ``_/ElectricChargeLinearDensity`` =
        Prefixed_Name(quantitykind, "/ElectricChargeLinearDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricChargePerMass</para>
    ...
    let ``_/ElectricChargePerMass`` =
        Prefixed_Name(quantitykind, "/ElectricChargePerMass") |> PrefixedName
    ...
    let ``_/IntinsicCarrierDensity`` =
        Prefixed_Name(quantitykind, "/IntinsicCarrierDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InverseAmountOfSubstance</para>
    ...
    let ``_/InverseAmountOfSubstance`` =
        Prefixed_Name(quantitykind, "/InverseAmountOfSubstance") |> PrefixedName
    ...
    let ``_/UpperCriticalMagneticFluxDensity`` =
        Prefixed_Name(quantitykind, "/UpperCriticalMagneticFluxDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Luminance</para>
    ...
    let ``_/Luminance`` = Prefixed_Name(quantitykind, "/Luminance") |> PrefixedName
    ...
    let ``_/OsmoticConcentration`` =
        Prefixed_Name(quantitykind, "/OsmoticConcentration") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ForcePerArea</para>
    /// labels<para>pressione osmotica</para><para>pression osmotique</para><para>osmotischer Druck</para><para>presión osmótica</para><para>pressão osmótica</para><para>osmotic pressure</para><para>Tekanan osmotik</para><para>Osmotický tlak</para><para>ozmotik basıç</para><para>فشار اسمزی</para><para>渗透压</para></remarks>
    ...
    let ``_/OsmoticPressure`` =
        Prefixed_Name(quantitykind, "/OsmoticPressure") |> PrefixedName
    ...
    let ``_/OverRangeDistance`` =
        Prefixed_Name(quantitykind, "/OverRangeDistance") |> PrefixedName
    ...
    let ``_/PREDICTED_MASS`` =
        Prefixed_Name(quantitykind, "/PREDICTED-MASS") |> PrefixedName
    ...
    let ``_/PRODUCT_OF_INERTIA`` =
        Prefixed_Name(quantitykind, "/PRODUCT-OF-INERTIA") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Power</para>
    /// labels<para>moc promieniowania</para><para>potencia radiante</para><para>potência radiante</para><para>flux énergétique</para><para>flusso radiante</para><para>Strahlungsfluss</para><para>قدرة إشعاعية</para><para>radiant flux</para><para>放射パワー</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/RadiantFlux">http://qudt.org/vocab/quantitykind/RadiantFlux</seealso>
    let ``_/RadiantFlux`` = Prefixed_Name(quantitykind, "/RadiantFlux") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificElectricCharge</para>
    ...
    let ``_/SpecificElectricCharge`` =
        Prefixed_Name(quantitykind, "/SpecificElectricCharge") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificElectricCurrent</para>
    ...
    let ``_/SpecificElectricCurrent`` =
        Prefixed_Name(quantitykind, "/SpecificElectricCurrent") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThomsonCoefficient</para>
    ...
    let ``_/ThomsonCoefficient`` =
        Prefixed_Name(quantitykind, "/ThomsonCoefficient") |> PrefixedName
    ...
    let ``_/ThrustCoefficient`` =
        Prefixed_Name(quantitykind, "/ThrustCoefficient") |> PrefixedName
    ...
    let ``_/WaterHorsepower`` =
        Prefixed_Name(quantitykind, "/WaterHorsepower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:WaterVaporDiffusionCoefficient</para>
    ...
    let ``_/WaterVaporDiffusionCoefficient`` =
        Prefixed_Name(quantitykind, "/WaterVaporDiffusionCoefficient") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Length</para>
    /// labels<para>comprimento de onda</para><para>longitud de onda</para><para>lunghezza d'onda</para><para>longueur d'onde</para><para>Jarak gelombang</para><para>Vlnové délka</para><para>Wellenlänge</para><para>длина волны</para><para>wavelength</para><para>dalga boyu</para><para>طول موج</para><para>波长</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Wavelength">http://qudt.org/vocab/quantitykind/Wavelength</seealso>
    let ``_/Wavelength`` = Prefixed_Name(quantitykind, "/Wavelength") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/Wavenumber</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InverseLength</para>
    /// labels<para>Bilangan gelombang</para><para>valovno število</para><para>número de onda</para><para>Волновое число</para><para>nombre d'onde</para><para>Liczba falowa</para><para>numero d'onda</para><para>número de ola</para><para>dalga sayısı</para><para>Vlnové číslo</para><para>عدد الموجة</para><para>wavenumber</para><para>Repetenz</para><para>عدد موج</para><para>波数</para><para>波数</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Wavenumber">http://qudt.org/vocab/quantitykind/Wavenumber</seealso>
    let ``_/Wavenumber`` = Prefixed_Name(quantitykind, "/Wavenumber") |> PrefixedName
    /// <summary>
    ...
    let ``_/WebTime`` = Prefixed_Name(quantitykind, "/WebTime") |> PrefixedName
    ...
    let ``_/WebTimeAveragePressure`` =
        Prefixed_Name(quantitykind, "/WebTimeAveragePressure") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Length</para>
    /// labels<para>Kartézská soustava souřadnic</para><para>coordonnées cartésiennes</para><para>kartezyen koordinatları</para><para>coordenadas cartesianas</para><para>kartesische Koordinaten</para><para>coordinate cartesiane</para><para>Cartesian coordinates</para><para>Koordiant Kartesius</para><para>مختصات دکارتی</para><para>直角坐标系</para></remarks>
    ...
    let ``_/CartesianCoordinates`` =
        Prefixed_Name(quantitykind, "/CartesianCoordinates") |> PrefixedName
    ...
    let ``_/EinsteinTransitionProbabilityForSpontaneousOrInducedEmissionAndAbsorption`` =
        Prefixed_Name(quantitykind, "/EinsteinTransitionProbabilityForSpontaneousOrInducedEmissionAndAbsorption") |> PrefixedName
    ...
    let ``_/EnergyFluenceRate`` =
        Prefixed_Name(quantitykind, "/EnergyFluenceRate") |> PrefixedName
    ...
    let ``_/EnergyImparted`` =
        Prefixed_Name(quantitykind, "/EnergyImparted") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ForcePerElectricCharge</para>
    ...
    let ``_/ForcePerElectricCharge`` =
        Prefixed_Name(quantitykind, "/ForcePerElectricCharge") |> PrefixedName
    ...
    let ``_/MassOfElectricalPowerSupply`` =
        Prefixed_Name(quantitykind, "/MassOfElectricalPowerSupply") |> PrefixedName
    ...
    let ``_/MassOfSolidBooster`` =
        Prefixed_Name(quantitykind, "/MassOfSolidBooster") |> PrefixedName
    ...
    let ``_/OlfactoryThreshold`` =
        Prefixed_Name(quantitykind, "/OlfactoryThreshold") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:OpeningRatio</para>
    ...
    let ``_/OpeningRatio`` =
        Prefixed_Name(quantitykind, "/OpeningRatio") |> PrefixedName
    ...
    let ``_/VisionThresholds`` =
        Prefixed_Name(quantitykind, "/VisionThresholds") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AmountOfSubstanceFraction</para>
    ...
    let ``_/AmountOfSubstanceFraction`` =
        Prefixed_Name(quantitykind, "/AmountOfSubstanceFraction") |> PrefixedName
    ...
    let ``_/EffectiveMultiplicationFactor`` =
        Prefixed_Name(quantitykind, "/EffectiveMultiplicationFactor") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EinsteinCoefficients</para>
    /// labels<para>Einstein coefficients</para></remarks>
    ...
    let ``_/EinsteinCoefficients`` =
        Prefixed_Name(quantitykind, "/EinsteinCoefficients") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EinsteinTransitionProbability</para>
    ...
    let ``_/EinsteinTransitionProbability`` =
        Prefixed_Name(quantitykind, "/EinsteinTransitionProbability") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Energy</para>
    /// labels<para>внутренняя энергия</para><para>energia wewnętrzna</para><para>Notranja energija</para><para>vnitřní energie</para><para>energia interna</para><para>internal energy</para><para>energia interna</para><para>énergie interne</para><para>energie internă</para><para>energía interna</para><para>Tenaga dalaman</para><para>innere Energie</para><para>आन्तरिक ऊर्जा</para><para>طاقة داخلية</para><para>انرژی درونی</para><para>İç enerji</para><para>内部エネルギー</para><para>内能</para></remarks>
    ...
    let ``_/EnergyInternal`` =
        Prefixed_Name(quantitykind, "/EnergyInternal") |> PrefixedName
    ...
    let ``_/ForcePerLength`` =
        Prefixed_Name(quantitykind, "/ForcePerLength") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Fugacity</para>
    /// labels<para>fugacitate</para><para>fugacidade</para><para>Fugazität</para><para>fugacidad</para><para>Fugasiti</para><para>انفلاتية</para><para>fugacity</para><para>fügasite</para><para>fugacità</para><para>بی‌دوامی</para><para>fugacita</para><para>fugacité</para><para>Lotność</para><para>フガシティー</para><para>逸度</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Fugacity">http://qudt.org/vocab/quantitykind/Fugacity</seealso>
    let ``_/Fugacity`` = Prefixed_Name(quantitykind, "/Fugacity") |> PrefixedName
    ...
    let ``_/FundamentalLatticeVector`` =
        Prefixed_Name(quantitykind, "/FundamentalLatticeVector") |> PrefixedName
    ...
    let ``_/LatticeVector`` =
        Prefixed_Name(quantitykind, "/LatticeVector") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AngularReciprocalLatticeVector</para>
    ...
    let ``_/FundamentalReciprocalLatticeVector`` =
        Prefixed_Name(quantitykind, "/FundamentalReciprocalLatticeVector") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:IonTransportNumber</para>
    ...
    let ``_/IonTransportNumber`` =
        Prefixed_Name(quantitykind, "/IonTransportNumber") |> PrefixedName
    ...
    let ``_/IonicCharge`` = Prefixed_Name(quantitykind, "/IonicCharge") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LuminousIntensityDistribution</para>
    ...
    let ``_/LuminousIntensityDistribution`` =
        Prefixed_Name(quantitykind, "/LuminousIntensityDistribution") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MeltingPoint</para>
    ...
    let ``_/MeltingPoint`` =
        Prefixed_Name(quantitykind, "/MeltingPoint") |> PrefixedName
    ...
    let ``_/MicroCanonicalPartitionFunction`` =
        Prefixed_Name(quantitykind, "/MicroCanonicalPartitionFunction") |> PrefixedName
    ...
    let ``_/MicrobialFormation`` =
        Prefixed_Name(quantitykind, "/MicrobialFormation") |> PrefixedName
    ...
    let ``_/ParticleNumberDensity`` =
        Prefixed_Name(quantitykind, "/ParticleNumberDensity") |> PrefixedName
    ...
    let ``_/ParticlePositionVector`` =
        Prefixed_Name(quantitykind, "/ParticlePositionVector") |> PrefixedName
    ...
    let ``_/PathLength`` = Prefixed_Name(quantitykind, "/PathLength") |> PrefixedName
    /// <summary>
    ...
    let ``_/PayloadMass`` = Prefixed_Name(quantitykind, "/PayloadMass") |> PrefixedName
    ...
    let ``_/RadiusOfCurvature`` =
        Prefixed_Name(quantitykind, "/RadiusOfCurvature") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermodynamicTemperature</para>
    /// labels<para>Rankine temperature</para><para>Rankine temperature</para></remarks>
    ...
    let ``_/RankineTemperature`` =
        Prefixed_Name(quantitykind, "/RankineTemperature") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificWeight</para>
    ...
    let ``_/SpecificWeight`` =
        Prefixed_Name(quantitykind, "/SpecificWeight") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>time constant (inductance based)</para></remarks>
    ...
    let ``_/TimeConstant_Inductance`` =
        Prefixed_Name(quantitykind, "/TimeConstant_Inductance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TimePerCount</para>
    /// labels<para>Time per Count</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/TimePerCount">http://qudt.org/vocab/quantitykind/TimePerCount</seealso>
    let ``_/TimePerCount`` =
        Prefixed_Name(quantitykind, "/TimePerCount") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TimeRatio</para>
    ...
    let ``_/TimeRatio`` = Prefixed_Name(quantitykind, "/TimeRatio") |> PrefixedName
    ...
    let ``_/TimeRelatedLogarithmicRatio`` =
        Prefixed_Name(quantitykind, "/TimeRelatedLogarithmicRatio") |> PrefixedName
    ...
    let ``_/Time_Squared`` =
        Prefixed_Name(quantitykind, "/Time_Squared") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Force</para>
    ///   <para>Web Time Avg Thrust (Mlbf)</para>
    ...
    let ``_/WebTimeAverageThrust`` =
        Prefixed_Name(quantitykind, "/WebTimeAverageThrust") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Force</para>
    /// labels<para>Siła ciężkości</para><para>forza peso</para><para>greutate</para><para>Ağırlık</para><para>Gewicht</para><para>weight</para><para>Berat</para><para>poids</para><para>peso</para><para>tíha</para><para>peso</para><para>وزن</para><para>Вес</para><para>وزن</para><para>重さ</para><para>重量</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Weight">http://qudt.org/vocab/quantitykind/Weight</seealso>
    let ``_/Weight`` = Prefixed_Name(quantitykind, "/Weight") |> PrefixedName
    ...
    let ``_/WetBulbTemperature`` =
        Prefixed_Name(quantitykind, "/WetBulbTemperature") |> PrefixedName
    ...
    let ``_/Width`` = Prefixed_Name(quantitykind, "/Width") |> PrefixedName
    ...
    let ``_/AngleOfAttack`` =
        Prefixed_Name(quantitykind, "/AngleOfAttack") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Volume</para>
    ...
    let ``_/Volume`` = Prefixed_Name(quantitykind, "/Volume") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CatalyticActivityConcentration</para>
    ...
    let ``_/CatalyticActivityConcentration`` =
        Prefixed_Name(quantitykind, "/CatalyticActivityConcentration") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ReactiveChargePerMass</para>
    ...
    let ``_/ReactiveChargePerMass`` =
        Prefixed_Name(quantitykind, "/ReactiveChargePerMass") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Temperature</para>
    /// labels<para>درجة الحرارة المئوية أو السيلسيوس</para><para>دمای سلسیوس/سانتیگراد</para><para>Celsius temperature</para><para>temperatura Celsius</para><para>temperatura Celsius</para><para>Температура Цельсия</para><para>température Celsius</para><para>temperatură Celsius</para><para>temperatura celsius</para><para>Celsius-Temperatur</para><para>Celsius sıcaklık</para><para>सेल्सियस तापमान</para><para>Suhu Celsius</para><para>temperatura</para><para>temperatura</para><para>teplota</para><para>צלזיוס</para><para>温度</para><para>温度</para></remarks>
    ...
    let ``_/CelsiusTemperature`` =
        Prefixed_Name(quantitykind, "/CelsiusTemperature") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermodynamicTemperature</para>
    /// labels<para>temperatura thermodynamica absoluta</para><para>Термодинамическая температура</para><para>température thermodynamique</para><para>thermodynamische Temperatur</para><para>Термодинамична температура</para><para>thermodynamic temperature</para><para>temperatură termodinamică</para><para>temperatura termodinamica</para><para>Termodynamická teplota</para><para>termodinamik sıcaklık</para><para>abszolút hőmérséklet</para><para>درجة الحرارة المطلقة</para><para>ऊष्मगतिकीय तापमान</para><para>Suhu termodinamik</para><para>دمای ترمودینامیکی</para><para>טמפרטורה מוחלטת</para><para>temperatura</para><para>temperatura</para><para>temperatura</para><para>temperatura</para><para>Απόλυτη</para><para>熱力学温度</para><para>热力学温度</para></remarks>
    ...
    let ``_/ThermodynamicTemperature`` =
        Prefixed_Name(quantitykind, "/ThermodynamicTemperature") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AcousticImpedance</para>
    ...
    let ``_/CharacteristicAcousticImpedance`` =
        Prefixed_Name(quantitykind, "/CharacteristicAcousticImpedance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DataRate</para>
    ...
    let ``_/DataRate`` = Prefixed_Name(quantitykind, "/DataRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InformationFlowRate</para>
    ...
    let ``_/InformationFlowRate`` =
        Prefixed_Name(quantitykind, "/InformationFlowRate") |> PrefixedName
    ...
    let ``_/DataTransmissionRate`` =
        Prefixed_Name(quantitykind, "/DataTransmissionRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DatasetOfBits</para>
    /// labels<para>dataset of bits</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/DatasetOfBits">http://qudt.org/vocab/quantitykind/DatasetOfBits</seealso>
    let ``_/DatasetOfBits`` =
        Prefixed_Name(quantitykind, "/DatasetOfBits") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>dataset of bytes</para></remarks>
    ...
    let ``_/DatasetOfBytes`` =
        Prefixed_Name(quantitykind, "/DatasetOfBytes") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Debye-WallerFactor</para>
    ...
    let ``_/Debye_WallerFactor`` =
        Prefixed_Name(quantitykind, "/Debye-WallerFactor") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AngularFrequency</para>
    ...
    let ``_/DebyeAngularFrequency`` =
        Prefixed_Name(quantitykind, "/DebyeAngularFrequency") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:DebyeAngularWavenumber</para>
    ...
    let ``_/DebyeAngularWavenumber`` =
        Prefixed_Name(quantitykind, "/DebyeAngularWavenumber") |> PrefixedName
    ...
    let ``_/DebyeTemperature`` =
        Prefixed_Name(quantitykind, "/DebyeTemperature") |> PrefixedName
    ...
    let ``_/ExitPlaneCrossSectionalArea`` =
        Prefixed_Name(quantitykind, "/ExitPlaneCrossSectionalArea") |> PrefixedName
    ...
    let ``_/ExitPlanePressure`` =
        Prefixed_Name(quantitykind, "/ExitPlanePressure") |> PrefixedName
    ...
    let ``_/ExitPlaneTemperature`` =
        Prefixed_Name(quantitykind, "/ExitPlaneTemperature") |> PrefixedName
    ...
    let ``_/Exposure`` = Prefixed_Name(quantitykind, "/Exposure") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Speed</para>
    /// labels<para>Schallgeschwindigkeit</para><para>velocidad del sonido</para><para>velocità del suono</para><para>velocidade do som</para><para>viteza sunetului</para><para>prędkość dźwięku</para><para>rychlost zvuku</para><para>speed of sound</para><para>vitesse du son</para><para>скорость звука</para><para>Kelajuan bunyi</para><para>Hitrost zvoka</para><para>ध्वनि का वेग</para><para>سرعة الصوت</para><para>Ses hızı</para><para>سرعت صوت</para><para>音速</para><para>音速</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/SpeedOfSound">http://qudt.org/vocab/quantitykind/SpeedOfSound</seealso>
    let ``_/SpeedOfSound`` =
        Prefixed_Name(quantitykind, "/SpeedOfSound") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:GrowingDegreeDay</para>
    ...
    let ``_/GrowingDegreeDay`` =
        Prefixed_Name(quantitykind, "/GrowingDegreeDay") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TimeTemperature</para>
    ...
    let ``_/TimeTemperature`` =
        Prefixed_Name(quantitykind, "/TimeTemperature") |> PrefixedName
    ...
    let ``_/GrowingDegreeDay_Cereal`` =
        Prefixed_Name(quantitykind, "/GrowingDegreeDay_Cereal") |> PrefixedName
    ...
    let ``_/KineticEnergy`` =
        Prefixed_Name(quantitykind, "/KineticEnergy") |> PrefixedName
    ...
    let ``_/KineticOrThermalEnergy`` =
        Prefixed_Name(quantitykind, "/KineticOrThermalEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LagrangeFunction</para>
    ...
    let ``_/LagrangeFunction`` =
        Prefixed_Name(quantitykind, "/LagrangeFunction") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MadelungConstant</para>
    /// labels<para>Constante de Madelung</para><para>Constante de Madelung</para><para>constante de Madelung</para><para>Costante di Madelung</para><para>постоянная Маделунга</para><para>Madelung-Konstante</para><para>Madelung constant</para><para>Stała Madelunga</para><para>ثابت مادلونك</para><para>ثابت مادلونگ</para><para>マーデルングエネルギー</para><para>馬德隆常數</para></remarks>
    ...
    let ``_/MadelungConstant`` =
        Prefixed_Name(quantitykind, "/MadelungConstant") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticAreaMoment</para>
    ...
    let ``_/MagneticAreaMoment`` =
        Prefixed_Name(quantitykind, "/MagneticAreaMoment") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticMoment</para>
    /// labels<para>momento de dipolo magnético</para><para>momento de dipolo magnético</para><para>momento di dipolo magnetico</para><para>magnetisches Dipolmoment</para><para>चुम्बकीय द्विध्रुव</para><para>dipol magnetyczny</para><para>moment magnétique</para><para>Magnetický dipól</para><para>Магнитный момент</para><para>Manyetik moment</para><para>دوقطبی مغناطیسی</para><para>magnetic moment</para><para>Momen magnetik</para><para>عزم مغناطيسي</para><para>磁気双極子</para><para>磁偶极</para></remarks>
    ...
    let ``_/MagneticMoment`` =
        Prefixed_Name(quantitykind, "/MagneticMoment") |> PrefixedName
    ...
    let ``_/MagneticDipoleMomentOfAMolecule`` =
        Prefixed_Name(quantitykind, "/MagneticDipoleMomentOfAMolecule") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticField</para>
    ...
    let ``_/MagneticField`` =
        Prefixed_Name(quantitykind, "/MagneticField") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarFlowRate</para>
    ...
    let ``_/MolarFlowRate`` =
        Prefixed_Name(quantitykind, "/MolarFlowRate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarFluxDensity</para>
    ...
    let ``_/MolarFluxDensity`` =
        Prefixed_Name(quantitykind, "/MolarFluxDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarFluxDensityVariance</para>
    ...
    let ``_/MolarFluxDensityVariance`` =
        Prefixed_Name(quantitykind, "/MolarFluxDensityVariance") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarEnergy</para>
    /// labels<para>molar internal energy</para></remarks>
    ...
    let ``_/MolarInternalEnergy`` =
        Prefixed_Name(quantitykind, "/MolarInternalEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarMass</para>
    /// labels<para>Molární hmotnost</para><para>मोलर द्रव्यमान</para><para>Молярная масса</para><para>masse molaire</para><para>massa molare</para><para>Masă molară</para><para>Jisim molar</para><para>molar kütle</para><para>massa molar</para><para>molska masa</para><para>Masa molowa</para><para>كتلة مولية</para><para>molar mass</para><para>masa molar</para><para>Molmasse</para><para>جرم مولی</para><para>モル質量</para><para>摩尔质量</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/MolarMass">http://qudt.org/vocab/quantitykind/MolarMass</seealso>
    let ``_/MolarMass`` = Prefixed_Name(quantitykind, "/MolarMass") |> PrefixedName
    ...
    let ``_/PolarizationField`` =
        Prefixed_Name(quantitykind, "/PolarizationField") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Population</para>
    ...
    let ``_/Population`` = Prefixed_Name(quantitykind, "/Population") |> PrefixedName
    ...
    let ``_/PositiveDimensionlessRatio`` =
        Prefixed_Name(quantitykind, "/PositiveDimensionlessRatio") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>state density as expression of angular frequency)</para><para>state density as expression of angular frequency</para></remarks>
    ...
    let ``_/StateDensityAsExpressionOfAngularFrequency`` =
        Prefixed_Name(quantitykind, "/StateDensityAsExpressionOfAngularFrequency") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:StateOfCharge</para>
    ...
    let ``_/StateOfCharge`` =
        Prefixed_Name(quantitykind, "/StateOfCharge") |> PrefixedName
    ...
    let ``_/StaticFriction`` =
        Prefixed_Name(quantitykind, "/StaticFriction") |> PrefixedName
    ...
    let ``_/StaticFrictionCoefficient`` =
        Prefixed_Name(quantitykind, "/StaticFrictionCoefficient") |> PrefixedName
    ...
    let ``_/StaticPressure`` =
        Prefixed_Name(quantitykind, "/StaticPressure") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Volume</para>
    /// labels<para>prostornina</para><para>Επιτάχυνση</para><para>objętość</para><para>volumen</para><para>Isipadu</para><para>Volumen</para><para>volume</para><para>volume</para><para>volume</para><para>volume</para><para>Objem</para><para>hacim</para><para>volum</para><para>Объём</para><para>Обем</para><para>आयतन</para><para>حجم</para><para>حجم</para><para>נפח</para><para>体积</para><para>体積</para></remarks>
    ...
    let ``_/CartesianVolume`` =
        Prefixed_Name(quantitykind, "/CartesianVolume") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricChargeSurfaceDensity</para>
    ...
    let ``_/ElectricChargeSurfaceDensity`` =
        Prefixed_Name(quantitykind, "/ElectricChargeSurfaceDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricChargePerAmountOfSubstance</para>
    ...
    let ``_/ElectricChargePerAmountOfSubstance`` =
        Prefixed_Name(quantitykind, "/ElectricChargePerAmountOfSubstance") |> PrefixedName
    ...
    let ``_/MassOfTheEarth`` =
        Prefixed_Name(quantitykind, "/MassOfTheEarth") |> PrefixedName
    ...
    let ``_/OrbitalAngularMomentumPerMass`` =
        Prefixed_Name(quantitykind, "/OrbitalAngularMomentumPerMass") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermalInsulance</para>
    ...
    let ``_/ThermalInsulance`` =
        Prefixed_Name(quantitykind, "/ThermalInsulance") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>surface‑related volume flow rate</para></remarks>
    ...
    let ``_/VolumeFlowRate_SurfaceRelated`` =
        Prefixed_Name(quantitykind, "/VolumeFlowRate_SurfaceRelated") |> PrefixedName
    ...
    let ``_/VolumeFlowRatio`` =
        Prefixed_Name(quantitykind, "/VolumeFlowRatio") |> PrefixedName
    ...
    let ``_/Azimuth`` = Prefixed_Name(quantitykind, "/Azimuth") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CurvatureFromRadius</para>
    /// labels<para>Curvature</para></remarks>
    ...
    let ``_/CurvatureFromRadius`` =
        Prefixed_Name(quantitykind, "/CurvatureFromRadius") |> PrefixedName
    ...
    let ``_/CutoffCurrentRating`` =
        Prefixed_Name(quantitykind, "/CutoffCurrentRating") |> PrefixedName
    ...
    let ``_/CyclotronAngularFrequency`` =
        Prefixed_Name(quantitykind, "/CyclotronAngularFrequency") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EnergyPerAreaElectricCharge</para>
    ...
    let ``_/EnergyPerAreaElectricCharge`` =
        Prefixed_Name(quantitykind, "/EnergyPerAreaElectricCharge") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InverseTemperature</para>
    ...
    let ``_/InverseTemperature`` =
        Prefixed_Name(quantitykind, "/InverseTemperature") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InverseTimeTemperature</para>
    ...
    let ``_/InverseTimeTemperature`` =
        Prefixed_Name(quantitykind, "/InverseTimeTemperature") |> PrefixedName
    ...
    let ``_/IonDensity`` = Prefixed_Name(quantitykind, "/IonDensity") |> PrefixedName
    /// <summary>
    ...
    let ``_/IonCurrent`` = Prefixed_Name(quantitykind, "/IonCurrent") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LuminousFlux</para>
    /// labels<para>Fluks berluminositi</para><para>strumień świetlny</para><para>flusso luminoso</para><para>Светлинен поток</para><para>fluxo luminoso</para><para>Световой поток</para><para>flujo luminoso</para><para>प्रकाशीय बहाव</para><para>fluctús lucis</para><para>luminous flux</para><para>flux lumineux</para><para>svetlobni tok</para><para>التدفق الضوئي</para><para>flux luminos</para><para>Světelný tok</para><para>işık akısı</para><para>Lichtstrom</para><para>fényáram</para><para>شار نوری</para><para>שטף הארה</para><para>光通量</para><para>光束</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/LuminousFlux">http://qudt.org/vocab/quantitykind/LuminousFlux</seealso>
    let ``_/LuminousFlux`` =
        Prefixed_Name(quantitykind, "/LuminousFlux") |> PrefixedName
    ...
    let ``_/PRODUCT_OF_INERTIA_X`` =
        Prefixed_Name(quantitykind, "/PRODUCT-OF-INERTIA_X") |> PrefixedName
    ...
    let ``_/ProductOfInertia_X`` =
        Prefixed_Name(quantitykind, "/ProductOfInertia_X") |> PrefixedName
    ...
    let ``_/PRODUCT_OF_INERTIA_Y`` =
        Prefixed_Name(quantitykind, "/PRODUCT-OF-INERTIA_Y") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RadiantIntensity</para>
    ...
    let ``_/RadiantIntensity`` =
        Prefixed_Name(quantitykind, "/RadiantIntensity") |> PrefixedName
    ...
    let ``_/RadiativeHeatTransfer`` =
        Prefixed_Name(quantitykind, "/RadiativeHeatTransfer") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>radioactive decay</para></remarks>
    ...
    let ``_/RadioactiveDecay`` =
        Prefixed_Name(quantitykind, "/RadioactiveDecay") |> PrefixedName
    ...
    let ``_/Radioactivity`` =
        Prefixed_Name(quantitykind, "/Radioactivity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Radiosity</para>
    ...
    let ``_/Radiosity`` = Prefixed_Name(quantitykind, "/Radiosity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThrustToMassRatio</para>
    ...
    let ``_/ThrustToMassRatio`` =
        Prefixed_Name(quantitykind, "/ThrustToMassRatio") |> PrefixedName
    ...
    let ``_/ThrustToWeightRatio`` =
        Prefixed_Name(quantitykind, "/ThrustToWeightRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThrusterPowerToThrustEfficiency</para>
    ...
    let ``_/ThrusterPowerToThrustEfficiency`` =
        Prefixed_Name(quantitykind, "/ThrusterPowerToThrustEfficiency") |> PrefixedName
    ...
    let ``_/TimeAveragedSoundIntensity`` =
        Prefixed_Name(quantitykind, "/TimeAveragedSoundIntensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Avg Specific Impulse (lbf-sec/lbm) </para>
    ...
    let ``_/AverageSpecificImpulse`` =
        Prefixed_Name(quantitykind, "/AverageSpecificImpulse") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:CatalyticActivity</para>
    ...
    let ``_/CatalyticActivity`` =
        Prefixed_Name(quantitykind, "/CatalyticActivity") |> PrefixedName
    ...
    let ``_/CationExchangeCapacity`` =
        Prefixed_Name(quantitykind, "/CationExchangeCapacity") |> PrefixedName
    ...
    let ``_/DELTA_V`` = Prefixed_Name(quantitykind, "/DELTA-V") |> PrefixedName
    ...
    let ``_/InverseTime_Squared`` =
        Prefixed_Name(quantitykind, "/InverseTime_Squared") |> PrefixedName
    ...
    let ``_/IonConcentration`` =
        Prefixed_Name(quantitykind, "/IonConcentration") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LuminousEnergy</para>
    ...
    let ``_/LuminousEnergy`` =
        Prefixed_Name(quantitykind, "/LuminousEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassTemperature</para>
    ...
    let ``_/MassTemperature`` =
        Prefixed_Name(quantitykind, "/MassTemperature") |> PrefixedName
    ...
    let ``_/RadiantFluenceRate`` =
        Prefixed_Name(quantitykind, "/RadiantFluenceRate") |> PrefixedName
    ...
    let ``_/Thickness`` = Prefixed_Name(quantitykind, "/Thickness") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:WarpingMoment</para>
    ...
    let ``_/WarpingMoment`` =
        Prefixed_Name(quantitykind, "/WarpingMoment") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AngularImpulse</para>
    /// labels<para>impulsion angulaire</para><para>impulso angolare</para><para>نبضة دفعية زاوية</para><para>impulsão angular</para><para>angular impulse</para><para>impulso angular</para><para>popęd kątowy</para><para>Drehstoß</para><para>角冲量;冲量矩</para><para>角力積</para></remarks>
    ...
    let ``_/AngularImpulse`` =
        Prefixed_Name(quantitykind, "/AngularImpulse") |> PrefixedName
    ...
    let ``_/AngularMomentum`` =
        Prefixed_Name(quantitykind, "/AngularMomentum") |> PrefixedName
    ...
    let ``_/DRY_MASS`` = Prefixed_Name(quantitykind, "/DRY-MASS") |> PrefixedName
    ...
    let ``_/ElectricDipoleMoment_CubicPerEnergy_Squared`` =
        Prefixed_Name(quantitykind, "/ElectricDipoleMoment_CubicPerEnergy_Squared") |> PrefixedName
    ...
    let ``_/ElectricDipoleMoment_QuarticPerEnergy_Cubic`` =
        Prefixed_Name(quantitykind, "/ElectricDipoleMoment_QuarticPerEnergy_Cubic") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:QuarticElectricDipoleMomentPerCubicEnergy</para>
    /// labels<para>Quartic Electric Dipole Moment per Cubic Energy</para></remarks>
    ...
    let ``_/QuarticElectricDipoleMomentPerCubicEnergy`` =
        Prefixed_Name(quantitykind, "/QuarticElectricDipoleMomentPerCubicEnergy") |> PrefixedName
    ...
    let ``_/EquilibriumConstantBasedOnPressure`` =
        Prefixed_Name(quantitykind, "/EquilibriumConstantBasedOnPressure") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Irradiance</para>
    /// labels<para>Поверхностная плотность потока энергии</para><para>éclairement énergétique</para><para>پرتو افکنی/چگالی تابش</para><para>Bestrahlungsstärke</para><para>Intenzita záření</para><para>الطاقة الهلامية</para><para>Kepenyinaran</para><para>irradiância</para><para>irradiancia</para><para>irradiance</para><para>irradianza</para><para>yoğunluk</para><para>熱流束</para><para>辐照度</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Irradiance">http://qudt.org/vocab/quantitykind/Irradiance</seealso>
    let ``_/Irradiance`` = Prefixed_Name(quantitykind, "/Irradiance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:IsentropicCompressibility</para>
    ...
    let ``_/IsentropicCompressibility`` =
        Prefixed_Name(quantitykind, "/IsentropicCompressibility") |> PrefixedName
    ...
    let ``_/MASS_DELIVERED`` =
        Prefixed_Name(quantitykind, "/MASS-DELIVERED") |> PrefixedName
    ...
    let ``_/MASS_GROWTH_ALLOWANCE`` =
        Prefixed_Name(quantitykind, "/MASS-GROWTH-ALLOWANCE") |> PrefixedName
    ...
    let ``_/MASS_MARGIN`` = Prefixed_Name(quantitykind, "/MASS-MARGIN") |> PrefixedName
    ...
    let ``_/MASS_PROPERTY_UNCERTAINTY`` =
        Prefixed_Name(quantitykind, "/MASS-PROPERTY-UNCERTAINTY") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PhaseSpeedOfSound</para>
    ...
    let ``_/PhaseSpeedOfSound`` =
        Prefixed_Name(quantitykind, "/PhaseSpeedOfSound") |> PrefixedName
    ...
    let ``_/ReactionEnergy`` =
        Prefixed_Name(quantitykind, "/ReactionEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ReactivePower</para>
    /// labels<para>القدرة الكهربائية الردفعلية;الردية</para><para>puissance réactive</para><para>potencia reactiva</para><para>potenza reattiva</para><para>potência reativa</para><para>reactive power</para><para>Blindleistung</para><para>Kuasa reaktif</para><para>Jalový výkon</para><para>reaktif güç</para><para>توان راکتیو</para><para>moc bierna</para><para>無効電力</para><para>无功功率</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/ReactivePower">http://qudt.org/vocab/quantitykind/ReactivePower</seealso>
    let ``_/ReactivePower`` =
        Prefixed_Name(quantitykind, "/ReactivePower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SquareTime</para>
    ...
    let ``_/SquareTime`` = Prefixed_Name(quantitykind, "/SquareTime") |> PrefixedName
    ...
    let ``_/Transmittance`` =
        Prefixed_Name(quantitykind, "/Transmittance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TransmittanceDensity</para>
    ...
    let ``_/TransmittanceDensity`` =
        Prefixed_Name(quantitykind, "/TransmittanceDensity") |> PrefixedName
    ...
    let ``_/TrueExhaustVelocity`` =
        Prefixed_Name(quantitykind, "/TrueExhaustVelocity") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Acceleration</para>
    /// labels<para>Beschleunigung</para><para>przyspieszenie</para><para>accelerazione</para><para>accélération</para><para>acceleration</para><para>aceleración</para><para>accelerație</para><para>acceleratio</para><para>aceleração</para><para>Ускоре́ние</para><para>Zrychlení</para><para>pospešek</para><para>Pecutan</para><para>التسارع</para><para>त्वरण</para><para>Όγκος</para><para>ivme</para><para>شتاب</para><para>加速度</para><para>加速度</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Acceleration">http://qudt.org/vocab/quantitykind/Acceleration</seealso>
    let ``_/Acceleration`` =
        Prefixed_Name(quantitykind, "/Acceleration") |> PrefixedName
    ...
    let ``_/AccelerationOfGravity`` =
        Prefixed_Name(quantitykind, "/AccelerationOfGravity") |> PrefixedName
    ...
    let ``_/Radius`` = Prefixed_Name(quantitykind, "/Radius") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ApparentPower</para>
    /// labels<para>puissance apparente</para><para>potenza apparente</para><para>potência aparente</para><para>potencia aparente</para><para>القدرة الظاهرية</para><para>apparent power</para><para>Scheinleistung</para><para>moc pozorna</para><para>皮相電力</para><para>视在功率</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/ApparentPower">http://qudt.org/vocab/quantitykind/ApparentPower</seealso>
    let ``_/ApparentPower`` =
        Prefixed_Name(quantitykind, "/ApparentPower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ApparentThermalInertia</para>
    /// labels<para>Measurement Unit for a quantity approximately proportional to Thermal Inertia</para></remarks>
    ...
    let ``_/ApparentThermalInertia`` =
        Prefixed_Name(quantitykind, "/ApparentThermalInertia") |> PrefixedName
    ...
    let ``_/Temperature`` = Prefixed_Name(quantitykind, "/Temperature") |> PrefixedName
    /// <summary>
    ...
    let ``_/BraggAngle`` = Prefixed_Name(quantitykind, "/BraggAngle") |> PrefixedName
    /// <summary>
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Length</para>
    /// labels<para>larghezza</para><para>szerokość</para><para>genişliği</para><para>largeur</para><para>breadth</para><para>largura</para><para>Breite</para><para>širina</para><para>ширина</para><para>العرض</para><para>lebar</para><para>šířka</para><para>ancho</para><para>عرض</para><para>寬度</para><para>幅</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Breadth">http://qudt.org/vocab/quantitykind/Breadth</seealso>
    let ``_/Breadth`` = Prefixed_Name(quantitykind, "/Breadth") |> PrefixedName
    /// <summary>
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Frequency</para>
    /// labels<para>التردد لدى نظام الوحدات الدولي</para><para>częstotliwość</para><para>frekvencia</para><para>frecuencia</para><para>frequência</para><para>frequentia</para><para>Συχνότητα</para><para>frequency</para><para>Frekuensi</para><para>frequenza</para><para>fréquence</para><para>Frekvence</para><para>frecvență</para><para>frekvenca</para><para>Frequenz</para><para>Частота</para><para>आवृत्ति</para><para>Честота</para><para>frekans</para><para>תדירות</para><para>بسامد</para><para>周波数</para><para>频率</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Frequency">http://qudt.org/vocab/quantitykind/Frequency</seealso>
    let ``_/Frequency`` = Prefixed_Name(quantitykind, "/Frequency") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Frequency</para>
    /// labels<para>real part of complex frequency</para></remarks>
    ...
    let ``_/ComplexFrequency_Real`` =
        Prefixed_Name(quantitykind, "/ComplexFrequency_Real") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricPower</para>
    ...
    let ``_/ComplexPower`` =
        Prefixed_Name(quantitykind, "/ComplexPower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricPotentialDifference</para>
    /// labels<para>tensão elétrica (diferença de potencial)</para><para>Voltan Perbezaan keupayaan elektrik</para><para>differenza di potenziale elettrico</para><para>diferență de potențial electric</para><para>electric potential difference</para><para>электрическое напряжение</para><para>ولتاژ/ اختلاف پتانسیل</para><para>elektrische Spannung</para><para>napięcie elektryczne</para><para>električna napetost</para><para>tension électrique</para><para>elektrické napětí</para><para>tensión eléctrica</para><para>جهد كهربائي</para><para>विभवांतर</para><para>gerilim</para><para>電圧</para><para>電壓</para></remarks>
    ...
    let ``_/ElectricPotentialDifference`` =
        Prefixed_Name(quantitykind, "/ElectricPotentialDifference") |> PrefixedName
    ...
    let ``_/EnergyPerElectricCharge`` =
        Prefixed_Name(quantitykind, "/EnergyPerElectricCharge") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Power</para>
    /// labels<para>teljesítmény , hőáramlás</para><para>توان، نرخ جریان گرما</para><para>puissance</para><para>Мощность</para><para>Leistung</para><para>potência</para><para>potentia</para><para>potencia</para><para>potenza</para><para>Мощност</para><para>電力・仕事率</para><para>القدرة</para><para>putere</para><para>Výkon</para><para>power</para><para>功率、热流</para><para>Ισχύς</para><para>Kuasa</para><para>शक्ति</para><para>הספק</para><para>moc</para><para>güç</para><para>moč</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Power">http://qudt.org/vocab/quantitykind/Power</seealso>
    let ``_/Power`` = Prefixed_Name(quantitykind, "/Power") |> PrefixedName
    ...
    let ``_/ElectricPropulsionPropellantMass`` =
        Prefixed_Name(quantitykind, "/ElectricPropulsionPropellantMass") |> PrefixedName
    ...
    let ``_/PropellantMass`` =
        Prefixed_Name(quantitykind, "/PropellantMass") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricQuadrupoleMoment</para>
    /// labels<para>Электрический квадрупольный момент</para><para>elektryczny moment kwadrupolowy</para><para>momento de cuadrupolo eléctrico</para><para>moment quadrupolaire électrique</para><para>momento di quadrupolo elettrico</para><para>momento de quadrupolo elétrico</para><para>elektrisches Quadrupolmoment</para><para>elektrik kuadrupol momenti</para><para>electric quadrupole moment</para><para>گشتاور چهار قطبی الکتریکی</para><para>Momen kuadrupol elektrik</para><para>电四极矩</para><para>四極子</para></remarks>
    ...
    let ``_/ElectricQuadrupoleMoment`` =
        Prefixed_Name(quantitykind, "/ElectricQuadrupoleMoment") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricSusceptibility</para>
    /// labels<para>المتأثرية الكهربائية، سرعة التأثر الكهربائية</para><para>электрическая восприимчивость</para><para>elektrische Suszeptibilität</para><para>susceptibilidade eléctrica</para><para>susceptibilidad eléctrica</para><para>susceptibilité électrique</para><para>electric susceptibility</para><para>suscettività elettrica</para><para>podatność elektryczna</para><para>電気感受率</para></remarks>
    ...
    let ``_/ElectricSusceptibility`` =
        Prefixed_Name(quantitykind, "/ElectricSusceptibility") |> PrefixedName
    ...
    let ``_/FirstMomentOfArea`` =
        Prefixed_Name(quantitykind, "/FirstMomentOfArea") |> PrefixedName
    ...
    let ``_/FirstStageMassRatio`` =
        Prefixed_Name(quantitykind, "/FirstStageMassRatio") |> PrefixedName
    ...
    let ``_/MassRatio`` = Prefixed_Name(quantitykind, "/MassRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:FishBiotransformationHalfLife</para>
    ...
    let ``_/FishBiotransformationHalfLife`` =
        Prefixed_Name(quantitykind, "/FishBiotransformationHalfLife") |> PrefixedName
    ...
    let ``_/FissionCoreRadiusToHeightRatio`` =
        Prefixed_Name(quantitykind, "/FissionCoreRadiusToHeightRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LengthTemperature</para>
    ...
    let ``_/LengthTemperature`` =
        Prefixed_Name(quantitykind, "/LengthTemperature") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LengthTemperatureTime</para>
    ...
    let ``_/LengthTemperatureTime`` =
        Prefixed_Name(quantitykind, "/LengthTemperatureTime") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Lethargy</para>
    ...
    let ``_/Lethargy`` = Prefixed_Name(quantitykind, "/Lethargy") |> PrefixedName
    ...
    let ``_/MolarOpticalRotationalAbility`` =
        Prefixed_Name(quantitykind, "/MolarOpticalRotationalAbility") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarOpticalRotatoryPower</para>
    ...
    let ``_/MolarOpticalRotatoryPower`` =
        Prefixed_Name(quantitykind, "/MolarOpticalRotatoryPower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarRefractivity</para>
    ...
    let ``_/MolarRefractivity`` =
        Prefixed_Name(quantitykind, "/MolarRefractivity") |> PrefixedName
    ...
    let ``_/PositiveLength`` =
        Prefixed_Name(quantitykind, "/PositiveLength") |> PrefixedName
    ...
    let ``_/PositivePlaneAngle`` =
        Prefixed_Name(quantitykind, "/PositivePlaneAngle") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Energy</para>
    /// labels<para>потенциальная энергия</para><para>Energia potencjalna</para><para>potenciální energie</para><para>potentielle Energie</para><para>énergie potentielle</para><para>energia potenziale</para><para>Energie potențială</para><para>energía potencial</para><para>Potansiyel enerji</para><para>energia potencial</para><para>potential energy</para><para>Tenaga keupayaan</para><para>स्थितिज ऊर्जा</para><para>انرژی پتانسیل</para><para>طاقة وضع</para><para>位置エネルギー</para><para>势能</para></remarks>
    ...
    let ``_/PotentialEnergy`` =
        Prefixed_Name(quantitykind, "/PotentialEnergy") |> PrefixedName
    ...
    let ``_/ReverberationTime`` =
        Prefixed_Name(quantitykind, "/ReverberationTime") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SunProtectionFactorOfAProduct</para>
    /// labels<para>sun protection factor of a product</para></remarks>
    ...
    let ``_/SunProtectionFactorOfAProduct`` =
        Prefixed_Name(quantitykind, "/SunProtectionFactorOfAProduct") |> PrefixedName
    ...
    let ``_/SuperconductorEnergyGap`` =
        Prefixed_Name(quantitykind, "/SuperconductorEnergyGap") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SurfaceActivityDensity</para>
    ...
    let ``_/SurfaceActivityDensity`` =
        Prefixed_Name(quantitykind, "/SurfaceActivityDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SurfaceCoefficientOfHeatTransfer</para>
    ...
    let ``_/SurfaceCoefficientOfHeatTransfer`` =
        Prefixed_Name(quantitykind, "/SurfaceCoefficientOfHeatTransfer") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AngularWavenumber</para>
    /// labels<para>nombre d'onde angulaire</para><para>número de onda angular</para><para>número de onda angular</para><para>numero d'onda angolare</para><para>liczba falowa kątowa</para><para>angular wavenumber</para><para>عدد موجى زاوى</para><para>Kreisrepetenz</para><para>角波数</para><para>角波数</para></remarks>
    ...
    let ``_/AngularWavenumber`` =
        Prefixed_Name(quantitykind, "/AngularWavenumber") |> PrefixedName
    ...
    let ``_/ElectricField`` =
        Prefixed_Name(quantitykind, "/ElectricField") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricFlux</para>
    ...
    let ``_/ElectricFlux`` =
        Prefixed_Name(quantitykind, "/ElectricFlux") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricPolarizability</para>
    /// labels<para>elektrische Polarisierbarkeit</para><para>polarizzabilità elettrica</para><para>electric polarizability</para><para>Kepengkutuban elektrik</para><para>قطبیت پذیری الکتریکی</para><para>Kutuplanabilirlik</para><para>Polarizovatelnost</para><para>polarizabilidade</para><para>Polaryzowalność</para><para>Polarizabilidad</para><para>Поляризуемость</para><para>قابلية استقطاب</para><para>Polarisabilité</para><para>極化性</para><para>分極率</para></remarks>
    ...
    let ``_/ElectricPolarizability`` =
        Prefixed_Name(quantitykind, "/ElectricPolarizability") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricPolarization</para>
    /// labels<para>электрическая поляризация</para><para>polarizzazione elettrica</para><para>elektrische Polarisation</para><para>polaryzacja elektryczna</para><para>polarisation électrique</para><para>polarización eléctrica</para><para>polarização eléctrica</para><para>electric polarization</para><para>إستقطاب كهربائي</para><para>電気分極</para></remarks>
    ...
    let ``_/ElectricPolarization`` =
        Prefixed_Name(quantitykind, "/ElectricPolarization") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricPotential</para>
    /// labels<para>elektromos feszültség , elektromos potenciálkülönbség</para><para>электростатический потенциал</para><para>מתח חשמלי (הפרש פוטנציאלים)</para><para>Електрически потенциал</para><para>elektrisches Potenzial</para><para>potencjał elektryczny</para><para>potenziale elettrico</para><para>elektrik potansiyeli</para><para>elektrický potenciál</para><para>električni potencial</para><para>potentiel électrique</para><para>potencial eléctrico</para><para>potențial electric</para><para>Keupayaan elektrik</para><para>potencial elétrico</para><para>electric potential</para><para>tensio electrica</para><para>پتانسیل الکتریکی</para><para>كمون كهربائي</para><para>विद्युत विभव</para><para>電位</para><para>電勢</para></remarks>
    ...
    let ``_/ElectricPotential`` =
        Prefixed_Name(quantitykind, "/ElectricPotential") |> PrefixedName
    ...
    let ``_/ExposureRateOfIonizingRadiation`` =
        Prefixed_Name(quantitykind, "/ExposureRateOfIonizingRadiation") |> PrefixedName
    ...
    let ``_/FLIGHT_PERFORMANCE_RESERVE_PROPELLANT_MASS`` =
        Prefixed_Name(quantitykind, "/FLIGHT-PERFORMANCE-RESERVE-PROPELLANT-MASS") |> PrefixedName
    ...
    let ``_/FUEL_BIAS`` = Prefixed_Name(quantitykind, "/FUEL-BIAS") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Temperature</para>
    /// labels<para>Fahrenheit temperature</para><para>Fahrenheit temperature</para></remarks>
    ...
    let ``_/FahrenheitTemperature`` =
        Prefixed_Name(quantitykind, "/FahrenheitTemperature") |> PrefixedName
    ...
    let ``_/Incidence`` = Prefixed_Name(quantitykind, "/Incidence") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:FastFissionFactor</para>
    ...
    let ``_/FastFissionFactor`` =
        Prefixed_Name(quantitykind, "/FastFissionFactor") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:FermiAngularWavenumber</para>
    ...
    let ``_/FermiAngularWavenumber`` =
        Prefixed_Name(quantitykind, "/FermiAngularWavenumber") |> PrefixedName
    ...
    let ``_/FermiEnergy`` = Prefixed_Name(quantitykind, "/FermiEnergy") |> PrefixedName
    ...
    let ``_/FermiTemperature`` =
        Prefixed_Name(quantitykind, "/FermiTemperature") |> PrefixedName
    ...
    let ``_/FinalOrCurrentVehicleMass`` =
        Prefixed_Name(quantitykind, "/FinalOrCurrentVehicleMass") |> PrefixedName
    ...
    let ``_/HeatCapacityRatio`` =
        Prefixed_Name(quantitykind, "/HeatCapacityRatio") |> PrefixedName
    ...
    let ``_/HeatFlowRatePerArea`` =
        Prefixed_Name(quantitykind, "/HeatFlowRatePerArea") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LengthMolarEnergy</para>
    ...
    let ``_/LengthMolarEnergy`` =
        Prefixed_Name(quantitykind, "/LengthMolarEnergy") |> PrefixedName
    ...
    let ``_/LengthPerElectricCurrent`` =
        Prefixed_Name(quantitykind, "/LengthPerElectricCurrent") |> PrefixedName
    ...
    let ``_/LengthRatio`` = Prefixed_Name(quantitykind, "/LengthRatio") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/LevelWidth</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LevelWidth</para>
    ...
    let ``_/LevelWidth`` = Prefixed_Name(quantitykind, "/LevelWidth") |> PrefixedName
    ...
    let ``_/LiftCoefficient`` =
        Prefixed_Name(quantitykind, "/LiftCoefficient") |> PrefixedName
    ...
    let ``_/LiftForce`` = Prefixed_Name(quantitykind, "/LiftForce") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearAbsorptionCoefficient</para>
    ...
    let ``_/LinearAbsorptionCoefficient`` =
        Prefixed_Name(quantitykind, "/LinearAbsorptionCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticSusceptability</para>
    ...
    let ``_/MagneticSusceptability`` =
        Prefixed_Name(quantitykind, "/MagneticSusceptability") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticTension</para>
    ...
    let ``_/MagneticTension`` =
        Prefixed_Name(quantitykind, "/MagneticTension") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticVectorPotential</para>
    /// labels<para>potenziale vettore magnetico</para><para>magnetic vector potential</para><para>Keupayaan vektor magnetik</para><para>پتانسیل برداری مغناطیسی</para><para>magnetisches Potenzial</para><para>potencjał magnetyczny</para><para>magnetický potenciál</para><para>manyetik potansiyeli</para><para>potentiel magnétique</para><para>potencial magnético</para><para>Магнитний потенциал</para><para>potencial magnético</para><para>potențial magnetic</para><para>磁向量势</para></remarks>
    ...
    let ``_/MagneticVectorPotential`` =
        Prefixed_Name(quantitykind, "/MagneticVectorPotential") |> PrefixedName
    ...
    let ``_/MolarThermalCapacity`` =
        Prefixed_Name(quantitykind, "/MolarThermalCapacity") |> PrefixedName
    ...
    let ``_/MolarThermodynamicEnergy`` =
        Prefixed_Name(quantitykind, "/MolarThermodynamicEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarVolume</para>
    /// labels<para>Молярный объём</para><para>molski volumen</para><para>volume molaire</para><para>Isipadu molar</para><para>molární objem</para><para>volume molare</para><para>volumen molar</para><para>volume molar</para><para>molar volume</para><para>volume molar</para><para>volum molar</para><para>molar hacim</para><para>Molvolumen</para><para>حجم مولي</para><para>حجم مولی</para><para>摩尔体积</para><para>モル体積</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/MolarVolume">http://qudt.org/vocab/quantitykind/MolarVolume</seealso>
    let ``_/MolarVolume`` = Prefixed_Name(quantitykind, "/MolarVolume") |> PrefixedName
    ...
    let ``_/MoleFraction`` =
        Prefixed_Name(quantitykind, "/MoleFraction") |> PrefixedName
    ...
    let ``_/MolecularConcentration`` =
        Prefixed_Name(quantitykind, "/MolecularConcentration") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolecularMass</para>
    ...
    let ``_/MolecularMass`` =
        Prefixed_Name(quantitykind, "/MolecularMass") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ReynoldsNumber</para>
    ...
    let ``_/ReynoldsNumber`` =
        Prefixed_Name(quantitykind, "/ReynoldsNumber") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RichardsonConstant</para>
    ...
    let ``_/RichardsonConstant`` =
        Prefixed_Name(quantitykind, "/RichardsonConstant") |> PrefixedName
    ...
    let ``_/RiseOfOffStateVoltage`` =
        Prefixed_Name(quantitykind, "/RiseOfOffStateVoltage") |> PrefixedName
    ...
    let ``_/RocketAtmosphericTransverseForce`` =
        Prefixed_Name(quantitykind, "/RocketAtmosphericTransverseForce") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TorquePerAngle</para>
    ...
    let ``_/RotationalStiffness`` =
        Prefixed_Name(quantitykind, "/RotationalStiffness") |> PrefixedName
    ...
    let ``_/TorquePerAngle`` =
        Prefixed_Name(quantitykind, "/TorquePerAngle") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ScalarMagneticPotential</para>
    ...
    let ``_/ScalarMagneticPotential`` =
        Prefixed_Name(quantitykind, "/ScalarMagneticPotential") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SurfaceRelatedVolumeFlowRate</para>
    /// labels<para>surface‑related volume flow rate</para></remarks>
    ...
    let ``_/SurfaceRelatedVolumeFlowRate`` =
        Prefixed_Name(quantitykind, "/SurfaceRelatedVolumeFlowRate") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EnergyPerArea</para>
    /// labels<para>поверхностное натяжение</para><para>napięcie powierzchniowe</para><para>Tensiune superficială</para><para>tensione superficiale</para><para>tension superficielle</para><para>Oberflächenspannung</para><para>tensión superficial</para><para>površinska napetost</para><para>tensão superficial</para><para>Tegangan permukaan</para><para>povrchové napětí</para><para>surface tension</para><para>Yüzey gerilimi</para><para>पृष्ठ तनाव</para><para>توتر سطحي</para><para>کشش سطحی</para><para>表面张力</para><para>表面張力</para></remarks>
    ...
    let ``_/SurfaceTension`` =
        Prefixed_Name(quantitykind, "/SurfaceTension") |> PrefixedName
    ...
    let ``_/Susceptance`` = Prefixed_Name(quantitykind, "/Susceptance") |> PrefixedName
    ...
    let ``_/SymbolTransmissionRate`` =
        Prefixed_Name(quantitykind, "/SymbolTransmissionRate") |> PrefixedName
    ...
    let ``_/TARGET_BOGIE_MASS`` =
        Prefixed_Name(quantitykind, "/TARGET-BOGIE-MASS") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearAcceleration</para>
    ...
    let ``_/LinearAcceleration`` =
        Prefixed_Name(quantitykind, "/LinearAcceleration") |> PrefixedName
    ...
    let ``_/InverseLength`` =
        Prefixed_Name(quantitykind, "/InverseLength") |> PrefixedName
    ...
    let ``_/ApogeeRadius`` =
        Prefixed_Name(quantitykind, "/ApogeeRadius") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ChargeNumber</para>
    ...
    let ``_/ChargeNumber`` =
        Prefixed_Name(quantitykind, "/ChargeNumber") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarEnergy</para>
    /// labels<para>chemisches Potential des Stoffs B</para><para>Химический потенциал</para><para>Potencjał chemiczny</para><para>kimyasal potansiyel</para><para>Chemický potenciál</para><para>potenziale chimico</para><para>potential chimique</para><para>chemical potential</para><para>potencial químico</para><para>potencial químico</para><para>Potențial chimic</para><para>پتانسیل شیمیایی</para><para>Keupayaan kimia</para><para>جهد كيميائي</para><para>化学ポテンシャル</para><para>化学势</para></remarks>
    ...
    let ``_/ChemicalPotential`` =
        Prefixed_Name(quantitykind, "/ChemicalPotential") |> PrefixedName
    ...
    let ``_/MolarEnergy`` = Prefixed_Name(quantitykind, "/MolarEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Chromaticity</para>
    ...
    let ``_/Chromaticity`` =
        Prefixed_Name(quantitykind, "/Chromaticity") |> PrefixedName
    ...
    let ``_/Circulation`` = Prefixed_Name(quantitykind, "/Circulation") |> PrefixedName
    ...
    let ``_/ClosestApproachRadius`` =
        Prefixed_Name(quantitykind, "/ClosestApproachRadius") |> PrefixedName
    ...
    let ``_/ExhaustGasMeanMolecularWeight`` =
        Prefixed_Name(quantitykind, "/ExhaustGasMeanMolecularWeight") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpecificHeatCapacity</para>
    ...
    let ``_/ExhaustGasesSpecificHeat`` =
        Prefixed_Name(quantitykind, "/ExhaustGasesSpecificHeat") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:GeneralizedCoordinate</para>
    ...
    let ``_/GeneralizedCoordinate`` =
        Prefixed_Name(quantitykind, "/GeneralizedCoordinate") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:GeneralizedForce</para>
    ...
    let ``_/GeneralizedForce`` =
        Prefixed_Name(quantitykind, "/GeneralizedForce") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:GeneralizedMomentum</para>
    /// labels<para>Generalized Force</para></remarks>
    ...
    let ``_/GeneralizedMomentum`` =
        Prefixed_Name(quantitykind, "/GeneralizedMomentum") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:KinematicViscosity</para>
    /// labels<para>گرانروی جنبشی/ویسکوزیته جنبشی</para><para>kinematische Viskosität</para><para>кинематическую вязкость</para><para>Viscozitate cinematică</para><para>viscosidade cinemática</para><para>kinematična viskoznost</para><para>viscosité cinématique</para><para>viscosidad cinemática</para><para>lepkość kinematyczna</para><para>viscosità cinematica</para><para>kinematic viscosity</para><para>Kelikatan kinematik</para><para>Kinematik akmazlık</para><para>viskozita</para><para>श्यानता</para><para>لزوجة</para><para>运动粘度</para><para>粘度</para></remarks>
    ...
    let ``_/KinematicViscosity`` =
        Prefixed_Name(quantitykind, "/KinematicViscosity") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MomentOfInertia</para>
    /// labels<para>Massenträgheitsmoment</para><para>Moment bezwładności</para><para>Eylemsizlik momenti</para><para>Moment setrvačnosti</para><para>momento di inerzia</para><para>momento de inercia</para><para>momento de inércia</para><para>Moment de inerție</para><para>moment of inertia</para><para>عزم القصور الذاتي</para><para>moment d'inertie</para><para>Момент инерции</para><para>Momen inersia</para><para>जड़त्वाघूर्ण</para><para>گشتاور لختی</para><para>慣性モーメント</para><para>轉動慣量</para></remarks>
    ...
    let ``_/MomentOfInertia`` =
        Prefixed_Name(quantitykind, "/MomentOfInertia") |> PrefixedName
    ...
    let ``_/MOMENT_OF_INERTIA_Z`` =
        Prefixed_Name(quantitykind, "/MOMENT-OF-INERTIA_Z") |> PrefixedName
    ...
    let ``_/MomentOfInertia_Z`` =
        Prefixed_Name(quantitykind, "/MomentOfInertia_Z") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MachNumber</para>
    /// labels<para>Machovo število</para><para>numero di Mach</para><para>nombre de Mach</para><para>número de Mach</para><para>número de Mach</para><para>Machovo číslo</para><para>liczba Macha</para><para>Nombor Mach</para><para>Mach number</para><para>Mach sayısı</para><para>число Маха</para><para>मैक संख्या</para><para>număr Mach</para><para>Mach-Zahl</para><para>عدد ماخ</para><para>عدد ماخ</para><para>マッハ数n</para><para>马赫</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/MachNumber">http://qudt.org/vocab/quantitykind/MachNumber</seealso>
    let ``_/MachNumber`` = Prefixed_Name(quantitykind, "/MachNumber") |> PrefixedName
    ...
    let ``_/MacroscopicCrossSection`` =
        Prefixed_Name(quantitykind, "/MacroscopicCrossSection") |> PrefixedName
    ...
    let ``_/MacroscopicTotalCrossSection`` =
        Prefixed_Name(quantitykind, "/MacroscopicTotalCrossSection") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarAbsorptionCoefficient</para>
    ...
    let ``_/MolarAbsorptionCoefficient`` =
        Prefixed_Name(quantitykind, "/MolarAbsorptionCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarAngularMomentum</para>
    ...
    let ``_/MolarAngularMomentum`` =
        Prefixed_Name(quantitykind, "/MolarAngularMomentum") |> PrefixedName
    ...
    let ``_/MolarDensity`` =
        Prefixed_Name(quantitykind, "/MolarDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MolarEntropy</para>
    ...
    let ``_/MolarEntropy`` =
        Prefixed_Name(quantitykind, "/MolarEntropy") |> PrefixedName
    ...
    let ``_/TouchThresholds`` =
        Prefixed_Name(quantitykind, "/TouchThresholds") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>traffic intensity</para><para>traffic intensity</para></remarks>
    ...
    let ``_/TrafficIntensity`` =
        Prefixed_Name(quantitykind, "/TrafficIntensity") |> PrefixedName
    ...
    let ``_/TransmissionRatioBetweenRotationAndTranslation`` =
        Prefixed_Name(quantitykind, "/TransmissionRatioBetweenRotationAndTranslation") |> PrefixedName
    ...
    let ``_/DimensionlessRatio`` =
        Prefixed_Name(quantitykind, "/DimensionlessRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AbsoluteActivity</para>
    ...
    let ``_/AbsoluteActivity`` =
        Prefixed_Name(quantitykind, "/AbsoluteActivity") |> PrefixedName
    ...
    let ``_/NumberDensity`` =
        Prefixed_Name(quantitykind, "/NumberDensity") |> PrefixedName
    ...
    let ``_/IonizationEnergy`` =
        Prefixed_Name(quantitykind, "/IonizationEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Basicity</para>
    ...
    let ``_/Basicity`` = Prefixed_Name(quantitykind, "/Basicity") |> PrefixedName
    ...
    let ``_/AcousticImpedance`` =
        Prefixed_Name(quantitykind, "/AcousticImpedance") |> PrefixedName
    ...
    let ``_/ActionTime`` = Prefixed_Name(quantitykind, "/ActionTime") |> PrefixedName
    ...
    let ``_/InstantaneousPower`` =
        Prefixed_Name(quantitykind, "/InstantaneousPower") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Energy</para>
    /// labels<para>energia , munka , hő</para><para>Έργο - Ενέργεια</para><para>אנרגיה ועבודה</para><para>energija</para><para>Енергия</para><para>energie</para><para>Энергия</para><para>Energie</para><para>energia</para><para>energia</para><para>énergie</para><para>energia</para><para>Energie</para><para>energia</para><para>energia</para><para>الطاقة</para><para>energy</para><para>Tenaga</para><para>enerji</para><para>ऊर्जा</para><para>エネルギー</para><para>انرژی</para><para>能量</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Energy">http://qudt.org/vocab/quantitykind/Energy</seealso>
    let ``_/Energy`` = Prefixed_Name(quantitykind, "/Energy") |> PrefixedName
    /// <summary>
    ...
    let ``_/ActivePower`` = Prefixed_Name(quantitykind, "/ActivePower") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricPower</para>
    /// labels<para>puissance active</para><para>potencia activa</para><para>potência activa</para><para>electric power</para><para>potenza attiva</para><para>القدرة الفعالة</para><para>Wirkleistung</para><para>moc czynna</para><para>有効電力</para><para>有功功率</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/ElectricPower">http://qudt.org/vocab/quantitykind/ElectricPower</seealso>
    let ``_/ElectricPower`` =
        Prefixed_Name(quantitykind, "/ElectricPower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Activity</para>
    ...
    let ``_/Activity`` = Prefixed_Name(quantitykind, "/Activity") |> PrefixedName
    ...
    let ``_/StochasticProcess`` =
        Prefixed_Name(quantitykind, "/StochasticProcess") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ActivityCoefficient</para>
    ...
    let ``_/ActivityCoefficient`` =
        Prefixed_Name(quantitykind, "/ActivityCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassicActivity</para>
    ...
    let ``_/ActivityRelatedByMass`` =
        Prefixed_Name(quantitykind, "/ActivityRelatedByMass") |> PrefixedName
    ...
    let ``_/MassicActivity`` =
        Prefixed_Name(quantitykind, "/MassicActivity") |> PrefixedName
    ...
    let ``_/ActivityThresholds`` =
        Prefixed_Name(quantitykind, "/ActivityThresholds") |> PrefixedName
    ...
    let ``_/Adaptation`` = Prefixed_Name(quantitykind, "/Adaptation") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/Admittance</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Admittance</para>
    ...
    let ``_/Admittance`` = Prefixed_Name(quantitykind, "/Admittance") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/Impedance</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Impedance</para>
    ...
    let ``_/Impedance`` = Prefixed_Name(quantitykind, "/Impedance") |> PrefixedName
    ...
    let ``_/AlphaDisintegrationEnergy`` =
        Prefixed_Name(quantitykind, "/AlphaDisintegrationEnergy") |> PrefixedName
    ...
    let ``_/Altitude`` = Prefixed_Name(quantitykind, "/Altitude") |> PrefixedName
    ...
    let ``_/AmbientPressure`` =
        Prefixed_Name(quantitykind, "/AmbientPressure") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ForcePerArea</para>
    /// labels<para>الضغط أو الإجهاد</para><para>Πίεση - τάση</para><para>pressione</para><para>فشار، تنش</para><para>ciśnienie</para><para>presiune</para><para>pressure</para><para>Давление</para><para>pression</para><para>Налягане</para><para>Tekanan</para><para>presión</para><para>pressão</para><para>pressio</para><para>basınç</para><para>nyomás</para><para>Druck</para><para>压强、压力</para><para>दबाव</para><para>tlak</para><para>Tlak</para><para>לחץ</para><para>圧力</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Pressure">http://qudt.org/vocab/quantitykind/Pressure</seealso>
    let ``_/Pressure`` = Prefixed_Name(quantitykind, "/Pressure") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///
    /// labels<para>amount of biologically active substance</para></remarks>
    ...
    let ``_/AmountOfBiologicallyActiveSubstance`` =
        Prefixed_Name(quantitykind, "/AmountOfBiologicallyActiveSubstance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AmountOfCloudCover</para>
    ...
    let ``_/AmountOfCloudCover`` =
        Prefixed_Name(quantitykind, "/AmountOfCloudCover") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AmountOfSubstance</para>
    /// labels<para>quantidade de substância</para><para>cantitate de substanță</para><para>cantidad de sustancia</para><para>quantitas substantiae</para><para>quantità di sostanza</para><para>quantité de matière</para><para>Количество вещества</para><para>Количество вещество</para><para>amount of substance</para><para>Látkové množství</para><para>पदार्थ की मात्रा</para><para>liczność materii</para><para>Ποσότητα Ουσίας</para><para>anyagmennyiség</para><para>madde miktarı</para><para>množina snovi</para><para>Jumlah bahan</para><para>كمية المادة</para><para>مقدار ماده</para><para>Stoffmenge</para><para>כמות חומר</para><para>物质的量</para><para>物質量</para></remarks>
    ...
    let ``_/AmountOfSubstance`` =
        Prefixed_Name(quantitykind, "/AmountOfSubstance") |> PrefixedName
    ...
    let ``_/AmountOfSubstanceConcentration`` =
        Prefixed_Name(quantitykind, "/AmountOfSubstanceConcentration") |> PrefixedName
    ...
    let ``_/AmountOfSubstancePerVolume`` =
        Prefixed_Name(quantitykind, "/AmountOfSubstancePerVolume") |> PrefixedName
    ...
    let ``_/AmountOfSubstanceIonConcentration`` =
        Prefixed_Name(quantitykind, "/AmountOfSubstanceIonConcentration") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AmountOfSubstancePerMass</para>
    ...
    let ``_/AmountOfSubstancePerMass`` =
        Prefixed_Name(quantitykind, "/AmountOfSubstancePerMass") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AmountOfSubstancePerMassPressure</para>
    ...
    let ``_/AmountOfSubstancePerMassPressure`` =
        Prefixed_Name(quantitykind, "/AmountOfSubstancePerMassPressure") |> PrefixedName
    ...
    let ``_/Angle`` = Prefixed_Name(quantitykind, "/Angle") |> PrefixedName
    /// <summary>
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PlaneAngle</para>
    /// labels<para>الزاوية النصف قطرية</para><para>angulus planus</para><para>medida angular</para><para>Επίπεδη γωνία</para><para>düzlemsel açı</para><para>Равнинен ъгъл</para><para>ebener Winkel</para><para>ravninski kot</para><para>angolo piano</para><para>Плоский угол</para><para>ángulo plano</para><para>Rovinný úhel</para><para>Sudut satah</para><para>plane angle</para><para>زاویه مستوی</para><para>unghi plan</para><para>angle plan</para><para>kąt płaski</para><para>क्षेत्र</para><para>זווית</para><para>szög</para><para>角度</para><para>弧度</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/PlaneAngle">http://qudt.org/vocab/quantitykind/PlaneAngle</seealso>
    let ``_/PlaneAngle`` = Prefixed_Name(quantitykind, "/PlaneAngle") |> PrefixedName
    ...
    let ``_/AngleOfOpticalRotation`` =
        Prefixed_Name(quantitykind, "/AngleOfOpticalRotation") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AngularAcceleration</para>
    /// labels<para>Accelerație unghiulară</para><para>accelerazione angolare</para><para>accélération angulaire</para><para>Przyspieszenie kątowe</para><para>Winkelbeschleunigung</para><para>angular acceleration</para><para>aceleración angular</para><para>aceleração angular</para><para>Угловое ускорение</para><para>Pecutan bersudut</para><para>Úhlové zrychlení</para><para>شتاب زاویه‌ای</para><para>कोणीय त्वरण</para><para>Açısal ivme</para><para>تسارع زاوي</para><para>角加速度</para><para>角加速度</para></remarks>
    ...
    let ``_/AngularAcceleration`` =
        Prefixed_Name(quantitykind, "/AngularAcceleration") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:InverseSquareTime</para>
    /// labels<para>Inverse Square Time</para></remarks>
    ...
    let ``_/InverseSquareTime`` =
        Prefixed_Name(quantitykind, "/InverseSquareTime") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AngularCrossSection</para>
    ...
    let ``_/AngularCrossSection`` =
        Prefixed_Name(quantitykind, "/AngularCrossSection") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpectralCrossSection</para>
    ...
    let ``_/SpectralCrossSection`` =
        Prefixed_Name(quantitykind, "/SpectralCrossSection") |> PrefixedName
    ...
    let ``_/AngularDistance`` =
        Prefixed_Name(quantitykind, "/AngularDistance") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AngularFrequency</para>
    /// labels<para>frequência angular</para><para>frequenza angolare</para><para>angular frequency</para><para>Kreisfrequenz</para><para>تردد زاوى</para><para>pulsación</para><para>Pulsación</para><para>pulsacja</para><para>角振動数</para><para>角频率</para></remarks>
    ...
    let ``_/AngularFrequency`` =
        Prefixed_Name(quantitykind, "/AngularFrequency") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AngularVelocity</para>
    /// labels<para>Winkelgeschwindigkeit</para><para>velocidade angular</para><para>vitesse angulaire</para><para>velocità angolare</para><para>velocidad angular</para><para>Viteză unghiulară</para><para>angular velocity</para><para>Угловая скорость</para><para>Halaju bersudut</para><para>Úhlová rychlost</para><para>Prędkość kątowa</para><para>kotna hitrost</para><para>سرعت زاویه‌ای</para><para>Açısal hız</para><para>سرعة زاوية</para><para>कोणीय वेग</para><para>角速度</para><para>角速度</para></remarks>
    ...
    let ``_/AngularVelocity`` =
        Prefixed_Name(quantitykind, "/AngularVelocity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RotationalFrequency</para>
    ...
    let ``_/RotationalFrequency`` =
        Prefixed_Name(quantitykind, "/RotationalFrequency") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:RotationalVelocity</para>
    /// labels<para>RotationalFrequency</para></remarks>
    ...
    let ``_/RotationalVelocity`` =
        Prefixed_Name(quantitykind, "/RotationalVelocity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:AngularMomentumPerAngle</para>
    ...
    let ``_/AngularMomentumPerAngle`` =
        Prefixed_Name(quantitykind, "/AngularMomentumPerAngle") |> PrefixedName
    ...
    let ``_/AngularReciprocalLatticeVector`` =
        Prefixed_Name(quantitykind, "/AngularReciprocalLatticeVector") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricCurrentPerAngle</para>
    ...
    let ``_/ElectricCurrentPerAngle`` =
        Prefixed_Name(quantitykind, "/ElectricCurrentPerAngle") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricCurrentPerEnergy</para>
    ...
    let ``_/ElectricCurrentPerEnergy`` =
        Prefixed_Name(quantitykind, "/ElectricCurrentPerEnergy") |> PrefixedName
    ...
    let ``_/ElectricCurrentPerLength`` =
        Prefixed_Name(quantitykind, "/ElectricCurrentPerLength") |> PrefixedName
    ...
    let ``_/LinearElectricCurrentDensity`` =
        Prefixed_Name(quantitykind, "/LinearElectricCurrentDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricCurrentPerTemperature</para>
    ...
    let ``_/ElectricCurrentPerTemperature`` =
        Prefixed_Name(quantitykind, "/ElectricCurrentPerTemperature") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ElectricDipoleMoment</para>
    /// labels<para>Электрический дипольный момент</para><para>elektryczny moment dipolowy</para><para>momento di dipolo elettrico</para><para>momento de dipolo eléctrico</para><para>momento do dipolo elétrico</para><para>विद्युत द्विध्रुव आघूर्ण</para><para>elektrisches Dipolmoment</para><para>Momen dwikutub elektrik</para><para>moment electric dipolar</para><para>elektrik dipol momenti</para><para>electric dipole moment</para><para>گشتاور دوقطبی الکتریکی</para><para>moment dipolaire</para><para>Dipólový moment</para><para>عزم ثنائي قطب</para><para>電気双極子</para><para>电偶极矩</para></remarks>
    ...
    let ``_/ElectricDipoleMoment`` =
        Prefixed_Name(quantitykind, "/ElectricDipoleMoment") |> PrefixedName
    ...
    let ``_/SquareEnergy`` =
        Prefixed_Name(quantitykind, "/SquareEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EquilibriumConstant</para>
    ...
    let ``_/EquilibriumConstant`` =
        Prefixed_Name(quantitykind, "/EquilibriumConstant") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>The unit is unit:MOL-PER-M3 raised to the N where N is the summation of stoichiometric numbers. I don't know what to do with this.</para>
    ///   <para>Applicable units are those of quantitykind:EquilibriumConstant</para>
    ...
    let ``_/EquilibriumConstantOnConcentrationBasis`` =
        Prefixed_Name(quantitykind, "/EquilibriumConstantOnConcentrationBasis") |> PrefixedName
    ...
    let ``_/EquilibriumConstantOnPressureBasis`` =
        Prefixed_Name(quantitykind, "/EquilibriumConstantOnPressureBasis") |> PrefixedName
    ...
    let ``_/EquilibriumConstantBasedOnConcentration`` =
        Prefixed_Name(quantitykind, "/EquilibriumConstantBasedOnConcentration") |> PrefixedName
    ...
    let ``_/EquilibriumPositionVectorOfIon`` =
        Prefixed_Name(quantitykind, "/EquilibriumPositionVectorOfIon") |> PrefixedName
    ...
    let ``_/EquivalenceDoseOutput`` =
        Prefixed_Name(quantitykind, "/EquivalenceDoseOutput") |> PrefixedName
    ...
    let ``_/EquivalentAbsorptionArea`` =
        Prefixed_Name(quantitykind, "/EquivalentAbsorptionArea") |> PrefixedName
    ...
    let ``_/EquivalentConcentration`` =
        Prefixed_Name(quantitykind, "/EquivalentConcentration") |> PrefixedName
    ...
    let ``_/EquivalentDensity`` =
        Prefixed_Name(quantitykind, "/EquivalentDensity") |> PrefixedName
    ...
    let ``_/Equivalent_Mass`` =
        Prefixed_Name(quantitykind, "/Equivalent_Mass") |> PrefixedName
    ...
    let ``_/Equivalent_Molar`` =
        Prefixed_Name(quantitykind, "/Equivalent_Molar") |> PrefixedName
    ...
    let ``_/MolarEquivalent`` =
        Prefixed_Name(quantitykind, "/MolarEquivalent") |> PrefixedName
    ...
    let ``_/EvaporativeHeatTransfer`` =
        Prefixed_Name(quantitykind, "/EvaporativeHeatTransfer") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:EvaporativeHeatTransferCoefficient</para>
    /// labels<para>Combined Non Evaporative Heat Transfer Coefficient</para></remarks>
    ...
    let ``_/EvaporativeHeatTransferCoefficient`` =
        Prefixed_Name(quantitykind, "/EvaporativeHeatTransferCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ExchangeIntegral</para>
    ...
    let ``_/ExchangeIntegral`` =
        Prefixed_Name(quantitykind, "/ExchangeIntegral") |> PrefixedName
    ...
    let ``_/SpecificHeatCapacity`` =
        Prefixed_Name(quantitykind, "/SpecificHeatCapacity") |> PrefixedName
    ...
    let ``_/ExhaustStreamPower`` =
        Prefixed_Name(quantitykind, "/ExhaustStreamPower") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:GeneralizedVelocity</para>
    ...
    let ``_/GeneralizedVelocity`` =
        Prefixed_Name(quantitykind, "/GeneralizedVelocity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Gradient</para>
    /// labels<para>gradient</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Gradient">http://qudt.org/vocab/quantitykind/Gradient</seealso>
    let ``_/Gradient`` = Prefixed_Name(quantitykind, "/Gradient") |> PrefixedName
    ...
    let ``_/GrandCanonicalPartitionFunction`` =
        Prefixed_Name(quantitykind, "/GrandCanonicalPartitionFunction") |> PrefixedName
    ...
    let ``_/GravitationalAttraction`` =
        Prefixed_Name(quantitykind, "/GravitationalAttraction") |> PrefixedName
    ...
    let ``_/Gravity_API`` = Prefixed_Name(quantitykind, "/Gravity_API") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:GroupSpeedOfSound</para>
    ...
    let ``_/GroupSpeedOfSound`` =
        Prefixed_Name(quantitykind, "/GroupSpeedOfSound") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:GruneisenParameter</para>
    ...
    let ``_/GruneisenParameter`` =
        Prefixed_Name(quantitykind, "/GruneisenParameter") |> PrefixedName
    ...
    let ``_/GustatoryThreshold`` =
        Prefixed_Name(quantitykind, "/GustatoryThreshold") |> PrefixedName
    ...
    let ``_/GyromagneticRatio`` =
        Prefixed_Name(quantitykind, "/GyromagneticRatio") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Time</para>
    /// labels<para>tempo di dimezzamento</para><para>temps de demi-vie</para><para>yarılanma süresi</para><para>Poločas rozpadu</para><para>Separuh hayat</para><para>Halbwertszeit</para><para>semiperiodo</para><para>half-life</para><para>meia-vida</para><para>نیمه عمر</para><para>半衰期</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Half-Life">http://qudt.org/vocab/quantitykind/Half-Life</seealso>
    let ``_/Half_Life`` = Prefixed_Name(quantitykind, "/Half-Life") |> PrefixedName
    ...
    let ``_/Half_ValueThickness`` =
        Prefixed_Name(quantitykind, "/Half-ValueThickness") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:HallCoefficient</para>
    ...
    let ``_/HallCoefficient`` =
        Prefixed_Name(quantitykind, "/HallCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:HeartRate</para>
    ...
    let ``_/HeartRate`` = Prefixed_Name(quantitykind, "/HeartRate") |> PrefixedName
    /// <summary>
    ///   <para>quantitykind:/Heat</para>
    /// </summary>
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ThermalEnergy</para>
    /// labels<para>cantitate de căldură</para><para>quantité de chaleur</para><para>quantidade de calor</para><para>kuantiti haba Haba</para><para>jednotka tepla</para><para>ısı miktarı</para><para>کمیت گرما</para><para>toplota</para><para>Теплота</para><para>calore</para><para>ciepło</para><para>حرارة</para><para>ऊष्मा</para><para>labor</para><para>Wärme</para><para>calor</para><para>heat</para><para>熱量</para><para>热量</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Heat">http://qudt.org/vocab/quantitykind/Heat</seealso>
    let ``_/Heat`` = Prefixed_Name(quantitykind, "/Heat") |> PrefixedName
    ...
    let ``_/ThermalEnergy`` =
        Prefixed_Name(quantitykind, "/ThermalEnergy") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:HeatCapacity</para>
    /// labels<para>capacidad calorífica</para><para>toplotna kapaciteta</para><para>capacité thermique</para><para>capacidade térmica</para><para>capacitate termică</para><para>pojemność cieplna</para><para>tepelná kapacita</para><para>capacità termica</para><para>isı kapasitesi</para><para>Wärmekapazität</para><para>heat capacity</para><para>ظرفیت گرمایی</para><para>теплоёмкость</para><para>ऊष्मा धारिता</para><para>muatan haba</para><para>سعة حرارية</para><para>熱容量</para><para>热容</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/HeatCapacity">http://qudt.org/vocab/quantitykind/HeatCapacity</seealso>
    let ``_/HeatCapacity`` =
        Prefixed_Name(quantitykind, "/HeatCapacity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LandeGFactor</para>
    ...
    let ``_/LandeGFactor`` =
        Prefixed_Name(quantitykind, "/LandeGFactor") |> PrefixedName
    ...
    let ``_/LarmorAngularFrequency`` =
        Prefixed_Name(quantitykind, "/LarmorAngularFrequency") |> PrefixedName
    ...
    let ``_/LatticePlaneSpacing`` =
        Prefixed_Name(quantitykind, "/LatticePlaneSpacing") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LeakageFactor</para>
    ...
    let ``_/LeakageFactor`` =
        Prefixed_Name(quantitykind, "/LeakageFactor") |> PrefixedName
    ...
    let ``_/LengthByForce`` =
        Prefixed_Name(quantitykind, "/LengthByForce") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearElectricCurrentDensity</para>
    /// labels<para>intensidade de campo magnético</para><para>intensité de champ magnétique</para><para>intensidad de campo magnético</para><para>intensità di campo magnetico</para><para>magnetic field strength</para><para>Kekuatan medan magnetik</para><para>jakost magnetnega polja</para><para>magnetische Feldstärke</para><para>شدت میدان مغناطیسی</para><para>pole magnetyczne</para><para>Magnetické pole</para><para>Магнитное поле</para><para>Câmp magnetic</para><para>Manyetik alan</para><para>حقل مغناطيسي</para><para>磁場</para><para>磁場</para></remarks>
    ...
    let ``_/MagneticFieldStrength_H`` =
        Prefixed_Name(quantitykind, "/MagneticFieldStrength_H") |> PrefixedName
    ...
    let ``_/MagneticFluxDensityOrMagneticPolarization`` =
        Prefixed_Name(quantitykind, "/MagneticFluxDensityOrMagneticPolarization") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticFluxPerLength</para>
    ...
    let ``_/MagneticFluxPerLength`` =
        Prefixed_Name(quantitykind, "/MagneticFluxPerLength") |> PrefixedName
    ...
    let ``_/MagneticPolarization`` =
        Prefixed_Name(quantitykind, "/MagneticPolarization") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:LinearElectricCurrentDensity</para>
    /// labels<para>magnetizzazione</para><para>намагниченность</para><para>Magnetisierung</para><para>magnetization</para><para>magnetización</para><para>magnetização</para><para>magnetyzacia</para><para>aimantation</para><para>مغنطة</para><para>磁化</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/Magnetization">http://qudt.org/vocab/quantitykind/Magnetization</seealso>
    let ``_/Magnetization`` =
        Prefixed_Name(quantitykind, "/Magnetization") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticQuantumNumber</para>
    ...
    let ``_/MagneticQuantumNumber`` =
        Prefixed_Name(quantitykind, "/MagneticQuantumNumber") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:OrbitalAngularMomentumQuantumNumber</para>
    ...
    let ``_/OrbitalAngularMomentumQuantumNumber`` =
        Prefixed_Name(quantitykind, "/OrbitalAngularMomentumQuantumNumber") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PrincipalQuantumNumber</para>
    ...
    let ``_/PrincipalQuantumNumber`` =
        Prefixed_Name(quantitykind, "/PrincipalQuantumNumber") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SpinQuantumNumber</para>
    /// labels<para>Spin Quantum Number</para></remarks>
    ...
    let ``_/SpinQuantumNumber`` =
        Prefixed_Name(quantitykind, "/SpinQuantumNumber") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagneticReluctivity</para>
    ...
    let ``_/MagneticReluctivity`` =
        Prefixed_Name(quantitykind, "/MagneticReluctivity") |> PrefixedName
    ...
    let ``_/MagnetizationField`` =
        Prefixed_Name(quantitykind, "/MagnetizationField") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MagnetomotiveForce</para>
    ...
    let ``_/MagnetomotiveForce`` =
        Prefixed_Name(quantitykind, "/MagnetomotiveForce") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassAbsorptionCoefficient</para>
    ...
    let ``_/MassAbsorptionCoefficient`` =
        Prefixed_Name(quantitykind, "/MassAbsorptionCoefficient") |> PrefixedName
    ...
    let ``_/MassAmountOfSubstance`` =
        Prefixed_Name(quantitykind, "/MassAmountOfSubstance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassAmountOfSubstanceTemperature</para>
    ...
    let ``_/MassAmountOfSubstanceTemperature`` =
        Prefixed_Name(quantitykind, "/MassAmountOfSubstanceTemperature") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassAttenuationCoefficient</para>
    ...
    let ``_/MassAttenuationCoefficient`` =
        Prefixed_Name(quantitykind, "/MassAttenuationCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassConcentration</para>
    ...
    let ``_/MassConcentration`` =
        Prefixed_Name(quantitykind, "/MassConcentration") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassConcentrationOfWater</para>
    ...
    let ``_/MassConcentrationOfWater`` =
        Prefixed_Name(quantitykind, "/MassConcentrationOfWater") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassConcentrationOfWaterVapour</para>
    ...
    let ``_/MassConcentrationOfWaterVapour`` =
        Prefixed_Name(quantitykind, "/MassConcentrationOfWaterVapour") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:MassConcentrationRateOfChange</para>
    ...
    let ``_/MassConcentrationRateOfChange`` =
        Prefixed_Name(quantitykind, "/MassConcentrationRateOfChange") |> PrefixedName
    ...
    let ``_/PowerConstant`` =
        Prefixed_Name(quantitykind, "/PowerConstant") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PowerDensity</para>
    ...
    let ``_/PowerDensity`` =
        Prefixed_Name(quantitykind, "/PowerDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PowerPerVolume</para>
    ...
    let ``_/PowerPerVolume`` =
        Prefixed_Name(quantitykind, "/PowerPerVolume") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PowerFactor</para>
    /// labels<para>Коэффициент_мощности</para><para>facteur de puissance</para><para>factor de potencia</para><para>fattore di potenza</para><para>fator de potência</para><para>Współczynnik mocy</para><para>factor de putere</para><para>Leistungsfaktor</para><para>معامل القدرة</para><para>power factor</para><para>faktor kuasa</para><para>शक्ति गुणांक</para><para>güç faktörü</para><para>ضریب توان</para><para>Účiník</para><para>功率因数</para><para>力率</para></remarks>
    /// <seealso href="http://qudt.org/vocab/quantitykind/PowerFactor">http://qudt.org/vocab/quantitykind/PowerFactor</seealso>
    let ``_/PowerFactor`` = Prefixed_Name(quantitykind, "/PowerFactor") |> PrefixedName
    ...
    let ``_/PowerPerAreaAngle`` =
        Prefixed_Name(quantitykind, "/PowerPerAreaAngle") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PowerPerAreaQuarticTemperature</para>
    ...
    let ``_/PowerPerAreaQuarticTemperature`` =
        Prefixed_Name(quantitykind, "/PowerPerAreaQuarticTemperature") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PowerPerElectricCharge</para>
    ...
    let ``_/PowerPerElectricCharge`` =
        Prefixed_Name(quantitykind, "/PowerPerElectricCharge") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:PoyntingVector</para>
    /// labels<para>vecteur de Poynting</para><para>vettore di Poynting</para><para>vector de Poynting</para><para>vector de Poynting</para><para>вектор Пойнтинга</para><para>wektor Poyntinga</para><para>Poynting-Vektor</para><para>Poynting vector</para><para>متجَه بوينتنج</para><para>ポインティングベクトル</para></remarks>
    ...
    let ``_/PoyntingVector`` =
        Prefixed_Name(quantitykind, "/PoyntingVector") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SecondAxialMomentOfArea</para>
    ...
    let ``_/SecondAxialMomentOfArea`` =
        Prefixed_Name(quantitykind, "/SecondAxialMomentOfArea") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SecondMomentOfArea</para>
    /// labels<para>Geometryczny moment bezwładności</para><para>क्षेत्रफल का द्वितीय आघूर्ण</para><para>secondo momento di area</para><para>Segundo momento de área</para><para>segundo momento de érea</para><para>Flächenträgheitsmoment</para><para>second moment of area</para><para>moment quadratique</para><para>گشتاور دوم سطح</para><para>断面二次モーメント</para><para>截面二次轴矩</para></remarks>
    ...
    let ``_/SecondMomentOfArea`` =
        Prefixed_Name(quantitykind, "/SecondMomentOfArea") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SecondPolarMomentOfArea</para>
    ...
    let ``_/SecondPolarMomentOfArea`` =
        Prefixed_Name(quantitykind, "/SecondPolarMomentOfArea") |> PrefixedName
    ...
    let ``_/SecondRadiationConstant`` =
        Prefixed_Name(quantitykind, "/SecondRadiationConstant") |> PrefixedName
    ...
    let ``_/SecondStageMassRatio`` =
        Prefixed_Name(quantitykind, "/SecondStageMassRatio") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SectionAreaIntegral</para>
    ...
    let ``_/SectionAreaIntegral`` =
        Prefixed_Name(quantitykind, "/SectionAreaIntegral") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SeebeckCoefficient</para>
    ...
    let ``_/SeebeckCoefficient`` =
        Prefixed_Name(quantitykind, "/SeebeckCoefficient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SerumLevel</para>
    ...
    let ``_/SerumLevel`` = Prefixed_Name(quantitykind, "/SerumLevel") |> PrefixedName
    ...
    let ``_/SerumOrPlasmaLevel`` =
        Prefixed_Name(quantitykind, "/SerumOrPlasmaLevel") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ServiceFactor</para>
    ...
    let ``_/ServiceFactor`` =
        Prefixed_Name(quantitykind, "/ServiceFactor") |> PrefixedName
    ...
    let ``_/ShannonDiversityIndex`` =
        Prefixed_Name(quantitykind, "/ShannonDiversityIndex") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:ShearModulus</para>
    ...
    let ``_/ShearModulus`` =
        Prefixed_Name(quantitykind, "/ShearModulus") |> PrefixedName
    ...
    let ``_/ShearStrain`` = Prefixed_Name(quantitykind, "/ShearStrain") |> PrefixedName
    /// <summary>
    ...
    let ``_/ShearStress`` = Prefixed_Name(quantitykind, "/ShearStress") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Short-RangeOrderParameter</para>
    ...
    let ``_/Short_RangeOrderParameter`` =
        Prefixed_Name(quantitykind, "/Short-RangeOrderParameter") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:SignalDetectionThreshold</para>
    ...
    let ``_/SignalDetectionThreshold`` =
        Prefixed_Name(quantitykind, "/SignalDetectionThreshold") |> PrefixedName
    ...
    let ``_/TemperatureBasedDynamicViscosity`` =
        Prefixed_Name(quantitykind, "/TemperatureBasedDynamicViscosity") |> PrefixedName
    ...
    let ``_/TemperatureBasedKinematicViscosity`` =
        Prefixed_Name(quantitykind, "/TemperatureBasedKinematicViscosity") |> PrefixedName
    ...
    let ``_/TemperatureBasedLength`` =
        Prefixed_Name(quantitykind, "/TemperatureBasedLength") |> PrefixedName
    ...
    let ``_/TemperatureBasedMass`` =
        Prefixed_Name(quantitykind, "/TemperatureBasedMass") |> PrefixedName
    ...
    let ``_/TemperatureBasedMassFlowRate`` =
        Prefixed_Name(quantitykind, "/TemperatureBasedMassFlowRate") |> PrefixedName
    ...
    let ``_/TemperatureBasedQuantity`` =
        Prefixed_Name(quantitykind, "/TemperatureBasedQuantity") |> PrefixedName
    ...
    let ``_/TemperatureBasedVelocity`` =
        Prefixed_Name(quantitykind, "/TemperatureBasedVelocity") |> PrefixedName
    ...
    let ``_/TemperatureBasedVolumeFlowRate`` =
        Prefixed_Name(quantitykind, "/TemperatureBasedVolumeFlowRate") |> PrefixedName
    ...
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:Temperature</para>
    /// labels<para>temperature difference</para><para>Temperaturdifferenz</para></remarks>
    ...
    let ``_/TemperatureDifference`` =
        Prefixed_Name(quantitykind, "/TemperatureDifference") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TemperatureGradient</para>
    ...
    let ``_/TemperatureGradient`` =
        Prefixed_Name(quantitykind, "/TemperatureGradient") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TemperaturePerMagneticFluxDensity</para>
    ...
    let ``_/TemperaturePerMagneticFluxDensity`` =
        Prefixed_Name(quantitykind, "/TemperaturePerMagneticFluxDensity") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:TemperaturePerSquareTime</para>
    ...
    let ``_/TemperaturePerSquareTime`` =
        Prefixed_Name(quantitykind, "/TemperaturePerSquareTime") |> PrefixedName
    ...
    let ``_/VaporPermeability`` =
        Prefixed_Name(quantitykind, "/VaporPermeability") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VapourPermeability</para>
    ...
    let ``_/VapourPermeability`` =
        Prefixed_Name(quantitykind, "/VapourPermeability") |> PrefixedName
    ...
    let ``_/VaporPermeance`` =
        Prefixed_Name(quantitykind, "/VaporPermeance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VapourPermeance</para>
    ...
    let ``_/VapourPermeance`` =
        Prefixed_Name(quantitykind, "/VapourPermeance") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>qudt:QuantityKind</para>
    ///   <para>Applicable units are those of quantitykind:VaporPressure</para>
    ...
    let ``_/VaporPressure`` =
        Prefixed_Name(quantitykind, "/VaporPressure") |> PrefixedName
