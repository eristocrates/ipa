...
module r4r =
    ...
    ///
    /// labels<para>hasProvenance</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>RRObject</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>RRPolicy</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isPackagedWith</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>locateAt</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isCitedBy</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasLicense</para></remarks>
