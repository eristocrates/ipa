...
module premisv3 =
    ...
    ///   <para>"Ontology for PREMIS 3, the international standard       for metadata to support the preservation of digital objects and ensure their       long-term usability."</para>
    ...
    /// <summary>
    ///   <para>premisv3:2018/10/12/</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.loc.gov/premis/rdf/v3/2018/10/12/">http://www.loc.gov/premis/rdf/v3/2018/10/12/</seealso>
    let ``_2018/10/12/`` = Prefixed_Name(premisv3, "2018/10/12/") |> PrefixedName
    /// <summary>
    ...
    ///   <para>"Actor (human, machine, or software) associated with one or more Event and/or Rights       statement associated with a digital object."</para>
    ...
    ///   <para>"Contiguous or non-contiguous data within a file that has meaningful properties for       preservation purposes."</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Relationship where one Object requires another Object to support its function, delivery, or       the coherence of its content."</para>
    ...
    ///       purpose."</para>
    ///   <para>"An assessment of the extent to which the described environment supports its       purpose."</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Information used to verify whether an object has been altered in an undocumented or       unauthorized way."</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"An unambiguous reference to the PREMIS entity within the preservation       repository."</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Feature of a Digital Object intended to inhibit access, copying, dissemination, or       migration. Common Inhibitors are encryption and password protection."</para>
    ...
    ///   <para>"Discrete unit of information subject to digital preservation. Subclasses of Object are       Intellectual Entity, Representation, File and Bitstream."</para>
    ...
    ///   <para>"Statement about the Actions an Agent is permitted to undertake or prohibited from       undertaking with respect to an Object."</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Mathematical technique used to validate the authenticity and integrity of a message,       software or digital document."</para>
    ...
    ///   <para>"Characteristics of a particular object subjectively determined to be important to maintain       through preservation actions."</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A law that grants or revokes rights, such as laws governing privacy or orphan       works."</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Information needed to retrieve a physical item from its physical storage location or a file       from the storage system, or to access a bitstream within a file."</para>
    ...
    ///       DVD)."</para>
    ///   <para>"The physical medium on which the Object is stored (e.g., magnetic tape, hard disk, CD-ROM,       DVD)."</para>
    ...
    ///       it."</para>
    ///   <para>"Links from a RightsStatus to the RightsBasis instance that supports or documents       it."</para>
