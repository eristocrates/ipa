...
module taxref_ld =
    ...
    ///
    /// labels<para>TAXREF-LD</para></remarks>
    ...
    let ``property/hasBiologicalStage`` =
        Prefixed_Name(taxref_ld, "property/hasBiologicalStage") |> PrefixedName
    ...
    let ``property/hasSex`` =
        Prefixed_Name(taxref_ld, "property/hasSex") |> PrefixedName
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>Biota</para></remarks>
    ...
    let ``property/isReferenceNameOf`` =
        Prefixed_Name(taxref_ld, "property/isReferenceNameOf") |> PrefixedName
    ...
    let ``taxon/349525`` = Prefixed_Name(taxref_ld, "taxon/349525") |> PrefixedName
    ...
    let ``property/habitat`` =
        Prefixed_Name(taxref_ld, "property/habitat") |> PrefixedName
    ...
    let ``property/hasAuthority`` =
        Prefixed_Name(taxref_ld, "property/hasAuthority") |> PrefixedName
    ...
    let ``property/hasRank`` =
        Prefixed_Name(taxref_ld, "property/hasRank") |> PrefixedName
    ...
    let ``property/hasReferenceName`` =
        Prefixed_Name(taxref_ld, "property/hasReferenceName") |> PrefixedName
    ...
    let ``property/hasSpecificity`` =
        Prefixed_Name(taxref_ld, "property/hasSpecificity") |> PrefixedName
    ...
    let ``property/hasStatus`` =
        Prefixed_Name(taxref_ld, "property/hasStatus") |> PrefixedName
    ...
    let ``property/hasSynonym`` =
        Prefixed_Name(taxref_ld, "property/hasSynonym") |> PrefixedName
    ...
    let ``property/hasTrophicLevel`` =
        Prefixed_Name(taxref_ld, "property/hasTrophicLevel") |> PrefixedName
    ...
    let ``property/statusValue`` =
        Prefixed_Name(taxref_ld, "property/statusValue") |> PrefixedName
    ...
    let ``property/vernacularName`` =
        Prefixed_Name(taxref_ld, "property/vernacularName") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>This property was initially defined as a subPropertyOf skosxl:altLabel. However skosxl:altLabel is an owl:ObjectProperty and thus cannot apply to a class. Therefore, we instead define it a an owl:AnnotationProperty whose range is a skosxl:Label</para>
    ...
    let ``property/vernacularNameXL`` =
        Prefixed_Name(taxref_ld, "property/vernacularNameXL") |> PrefixedName
    ...
    let ``property/bioGeoStatusIn`` =
        Prefixed_Name(taxref_ld, "property/bioGeoStatusIn") |> PrefixedName
    ...
    ///
    /// labels<para>RDF generation process</para></remarks>
    ...
    let ``property/isSynonymOf`` =
        Prefixed_Name(taxref_ld, "property/isSynonymOf") |> PrefixedName
    ...
    ///
    /// labels<para>SPARQL endpoint serving the TAXREF-LD Knowledge Graph</para></remarks>
    ...
    ///   <para>nsprov:Entity</para>
    ///
    /// labels<para>TAXREF web service</para></remarks>
    ...
    ///
    /// labels<para>Morph-xR2RML</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>Introduced</para><para>Introduit</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>mentionné par erreur </para><para>reported in error</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>absent</para><para>absent</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>occasionnel</para><para>occasional</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>introduit non établi (dont domestique)</para><para>introduced casual</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>subendémique</para><para>subendemic</para></remarks>
    ...
    let ``property/statusType`` =
        Prefixed_Name(taxref_ld, "property/statusType") |> PrefixedName
    ...
    ///   <para>wikidata:Q82673</para>
    ///
    /// labels<para>Non applicable</para><para>Not applicable</para></remarks>
    ...
    ///   <para>wikidata:Q82673</para>
    ///
    /// labels<para>Probablement disparue au niveau régional</para><para>Probably extinct regionaly</para></remarks>
    ...
    let ``taxon/60878`` = Prefixed_Name(taxref_ld, "taxon/60878") |> PrefixedName
    /// <summary>
