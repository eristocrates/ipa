...
module pwo =
    ...
    let involvesAction = _prefix "involvesAction"
    /// <summary>
    ...
    let isActionInvolvedIn = _prefix "isActionInvolvedIn"
    /// <summary>
    ...
    let hasPreviousStep = _prefix "hasPreviousStep"
    /// <summary>
    ...
    let hasNextStep = _prefix "hasNextStep"
    /// <summary>
    ...
    let isNeededBy = _prefix "isNeededBy"
    /// <summary>
