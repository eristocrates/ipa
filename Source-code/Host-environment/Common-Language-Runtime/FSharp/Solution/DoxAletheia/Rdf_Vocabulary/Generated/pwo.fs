...
module pwo =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"An event with at least one agent that is participant in it and that is linked to a workflow execution and to a step of the related workflow description."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"This property allows to link a workflow description to the related workflow execution."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"is executed by"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
