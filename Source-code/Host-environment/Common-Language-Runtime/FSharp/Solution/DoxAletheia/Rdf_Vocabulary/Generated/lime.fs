...
module lime =
    ...
    /// labels<para>conjunto de datos del lexicón</para><para>banque de données lexicales</para><para>лексический набор данных</para><para>set de date de lexicon</para><para>banca dati lessicale</para><para>leksikale datastel</para><para>lexicale dataset</para><para>lexikondatamängd</para><para>Lexikondatensatz</para><para>lexicon dataset</para></remarks>
    ...
    /// labels<para>leksikon</para><para>лексикон</para><para>lexicon</para><para>Lexikon</para><para>lexikon</para><para>Lessico</para><para>Lexique</para><para>lexicón</para><para>lexicon</para><para>Lexicon</para></remarks>
    ...
    /// labels<para>verzameling van conceptialisaties</para><para>conjuto de conceptualizaciones</para><para>banque de concepitalisations</para><para>banca concettualizzazioni</para><para>Konzeptualisierungsatz</para><para>conceptualization set</para><para>набор концепций</para></remarks>
    ...
    /// labels<para>концептуальный набор данных</para><para>conjunto de conceptos</para><para>dataset van begrippen</para><para>conceptual dataset</para><para>banque de concepts</para><para>Konzeptdatensatz</para><para>banca concetti</para></remarks>
    ...
    /// labels<para>verzameling van taalkundige categories</para><para>conjunto de categoríes lingüísticas</para><para>banque de catégories linguistiques</para><para>linguistische Kategorienmodell</para><para>banca categorie linguistiche</para><para>лингвистический каталог</para><para>lingustic catalog</para></remarks>
    ...
    /// labels<para>referencias</para><para>referencias</para><para>riferimenti</para><para>referenties</para><para>references</para><para>referenser</para><para>Referenzen</para><para>références</para><para>verwysings</para><para>referințe</para><para>ссылки</para></remarks>
    ...
    /// labels<para>type van ressource</para><para>type de ressource</para><para>tipo di risorsa</para><para>tipo de recurso</para><para>resource type</para><para>Ressourcentyp</para><para>тип ресурса</para></remarks>
    ...
    /// labels<para>lessicalizzazioni</para><para>Lexikalisierungen</para><para>leksikaliserings</para><para>lexikaliseringar</para><para>lexicalizaciones</para><para>lexicalisations</para><para>lexicalizations</para><para>lexicalizações</para><para>lexicalisaties</para><para>лексикализации</para><para>lexicalizari</para></remarks>
    ...
    /// labels<para>verzameling van lexicale links</para><para>banque de liens lexicals</para><para>лексический набор ссылок</para><para>banca di link lessicali</para><para>lexikalisk länkmängd</para><para>leksikale skakelstel</para><para>conjunto de enlaces</para><para>Lexikonlinksatz</para><para>linkset lexical</para><para>lexical linkset</para></remarks>
    ...
    /// labels<para>partizione</para><para>partition</para><para>partición</para><para>verdeling</para><para>partition</para><para>Teilung</para><para>раздел</para></remarks>
    ...
    /// labels<para>pourcentage</para><para>percentuale</para><para>Prozentsatz</para><para>percentage</para><para>percentage</para><para>porcentaje</para><para>процент</para></remarks>
    ...
    /// labels<para>enlaces</para><para>Links</para><para>liens</para><para>связи</para><para>links</para><para>links</para><para>link</para></remarks>
    ...
    /// labels<para>înregistrare</para><para>inskrywing</para><para>entrata</para><para>entrada</para><para>entrada</para><para>Eintrag</para><para>ingång</para><para>запись</para><para>entrée</para><para>entry</para><para>Item</para></remarks>
    ...
    /// labels<para>Durchschnittliche Anzahl von Lexikalisierungen</para><para>genomsnittligt antal lexikaliseringar</para><para>gemiddeld aantal van lexicalisatie</para><para>gemiddelde aantal leksikaliserings</para><para>average number of lexicalizations</para><para>numero medio di lessicalizzazioni</para><para>среднее количество лексикализаций</para><para>nombre moyen de lexicalisations</para><para>numero medio de lexicalizações</para><para>numărul mediu de lexicalizari</para><para>promedio de lexicalizaciones</para></remarks>
    ...
    /// labels<para>language</para><para>Sprache</para><para>lingua</para><para>lengua</para><para>langue</para><para>idioma</para><para>limbă</para><para>språk</para><para>язык</para><para>taal</para><para>taal</para></remarks>
    ...
    /// labels<para>Durchschnittliche Amiguität</para><para>средняя неоднозначность</para><para>gemiddelde ambiguïteit</para><para>ambigüedad promedia</para><para>average ambiguity</para><para>ambiguïté moyenne</para><para>ambiguità media</para></remarks>
    ...
    /// labels<para>Durchschnittliche Anzahl von Links</para><para>gemiddeld aantal van links</para><para>среднее количество ссылок</para><para>average number of links</para><para>nombre moyen de liens</para><para>numero medio di link</para><para>promedio de enlaces</para></remarks>
    ...
    /// labels<para>Durchschnittliche Synonymie</para><para>sinóminedad promedia</para><para>gemiddelde synonymie</para><para>synonymie moyenne</para><para>средняя синонимия</para><para>sinonimità media</para><para>average synonymy</para></remarks>
    ...
    /// labels<para>conceptos</para><para>begrippen</para><para>concetti</para><para>Konzepte</para><para>concepts</para><para>concepts</para><para>понятия</para></remarks>
    ...
    /// labels<para>Konzeptualisierungen</para><para>conceptualizaciones</para><para>concettualizzazioni</para><para>conceptualizations</para><para>conceptualisations</para><para>conceptualisaties</para><para>концептуализации</para></remarks>
    ...
    /// labels<para>înregistrari lexicale</para><para>leksikale inskrywing</para><para>словарная единица</para><para>entrate lessicali</para><para>entradas lexicas</para><para>entradas léxicas</para><para>lexical entries</para><para>Lexikoneinträge</para><para>lexikoningångar</para><para>lexikaal items</para><para>lexie</para></remarks>
    ...
    /// labels<para>conjunto de datos de referencia</para><para>verzameling van referenties</para><para>setul de date de referință</para><para>справочный набор данных</para><para>banque de réfèrences</para><para>verwysingsdatastel</para><para>banca riferimenti</para><para>referensdatamängd</para><para>reference dataset</para><para>Referenzdatensatz</para></remarks>
    ...
    /// labels<para>modello di lessicalizzazione</para><para>modelo de lexicalización</para><para>modèle de lexicalisation</para><para>model van lexicalisatie</para><para>Lexikalisierungmodell</para><para>модель лексикализации</para><para>lexicalization model</para></remarks>
