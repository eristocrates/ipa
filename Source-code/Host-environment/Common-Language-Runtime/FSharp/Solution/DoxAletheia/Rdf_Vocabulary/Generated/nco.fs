...
module nco =
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>An account in an Instant Messaging system.</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>A class representing a person contact's birth date information. Possesses various attributes.</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>Deprecated in favour of nco:imCapabilityAudio.</para>
    /// labels<para>AudioIMAccount</para></remarks>
    ...
    ///   <para>Indicates the local IMAccount by which this IMAccount is accessed. This does not imply membership of a contact list.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>A nickname of the Object represented by this Contact. This is an equivalent of the 'NICKNAME' property as defined in RFC 2426 Sec. 3.1.3.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Sound clip attached to a Contact. The DataObject referred to by this property is usually interpreted as an nfo:Audio. Inspired by the SOUND property defined in RFC 2425 sec. 3.6.6.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The official title  the object represented by this contact in an organization. E.g. 'CEO', 'Director, Research and Development', 'Junior Software Developer/Analyst' etc. An equivalent of the 'TITLE' property defined in RFC 2426 Sec. 3.5.1</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>A nickname attached to a particular IM Account.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Photograph attached to a Contact. The DataObject referred to by this property is usually interpreted as an nfo:Image. Inspired by the PHOTO property defined in RFC 2426 sec. 3.1.4</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Indicates that this IMAccount publishes its presence information to the other IMAccount.</para>
    /// labels<para>publishesPresenceTo</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Role an object represented by this contact represents in the organization. This might include 'Programmer', 'Manager', 'Sales Representative'. Be careful to avoid confusion with the title property. An equivalent of the 'ROLE' property as defined in RFC 2426. Sec. 3.5.2. Note the difference between nco:Role class and nco:role property.</para>
    /// labels<para>role</para></remarks>
    /// <seealso href="http://www.semanticdesktop.org/ontologies/2007/03/22/nco#role">http://www.semanticdesktop.org/ontologies/2007/03/22/nco#role</seealso>
    let role = Prefixed_Name(nco, "role") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>Capabilities of a cetain IMAccount.</para>
    /// labels<para>imCapability</para></remarks>
    ...
    ///   <para>nco:IMStatusType</para>
    ///
    /// labels<para>offline</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>Instances of this class represent personal hobbies and interests.</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>The status type of an IMAccount. Based on the Connection_Presence_Type enumeration of the Telepathy project: http://telepathy.freedesktop.org/spec/Connection_Interface_Simple_Presence.html#Enum:Connection_Presence_Type</para>
    /// labels<para>instant messaging status type</para></remarks>
    ...
    ///   <para>nco:IMStatusType</para>
    ///
    /// labels<para>extended away</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>A class representing a contact's name. Possesses various attributes.</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>A class representing a person contact's name. Possesses various attributes.</para>
    /// labels<para>PersonName</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>Deprecated in favour of nco:imCapabilityVideo.</para>
    /// labels<para>VideoIMAccount</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Indicates the age of a person contact.</para>
    ...
    ///     'ContactList' class for details</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Creator of an information element, an entity primarily responsible for the creation of the content of the data object.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>End datetime for the role, such as: the datetime of leaving a project or organization, datetime of ending employment, datetime of divorce. If absent or set to a date in the future, the role is currently active.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>A comment about the contact medium. (Deprecated in favor of nie:comment or nao:description - based on the context)</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>A part of an address specyfing the country. Inspired by the seventh part of the value of the 'ADR' property as defined in RFC 2426, sec. 3.2.1</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Attaches birth date information to a person contact.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>A generic contact attribute introduced in order to enable customisation of contact details. Thus, systems using the NCO to model contact and person information, can introduce customised attributes by creating them as a subproperty of this one.</para>
    /// labels<para>hasCustomAttribute</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Indicates that an Instant Messaging account owned by an entity represented by this contact.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Attaches name information to a contact.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Indicates that an IMAccount has a certain capability.</para>
    /// labels<para>hasIMCapability</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Attaches name information to a person contact.</para>
    /// labels<para>hasPersonName</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Current status type of the given IM account. When this property is set, the nco:imStatus property should also always be set. Applications should attempt to parse the nco:imStatus property to determine the presence, only falling back to this property in the case that the nco:imStatus property's value is unrecognised.</para>
    /// labels<para>instant messaging status type</para></remarks>
    /// <seealso href="http://www.semanticdesktop.org/ontologies/2007/03/22/nco#imStatusType">http://www.semanticdesktop.org/ontologies/2007/03/22/nco#imStatusType</seealso>
    let imStatusType = Prefixed_Name(nco, "imStatusType") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Indicates that this IMAccount has been blocked.</para>
    /// labels<para>isBlocked</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Indicates that this IMAccount has requested a subscription to the presence information of the other IMAccount.</para>
    /// labels<para>requestedPresenceSubscriptionTo</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Start datetime for the role, such as: the datetime of joining a project or organization, datetime of starting employment, datetime of marriage</para>
