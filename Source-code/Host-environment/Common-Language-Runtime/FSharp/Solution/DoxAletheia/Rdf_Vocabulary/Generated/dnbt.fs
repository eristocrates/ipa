...
module dnbt =
    ...
    /// 			prov:wasAttributedTo :anAgent .
    /// 		:anAgent a prov:SoftwareAgent ."</para>
    /// labels<para>"Automated activity"</para><para>"Automatisierte Aktivität"</para></remarks>
    ...
    /// 			ex:confidenceValue 0.6^^xsd:decimal ;
    /// 			dnbt:qualifiesLanguage loc:ger ] ."</para>
    /// labels<para>"Qualified Language"</para><para>"Qualifizierte Sprache"</para></remarks>
    ...
    /// 			ex:confidenceValue 0.6^^xsd:decimal ;
    /// 			dnbt:qualifiesSubject gnd:12345-6 ] ."</para>
    /// labels<para>"Qualified subject"</para><para>"Qualifiziertes Thema"</para></remarks>
    ...
    /// labels<para>"DDC-Sachgruppe"</para><para>"DDC Subject Category"</para></remarks>
    ...
    /// labels<para>"Is described in"</para><para>"Wird beschrieben in"</para></remarks>
    ...
    ///
    /// labels<para>"Lars G. Svensson"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"Literary Genre Notation"</para><para>"Notation aus der Liste der Literarischen Gattungsbegriffe"</para></remarks>
    ...
    /// labels<para>"Qualifies subject"</para><para>"Qualifiziert Thema"</para></remarks>
    ...
    /// labels<para>"Thema classification notation"</para><para>"Notation aus der Thema-Klassifikation"</para></remarks>
