...
module li =
    ...
    ///
    /// labels<para>source reference system</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>source citation</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>source step</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Process step</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>source extent</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>scale denominator</para></remarks>
