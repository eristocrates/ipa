...
module jup =
    ...
    /// labels<para>"Typy hlaseni AOB"</para><para>"Types of AOB announcements"</para></remarks>
    ...
    /// labels<para>"Assessable entity"</para><para>"Ohodnotitelna entita"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Bell"</para><para>"Zvonek"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Bell type scheme"</para><para>"Schema typu zvonku"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Bottom entry area, entry and exit"</para><para>"Dolni nastupni plocha, vstup a dojezd"</para></remarks>
    ...
    /// labels<para>"Komplex budov"</para><para>"Building complex"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Types of contrast marking of glass surfaces"</para><para>"Typy umisteni kontrastniho znaceni prosklenych ploch"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Types of contrast marking of glass surfaces scheme"</para><para>"Schema typu umisteni kontrastniho znaceni prosklenych ploch"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Door"</para><para>"Dvere"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Door opening direction type scheme"</para><para>"Schema typu orientace otevirani dveri"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Door openings type scheme"</para><para>"Schema typu otevirani dveri"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Typy dveri"</para><para>"Door types"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Vytah"</para><para>"Elevator"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Dvere klece vytahu"</para><para>"Elevator cage door"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Schema typu umisteni zrcadla"</para><para>"Type of elevator cage mirror localizations scheme"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Typy plochych oznaceni ovladace vytahu"</para><para>"Types of elevator control flat markings"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Type of elevator control flat markings scheme"</para><para>"Schema typu plochych oznaceni ovladace vytahu"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Type of elevator control reliefs scheme"</para><para>"Schema typu reliefu oznaceni ovladace vytahu"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Typy dojezdu vytahu"</para><para>"Types of elevator drive-offs"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Typy vytahu"</para><para>"Types of elevators"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Schema typu vytahu"</para><para>"Type of elevators scheme"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Vstup"</para><para>"Entrance"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Schema pristupnosti vsupu"</para><para>"Entrance accessibility scheme"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Typy pristupnosti vstupu"</para><para>"Entrance accessibility types"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Entry area"</para><para>"Nastupni plocha"</para></remarks>
    ...
    ///   <para>"Types of elevator cage mirror localizations"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Types of entry area entries"</para><para>"Typy vstupu na nastupni plochu"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Form mapping entity"</para><para>"Formular mapujici entitu"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Hallway"</para><para>"Predsin"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Madlo"</para><para>"Handle"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Schema umisteni madla"</para><para>"Localization of handles scheme"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Orientace madel"</para><para>"Orientation of handels"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Schema orientace madla"</para><para>"Orientation of handles scheme"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Pozice madel"</para><para>"Positions of handels"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Schema typu madla"</para><para>"Handle type scheme"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Schodiste v interieru"</para><para>"Stairs inside the interior"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Podesta"</para><para>"Landings"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Steps in lobby"</para><para>"Schody v zadveri"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Vstup hlavni"</para><para>"Main entrance"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Forms mapping entities"</para><para>"Formulare mapujici entity"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Navigacni system pro osoby se zrakovym omezenim"</para><para>"Navigation system for visually handicapped persons"</para></remarks>
    ...
    /// labels<para>"Mapped object"</para><para>"Mapovany objekt"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Tristupnovy system ohodnoceni pristupnosti objektu dle Metodiky Kategorizace Pristupnosti Objektu"</para><para>"Three degree evaluation system for object accessibility based on Object Accessibility Categorization Methodology"</para></remarks>
    ...
    /// labels<para>"Organizace"</para><para>"Organization"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Fyzicka entita"</para><para>"Physical entity"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"Types of elevator cage mirror localizations"</para>
    /// labels<para>"Typy plosiny"</para><para>"Types of platforms"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Ramp handle (bannister)"</para><para>"Madlo (zabradli)u rampy"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Ramp leg"</para><para>"Rameno rampy"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"Types of elevator cage mirror localizations"</para>
    /// labels<para>"Lokalizace rampy/lizin"</para><para>"Localization of ramps/skids"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"Types of elevator cage mirror localizations"</para>
    /// labels<para>"Schema lokalizace rampy/lizin"</para><para>"Localisation of ramps/skids scheme"</para></remarks>
    ...
    ///   <para>"Types of elevator cage mirror localizations"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Schema typu mobility rampy/lizin"</para><para>"Mobility type of ramps/skids scheme"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"Types of elevator cage mirror localizations"</para>
    /// labels<para>"Typy mobility rampy/lizin"</para><para>"Mobility types of ramps/skids"</para></remarks>
    ...
    ///   <para>"Types of elevator cage mirror localizations"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Typy ramp"</para><para>"Types of ramp"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Skids"</para><para>"Liziny"</para></remarks>
    ...
    /// labels<para>"Steps, Stairs"</para><para>"Schody, Schodiste"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Stair type scheme"</para><para>"Schema typu schodiste"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Typy baterii"</para><para>"Types of taps"</para></remarks>
    ...
    /// labels<para>"Adapted WC"</para><para>"Upravene WC"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Leve madlo u WC"</para><para>"WC basin left handle"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Prave madlo u WC"</para><para>"WC basin right handle"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Schema typu prostoru pro vozik vedle WC misy"</para><para>"Type of wheelchair space next to closet scheme"</para></remarks>
    ...
    ///   <para>skos:ConceptScheme</para>
    ///
    /// labels<para>"Disposition of WC cabin scheme"</para><para>"Schema typu dispozic kabiny WC"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Typy umisteni kabiny WC"</para><para>"Localization of WC cabin"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Tristupnovy system ohodnoceni pristupnosti toalet dle Metodiky Kategorizace Pristupnosti Objektu"</para><para>"Three degree evaluation system for bathroom accessibility based on Object Accessibility Categorization Methodology"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Types of changing desks"</para><para>"Typy prebalovacich pultu"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Typy splachovani WC"</para><para>"Types of WC flushings"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Schema typu obtiznosti splachovani WC"</para><para>"Type of WC flushing difficulties scheme"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Typy vypinace"</para><para>"Types of WC switches"</para></remarks>
    ...
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    /// labels<para>"Schema typu vypinacu"</para><para>"Type of WC switches scheme"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Umyvadlo"</para><para>"WashBasin"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Madlo u umyvadla"</para><para>"WashBasin handle"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"WashBasin tap"</para><para>"Baterie u umyvadla"</para></remarks>
    ...
    ///   <para>"The list copied from the form based on Object Accessibility Categorization Methodology"</para>
    ///   <para>"Vycet prevzat z formularu dle Metodiky Kategorizace Pristupnosti Objektu"</para>
    /// labels<para>"Schema typu podjezdu umyvadla"</para><para>"Type of wash basin underpasses scheme"</para></remarks>
    ...
    ///
    /// labels<para>"Pristup k mapovatelne entite"</para><para>"Access to the mappable entity"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Assessable entity accessibility"</para><para>"Pristupnost ohodnotitelne entity"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Nad osou vstupnich dveri"</para><para>"Above the front door axis"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Lokalizace AOB v pripade, ze neni nad osou dveri"</para><para>"Localization of AOB in the case that not placed above the door axis"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Height of bell in cm"</para><para>"Vyska umisteni zvonku v cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Odsazeni zvonku od rohu v cm"</para><para>"Bell distance from corner in cm"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>""</para><para>"Objekt je soucasti komplexu budov"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Braille labelling"</para><para>"Oznaceni Braillovym pismem"</para></remarks>
    ...
    /// labels<para>"Entry created by a certified person"</para><para>"Zaznam byl vytvoreny certifikovanou osobou"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Contrast marking"</para><para>"Kontrastni znaceni"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Umisteni"</para><para>"Localization of contrast marking"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/contrastMarkingLocalization">http://w3id.org/charta77/jup/contrastMarkingLocalization</seealso>
    let contrastMarkingLocalization =
        Prefixed_Name(jup, "contrastMarkingLocalization") |> PrefixedName
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Entry creation date"</para><para>"Datum vytvoreni zaznamu"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Marking on door"</para><para>"Oznaceni na dverich"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Typ dveri"</para><para>"Type of door"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/doorType">http://w3id.org/charta77/jup/doorType</seealso>
    let doorType = Prefixed_Name(jup, "doorType") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///
    /// labels<para>"Pristup k vytahu"</para><para>"Access to elevator"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Vzdalenost ovladace uvnitr klece od nejblizsiho rohu v cm"</para><para>"Distance of control inside the cage from the nearest corner in cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Type of flat marking of control inside the cage"</para><para>"Typ plocheho oznaceni ovladace ovladace uvnitr klece"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Typ reliefu oznaceni ovladace uvnitr klece"</para><para>"Type of relief marking of control inside the cage"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Height of bottom side of mirror in cm"</para><para>"Vyska umisteni spodni hrany zrcadla v cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Pruchozi klec vytahu"</para><para>"Pass-through elevator cage"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Ovladani v dosahu sedatka"</para><para>"Control within reach of seat"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Umisteni druhych dveri pruchozi klece"</para><para>"Localization of elevator cage second door"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/elevatorCageSecondDoorLocalization">http://w3id.org/charta77/jup/elevatorCageSecondDoorLocalization</seealso>
    let elevatorCageSecondDoorLocalization =
        Prefixed_Name(jup, "elevatorCageSecondDoorLocalization") |> PrefixedName
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Sirka klece vytahu v cm"</para><para>"Width of elevator cage in cm"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Vytah spojuje patra"</para><para>"Elevator connects floors"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Typ reliefu oznaceni ovladace na nastupnich mistech"</para><para>"Type of relief marking of controls at places of entry"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/elevatorControlReliefMarking">http://w3id.org/charta77/jup/elevatorControlReliefMarking</seealso>
    let elevatorControlReliefMarking =
        Prefixed_Name(jup, "elevatorControlReliefMarking") |> PrefixedName
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Elevator drive-off at main landings or at mezzanines"</para><para>"Dojezd vytahu na hlavnich podestach nebo v mezipatrech"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/elevatorDriveOff">http://w3id.org/charta77/jup/elevatorDriveOff</seealso>
    let elevatorDriveOff = Prefixed_Name(jup, "elevatorDriveOff") |> PrefixedName
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Akusticke hlaseni ovladace uvnitr klece"</para><para>"Acoustic announcement of control inside the cage"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Oznaceni ovladace uvnitr klece Braillovym pismem"</para><para>"Braille relief marking of control inside the cage"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Seat is functional in all positions"</para><para>"Sedatko je funkcni ve vsech polohach"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Braille marking of controls at places of entry"</para><para>"Oznaceni ovladace na nastupnich mistech Braillovym pismem"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Lokalizace vytahu"</para><para>"Localization of elevator"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Typ vytahu"</para><para>"Type of elevator"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/elevatorType">http://w3id.org/charta77/jup/elevatorType</seealso>
    let elevatorType = Prefixed_Name(jup, "elevatorType") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///
    /// labels<para>"Pristup ke vstupu"</para><para>"Access to entrance"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Pristup ke vstupu zajisti"</para><para>"Access to entrance provided by"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Pristupnost vstupu"</para><para>"Accessibility of entrance"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/entranceAccessibility">http://w3id.org/charta77/jup/entranceAccessibility</seealso>
    let entranceAccessibility =
        Prefixed_Name(jup, "entranceAccessibility") |> PrefixedName
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Hloubka plochy pred dvermi v cm"</para><para>"Depth of area before the door in cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Sirka plochy pred dvermi v cm"</para><para>"Width of area before the door in cm"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Typ obtizneho povrchu (hruba historicka dlazba, popraskany asfalt…)"</para><para>"Type of difficult surface: (rough historical pavement, cracked tarmac…)"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Guiding line"</para><para>"Vodici linie"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/entranceGuidingLine">http://w3id.org/charta77/jup/entranceGuidingLine</seealso>
    let entranceGuidingLine = Prefixed_Name(jup, "entranceGuidingLine") |> PrefixedName
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Obtizny povrch"</para><para>"Difficult surface"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Sklon podelny"</para><para>"Longitudinal inclination"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Reserved parking places"</para><para>"Vyhrazene parkovaci stani"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"First and last step marked"</para><para>"Prvni a posledni schod kontrastne vyznacen"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Lobby depth in cm"</para><para>"Hloubka zadveri v cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Lobby width in cm"</para><para>"Sirka zadveri v cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Sklon podelny v %"</para><para>"Longitudinal inclination in %"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Pristup od vyhrazeneho parkovaciho stani ke vstupu objektu (bezbarierovy, obrubnik bez najezdu, zuzeni…)"</para><para>"Access from reserved parking places to the building entrance: (barrier-free, curb without a ramp, narrowing…)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Reserved parking places localization"</para><para>"Lokalizace vyhrazeneho parkovaciho stani"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Depth of entry area in cm"</para><para>"Hloubka nastupni plochy v cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Zavirani (dvirka, zabrana) vstupu"</para><para>"closing (doors, barriers) of entry area"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Vyska prevyseni mezi podlahou klece/plosiny a nastupistem v cm"</para><para>"Height elevation difference between platform floor and entry area in cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Width of entry area in cm"</para><para>"Sirka nastupni plochy v cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Sirka predsine v cm"</para><para>"Width of hallway in cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Umisteni madla"</para><para>"Handle localization"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/handleLocalization">http://w3id.org/charta77/jup/handleLocalization</seealso>
    let handleLocalization = Prefixed_Name(jup, "handleLocalization") |> PrefixedName
    /// <summary>
    ///   <para>jup:handleOrientation</para>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Orientace madla"</para><para>"Handle orientation"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/handleOrientation">http://w3id.org/charta77/jup/handleOrientation</seealso>
    let handleOrientation = Prefixed_Name(jup, "handleOrientation") |> PrefixedName
    /// <summary>
    ///   <para>jup:handlePosition</para>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Pozice madla"</para><para>"Handle position"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/handlePosition">http://w3id.org/charta77/jup/handlePosition</seealso>
    let handlePosition = Prefixed_Name(jup, "handlePosition") |> PrefixedName
    /// <summary>
    ///   <para>jup:handleType</para>
    ...
    /// labels<para>"Priloha"</para><para>"Attachment"</para></remarks>
    ...
    /// labels<para>"Unique ID in the particular context"</para><para>"Jednoznacny identifikator v danem kontextu"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Addressable entity latitude"</para><para>"Zemepisna sirka adresovatelne entity"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Addressable entity longitude"</para><para>"Zemepisna delka adresovatelne entity"</para></remarks>
    ...
    /// labels<para>"Mappable entity notes"</para><para>"Poznamky k mapovatelne entite"</para></remarks>
    ...
    /// labels<para>"RUIAN address points"</para><para>"Adresni misto podle RUIAN"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Pristup ke vstupu mapovatelne entity zajisti"</para><para>"Access to entrance to the mappable entity provided by"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Mappable entity accessibility"</para><para>"Pristupnost mapovatelne entity"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Vyska umisteni ovladace v cm"</para><para>"Control placement height in cm"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Lokalizace mapovatelne entity"</para><para>"Localization of mappable entity"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Seat placement height in cm"</para><para>"Vyska umisteni sedatka v cm"</para></remarks>
    ...
    ///   <para>"Certifikovana osoba vklada profesionalne (odborne) namerene udaje. K ziskani certifikace je nutne skoleni, zkouska, apod."</para>
    ///   <para>"A certified person enters professionally taken data. To become a certified person a special training, examination etc. is required."</para>
    /// labels<para>"Certified person"</para><para>"Cerifikovana osoba"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Object category"</para><para>"Kategorie budovy"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/objectCategory">http://w3id.org/charta77/jup/objectCategory</seealso>
    let objectCategory = Prefixed_Name(jup, "objectCategory") |> PrefixedName
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Zuzeny pruchod (mene nez 800mm)"</para><para>"Narrowed passage (less than 80 cm)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Lokalizace zuzeneho pruchodu"</para><para>"Narrowed passage localization"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Sirka zuzeneho pruchodu v cm"</para><para>"Narrowed passage width in cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Stairs width in cm"</para><para>"Sirka schodiste v cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Hloubka plosiny ve smeru jizdy v cm"</para><para>"Depth of platform in direction of motion in cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Min. rozmer 70 x 90 cm, min. nosnost 150 kg"</para><para>"Min. dimensions 70 x 90 cm, min. load capacity 150 kg"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Lokalizace plosiny"</para><para>"Platform localization"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Nosnost v kg"</para><para>"Maximum load in kg"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Vyska umisteni ovladacu vne plosiny nahore v cm"</para><para>"Height of control outside the platform top in cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Typ plosiny"</para><para>"Type of platform"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/platformType">http://w3id.org/charta77/jup/platformType</seealso>
    let platformType = Prefixed_Name(jup, "platformType") |> PrefixedName
    /// <summary>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Pristup k rampe zajisti"</para><para>"Access to the ramp provided by"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Delka ramena v cm"</para><para>"Length of rampLeg in cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Sirka ramena v cm"</para><para>"Width of rampLeg in cm"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Lokalizace rampy/lizin"</para><para>"Localization of ramp/skids"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/rampSkidsLocalization">http://w3id.org/charta77/jup/rampSkidsLocalization</seealso>
    let rampSkidsLocalization =
        Prefixed_Name(jup, "rampSkidsLocalization") |> PrefixedName
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Ramp/skids mobility"</para><para>"Mobilita rampy/lizin"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/rampSkidsMobility">http://w3id.org/charta77/jup/rampSkidsMobility</seealso>
    let rampSkidsMobility = Prefixed_Name(jup, "rampSkidsMobility") |> PrefixedName
    /// <summary>
    ///   <para>jup:rampSurface</para>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Ramp surface"</para><para>"Povrch rampy"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/rampSurface">http://w3id.org/charta77/jup/rampSurface</seealso>
    let rampSurface = Prefixed_Name(jup, "rampSurface") |> PrefixedName
    /// <summary>
    ///   <para>jup:rampType</para>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Typ rampy"</para><para>"Type of ramp"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/rampType">http://w3id.org/charta77/jup/rampType</seealso>
    let rampType = Prefixed_Name(jup, "rampType") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"Odkaz na zdroj informaci o entite"</para><para>"Entity information source reference"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Sklon lizin v %"</para><para>"Skids inclination in %"</para></remarks>
    ...
    /// labels<para>"Localization of steps or stairs"</para><para>"Lokalizace schodu nebo schodiste"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Pocet schodu"</para><para>"Number of steps"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Vyska umisteni vypinace v cm"</para><para>"Switch placement height in cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Height of tap in cm"</para><para>"Vyska umisteni baterie od podlahy v cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Type of tap"</para><para>"Typ baterie"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/tapType">http://w3id.org/charta77/jup/tapType</seealso>
    let tapType = Prefixed_Name(jup, "tapType") |> PrefixedName
    /// <summary>
    ...
    ///   <para>"Older entries describing the same mappable entity are assigned the false value."</para>
    ///   <para>"Starsi zaznamy o stejne mapovatelne entite maji nastaveny priznak na false"</para>
    /// labels<para>"Current entry"</para><para>"Aktualni zaznam"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Height of alarm at bottom level in cm"</para><para>"Vyska signalizacniho tlacitka ve spodni urovni v cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Alarm button"</para><para>"Signalizacni tlacitko"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Indentation of WC basin from back wall in cm"</para><para>"Vzdalenost odsazeni cela misy od zadni steny v cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Vzdalenost od leveho boku misy k leve stene v cm"</para><para>"Distance from left side of basin to the left wall in cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Toaletni papir v dosahu z misy"</para><para>"Toilet paper within a reach of the WC basin"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Height of seat in cm"</para><para>"Vyska umisteni sedatka v cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Prostor pro vozik vedle WC misy"</para><para>"Space for wheelchair next to the WC basin"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/wcBasinSpace">http://w3id.org/charta77/jup/wcBasinSpace</seealso>
    let wcBasinSpace = Prefixed_Name(jup, "wcBasinSpace") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///
    /// labels<para>"Pristup do upravene WC kabiny"</para><para>"Accessibility to adpted WC cabin"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Hloubka kabiny v cm"</para><para>"Depth of WC cabin in cm"</para></remarks>
    ...
    /// labels<para>"Cabin door disposition"</para><para>"Dispozice dveri v kabine WC"</para></remarks>
    ...
    ///   <para>""</para>
    ///   <para>"pridat sken nakresu"</para>
    /// labels<para>"Cabin WC basin disposition"</para><para>"Dispozice WC misy v kabine WC"</para></remarks>
    ...
    ///   <para>"pridat sken nakresu"</para>
    ///   <para>""</para>
    /// labels<para>"Cabin washBasin disposition"</para><para>"Dispozice umyvadla v kabine WC"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Changing desk obstructs the use of WC"</para><para>"Prekazi prebalovaci pult pri obsluze WC"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Typ splachovani"</para><para>"Type of flushing"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/wcFlushing">http://w3id.org/charta77/jup/wcFlushing</seealso>
    let wcFlushing = Prefixed_Name(jup, "wcFlushing") |> PrefixedName
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Vyska umisteni splachovani vzadu v cm"</para><para>"Height of toilet flushing at the back in cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Obtiznost splachovani"</para><para>"Difficulty of flushing"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/wcFlushingDifficulty">http://w3id.org/charta77/jup/wcFlushingDifficulty</seealso>
    let wcFlushingDifficulty =
        Prefixed_Name(jup, "wcFlushingDifficulty") |> PrefixedName
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Vzdalenost splachovani od rohu mistnosti v cm"</para><para>"Distance from corner of toilet flushing from side in cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Osova vydalenost madel v cm"</para><para>"Axis distance of handles in cm"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Changing desk"</para><para>"Prebalovaci pult"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Oznaceni bezneho WC Braillovym pismem"</para><para>"Braille marking of regular WC in building"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Bezne WC v budove"</para><para>"Regular WC in building"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Switch type"</para><para>"Typ vypinace"</para></remarks>
    /// <seealso href="http://w3id.org/charta77/jup/wcSwitch">http://w3id.org/charta77/jup/wcSwitch</seealso>
    let wcSwitch = Prefixed_Name(jup, "wcSwitch") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///
    /// labels<para>"Height of switch in cm"</para><para>"Vyska umisteni vypinace v cm"</para></remarks>
