...
module gom =
    ...
    let AffineCoordinateSystemTransformation =
        _prefix "AffineCoordinateSystemTransformation"
    ...
    let CoordinateSystemTransformation = _prefix "CoordinateSystemTransformation"
    /// <summary>
    ...
    let CartesianCoordinateSystem = _prefix "CartesianCoordinateSystem"
    /// <summary>
    ...
    let GeometryModellingApplication = _prefix "GeometryModellingApplication"
    /// <summary>
    ...
    let MeshGeometry = _prefix "MeshGeometry"
    /// <summary>
    ///   <see href="https://w3id.org/gom#Meshlab_v2016"></see>
    /// </summary>
    let Meshlab_v2016 = _prefix "Meshlab_v2016"
    /// <summary>
    ...
    let PlanGeometry = _prefix "PlanGeometry"
    /// <summary>
    ...
    let PointCloudGeometry = _prefix "PointCloudGeometry"
    /// <summary>
    ...
    let RepresentedAccuracyAnalysis = _prefix "RepresentedAccuracyAnalysis"
    /// <summary>
    ///   <see href="https://w3id.org/gom#Rhinoceros_v6"></see>
    /// </summary>
    let Rhinoceros_v6 = _prefix "Rhinoceros_v6"
    /// <summary>
    ...
    let columnMajorArray = _prefix "columnMajorArray"
    /// <summary>
    ...
    let fromCartesianCoordinateSystem = _prefix "fromCartesianCoordinateSystem"
    /// <summary>
    ...
    let fromCoordinateSystem = _prefix "fromCoordinateSystem"
    /// <summary>
    ...
    let hasAnalysisFile = _prefix "hasAnalysisFile"
    /// <summary>
    ...
    let hasFileSize = _prefix "hasFileSize"
    /// <summary>
    ...
    let hasLengthUnit = _prefix "hasLengthUnit"
    /// <summary>
    ...
    let hasSimplifiedGeometry = _prefix "hasSimplifiedGeometry"
    /// <summary>
    ...
    let hasSurveyGeometry = _prefix "hasSurveyGeometry"
    /// <summary>
    ...
    let hasTransformationMatrix = _prefix "hasTransformationMatrix"
    /// <summary>
    ...
    let locallyTransformedByMatrix = _prefix "locallyTransformedByMatrix"
    /// <summary>
    ...
    let maxOcclusionDistance = _prefix "maxOcclusionDistance"
    /// <summary>
    ...
    let toCartesianCoordinateSystem = _prefix "toCartesianCoordinateSystem"
    /// <summary>
    ...
    let toCoordinateSystem = _prefix "toCoordinateSystem"
    /// <summary>
    ...
    let total95PercentUpperLimit = _prefix "total95PercentUpperLimit"
    /// <summary>
    ...
    let totalLOA10 = _prefix "totalLOA10"
    /// <summary>
    ...
    let totalLOA20 = _prefix "totalLOA20"
    /// <summary>
    ...
    let totalLOA30 = _prefix "totalLOA30"
    /// <summary>
    ...
    let totalLOA40 = _prefix "totalLOA40"
    /// <summary>
    ...
    let totalLOA50 = _prefix "totalLOA50"
    /// <summary>
    ...
    let totalOccluded = _prefix "totalOccluded"
    /// <summary>
    ...
    let totalRelevant = _prefix "totalRelevant"
    /// <summary>
    ...
    let usedLocalModelMethod = _prefix "usedLocalModelMethod"
