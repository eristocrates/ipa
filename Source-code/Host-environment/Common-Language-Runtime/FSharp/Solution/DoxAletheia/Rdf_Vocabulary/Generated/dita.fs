...
module dita =
    ...
    /// labels<para>Bookmap</para></remarks>
    ...
    /// labels<para>Conref</para></remarks>
    ...
    /// labels<para>Doctype</para></remarks>
    ...
    /// labels<para>Keydef</para></remarks>
    ...
    /// labels<para>Keyref</para></remarks>
    ...
    /// labels<para>LearningBase</para></remarks>
    ...
    /// labels<para>LearningContentComponentRef</para></remarks>
    ...
    /// labels<para>LearningObject</para></remarks>
    ...
    /// labels<para>LearningOverviewRef</para></remarks>
    ...
    /// labels<para>LearningPlan</para></remarks>
    ...
    /// labels<para>Coderef</para></remarks>
    ...
    /// labels<para>subtopic</para></remarks>
    ...
    /// labels<para>vrm Modification</para></remarks>
    ...
    /// labels<para>Topicref</para></remarks>
    ...
    /// labels<para>LearningAssessment</para></remarks>
    ...
    /// labels<para>LearningContent</para></remarks>
    ...
    /// labels<para>LearningContentRef</para></remarks>
    ...
    /// labels<para>prodname</para></remarks>
    ...
    /// labels<para>revised (golive)</para></remarks>
    ...
    /// labels<para>searchtitle</para></remarks>
    ...
    /// labels<para>shortdesc</para></remarks>
    ...
    /// labels<para>LearningOverview</para></remarks>
    ...
    /// labels<para>LearningPlanRef</para></remarks>
    ...
    /// labels<para>LearningPostAssessmentRef</para></remarks>
    ...
    /// labels<para>LearningSummary</para></remarks>
    ...
    /// labels<para>LearningSummaryRef</para></remarks>
    ...
    /// labels<para>LearningPreAssessmentRef</para></remarks>
    ...
    /// labels<para>Parmname</para></remarks>
    ...
    /// labels<para>Mapref</para></remarks>
    ...
    /// labels<para>Prodinfo</para></remarks>
    ...
    /// labels<para>conkeyref</para></remarks>
    ...
    /// labels<para>backmatter</para></remarks>
    ...
    /// labels<para>booklibrary</para></remarks>
    ...
    /// labels<para>created (expiry)</para></remarks>
    ...
    /// labels<para>experiencelevel</para></remarks>
    ...
    /// labels<para>frontmatter</para></remarks>
    ...
    /// labels<para>keyname</para></remarks>
    ...
    /// labels<para>referenceObject</para></remarks>
    /// <seealso href="http://purl.org/dita/ns#referenceObject">http://purl.org/dita/ns#referenceObject</seealso>
    let referenceObject = Prefixed_Name(dita, "referenceObject") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>booktitlealt</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>The publication or general availability (GA) date, entered as YYYY-MM-DD, where YYYY is the year, MM is the month from 01 to 12, and DD is the day from 01-31.</para>
    /// labels<para>created (golive)</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The language of the file as specified in @xml:lang, and supposed to conform to RFC 1766.</para>
    ...
    /// labels<para>mainbooktitle</para></remarks>
    ...
    /// labels<para>notices</para></remarks>
    ...
    /// labels<para>othermeta</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>The date when the information should be retired or refreshed, entered as YYYY-MM-DD, where YYYY is the year, MM is the month from 01 to 12, and DD is the day from 01-31.</para>
    /// labels<para>revised (expiry)</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>The vrm element contains information about a single product's version, modification, and release, to which the current topic applies.</para>
    /// labels<para>vrm Release</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>The vrm element contains information about a single product's version, modification, and release, to which the current topic applies.</para>
    /// labels<para>vrm Version</para></remarks>
