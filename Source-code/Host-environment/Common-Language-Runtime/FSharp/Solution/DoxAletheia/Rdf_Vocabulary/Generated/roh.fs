...
module roh =
    ...
    ///
    /// labels<para>Universal Product Code</para><para>has UPC</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Gasto de Objeto de Investigación</para><para>Research Object Expense</para></remarks>
    ...
    /// labels<para>Fondo Europeo de Desarrollo Regional</para><para>European Regional Development Fund</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Data property used by roh:Funding and roh:FundingAmount</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>language</para><para>lenguaje</para></remarks>
    ...
    /// labels<para>Segell de qualitat</para><para>Segell de qualitat</para><para>Selo de qualidade</para><para>Sello de calidad</para><para>Seal of quality</para><para>Label qualité</para></remarks>
    ...
    /// labels<para>role of</para><para>rol de</para></remarks>
    ...
    /// labels<para>División de universidade</para><para>División de universidad</para><para>Divisão de universidade</para><para>Division d'université</para><para>Divisió d'universitat</para><para>Divisió d'universitat</para><para>University division</para></remarks>
    ...
    /// labels<para>accreditation of</para><para>acreditación de</para></remarks>
    ...
    /// labels<para>fecha de nacimiento</para><para>birthdate</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A roh:Activity is participated by Persons (roh:participates) and organized by Organizations through roh:hasRole connecting to intermediary entity vivo:OrganizerRole. Each activity is usually linked to a Project through relationship (roh:participates) and causes a ProjectExpense linked through (vivo:relates). A thorough hierarchy of roh:Activity subtypes is defined: bibo:Conference, vivo:Intership, roh:ThesisViva.</para>
    /// labels<para>Actividad</para><para>Activity</para></remarks>
    ...
    /// labels<para>produces</para><para>produce</para></remarks>
    ...
    /// labels<para>Repositorio  de BitBucket</para><para>BitBucket Repository</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>tiene predecesor</para><para>has predecessor</para></remarks>
    ...
    /// labels<para>tiene CV</para><para>has CV</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Métrica de Tesis Doctoral</para><para>PhD Thesis Metric</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Métrica de Grado</para><para>Degree Metric</para></remarks>
    ...
    /// labels<para>Unidace curricular de mestrado</para><para>Assignatura de mestratge</para><para>Master's degree subject</para><para>Assignatura de màster</para><para>Asignatura de máster</para><para>Asignatura de máster</para></remarks>
    ...
    /// labels<para>nombre de la métrica</para><para>metric name</para></remarks>
    ...
    /// labels<para>Charla en Panel</para><para>Panel Talk</para></remarks>
    ...
    /// labels<para>Mémoire de fin de licence</para><para>Trabajo de fin de grado</para><para>Treball fi de bàtxelor</para><para>Trabayu de fin de grau</para><para>Treball fi de grau</para><para>Bachelor's Thesis</para><para>Tesis de Grado</para><para>Degree Thesis</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>roh:CurriculumVitae adds extra fields necessary to be able to complete the CV of a foaf:Person which cannot be extracted from the relationships with roh:ResearchObject and vivo:Project, among others, that a foaf:Person may have.</para>
    ///   <para>A document used and created by a person to present their background, skills and accomplishments.</para>
    /// labels<para>Currículum vitae</para><para>Curriculum vitae</para><para>Curriculum Vitae</para><para>Curriculum vitae</para><para>Currículum vitae</para><para>Currículum vitae</para><para>Curriculum vitae</para><para>Currículum vitae</para><para>Curriculum Vitae</para><para>Currículum vitae</para></remarks>
    ...
    /// labels<para>cum laude</para><para>cum laude</para></remarks>
    ...
    /// labels<para>nota</para><para>mark</para></remarks>
    ...
    /// labels<para>tiene readme</para><para>has readme</para></remarks>
    ...
    /// labels<para>Centro de investigación</para><para>Centro de investigação</para><para>Centre d'investigació</para><para>Centre de recherche</para><para>Research institute</para><para>Centre de recerca</para></remarks>
    ...
    /// labels<para>producido por</para><para>produced by</para></remarks>
    ...
    /// labels<para>Reservable</para><para>Reservable</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>lenguaje de programación</para><para>programming language</para></remarks>
    ...
    /// labels<para>objetivo de proyecto</para><para>project objective</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A project may be in a CLOSED, OPEN or in other future status that may be defined.</para>
    ...
    /// labels<para>línea de investigación</para><para>research line</para></remarks>
    ...
    /// labels<para>gasto realizado por</para><para>spent by</para></remarks>
    ...
    /// labels<para>supervisado por</para><para>supervised by</para></remarks>
    ...
    /// labels<para>organización propietaria</para><para>owner organization</para></remarks>
    ...
    /// labels<para>clasificado en RRHH como</para><para>has HR classification</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Invoice</para><para>Factura</para></remarks>
    ...
    /// labels<para>Subcontratación</para><para>Outsourcing</para></remarks>
    ...
    /// labels<para>Contracte de treball</para><para>Contracte de treball</para><para>Contrato de trabalho</para><para>Contrato de Persona</para><para>Contrato de trabajo</para><para>Contrat de travail</para><para>Person Contract</para></remarks>
    ...
    /// labels<para>Contrato de Proyecto</para><para>Project Contract</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Relación de Supervisión de Máster Universitario</para><para>Master's Supervising Relationship</para></remarks>
    ...
    /// labels<para>Posición de Investigador</para><para>Researcher Position</para></remarks>
    ...
    /// labels<para>tiene area de conocimiento</para><para>has knowledge area</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>A data property that associates a title to any ROH entity requiring it.</para>
    /// labels<para>título</para><para>title</para></remarks>
    ...
    /// labels<para>Emisor de Acreditación</para><para>Accreditation Issuer</para></remarks>
    ...
    /// labels<para>participated by</para><para>participante</para></remarks>
    ...
    /// labels<para>Entidades administrativas</para><para>Entidades administrativas</para><para>Entitats administratives</para><para>Entitats administratives</para><para>Administrative entities</para><para>Entités administratives</para></remarks>
    ...
    /// labels<para>expresión escrita</para><para>writing skill</para></remarks>
    ...
    /// labels<para>spoken interaction skill</para><para>interacción oral</para></remarks>
    ...
    /// labels<para>language of the certificate</para><para>idioma del certificado</para></remarks>
    ...
    /// labels<para>información de contacto de</para><para>contact info of</para></remarks>
    ...
    /// labels<para>fecha de firma del contrato</para><para>contract signing date</para></remarks>
    ...
    /// labels<para>horas lectivas</para><para>course hours</para></remarks>
    ...
    /// labels<para>dedicación</para><para>dedication</para></remarks>
    ...
    /// labels<para>tiene categorizacion proyecto</para><para>has project categorization</para></remarks>
    ...
    /// labels<para>categorización de proyecto de</para><para>project categorization of</para></remarks>
    ...
    /// labels<para>tiene reservable</para><para>has reservable</para></remarks>
    ...
    /// labels<para>is spinoff of</para><para>es spinoff de</para><para>spins of from</para></remarks>
    ...
    /// labels<para>supports</para><para>apoya</para></remarks>
    ...
    /// labels<para>isbn</para><para>isbn</para></remarks>
    ...
    /// labels<para>emitido por</para><para>issued by</para></remarks>
    ...
    /// labels<para>modalidad</para><para>modalidad</para></remarks>
    ...
    /// labels<para>necesita validación ética</para><para>needs ethical validation</para></remarks>
    ...
    /// labels<para>Dossier</para><para>Dossier</para></remarks>
    ...
    /// labels<para>parte de un repositorio.</para><para>part of repository</para></remarks>
    ...
    /// labels<para>Grupo de Investigación</para><para>Grupo de investigación</para><para>Grupo de investigação</para><para>Grup d'investigació</para><para>Group de recherche</para><para>Grup de recerca</para><para>Research Group</para><para>Research group</para></remarks>
    ...
    /// labels<para>Préstamo</para><para>Loan</para></remarks>
    ...
    /// labels<para>is startup</para><para>es startup</para></remarks>
    ...
    /// labels<para>organización propietaria de</para><para>owner organization of</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Rol de Auditado</para><para>Auditee Role</para></remarks>
    ...
    /// labels<para>Rol de Miembro Externo</para><para>External Member Role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Contrato de servicio</para><para>Contracte de servei</para><para>Contrato de serviço</para><para>Contrat de service</para><para>Service contract</para></remarks>
    ...
    /// labels<para>estado de la evaluación</para><para>evaluation status</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Rol de Auditor</para><para>Auditor Role</para></remarks>
    ...
    /// labels<para>financiación pública</para><para>public funding</para></remarks>
    ...
    /// labels<para>Rol de Contración de Tercera Parte</para><para>Third Party Contractor Role</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Data property used by roh:Funding and roh:FundingAmount</para>
    /// labels<para>currency</para><para>moneda</para></remarks>
    ...
    /// labels<para>concede a</para><para>grants</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has Funding Program Classification</para></remarks>
    ...
    /// labels<para>tiene contrato</para><para>has contract</para></remarks>
    ...
    /// labels<para>Repositorio de GitHub</para><para>GitHub Repository</para></remarks>
    ...
    /// labels<para>Unidade curricular acadêmica</para><para>Assignatura acadèmica</para><para>Asignatura académica</para><para>Academic subject</para></remarks>
    ...
    /// labels<para>Academic Accreditation</para><para>Acreditación Académica</para></remarks>
    ...
    /// labels<para>Acreditación de Investigación</para><para>Research Accreditation</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Clasificación de Proyecto</para><para>Project Classification</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Justification is a bibo:Report used to justify eithet technically, economically or both a project.</para>
    ...
    /// labels<para>Objecto de investigación</para><para>Research Object</para></remarks>
    ...
    /// labels<para>Herrialde</para><para>Country</para><para>País</para><para>País</para><para>País</para><para>País</para><para>Pays</para></remarks>
    /// <seealso href="http://w3id.org/roh#Country">http://w3id.org/roh#Country</seealso>
    let Country = Prefixed_Name(roh, "Country") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>ROH will be populated with instance data of UNESCO skos concepts. A Person, Activity, Project and Organization can be qualified by a KnowledgeArea</para>
    /// labels<para>Área de Conocimiento</para><para>Knowledge Area</para></remarks>
    ...
    /// labels<para>Artículo de Seminario</para><para>Workshop Paper</para></remarks>
    ...
    /// labels<para>Metrica de una revista</para><para>Journal Metric</para></remarks>
    ...
    /// labels<para>factor de impacto</para><para>impact factor</para></remarks>
    ...
    /// labels<para>ranking</para><para>ranking</para></remarks>
    ...
    /// labels<para>quartile</para><para>cuartil</para></remarks>
    ...
    /// labels<para>Métrica de Publicación</para><para>Publication Metric</para></remarks>
    ...
    /// labels<para>Bachelor's degree subject</para><para>Assignatura de bàtxelor</para><para>Assignatura de grau</para><para>Asignatura de grao</para></remarks>
    ...
    /// labels<para>comprensión auditiva</para><para>listening skill</para></remarks>
    ...
    /// labels<para>tiene acreditación</para><para>has accreditation</para></remarks>
    ...
    /// labels<para>Licenciatura (pós-Bologna)</para><para>Bachelor's degree</para><para>Títol de bàtxelor</para><para>Título de grado</para><para>Títol de grau</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Maîtrise universitaire</para><para>Maîtrise universitaire</para><para>Maîtrise universitaire</para><para>Maîtrise universitaire</para><para>Máster universitario</para><para>Máster universitario</para><para>Màster universitari</para><para>Màster universitari</para><para>Magister Scientiae</para><para>Master's degree</para><para>Mestrado</para><para>Mestrado</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A roh:FundingProgram is promoted (roh:promotedBy) by a Funding Organization (vivo:FundingOrganization) and it is in place for a time interval (vivo:dateTimeInterval)</para>
    ///   <para>A programme of related funded projects, typically established by a funding organization.</para>
    /// labels<para>Programa de Financiación</para><para>Funding programme</para><para>Funding Program</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An roh:Metric indicates qualifies a roh:ResearchObject according to common established quality measurement metrics, e.g. impact factor or mark in an PhD viva.</para>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Doctoral degree</para><para>Doutoramento</para><para>Doutoramento</para><para>Doctorado</para><para>Doktorego</para><para>Doctorat</para><para>Doctorat</para><para>Doctorat</para><para>Doctorat</para><para>Doctorat</para><para>Doctorat</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Large Enterprise</para><para>Large enterprise</para><para>Grande empresa</para><para>Empresa grande</para><para>Empresa gran</para></remarks>
    ...
    /// labels<para>Traballo de fin de máster</para><para>Trabajo de fin de máster</para><para>Dissertação de mestrado</para><para>Dissertação de mestrado</para><para>Treball de fi de màster</para><para>Treball de fi de màster</para><para>Mémoire de maîtrise</para><para>Mémoire de maîtrise</para><para>Tesis de maestría</para><para>Tesis de maestría</para><para>Tesis de maestría</para><para>Tesis de maestría</para><para>Tese de mestrado</para><para>Master's Thesis</para><para>Tesis de Máster</para></remarks>
    ...
    /// labels<para>Tese de doutoramento</para><para>Tesis de Doctorado</para><para>Thèse doctorale</para><para>Doctoral thesis</para><para>Tesis doctoral</para><para>Tesi doctoral</para><para>Tese doctoral</para><para>Tesi doctoral</para><para>Doktore tesi</para><para>PhD Thesis</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Relación de Auditoría</para><para>Auditing Relationship</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Supervising Relationship</para><para>Relación de Supervisión</para></remarks>
    ...
    /// labels<para>readme of</para><para>readme de</para></remarks>
    ...
    /// labels<para>estado del repositorio</para><para>repository status</para></remarks>
    ...
    /// labels<para>provides</para><para>provee</para></remarks>
    ...
    /// labels<para>Gasto de Persona</para><para>Person Expense</para></remarks>
