...
module xkos =
    ...
    ///
    /// labels<para>"Classification level"</para><para>"Niveau de nomenclature"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Concept association"</para><para>"Association de concepts"</para></remarks>
    ...
    ///
    /// labels<para>"contenu limite"</para><para>"additional content"</para></remarks>
    ...
    ///
    /// labels<para>"après"</para><para>"after"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"core content"</para><para>"contenu central"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"covers"</para><para>"couvre"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"covers exhaustively"</para><para>"couvre exhaustivement"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"couvre sans recouvrement"</para><para>"covers mutually exclusively"</para></remarks>
    ...
    ///
    /// labels<para>"depth"</para><para>"profondeur"</para></remarks>
    ...
    ///   <para>owl:AnnotationProperty</para>
    ///
    /// labels<para>"exclusions"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"inclusions"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"is a part of"</para><para>"est une partie de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"level list"</para><para>"liste des niveaux"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"successeur immédiat dans la séquence"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"immediate successor in the sequence"</para>
    /// labels<para>"next"</para><para>"suivant"</para></remarks>
    ...
    /// labels<para>"previous"</para><para>"précédent"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"has sequential"</para><para>"en relation séquentielle"</para></remarks>
    ...
    ///   <para>owl:TransitiveProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"successeur dans la séquence"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"successor in the sequence"</para>
    /// labels<para>"succeeds"</para><para>"succède à"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"remplace"</para><para>"supersedes"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"concept cible"</para><para>"target concept"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has temporal"</para><para>"en relation temporelle"</para></remarks>
