...
module odapps =
    ...
    ///   <para>An App Concept implementation.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The Agent which conceived the idea about the App Concept</para>
    /// labels<para>conceived by</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>comment on the application and the Concept</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>An App concept which was revised and re-posed / extended. </para>
