...
module voidext =
    ...
    let ComplexLinkSet =
        Namespaced_IRI.parse _namespace_name "ComplexLinkSet" |> NamespacedName
    ...
    let queryLinkset =
        Namespaced_IRI.parse _namespace_name "queryLinkset" |> NamespacedName
    ...
    let querySharedInstanceSet =
        Namespaced_IRI.parse _namespace_name "querySharedInstanceSet" |> NamespacedName
    ...
    let VirtualLinkSet =
        Namespaced_IRI.parse _namespace_name "VirtualLinkSet" |> NamespacedName
    ...
    let SharedInstanceSet =
        Namespaced_IRI.parse _namespace_name "SharedInstanceSet" |> NamespacedName
    ...
    let intersectAt =
        Namespaced_IRI.parse _namespace_name "intersectAt" |> NamespacedName
    ...
    let SimpleLinkSet =
        Namespaced_IRI.parse _namespace_name "SimpleLinkSet" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/query/voidext#LINK_SHAREDINSTANCE_SET"></see>
    /// </summary>
    let LINK_SHAREDINSTANCE_SET =
        Namespaced_IRI.parse _namespace_name "LINK_SHAREDINSTANCE_SET" |> NamespacedName
    ...
    let LinkSetIntersection =
        Namespaced_IRI.parse _namespace_name "LinkSetIntersection" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/query/voidext#MODIFIED_TARGET_1"></see>
    /// </summary>
    let MODIFIED_TARGET_1 =
        Namespaced_IRI.parse _namespace_name "MODIFIED_TARGET_1" |> NamespacedName
    ...
    let OBJECT_OBJECT =
        Namespaced_IRI.parse _namespace_name "OBJECT_OBJECT" |> NamespacedName
    ...
    let SUBJECT_OBJECT =
        Namespaced_IRI.parse _namespace_name "SUBJECT_OBJECT" |> NamespacedName
    ...
    let SUBJECT_SUBJECT =
        Namespaced_IRI.parse _namespace_name "SUBJECT_SUBJECT" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/query/voidext#isSubsetOf"></see>
    /// </summary>
    let isSubsetOf = Namespaced_IRI.parse _namespace_name "isSubsetOf" |> NamespacedName
    ...
    let hasPerformanceMeasure =
        Namespaced_IRI.parse _namespace_name "hasPerformanceMeasure" |> NamespacedName
    ...
    let intersectionType =
        Namespaced_IRI.parse _namespace_name "intersectionType" |> NamespacedName
    ...
    let linkPredicateDomain =
        Namespaced_IRI.parse _namespace_name "linkPredicateDomain" |> NamespacedName
    ...
    let linkPredicateRange =
        Namespaced_IRI.parse _namespace_name "linkPredicateRange" |> NamespacedName
    ...
    let recommendedMapping =
        Namespaced_IRI.parse _namespace_name "recommendedMapping" |> NamespacedName
    ...
    let resourceMapping =
        Namespaced_IRI.parse _namespace_name "resourceMapping" |> NamespacedName
    ...
    let sharedInstanceType =
        Namespaced_IRI.parse _namespace_name "sharedInstanceType" |> NamespacedName
    ...
    let supportFederatedQuery =
        Namespaced_IRI.parse _namespace_name "supportFederatedQuery" |> NamespacedName
