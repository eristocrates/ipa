...
module voidext =
    ...
    ///
    /// labels<para>"modified void:target domain"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is subset of"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// the output of a function."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
