...
module wty =
    ...
    /// labels<para>Invoice</para><para>Facture</para></remarks>
    ...
    /// labels<para>Limite</para><para>Limit</para></remarks>
    ...
    /// labels<para>Règle de Paiement</para><para>Payment Rule</para></remarks>
    ...
    /// labels<para>vérifie les exclusions</para><para>checks exclusions</para></remarks>
    ...
    /// labels<para>date de fin de contrat</para><para>contract end date</para></remarks>
    ...
    /// labels<para>date de début de contrat</para><para>contract start date</para></remarks>
    ...
    /// labels<para>statut du contrat</para><para>contract status</para></remarks>
    ...
    /// labels<para>montant couvert</para><para>covered amount</para></remarks>
    ...
    /// labels<para>covered currency</para><para>devise couverte</para></remarks>
    ...
    /// labels<para>couvre le type de défaut</para><para>covers defect type</para></remarks>
    ...
    /// labels<para>couvre le type de réparation</para><para>covers repair type</para></remarks>
    ...
    /// labels<para>définit les conditions</para><para>defines conditions</para></remarks>
    ...
    /// labels<para>définit les exclusions</para><para>defines exclusions</para></remarks>
    ...
    /// labels<para>définit la règle de paiement</para><para>defines payment rule</para></remarks>
    ...
    /// labels<para>détermine le paiement</para><para>determines payment</para></remarks>
    ...
    /// labels<para>excluded cause</para><para>cause exclue</para></remarks>
    ...
    /// labels<para>excluded defect type</para><para>type de défaut exclu</para></remarks>
    ...
    /// labels<para>première partie</para><para>first party</para></remarks>
    ...
    /// labels<para>devise de facture</para><para>invoice currency</para></remarks>
    ...
    /// labels<para>montant limite</para><para>limit amount</para></remarks>
    ...
    /// labels<para>type de limite</para><para>limit type</para></remarks>
    ...
    /// labels<para>payeur</para><para>payer</para></remarks>
    ...
    /// labels<para>Condition</para><para>Condition</para></remarks>
    ...
    /// labels<para>Couverture</para><para>Coverage</para></remarks>
    ...
    /// labels<para>définit la couverture</para><para>defines coverage</para></remarks>
    ...
    /// labels<para>pourcentage de paiement</para><para>payment percentage</para></remarks>
    ...
    /// labels<para>déclenche l'évaluation</para><para>triggers assessment</para></remarks>
    ...
    /// labels<para>couvre le composant</para><para>covers component</para></remarks>
    ...
    /// labels<para>nécessite une preuve</para><para>requires proof</para></remarks>
    ...
    /// labels<para>Contract</para><para>Contrat</para></remarks>
    ...
    /// labels<para>Exclusion</para><para>Exclusion</para></remarks>
    ...
    /// labels<para>numéro de contrat</para><para>contract number</para></remarks>
    ...
    /// labels<para>limit currency</para><para>devise limite</para></remarks>
