...
module ssno =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"System is a unit of abstraction for pieces of infrastructure that implement Procedures. A System may have components, its subsystems, which are other Systems. (Definition taken from http://www.w3.org/ns/ssn/System)"</para>
    ...
    ///   <para>"System is a unit of abstraction for pieces of infrastructure that implement Procedures. A System may have components, its subsystems, which are other Systems."</para>
    ///   <para>"System is a unit of abstraction for pieces of infrastructure that implement Procedures. A System may have components, its subsystems, which are other systems."</para>
    ...
    ///   <para>"Relation between a deployment and the platform(s) involved in the deployment."</para>
    ...
    ///   <para>"Relation between a deployment and the system deployed."</para>
    ...
    /// labels<para>"for property"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"for property"</para></remarks>
    ...
    /// labels<para>"has subsystem"</para><para>"has subsystem"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Relation between a platform and the deployment(s) that takes place in the platform."</para>
    ...
    /// <summary>
    ///   <para>ssno:systems/</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.w3.org/ns/ssn/systems/">http://www.w3.org/ns/ssn/systems/</seealso>
    let ``systems/`` = Prefixed_Name(ssno, "systems/") |> PrefixedName
    /// <summary>
    ///   <para>ssno:systems/Accuracy</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.w3.org/ns/ssn/systems/Accuracy">http://www.w3.org/ns/ssn/systems/Accuracy</seealso>
    let ``systems/Accuracy`` = Prefixed_Name(ssno, "systems/Accuracy") |> PrefixedName
    /// <summary>
    ///   <para>ssno:systems/Precision</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    /// </remarks>
    /// <seealso href="http://www.w3.org/ns/ssn/systems/Precision">http://www.w3.org/ns/ssn/systems/Precision</seealso>
    let ``systems/Precision`` = Prefixed_Name(ssno, "systems/Precision") |> PrefixedName

    /// <summary>
    ///   <para>ssno:systems/SystemCapability</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Describes normal measurement, actuation, sampling properties such as accuracy, range, precision, etc. of a System under some specified Conditions such as a temperature range.
    /// The capabilities specified here are those that affect the primary purpose of the System, while those in OperatingRange represent the system's normal operating environment, including Conditions that don't affect the Observations or the Actuations."</para>
    /// labels<para>"System capability"</para></remarks>
    /// <seealso href="http://www.w3.org/ns/ssn/systems/SystemCapability">http://www.w3.org/ns/ssn/systems/SystemCapability</seealso>
    let ``systems/SystemCapability`` =
        Prefixed_Name(ssno, "systems/SystemCapability") |> PrefixedName

    /// <summary>
    ///   <para>ssno:systems/SystemProperty</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.w3.org/ns/ssn/systems/SystemProperty">http://www.w3.org/ns/ssn/systems/SystemProperty</seealso>
    let ``systems/SystemProperty`` =
        Prefixed_Name(ssno, "systems/SystemProperty") |> PrefixedName

    /// <summary>
    ///   <para>ssno:systems/hasSystemCapability</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Relation from a System to a SystemCapability describing the capabilities of the System under certain Conditions."</para>
    /// labels<para>"has system capability"</para></remarks>
    /// <seealso href="http://www.w3.org/ns/ssn/systems/hasSystemCapability">http://www.w3.org/ns/ssn/systems/hasSystemCapability</seealso>
    let ``systems/hasSystemCapability`` =
        Prefixed_Name(ssno, "systems/hasSystemCapability") |> PrefixedName
