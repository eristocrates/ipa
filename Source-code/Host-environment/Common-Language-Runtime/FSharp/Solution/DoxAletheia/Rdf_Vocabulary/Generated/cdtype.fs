...
module cdtype =
    ...
    let AnalyticFindingAid =
        Namespaced_IRI.parse _namespace_name "AnalyticFindingAid" |> NamespacedName
    ...
    let HierarchicFindingAid =
        Namespaced_IRI.parse _namespace_name "HierarchicFindingAid" |> NamespacedName
    ...
    let IndexingFindingAid =
        Namespaced_IRI.parse _namespace_name "IndexingFindingAid" |> NamespacedName
