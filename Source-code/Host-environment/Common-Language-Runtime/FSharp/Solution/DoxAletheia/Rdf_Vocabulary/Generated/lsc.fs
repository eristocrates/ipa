...
module lsc =
    ...
    ///   <para>"This predicate can be used to express a begin of a time period."</para>
    /// labels<para>"begin"</para></remarks>
    /// <seealso href="http://linkedscience.org/lsc/ns#begin">http://linkedscience.org/lsc/ns#begin</seealso>
    let begin_ = Prefixed_Name(lsc, "begin") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"This predicate can be used to express an end of a time period."</para>
    /// labels<para>"end"</para></remarks>
    /// <seealso href="http://linkedscience.org/lsc/ns#end">http://linkedscience.org/lsc/ns#end</seealso>
    let end_ = Prefixed_Name(lsc, "end") |> PrefixedName
    /// <summary>
    ...
    /// <summary>
    ///   <para>lsc:fuzzybegin</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"This predicate can be used to express a fuzzybegin of an imprecise time period."</para>
    /// labels<para>"fuzzybegin"</para></remarks>
    /// <seealso href="http://linkedscience.org/lsc/ns#fuzzybegin">http://linkedscience.org/lsc/ns#fuzzybegin</seealso>
    let fuzzybegin = Prefixed_Name(lsc, "fuzzybegin") |> PrefixedName
    /// <summary>
    ///   <para>lsc:fuzzyend</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"This predicate can be used to express a fuzzyend of an imprecise time period."</para>
    /// labels<para>"fuzzyend"</para></remarks>
    /// <seealso href="http://linkedscience.org/lsc/ns#fuzzyend">http://linkedscience.org/lsc/ns#fuzzyend</seealso>
    let fuzzyend = Prefixed_Name(lsc, "fuzzyend") |> PrefixedName
    /// <summary>
