...
module vrank =
    ...
    ///   <para>"A ranking algorithm used to compute the ranking scores associated with an item (vrank:Rank)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"A feature of a vrank:Algorithm such as Granularity, RankingFactor, etc."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"A parameter of a vrank:Algorithm such as number of iterations or damping factor."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"Represents a ranking score associated with an item."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>"A vrank:Rank is computed by an vrank:Algorithm."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>"The id associated to a vrank:Feature."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"feature id"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"The value associated to a vrank:Feature."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"feature value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"TODO."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"A vrank:Algorithm has a name."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"A subject, property or object hasRank a vrank:Rank."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"has rank"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"The time when a vrank:Rank was computed."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"has rank timestamp"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"The id associated to a vrank:Parameter."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"parameter id"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"The value associated to a vrank:Parameter."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>"The numerical value associated to a vrank:Rank."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"has rank value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
