...
module ntag =
    ...
    /// labels<para>Verzamelen</para><para>Aggregare</para><para>Aggregate</para><para>Agregar</para><para>Agréger</para></remarks>
    ...
    /// labels<para>Poser une question</para><para>Porre una domanda</para><para>Vraag stellen</para><para>Preguntar</para><para>Ask</para></remarks>
    ...
    /// labels<para>Acción de etiquetado</para><para>Azione di tagging</para><para>Acte de taguer</para><para>Taghandeling</para><para>Tag action</para></remarks>
    ...
    /// labels<para>Bevestigen</para><para>Asserter</para><para>Asserire</para><para>Afirmar</para><para>Assert</para></remarks>
    ...
    /// labels<para>Kan gelezen worden door</para><para>Può essere letto da</para><para>Puede ser leído por</para><para>Peut être lu par</para><para>Can be read by</para></remarks>
    ...
    /// labels<para>Colección de etiquetas personal</para><para>Collection de tags personnelle</para><para>Collezione di tag personale</para><para>Persoonlijke tagverzameling</para><para>Personal tag collection</para></remarks>
    ...
    /// labels<para>Definire un compito</para><para>Définir une tâche</para><para>Definir una tarea</para><para>Taak definiëren</para><para>Set task</para></remarks>
    ...
    /// labels<para>Acción de etiquetado de un visitante</para><para>Azione di tagging di un visitatore</para><para>Acte de taguer d'un visiteur</para><para>Taghandeling bezoeker</para><para>Visitor tag action</para></remarks>
    ...
    /// labels<para>Bron met aantekeningen</para><para>Annotated resource</para><para>Ressource annotée</para><para>Risorsa annotata</para><para>Recurso anotado</para></remarks>
    ...
    /// labels<para>Acción de etiquetado automática</para><para>Geautomatiseerde taghandeling</para><para>Azione di tagging automatica</para><para>Acte de taguer automatique</para><para>Auto tag action</para></remarks>
    ...
    /// labels<para>Colección de etiquetas comunitaria</para><para>Collection de tags communautaire</para><para>Collezione di tag comunitaria</para><para>Gemeenschapstagverzameling</para><para>Community tag collection</para></remarks>
    ...
    /// labels<para>Colección de etiquetas</para><para>Collection de tags</para><para>Collezione di tag</para><para>Tag collection</para><para>Tagverzameling</para></remarks>
    ...
    /// labels<para>Acción de etiquetado con desambiguación</para><para>Taghandeling met gedisambigueerd teken</para><para>Azione di tagging con disambiguazione</para><para>Acte de taguer avec désambigüisation</para><para>Disambiguate Tag Action</para></remarks>
    ...
    /// labels<para>Maakt dat ik me voel</para><para>Produit sur moi</para><para>Makes me feel</para><para>Me provoca</para><para>Mi suscita</para></remarks>
    ...
    /// labels<para>Verstuurd aan</para><para>Enviado a</para><para>Inviato a</para><para>Envoyé à</para><para>Sent to</para></remarks>
    ...
    /// labels<para>Tiene como parte</para><para>Heeft als deel</para><para>A pour partie</para><para>Ha come parte</para><para>Has part</para></remarks>
    ...
    /// labels<para>Heeft een persoonlijk teken</para><para>A pour signe personnel</para><para>Tiene signo personal</para><para>Ha segno personale</para><para>Has personal sign</para></remarks>
    ...
    /// labels<para>Tiene como tema</para><para>A pour thème</para><para>Ha come tema</para><para>Is about</para><para>Betreft</para></remarks>
    ...
    /// labels<para>Beoordelen</para><para>Valutare</para><para>Evaluate</para><para>Evaluar</para><para>Evaluer</para></remarks>
    ...
    /// labels<para>Expresar un sentimiento</para><para>Esprimere un sentimento</para><para>Gevoelens uitdrukken</para><para>Exprimer un ressenti</para><para>Express feelings</para></remarks>
    ...
    /// labels<para>Accordare diritti di accesso a</para><para>Accorder des droits d'accès à</para><para>Toegangsrechten verlenen aan</para><para>Acordar derechos de acceso a</para><para>Give access rights to</para></remarks>
    ...
    /// labels<para>Acción de etiquetado con machine tag</para><para>Azione di tagging con machine tag</para><para>Acte de taguer avec machine tag</para><para>Taghandeling met machinetag</para><para>Machine tag action</para></remarks>
    ...
    /// labels<para>Acción de etiquetado sintáctica</para><para>Azione di tagging sintattica</para><para>Acte de taguer syntaxique</para><para>Syntactische taghandeling</para><para>Syntactic Tag Action</para></remarks>
    ...
    /// labels<para>Acción de etiquetado manual</para><para>Azione di tagging manuale</para><para>Handmatige taghandeling</para><para>Acte de taguer manuel</para><para>Manual tag action</para></remarks>
    ...
    /// labels<para>Acción de etiquetado con una etiqueta n-dimensional</para><para>Azione di tagging con una tag n-dimensionale</para><para>Acte de taguer avec un tag à n-dimensions</para><para>Taghandeling met n-tuple</para><para>N-tuple tag action</para></remarks>
    ...
    /// labels<para>Acción de etiquetado con una etiqueta n-dimensional y sintaxis de las machine tags</para><para>Azione di tagging con una tag a n-dimensionale e sintassi delle machine tag</para><para>Acte de taguer avec un tag à n-dimensions et syntaxe de machine tags</para><para>Taghandeling met een n-tuple met machinetag syntaxis</para><para>N-tuple tag action with machine tag syntax</para></remarks>
    ...
    /// labels<para>Acción de etiquetado del propietario</para><para>Azione di tagging del proprietario</para><para>Acte de taguer d'un propriétaire</para><para>Taghandeling eigenaar</para><para>Owner tag action</para></remarks>
    ...
    /// labels<para>Partie de la représentation d'une ressource sur le Web</para><para>Onderdeel van de representatie van een bron op het web</para><para>Parte de la representación de un recurso en la Web</para><para>Parte della rappresentazione di una risorsa Web</para><para>Part Of Web representation</para></remarks>
    ...
    /// labels<para>Aanwijzen</para><para>Puntare</para><para>Pointer</para><para>Puntar</para><para>Point</para></remarks>
    ...
    /// labels<para>Condividere</para><para>Compartir</para><para>Partager</para><para>Delen</para><para>Share</para></remarks>
    ...
    /// labels<para>Acción de etiquetado con Web concept</para><para>Azione di tagging con Web concept</para><para>Acte de taguer par concept Web</para><para>Taghandeling met webconcept</para><para>Web concept tag action</para></remarks>
    ...
    /// labels<para>Recurso etiquetado</para><para>Ressource taguée</para><para>Risorsa taggata</para><para>Tagged resource</para><para>Getagde bron</para></remarks>
    ...
    /// labels<para>Pertenece a una colección de etiquetas</para><para>Appartient à une collection de tags</para><para>Appartiene a una collezione di tag</para><para>Behoort toe aan tagverzameling</para><para>Belongs to tag collection</para></remarks>
    ...
    /// labels<para>Está relacionado con</para><para>Houdt verband met</para><para>È connesso con</para><para>Is related to</para><para>Est relié à</para></remarks>
    ...
    /// labels<para>Kan niet gelezen worden door</para><para>Non può essere letto da</para><para>No puede ser leído por</para><para>Ne peut être lu par</para><para>Cannot be read by</para></remarks>
    ...
    /// labels<para>Heeft een gemeenschappelijk teken</para><para>A pour signe collectif</para><para>Tiene signo colectivo</para><para>Ha segno collettivo</para><para>Has community sign</para></remarks>
    ...
    /// labels<para>Est pertinent</para><para>Es pertinente</para><para>È pertinente</para><para>Is relevant</para><para>Is relevant</para></remarks>
    ...
    /// labels<para>Est pertinent pour quelqu'un</para><para>Es pertinente para alguien</para><para>Is relevant voor iemand</para><para>È pertinente a qualcuno</para><para>Is relevant to somebody</para></remarks>
    ...
    /// labels<para>Est pertinent par rapport à quelque chose</para><para>Is relevant met betrekking tot iets</para><para>Is relevant to something</para><para>Es pertinente para algo</para><para>È pertinente a qualcosa</para></remarks>
    ...
    /// labels<para>Tiene valor</para><para>Ha valore</para><para>Is waaard</para><para>Is worth</para><para>Vaut</para></remarks>
    ...
    /// labels<para>Soulève une interrogation au sujet de</para><para>Plantea una cuestión sobre</para><para>Solleva una domanda su</para><para>Raises question about</para><para>Roept vragen op over</para></remarks>
    ...
    /// labels<para>Verstuurd door</para><para>Enviado por</para><para>Inviato da</para><para>Envoyé par</para><para>Sent by</para></remarks>
    ...
    /// labels<para>Ontlokt de handeling</para><para>Suscita la acción</para><para>Suscita l'azione</para><para>Suscite l'action</para><para>Elicits action</para></remarks>
    ...
    /// labels<para>Est un medium de type</para><para>Es un medium de tipo</para><para>È un medium di tipo</para><para>Has for medium</para><para>Is het medium</para></remarks>
