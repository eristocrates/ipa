...
module samfl =
    ...
    ///
    /// This stub is included in the sam: ontology to support constraints on the sam:shape property of a sam:SamplingCurve.  An existing OWL class that represents the notion of a Curve may be asserted to be a sub-class of this stub, but without requiring use of any particular representation of Curve in the context of a sam:SamplingCurve instance."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Spatial curve"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Simple model for elevation, expressed as a vertical offset from a datum"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// w3geo:SpatialThing, geosparql:SpatialObject are subclasses"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// are candidates. "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Measure or quantity"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// The result of application of an observation process is an observation result - i.e. an estimate of a property value."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// The result of a application of a sampling process is a - new or - transformed sample. "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>"Agent, device, protocol, or plan responsible for transforming a sampling features.
    ///
    /// The result of a operation of a sample trasnformation agent is a - new or - transformed sample. "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// The features that the member sampling features are intended to sample may be indicated by one or more sampledFeature properties. If only one is present then it may be inferred that this is the sampled feature of all the member sampling features, unless locally overridden."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// Transect, traverse, flightline, cruise, trajectory, borehole, etc"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// A sampling feature is intended to sample some feature-of-interest in an application domain, so there is an expectation of at least one sampledFeature property. However, in some cases the identity, and even the exact type, of the sampled feature may not be known when observations are made using the sampling features."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"The value for the property 'sampledFeature' may be inherited from a container resource."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// Sampling features are frequently related to each other, as parts of complexes, through sub-sampling, and in other ways. If present, the association class SamplingFeatureComplex (Figure 9) shall link an SF_SamplingFeature to another SF_SamplingFeature."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// Often referred to as a 'station', 'pixel', 'probe-spot' etc."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Spatial sampling feature whose shape is a 3-D manifold (Solid)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// Scene, swath, cross-section, level, quadrat, area-of-interest, fence, etc."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// This stub is included in the sam: ontology to support constraints on the sam:shape property of a sam:SamplingSolid.  An existing OWL class that represents the notion of a Solid may be asserted to be a sub-class of this stub, but without requiring use of any particular representation of Solid in the context of a sam:SamplingSolid instance."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Spatial solid"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A Specimen is a physical sample, obtained for observation(s) normally carried out ex-situ, sometimes in a laboratory."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"This stub is included in the sam: ontology to support constraints on the sam:shape property of a sam:SamplingSurface.  An existing OWL class that represents the notion of a Surface may be asserted to be a sub-class of this stub, but without requiring use of any particular representation of Surface in the context of a sam:SamplingSurface instance."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Spatial surface"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// labels<para>"sampling feature complex"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// NOTE If a specimen no longer exists, for example, it was destroyed in connection with an observation act, then the currentLocation should be omitted or carry a suitable null indicator."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"current location"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// labels<para>"vertical offset from a datum"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://def.seegrid.csiro.au/ontology/om/sam-lite#elevation">http://def.seegrid.csiro.au/ontology/om/sam-lite#elevation</seealso>
    let elevation = Prefixed_Name(samfl, "elevation") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"hosted procedure or instrument"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// e.g. aqueous liquid, non-aqueous liquid, soil, rock, tissue, vegetation (broad case) or finer classifications if available"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"class of material"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"related sampling feature"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// EXAMPLE A profile typically samples a water- or atmospheric-column; a well samples the water in an aquifer; a tissue specimen samples a part of an organism."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"sampled feature"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// NOTE Where a specimen has a relatedSamplingFeature whose location provides an unambiguous elevation then this attribute is not required. However, if the specific elevationat the location, then this attribute supports its description."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"sampling elevation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// NOTE Where a specimen has a relatedSamplingFeature whose location provides an unambiguous location then this attribute is not required. However, if the specific sampling location within the sampledFeature is important, then this attribute supports its description."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"sampling location"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Process used to obtain the Specimen from its sampledFeature"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"sampling method"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>"samplingTime records when the specimen was retrieved from the sampled feature."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"sampling time"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"spatial sampling feature shape"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"specimen size"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"vertical (elevation) datum"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
