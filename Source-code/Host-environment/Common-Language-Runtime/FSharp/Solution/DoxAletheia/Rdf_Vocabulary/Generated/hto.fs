...
module hto =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Chilled System</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Cooling Coil</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Condenser System</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Entering</para></remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>  Associated with the cooling mode of an HVAC system.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Associated with the discharge air an `ahu` or `vav`.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Indicates `water` or `steam` exiting a piece of equipment like a `boiler` or `chiller`.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Occupancy sensor under `lightsGroup`.  Point must be Bool where true indicates occupied and false indicates unoccupied</para>
    ///   <para>note: according to the documentation, subsumes sensor. But associated here to a Measurement type. Similarly, lights and lightLevel tags both refer to the class LightLevel.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Data point such as a sensor or actuator.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Classifies a `point` as a setpoint, soft point, or process control variable.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Temperature measured in Â°C or Â°F.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Associated with a conditioned [zone]`Zones` of a building.</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>HEntity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Heating Coil</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Isolation Valve</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Mixed</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Lights Group</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Perimeter Heat</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Refrigirant Substance</para></remarks>
    ...
    ///   <para>gives the OWL class defined in the present ontology that should be associated to the individual defined as subject.</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Steam</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Writable</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Set Point</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Real time</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Classifies a `point` as an input, AI/BI, or sensor.</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>VFD Fan</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>note: does not fully implement specification (no boilerPlant). However, is still a TODO in project Haystack.</para>
    ///   <para>  Boiler `equip` used to generate hot water or steam for heating.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#boiler">http://vcharpenay.github.io/hto/hto.xml#boiler</seealso>
    let boiler = Prefixed_Name(hto, "boiler") |> PrefixedName
    /// <summary>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  If used with `valve` indicates a by-pass in a piping system. If used in combination with the `damper` tag on an `ahu` to indicate a damper in the ductwork to by-pass the VAV boxs and create a direct circuit between the discharge and return of the unit.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>note: does not fully implement specification (no chillerPlant, no CoolingTower).</para>
    ///   <para>  Chillers remove heat from a liquid via a vapor compression or an absorption refrigeration cycle.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Air Handler Unit which heats and/or cools air.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#ahu">http://vcharpenay.github.io/hto/hto.xml#ahu</seealso>
    let ahu = Prefixed_Name(hto, "ahu") |> PrefixedName
    /// <summary>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Point associated with the measurement or control of air. In regards to `wetBulb`, points with the 'air' tag are associated with dry bulb.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Marker tag used with `water` for the chilled water system between `chiller` and `ahu`.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Classifies a `point` as an output, AO/BO, command, or actuator.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Carbon dioxide level `point` measured in "ppm".</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Cooling coil as bool or numeric `point` used with `ahu` equip.  If multiple stages are used, then also specify the `stage` tag. If the cooling coil is controlled by a valve, then this point is mesaured from 0% to 100%, otherwise it should be a boolean point.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Indicates a differential of `air`, `water`, or `steam` between the `entering` and `leaving` sensors.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Used to indicate the effective setpoint which takes into account various other mode based setpoints the equip might define.  See [zone setpoints]`Zones#zonePoints` for complete example of how this tag is used.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Damper position measured from 0% (fully closed) to 100% (fully open).</para>
    ///   <para>note: indicates the measurement of how open the damper of a AHU is (0-100%)</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Used on `point` or `equip` entities relating to electricity. When paried with `meter` indicates a electric meter.</para>
    ///   <para>note: according to the documentation, is assocated to either point or equip</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Indicates points on the evaporator mechanism used to convert a refrigerant from its liquid to gageous state.  It is often paired with the `refrig` marker tag.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  A `point` of an `ahu` indicating air flow is by-passing the heating/cooling elements. If a boolean point, then true indicates the unit is in by-pass mode and false indicates by-pass is disabled.  If the point is an analog point then 100% indicates full by-pass mode and 0% that by-pass is completely disabled.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  A boolean `point` of an `ahu` indicating a freezing condition which might require a control sequence to protect the equipment. If true then a freeze condition is deteted, or false if not.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Heating coil as bool or float point on an `ahu` or `vav`. If multiple stages are used, then also specify the `stage` tag. If the heating coil is controlled by a valve, then this point is mesaured from 0% to 100%, otherwise it should be a boolean point.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Efficiency point of a `chiller` measured in "COP" or "kW/ton".</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Applied to `point` entities which measure energy consumption:   - Electric meters: "kWh"   - Thermal meters: "BTU"   - Gas meters: "mÂ³_gas"   - Chillers: "tonrefh"</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Differential pressure across the filter of an `ahu`.  If a boolean point then true indicates successful airflow and false indicates a clogged filter.  If a numeric then the pressure differential should be measured in "inHâ‚‚O" or "kPa"</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Electrical A/C frequency `point` measured in "Hz" for `elec` `meter` or a `vfd`.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Boolean or numeric `point` of an `ahu` used to indicate if if the humidifier is on or off.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Associated with HVAC (Heating, Ventilating, Air Conditioning)</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>note: according to the documentation, subsumes sensor. But associated here to a Measurement type and redundant with the tag lightLevel.</para>
    ///   <para>  Lighting on/off status as a boolean or if dimmable a numeric between 0% and 100%.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Applied to `point` entities which measure energy consumed per unit time. For 'elec meter' this is the electrical demand.   - Electric meters: "kW"   - Thermal meters: "BTU/h"   - Chillers: "tonref" or "kW" refrigeration</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Associated with the return air an `ahu`.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#return">http://vcharpenay.github.io/hto/hto.xml#return</seealso>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Speed `point` of a `vfd` measured in "%" where 0% is off and 100% is the fastest speed.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#speed">http://vcharpenay.github.io/hto/hto.xml#speed</seealso>
    let speed = Prefixed_Name(hto, "speed") |> PrefixedName
    /// <summary>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Point associated with the measurement or control of steam. This tag is often paired with `entering` versus `leaving` versus `delta`. It may also be paired with `meter` to indicate a steam meter.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#steam">http://vcharpenay.github.io/hto/hto.xml#steam</seealso>
    let steam = Prefixed_Name(hto, "steam") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Marker for a motor `equip` with variable frequency drive.  Commonly used in combination with `fan` and `pump`.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#vfd">http://vcharpenay.github.io/hto/hto.xml#vfd</seealso>
    let vfd = Prefixed_Name(hto, "vfd") |> PrefixedName
    /// <summary>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Point associated with the measurement or control of water.  This tag is often paired:   - `entering` versus `leaving` versus `delta`   - `chilled` versus `condenser` It may also be paired with `meter` to indicate a water meter.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#water">http://vcharpenay.github.io/hto/hto.xml#water</seealso>
    let water = Prefixed_Name(hto, "water") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Indicates `water` or `steam` entering a piece of equipment like a `boiler` or `chiller`.  Used with `vav` for air flow into the unit from the AHU.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#entering">http://vcharpenay.github.io/hto/hto.xml#entering</seealso>
    let entering = Prefixed_Name(hto, "entering") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Fan `point` or `equip` associated with an `ahu`, `vav`, or `coolingTower`.</para>
    ///   <para>note: according to the documentation, is assocated to either point or equip. Should use reasoning to choose the right one for a given HEntity</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Used on `point` or `equip` entities relating to natural gas. When paried with `meter` indicates a gas meter.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Humidity measured from 0% to 100%.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#humidity">http://vcharpenay.github.io/hto/hto.xml#humidity</seealso>
    let humidity = Prefixed_Name(hto, "humidity") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Equip level of the lighting system which is a group of one or more `lights` points.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#lightsGroup">http://vcharpenay.github.io/hto/hto.xml#lightsGroup</seealso>
    let lightsGroup = Prefixed_Name(hto, "lightsGroup") |> PrefixedName
    /// <summary>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Equip which meters usage of `elec` energy, thermal energy, `gas`, `water` or `steam`.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#meter">http://vcharpenay.github.io/hto/hto.xml#meter</seealso>
    let meter = Prefixed_Name(hto, "meter") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Auxiliary heating points associated with a `vav`.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#perimeterHeat">http://vcharpenay.github.io/hto/hto.xml#perimeterHeat</seealso>
    let perimeterHeat = Prefixed_Name(hto, "perimeterHeat") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Indicates points associated with the measurment or control of the refrigerant substance in a cooling system like a `chiller`.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Primary on/off `point` of an `equip` especially used with a `vfd`. Run is used with Bool points where true indicates on and false indicates off. When paired with `cmd` this is the commanded state of the equipment. When paired with `sensor` this is the actual status of the equip.  If the equipment also defines an `enable` point then both must be commanded on in order to run the equipment.</para>
    ///   <para>note: according to the documentation, subsumes sensor. But associated here to a Measurement type.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Variable Volume Volume supply duct `equip`.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#vav">http://vcharpenay.github.io/hto/hto.xml#vav</seealso>
    let vav = Prefixed_Name(hto, "vav") |> PrefixedName
    /// <summary>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Secondary on/off `point` of an `equip` especially used with a `vfd`. Enable is used with Bool points where true indicates on and false indicates off.  Equip with an enable should always also define a `run` point which indicates the primary on/off state of the equipment.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Associated with the exhaust air an `ahu`.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#exhaust">http://vcharpenay.github.io/hto/hto.xml#exhaust</seealso>
    let exhaust = Prefixed_Name(hto, "exhaust") |> PrefixedName
    /// <summary>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Marker tag on a `point` which measures rate of volume currently flowing through a flow meter, duct, or pipe .   - Air flow: "cfm" or "L/s"   - Gas/water flow: "gal/min" or "mÂ³/s"</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Bool `point` which models the on or off state of an `ahu` heat wheel.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Associated with the heating mode of an HVAC system.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Indicates a `valve` used to isolate a piece of equipment from a piping system.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Light level sensor point under `lightsGroup` measured in "lux" or "lumen".</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Models a `point` on a `chiller` used to command or measure the chiller's load as a percentage from "0%" to "100%".  When paired with `cmd` this models the chiller's load limit.  When paired with `sensor` this models the chiller's current load factor.</para>
    /// </remarks>
    ...
    ///   <para>hto:HTag</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>  Associated with the mixed air of an `ahu`.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#mixed">http://vcharpenay.github.io/hto/hto.xml#mixed</seealso>
    let mixed = Prefixed_Name(hto, "mixed") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Static pressure associated with the measurement or control of fluids such as air, oxygen, water, steam, gas, oil, etc.</para>
    /// </remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#pressure">http://vcharpenay.github.io/hto/hto.xml#pressure</seealso>
    let pressure = Prefixed_Name(hto, "pressure") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>hto:HTag</para>
    ///   <para>  Used with `ahu` to mark an AHU as a packaged rooftop unit (RTU).</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Efficiency</para></remarks>
    /// <seealso href="http://vcharpenay.github.io/hto/hto.xml#Efficiency">http://vcharpenay.github.io/hto/hto.xml#Efficiency</seealso>
    let Efficiency = Prefixed_Name(hto, "Efficiency") |> PrefixedName
    /// <summary>
    ///   <para>hto:Fan</para>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Historized</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Point Property</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>On/Off</para></remarks>
