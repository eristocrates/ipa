...
module essglobal =
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Cost Composition"</para><para>"Composição de Custos"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Labour"</para><para>"Trabalho"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Local de Venda"</para><para>"Location of Sale"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Rede"</para><para>"Network"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Sale Option"</para><para>"Opção de Venda"</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"Type of Labour VES"</para><para>"Tipo de Trabalho VES"</para></remarks>
    ...
    ///
    /// labels<para>"Cost per Unit"</para><para>"Custo por Unidade"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Delivery Range (distance)"</para><para>"Alcance da Entrega (distância)"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Has Cost"</para><para>"Tem Custo"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Has input"</para><para>"Tem insumo"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Has Other Costs"</para><para>"Tem Outros Custos"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Is available"</para><para>"Está disponível"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Available At"</para><para>"Disponível Em"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Is Main"</para><para>"É o Principal"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Is SSE Initiative"</para><para>"É Iniciativa da ESS"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Legal Form"</para><para>"Forma Jurídica"</para></remarks>
    /// <seealso href="http://purl.org/essglobal/vocab/legalForm">http://purl.org/essglobal/vocab/legalForm</seealso>
    let legalForm = Prefixed_Name(essglobal, "legalForm") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Missão"</para><para>"Mission"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Objetivo"</para><para>"Objective"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Qualifier"</para><para>"Qualificador"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Quantity per Product or Service Unit"</para><para>"Quantidade por Unidade de Produto ou Serviço"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"State"</para><para>"Estado"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Total of Men"</para><para>"Total de Homens"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Total of Members"</para><para>"Total de Associados"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Unit"</para><para>"Unidade"</para></remarks>
