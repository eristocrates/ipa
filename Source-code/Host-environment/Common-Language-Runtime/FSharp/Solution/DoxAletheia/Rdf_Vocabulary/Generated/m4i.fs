...
module m4i =
    ...
    /// </para>
    /// labels<para>Metadata4Ing</para><para>Metadata4Ing</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>redundant information: applicable unit can be deduced from quantity kind. If one wants to enforce the use of a specific unit, use a SHACL constraint.</para>
    /// </remarks>
