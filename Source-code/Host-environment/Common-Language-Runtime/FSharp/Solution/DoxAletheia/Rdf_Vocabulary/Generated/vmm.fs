...
module vmm =
    ...
    ///    con algún lenguaje visual.</para>
    /// labels<para>The Diagram entity</para></remarks>
    ...
    ///    la herramienta de modelado.</para>
    /// labels<para>The ModelRepository entity</para></remarks>
    ...
    ///   <para>Conectores de un determinado elemento de modelado</para>
    /// labels<para>The connectors reference</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Elementos de modelado contenidos en un determinado diagrama</para>
    /// labels<para>The containedElements reference</para></remarks>
    ...
    ///    dos elementos de modelado.</para>
    /// labels<para>The Connector entity</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>Nombre de un paquete, diagrama, elemento, conector o proyecto</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Elemento destino de un conector entre dos elementos de modelado</para>
    /// labels<para>The target reference</para></remarks>
    ...
    ///    cual organizar los diferentes modelos.</para>
    /// labels<para>The Package entity</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Paquetes de modelos de un determinado proyecto</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Tipo de un diagrama, elemento o conector entre elementos de modelado</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>Descripción de un paquete, diagrama, elemento, conector o proyecto</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Diagramas (modelos) includos en un paquete</para>
    /// labels<para>The diagrams reference</para></remarks>
    ...
    ///    son ejemplos de tipos de elementos en modelos UML.</para>
    /// labels<para>The Element entity</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Elementos de modelado incluidos en un paquete</para>
    /// labels<para>The elements reference</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Paquetes incluidos dentro de un paquete de modelos</para>
    /// labels<para>The embeddedPackages reference</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Proyectos registrados en la herramienta de modelado visual</para>
