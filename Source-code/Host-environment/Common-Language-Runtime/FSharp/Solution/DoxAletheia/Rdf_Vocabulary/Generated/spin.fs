...
module spin =
    ...
    let AskTemplate = _prefix "AskTemplate"
    /// <summary>
    ...
    let AskTemplates = _prefix "AskTemplates"
    /// <summary>
    ...
    let ConstraintViolation = _prefix "ConstraintViolation"
    /// <summary>
    ...
    let LibraryOntology = _prefix "LibraryOntology"
    /// <summary>
    ...
    let MagicProperties = _prefix "MagicProperties"
    /// <summary>
    ///   <see href="http://spinrdf.org/spin#MagicProperty"></see>
    /// </summary>
    let MagicProperty = _prefix "MagicProperty"
    /// <summary>
    ...
    let columnIndex = _prefix "columnIndex"
    /// <summary>
    ...
    let columnType = _prefix "columnType"
    /// <summary>
    ...
    let columnWidth = _prefix "columnWidth"
    /// <summary>
    ...
    let nextRuleProperty = _prefix "nextRuleProperty"
    /// <summary>
    ...
    let rulePropertyMaxIterationCount = _prefix "rulePropertyMaxIterationCount"
    /// <summary>
    ...
    let thisUnbound = _prefix "thisUnbound"
    /// <summary>
    ...
    let violationLevel = _prefix "violationLevel"
    /// <summary>
    ...
    let violationPath = _prefix "violationPath"
    /// <summary>
    ...
    let violationRoot = _prefix "violationRoot"
    /// <summary>
    ...
    let violationSource = _prefix "violationSource"
    /// <summary>
    ...
    let violationValue = _prefix "violationValue"
