...
module uby =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>WordFormAttribute</para></remarks>
    ...
    /// </para>
    /// labels<para>quantification</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>In Uby-LMF, the attribute senseAxisType of the SenseAxis class indicates, whether the type of linking between to senses or between two synsets. Example values are monolingualSenseAlignment and crosslingualSenseAlignment</para>
    /// labels<para>senseAxisType</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>translatedDefinition</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>transparentMeaning</para></remarks>
    ...
    ///   <para>uby:PartOfSpeech</para>
    ///
    /// labels<para>particleInfinitive</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>SyntacticFeature groups attributes of UBY-LMF classes from the ISO LMF Syntax extension package.</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>coreType</para></remarks>
    ...
    ///   <para>uby:PartOfSpeech</para>
    ///
    /// labels<para>adpositionPreposition</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>adverbPhrase</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>adverbialComplement</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>affixPrefix</para></remarks>
    ...
    /// labels<para>lexical feature structure</para><para>complex lexical feature</para><para>lexical data structure</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>exampleType</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>grammaticalFunction</para></remarks>
    ...
    /// Example: These types of fish mix well together.</para>
    /// labels<para>grammaticalNumber</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Label encodes a name (short - like a tag) and is an attribute of the UBY-LMF class SemanticLabel, SemanticPredicate, </para>
    ...
    ///
    /// labels<para>monolingualExternalRef</para></remarks>
    ...
    ///   <para>uby:SenseAxisType</para>
    ///
    /// labels<para>monolingualSenseAlignment</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>nounProperLastName</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>particleNegative</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>perspectivalized</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>definitionType</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>In UBY-LMF, relType is an attribute of the RelatedForm class which encodes links to derivationally related lexical entries or senses.</para>
    /// labels<para>relType</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>LexicalFeature groups different kinds of lexical feaures, which correspond to attributes of UBY-LMF classes.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>determinerIndefinite</para></remarks>
    ...
    /// There echoed voices through the hall. (verb class sound_existence-47.4)</para>
    ...
    ///   <para>uby:CoreType</para>
    ///
    /// labels<para>extraThematic</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>geographicalVariant</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>syntacticProperty</para></remarks>
    ...
    /// label=animate (for type=semanticField).</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>grammaticalGender</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>verbFormMood</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hyphenation</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>incorporatedSemArg</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>infinitiveZu</para></remarks>
    ...
    ///   <para>uby:VerbForm</para>
    ///
    /// labels<para>ingForm</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>isHead</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>isIncorporated</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>languageIdentifier</para></remarks>
    ...
    /// * Er schafft, den Termin einzuhalten.</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>lexicalized</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>loanWord</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>nominative</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>nonPredicativeAdjective</para></remarks>
    ...
    ///   <para>uby:PartOfSpeech</para>
    ///
    /// labels<para>nounCommon</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>nounProper</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>objectComplement</para></remarks>
    ...
    ///   <para>uby:SyntacticProperty</para>
    ///
    /// labels<para>objectControl</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>objectRaising</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>orthographyName</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>partWhole</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>particleAnswer</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>particleComparative</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>partitiveDefinition</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>peripheral</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>phoneticForm</para></remarks>
    ...
    ///   <para>uby:PartOfSpeech</para>
    ///
    /// labels<para>phraseme</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>postpositiveAdjective</para></remarks>
    ...
    /// Example: That depends on who did it.</para>
    ...
    /// The preposition type is specified in VerbNet.</para>
    /// labels<para>prepositionType</para></remarks>
    ...
    ///   <para>uby:GrammaticalFunction</para>
    ///
    /// labels<para>prepositionalComplement</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>prepositionalPhrase</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>pronounDemonstrative</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>pronounIndefinite</para></remarks>
    ...
    ///   <para>uby:PartOfSpeech</para>
    ///
    /// labels<para>pronounInterrogative</para></remarks>
    ...
    ///   <para>uby:PartOfSpeech</para>
    ///
    /// labels<para>pronounPersonal</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>pronounPersonalIrreflexive</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>SenseRelation</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>separableParticle</para></remarks>
    ...
    ///   <para>uby:ExampleType</para>
    ///
    /// labels<para>subcatFrame</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>subjectComplement</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>subjectControl</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>subjectRaising</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>syntacticUsage</para></remarks>
    ...
    ///   <para>uby:RelType</para>
    ///
    /// labels<para>taxonomic</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>thatType</para></remarks>
    ...
    ///   <para>uby:VerbForm</para>
    ///
    /// labels<para>toInfinitive</para></remarks>
    ...
    ///   <para>uby:PartOfSpeech</para>
    ///
    /// labels<para>verbAuxiliary</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>verbMain</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>verbModal</para></remarks>
    ...
    ///   <para>uby:Complementizer</para>
    ///
    /// labels<para>whType</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>writtenForm</para></remarks>
    ...
    ///   <para>uby:Complementizer</para>
    ///
    /// labels<para>yesNoType</para></remarks>
    ...
    ///   <para>uby:CoreType</para>
    ///
    /// labels<para>coreUnexpressed</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>crosslingualSenseAlignment</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>This owl:Class corresponds to the LMF-class Frequency which has been introduced in UBY-LMF as an extension of ISO-LMF.</para>
    /// </remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>externalSystem</para></remarks>
    ...
    /// The current name "hasUbyObjectProperty" indicates that it groups Object Properties used in UBY-LMF.</para>
    /// </remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>syntacticCategory</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>verbForm</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>partOfSpeech</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>idiomaticExpression</para></remarks>
    ...
    /// It encodes a ranking of the senses according to their frequency which is provided, e.g., by WordNet.</para>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>intensionalDefinition</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>isBreakBefore</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>As a convention, the relation is called has_partOfSpeech, partOfSpeech is the top-level *class* of parts of speech</para>
    /// labels<para>partOfSpeech</para></remarks>
    ...
    ///   <para>uby:SyntacticProperty</para>
    ///
    /// labels<para>predicativeAdjective</para></remarks>
    ...
    ///   <para>uby:PartOfSpeech</para>
    ///
    /// labels<para>pronounPersonalReflexive</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>pronounPossessive</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>pronounRelative</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>nounProperFirstName</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>This owl:Class corresponds to the LMF-class SemanticLabel which has been introduced in UBY-LMF as an extension of ISO-LMF.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>senseInstance</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Specifies the verb form to be used in a verb phrase complement.</para>
    /// labels<para>verbForm</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>abbreviationAcronym</para></remarks>
    ...
    ///   <para>uby:Case</para>
    ///
    /// labels<para>accusative</para></remarks>
    ...
    ///   <para>uby:PartOfSpeech</para>
    ///
    /// labels<para>adpositionPostposition</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>This owl:Class corresponds to the ISO LMF-class Synset.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Attribute of the UBY-LMF class SubcategorizationFrame.</para>
    /// labels<para>syntacticProperty</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>WordForm</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>abbreviationInitialism</para></remarks>
    ...
    ///   <para>uby:SyntacticCategory</para>
    ///
    /// labels<para>adjectivePhrase_nounPhrase</para></remarks>
    ...
    ///   <para>uby:PartOfSpeech</para>
    ///
    /// labels<para>adpositionCircumposition</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>adverbPronominal</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>affixSuffix</para></remarks>
    ...
    ///   <para>uby:VerbForm</para>
    ///
    /// labels<para>bareInfinitive</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>complementary</para></remarks>
    ...
    ///   <para>uby:PartOfSpeech</para>
    ///
    /// labels<para>conjunctionSubordinating</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>corpus</para></remarks>
    ...
    ///   <para>uby:Case</para>
    ///
    /// labels<para>dative</para></remarks>
    ...
    ///   <para>uby:SyntacticCategory</para>
    ///
    /// labels<para>declarativeClause</para></remarks>
    ...
    ///   <para>uby:DerivationType</para>
    ///
    /// labels<para>derivationBaseNoun</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>derivationBaseVerb</para></remarks>
    ...
    ///   <para>uby:PartOfSpeech</para>
    ///
    /// labels<para>determinerDefinite</para></remarks>
    ...
    ///   <para>uby:PartOfSpeech</para>
    ///
    /// labels<para>determinerDemonstrative</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>determinerInterrogative</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>determinerPossessive</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>extensionalDefinition</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>compoundRoot</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>conjunctionCoordinating</para></remarks>
    ...
    /// The current name "hasUbyDatatypeProperty" indicates that it groups Data Properties used in UBY-LMF.</para>
    /// </remarks>
    ...
    ///   <para>uby:DerivationType</para>
    ///
    /// labels<para>derivationBase</para></remarks>
    ...
    ///   <para>uby:DerivationType</para>
    ///
    /// labels<para>derivationBaseAdj</para></remarks>
