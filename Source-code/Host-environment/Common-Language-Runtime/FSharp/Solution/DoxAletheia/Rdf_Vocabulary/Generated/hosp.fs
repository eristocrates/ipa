...
module hosp =
    ...
    ///
    /// labels<para>accreditation</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>HospitalType</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>cacProvider</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>mpvProvider</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>HospitalOwnershipType</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>emergencyServices</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>treats</para></remarks>
