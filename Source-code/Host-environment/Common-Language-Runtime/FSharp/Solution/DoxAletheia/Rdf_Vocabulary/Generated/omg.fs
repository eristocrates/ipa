...
module omg =
    ...
    let CurrentGeometryState =
        Namespaced_IRI.parse _namespace_name "CurrentGeometryState" |> NamespacedName
    ...
    let GeometryState =
        Namespaced_IRI.parse _namespace_name "GeometryState" |> NamespacedName
    ...
    let GeometryContext =
        Namespaced_IRI.parse _namespace_name "GeometryContext" |> NamespacedName
    ...
    let complementsGeometry =
        Namespaced_IRI.parse _namespace_name "complementsGeometry" |> NamespacedName
    ...
    let containsGeometryObject =
        Namespaced_IRI.parse _namespace_name "containsGeometryObject" |> NamespacedName
    ...
    let containsPropertyState =
        Namespaced_IRI.parse _namespace_name "containsPropertyState" |> NamespacedName
    ...
    let hasComplexGeometryDescription =
        Namespaced_IRI.parse _namespace_name "hasComplexGeometryDescription" |> NamespacedName
    ...
    let hasGeometryContext =
        Namespaced_IRI.parse _namespace_name "hasGeometryContext" |> NamespacedName
    ...
    let hasGeometryState =
        Namespaced_IRI.parse _namespace_name "hasGeometryState" |> NamespacedName
    ...
    let hasInferredPropertyState =
        Namespaced_IRI.parse _namespace_name "hasInferredPropertyState" |> NamespacedName
    ...
    let isExplicitlyDerivedFrom =
        Namespaced_IRI.parse _namespace_name "isExplicitlyDerivedFrom" |> NamespacedName
    ...
    let hasSimpleGeometryDescription =
        Namespaced_IRI.parse _namespace_name "hasSimpleGeometryDescription" |> NamespacedName
    ...
    let isDerivedFromGeometry =
        Namespaced_IRI.parse _namespace_name "isDerivedFromGeometry" |> NamespacedName
    ...
    let isDerivedFromGeometryState =
        Namespaced_IRI.parse _namespace_name "isDerivedFromGeometryState" |> NamespacedName
    ...
    let isImplicitlyDerivedFrom =
        Namespaced_IRI.parse _namespace_name "isImplicitlyDerivedFrom" |> NamespacedName
    ...
    let transformsGeometry =
        Namespaced_IRI.parse _namespace_name "transformsGeometry" |> NamespacedName
