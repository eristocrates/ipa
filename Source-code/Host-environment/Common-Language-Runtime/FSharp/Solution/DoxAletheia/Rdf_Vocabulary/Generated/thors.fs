...
module thors =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Time Ordinal Era Boundary</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Time Ordinal Era or Interval</para></remarks>
    ...
    ///   <para>era or interval beginning or start</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>reference system that this era belongs to</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>reference point in timescale</para></remarks>
