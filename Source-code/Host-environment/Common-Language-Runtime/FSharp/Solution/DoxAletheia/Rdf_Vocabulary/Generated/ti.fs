...
module ti =
    ...
    ///   <para>The end date of a time interval.</para>
    ...
    /// It should be used when you want to talk about time as an object having some characteristics.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The start date of a time interval.</para>
