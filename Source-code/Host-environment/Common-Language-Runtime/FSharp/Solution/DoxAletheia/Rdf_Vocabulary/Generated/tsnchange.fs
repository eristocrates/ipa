...
module tsnchange =
    ...
    let AcronymChange =
        Namespaced_IRI.parse _namespace_name "AcronymChange" |> NamespacedName
    ...
    let IdentificationChange =
        Namespaced_IRI.parse _namespace_name "IdentificationChange" |> NamespacedName
    ...
    let FeatureChange =
        Namespaced_IRI.parse _namespace_name "FeatureChange" |> NamespacedName
    ...
    let ContinuationChange =
        Namespaced_IRI.parse _namespace_name "ContinuationChange" |> NamespacedName
    ...
    let GeometryRestructuration =
        Namespaced_IRI.parse _namespace_name "GeometryRestructuration" |> NamespacedName
    ...
    let GeometryChange =
        Namespaced_IRI.parse _namespace_name "GeometryChange" |> NamespacedName
    ...
    let DerivationChange =
        Namespaced_IRI.parse _namespace_name "DerivationChange" |> NamespacedName
    ...
    let DescriptionChange =
        Namespaced_IRI.parse _namespace_name "DescriptionChange" |> NamespacedName
    ...
    let Disappearance =
        Namespaced_IRI.parse _namespace_name "Disappearance" |> NamespacedName
    ...
    let Expansion = Namespaced_IRI.parse _namespace_name "Expansion" |> NamespacedName
    /// <summary>
    ...
    let Fusion = Namespaced_IRI.parse _namespace_name "Fusion" |> NamespacedName
    /// <summary>
    ...
    let StructureChange =
        Namespaced_IRI.parse _namespace_name "StructureChange" |> NamespacedName
    ...
    let HierarchyChange =
        Namespaced_IRI.parse _namespace_name "HierarchyChange" |> NamespacedName
    ...
    let HierarchyRestructuration =
        Namespaced_IRI.parse _namespace_name "HierarchyRestructuration" |> NamespacedName
    ...
    let IdentificationRestructuration =
        Namespaced_IRI.parse _namespace_name "IdentificationRestructuration" |> NamespacedName
    ...
    let IdentifierChange =
        Namespaced_IRI.parse _namespace_name "IdentifierChange" |> NamespacedName
    ...
    let Integration =
        Namespaced_IRI.parse _namespace_name "Integration" |> NamespacedName
    ...
    let LevelBelongingChange =
        Namespaced_IRI.parse _namespace_name "LevelBelongingChange" |> NamespacedName
    ...
    let UnitHierarchyChange =
        Namespaced_IRI.parse _namespace_name "UnitHierarchyChange" |> NamespacedName
    ...
    let LevelChange =
        Namespaced_IRI.parse _namespace_name "LevelChange" |> NamespacedName
    ...
    let LevelHierarchyChange =
        Namespaced_IRI.parse _namespace_name "LevelHierarchyChange" |> NamespacedName

    /// <summary>
    /// The lower level  of a level changes.
    /// <see href="http://purl.org/net/tsnchange#LowerLevelChange"></see></summary>
    let LowerLevelChange =
        Namespaced_IRI.parse _namespace_name "LowerLevelChange" |> NamespacedName

    /// <summary>
    /// The name of a TSNFeature changes.
    /// <see href="http://purl.org/net/tsnchange#NameChange"></see></summary>
    let NameChange = Namespaced_IRI.parse _namespace_name "NameChange" |> NamespacedName
    ...
    let Reallocation =
        Namespaced_IRI.parse _namespace_name "Reallocation" |> NamespacedName
    ...
    let Redistribution =
        Namespaced_IRI.parse _namespace_name "Redistribution" |> NamespacedName
    ...
    let Rectification =
        Namespaced_IRI.parse _namespace_name "Rectification" |> NamespacedName
    ...
    let Scission = Namespaced_IRI.parse _namespace_name "Scission" |> NamespacedName
    ...
    let SuperUnitChange =
        Namespaced_IRI.parse _namespace_name "SuperUnitChange" |> NamespacedName
    ...
    let TerritoryChange =
        Namespaced_IRI.parse _namespace_name "TerritoryChange" |> NamespacedName
    ...
    let UnitChange = Namespaced_IRI.parse _namespace_name "UnitChange" |> NamespacedName

    /// <summary>
    /// The upper level  of a level changes.
    /// <see href="http://purl.org/net/tsnchange#UpperLevelChange"></see></summary>
    let UpperLevelChange =
        Namespaced_IRI.parse _namespace_name "UpperLevelChange" |> NamespacedName
    ...
    let inputLevelVersion =
        Namespaced_IRI.parse _namespace_name "inputLevelVersion" |> NamespacedName
    ...
    let inputNomenclatureVersion =
        Namespaced_IRI.parse _namespace_name "inputNomenclatureVersion" |> NamespacedName
    ...
    let inputTerritoryVersion =
        Namespaced_IRI.parse _namespace_name "inputTerritoryVersion" |> NamespacedName
    ...
    let inputUnitVersion =
        Namespaced_IRI.parse _namespace_name "inputUnitVersion" |> NamespacedName
    ...
    let levelVersionAfter =
        Namespaced_IRI.parse _namespace_name "levelVersionAfter" |> NamespacedName
    ...
    let outputLevelVersion =
        Namespaced_IRI.parse _namespace_name "outputLevelVersion" |> NamespacedName
    ...
    let levelVersionBefore =
        Namespaced_IRI.parse _namespace_name "levelVersionBefore" |> NamespacedName
    ...
    let lowerChange =
        Namespaced_IRI.parse _namespace_name "lowerChange" |> NamespacedName
    ...
    let nomenclatureVersionAfter =
        Namespaced_IRI.parse _namespace_name "nomenclatureVersionAfter" |> NamespacedName
    ...
    let outputNomenclatureVersion =
        Namespaced_IRI.parse _namespace_name "outputNomenclatureVersion" |> NamespacedName
    ...
    let nomenclatureVersionBefore =
        Namespaced_IRI.parse _namespace_name "nomenclatureVersionBefore" |> NamespacedName
    ...
    let outputTerritoryVersion =
        Namespaced_IRI.parse _namespace_name "outputTerritoryVersion" |> NamespacedName
    ...
    let outputUnitVersion =
        Namespaced_IRI.parse _namespace_name "outputUnitVersion" |> NamespacedName
    ...
    let territoryVersionAfter =
        Namespaced_IRI.parse _namespace_name "territoryVersionAfter" |> NamespacedName
    ...
    let territoryVersionBefore =
        Namespaced_IRI.parse _namespace_name "territoryVersionBefore" |> NamespacedName

    /// <summary>
    /// Indicates a UnitVersion after a change event.
    /// <see href="http://purl.org/net/tsnchange#unitVersionAfter"></see></summary>
    let unitVersionAfter =
        Namespaced_IRI.parse _namespace_name "unitVersionAfter" |> NamespacedName
    ...
    let unitVersionBefore =
        Namespaced_IRI.parse _namespace_name "unitVersionBefore" |> NamespacedName
    ...
    let upperChange =
        Namespaced_IRI.parse _namespace_name "upperChange" |> NamespacedName
