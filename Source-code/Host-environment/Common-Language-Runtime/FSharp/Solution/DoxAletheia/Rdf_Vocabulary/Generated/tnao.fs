...
module tnao =
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"In the context of the social semantic desktop the textual annotation provided via rdfs:comment is meant for technical users, the textual annotation here is aimed at average users and is meant to be used to define custom descriptions of resources on the desktop"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"This property defines a symmetric relation between any two resources. In order for this property to be used legally, the relationship must be symmetric."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <summary>
    ///   <para>tnao:predefined-tag-favorite</para>
    /// </summary>
    /// <remarks>
    ///   <para>tnao:Tag</para>
    /// </remarks>
    /// <seealso href="http://tracker.api.gnome.org/ontology/v3/nao#predefined-tag-favorite">http://tracker.api.gnome.org/ontology/v3/nao#predefined-tag-favorite</seealso>
    let predefined_tag_favorite =
        Prefixed_Name(tnao, "predefined-tag-favorite") |> PrefixedName
