...
module eduprog =
    ...
    /// labels<para>"Cours"</para><para>"Course "</para></remarks>
    ...
    /// labels<para>"Learning domain"</para><para>"Domaine d'enseignement"</para></remarks>
    ...
    /// labels<para>"Progression"</para></remarks>
