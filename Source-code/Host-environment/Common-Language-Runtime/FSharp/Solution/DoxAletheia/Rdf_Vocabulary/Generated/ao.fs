...
module ao =
    ...
    /// labels<para>"has included association"</para><para>"is included association of"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Associates likeminded people to an association, which they like/ agree with."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"is likeminded of"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"has likeminded"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
