...
module lio =
    ...
    let PictorialElement =
        Namespaced_IRI.parse _namespace_name "PictorialElement" |> NamespacedName
    ...
    let conveys = Namespaced_IRI.parse _namespace_name "conveys" |> NamespacedName
    /// <summary>
    ...
    let shows = Namespaced_IRI.parse _namespace_name "shows" |> NamespacedName
    ...
    let hasArtisticElement =
        Namespaced_IRI.parse _namespace_name "hasArtisticElement" |> NamespacedName
    ...
    let hasDepictedBackground =
        Namespaced_IRI.parse _namespace_name "hasDepictedBackground" |> NamespacedName
    ...
    let hasInBackground =
        Namespaced_IRI.parse _namespace_name "hasInBackground" |> NamespacedName
    ...
    let hasInForeground =
        Namespaced_IRI.parse _namespace_name "hasInForeground" |> NamespacedName
    ...
    let hasPictorialBackground =
        Namespaced_IRI.parse _namespace_name "hasPictorialBackground" |> NamespacedName
    ...
    let hasVisualPart =
        Namespaced_IRI.parse _namespace_name "hasVisualPart" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/net/lio#visualPartOf"></see>
    /// </summary>
    let visualPartOf =
        Namespaced_IRI.parse _namespace_name "visualPartOf" |> NamespacedName
    ...
    let looksLike = Namespaced_IRI.parse _namespace_name "looksLike" |> NamespacedName
    /// <summary>
    ...
    let usesPictorially =
        Namespaced_IRI.parse _namespace_name "usesPictorially" |> NamespacedName
