...
module oml =
    ...
    let CountObject =
        Namespaced_IRI.parse _namespace_name "CountObject" |> NamespacedName
    ...
    let MeasureObject =
        Namespaced_IRI.parse _namespace_name "MeasureObject" |> NamespacedName
    ...
    let ObservationAgent =
        Namespaced_IRI.parse _namespace_name "ObservationAgent" |> NamespacedName
    ...
    let ObservationCollection =
        Namespaced_IRI.parse _namespace_name "ObservationCollection" |> NamespacedName
    ...
    let SimpleMeasure =
        Namespaced_IRI.parse _namespace_name "SimpleMeasure" |> NamespacedName
    ...
    let TemporalObject =
        Namespaced_IRI.parse _namespace_name "TemporalObject" |> NamespacedName
    ...
    let TruthObject =
        Namespaced_IRI.parse _namespace_name "TruthObject" |> NamespacedName
    ...
    let samplingStrategy =
        Namespaced_IRI.parse _namespace_name "samplingStrategy" |> NamespacedName
