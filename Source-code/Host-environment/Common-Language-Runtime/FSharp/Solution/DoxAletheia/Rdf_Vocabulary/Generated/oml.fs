...
module oml =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Object to wrap a count value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Count object"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Observation whose result is a geometry object, such as a point, curve, surface or solid"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"Mesure"</para><para>"Measurement"</para></remarks>
    ...
    ///
    /// The values for the properties 'procedure', 'featureOfInterest', 'observedProperty', 'phenomenonTime', 'resultTime' may be inherited from a container resource."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Agent, device, sensor, software, protocol, computational method, algorithm or plan responsible for generating an observation result. Input may be a sensor stimulus, or the output from a previous process."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// The collection may be homogeneous in one or more of the feature-of-interest, observed-property, procedures, phenomenon-time or result-time. If only one value for any of these properties is provided on the collection, then it may be inferred to be a common (default) value for all the member observations, unless locally overridden."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Simple implementation of a scaled number as an (amount, unit) pair"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Simple measure (quantity)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// Temporal object has properties relating to time only."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Object to wrap a truth value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Truth object"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// labels<para>"numeric amount value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// The first half of the property named 'relatedObservation' in the UML model. (The rule for implementing association classes needs clarification.)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"observation context"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Count value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// Links the Observation to the Feature that is the ultimate subject of the observation and carries the observed property. This feature is the real-world object whose properties are under observation. An observation instance serves as a propertyValueProvider for its feature-of-interest."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"is member of"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Truth value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>owl:Class</para>
    ///   <para>"Unit of measure or scale"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
