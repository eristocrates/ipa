...
module lexinfov2 =
    ...
    let AccusativePostPositiveArgument =
        Namespaced_IRI.parse _namespace_name "AccusativePostPositiveArgument" |> NamespacedName

    /// <summary>
    ///   <see href="http://www.lexinfo.net/ontology/2.0/lexinfo#PostPositiveArgument"></see>
    /// </summary>
    let PostPositiveArgument =
        Namespaced_IRI.parse _namespace_name "PostPositiveArgument" |> NamespacedName
    ...
    let DativePostPositiveArgument =
        Namespaced_IRI.parse _namespace_name "DativePostPositiveArgument" |> NamespacedName
    ...
    let GenitivePostPositiveArgument =
        Namespaced_IRI.parse _namespace_name "GenitivePostPositiveArgument" |> NamespacedName
    ...
    let AttributiveArgument =
        Namespaced_IRI.parse _namespace_name "AttributiveArgument" |> NamespacedName
    ...
    /// </summary>
    let ClausalArgument =
        Namespaced_IRI.parse _namespace_name "ClausalArgument" |> NamespacedName
    ...
    let formPositivityVariant =
        Namespaced_IRI.parse _namespace_name "formPositivityVariant" |> NamespacedName
