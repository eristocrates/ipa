...
module poso =
    ...
    /// <summary>
    ///   <para>poso:1.0/common/</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://purl.org/poso/1.0/common/">http://purl.org/poso/1.0/common/</seealso>
    let ``_1.0/common/`` = Prefixed_Name(poso, "1.0/common/") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"Versnelling"</para><para>"Acceleration"</para></remarks>
    ...
    /// labels<para>"Draaisnelheid"</para><para>"Angular velocity"</para></remarks>
    ...
    /// labels<para>"Linear movement"</para><para>"Lineaire beweging"</para></remarks>
    ...
    /// labels<para>"Linear velocity"</para><para>"Lineaire snelheid"</para></remarks>
    ...
    /// labels<para>"Movement"</para><para>"Beweging"</para></remarks>
    ...
    /// labels<para>"Orientatie"</para><para>"Orientation"</para></remarks>
    ...
    /// labels<para>"Relative position"</para><para>"Relatieve positie"</para></remarks>
    ...
    /// labels<para>"Relative velocity"</para><para>"Relatieve snelheid"</para></remarks>
    ...
    /// labels<para>"hoek"</para><para>"angle"</para></remarks>
    ...
    /// labels<para>"has accuracy"</para><para>"heeft accuraatheid"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"has coordinate reference system"</para><para>"heeft een coördinaten referentiesysteem"</para></remarks>
    ...
    /// labels<para>"has position"</para><para>"heeft positie"</para></remarks>
    ...
    /// labels<para>"has velocity"</para><para>"heeft snelheid"</para></remarks>
    ...
    /// labels<para>"observes type"</para><para>"observeert type"</para></remarks>
