...
module poso =
    ...
    let AngularMovement =
        Namespaced_IRI.parse _namespace_name "AngularMovement" |> NamespacedName
    ...
    let Angulation = Namespaced_IRI.parse _namespace_name "Angulation" |> NamespacedName
    ...
    let Triangulation =
        Namespaced_IRI.parse _namespace_name "Triangulation" |> NamespacedName

    /// <summary>
    /// A spatial landmark that can be observed by sound.
    /// <see href="http://purl.org/poso/AuditoryLandmark"></see></summary>
    let AuditoryLandmark =
        Namespaced_IRI.parse _namespace_name "AuditoryLandmark" |> NamespacedName
    ...
    let AxisAngleOrientation =
        Namespaced_IRI.parse _namespace_name "AxisAngleOrientation" |> NamespacedName
    ...
    let xAxisValue = Namespaced_IRI.parse _namespace_name "xAxisValue" |> NamespacedName
    /// <summary>
    ...
    let yAxisValue = Namespaced_IRI.parse _namespace_name "yAxisValue" |> NamespacedName
    /// <summary>
    /// Quantitative result value along the Z-axis of a spatial sensor.
    /// <see href="http://purl.org/poso/zAxisValue"></see></summary>
    let zAxisValue = Namespaced_IRI.parse _namespace_name "zAxisValue" |> NamespacedName
    ...
    let CellIdentification =
        Namespaced_IRI.parse _namespace_name "CellIdentification" |> NamespacedName
    ...
    let PositioningTechnique =
        Namespaced_IRI.parse _namespace_name "PositioningTechnique" |> NamespacedName
    ...
    let DeadReckoning =
        Namespaced_IRI.parse _namespace_name "DeadReckoning" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/poso/EulerOrientation"></see>
    /// </summary>
    let EulerOrientation =
        Namespaced_IRI.parse _namespace_name "EulerOrientation" |> NamespacedName
    ...
    let roll = Namespaced_IRI.parse _namespace_name "roll" |> NamespacedName
    /// <summary>
    ...
    let yaw = Namespaced_IRI.parse _namespace_name "yaw" |> NamespacedName
    ...
    let Fingerprinting =
        Namespaced_IRI.parse _namespace_name "Fingerprinting" |> NamespacedName
    ...
    let HighLevelFusion =
        Namespaced_IRI.parse _namespace_name "HighLevelFusion" |> NamespacedName
    ...
    let SensorFusion =
        Namespaced_IRI.parse _namespace_name "SensorFusion" |> NamespacedName
    ...
    let IndoorDeployment =
        Namespaced_IRI.parse _namespace_name "IndoorDeployment" |> NamespacedName
    ...
    let IndoorPositioningSystem =
        Namespaced_IRI.parse _namespace_name "IndoorPositioningSystem" |> NamespacedName
    ...
    let InertialPositioningSystem =
        Namespaced_IRI.parse _namespace_name "InertialPositioningSystem" |> NamespacedName
    ...
    let IntegratedPositioningSystem =
        Namespaced_IRI.parse _namespace_name "IntegratedPositioningSystem" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/poso/Lateration"></see>
    /// </summary>
    let Lateration = Namespaced_IRI.parse _namespace_name "Lateration" |> NamespacedName
    ...
    let LinearMovement =
        Namespaced_IRI.parse _namespace_name "LinearMovement" |> NamespacedName
    ...
    let LocationBasedService =
        Namespaced_IRI.parse _namespace_name "LocationBasedService" |> NamespacedName
    ...
    let LowLevelFusion =
        Namespaced_IRI.parse _namespace_name "LowLevelFusion" |> NamespacedName
    ...
    let MagneticOdometry =
        Namespaced_IRI.parse _namespace_name "MagneticOdometry" |> NamespacedName
    ...
    let Odometry = Namespaced_IRI.parse _namespace_name "Odometry" |> NamespacedName
    /// <summary>
    ///   <see href="http://purl.org/poso/MapOutput"></see>
    /// </summary>
    let MapOutput = Namespaced_IRI.parse _namespace_name "MapOutput" |> NamespacedName
    ...
    let MidLevelFusion =
        Namespaced_IRI.parse _namespace_name "MidLevelFusion" |> NamespacedName
    ...
    let Multilateration =
        Namespaced_IRI.parse _namespace_name "Multilateration" |> NamespacedName
    ...
    let OpticalPositioningSystem =
        Namespaced_IRI.parse _namespace_name "OpticalPositioningSystem" |> NamespacedName

    /// <summary>
    /// Describes the deployment of a System in an outdoor environment.
    /// <see href="http://purl.org/poso/OutdoorDeployment"></see></summary>
    let OutdoorDeployment =
        Namespaced_IRI.parse _namespace_name "OutdoorDeployment" |> NamespacedName
    ...
    /// </summary>
    let PolygonalAccuracy =
        Namespaced_IRI.parse _namespace_name "PolygonalAccuracy" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/poso/PositionOutput"></see>
    /// </summary>
    let PositionOutput =
        Namespaced_IRI.parse _namespace_name "PositionOutput" |> NamespacedName
    ...
    let PositioningPlatform =
        Namespaced_IRI.parse _namespace_name "PositioningPlatform" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/poso/QuaternionOrientation"></see>
    /// </summary>
    let QuaternionOrientation =
        Namespaced_IRI.parse _namespace_name "QuaternionOrientation" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/poso/scalar"></see>
    /// </summary>
    let scalar = Namespaced_IRI.parse _namespace_name "scalar" |> NamespacedName
    /// <summary>
    ...
    let RFLandmark = Namespaced_IRI.parse _namespace_name "RFLandmark" |> NamespacedName
    ...
    let RadioPropagation =
        Namespaced_IRI.parse _namespace_name "RadioPropagation" |> NamespacedName
    ...
    let RelativeVelocity =
        Namespaced_IRI.parse _namespace_name "RelativeVelocity" |> NamespacedName

    /// <summary>
    /// Simultaneous localization and mapping (SLAM) is the computational problem of constructing or updating a map of an unknown environment while simultaneously keeping track of an agent's location within it.
    /// <see href="http://purl.org/poso/SLAM"></see></summary>
    let SLAM = Namespaced_IRI.parse _namespace_name "SLAM" |> NamespacedName
    /// <summary>
    ...
    let SatellitePositioningSystem =
        Namespaced_IRI.parse _namespace_name "SatellitePositioningSystem" |> NamespacedName
    ...
    let TrackedFeature =
        Namespaced_IRI.parse _namespace_name "TrackedFeature" |> NamespacedName
    ...
    let VSLAM = Namespaced_IRI.parse _namespace_name "VSLAM" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/poso/VisualInput"></see>
    /// </summary>
    let VisualInput =
        Namespaced_IRI.parse _namespace_name "VisualInput" |> NamespacedName
    ...
    let VisualLandmark =
        Namespaced_IRI.parse _namespace_name "VisualLandmark" |> NamespacedName
    ...
    let VisualOdometry =
        Namespaced_IRI.parse _namespace_name "VisualOdometry" |> NamespacedName
    ...
    let hasAcceleration =
        Namespaced_IRI.parse _namespace_name "hasAcceleration" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/poso/isAccelerationOf"></see>
    /// </summary>
    let isAccelerationOf =
        Namespaced_IRI.parse _namespace_name "isAccelerationOf" |> NamespacedName

    /// <summary>
    /// The accuracy of an entity.
    /// <see href="http://purl.org/poso/hasAccuracy"></see></summary>
    let hasAccuracy =
        Namespaced_IRI.parse _namespace_name "hasAccuracy" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/poso/hasCRS"></see>
    /// </summary>
    let hasCRS = Namespaced_IRI.parse _namespace_name "hasCRS" |> NamespacedName
    /// <summary>
    ...
    let hasSRS = Namespaced_IRI.parse _namespace_name "hasSRS" |> NamespacedName
    ...
    /// </summary>
    let isPositionOf =
        Namespaced_IRI.parse _namespace_name "isPositionOf" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/poso/hasRelativePosition"></see>
    /// </summary>
    let hasRelativePosition =
        Namespaced_IRI.parse _namespace_name "hasRelativePosition" |> NamespacedName

    /// <summary>
    /// Indicates the velocity of a feature of interest.
    /// <see href="http://purl.org/poso/hasVelocity"></see></summary>
    let hasVelocity =
        Namespaced_IRI.parse _namespace_name "hasVelocity" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/poso/isVelocityOf"></see>
    /// </summary>
    let isVelocityOf =
        Namespaced_IRI.parse _namespace_name "isVelocityOf" |> NamespacedName
    ...
    let madeBySystem =
        Namespaced_IRI.parse _namespace_name "madeBySystem" |> NamespacedName
    ...
    let observesType =
        Namespaced_IRI.parse _namespace_name "observesType" |> NamespacedName
