...
module pso =
    ...
    let ``APC-fully-waived`` = _prefix "APC-fully-waived"
    /// <summary>
    ...
    let ArticleProcessingChargeStatus = _prefix "ArticleProcessingChargeStatus"
    /// <summary>
    ...
    let ``APC-not-charged`` = _prefix "APC-not-charged"
    /// <summary>
    ...
    let ``APC-not-required`` = _prefix "APC-not-required"
    /// <summary>
    ...
    let ``APC-partially-waived`` = _prefix "APC-partially-waived"
    /// <summary>
    ...
    let StatusInTime = _prefix "StatusInTime"
    /// <summary>
    ...
    let isStatusHeldBy = _prefix "isStatusHeldBy"
    /// <summary>
    ...
    let withStatus = _prefix "withStatus"
    /// <summary>
    ...
    let isAcquiredAsConsequenceOf = _prefix "isAcquiredAsConsequenceOf"
    /// <summary>
    ...
    let ``accepted-for-publication`` = _prefix "accepted-for-publication"
    /// <summary>
    ...
    let anonymized = _prefix "anonymized"
    /// <summary>
    ...
    let catalogued = _prefix "catalogued"
    /// <summary>
    ...
    let ``closed-access`` = _prefix "closed-access"
    /// <summary>
    ...
    let ``copy-edited`` = _prefix "copy-edited"
    /// <summary>
    ...
    let corrected = _prefix "corrected"
    /// <summary>
    ...
    let embargoed = _prefix "embargoed"
    /// <summary>
    ...
    let ``final-draft`` = _prefix "final-draft"
    /// <summary>
    ...
    let ``gold-open-access`` = _prefix "gold-open-access"
    /// <summary>
    ...
    let ``gratis-open-access`` = _prefix "gratis-open-access"
    /// <summary>
    ...
    let ``green-open-access`` = _prefix "green-open-access"
    /// <summary>
    ...
    let holdsStatusInTime = _prefix "holdsStatusInTime"
    /// <summary>
    ...
    let ``initial-draft`` = _prefix "initial-draft"
    /// <summary>
    ...
    let ``intermediate-draft`` = _prefix "intermediate-draft"
    /// <summary>
    ...
    let isLostAsConsequenceOf = _prefix "isLostAsConsequenceOf"
    /// <summary>
    ...
    let isStatusIn = _prefix "isStatusIn"
    /// <summary>
    ...
    let ``libre-open-access`` = _prefix "libre-open-access"
    /// <summary>
    ...
    let ``non-confidential`` = _prefix "non-confidential"
    /// <summary>
    ...
    let ``open-access`` = _prefix "open-access"
    /// <summary>
    ...
    let ``peer-reviewed`` = _prefix "peer-reviewed"
    /// <summary>
    ...
    let ``rejected-for-publication`` = _prefix "rejected-for-publication"
    /// <summary>
    ...
    let republished = _prefix "republished"
    /// <summary>
    ...
    let ``restricted-access`` = _prefix "restricted-access"
    /// <summary>
    ...
    let resultsInAcquiring = _prefix "resultsInAcquiring"
    /// <summary>
    ...
    let resultsInLosing = _prefix "resultsInLosing"
    /// <summary>
    ...
    let ``retracted-from-publication`` = _prefix "retracted-from-publication"
    /// <summary>
    ...
    let ``subscription-access`` = _prefix "subscription-access"
    /// <summary>
    ...
    let ``under-review`` = _prefix "under-review"
    /// <summary>
    ...
    let ``version-of-record`` = _prefix "version-of-record"
    /// <summary>
    ...
    let ``withdrawn-from-submission`` = _prefix "withdrawn-from-submission"
