...
module osam =
    ...
    ///   <para>A locally managed resource that describes a link type predicate that might otherwise not be directly resolvable.</para>
    /// labels<para>LinkType</para></remarks>
    ...
    ///
    /// labels<para>OSLC Architecture Management (AM) Vocabulary</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>A generic architecture resource.  A resource of this type is likely to be a model or design artifact.</para>
    /// labels<para>ArchitectureResource</para></remarks>
