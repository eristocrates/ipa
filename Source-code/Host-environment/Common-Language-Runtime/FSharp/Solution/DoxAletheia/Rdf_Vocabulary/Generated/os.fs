...
module os =
    ...
    /// </para>
    /// labels<para>absolute form assuming current base</para></remarks>
    ...
    /// </para>
    /// labels<para>relative to current base</para></remarks>
    ...
    /// </para>
    /// labels<para>environment value</para></remarks>
    ...
    ///
    /// </para>
    /// labels<para>command line argument value</para></remarks>
