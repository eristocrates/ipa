...
module adms =
    ...
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.w3.org/ns/adms#">http://www.w3.org/ns/adms#</seealso>
    let _prefix_iri = Prefixed_Name(adms, "") |> PrefixedName
    /// <summary>
    ...
    ///   <para>"An abstract entity that reflects the intellectual content of the asset and represents those characteristics of the asset that are independent of its physical embodiment. This abstract entity combines the FRBR entities work (a distinct intellectual or artistic creation) and expression (the intellectual or artistic realization of a work)."</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"A particular physical embodiment of an Asset, which is an example of the FRBR entity manifestation (the physical embodiment of an expression of a work)."</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"This is based on the UN/CEFACT Identifier class which consists of:
    ///
    ...
    ///     an optional identifier for the agency that manages the identifier scheme."</para>
    ///   <para>"The ADMS class of Identifier fully represents the Business Core Vocabulary term of the same name"</para>
    ///   <para>"This class is based on the UN/CEFACT Identifier complex type defined in See Section 5.8 of Core Components Data Type Catalogue Version 3.1 (http://www.unece.org/fileadmin/DAM/cefact/codesfortrade/CCTS/CCTS-DTCatalogueVersion3p1.pdf) In RDF this is expressed using the following properties: - the content string should be provided using skos:notation, datatyped with the identifier scheme (inclduing the version number if appropriate); - use dcterms:creator to link to a class describing the agency that manages the identifier scheme or adms:schemaAgency to provide the name as a literal. Although not part of the ADMS conceptual model, it may be useful to provide further properties to the Identifier class such as dcterms:created to provide the date on which the identifier was issued."^^&lt;http://www.w3.org/1999/02/22-rdf-syntax-ns#XMLLiteral&gt;</para>
    /// labels<para>"Identifier"</para><para>"Identifier"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    /// </remarks>
    /// <seealso href="http://www.w3.org/ns/adms#SemanticAsset">http://www.w3.org/ns/adms#SemanticAsset</seealso>
    let SemanticAsset = Prefixed_Name(adms, "SemanticAsset") |> PrefixedName

    /// <summary>
    ///   <para>adms:SemanticDistribution</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.w3.org/ns/adms#SemanticDistribution">http://www.w3.org/ns/adms#SemanticDistribution</seealso>
    let SemanticDistribution =
        Prefixed_Name(adms, "SemanticDistribution") |> PrefixedName

    /// <summary>
    ///   <para>adms:accessURL</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.w3.org/ns/adms#accessURL">http://www.w3.org/ns/adms#accessURL</seealso>
    let accessURL = Prefixed_Name(adms, "accessURL") |> PrefixedName
    /// <summary>
    ///   <para>adms:identifier</para>
    /// </summary>
    /// <remarks>
    ...
    ///   <para>"Links a resource to an adms:Identifier class."</para>
    ...
    let identifier = Prefixed_Name(adms, "identifier") |> PrefixedName
    /// <summary>
    ///   <para>adms:identifies</para>
    /// </summary>
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"adms:identifies fully represents the Core Vocabulary property of the same name"</para>
    /// labels<para>"identifies"</para></remarks>
    /// <seealso href="http://www.w3.org/ns/adms#identifies">http://www.w3.org/ns/adms#identifies</seealso>
    let identifies = Prefixed_Name(adms, "identifies") |> PrefixedName
    /// <summary>
    ...
    /// <summary>
    ///   <para>adms:relatedDocumentation</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    /// </remarks>
    /// <seealso href="http://www.w3.org/ns/adms#relatedDocumentation">http://www.w3.org/ns/adms#relatedDocumentation</seealso>
    let relatedDocumentation =
        Prefixed_Name(adms, "relatedDocumentation") |> PrefixedName

    /// <summary>
    ///   <para>adms:relatedWebPage</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.w3.org/ns/adms#relatedWebPage">http://www.w3.org/ns/adms#relatedWebPage</seealso>
    let relatedWebPage = Prefixed_Name(adms, "relatedWebPage") |> PrefixedName
    ...
    ///   <para>"More information about the format in which an Asset Distribution is released. This is different from the file format as, for example, a ZIP file (file format) could contain an XML schema (representation technique)."</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Links to the status of the Asset or Asset Distribution in the context of a particular workflow process. Since Status is defined using a skos:Concept, that is the defined range for this property."^^&lt;http://www.w3.org/1999/02/22-rdf-syntax-ns#XMLLiteral&gt;</para>
    ///   <para>"The status of the Asset in the context of a particular workflow process."</para>
    /// labels<para>"status"</para><para>"status"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"version notes"</para><para>"version info"</para></remarks>
