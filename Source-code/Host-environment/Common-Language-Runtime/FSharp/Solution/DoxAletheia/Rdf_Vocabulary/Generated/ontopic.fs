...
module ontopic =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Specific Topic(s) for e.g. a conversation, an article, a document, etc. E.g. wikipedia article names can be considered Subject(s)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A collection of tags or metadata that have no formal semantics, and are typically used sparsely to annotate texts, images, bookmarks, etc."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Subject directory"</para><para>"Catalogo di argomenti"</para></remarks>
    ...
    /// Accordingly to these basic observations, in this ontology dul:Concept and Topic result to be disjoint, and an appropriate representation should be in place in order to model thesauri. E.g. skos:Concept should be mapped to the union of dul:Concept and Topic."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Topic"</para><para>"Argomento"</para></remarks>
    ...
    /// The subcollection of terms populating a Topic is called here TopicSignature"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"The collection of lmm1:Expression(s) that are in a Topic; for example, the topic signatures from sensecorpus, the entries from Roget's, etc."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// This class is mostly similar to the Topic class in Welty's formal ontology of subjects."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Topic space"</para><para>"Spazio di argomenti"</para></remarks>
    ...
    /// Distance is typically established with reference to a threshold on the number of dul:SocialObject(s) that are common to the two topics. Alternatively, it can be established with reference to the a geometrical semantics applied to the TopicSpace(s) that are regions for the Topic(s)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"far topic from"</para><para>"è un argomento lontano da"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"has core concept"</para><para>"ha concetto centrale {@it}"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// The counterpart of this relation for TopicSpace(s) is simply dul:hasPart"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"ha argomento più specifico {it}"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"has subtopic"</para></remarks>
    ...
    /// (3) A biography of Claude Chabrol (dul:InformationObject) ontopic:hasTopic 'Nouvelle Vague' (Topic)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"ha argomento"</para><para>"ha argomento {it}"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"has topic"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"A relation between topic assignments and topics."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"includes topic"</para><para>"include l'argomento"</para></remarks>
    ...
    /// For example, Saxophone (as a Concept) isCoreConceptFor Saxophones (as a Topic)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"is core concept for"</para><para>"è concetto centrale di {it}"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// It can be used widely to talk about document annotations, subject directories, etc.
    /// The counterpart of this relation for TopicSpace(s) is simply dul:isPartOf"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"è argomento più specifico di {it}"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"is sub topic of"</para></remarks>
    ...
    /// The range is here relaxed to any SocialObject, in order to allow alignment of deviant uses of topic or subject relations for 'concepts' (e.g. in thesauri), and other things that are mixed up with the notion of Topic."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"is topic of"</para><para>"è argomento di"</para></remarks>
    ...
    /// Vicinity is typically established with reference to a threshold on the number of dul:SocialObject(s) that are common to the two Topic(s), or based on a geometrical semantics applied to the TopicSpace(s) that are regions for the two Topic(s)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"near topic to"</para><para>"è un argomento vicino a"</para></remarks>
