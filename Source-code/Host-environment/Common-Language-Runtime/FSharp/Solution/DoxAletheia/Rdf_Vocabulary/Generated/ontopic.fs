...
module ontopic =
    ...
    let TopicSpace = Namespaced_IRI.parse _namespace_name "TopicSpace" |> NamespacedName
    ...
    let SubjectSpace =
        Namespaced_IRI.parse _namespace_name "SubjectSpace" |> NamespacedName
    ...
    let SubjectDirectory =
        Namespaced_IRI.parse _namespace_name "SubjectDirectory" |> NamespacedName
    ...
    let isSubTopicOf =
        Namespaced_IRI.parse _namespace_name "isSubTopicOf" |> NamespacedName
    ...
    let hasSubTopic =
        Namespaced_IRI.parse _namespace_name "hasSubTopic" |> NamespacedName
    ...
    let TopicAssignment =
        Namespaced_IRI.parse _namespace_name "TopicAssignment" |> NamespacedName
    ...
    let includesTopic =
        Namespaced_IRI.parse _namespace_name "includesTopic" |> NamespacedName
    ...
    let TopicSignature =
        Namespaced_IRI.parse _namespace_name "TopicSignature" |> NamespacedName
    ...
    let farTopicFrom =
        Namespaced_IRI.parse _namespace_name "farTopicFrom" |> NamespacedName

    /// <summary>
    ///   <see href="http://www.ontologydesignpatterns.org/ont/dul/ontopic.owl#hasCoreConcept"></see>
    /// </summary>
    let hasCoreConcept =
        Namespaced_IRI.parse _namespace_name "hasCoreConcept" |> NamespacedName
    ...
    let isCoreConceptFor =
        Namespaced_IRI.parse _namespace_name "isCoreConceptFor" |> NamespacedName
    ...
    /// </summary>
    let hasTopicSignature =
        Namespaced_IRI.parse _namespace_name "hasTopicSignature" |> NamespacedName

    /// <summary>
    ///   <see href="http://www.ontologydesignpatterns.org/ont/dul/ontopic.owl#isTopicSignatureOf"></see>
    /// </summary>
    let isTopicSignatureOf =
        Namespaced_IRI.parse _namespace_name "isTopicSignatureOf" |> NamespacedName

    /// <summary>
    ///   <see href="http://www.ontologydesignpatterns.org/ont/dul/ontopic.owl#isTopicIncludedIn"></see>
    /// </summary>
    let isTopicIncludedIn =
        Namespaced_IRI.parse _namespace_name "isTopicIncludedIn" |> NamespacedName
    ...
    let nearTopicTo =
        Namespaced_IRI.parse _namespace_name "nearTopicTo" |> NamespacedName

    /// <summary>
    ///   <see href="http://www.ontologydesignpatterns.org/ont/dul/ontopic.owl#overlappingTopic"></see>
    /// </summary>
    let overlappingTopic =
        Namespaced_IRI.parse _namespace_name "overlappingTopic" |> NamespacedName
