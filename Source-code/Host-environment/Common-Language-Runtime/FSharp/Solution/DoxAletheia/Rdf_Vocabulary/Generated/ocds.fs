...
module ocds =
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>"The date of the contract award. This is usually the date on which a decision to award was made."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Award description"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>"The current status of the award drawn from the [awardStatus codelist](http://standard.open-contracting.org/latest/en/schema/codelists/#award-status)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Award status"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://purl.org/onto-ocds/ocds#awardStatus">http://purl.org/onto-ocds/ocds#awardStatus</seealso>
    let awardStatus = Prefixed_Name(ocds, "awardStatus") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Used to point either to a corresponding Budget Data Package, or to a machine or human-readable source where users can find further information on the budget line item identifiers, or project identifiers, provided here."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Contract title"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"Release ID"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Tender description"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
