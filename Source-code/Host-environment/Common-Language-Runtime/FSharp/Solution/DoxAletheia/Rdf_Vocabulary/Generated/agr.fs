...
module agr =
    ...
    ///
    /// labels<para>SHOULD NOT</para></remarks>
    ...
    ///   <para>agr:RequirementLevel</para>
    ///
    /// labels<para>SHALL</para></remarks>
    ...
    ///   <para>agr:RequirementLevel</para>
    ///
    /// labels<para>SHOULD</para></remarks>
    ...
    ///   <para>agr:RequirementLevel</para>
    ///
    /// labels<para>RECOMMENDED</para></remarks>
    ...
    ///   <para>agr:RequirementLevel</para>
    ///
    /// labels<para>MUST NOT</para></remarks>
    ...
    ///   <para>agr:RequirementLevel</para>
    ///
    /// labels<para>SHALL NOT</para></remarks>
