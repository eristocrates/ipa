...
module tm =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Clock time</para></remarks>
    ...
    ///
    /// labels<para>temporal position value</para></remarks>
    ...
    ///
    /// labels<para>temporal geometry</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>domain of validity</para></remarks>
    ...
    ///
    /// labels<para>parent reference system</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal Coordinate</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>component era</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal Geometric Primitive</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The value of this property indicates the temporal reference system for a time position</para>
    /// labels<para>temporal reference system or frame</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>begun by</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>member era</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The value of this property is a time encoded as an xsd:dateTime</para>
    /// labels<para>date or dateTime position</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal Edge</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>previous edge</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>next edge</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>ordinal time position</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal ordinal position</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Date and time</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal Topological Primitive</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal Node</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>primitive member</para></remarks>
    /// <seealso href="http://def.seegrid.csiro.au/isotc211/iso19108/2002/temporal#primitive">http://def.seegrid.csiro.au/isotc211/iso19108/2002/temporal#primitive</seealso>
    let primitive = Prefixed_Name(tm, "primitive") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal Coordinate System</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>temporal topology</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal Period</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>parent era</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The value of this property defines the beginning of a time period</para>
    /// labels<para>beginning instant or node</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal Complex</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal ordinal era</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal topologic complex</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal geometric complex</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal Ordinal Reference System</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The value of this property defines the end of a time period</para>
    /// labels<para>ending instant or node</para></remarks>
