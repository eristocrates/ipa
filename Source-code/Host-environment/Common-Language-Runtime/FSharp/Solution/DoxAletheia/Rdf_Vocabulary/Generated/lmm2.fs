...
module lmm2 =
    ...
    /// </summary>
    let isSyntacticFunctionOf = _prefix "isSyntacticFunctionOf"
    /// <summary>
    ///   <see href="http://www.ontologydesignpatterns.org/ont/lmm/LMM_L2.owl#hasSyntacticFunction"></see>
    /// </summary>
    let hasSyntacticFunction = _prefix "hasSyntacticFunction"
    /// <summary>
    ...
    let AnalyticFeature = _prefix "AnalyticFeature"
    /// <summary>
    ...
    let ExperimentalSetting = _prefix "ExperimentalSetting"
    /// <summary>
    ...
    let AssociativeContext = _prefix "AssociativeContext"
    /// <summary>
    ///   <see href="http://www.ontologydesignpatterns.org/ont/lmm/LMM_L2.owl#AssociativeRule"></see>
    /// </summary>
    let AssociativeRule = _prefix "AssociativeRule"
    /// <summary>
    ...
    let ConceptExpression = _prefix "ConceptExpression"
    /// <summary>
    ...
    let MultipleReference = _prefix "MultipleReference"
    /// <summary>
    ...
    let ContextualExpression = _prefix "ContextualExpression"
    /// <summary>
    ...
    let ConceptReference = _prefix "ConceptReference"
    /// <summary>
    ...
    let ContextualReference = _prefix "ContextualReference"
    /// <summary>
    ...
    let ExtensionalReference = _prefix "ExtensionalReference"
    /// <summary>
    ...
    let IndividualReference = _prefix "IndividualReference"
    /// <summary>
    ...
    let EnumeratedExpression = _prefix "EnumeratedExpression"
    /// <summary>
    ...
    let lexicalizesOE = _prefix "lexicalizesOE"
    /// <summary>
    ...
    let PolyrhematicConceptExpression = _prefix "PolyrhematicConceptExpression"
    /// <summary>
    ...
    let SimpleConceptExpression = _prefix "SimpleConceptExpression"
    /// <summary>
    ...
    let SyntacticContext = _prefix "SyntacticContext"
    /// <summary>
    ///   <see href="http://www.ontologydesignpatterns.org/ont/lmm/LMM_L2.owl#SyntacticRule"></see>
    /// </summary>
    let SyntacticRule = _prefix "SyntacticRule"
    /// <summary>
    ...
    let hasCoInterpretant = _prefix "hasCoInterpretant"
    /// <summary>
    ///   <see href="http://www.ontologydesignpatterns.org/ont/lmm/LMM_L2.owl#hasInstance"></see>
    /// </summary>
    let hasInstance = _prefix "hasInstance"
