...
module biotop =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>one dimensional physical entity</para></remarks>
    ...
    ///
    /// See disease role etc.</para>
    /// labels<para>pathological static processual entity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>two dimensional physical entity</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>fruit fly population</para></remarks>
    ...
    ///
    /// labels<para>has realization</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>fungus population</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>gene information</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>gene region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>genome information</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>genus saccharomyces value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>genus drosophila value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>subfamily drosophilinae value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>genus homo value region</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>previous name "geographic entity"</para>
    /// labels<para>geographic surface</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>one great ape</para>
    /// labels<para>great ape</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>growing process</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>signalling role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>animal including human</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>organism interaction</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>non steroid lipid</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>pathological value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>congenital pathological condition</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>categorization system</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>syncytium</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>cell in vivo</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>central nervous system</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>chlamydia cell</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>not (properPartOf some MonoMolecularEntity)  REMOVED</para>
    /// labels<para>entire nucleic acid molecule</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>class gamma proteobacteria value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>class mammalia value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>subphylum vertebrata value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>class saccharomycetes value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>subphylum saccharomycotina value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>treating organism</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>physically surrounded by</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>physically surrounds</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>physically traverses</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>immunologic role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>biomolecule</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>body liquid</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>water molecule</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>portion of heterogenous liquid</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>species candida albicans value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>canonical processual entity</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>abstract region in which the value "canonical" of canonicity is located</para>
    /// labels<para>canonical value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>noncanonical static processual entity</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>abstract region in which the value "noncanonical" of canonicity is located</para>
    /// labels<para>noncanonical value region</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>quality location of</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>carbohydrate monomer</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>carbohydrate sequence information</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>intellectual product</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>regulation or law</para></remarks>
    ...
    ///
    /// ontologically irrelevant disjoint partition: structured biological compound by granularity</para>
    /// labels<para>*</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>modified cell</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>treating</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>treating condition</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>two dimensional biological entity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>using action</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>vertebrate population</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>virus population</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>yeast population</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>abstract part of</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>abstractly related to</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has abstract part</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>contiguous with</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>locus of</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>causally related to</para></remarks>
    ...
    ///   <para>owl:SymmetricProperty</para>
    ///
    /// labels<para>cooccurring with</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>temporally related to</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>denoted by</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>derived into</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has origin</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>feature of</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>granular part of</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>vitamin role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>protist</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>group interaction</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>kingdom animalia value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>kingdom bacteria value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>kingdom chromista value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>kingdom protozoa value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>body system</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>cell membrane</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>sum of genetic material in a cell</para>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>preventive role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>subject of care role</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Ontologically irrelevant partitioning node. Used for improving ontology housekeeping. Its purpose is to express that all subclasses are mutually disjoint.</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>amino acid sequence</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>amount of body substance</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>compound of collective material entities</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>The fuzzyness of this class is due to the "same sort" criterion.</para>
    /// labels<para>collective material entity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>plurality of organisms</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>animal cell</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>bacterial cell</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>ramification of</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>ramifies</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"embryonic" as the value of a developmental stage. E.g. a 3 days old mouse embryo has a quality which has its value located in "embryonic value region".</para>
    /// labels<para>embryonic value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>hormone role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>tissue process</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>outcome of</para></remarks>
    ...
    ///   <para>owl:SymmetricProperty</para>
    ///
    /// labels<para>physically connected to</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>physical part of</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>physically located in</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>physically bounded by</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>physically contains</para></remarks>
    ...
    ///   <para>owl:SymmetricProperty</para>
    ///
    /// labels<para>physically disconnected from</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>physically interconnects</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>substance interaction</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>kingdom viruses value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>organ part</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>cytoplasm</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>process role of</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"solid" as the value of a states of matter. E.g. a stone has a quality which has its value located in "solid value region"</para>
    /// labels<para>solid value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>human language</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>eicosanoid</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>one primate</para>
    /// labels<para>primate</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>organism action</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>human epithelial cell</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>human reasoning</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>negatively affecting a biological system by using physical force</para>
    /// labels<para>hurting</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>immaterial nonphysical entity</para></remarks>
    ...
    ///   <para>owl:TransitiveProperty</para>
    ///
    /// labels<para>has physical part</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>immaterial processual entity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>indicating</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>individual behavior</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>social behavior</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>kingdom archaea value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>kingdom plantae value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>cell nucleus</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>inorganic molecular entity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>plant population</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>plurality of identical polymolecular entities</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>negatively affecting the integrity of a biologival system caused by one or more chemical substances</para>
    /// labels<para>poisoning</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>kingdom fungi value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>acquired abnormal structure</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>acquired pathological static processual entity</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has process quality</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>proper physical part of</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>organ system</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>rickettsia cell</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>phylum proteobacteria value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>class insecta value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>insect population</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>instantaneous process</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>patient in</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>intra cellular process</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>machine action</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>macroscopic value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>microscopic value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>managing care</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>measurement method</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>measuring action</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>mental function</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>microorganism</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Difficult concept. Better to be expressed by the primitive "mental function" </para>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>affecting</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has proper physical part</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>In chemistry, an amino acid is any molecule that contains both amine and carboxyl functional groups. However, in biochemistry, this more general term is frequently used to refer to alpha amino acids (amino acids in which the amino and carboxylate functionalities are attached to the same carbon, called ?–carbon). Amino Acids have at least one amino and one carboxy group. Those having two carboxy groups have only one amino group and vice versa.</para>
    ///   <para>(QCR) ro:hasPart some CarbonHydrogenSubstructure and ((hasComponent myx 2 CarboxyGroup) and (hasComponent min 1 CarboxyGroup) and (hasComponent exactly 1 AminoGroup)) or ((hasComponent max 2 AminoGroup) and (hasComponent min 1 AminoGroup) and (hasComponent exactly 1 CarboxyGroup))</para>
    /// labels<para>amino acid molecule or residue</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A submolecular group or moiety is a group of covalently bound atoms that occurs only as part of a molecule</para>
    /// labels<para>submolecular group</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Comment: We here use the term peptide in the most general sense, viz. a oligo or polymer made out of amino acids.</para>
    /// labels<para>peptide structure</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>amino acid sequence information</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has granular part</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>one vertebrate</para>
    /// labels<para>vertebrate</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>analyzing</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>human action</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>all child classes of population are only meant as examples demonstrating how population classes can be postcoordinated</para>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>drug role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>archaebacterial cell</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>invertebrate</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>arthropod population</para></remarks>
    ...
    ///
    /// Ontologically irrelevant partitioning node. Used for improving ontology housekeeping. Its purpose is to express that all subclasses are mutually disjoint.</para>
    /// labels<para>*</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>bacterial colony</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>biological colony</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>species saccharomyces cerevisiae value region</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Unicellular Fungi.</para>
    /// labels<para>yeast cell</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>One candida albicans cell</para>
    /// labels<para>candida albicans cell</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>bakers yeast population</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>bio molecular process</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>biological processual entity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>bio molecular sequence information</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>bio molecular sequence structure</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>chain of nucleotide monomers</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>DNA chain</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>RNA chain</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>biological action</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>biological boundary</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>physical boundary</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>biological space</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>physically bounds</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>biological function</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>organism process</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>physical processual entity</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has locus</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>health professional role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>therapeutic role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>proton</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>phylum arthropoda value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>molecular residue</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>portion of homogenous matter</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>prevention action</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>educator role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>finding role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>neutron</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>plant cell</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>animal excluding human</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>food role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>electron</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>immaterial object</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>fatty acid molecule or residue</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>producing</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>alpha particle</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Place for currently non maintained classes. It should be assured that they are not being referred to by application ontologies that import BioTop</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>amount of pure substance</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>material object</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>amino acid or peptide molecule or structure</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>bacteria population</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>primate population</para></remarks>
    ...
    ///   <para>owl:SymmetricProperty</para>
    ///
    /// labels<para>physically adjacent to</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>continuous with</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>animal population</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>antibiotic role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>portion of heterogenous solid</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>carbohydrate molecule or residue</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>lipid molecule or residue</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>order diptera value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>mammal population</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>heterocyclic base molecule or residue</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>canonicity value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>developmental value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>parent role</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>process in an organism as a realization of a mental function</para>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>protein domain</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>protein subunit</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>regulatory body</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>social action</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>nucleic acid nucleotide or nucleoside molecule or residue</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>biological size value region</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>one saccharomyces cerevisiae cell</para>
    /// labels<para>bakers yeast cell</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>family enterobacteriaceaea value region</para></remarks>
    ...
    ///   <para>owl:SymmetricProperty</para>
    ///
    /// labels<para>spatially related to</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has original part</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>original part of</para></remarks>
    ...
    ///   <para>owl:TransitiveProperty</para>
    ///
    /// labels<para>has originating physical part</para></remarks>
    ...
    ///   <para>owl:TransitiveProperty</para>
    ///
    /// labels<para>originating physical part of</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>processually related to</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has process role</para></remarks>
    ...
    ///   <para>owl:TransitiveProperty</para>
    ///
    /// labels<para>processual part of</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>state of matter value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>sibling role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>biological system role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>biological life</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>genetic information</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>taxon value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>artefact role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>family role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>health related role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>protein substructure</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>protist population</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>child role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>organic molecular entity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>chain of carbohydrate monomers</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>component part of</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>chemical role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>nucleic acid structure</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>nucleotide molecule</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>mono molecular entity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>molecule complex</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>age quality</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>physical force</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>former name: StateOfAggregation</para>
    /// labels<para>physical state</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>physical volume</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>neuroreactive role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>receptor role</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"gaseous" as the value of a states of matter.  E.g. a portion of air has a quality which has its value located in "gaseous value region"</para>
    /// labels<para>gaseous value region</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"liquid" as the value of a states of matter. E.g. a portion of water has a quality which has its value located in "liquid value region"</para>
    /// labels<para>liquid value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>animal language</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>machine language</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>steroid</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>indicator role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>pathological structure</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>congenital abnormal structure</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>acquired pathological condition</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>quality located</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>action on biological system</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>adult organism</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>embryonic organism</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>juvenile organism</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>complicating</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>congenital pathological static processual entity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>dead body</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>living body</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>point in time</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has point in time</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>disrupting</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>embryonic structure</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>entire carbohydrate monomer</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>entire molecular entity</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>(QCR) Peptide and hasComponent min 101 AminoAcidMonomer and not (ro:properPartOf some MolecularEntity)</para>
    /// labels<para>entire protein molecule</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>The role a peptide plays in accelerating a biochemical reaction</para>
    /// labels<para>enzyme role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>epithelial cell</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>escherichia coli cell</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>species escherichia coli value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>escherichia coli population</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>eukaryote population</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>examination result role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>sign or symptom role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>family drosophilidae value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>order enterobacteriales value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>family hominidae value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>order primates value region</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>unclear classe. to be revised</para>
    /// labels<para>family of individual organisms</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>family saccharomycetaceae value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>order saccharomycetales value region</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>one drosophila melanogaster</para>
    /// labels<para>fruit fly</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>species drosophila melanogaster value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>oligo or polymer</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>molecular function</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>neoplastic process</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>nucleotide sequence information</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>physician role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>one dimensional boundary</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>two dimensional boundary</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>organ system part</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>pathological condition</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>pathological disposition</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>pathological process</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>spatial reference role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>poly molecular composite entity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>subatomic particle</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>structured biological entity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>biological size</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>developmental quality</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>physical mass</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>state of matter</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>taxon quality</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"adult" as the value of a developmental stage. E.g. a 4 year old dog has a quality which has its value located in "adult value region".</para>
    /// labels<para>adult value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>juvenile value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>organism part</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>candida albicans population</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>noncanonical processual entity</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>a biological state that is considered "normal"</para>
    /// labels<para>canonical static processual entity</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Static condition as a special case of process in which temporal parts are neglected.  </para>
    /// labels<para>static processual entity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>species homo sapiens value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>well formed biological structure</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>process quality of</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>peptide function</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>phosphate</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>phylum chordata value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>phylum ascomycota value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>nucleoside molecule</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>prokaryote</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>physically contained in</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>biomedical material role</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>genus candida value region</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF TAXON REGION</para>
    /// labels<para>genus escherichia value region</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has processual part</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>structured nonbiological compound</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>canonicity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>physical length</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>originates from</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>EXAMPLE OF POPULATION</para>
    /// labels<para>great ape population</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>immaterial three dimensional physical entity</para></remarks>
