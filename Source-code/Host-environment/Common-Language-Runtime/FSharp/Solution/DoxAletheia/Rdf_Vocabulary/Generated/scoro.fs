...
module scoro =
    ...
    let AuthorshipRole = _prefix "AuthorshipRole"
    /// <summary>
    ...
    let FinancialRole = _prefix "FinancialRole"
    /// <summary>
    ...
    let InvestigationRole = _prefix "InvestigationRole"
    /// <summary>
    ...
    let OrganizationalRole = _prefix "OrganizationalRole"
    /// <summary>
    ...
    let ProjectRole = _prefix "ProjectRole"
    /// <summary>
    ...
    let ``article-guarantor`` = _prefix "article-guarantor"
    /// <summary>
    ...
    let AuthorshipContribution = _prefix "AuthorshipContribution"
    /// <summary>
    ...
    let ExperimentalContribution = _prefix "ExperimentalContribution"
    /// <summary>
    ...
    let IntellectualContribution = _prefix "IntellectualContribution"
    /// <summary>
    ...
    let OrganizationalContribution = _prefix "OrganizationalContribution"
    /// <summary>
    ///   <see href="http://purl.org/spar/scoro/scoro.png"></see>
    /// </summary>
    let ``scoro.png`` = _prefix "scoro.png"
    /// <summary>
    ///   <see href="http://purl.org/spar/scoro/2017-09-04"></see>
    /// </summary>
    let ``_2017-09-04`` = _prefix "2017-09-04"
    /// <summary>
    ...
    let ContributionSituation = _prefix "ContributionSituation"
    /// <summary>
    ...
    let withContribution = _prefix "withContribution"
    /// <summary>
    ...
    let ``access-provider`` = _prefix "access-provider"
    /// <summary>
    ...
    let ``analyses-data`` = _prefix "analyses-data"
    /// <summary>
    ...
    let ``approves-final-manuscript`` = _prefix "approves-final-manuscript"
    /// <summary>
    ...
    let ``builds-and-or-maintains-instruments`` =
        _prefix "builds-and-or-maintains-instruments"
    ...
    let ``chief-executive-officer`` = _prefix "chief-executive-officer"
    /// <summary>
    ...
    let ``chief-scientist`` = _prefix "chief-scientist"
    /// <summary>
    ...
    let ``chief-technology-officer`` = _prefix "chief-technology-officer"
    /// <summary>
    ...
    let ``co-applicant`` = _prefix "co-applicant"
    /// <summary>
    ...
    let ``co-investigator`` = _prefix "co-investigator"
    /// <summary>
    ...
    let collaborator = _prefix "collaborator"
    /// <summary>
    ...
    let ``college-head`` = _prefix "college-head"
    /// <summary>
    ...
    let ``computer-programmer`` = _prefix "computer-programmer"
    /// <summary>
    ...
    let ``conceives-project`` = _prefix "conceives-project"
    /// <summary>
    ...
    let ``consortium-author`` = _prefix "consortium-author"
    /// <summary>
    ...
    let ``contact-person`` = _prefix "contact-person"
    /// <summary>
    ...
    let ``controls-project-finances`` = _prefix "controls-project-finances"
    /// <summary>
    ...
    let ``corresponding-author`` = _prefix "corresponding-author"
    ...
    let ``creates-novel-organisms-or-cells`` =
        _prefix "creates-novel-organisms-or-cells"
    ...
    let ``creates-novel-reagents`` = _prefix "creates-novel-reagents"
    /// <summary>
    ...
    let ``creates-software`` = _prefix "creates-software"
    /// <summary>
    ...
    let ``data-creator`` = _prefix "data-creator"
    /// <summary>
    ...
    let ``data-curator`` = _prefix "data-curator"
    /// <summary>
    ...
    let ``develops-methodology`` = _prefix "develops-methodology"
    /// <summary>
    ...
    let ``doctoral-student`` = _prefix "doctoral-student"
    /// <summary>
    ...
    let ``embargo-controller`` = _prefix "embargo-controller"
    /// <summary>
    ...
    let ``ensures-regulatory-compliance`` = _prefix "ensures-regulatory-compliance"
    /// <summary>
    ...
    let ``faculty-member`` = _prefix "faculty-member"
    /// <summary>
    ...
    let ``financial-controller`` = _prefix "financial-controller"
    /// <summary>
    ...
    let ``formulates-research-questions`` = _prefix "formulates-research-questions"
    /// <summary>
    ...
    let ``funding-recipient`` = _prefix "funding-recipient"
    /// <summary>
    ...
    let hasContributionContext = _prefix "hasContributionContext"
    /// <summary>
    ...
    let isRelatedToContributionSituation = _prefix "isRelatedToContributionSituation"
    /// <summary>
    ...
    let hasPersonalIdentifier = _prefix "hasPersonalIdentifier"
    /// <summary>
    ...
    let ``head-of-department`` = _prefix "head-of-department"
    /// <summary>
    ...
    let ``host-institution`` = _prefix "host-institution"
    /// <summary>
    ...
    let ``interprets-results`` = _prefix "interprets-results"
    /// <summary>
    ...
    let isContributionIn = _prefix "isContributionIn"
    /// <summary>
    ...
    let isEqualToContributionSituation = _prefix "isEqualToContributionSituation"
    /// <summary>
    ...
    let isEqualToRoleInTime = _prefix "isEqualToRoleInTime"
    /// <summary>
    ...
    let makesContribution = _prefix "makesContribution"
    /// <summary>
    ...
    let ``lead-applicant`` = _prefix "lead-applicant"
    /// <summary>
    ...
    let ``leads-investigation`` = _prefix "leads-investigation"
    /// <summary>
    ...
    let ``maintains-IT-Infrastructure`` = _prefix "maintains-IT-Infrastructure"
    /// <summary>
    ...
    let ``maintains-organisms-or-cells`` = _prefix "maintains-organisms-or-cells"
    /// <summary>
    ...
    let ``maintains-research-facility`` = _prefix "maintains-research-facility"
    /// <summary>
    ...
    let ``major-effort`` = _prefix "major-effort"
    /// <summary>
    ...
    let ``manages-project`` = _prefix "manages-project"
    /// <summary>
    ...
    let ``master-student`` = _prefix "master-student"
    /// <summary>
    ...
    let ``minor-effort`` = _prefix "minor-effort"
    /// <summary>
    ...
    let ``non-academic-staff-member`` = _prefix "non-academic-staff-member"
    ...
    let ``obtains-and-or-prepares-specimens`` =
        _prefix "obtains-and-or-prepares-specimens"
    ...
    let ``patent-holder`` = _prefix "patent-holder"
    /// <summary>
    ...
    let possessor = _prefix "possessor"
    /// <summary>
    ...
    let ``postdoctoral-researcher`` = _prefix "postdoctoral-researcher"
    /// <summary>
    ...
    let ``postgraduate-student`` = _prefix "postgraduate-student"
    /// <summary>
    ...
    let ``prepares-illustrations`` = _prefix "prepares-illustrations"
    ...
    let ``prepares-supplementary-information`` =
        _prefix "prepares-supplementary-information"
    ...
    let ``principal-author`` = _prefix "principal-author"
    /// <summary>
    ...
    let ``principal-investigator`` = _prefix "principal-investigator"
    /// <summary>
    ...
    let ``processes-data`` = _prefix "processes-data"
    /// <summary>
    ...
    let ``programme-manager`` = _prefix "programme-manager"
    /// <summary>
    ...
    let ``project-leader`` = _prefix "project-leader"
    /// <summary>
    ...
    let ``project-manager`` = _prefix "project-manager"
    /// <summary>
    ...
    let ``project-member`` = _prefix "project-member"
    /// <summary>
    ...
    let ``project-student`` = _prefix "project-student"
    /// <summary>
    ...
    let ``provides-administrative-support`` = _prefix "provides-administrative-support"
    /// <summary>
    ...
    let ``provides-advice`` = _prefix "provides-advice"
    /// <summary>
    ...
    let ``provides-exising-data`` = _prefix "provides-exising-data"
    /// <summary>
    ...
    let ``provides-patients`` = _prefix "provides-patients"
    ...
    let ``provides-reagents-specimens-or-materials`` =
        _prefix "provides-reagents-specimens-or-materials"
    ...
    let ``provides-service`` = _prefix "provides-service"
    /// <summary>
    ...
    let ``provides-software`` = _prefix "provides-software"
    /// <summary>
    ...
    let ``provides-technical-support`` = _prefix "provides-technical-support"
    ...
    let ``provides-tools-equipment-or-facilities`` =
        _prefix "provides-tools-equipment-or-facilities"
    ...
    let ``publishes-data`` = _prefix "publishes-data"
    /// <summary>
    ...
    let purchaser = _prefix "purchaser"
    /// <summary>
    ...
    let registrar = _prefix "registrar"
    /// <summary>
    ...
    let ``registration-agency`` = _prefix "registration-agency"
    /// <summary>
    ...
    let ``registration-authority`` = _prefix "registration-authority"
    /// <summary>
    ...
    let ``repository-manager`` = _prefix "repository-manager"
    /// <summary>
    ...
    let ``research-assistant`` = _prefix "research-assistant"
    /// <summary>
    ...
    let ``research-student`` = _prefix "research-student"
    /// <summary>
    ...
    let ``revises-manuscript`` = _prefix "revises-manuscript"
    /// <summary>
    ...
    let ``rights-holder`` = _prefix "rights-holder"
    /// <summary>
    ...
    let ``secures-funding`` = _prefix "secures-funding"
    /// <summary>
    ...
    let ``senior-author`` = _prefix "senior-author"
    /// <summary>
    ...
    let ``service-engineer`` = _prefix "service-engineer"
    /// <summary>
    ...
    let ``solo-effort`` = _prefix "solo-effort"
    /// <summary>
    ...
    let ``sub-contractor`` = _prefix "sub-contractor"
    /// <summary>
    ...
    let ``supervises-colleagues`` = _prefix "supervises-colleagues"
    /// <summary>
    ...
    let ``undergraduate-student`` = _prefix "undergraduate-student"
    /// <summary>
    ...
    let ``undertakes-modelling`` = _prefix "undertakes-modelling"
    /// <summary>
    ...
    let ``vice-chancellor`` = _prefix "vice-chancellor"
    /// <summary>
    ...
    let ``web-master`` = _prefix "web-master"
    /// <summary>
    ...
    let withEffort = _prefix "withEffort"
    /// <summary>
    ...
    let withJobTitle = _prefix "withJobTitle"
    /// <summary>
    ...
    let ``workpackage-leader`` = _prefix "workpackage-leader"
    /// <summary>
    ...
    let ``writes-manuscript-draft`` = _prefix "writes-manuscript-draft"
