...
module lom =
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Keywords and phrases descriptive of the learning object relative to the stated 9.1:Classification.Purpose of this specific classification, such as accessibility, security level, etc., most relevant first. IEEE LOM element 9.4</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The degree of interactivity characterizing this learning object. Interactivity in this context refers to the degree to which the learner can influence the aspect or behavior of the learning object. IEEE LOM element 5.3.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A globally unique label that identifies this metadata record. IEEE LOM element 3.1.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Age of the typical intended user. IEEE LOM element 5.7.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The completion status or condition of this learning object. IEEE LOM element 2.2</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Kind of contribution. IEEE LOM element 3.2.1.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The identification of and information about entities (i.e., people, organizations) contributing to this learning object. The entities shall be ordered as most relevant first. IEEE LOM element 3.2.2.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Email as it appears in the vCard</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The degree of conciseness of a learning object. The semantic density of a learning object may be estimated in terms of its size, span, or --in the case of self-timed resources such as audio or video-- duration. IEEE LOM element 5.4.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Comments on how this learning object is to be used. IEEE LOM element 5.10</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>This category describes the key educational or pedagogic characteristics of this learning object. IEEE LOM element 5.</para>
    /// </remarks>
    /// <seealso href="http://data.opendiscoveryspace.eu/lom_ontology_ods.owl#educational">http://data.opendiscoveryspace.eu/lom_ontology_ods.owl#educational</seealso>
    let educational = Prefixed_Name(lom, "educational") |> PrefixedName
