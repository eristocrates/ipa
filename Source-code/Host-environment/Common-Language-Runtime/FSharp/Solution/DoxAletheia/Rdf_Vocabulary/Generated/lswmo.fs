...
module lswmo =
    ...
    /// <summary>
    ///   <para>lswmo:ServiceActivity</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    /// </remarks>
    /// <seealso href="http://ontology.cybershare.utep.edu/ELSEWeb/elseweb-modelling.owl#ServiceActivity">http://ontology.cybershare.utep.edu/ELSEWeb/elseweb-modelling.owl#ServiceActivity</seealso>
    let ServiceActivity = Prefixed_Name(lswmo, "ServiceActivity") |> PrefixedName
    /// <summary>
    ///   <para>lswmo:ServiceAgent</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    /// </remarks>
    /// <seealso href="http://ontology.cybershare.utep.edu/ELSEWeb/elseweb-modelling.owl#ServiceAgent">http://ontology.cybershare.utep.edu/ELSEWeb/elseweb-modelling.owl#ServiceAgent</seealso>
    let ServiceAgent = Prefixed_Name(lswmo, "ServiceAgent") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Following SIO's definition of algorithm, a species modelling algorithm is an effective method expressed as a finite list of well-defined instructions for calculating a model about species."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"species modelling algorithm"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Following SIO's definition of parameter, a species modelling parameter  is variable whose value changes the characteristics of a species model."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"species modelling parameter"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A set of modelling parameter(s) required by a specific species modeling algorithm."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"species modelling parameters"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Following SIO's definition of software application, a species modelling software is a software that can be directly executed by some processing unit and offers species modelling services."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"species modelling software"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// labels<para>"behaviour controlled by"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// labels<para>"bound to value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"controls behavior of"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"has algorithm name"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"has parameter member"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"implemented in"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
