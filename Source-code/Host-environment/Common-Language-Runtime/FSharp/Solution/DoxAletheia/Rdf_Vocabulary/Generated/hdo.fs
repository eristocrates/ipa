...
module hdo =
    ...
    /// labels<para>North Aegean Regional Administration (NARA)</para><para>ΠΕΡΙΦΕΡΕΙΑ ΒΟΡΕΙΟΥ ΑΙΓΑΙΟΥ</para></remarks>
    ...
    /// labels<para>Τμήμα Πληροφορικής Περιφερειακής Ενότητας Σάμου</para><para>Samos IT department at NARA</para></remarks>
