...
module oh =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A calendar which can be used for opening hours"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"A calendar"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A class to identify opening hours"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Opening Hours"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A class to identify the type of opening hours"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Opening Hours Type"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Tell whether or not this oh:Calendar specifies closing hours."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Are Closing Hours"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Link a certain thing to a description of opening hours"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Has Opening Hours"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"has Opening Hours Type"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
