...
module semio =
    ...
    let DataSign = Namespaced_IRI.parse _namespace_name "DataSign" |> NamespacedName
    /// <summary>
    ...
    let signifierData =
        Namespaced_IRI.parse _namespace_name "signifierData" |> NamespacedName
    ...
    let ObjectSign = Namespaced_IRI.parse _namespace_name "ObjectSign" |> NamespacedName
    /// <summary>
    ...
    let signifierObject =
        Namespaced_IRI.parse _namespace_name "signifierObject" |> NamespacedName
    ...
    let UF = Namespaced_IRI.parse _namespace_name "UF" |> NamespacedName
    /// <summary>
    ...
    let coreferentWith =
        Namespaced_IRI.parse _namespace_name "coreferentWith" |> NamespacedName
    ...
    let significationContext =
        Namespaced_IRI.parse _namespace_name "significationContext" |> NamespacedName

    /// <summary>
    /// The resource for which the sign stands for
    /// <see href="http://www.lingvoj.org/semio#signified"></see></summary>
    let signified = Namespaced_IRI.parse _namespace_name "signified" |> NamespacedName
