...
module p_plan =
    ...
    ///   <para>"PROV extension for linking Plans and parts of plans to their respective executions. Created by Daniel Garijo and Yolanda Gil"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Multi Step"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"MultiStep"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Plan"</para><para>"Plan"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Step"</para><para>"Step"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Variable"</para><para>"Variable"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"correspondsToVariable"</para><para>"corresponds to variable"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"has input var"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"hasInputVar"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"hasOutputVar"</para><para>"has output var"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <seealso href="http://purl.org/net/p-plan#isPrecededBy">http://purl.org/net/p-plan#isPrecededBy</seealso>
    let isPrecededBy = Prefixed_Name(p_plan, "isPrecededBy") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"isStepOfPlan"</para><para>"is step of plan"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
