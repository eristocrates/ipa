...
module w3dt =
    ...
    /// <summary>
    ///   <para>w3dt:hasSetOfProperties</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has set of properties</para></remarks>
    ...
    /// <summary>
    ///   <para>w3dt:PredefinedValuesList</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// <summary>
    ///   <para>w3dt:ReferenceDocument</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///   <para>w3dt:hasPredefinedValueItem</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///
    ...
    /// <summary>
    ///   <para>w3dt:ConstructionObject</para>
    /// </summary>
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ...
    /// <summary>
    ///   <para>w3dt:LibraryComponent</para>
    /// </summary>
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ...
    /// <summary>
    ///   <para>w3dt:isDataTemplateFor</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>is data template for</para></remarks>
    ...
    /// <summary>
    ///   <para>w3dt:hasExternalDictionaryProperty</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///
    ...
    /// <summary>
    ///   <para>w3dt:SetOfProperties</para>
    /// </summary>
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>a set of properties that can be applied to a data template</para>
    /// labels<para>Set of properties</para></remarks>
    ...
    /// <summary>
    ///   <para>w3dt:ExternalDictionaryReference</para>
    /// </summary>
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ...
    /// labels<para>External dictionary</para></remarks>
    ...
    /// <summary>
    ///   <para>w3dt:hasExternalDictionary</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///
    ...
    /// <summary>
    ///   <para>w3dt:hasReferenceDocument</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///
    ...
    /// <summary>
    ///   <para>w3dt:PhysicalQuantity</para>
    /// </summary>
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ...
    /// <summary>
    ///   <para>w3dt:PredefinedValueItem</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>the physical quantity of a library component</para>
    ...
    /// <summary>
    ///   <para>w3dt:hasPredefinedValues</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///
    ...
    /// <summary>
    ///   <para>w3dt:dateOfPublication</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>real scalar quantity, defined and adopted by convention, with which any other quantity of the same kind can be compared to express the ratio of the second quantity to the first one as a number</para>
    ...
    /// <summary>
    ///   <para>w3dt:hasExternalDictionaryReference</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///
