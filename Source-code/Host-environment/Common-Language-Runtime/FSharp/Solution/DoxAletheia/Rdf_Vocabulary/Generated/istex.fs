...
module istex =
    ...
    /// labels<para>"istex:accessURL"</para><para>"istex:addresseeWork"</para></remarks>
    ...
    /// labels<para>"istex:query"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"istex:tool"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
