...
module tresiot =
    ...
    ///   <para>"This ontology models trust recommendation concepts in SIoT to bridge the gap between abstract trust concepts and real-world device concepts."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"The trustee is an agent that is perceived as trusted from the trustor to deliver a requested task in a given context in the expected manner."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Trustee"</para></remarks>
