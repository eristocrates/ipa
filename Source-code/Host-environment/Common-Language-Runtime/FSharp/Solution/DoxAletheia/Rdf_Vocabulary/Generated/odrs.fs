...
module odrs =
    ...
    let contentLicense = _prefix "contentLicense"
    /// <summary>
    ...
    let copyrightStatement = _prefix "copyrightStatement"
    /// <summary>
    ...
    let dataLicense = _prefix "dataLicense"
    /// <summary>
    ...
    let databaseRightHolder = _prefix "databaseRightHolder"
    /// <summary>
    ...
    let databaseRightStatement = _prefix "databaseRightStatement"
    /// <summary>
    ...
    let databaseRightYear = _prefix "databaseRightYear"
    /// <summary>
    ...
    let reuserGuidelines = _prefix "reuserGuidelines"
    /// <summary>
