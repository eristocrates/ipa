...
module dq =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Accuracy of a Time measurement</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Quantitative attribute accuracy</para></remarks>
    ...
    ///
    /// labels<para>error statistic</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Format consistency</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Logical consistency</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Topological consistency</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>evaluation method description</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>measure description</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Thematic classification correctness</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Conformance result</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Non quantitative attribute accuracy</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>evaluation method type</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal accuracy</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>level description</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Evaluation method code</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>measure identification</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Absolute external positional accuracy</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Completeness omission</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Data quality</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Gridded data positional accuracy</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Completeness commission</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Relative internal positional accuracy</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>name of measure</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Quantitative result</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Conceptual consistency</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal consistency</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Domain consistency</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Temporal validity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Thematic accuracy</para></remarks>
