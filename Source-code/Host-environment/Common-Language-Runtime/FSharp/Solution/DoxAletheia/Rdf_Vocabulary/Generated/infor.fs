...
module infor =
    let _namespace_iri = Namespace_Iri infor |> NamespaceIRI

    /// <summary>
    ///   <para>infor:InformationRealization</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A concrete realization of an information object, e.g. the written document containing the text of a law.</para>
    ...
    let InformationRealization =
        Prefixed_Name(infor, "InformationRealization") |> PrefixedName

    /// <summary>
    ///   <para>infor:realizes</para>
    /// </summary>
    /// <remarks>
    ...
    let realizes = Prefixed_Name(infor, "realizes") |> PrefixedName
    /// <summary>
    ///   <para>infor:InformationObject</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    let InformationObject = Prefixed_Name(infor, "InformationObject") |> PrefixedName
    /// <summary>
    ///   <para>infor:isRealizedBy</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relation between an information realization and an information object, e.g. the paper copy of the Italian Constitution realizes the text of the Constitution.</para>
    ...
    let isRealizedBy = Prefixed_Name(infor, "isRealizedBy") |> PrefixedName
