...
module pdo =
    ...
    ///   <para>owl:Class</para>
    ///   <para>Subclasses pdo:Artifact and models the structure of an action item/task</para>
    /// labels<para>ActionItem</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>An abstract class for  any kind of information artifact which can be structured according to its sematics.</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>The class modelling the structure and cotent of an electronic version of the minutes of a meetintg.</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Models an option in a poll. Each option is linked to a list of people who selected the option during the poll</para>
    /// labels<para>PollOption</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>Models the reporting role of a person in a status reporting context.</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Subclasses pdo:Artifact and models the structure of an agenda item</para>
    /// labels<para>AgendaItem</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Models the attendee role of a person in a meeting context.</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>The base class for all kinds of electronic documents in a project-specific setting.</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Subclasses pdo:Artefact and models the structure of a leave report</para>
    /// labels<para>LeaveReport</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Subclasses pdo:Artifact and models the structure of a poll</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>Models the presenter role of a person in the context of an agenda item.</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>Models the scribe role of a person in a meeting context.</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>The class modelling the structure and content of an electronic version of a status reports document</para>
    ...
    ///   <para>A way to store different alias names of objects (used internally by the application)</para>
    /// labels<para>hasAlias</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hadEndTime</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>Models the chair role of a person in a meeting context.</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Models a comment made by a person</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>The class modelling the actual meeting which is the subject of a particular minutes document.</para>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Subclasses pdo:Artefact and models the structure of a travel report</para>
    /// labels<para>TravelReport</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Subclasses pdo:Artifact and uses bibliography ontology to model the structure of a publication</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The property which links an artefact (for example, an agenda item , an action item, a travle report, etc ) to the document in which it is mentioned.</para>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>hasCreationTime</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>hasStartTime</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>This property links a pdo:ActionItem object to a foaf:Person object who is reponsible for the action item</para>
    /// labels<para>isAssignedTo</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>Models the absentee role of a person in a meeting context.</para>
    /// labels<para>Absentee</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>The abstract class modelling various roles taken by individuals during a particular context ( for example, the attendees, scribe etc in a meeting or the reporter in a status report.)</para>
    /// labels<para>PersonRole</para></remarks>
