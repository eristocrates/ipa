...
module cito =
    ...
    /// labels<para>is cited as data source by</para></remarks>
    ...
    /// labels<para>cites as data source</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The citing entity documents information about the cited entity.</para>
