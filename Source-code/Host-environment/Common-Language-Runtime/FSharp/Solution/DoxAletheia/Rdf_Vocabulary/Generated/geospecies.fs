...
module geospecies =
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>International Committee on Taxonomy of Viruses</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>OccurrenceStatus</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>OccurrenceStatus_absent</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>OccurrenceStatus_doubtful</para></remarks>
    ...
    ///   <para>geospecies:OccurrenceStatus</para>
    ///
    /// labels<para>OccurrenceStatus_present</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Omernik_Level_Three_Classification</para></remarks>
    ...
    ///
    /// labels<para>hasBBC_Habitat</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Managed</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Australasia</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>BBC_Freshwater_Habitats</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Lakes and ponds</para></remarks>
    ...
    ///   <para>geospecies:BBC_Freshwater_Habitat</para>
    ///
    /// labels<para>Wetlands</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Deep ocean</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Hydrothermal vents</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Sea bed</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Shallow seas</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>TaxonRank_cultivarGroup</para></remarks>
    ...
    ///   <para>geospecies:TaxonRank</para>
    ///
    /// labels<para>TaxonRank_order</para></remarks>
    ...
    ///
    /// labels<para>hasStartDate</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasStartDayOfYear</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasStateProv</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasStateProvinceName</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasSubgenusName</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasTDWG_Concept</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasTreeBaseID</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasTypeStatus</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasUSDA_ExpectationOf</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasUUID</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasWI_Herbarium_Habitat</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasWisconsinHerbariumHabitatPreference</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasWisconsinHerbariumSpeciesAssociation</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has_USDA_Growth_Habit</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has_USDA_Native_Status</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isNotUSDA_ExpectedIn</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isUnexpectedIn</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isUSDA_ExpectedIn</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isUSDA_UnexpectedIn</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>wasObservedIn</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>International Code of Zoological Nomenclature</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>USDA_Native_Status_Introduced_Garden_persistent</para></remarks>
    ...
    ///   <para>geospecies:USDA_Native_Status</para>
    ///
    /// labels<para>USDA_Native_Status_Introduced_Probably_Native_and_Introduced</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Homotypic Synonym</para></remarks>
    ...
    ///   <para>geospecies:TaxonomicStatus</para>
    ///
    /// labels<para>Proparte Synonym</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>USDA_Native_Status_Introduced_Probably_Garden_persistent</para></remarks>
    ...
    ///   <para>geospecies:USDA_Native_Status</para>
    ///
    /// labels<para>USDA_Native_Status_Introduced_Waif</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>USDA_Native_Status_Native_Native_and_Introduced</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>USDA_Native_Status_Native_Native_and_Probably_Introduced</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasHumanCollector</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasHumanIdentifier</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasHumanIdentifierName</para></remarks>
    ...
    ///   <para>geospecies:USDA_Native_Status</para>
    ///
    /// labels<para>USDA_Native_Status_Native_Native</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>BBC_Ecozone</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Indo-Malay</para></remarks>
    ...
    ///   <para>geospecies:BBC_Ecozone</para>
    ///
    /// labels<para>Palaearctic</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>OrderConcept</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasOccurrenceStatus</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasOmernik_3_Ecozone</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasOmernik_4_Ecozone</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasOrderName</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasProject</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasScientificName</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasScientificNameRank</para></remarks>
    ...
    ///   <para>geospecies:USDA_Native_Status</para>
    ///
    /// labels<para>USDA_Native_Status_Introduced_Probably_a_Waif</para></remarks>
    ...
    ///   <para>geospecies:USDA_Native_Status</para>
    ///
    /// labels<para>USDA_Native_Status_Native_Probably_Native</para></remarks>
    ...
    ///   <para>geospecies:Nativeness</para>
    ///
    /// labels<para>Invasive</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Omernik_4_Prairie Pothole Region</para></remarks>
    ...
    ///   <para>geospecies:Omernik_Ecoregion_Classification</para>
    ///
    /// labels<para>Omernik_4_Central_Wisconsin_Undulating_Till_Plain</para></remarks>
    ...
    ///   <para>geospecies:Omernik_Level_IV_Ecoregion_Classification</para>
    ///
    /// labels<para>Omernik_4_51e_Upper Wolf River Stagnation Moraine</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Omernik_4_Paleozoic_Plateau_Coulee_Section</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Omernik_4_53a_Rock River Drift Plain</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>BBC_Marine_Habitats</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Estuaries</para></remarks>
    ...
    ///   <para>geospecies:BBC_Marine_Habitat</para>
    ///
    /// labels<para>Reefs</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>BBC_Terrestrial_Habitats</para></remarks>
    ...
    ///   <para>geospecies:BBC_Terrestrial_Habitat</para>
    ///
    /// labels<para>Broadleaf forest</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Coastal</para></remarks>
    ...
    ///   <para>geospecies:BBC_Terrestrial_Habitat</para>
    ///
    /// labels<para>Flooded grassland</para></remarks>
    ...
    ///   <para>geospecies:BBC_Terrestrial_Habitat</para>
    ///
    /// labels<para>Mediterranean forest</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Mountain grassland</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Rainforest</para></remarks>
    ...
    ///   <para>geospecies:BBC_Terrestrial_Habitat</para>
    ///
    /// labels<para>Tropical coniferous forest</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Tropical dry forest</para></remarks>
    ...
    ///   <para>geospecies:BasisOfRecord</para>
    ///
    /// labels<para>BasisOfRecord_LivingSpecimen</para></remarks>
    ...
    ///   <para>geospecies:BasisOfRecord</para>
    ///
    /// labels<para>BasisOfRecord_MachineObservation</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>BasisOfRecord_Sound</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>BasisOfRecord_StillImage</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>BioLibPage</para><para>BBCPage</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>BugGuidePage</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>ClassConcept</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>CoL_LSID</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>DBpediaResource</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Darwin Point is an occurrence location that meets the DarwinCore specifications for longitude, latitude, datum, extent, etc as described in "Guide to Best Practices for Georeferencing"</para>
    /// labels<para>DarwinPoint</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>FamilyConcept</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>FreebaseGUID</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>GBIFPage</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>GeoSpeciesPage</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>GeodeticDatum_NAD27</para></remarks>
    ...
    ///   <para>geospecies:GeodeticDatum</para>
    ///
    /// labels<para>GeodeticDatum_NAD83</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>The Geodetic Datum WGS84</para>
    /// labels<para>GeodeticDatum_WGS84</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>ITISPage</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>HabitatIUCN</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>KingdomConcept</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>LifeStage</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A location, would be a subclass of geonames feature, but it will not always have a geonames feature id</para>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Method_Aerial_Collection_Net</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Method_Barrier_Trap</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Method_Berlese_Sample</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Method_CO2_Suction_Trap</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Method_Chicken_Mash_Baited_Trap</para></remarks>
    ...
    ///   <para>obsm:ArthropodCollectionMethods</para>
    ///
    /// labels<para>Method_Flight_Intercept_Trap</para></remarks>
    ...
    ///   <para>obsm:ArthropodCollectionMethods</para>
    ///
    /// labels<para>Method_Ground_Based_Sticky_Trap</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Method_Hand_Collected</para></remarks>
    ...
    ///   <para>obsm:ArthropodCollectionMethods</para>
    ///
    /// labels<para>Method_Human_Bite_Collection</para></remarks>
    ...
    ///
    /// labels<para>Method_Human_Observation</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Method_Light_and_CO2_Suction_Trap</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Method_Malaise_Trap</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Method_Photographed</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Method_Pitfall_Trap</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Method_Sweep_Net</para></remarks>
    ...
    ///   <para>obsm:ArthropodCollectionMethods</para>
    ///
    /// labels<para>Method_UV_Light_Trap</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Nativeness</para></remarks>
    ...
    ///   <para>geospecies:NomenclaturalCode</para>
    ///
    /// labels<para>NomenclaturalCode_ICVCN</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Unaccepted</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>PhotoCollection</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>IndividualOrganism</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>ObservationMethod</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>BBCPage</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Afrotropics</para></remarks>
    ...
    ///   <para>geospecies:BBC_Ecozone</para>
    ///
    /// labels<para>Antarctica</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Nearctic</para></remarks>
    ...
    ///   <para>geospecies:BBC_Ecozone</para>
    ///
    /// labels<para>Neotropical</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Introduced</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Naturalised</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Omernik_4_51a_St. Croix Pitted Stagnation Moraines</para></remarks>
    ...
    ///   <para>geospecies:Omernik_Level_IV_Ecoregion_Classification</para>
    ///
    /// labels<para>Omernik_4_Central_Sand_Ridges</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Omernik_4_Door_Peninsula</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Omernik_4_Kettle_Moraines</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Omernik_3_Western Corn Belt Plains</para></remarks>
    ...
    ///   <para>geospecies:Omernik_Ecoregion_Classification</para>
    ///
    /// labels<para>Omernik_3_Southeastern_Wisconsin_Till_Plains</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>EoLPage</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>GeoSpeciesScheme</para></remarks>
    ...
    ///
    /// labels<para>GeoSpecies_Knowledge_Base_Project</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>GeodeticDatum</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Native</para></remarks>
    ...
    ///   <para>geospecies:Omernik_Ecoregion_Classification</para>
    ///
    /// labels<para>Omernik_4_Lake Superior Clay Plain</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Omernik_4_Glacial_Lake_Wisconsin_Sand_Plain</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Omernik_4_Savanna Section</para></remarks>
    ...
    ///   <para>geospecies:Omernik_Ecoregion_Classification</para>
    ///
    /// labels<para>Omernik_4_Southeastern_Wisconsin_Savannah_and_Till_Plain</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Omernik_4_Chiwaukee Prairie Region</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Omernik_3_Driftless_Area</para></remarks>
    ...
    ///   <para>geospecies:BasisOfRecord</para>
    ///
    /// labels<para>BasisOfRecord_HumanObservation</para></remarks>
    ...
    ///   <para>geospecies:BasisOfRecord</para>
    ///
    /// labels<para>BasisOfRecord_MovingImage</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>basisOfRecord_PreservedSpecimen</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Bio2RDFtaxon</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>taxonomicStatus</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>BBC_Habitat_Classification</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Rivers and streams</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasPhylumName</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Omernik_4_51f_Green Bay Till and Lacustrine Plain</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Temporary pools</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TaxonRank_cultivar</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasScientificNameAuthorship</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasSpecies</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasSpecificEpithet</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasStateProvName</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasSubfamilyName</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Omernik_3_North_Central_Hardwood_Forests</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isUnknownIn</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Omernik_4_53d_Lake Michigan Lacustrine Clay Plain</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Open ocean</para></remarks>
    ...
    ///   <para>geospecies:TaxonRank</para>
    ///
    /// labels<para>TaxonRank_subfamily</para></remarks>
    ...
    ///   <para>geospecies:TaxonRank</para>
    ///
    /// labels<para>TaxonRank_subsection</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasWisconsinHerbariumHabitatAssociation</para></remarks>
    ...
    ///   <para>geospecies:BBC_Terrestrial_Habitat</para>
    ///
    /// labels<para>Mangroves</para></remarks>
    ...
    ///   <para>geospecies:BBC_Terrestrial_Habitat</para>
    ///
    /// labels<para>Taiga</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Temperate grassland</para></remarks>
    ...
    ///   <para>geospecies:BBC_Terrestrial_Habitat</para>
    ///
    /// labels<para>Tropical grassland</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasTaxonomicStatus</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Omernik_4_Northern Lakes and Forests</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Bog</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Cliff</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Emergent_Aquatic</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Prairie</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Sand_Barrens</para></remarks>
    ...
    ///   <para>geospecies:Wisconsin_Herbarium_Habitat_Classification</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Southern_Lowland_Forest</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Southern_Upland_Forest</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Method_Vacuum_Collector</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Method_Visible_Light_Trap</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>BasisOfRecord_FossilSpecimen</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>BasisOfRecord_NomenclaturalChecklist</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasUbio_LSID</para></remarks>
    ...
    ///   <para>geospecies:Omernik_Level_IV_Ecoregion_Classification</para>
    ///
    /// labels<para>Omernik_3_Central Corn Belt Plains</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>USDA_Plants_Characteristics</para></remarks>
    ...
    ///   <para>geospecies:Wisconsin_Herbarium_Habitat_Classification</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Beech_Forest</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Bracken_Grassland</para></remarks>
    ...
    ///   <para>geospecies:Wisconsin_Herbarium_Habitat_Classification</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Northern_Upland_Forest</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Sand_Dunes</para></remarks>
    ...
    ///   <para>geospecies:Wisconsin_Herbarium_Habitat_Classification</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Shrub_Carr</para></remarks>
    ...
    ///
    /// labels<para>TypeStatus_hapantotype</para></remarks>
    ...
    ///   <para>Applies to vascular plants only. Federal Geographic Data Committee (FGDC) definition includes graminoids, forbs, and ferns.</para>
    /// labels<para>USDA_Growth_Habit_Forb_Herb</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>LifeForm</para></remarks>
    ...
    ///   <para>obsm:ArthropodCollectionMethods</para>
    ///
    /// labels<para>Method_Above_Ground_Sticky_Trap</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Boreal_Forest</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Northern_Lowland_Forest</para></remarks>
    ...
    ///   <para>geospecies:Wisconsin_Herbarium_Habitat_Classification</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Savanna</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>OccurrenceStatus_irregular</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Omernik Ecoregion Classification</para></remarks>
    ...
    ///   <para>obsm:ArthropodCollectionMethods</para>
    ///
    /// labels<para>Method_Hand_Collected_and_Released</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Wisconsin Herbarium Habitat Classification</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>OccurrenceStatus_common</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>OccurrenceStatus_rare</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Omernik_Level_Four_Classification</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasCounty</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasCountyName</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasBasionymName</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasCountryName</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Heterotypic Synonym</para></remarks>
    ...
    ///   <para>geospecies:TaxonomicStatus</para>
    ///
    /// labels<para>Misapplied</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>OpenCycConcept</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>PhylumConcept</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>TaxonRank_family</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TaxonRank_form</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>TaxonRank_genus</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TaxonRank_infraorder</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TaxonRank_section</para></remarks>
    ...
    ///   <para>geospecies:TaxonRank</para>
    ///
    /// labels<para>TaxonRank_species</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TaxonRank_speciesAggregate</para></remarks>
    ...
    ///   <para>geospecies:TaxonRank</para>
    ///
    /// labels<para>TaxonRank_subform</para></remarks>
    ...
    ///   <para>geospecies:TaxonRank</para>
    ///
    /// labels<para>TaxonRank_subgenus</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TaxonRank_suborder</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TaxonRank_subspecies</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TaxonRank_subspecificAggregate</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>TaxonRank_subtribe</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TaxonRank_subvariety</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>TaxonRank_superfamily</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TaxonRank_superorder</para></remarks>
    ...
    ///   <para>geospecies:TaxonRank</para>
    ///
    /// labels<para>TaxonRank_tribe</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TaxonRank_variety</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>ThreatStatusIUCN</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>TypeStatus</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TypeStatus_holotype</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TypeStatus_lectotype</para></remarks>
    ...
    ///   <para>geospecies:TypeStatus</para>
    ///
    /// labels<para>TypeStatus_neotype</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TypeStatus_paralectotype</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TypeStatus_paratype</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>TypeStatus_syntype</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>TypeStatus_varitype</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>USDA_Growth_Habit</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///   <para>geospecies:USDA_Growth_Habit</para>
    ///   <para>Applies to vascular plants only. An herb in the FGDC classification.</para>
    /// labels<para>USDA_Growth_Habit_Graminoid</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>geospecies:USDA_Growth_Habit</para>
    ///   <para>Applies to vascular plants only. In PLANTS, mutually exclusive with VI (Vine). A shrub in the FGDC classification.</para>
    /// labels<para>USDA_Growth_Habit_Liana</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>geospecies:USDA_Growth_Habit</para>
    ///   <para>Applies to lichens only, which are not true plants.</para>
    /// labels<para>USDA_Growth_Habit_Lichenous</para></remarks>
    ...
    ///   <para>geospecies:USDA_Growth_Habit</para>
    ///   <para>owl:Thing</para>
    ///   <para>Applies to non-vascular plants only; in PLANTS system this is groups HN (Hornworts), LV (Liverworts), and MS (Mosses).</para>
    /// labels<para>USDA_Growth_Habit_Nonvascular</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>geospecies:USDA_Growth_Habit</para>
    ///   <para>Applies to vascular plants only.</para>
    /// labels<para>USDA_Growth_Habit_Shrub</para></remarks>
    ...
    ///   <para>geospecies:USDA_Growth_Habit</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>Applies to vascular plants only. A dwarf-shrub in the FGDC classification.</para>
    /// labels<para>USDA_Growth_Habit_Subshrub</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///   <para>Applies to vascular plants only.</para>
    /// labels<para>USDA_Growth_Habit_Tree</para></remarks>
    ...
    ///   <para>geospecies:USDA_Growth_Habit</para>
    ///
    /// labels<para>USDA_Growth_Habit_Unknown</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>owl:Thing</para>
    ///   <para>Applies to vascular plants only. In PLANTS, mutually exclusive with LI (Liana). FGDC classification considers woody vines to be shrubs and herbaceous vines to be herbs.</para>
    /// labels<para>USDA_Growth_Habit_Vine</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Native Jurisdiction Code</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>USDA_Native_Status</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Ubio_LSID</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>UniprotTaxon</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>WikipediaArticle</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>WikispeciesArticle</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Wisconsin_Natural_Heritage_Inventory Habitat_Classification</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>World Pyrochroidae Database</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasSpeciesAssociation</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasBBCHabitatPreference</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasHabitatAssociation</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasBBC_Ecozone</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasBBC_EcozoneName</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasBio2RDFtaxon</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasBioLib</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasBioLibPage</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasCanonicalName</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasClassName</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasCoL_LSID</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasCollectionCode</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasCommonName</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasVernacularName</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasContinent</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasContinentName</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasCountryCode</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasDBpediaResource</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasEndDate</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasEndDayOfYear</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasFamilyInfoContributor</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasFamilyName</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>FreebaseResource</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasGNI</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasGenusName</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasGeoSpeciesConcept</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasTaxonConcept</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasGeodeticDatum</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasInfraspecificEpithet</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasKingdomName</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasLocality</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasLocalityName</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasLocalityText</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasLocationName</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasLowExpectationOf</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasLowUSDA_ExpectationOf</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasNCBITaxonID</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasNoUSDA_ExpectationOf</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasNomenclaturalCode</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>hasNomenclaturalCodeString</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasObservation</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasObservationMethod</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasObservationOf</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>International Code of Botanical Nomenclature</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>International Code of Cultivated Plants</para></remarks>
    ...
    ///   <para>geospecies:USDA_Native_Status</para>
    ///
    /// labels<para>USDA_Native_Status_Introduced_Introduced</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>USDA_Native_Status_Introduced_Probably_Introduced</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Pine_Barrens</para></remarks>
    ...
    ///   <para>geospecies:Wisconsin_Herbarium_Habitat_Classification</para>
    ///
    /// labels<para>Wisconsin_Herbarium_Sedge_Meadow</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///
    /// labels<para>Method_Cantharidin_Baited_Jar_Trap</para></remarks>
