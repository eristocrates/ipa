...
module bio =
    ...
    /// labels<para>"Birth"</para><para>"The birth of Albert Einstein"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///     .&lt;/code&gt;&lt;/pre&gt;
    /// "^^&lt;http://www.w3.org/1999/02/22-rdf-syntax-ns#XMLLiteral&gt;</para>
    /// labels<para>"Cremation"</para><para>"The cremation of Albert Einstein"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"The death of Albert Einstein"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Death"</para></remarks>
    ...
    /// labels<para>"Divorce"</para><para>"The divorce of Albert Einstein and Mileva Marić"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"Albert Einstein emigrating to the United States"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Emigration"</para></remarks>
    ...
    ///   <para>"Suceso importante en la vida de una persona, grupo u organización"</para>
    ...
    ///     .&lt;/code&gt;&lt;/pre&gt;
    /// "^^&lt;http://www.w3.org/1999/02/22-rdf-syntax-ns#XMLLiteral&gt;</para>
    /// labels<para>"Albert Einstein receiving his Doctorate from the University of Zurich"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Graduation"</para></remarks>
    ...
    /// labels<para>"The marriage of Albert Einstein and Mileva Marić"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Marriage"</para></remarks>
    ...
    /// labels<para>"Albert Einstein becoming a citizen of the United States"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Naturalization"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"Datos biográficos de la persona"</para>
    ///   <para>"An extended description or account of someone's life."</para>
    /// labels<para>"Biography"</para><para>"biografía"</para></remarks>
    ...
    ///   <para>"El evento del nacimiento de una persona, grupo u organización"</para>
    /// labels<para>"Nacimiento"</para><para>"Birth Event"</para></remarks>
    /// <seealso href="http://purl.org/vocab/bio/0.1/birth">http://purl.org/vocab/bio/0.1/birth</seealso>
    let birth = Prefixed_Name(bio, "birth") |> PrefixedName
    /// <summary>
    ///   <para>bio:child</para>
    ...
    ///   <para>"Un evento que marca el final de un intervalo o relación"</para>
    /// labels<para>"Evento final"</para><para>"Concluding Event"</para></remarks>
    ...
    ///   <para>"La fecha cuando un evento ocurrió"</para>
    /// labels<para>"Date"</para><para>"Fecha"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>"El evento de la muerte de una persona, grupo u organización"</para>
    /// labels<para>"Muerte"</para><para>"Death Event"</para></remarks>
    /// <seealso href="http://purl.org/vocab/bio/0.1/death">http://purl.org/vocab/bio/0.1/death</seealso>
    let death = Prefixed_Name(bio, "death") |> PrefixedName
    /// <summary>
    ...
    ///   <para>"Un evento que indica el comienzo de un intervalo o relación"</para>
    /// labels<para>"Initiating Event"</para><para>"Evento inicial"</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Lugar donde ocurre un evento"</para>
    ///   <para>"The place at which an event occurred."</para>
    /// labels<para>"Lugar"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Place"</para></remarks>
