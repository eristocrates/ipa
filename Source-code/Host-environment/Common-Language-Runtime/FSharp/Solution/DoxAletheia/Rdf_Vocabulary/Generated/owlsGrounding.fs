...
module owlsGrounding =
    ...
    /// <summary>
    ///   <para>owlsGrounding:WadlAtomicProcessGrounding</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    /// </remarks>
    /// <seealso href="http://www.daml.org/services/owl-s/1.2/Grounding.owl#WadlAtomicProcessGrounding">http://www.daml.org/services/owl-s/1.2/Grounding.owl#WadlAtomicProcessGrounding</seealso>
    let WadlAtomicProcessGrounding =
        Prefixed_Name(owlsGrounding, "WadlAtomicProcessGrounding") |> PrefixedName
