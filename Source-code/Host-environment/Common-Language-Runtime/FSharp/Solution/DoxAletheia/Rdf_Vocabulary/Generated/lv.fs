...
module lv =
    ...
    /// labels<para>"Archived Web Page"</para><para>"Archivierte Webseite"</para></remarks>
    ...
    /// labels<para>"Bibliography"</para><para>"Bibliografie"</para></remarks>
    ...
    /// labels<para>"Biografie"</para><para>"Biography"</para></remarks>
    ...
    /// labels<para>"Festschrift"</para></remarks>
    ...
    /// labels<para>"Fulltext online"</para><para>"Online-Volltext"</para></remarks>
    ...
    /// labels<para>"Art des Unterhaltträgers"</para><para>"Type of funding organization"</para></remarks>
    ...
    /// labels<para>"NWBib-Sachschlagwort"</para><para>"NWBib subject heading"</para></remarks>
    ...
    /// labels<para>"Region key"</para><para>"Regionalschlüssel"</para></remarks>
    ...
    /// labels<para>"Stock Size"</para><para>"Bestandsgröße"</para></remarks>
    ...
    /// labels<para>"Web page archived"</para><para>"Archivierte Webseite"</para></remarks>
