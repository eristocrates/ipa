...
module qb =
    ...
    ///   <para>owl:Class</para>
    /// </remarks>
    /// <seealso href="http://purl.org/linked-data/cube#">http://purl.org/linked-data/cube#</seealso>
    let _prefix_iri = Prefixed_Name(qb, "") |> PrefixedName
    /// <summary>
    ...
    ///   <para>"Indicates a property on a Dataset Cube. rdfs:Range indicates the object type. E.g.: org:organization"</para>
    ///   <para>"Indica una propiedad de un Dataset Cube. rdfs:Range indica el tipo de objeto. Ejemplo org:organization"</para>
    /// labels<para>"Componente"</para><para>"Component property (abstract)"</para><para>"Component"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"Se usa para definir propiedades de un componente (atributo, dimensión, etc.) que son específicas de su uso en DataStructureDefinition"</para>
    ///   <para>"Used to define properties of a component (attribute, dimension etc) which are specific to its usage in a DSD."</para>
    ///   <para>"Used to define properties of a component (attribute, dimension etc) which are specific to its usage in a DSD"</para>
    /// labels<para>"Especificación de componente"</para><para>"Component specification"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"Representa una colección de observaciones, conforme a una estructura de dimensiones común"</para>
    ...
    ///   <para>"Represents a collection of observations, conforming to some common dimensional structure"</para>
    /// labels<para>"Cube Dataset"</para><para>"Data set"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"Define la estructura de un Dataset"</para>
    ///   <para>"Defines the structure of a DataSet or slice"</para>
    ///   <para>"Defines the structure of a DataSet"</para>
    /// labels<para>"Data structure definition"</para><para>"Data Structure Definition"</para><para>"Definición de la estructura de datos"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"It represents the dimensions of the cube"</para>
    ///   <para>"Representa las dimensiones de un cubo"</para>
    ///   <para>"The class of components which represent the dimensions of the cube"</para>
    /// labels<para>"Propiedad dimensión"</para><para>"Dimension property"</para></remarks>
    ...
    /// <summary>
    ///   <para>qb:LogicalDataSet</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://purl.org/linked-data/cube#LogicalDataSet">http://purl.org/linked-data/cube#LogicalDataSet</seealso>
    let LogicalDataSet = Prefixed_Name(qb, "LogicalDataSet") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"Representa el valor medido para el fenómeno observado"</para>
    ///   <para>"Represent the measured value of the phenomenon being observed"</para>
    ///   <para>"The class of components which represent the measured value of the phenomenon being observed"</para>
    /// labels<para>"Medida"</para><para>"Measure"</para><para>"Measure property"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"Una observación individual del cubo, puede tener una o más medidas asociadas"</para>
    ...
    ///   <para>"Enlace a las especificaciones de los componentes"</para>
    ///   <para>"indicates a component specification which is included in the structure of the dataset"</para>
    /// labels<para>"Especificaciones de los componentes"</para><para>"component specification"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"Enlace a la entidad raiz de propiedades de componente"</para>
    ///   <para>"indicates a ComponentProperty (i.e. attribute/dimension) expected on a DataSet, or a dimension fixed in a SliceKey"</para>
    /// labels<para>"component"</para><para>"propiedades de componente"</para></remarks>
    /// <seealso href="http://purl.org/linked-data/cube#componentProperty">http://purl.org/linked-data/cube#componentProperty</seealso>
    let componentProperty = Prefixed_Name(qb, "componentProperty") |> PrefixedName
    /// <summary>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"Indica si la dimensión o medidas son requeridos"</para>
    ...
    /// labels<para>"component required"</para><para>"Indica la obligatoridad"</para></remarks>
    ...
    ///   <para>"Enlace con Categoria Skos"</para>
    /// labels<para>"concept"</para><para>"Categorías"</para></remarks>
    ...
    ///   <para>"Enlace a dimensión"</para>
    /// labels<para>"dimension"</para><para>"Dimensión"</para></remarks>
    ...
    ///   <para>"Enlace con medidas"</para>
    /// labels<para>"measure"</para><para>"Medidas"</para></remarks>
    ...
    ///   <para>"Indica el orden de las dimensiones o medidas"</para>
    /// labels<para>"order"</para><para>"Orden"</para></remarks>
    ...
    ///   <para>"Enlace a la definición de la estructura"</para>
    /// labels<para>"Definición de estructura"</para><para>"structure"</para></remarks>
