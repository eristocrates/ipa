...
module vas =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Diary temporality, 500 m resolution, product MYD09GA_006_NDVI</para>
    ///   <para>Sensor that takes NDVI measurements from MODIS-Aqua.</para>
    ...
    /// labels<para>WindVane_AEMET</para></remarks>
    ...
    ///   <para>Sensor AGB UAV Hyperspectral hosted by UAV Hyperspectral 1.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes Land Surface Temperature measurements from MODIS-Aqua.</para>
    ///   <para>8 days temporality, 1 km resolution. Product MYD11A2.</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>Class that represents observations related to Land Surface Temperature (LST). Celsius Degree.</para>
    ///   <para>Sensor that takes Land Surface Temperature measurements from MODIS-Terra.</para>
    ///   <para>8 days temporality, 1 km resolution. Product MYD11A2.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes LST measurements from Landset-8.</para>
    ///   <para>Class that represents observations related to Land Surface Temperature (LST). Celsius Degree.</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>Class that represents observations related to Land Surface Temperature (LST). Celsius Degree.</para>
    ///   <para>Sensor that takes LST measurements from Landset-9.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes LST measurements from Sentinel-3.</para>
    ///   <para>Class that represents observations related to Land Surface Temperature (LST). Celsius Degree.</para>
    /// </remarks>
    ...
    ///   <para>Control Area indicates if it is 1x1 km or 10x10 km in VAS.</para>
    /// </remarks>
    ...
    ///   <para>Sensor that takes Chlorophyll measurements from Sentinel-2.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Unmanned aerial vehicle LiDAR</para>
    /// labels<para>UAV_LiDAR</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Unmanned aerial vehicle Multispectral</para>
    ...
    ///   <para>Sensor that takes EVI measurements from  Landsat-9.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Daily temporality, resolution 500 m, product MYD09GA_006_EVI</para>
    ///   <para>Sensor that takes Enhanced Vegetation Index (EVI) measurements from MODIS-Aqua.</para>
    ///   <para>Class that represents observations related to Enhanced Vegetation Index (EVI).</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Represents the general sensorization of SMAP. Observes Soil Moisture.</para>
    /// </remarks>
    ...
    /// labels<para>10x10 Area</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes Chl measurements from Landsat-8.</para>
    ///   <para>Class that represents observations related to Chlorophyll content. Micromoles of chlorophyll per square metre of leaf surface.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes Chl measurements from Lamdsat-9.</para>
    ///   <para>Class that represents observations related to Chlorophyll content. Micromoles of chlorophyll per square metre of leaf surface.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes CloudMask measurements from METEOSAT.</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>Class that represents observations related to cloud mask. Dimensionless.</para>
    ///   <para>Sensor that takes CloudType measurements from METEOSAT.</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>Class that represents observations related to Enhanced Vegetation Index (EVI).</para>
    ///   <para>Sensor that takes EVI measurements from Landsat-8.</para>
    /// </remarks>
    ...
    ///   <para>Sensor that takes LAI measurements from Landsat-8.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes LAI measurements from Landsat-9.</para>
    ///   <para>Class that represents observations related to Leaf Area Index (LAI). Dimensionless.</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>Class that represents observations related to Leaf Area Index (LAI). Dimensionless.</para>
    ///   <para>Sensor that takes LAI measurements from Sentinel-2.</para>
    /// </remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>Adquisition Period</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>Cloudy pixels</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>Ground Track Direction</para></remarks>
    ...
    ///   <para>Class that represents observations related to Land Surface Temperature (LST). Celsius Degree.</para>
    ///   <para>Sensor that takes Land Surface Temperature measurements from MODIS-Terra.</para>
    ///   <para>Daily temporality,1 km resolution. Product MYD11A1</para>
    /// </remarks>
    ...
    /// labels<para>1x1 Area</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes FAPAR measurements from MODIS-Aqua.</para>
    ///   <para>Temporality 8 days, resolution 500 m, product MYD15A2H</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>Class that represents observations related to fraction of absorved photosynthetically active radiation (FAPAR). Dimensionless.</para>
    ///   <para>Sensor that takes FAPAR measurements from Sentinel-2.</para>
    /// </remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>vas:RS_UAV_Hyperspectral</para>
    ///   <para>Sensor CRI UAV Hyperspectral hosted by UAV Hyperspectral 1.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes Enhanced Vegetation Index (EVI) measurements from MODIS-Terra.</para>
    ///   <para>Class that represents observations related to Enhanced Vegetation Index (EVI).</para>
    ///   <para>Daily temporality, 500 m resolution, product MYD09GA_006_EVI</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>Class that represents observations related to Enhanced Vegetation Index (EVI).</para>
    ///   <para>Sensor that takes EVI measurements from Sentinel-2.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes SAVI measurements from Landsat-9.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes SAVI measurements from Sentinel-2.</para>
    ///   <para>Class that represents observations related to Soil Adjusted Vegetation Index (SAVI).</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Unmanned aerial vehicle Hyperspectral</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>Land pixels</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>Product type</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Unmanned aerial vehicle Microwave</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Unmanned aerial vehicle RGB</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Unmanned aerial vehicle Thermal</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>Class that represents observations related to Soil Adjusted Vegetation Index (SAVI).</para>
    ///   <para>Sensor that takes SAVI measurements from Landsat-8.</para>
    /// </remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>Relative Orbit Number</para></remarks>
    ...
    ///   <para>Sensor that takes SR measurements from L8.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes OTCI measurements from Sentinel-3.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes SR measurements from L9.</para>
    ///   <para>Class that represents observations related to Simple Ratio (SR). Dimensionless.</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>Class that represents observations related to Simple Ratio (SR). Dimensionless.</para>
    ///   <para>Sensor that takes SR measurements from S2.</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>Class that represents observations related to fraction of absorved photosynthetically active radiation (FAPAR). Dimensionless.</para>
    ///   <para>Sensor that takes FAPAR measurements from  Landsat-8.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes FAPAR measurements from  Landsat-9.</para>
    ///   <para>Class that represents observations related to fraction of absorved photosynthetically active radiation (FAPAR). Dimensionless.</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>Temporality 8 days, resolution 500 m, product MYD15A2H</para>
    ///   <para>Sensor that takes FAPAR measurements from MODIS-Terra.</para>
    ///   <para>Class that represents observations related to fraction of absorved photosynthetically active radiation (FAPAR). Dimensionless.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>16 days temporality,  1km resolution, product MYD13A2</para>
    ///   <para>Class that represents observations related to Normalized Difference Vegetation Index (NDVI).</para>
    ///   <para>Sensor that takes NDVI measurements from MODIS-Aqua.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>16 days temporality, 1 km resolution. Producto MYD13A2</para>
    ///   <para>Sensor that takes NDVI measurements from MODIS-Terra.</para>
    ///   <para>Class that represents observations related to Normalized Difference Vegetation Index (NDVI).</para>
    /// </remarks>
    ...
    ///   <para>Sensor that takes NDVI measurements from MODIS-Aqua.</para>
    ///   <para>Class that represents observations related to Normalized Difference Vegetation Index (NDVI).</para>
    ///   <para>16 days temporality, 250 m resolution, product MYD13Q1</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes NDVI measurements from MODIS-Terra.</para>
    ///   <para>16 days temporality, 250 m resolution. Producto MYD13Q1</para>
    ///   <para>Class that represents observations related to Normalized Difference Vegetation Index (NDVI).</para>
    /// </remarks>
    ...
    ///   <para>Class that represents observations related to Normalized Difference Vegetation Index (NDVI).</para>
    ///   <para>Sensor that takes NDVI measurements from MODIS-Aqua.</para>
    ///   <para>16 days temporality, 500 m resolution, product MYD13A1</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes NDVI measurements from Landsat-8.</para>
    ///   <para>Class that represents observations related to Normalized Difference Vegetation Index (NDVI).</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>Class that represents observations related to Soil Moisture (SM). Dimensionless [0-1]</para>
    ///   <para>Sensor that takes SM measurements from S1.</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>Class that represents observations related to Soil Moisture (SM). Dimensionless [0-1]</para>
    ///   <para>Soil Moisture Sensor. Resolution of 36 km for Europe from SMAP.</para>
    ///   <para>Daily temporality, 36 km resolution</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Daily temporality, 3 km resolution</para>
    ///   <para>Class that represents observations related to Soil Moisture (SM). Dimensionless [0-1]</para>
    ///   <para>Soil Moisture Sensor. Resolution of 3 km for Europe from SMAP.</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Daily temporality, 9 km resolution</para>
    ///   <para>Soil Moisture Sensor. Resolution of 9 km for Europe from SMAP.</para>
    ///   <para>Class that represents observations related to Soil Moisture (SM). Dimensionless [0-1]</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes PWC measurements from METEOSAT.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes GIFAPAR measurements from Sentinel-3.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes NDVI measurements from Landsat-9.</para>
    ///   <para>Class that represents observations related to Normalized Difference Vegetation Index (NDVI).</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Sensor that takes NDVI measurements from Sentinel-2.</para>
    ///   <para>Class that represents observations related to Normalized Difference Vegetation Index (NDVI).</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Daily temporality, 500 m resolution.  Product MYD09GA_006_NDVI</para>
    ///   <para>Sensor that takes NDVI measurements from MODIS-Terra.</para>
    ///   <para>Class that represents observations related to Normalized Difference Vegetation Index (NDVI).</para>
    /// </remarks>
