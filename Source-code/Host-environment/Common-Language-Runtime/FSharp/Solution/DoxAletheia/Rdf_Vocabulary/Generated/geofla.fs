...
module geofla =
    ...
    /// labels<para>"Région"</para><para>"Region"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Type de commune"</para><para>"Type of commune"</para></remarks>
    ...
    /// labels<para>"belongs to canton"</para><para>"appartient au canton"</para></remarks>
    ...
    /// labels<para>"chef-lieu de l'unité administrative"</para><para>"capital of the administrative subdivision"</para></remarks>
    ...
    /// labels<para>"code géographique du canton"</para><para>"geographic code of the canton"</para></remarks>
    ...
    /// labels<para>"geographic code of the region"</para><para>"code géographique de la région"</para></remarks>
    ...
    /// labels<para>"numéro insee de la commune"</para><para>"insee identifier of the commune"</para></remarks>
    ...
    /// labels<para>"belongs to region"</para><para>"appartient à la région"</para></remarks>
    /// <seealso href="http://data.ign.fr/def/geofla#region">http://data.ign.fr/def/geofla#region</seealso>
    let region = Prefixed_Name(geofla, "region") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"statut"</para><para>"status"</para></remarks>
    ...
    /// labels<para>"area in hectares"</para><para>"superficie en hectares"</para></remarks>
    ...
    /// labels<para>"mean altitude"</para><para>"altitude moyenne"</para></remarks>
