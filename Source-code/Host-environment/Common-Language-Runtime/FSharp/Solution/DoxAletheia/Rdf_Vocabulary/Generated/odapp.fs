...
module odapp =
    ...
    ///   <para>a free application</para>
    /// labels<para>free application</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>describes the type of the application (e.g. mobile app, desktop app, etc...)</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>a paid application</para>
    /// labels<para>paid application</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>An application price</para>
    /// labels<para>application price</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>relationship between the admssw:SoftwareRelease and odap:Price</para>
    /// labels<para>application price</para></remarks>
    /// <seealso href="http://vocab.deri.ie/odapp#price">http://vocab.deri.ie/odapp#price</seealso>
    let price = Prefixed_Name(odapp, "price") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>describes a dataset that is used by the application</para>
    /// labels<para>uses dataset</para></remarks>
