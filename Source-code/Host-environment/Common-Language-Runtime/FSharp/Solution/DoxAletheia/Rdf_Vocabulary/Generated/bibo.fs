...
module bibo =
    ...
    /// labels<para>page end</para></remarks>
    ...
    /// labels<para>page start</para></remarks>
    ...
    /// labels<para>Collected Document</para></remarks>
    ...
    /// labels<para>Personal Communication Document</para></remarks>
    ...
    /// labels<para>Hearing</para></remarks>
    ...
    /// labels<para>Reference Source</para></remarks>
    ...
    /// labels<para>Thesis degree</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>An entity responsible for issuing often informally published documents such as press releases, reports, etc.</para>
    ...
    /// labels<para>prefix name</para></remarks>
    ...
    /// labels<para>presented at</para></remarks>
    ...
    /// labels<para>transcript of</para></remarks>
    ...
    /// labels<para>Academic Article</para></remarks>
    ...
    /// labels<para>audio-visual document</para></remarks>
    ...
    /// labels<para>Interview</para></remarks>
    ...
    /// labels<para>Legal Case Document</para></remarks>
