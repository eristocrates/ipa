...
module peco =
    ...
    let EmissionCalculationActivity =
        Namespaced_IRI.parse _namespace_name "EmissionCalculationActivity" |> NamespacedName
    ...
    let EmissionCalculationEntity =
        Namespaced_IRI.parse _namespace_name "EmissionCalculationEntity" |> NamespacedName
    ...
    let EmissionGenerationActivity =
        Namespaced_IRI.parse _namespace_name "EmissionGenerationActivity" |> NamespacedName
    ...
    let EmissionScore =
        Namespaced_IRI.parse _namespace_name "EmissionScore" |> NamespacedName
    ...
    let hasEmissionScore =
        Namespaced_IRI.parse _namespace_name "hasEmissionScore" |> NamespacedName
    ...
    let inEmissionActivityContext =
        Namespaced_IRI.parse _namespace_name "inEmissionActivityContext" |> NamespacedName
