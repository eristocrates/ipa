...
module person =
    ...
    let countryOfBirth =
        Namespaced_IRI.parse _namespace_name "countryOfBirth" |> NamespacedName

    /// <summary>
    /// The country in which a Person died.
    /// <see href="http://www.w3.org/ns/person#countryOfDeath"></see></summary>
    let countryOfDeath =
        Namespaced_IRI.parse _namespace_name "countryOfDeath" |> NamespacedName
    ...
    let patronymicName =
        Namespaced_IRI.parse _namespace_name "patronymicName" |> NamespacedName
    ...
    let residency = Namespaced_IRI.parse _namespace_name "residency" |> NamespacedName
