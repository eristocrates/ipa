...
module datacite =
    ...
    let ResourceIdentifier =
        Namespaced_IRI.parse _namespace_name "ResourceIdentifier" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/spar/datacite/datacite.png"></see>
    /// </summary>
    let ``datacite.png`` =
        Namespaced_IRI.parse _namespace_name "datacite.png" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/spar/datacite/2021-09-24"></see>
    /// </summary>
    let ``_2021-09-24`` =
        Namespaced_IRI.parse _namespace_name "2021-09-24" |> NamespacedName

    /// <summary>
    ///   <see href="http://purl.org/spar/datacite/2022-09-15"></see>
    /// </summary>
    let ``_2022-09-15`` =
        Namespaced_IRI.parse _namespace_name "2022-09-15" |> NamespacedName
    ...
    let usesIdentifierScheme =
        Namespaced_IRI.parse _namespace_name "usesIdentifierScheme" |> NamespacedName
    ...
    let AgentIdentifierScheme =
        Namespaced_IRI.parse _namespace_name "AgentIdentifierScheme" |> NamespacedName
    ...
    let AlternateResourceIdentifier =
        Namespaced_IRI.parse _namespace_name "AlternateResourceIdentifier" |> NamespacedName
    ...
    let PrimaryResourceIdentifier =
        Namespaced_IRI.parse _namespace_name "PrimaryResourceIdentifier" |> NamespacedName
    ...
    let DescriptionType =
        Namespaced_IRI.parse _namespace_name "DescriptionType" |> NamespacedName
    ...
    let FunderIdentifierScheme =
        Namespaced_IRI.parse _namespace_name "FunderIdentifierScheme" |> NamespacedName
    ...
    let MetadataScheme =
        Namespaced_IRI.parse _namespace_name "MetadataScheme" |> NamespacedName
    ...
    let OrganizationIdentifier =
        Namespaced_IRI.parse _namespace_name "OrganizationIdentifier" |> NamespacedName
    ...
    let PersonalIdentifierScheme =
        Namespaced_IRI.parse _namespace_name "PersonalIdentifierScheme" |> NamespacedName
    ...
    let ResourceIdentifierScheme =
        Namespaced_IRI.parse _namespace_name "ResourceIdentifierScheme" |> NamespacedName
    ...
    let acm = Namespaced_IRI.parse _namespace_name "acm" |> NamespacedName
    /// <summary>
    /// Archival Resource Key.
    /// <see href="http://purl.org/spar/datacite/ark"></see></summary>
    let ark = Namespaced_IRI.parse _namespace_name "ark" |> NamespacedName
    /// <summary>
    ...
    let arxiv = Namespaced_IRI.parse _namespace_name "arxiv" |> NamespacedName
    /// <summary>
    ...
    let bibcode = Namespaced_IRI.parse _namespace_name "bibcode" |> NamespacedName
    /// <summary>
    ...
    let crossref = Namespaced_IRI.parse _namespace_name "crossref" |> NamespacedName
    /// <summary>
    ...
    let dblp = Namespaced_IRI.parse _namespace_name "dblp" |> NamespacedName
    ...
    let ``dblp-record`` =
        Namespaced_IRI.parse _namespace_name "dblp-record" |> NamespacedName
    ...
    let dia = Namespaced_IRI.parse _namespace_name "dia" |> NamespacedName
    /// <summary>
    ...
    let dnb = Namespaced_IRI.parse _namespace_name "dnb" |> NamespacedName
    /// <summary>
    /// International Article Number
    /// <see href="http://purl.org/spar/datacite/ean13"></see></summary>
    let ean13 = Namespaced_IRI.parse _namespace_name "ean13" |> NamespacedName
    /// <summary>
    ...
    let fundref = Namespaced_IRI.parse _namespace_name "fundref" |> NamespacedName
    /// <summary>
    ...
    let gepris = Namespaced_IRI.parse _namespace_name "gepris" |> NamespacedName
    /// <summary>
    ...
    let github = Namespaced_IRI.parse _namespace_name "github" |> NamespacedName
    /// <summary>
    /// The identifier for GitLab Users.
    /// <see href="http://purl.org/spar/datacite/gitlab"></see></summary>
    let gitlab = Namespaced_IRI.parse _namespace_name "gitlab" |> NamespacedName
    /// <summary>
    ...
    let gnd = Namespaced_IRI.parse _namespace_name "gnd" |> NamespacedName
    ...
    let ``google-scholar`` =
        Namespaced_IRI.parse _namespace_name "google-scholar" |> NamespacedName
    ...
    let hasCreatorList =
        Namespaced_IRI.parse _namespace_name "hasCreatorList" |> NamespacedName
    ...
    let hasDescriptionType =
        Namespaced_IRI.parse _namespace_name "hasDescriptionType" |> NamespacedName
    ...
    let hasGeneralResourceType =
        Namespaced_IRI.parse _namespace_name "hasGeneralResourceType" |> NamespacedName
    ...
    let infouri = Namespaced_IRI.parse _namespace_name "infouri" |> NamespacedName
    /// <summary>
    ...
    let isni = Namespaced_IRI.parse _namespace_name "isni" |> NamespacedName
    /// <summary>
    ...
    let istc = Namespaced_IRI.parse _namespace_name "istc" |> NamespacedName
    /// <summary>
    /// Japanese Science and Technology Agency identifier scheme
    /// <see href="http://purl.org/spar/datacite/jst"></see></summary>
    let jst = Namespaced_IRI.parse _namespace_name "jst" |> NamespacedName
    /// <summary>
    ...
    let lattes = Namespaced_IRI.parse _namespace_name "lattes" |> NamespacedName
    /// <summary>
    ...
    let linkedin = Namespaced_IRI.parse _namespace_name "linkedin" |> NamespacedName
    /// <summary>
    /// Linking International Standard Serial Number
    /// <see href="http://purl.org/spar/datacite/lissn"></see></summary>
    let lissn = Namespaced_IRI.parse _namespace_name "lissn" |> NamespacedName
    /// <summary>
    ...
    let loc = Namespaced_IRI.parse _namespace_name "loc" |> NamespacedName
    ...
    let ``local-funder-identifier-scheme`` =
        Namespaced_IRI.parse _namespace_name "local-funder-identifier-scheme" |> NamespacedName
    ...
    let ``local-organization-identifier-scheme`` =
        Namespaced_IRI.parse _namespace_name "local-organization-identifier-scheme" |> NamespacedName
    ...
    let ``local-personal-identifier-scheme`` =
        Namespaced_IRI.parse _namespace_name "local-personal-identifier-scheme" |> NamespacedName
    ...
    let ``local-resource-identifier-scheme`` =
        Namespaced_IRI.parse _namespace_name "local-resource-identifier-scheme" |> NamespacedName
    ...
    let ``math-genealogy`` =
        Namespaced_IRI.parse _namespace_name "math-genealogy" |> NamespacedName
    ...
    let ``national-insurance-number`` =
        Namespaced_IRI.parse _namespace_name "national-insurance-number" |> NamespacedName
    ...
    let nii = Namespaced_IRI.parse _namespace_name "nii" |> NamespacedName
    /// <summary>
    /// Open Citation Identifier.
    /// <see href="http://purl.org/spar/datacite/oci"></see></summary>
    let oci = Namespaced_IRI.parse _namespace_name "oci" |> NamespacedName
    /// <summary>
    ...
    let openalex = Namespaced_IRI.parse _namespace_name "openalex" |> NamespacedName
    /// <summary>
    ...
    let pii = Namespaced_IRI.parse _namespace_name "pii" |> NamespacedName
    /// <summary>
    ...
    let purl = Namespaced_IRI.parse _namespace_name "purl" |> NamespacedName
    /// <summary>
    ...
    let repec = Namespaced_IRI.parse _namespace_name "repec" |> NamespacedName
    ...
    let ``research-gate`` =
        Namespaced_IRI.parse _namespace_name "research-gate" |> NamespacedName
    ...
    let ror = Namespaced_IRI.parse _namespace_name "ror" |> NamespacedName
    /// <summary>
    ...
    let scigraph = Namespaced_IRI.parse _namespace_name "scigraph" |> NamespacedName
    ...
    let ``series-information`` =
        Namespaced_IRI.parse _namespace_name "series-information" |> NamespacedName
    ...
    let ``social-security-number`` =
        Namespaced_IRI.parse _namespace_name "social-security-number" |> NamespacedName
    ...
    let spar = Namespaced_IRI.parse _namespace_name "spar" |> NamespacedName
    ...
    let ``table-of-content`` =
        Namespaced_IRI.parse _namespace_name "table-of-content" |> NamespacedName
    ...
    let usesMetadataScheme =
        Namespaced_IRI.parse _namespace_name "usesMetadataScheme" |> NamespacedName
    ...
    let viaf = Namespaced_IRI.parse _namespace_name "viaf" |> NamespacedName
    /// <summary>
    ...
    let wikidata = Namespaced_IRI.parse _namespace_name "wikidata" |> NamespacedName
    /// <summary>
    ...
    let zbmath = Namespaced_IRI.parse _namespace_name "zbmath" |> NamespacedName
