...
module gen =
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Indicates a member of a Family"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"familyMember"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
