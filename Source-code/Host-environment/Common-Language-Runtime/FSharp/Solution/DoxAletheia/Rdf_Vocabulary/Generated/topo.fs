...
module topo =
    ...
    /// labels<para>under construction</para><para>en construction</para></remarks>
    ...
    /// labels<para>gestionnaire</para><para>manager</para></remarks>
    ...
    /// labels<para>commune gestionnaire de la voie nommÃ©e</para><para>manager of the nammed street</para></remarks>
    ...
    /// labels<para>importance</para><para>importance</para></remarks>
    ...
    /// labels<para>Aire de pÃ©age</para><para>Toll-gate area</para></remarks>
    ...
    /// labels<para>Ã‰lÃ©ment du rÃ©seau ferroviaire</para><para>Transport by rail feature</para></remarks>
    ...
    /// labels<para>itinÃ©raire europÃ©en</para><para>european itinerary</para></remarks>
    ...
    /// labels<para>nature</para><para>nature</para></remarks>
    ...
    /// labels<para>numÃ©ro de borne postale</para><para>civic number</para></remarks>
    ...
    /// labels<para>type of addressing</para><para>type dâ€™adressage</para></remarks>
    ...
    /// labels<para>Marshalling yard</para><para>Aire de triage</para></remarks>
    ...
    /// labels<para>nombre de voies de circulation</para><para>number of traffic lanes</para></remarks>
    ...
    /// labels<para>origine</para><para>origine</para></remarks>
    ...
    /// labels<para>position in relation to the ground</para><para>position par rapport au sol</para></remarks>
    ...
    /// labels<para>prÃ©cision altimÃ©trique</para><para>altimetric accuracy</para></remarks>
    ...
    /// labels<para>largeur de chaussÃ©e</para><para>carriageway width</para></remarks>
    ...
    /// labels<para>EntitÃ© topographique</para><para>Topographic entity</para></remarks>
    ...
    /// labels<para>rÃ©gime des eaux</para><para>water regime</para></remarks>
    ...
    /// labels<para>direction of traffic</para><para>sens de circulation</para></remarks>
    ...
    /// labels<para>Canalisation d'eau</para><para>Water pipe</para></remarks>
    ...
    /// labels<para>numÃ©ro</para><para>number</para></remarks>
    ...
    /// labels<para>type de ligne de transport par cÃ¢ble</para><para>type of cableway transport line</para></remarks>
    ...
    /// labels<para>voltage</para><para>voltage</para></remarks>
    ...
    /// labels<para>initial z</para><para>z initial</para></remarks>
    ...
    /// labels<para>max z</para><para>z max</para></remarks>
    ...
    /// labels<para>average z</para><para>z moyen</para></remarks>
    ...
    /// labels<para>type of building </para><para>type de bÃ¢timent</para></remarks>
    ...
    /// labels<para>Pipeline</para><para>Conduite</para></remarks>
    ...
    /// labels<para>Cours d'eau</para><para>Watercourse</para></remarks>
    ...
    /// labels<para>Electricity transmission line</para><para>Ligne Ã©lectrique</para></remarks>
    ...
    /// labels<para>Ligne de transport par cÃ¢ble</para><para>Cableway transport line</para></remarks>
    ...
    /// labels<para>PylÃ´ne</para><para>Pylon</para></remarks>
    ...
    /// labels<para>Route</para><para>Road</para></remarks>
    ...
    /// labels<para>Piste d'aÃ©rodrome</para><para>Taxiway</para></remarks>
    ...
    /// labels<para>RÃ©servoir</para><para>Tank</para></remarks>
    ...
    /// labels<para>Terrain de sport</para><para>Sports ground</para></remarks>
    ...
    /// labels<para>Railway track</para><para>Voie ferrÃ©e</para></remarks>
    ...
    /// labels<para>Zone de vÃ©gÃ©tation</para><para>Vegetation area</para></remarks>
    ...
    /// labels<para>final civic number marker</para><para>borne finale</para></remarks>
    ...
    /// labels<para>fictif</para><para>dummy</para></remarks>
    ...
    /// labels<para>hauteur</para><para>height</para></remarks>
    ...
    /// labels<para>Bassin</para><para>Basin</para></remarks>
