...
module org =
    ...
    let ChangeEvent = _prefix "ChangeEvent"
    /// <summary>
    ...
    let roleProperty = _prefix "roleProperty"
    /// <summary>
    ...
    let OrganizationalCollaboration = _prefix "OrganizationalCollaboration"
    /// <summary>
    ...
    let changedBy = _prefix "changedBy"
    /// <summary>
    ...
    let originalOrganization = _prefix "originalOrganization"
    /// <summary>
    ...
    let hasPrimarySite = _prefix "hasPrimarySite"
    /// <summary>
    ...
    let hasRegisteredSite = _prefix "hasRegisteredSite"
    /// <summary>
    ...
    let hasSubOrganization = _prefix "hasSubOrganization"
    /// <summary>
    ...
    let subOrganizationOf = _prefix "subOrganizationOf"
    /// <summary>
    ...
    let memberDuring = _prefix "memberDuring"
    /// <summary>
    ...
    let resultingOrganization = _prefix "resultingOrganization"
    /// <summary>
    ...
    let transitiveSubOrganizationOf = _prefix "transitiveSubOrganizationOf"
