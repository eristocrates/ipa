...
module bto =
    ...
    let adjacentElement = _prefix "adjacentElement"
    /// <summary>
    ...
    let intersectingElement = _prefix "intersectingElement"
    /// <summary>
    ...
    let adjacentZone = _prefix "adjacentZone"
    /// <summary>
    ...
    let intersectsZone = _prefix "intersectsZone"
    /// <summary>
    ...
    let containsZone = _prefix "containsZone"
    /// <summary>
    ...
    let has3DModel = _prefix "has3DModel"
    /// <summary>
    ...
    let hasSimple3DModel = _prefix "hasSimple3DModel"
    /// <summary>
    ...
    let hasStorey = _prefix "hasStorey"
    /// <summary>
    ...
    let hasSubElement = _prefix "hasSubElement"
    /// <summary>
    ...
    let hasZeroPoint = _prefix "hasZeroPoint"
    /// <summary>
    ...
    let interfaceOf = _prefix "interfaceOf"
