...
module pproc =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Additional information notice"</para><para>"Anuncio de información adicional"</para></remarks>
    ...
    /// labels<para>"Awarded tender"</para><para>"Oferta adjudicada"</para></remarks>
    ...
    /// labels<para>"Bundle price"</para><para>"Precio de paquete"</para></remarks>
    ...
    /// labels<para>"Tender committee"</para><para>"Comité de contratación"</para></remarks>
    ...
    /// labels<para>"Conclusion contract"</para><para>"Contrato de establecimiento"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Public contract"</para><para>"Contrato público"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Contract award notice"</para><para>"Anuncio de adjudicación"</para></remarks>
    ...
    /// labels<para>"Contract execution conditions"</para><para>"Condiciones de ejecución del contrato"</para></remarks>
    ...
    /// labels<para>"Contract procedure"</para><para>"Procedimiento del contrato"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Contract resolution"</para><para>"Resolución del contrato"</para></remarks>
    ...
    /// labels<para>"Criterion score"</para><para>"Valoración de criterio"</para></remarks>
    ...
    /// labels<para>"Electronic auction"</para><para>"Subasta electrónica"</para></remarks>
    ...
    /// labels<para>"Electronic auction phase"</para><para>"Fase de subasta electrónica"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Expert committee"</para><para>"Comité de expertos"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Formalization notice"</para><para>"Anuncio de formalización"</para></remarks>
    ...
    /// labels<para>"Formalized tender"</para><para>"Oferta formalizada"</para></remarks>
    ...
    /// labels<para>"Acuerdo marco o Sistema Dinámico de contratación"</para><para>"Framework agreement or dynamic purchasing system"</para></remarks>
    ...
    /// labels<para>"Framework derivative contract"</para><para>"Contrato derivado de un acuerdo marco"</para></remarks>
    ...
    /// labels<para>"Information kind scheme"</para><para>"Esquema de tipos de información"</para></remarks>
    ...
    /// labels<para>"Information provider"</para><para>"Proveedor de información"</para></remarks>
    ...
    /// labels<para>"Lease contract"</para><para>"Arrendamiento financiero"</para></remarks>
    ...
    /// labels<para>"Mixed capital company contract"</para><para>"Contrato de sociedad de economia mixta"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Contrato mixto"</para><para>"Mixed contract"</para></remarks>
    ...
    /// labels<para>"Contrato plurianual"</para><para>"Multiannual contract"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Negociado sin publicidad"</para><para>"Negotiated without publicity"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Ordinary administrative remedy"</para><para>"Recurso administrativo ordinario"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Precomercial procurement"</para><para>"Compra pública pre-comercial"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Contrato privado"</para><para>"Private contract"</para></remarks>
    ...
    /// labels<para>"Procedure type scheme"</para><para>"Esquema de tipos de procedimiento"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Public services management contract"</para><para>"Contrato de gestión de servicios públicos"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Public works concession contract"</para><para>"Contrato de concesión de obras públicas"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Regular"</para><para>"Ordinaria"</para></remarks>
    ...
    /// labels<para>"Rent contract"</para><para>"Contrato de alquiler"</para></remarks>
    ...
    /// labels<para>"Gestión interesada"</para><para>"Shared result agreement contract"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Simple open"</para><para>"Abierto simple"</para></remarks>
    ...
    /// labels<para>"Subjective award criterion"</para><para>"Criterio de adjudicación subjetivo"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Información técnica"</para><para>"Technical information"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Tender committee"</para><para>"Mesa de contratación"</para></remarks>
    ...
    /// labels<para>"Tender requirements"</para><para>"Requisitos para las ofertas"</para></remarks>
    ...
    /// labels<para>"Tenderers requirements"</para><para>"Requisitos de los licitadores"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Works contract"</para><para>"Contrato de obras"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Briefing"</para><para>"Reunión informativa"</para></remarks>
    /// <seealso href="http://contsem.unizar.es/def/sector-publico/pproc#briefing">http://contsem.unizar.es/def/sector-publico/pproc#briefing</seealso>
    let briefing = Prefixed_Name(pproc, "briefing") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Contract budget price"</para><para>"Presupuesto del contrato"</para></remarks>
    ...
    /// labels<para>"Aportaciones públicas"</para><para>"Construction subsidies"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Contract activities"</para><para>"Trámites del contrato"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Contract economic conditions"</para><para>"Condiciones económicas del contrato"</para></remarks>
    /// <seealso href="http://contsem.unizar.es/def/sector-publico/pproc#contractEconomicConditions">http://contsem.unizar.es/def/sector-publico/pproc#contractEconomicConditions</seealso>
    let contractEconomicConditions =
        Prefixed_Name(pproc, "contractEconomicConditions") |> PrefixedName
    ...
    /// labels<para>"Contract modification"</para><para>"Modificación de contrato"</para></remarks>
    /// <seealso href="http://contsem.unizar.es/def/sector-publico/pproc#contractModification">http://contsem.unizar.es/def/sector-publico/pproc#contractModification</seealso>
    let contractModification =
        Prefixed_Name(pproc, "contractModification") |> PrefixedName
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Contract modification conditions"</para><para>"Condiciones para la modificación del contrato"</para></remarks>
    /// <seealso href="http://contsem.unizar.es/def/sector-publico/pproc#contractModificationConditions">http://contsem.unizar.es/def/sector-publico/pproc#contractModificationConditions</seealso>
    let contractModificationConditions =
        Prefixed_Name(pproc, "contractModificationConditions") |> PrefixedName
    ...
    /// labels<para>"Contract or procedure extinction"</para><para>"Extinción de contrato o de procedimiento"</para></remarks>
    /// <seealso href="http://contsem.unizar.es/def/sector-publico/pproc#contractOrProcedureExtinction">http://contsem.unizar.es/def/sector-publico/pproc#contractOrProcedureExtinction</seealso>
    let contractOrProcedureExtinction =
        Prefixed_Name(pproc, "contractOrProcedureExtinction") |> PrefixedName
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Duración"</para><para>"Duration"</para></remarks>
    ...
    /// labels<para>"Electronic auction web"</para><para>"Web de la subasta electrónica"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"End mode"</para><para>"Modo de finalización"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Duración estimada"</para><para>"Estimated duration"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Estimated end date"</para><para>"Fecha estimada de finalización"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Valor estimado del contrato"</para><para>"Estimated value of the contract"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Expected cause modification"</para><para>"Causas previstas de modificación"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Fee"</para><para>"Canon"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Plazo de la garantía definitiva"</para><para>"Final financial guarantee duration"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Formalized date"</para><para>"Fecha de formalización"</para></remarks>
    ...
    /// labels<para>"Item"</para><para>"Artículo"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Legal document reference"</para><para>"Pliego de cláusulas administrativas"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Lote"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Lot"</para></remarks>
    /// <seealso href="http://contsem.unizar.es/def/sector-publico/pproc#lot">http://contsem.unizar.es/def/sector-publico/pproc#lot</seealso>
    let lot = Prefixed_Name(pproc, "lot") |> PrefixedName
    /// <summary>
    ...
    ///
    /// The concept used should be a valid representation of a CPV code, as it is in http://cpv.data.ac.uk/."</para>
    /// labels<para>"Main object of contract"</para><para>"Principal objeto del contrato"</para></remarks>
    ...
    ///   <para>"El rango en esta propiedad indica un porcentaje, por lo que el rango del número real a utilizar debe estar comprendido entre 0.0 y 100.0."</para>
    ///   <para>"The range of this property must be a percentage (i.e. float between 0.0 and 100.0)"</para>
    /// labels<para>"Maximum final price change"</para><para>"Modificación máxima sobre precio final"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Maximum number of invitations"</para><para>"Número máximo de invitaciones"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Maximum number of operators"</para><para>"Número máximo de participantes"</para></remarks>
    ...
    ///   <para>"The range of this property must be a percentage (i.e. float between 0.0 and 100.0)"</para>
    ///   <para>"El rango en esta propiedad indica un porcentaje, por lo que el rango del número real a utilizar debe estar comprendido entre 0.0 y 100.0."</para>
    /// labels<para>"Subcontratación máxima"</para><para>"Maximum subcontracting"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Minimum number of operators"</para><para>"Número mínimo de participantes"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Modification reason"</para><para>"Justificación de la modificación"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Modification scope"</para><para>"Alcance de la modificación"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Notice"</para><para>"Anuncio"</para></remarks>
    /// <seealso href="http://contsem.unizar.es/def/sector-publico/pproc#notice">http://contsem.unizar.es/def/sector-publico/pproc#notice</seealso>
    let notice = Prefixed_Name(pproc, "notice") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Date of notice publication"</para><para>"Fecha de publicación del anuncio"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Notice sent date"</para><para>"Fecha de envio del anuncio"</para></remarks>
    ...
    /// labels<para>"Notice site"</para><para>"Medio de publicación del anuncio"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Notice web"</para><para>"Web del anuncio"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Offered duration"</para><para>"Plazo de ejecución ofertado"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Offered end date"</para><para>"Fecha de finalización ofertada"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Otros requisitos"</para><para>"Other ability requisites"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Other award terms"</para><para>"Otras condiciones de la adjudicación"</para></remarks>
    ...
    ///   <para>"The range of this property must be a percentage (i.e. float between 0.0 and 100.0)"</para>
    ///   <para>"El rango en esta propiedad indica un porcentaje, por lo que el rango del número real a utilizar debe estar comprendido entre 0.0 y 100.0."</para>
    /// labels<para>"Price percentage change"</para><para>"Porcentaje de variación sobre el precio"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Procedure type"</para><para>"Tipo de procedimiento"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Procedure void"</para><para>"Procedimiento desierto"</para></remarks>
    /// <seealso href="http://contsem.unizar.es/def/sector-publico/pproc#procedureVoid">http://contsem.unizar.es/def/sector-publico/pproc#procedureVoid</seealso>
    let procedureVoid = Prefixed_Name(pproc, "procedureVoid") |> PrefixedName
    /// <summary>
    ///   <para>pproc:procedureWaive</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Procedure waive"</para><para>"Renuncia del procedimiento"</para></remarks>
    /// <seealso href="http://contsem.unizar.es/def/sector-publico/pproc#procedureWaive">http://contsem.unizar.es/def/sector-publico/pproc#procedureWaive</seealso>
    let procedureWaive = Prefixed_Name(pproc, "procedureWaive") |> PrefixedName
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Remedy resolution date"</para><para>"Fecha de resolución del recurso"</para></remarks>
    ...
    /// labels<para>"Score"</para><para>"Valoración"</para><para>"Puntuación"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Technical document reference"</para><para>"Pliego de prescripciones técnicas"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Fecha de nombramiento"</para><para>"Tender committee appointment date"</para></remarks>
    ...
    /// labels<para>"Tender committee role"</para><para>"Cargo en el comité de contratación"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Time-limit for submission of tenders or requests to participate"</para><para>"Fecha límite para la presentación de ofertas o de peticiones a participar"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Tender information provider"</para><para>"Proveedor de información sobre la licitación"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Tender meeting"</para><para>"Reunión de la mesa de contratación"</para></remarks>
    /// <seealso href="http://contsem.unizar.es/def/sector-publico/pproc#tenderMeeting">http://contsem.unizar.es/def/sector-publico/pproc#tenderMeeting</seealso>
    let tenderMeeting = Prefixed_Name(pproc, "tenderMeeting") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Tender submission location"</para><para>"Sede de presentación de las ofertas"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>"Variant admission"</para><para>"Admisión de variantes"</para></remarks>
    ...
    /// labels<para>"Variant description"</para><para>"Descripción de las variantes"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Web con información"</para><para>"Website with information"</para></remarks>
