...
module vcard2006 =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Acquaintance</para></remarks>
    ...
    /// labels<para>has calendar request</para></remarks>
    ...
    /// labels<para>has messaging</para></remarks>
    ...
    /// labels<para>has geo</para></remarks>
    ...
    /// labels<para>has calendar link</para></remarks>
    ...
    /// labels<para>has nickname</para></remarks>
    ...
    /// labels<para>has street address</para></remarks>
    ...
    /// labels<para>has organization name</para></remarks>
    ...
    /// labels<para>has photo</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Crush</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Coworker</para></remarks>
    ...
    /// labels<para>formatted name</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Text phone</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Neighbor</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Sweetheart</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Coresident</para></remarks>
