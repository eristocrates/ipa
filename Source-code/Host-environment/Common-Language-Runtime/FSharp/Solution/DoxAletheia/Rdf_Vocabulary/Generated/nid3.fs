...
module nid3 =
    ...
    /// Note that in this RDF representation each InvolvedPerson is represented with a separate instance of the InvolvedPerson class and with a separate involvedPerson triple."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>"An element of the synchronized text. It aggregates the actual text content, with the timestamp."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"SynchronizedTextElement"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>"This frame is intended for one-string text information concerning the audiofile in a similar way to the other "T"-frames. The frame body consists of a description of the string, represented as a terminated string, followed by the actual string. There may be more than one "TXXX" frame in each tag, but only one with the same description."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"UserDefinedFrame"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>"This frame is intended for URL links concerning the audiofile in a similar way to the other "W"-frames. The frame body consists of a description of the string, represented as a terminated string, followed by the actual URL. The URL is always encoded with ISO-8859-1. There may be more than one "WXXX" frame in each tag, but only one with the same description."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"UserDefinedURLFrame"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>"TALB
    /// The 'Album/Movie/Show title' frame is intended for the title of the recording(/source of sound) which the audio in the file is taken from."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"albumTitle"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"A picture attached to an audio file. The DataObject refered to by this property is usually interpreted as an nfo:Image Inspired by the attached picture tag defined in http://www.id3.org/id3v2.3.0 sec. 4.15)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"attachedPicture"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TSIZ
    /// The 'Size' frame contains the size of the audiofile in bytes, excluding the ID3v2 tag, represented as a numeric string."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"audiofileSize"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TPE2
    /// The 'Band/Orchestra/Accompaniment' frame is used for additional information about the performers in the recording."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"backgroundArtist"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TBPM
    /// The 'BPM' frame contains the number of beats per minute in the mainpart of the audio. The BPM is an integer and represented as a numerical string."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"beatsPerMinute"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"WCOM
    /// The 'Commercial information' frame is a URL pointing at a webpage with information such as where the album can be bought. There may be more than one "WCOM" frame in a tag, but not with the same content."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"commercialInformationURL"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// Note that in the RDF representation each composer is represented with a separate triple."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TPE3
    /// The 'Conductor' frame is used for the name of the conductor."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TIT1
    /// The 'Content group description' frame is used if the sound belongs to a larger category of sounds/music. For example, classical music is often sorted in different musical sections (e.g. "Piano Concerto", "Weather - Hurricane")."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"contentGroupDescription"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// RX    Remix
    /// CR    Cover"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"WCOP
    /// The 'Copyright/Legal information' frame is a URL pointing at a webpage where the terms of use and ownership of the file is described."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"copyrightInformationURL"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TCOP
    /// The 'Copyright message' frame, which must begin with a year and a space character (making five characters), is intended for the copyright holder of the original sound, not the audio file itself. The absence of this frame means only that the copyright information is unavailable or has been removed, and must not be interpreted to mean that the sound is public domain. Every time this field is displayed the field must be preceded with "Copyright"."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"copyrightMessage"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TDAT
    /// The 'Date' frame is a numeric string in the DDMM format containing the date for the recording. This field is always four characters long."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// Note that the RDF representation doesn't allow the copyright message in this field. Please move it to the copyrightMessage field."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TSSE
    /// The 'Software/Hardware and settings used for encoding' frame includes the used audio encoder and its settings when the file was encoded. Hardware refers to hardware encoders, not the computer on which a program was run."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"encodingSettings"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TOWN
    /// The 'File owner/licensee' frame contains the name of the owner or licensee of the file and it's contents."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// PCM Pulse Code Modulated audio;"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"fileType"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// 4.16)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"generalEncapsulatedObject"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Links the ID3Audio with an instance of SynchronizedText"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"hasSynchronizedText"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Links the synchronized text object with the text elements."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"hasSynchronizedTextElement"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TKEY
    /// The 'Initial key' frame contains the musical key in which the sound starts. It is represented as a string with a maximum length of three characters. The ground keys are represented with "A","B","C","D","E", "F" and "G" and halfkeys represented with "b" and "#". Minor is represented as "m". Example "Cbm". Off key is represented with an "o" only."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"initialKey"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TSRC
    /// The 'ISRC' frame should contain the International Standard Recording Code (ISRC) (12 characters)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"internationalStandardRecordingCode"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TRSN
    /// The 'Internet radio station name' frame contains the name of the internet radio station from which the audio is streamed."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"internetRadioStationName"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TRSO
    /// The 'Internet radio station owner' frame contains the name of the owner of the internet radio station from which the audio is streamed."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"internetRadioStationOwner"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TPE4
    /// The 'Interpreted, remixed, or otherwise modified by' frame contains more information about the people behind a remix and similar interpretations of another existing piece."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"interpretedBy"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Links an ID3 file to an InvolvedPerson, an equivalent of the involvedPeopleList tag. Since there might be a lot of people contributing to an audio file in various ways, such as musicians and technicians, the 'Text information frames' are often insufficient to list everyone involved in a project. The 'Involved people list' is a frame containing the names of those involved, and how they were involved. The body simply contains a terminated string with the involvement directly followed by a terminated string with the involvee followed by a new involvement and so on. There may only be one "IPLS" frame in each tag."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"involvedPerson"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://www.semanticdesktop.org/ontologies/2007/05/10/nid3#involvedPerson">http://www.semanticdesktop.org/ontologies/2007/05/10/nid3#involvedPerson</seealso>
    let involvedPerson = Prefixed_Name(nid3, "involvedPerson") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"An actual contact to the involved person."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"involvedPersonContact"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"How was this particular person involved in this particular track."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"involvment"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TPE1
    /// The 'Lead artist(s)/Lead performer(s)/Soloist(s)/Performing group' is used for the main artist(s). They are seperated with the "/" character."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"leadArtist"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TLEN
    /// The 'Length' frame contains the length of the audiofile in milliseconds, represented as a numeric string."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// See http://www.id3.org/id3v2.3.0 for details."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"mediaType"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"This frame is intended for music that comes from a CD, so that the CD can be identified in databases such as the CDDB. The frame consists of a binary dump of the Table Of Contents, TOC, from the CD, which is a header of 4 bytes and then 8 bytes/track on the CD plus 8 bytes for the 'lead out' making a maximum of 804 bytes. The offset to the beginning of every track on the CD should be described with a four bytes absolute CD-frame address per track, and not with absolute time. This frame requires a present and valid "TRCK" frame, even if the CD's only got one track. There may only be one "MCDI" frame in each tag."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"musicCDIdentifier"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"officialArtistWebpage"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"WOAS
    /// The 'Official audio source webpage' frame is a URL pointing at the official webpage for the source of the audio file, e.g. a movie."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"officialAudioSourceWebpage"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"WOAF
    /// The 'Official audio file webpage' frame is a URL pointing at a file specific webpage."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"officialFileWebpage"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"WORS
    /// The 'Official internet radio station homepage' contains a URL pointing at the homepage of the internet radio station."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"officialInternetRadioStationHomepage"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TOAL
    /// The 'Original album/movie/show title' frame is intended for the title of the original recording (or source of sound), if for example the music in the file should be a cover of a previously released song."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"originalAlbumTitle"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// Note that in the RDF repressentation each orignal artist is represented with a separate triple."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"originalArtist"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TOFN
    /// The 'Original filename' frame contains the preferred filename for the file, since some media doesn't allow the desired length of the filename. The filename is case sensitive and includes its suffix."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"originalFilename"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TORY
    /// The 'Original release year' frame is intended for the year when the original recording, if for example the music in the file should be a cover of a previously released song, was released. The field is formatted as in the "TYER" frame."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"originalReleaseYear"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// Note that in the RDF representation each original lyricist is represented with a separate triple."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"originalTextWriter"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"WPAY
    /// The 'Payment' frame is a URL pointing at a webpage that will handle the process of paying for this file."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"paymentURL"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TPUB
    /// The 'Publisher' frame simply contains the name of the label or publisher."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"WPUB
    /// The 'Publishers official webpage' frame is a URL pointing at the official wepage for the publisher."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"publishersWebpage"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TRDA
    /// The 'Recording dates' frame is a intended to be used as complement to the "TYER", "TDAT" and "TIME" frames. E.g. "4th-7th June, 12th June" in combination with the "TYER" frame."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"recordingDate"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TYER
    /// The 'Year' frame is a numeric string with a year of the recording. This frames is always four characters long (until the year 10000)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"recordingYear"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TIT3
    /// The 'Subtitle/Description refinement' frame is used for information directly related to the contents title (e.g. "Op. 16" or "Performed live at Wembley")."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Synchronized text content descriptor. Inspired by the content descriptor part of the SYLT frame defined in ID3 2.3.0 spec sec. 4.10"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"synchronizedTextContentDescriptor"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// $06     is trivia/'pop up' information"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"textContentType"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"textElementContent"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"The 'time stamp' is set to zero or the whole sync is omitted if located directly at the beginning of the sound. All time stamps should be sorted in chronological order. The sync can be considered as a validator of the subsequent string."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"textElementTimestamp"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// Note that in the RDF representation each text writer is represented with a separate triple."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"textWriter"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TIME
    /// The 'Time' frame is a numeric string in the HHMM format containing the time for the recording. This field is always four characters long."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// $02 Absolute time, 32 bit sized, using milliseconds as unit"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"timestampFormat"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TIT2
    /// The 'Title/Songname/Content description' frame is the actual name of the piece (e.g. "Adagio", "Hurricane Donna"). Deprecated in favor of the more generic nie:title."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"TRCK
    /// The 'Track number/Position in set' frame is a numeric string containing the order number of the audio-file on its original recording. This may be extended with a "/" character and a numeric string containing the total numer of tracks/elements on the original recording. E.g. "4/9"."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"trackNumber"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Unsynchronized text content. Inspired by the content part of the USLT frame defined in the ID3 2.3.0 Spec sec. 4.9"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"unsynchronizedTextContent"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"The content descriptor of the unsynchronized text. Inspired by the Content Descriptor field of the USLT frame, defined in ID3 2.3.0 Spec sec. 4.9"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"unsynchronizedTextContentDescriptor"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Links the ID3 file to a user-defined frame."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"userDefinedFrame"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://www.semanticdesktop.org/ontologies/2007/05/10/nid3#userDefinedFrame">http://www.semanticdesktop.org/ontologies/2007/05/10/nid3#userDefinedFrame</seealso>
    let userDefinedFrame = Prefixed_Name(nid3, "userDefinedFrame") |> PrefixedName
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Description of a user-defined frame."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"userDefinedFrameDescription"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Value of a user-defined frame."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"userDefinedFrameValue"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
