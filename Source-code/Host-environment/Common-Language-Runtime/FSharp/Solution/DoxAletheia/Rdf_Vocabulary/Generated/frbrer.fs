...
module frbrer =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>ExpresiÃ³n</para><para>Expression</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>es suplemento (expresiÃ³n) de (expresiÃ³n)</para><para>supplements (expression) (from expression)</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene estado del ejemplar</para><para>has condition of the item</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>es ejemplar de</para><para>is exemplar of</para></remarks>
