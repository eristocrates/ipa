...
module frbrer =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Obra"</para><para>"Work"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Manifestation"</para><para>"ManifestaciÃ³n"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Item"</para><para>"Ejemplar"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Object"</para><para>"Objeto"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Place"</para><para>"Lugar"</para></remarks>
    ...
    /// <summary>
    ///   <para>frbrer:Expression</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"The intellectual or artistic realization of a work in the form of alpha-numeric, musical, or choreographic notation, sound, image, object, movement, etc., or any combination of such forms."</para>
    /// labels<para>"Expression"</para></remarks>
    /// <seealso href="http://iflastandards.info/ns/fr/frbr/frbrer/Expression">http://iflastandards.info/ns/fr/frbr/frbrer/Expression</seealso>
    let Expression = Prefixed_Name(frbrer, "Expression") |> PrefixedName
    /// <summary>
    ...
    ///
    /// labels<para>"is realized through"</para><para>"estÃ¡ realizado mediante"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is embodiment of"</para><para>"es materializaciÃ³n de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is exemplified by"</para><para>"estÃ¡ ejemplificado por"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is creator (corporate body) of"</para><para>"es creador (entidad corporativa) de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is realized by (corporate body)"</para><para>"estÃ¡ realizado por (entidad corporativa)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is realizer (person) of"</para><para>"es realizador (persona) de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is produced by (corporate body)"</para><para>"es producido por (entidad corporativa)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is producer (corporate body) of"</para><para>"es productor (entidad corporativa) de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is produced by (person)"</para><para>"es producido por (persona)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is owned by (corporate body)"</para><para>"es propiedad de (entidad corporativa)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is owner (corporate body) of"</para><para>"es propietario (entidad corporativa) de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is owned by (person)"</para><para>"es propiedad de (persona)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is owner (person) of"</para><para>"es propietario (persona) de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has as subject (concept)"</para><para>"tiene como materia (concepto)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is subject (concept) of"</para><para>"es materia (concepto) de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has as subject (object)"</para><para>"tiene como materia (objeto)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is subject (object) of"</para><para>"es materia (objeto) de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has as subject (place)"</para><para>"tiene como materia (lugar)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"es materia (lugar) de"</para><para>"is subject (place) of"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has as subject (corporate body)"</para><para>"tiene como materia (entidad corporativa)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has as subject (person)"</para><para>"tiene como materia (persona)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"es materia (obra) de"</para><para>"is subject (work) of"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has as subject (expression)"</para><para>"tiene como materia (expresiÃ³n)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"es materia (expresiÃ³n) de"</para><para>"is subject (expression) of"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is subject (manifestation) of"</para><para>"es materia (manifestaciÃ³n) de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has as subject (item)"</para><para>"tiene como materia (ejemplar)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is subject (item) of"</para><para>"es materia (ejemplar) de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"continuado por (obra) (de obra)"</para><para>"has a successor (work) (from work)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"supplements (work) (from work)"</para><para>"es suplemento (obra) de (obra)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"complements (work) (from work)"</para><para>"es complemento (obra) (de obra)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"tiene resumen (obra) (de obra)"</para><para>"has a summary (work) (from work)"</para></remarks>
    ...
    /// labels<para>"tiene adaptaciÃ³n (obra) (de obra)"</para><para>"has an adaptation (work) (from work)"</para></remarks>
    ...
    /// labels<para>"tiene transformaciÃ³n (obra) (de obra)"</para><para>"has a transformation (work) (from work)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"Source documentation has "literary genre", but other genres allowed."</para>
    /// labels<para>"es transformaciÃ³n (obra) de (obra)"</para><para>"is a transformation (work) of (work)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"es imitaciÃ³n (obra) de (obra)"</para><para>"is an imitation (work) of (work)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"es compendio (expresiÃ³n) de"</para><para>"is an abridgement (expression) of"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"es revisiÃ³n (expresiÃ³n) de"</para><para>"is a revision (expression) of"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"continuado por (expresiÃ³n) (de expresiÃ³n)"</para><para>"has a successor (expression) (from expression)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is a successor (expression) to (expression)"</para><para>"es continuaciÃ³n (expresiÃ³n) de (expresiÃ³n)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"tiene adaptaciÃ³n (expresiÃ³n) (de expresiÃ³n)"</para><para>"has an adaptation (expression) (from expression)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"Source documentation has "literary genre", but other genres allowed."</para>
    /// labels<para>"tiene transformaciÃ³n (expresiÃ³n) (de expresiÃ³n)"</para><para>"has a transformation (expression) (from expression)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has part (expression)"</para><para>"tiene como parte (expresiÃ³n)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is part (expression) of"</para><para>"forma parte (expresiÃ³n) de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has a reproduction (manifestation) (from manifestation)"</para><para>"tiene reproducciÃ³n (manifestaciÃ³n) (de manifestaciÃ³n)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has an alternate"</para><para>"tiene (manifestaciÃ³n) alterna"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has part (manifestation)"</para><para>"tiene como parte (manifestaciÃ³n)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is part (manifestation) of"</para><para>"forma parte (manifestaciÃ³n) de"</para></remarks>
    ...
    /// labels<para>"has a reconfiguration"</para><para>"tiene reconfiguraciÃ³n"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"es reconfiguraciÃ³n de"</para><para>"is a reconfiguration of"</para></remarks>
    ...
    /// labels<para>"has a reproduction (item) (from item)"</para><para>"tiene reproducciÃ³n (ejemplar) (de ejemplar)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is a reproduction (item) of (item)"</para><para>"es reproducciÃ³n (ejemplar) de (ejemplar)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has part (item)"</para><para>"tiene como parte (ejemplar)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is part (item) of"</para><para>"forma parte (ejemplar) de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has a reproduction (manifestation) (from item)"</para><para>"tiene reproducciÃ³n (manifestaciÃ³n) (de ejemplar)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is a reproduction (manifestation) of (item)"</para><para>"es reproducciÃ³n (manifestaciÃ³n) de (ejemplar)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"continuado por (obra) (de expresiÃ³n)"</para><para>"has a successor (work) (from expression)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"tiene suplemento (obra) (de expresiÃ³n)"</para><para>"has a supplement (work) (from expression)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"es suplemento (expresiÃ³n) de (obra)"</para><para>"supplements (expression) (from work)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"tiene complemento (obra) (de expresiÃ³n)"</para><para>"has a complement (work) (from expression)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"complements (work) (from expression)"</para><para>"es complemento (obra) de (expresiÃ³n)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"tiene imitaciÃ³n (obra) (de expresiÃ³n)"</para><para>"has an imitation (work) (from expression)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"es imitaciÃ³n (obra) de (expresiÃ³n)"</para><para>"is an imitation (work) of (expression)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"tiene suplemento (expresiÃ³n) (de expresiÃ³n) "</para><para>"has a supplement (expression) (from expression)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has title of the work"</para><para>"tiene tÃ­tulo de la obra"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has form of work"</para><para>"tiene forma de la obra"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has intended audience"</para><para>"tiene tipo de audencia"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has title of the expression"</para><para>"tiene tÃ­tulo de la expresiÃ³n"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has form of expression"</para><para>"tiene forma de la expresiÃ³n"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has language of expression"</para><para>"tiene lengua de la expresiÃ³n"</para></remarks>
    ...
    /// labels<para>"has other distinguishing characteristic of expression"</para><para>"tiene otras caracterÃ­sticas distintivas de expresiÃ³n"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has extensibility of expression"</para><para>"tiene extensibilidad de la expresiÃ³n"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has extent of the expression"</para><para>"tiene extensiÃ³n de la expresiÃ³n"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"tiene resumen del contenido"</para><para>"has summarization of content"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has context for the expression"</para><para>"tiene contexto de la expresiÃ³n"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has critical response to the expression"</para><para>"tiene respuesta crÃ­tica a la expresiÃ³n"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has statement of responsibility"</para><para>"tiene menciÃ³n de responsabilidad"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has form of carrier"</para><para>"tiene forma del soporte"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has physical medium"</para><para>"tiene soporte fÃ­sico"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has dimensions of the carrier"</para><para>"tiene dimensiones del soporte"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has item identifier"</para><para>"tiene identificador del ejemplar"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has fingerprint"</para><para>"tiene huella tipogrÃ¡fica"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has provenance of the item"</para><para>"tiene procedencia del ejemplar"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has scheduled treatment"</para><para>"tiene tratamiento programado"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has access restrictions on the item"</para><para>"tiene restricciones de acceso al ejemplar"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has name of person"</para><para>"tiene nombre de persona"</para></remarks>
    ...
    /// labels<para>"has dates of person"</para><para>"tiene fechas de persona"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has other designation associated with the person"</para><para>"tiene otras designaciones asociadas con la persona"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has term for the event"</para><para>"tiene tÃ©rmino del acontecimiento"</para></remarks>
    ...
    /// labels<para>"has date of publication or distribution"</para><para>"tiene fecha de publicaciÃ³n o distribuciÃ³n"</para></remarks>
    ...
    /// labels<para>"tiene editor o distribuidor"</para><para>"has publisher or distributor"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has numeric designation (musical work)"</para><para>"tiene designaciÃ³n numÃ©rica (obra musical)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has coordinates (cartographic work)"</para><para>"tiene coordenadas (obra cartogrÃ¡fica)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has equinox (cartographic work)"</para><para>"tiene equinoccio (obra cartogrÃ¡fica)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has expected frequency of issue (serial)"</para><para>"tiene frecuencia de publicaciÃ³n prevista (publicaciÃ³n seriada)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has type of score (musical notation)"</para><para>"tiene tipo de partitura (notaciÃ³n musical)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has medium of performance (musical notation or recorded sound)"</para><para>"tiene medio de interpretaciÃ³n (notaciÃ³n musical o registro sonoro)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has recording technique (remote sensing image)"</para><para>"tiene tÃ©cnica de grabaciÃ³n (imagen sensible remota)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has typeface (printed book)"</para><para>"tiene tipografÃ­a (libros impresos)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has groove width"</para><para>"tiene anchura del surco"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has tape configuration (sound recording)"</para><para>"tiene configuraciÃ³n de la cinta (grabaciÃ³n sonora)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has kind of sound (sound recording)"</para><para>"tiene tipo de sonido (grabaciÃ³n sonora)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has special reproduction characteristic (sound recording)"</para><para>"tiene caracterÃ­sticas especiales de la reproducciÃ³n  (grabaciÃ³n sonora)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has colour (image)"</para><para>"tiene color (imagen)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has polarity (microform or visual projection)"</para><para>"tiene polaridad (microforma o proyecciÃ³n visual)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has presentation format (visual projection)"</para><para>"tiene formato de presentaciÃ³n (proyecciÃ³n visual)"</para></remarks>
    ...
    /// labels<para>"has system requirements (electronic resource)"</para><para>"tiene requisitos del sistema (recurso electrÃ³nico)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has mode of access (remote electronic resource)"</para><para>"tiene modo de acceso (recurso electrÃ³nico de acceso remoto)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has access address (remote electronic resource)"</para><para>"tiene direcciÃ³n de acceso (recurso electrÃ³nico de acceso remoto)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has scale (cartographic image or object)"</para><para>"tiene escala (imagen cartogrÃ¡fica u objeto)"</para></remarks>
    ...
    /// labels<para>"has geodetic, grid and vertical measurement (cartographic image or object)"</para><para>"tiene geodÃ©sic, cuadrÃ­cula y medida vertical (imagen cartogrÃ¡fica u objeto)"</para></remarks>
    ...
    /// <summary>
    ///   <para>frbrer:Work</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A distinct intellectual or artistic creation."</para>
    /// labels<para>"Work"</para></remarks>
    /// <seealso href="http://iflastandards.info/ns/fr/frbr/frbrer/Work">http://iflastandards.info/ns/fr/frbr/frbrer/Work</seealso>
    let Work = Prefixed_Name(frbrer, "Work") |> PrefixedName
