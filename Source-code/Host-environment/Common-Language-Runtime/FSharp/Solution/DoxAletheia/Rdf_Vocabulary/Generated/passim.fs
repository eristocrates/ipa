...
module passim =
    ...
    ///   <para>This class represents the coverage of a service of transport.</para>
    ...
    ///   <para>The property "centerTown" represents the main town of the transport.</para>
    /// labels<para>centerTown</para></remarks>
    ...
    ///   <para>The property "SMSInformation" represents the SMS service of the transport.</para>
    /// labels<para>SMSInformation</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>This class represents the differents modes of transport.</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>This class represents an information service of transport.</para>
    /// labels<para>TransportServiceInformation</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The property "cityThrough" represents a city through by the transport. This property will be instanciate as many times as there is city through by the transport.</para>
    /// labels<para>cityThrough</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The property "department" represents the department of the transport.</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>The property "isAccessibilityForDisabledPerson" represents if the transport is for the disabled person or not.</para>
    /// labels<para>isAccessibilityForDisabledPerson</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The property "isWebSiteAccessibilityForDisabledPerson" represents if the website of the transport is for the disabled person or not.</para>
    /// labels<para>isWebSiteAccessibilityForDisabledPerson</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>This class represents the services of transport.</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>The property "comment" represents the comments about the transport.</para>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>The property "infoPoint" represents the point of information.</para>
    /// labels<para>infoPoint</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>The property "mobileApplication" represents the mobile application of the transport.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The property "modeOfTransport" represents a mode of transport. This property will be instanciate as many times as there is mode of transport.</para>
    /// labels<para>modeOfTransport</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The property "region" represents the region of the transport.</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The property "landInformation" represents the informations about the land through by the transport.</para>
    /// labels<para>landInformation</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The property "postalCode" represents the the postal code of the main town of the transport.</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The property "remark" represents the remarks about the transport.</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The property "serviceCoverage" represents the coverage of the transport.</para>
    /// labels<para>serviceCoverage</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The property "serviceName" represents the name of the service.</para>
    /// labels<para>serviceName</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>The property "typeOfService" represents a type of service.</para>
    /// labels<para>typeOfService</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>The property "webSite" represents the Web site of the transport.</para>
