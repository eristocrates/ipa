...
module cidoc =
    ...
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/">http://www.cidoc-crm.org/cidoc-crm/</seealso>
    let _prefix_iri = Prefixed_Name(cidoc, "") |> PrefixedName
    ...
    /// "</para>
    /// labels<para>"Changement de détenteur"</para><para>"Μεταβίβαση  Κατοχής"</para><para>"Transfer of Custody"</para><para>"Передача Опеки"</para><para>"Übertragung des Gewahrsams"</para><para>"Transferência de Custódia"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Modification"</para><para>"Событие Изменения"</para><para>"Τροποποίηση"</para><para>"Bearbeitung"</para><para>"Modificação"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Herstellung"</para><para>"Production"</para><para>"Событие Производства"</para><para>"Παραγωγή"</para><para>"Produção"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Attribute Assignment"</para><para>"Merkmalszuweisung"</para><para>"Affectation d'attribut"</para><para>"Atribuição de Característica"</para><para>"Присвоение Атрибута"</para><para>"Απόδοση Ιδιοτήτων"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Оценка Состояния"</para><para>"Zustandsfeststellung"</para><para>"Expertise de l'état matériel"</para><para>"Avaliação do Estado Material"</para><para>"Εκτίμηση Κατάστασης"</para><para>"Condition Assessment"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Identifier Assignment"</para><para>"Kennzeichenzuweisung"</para><para>"Назначение Идентификатора"</para><para>"Απόδοση Αναγνωριστικού"</para><para>"Attribution d’identificateur"</para><para>"Atribuição de Identificador"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Messung"</para><para>"Mesurage"</para><para>"Medição"</para><para>"Measurement"</para><para>"Событие Измерения"</para><para>"Μέτρηση"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Type Assignment"</para><para>"Attribution de type"</para><para>"Typuszuweisung"</para><para>"Απόδοση Τύπου"</para><para>"Присвоение Типа"</para><para>"Atribuição de Tipo"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Coisa Material"</para><para>"Materielles"</para><para>"Υλικό Πράγμα"</para><para>"Физическая Вещь"</para><para>"Chose matérielle"</para><para>"Physical Thing"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Physical Object"</para><para>"Materieller Gegenstand"</para><para>"Υλικό Αντικείμενο"</para><para>"Objeto Material"</para><para>"Физический Объект"</para><para>"Objet matériel"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Οντότητα CIDOC CRM"</para><para>"Entité CRM"</para><para>"CRM Entität"</para><para>"CRM Entity"</para><para>"Entidade CRM"</para><para>"CRM Сущность"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Biologischer Gegenstand"</para><para>"Βιολογικό Ακτικείμενο"</para><para>"Objet biologique"</para><para>"Objeto Biológico"</para><para>"Биологический Объект"</para><para>"Biological Object"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Personne"</para><para>"Person"</para><para>"Личность"</para><para>"Pessoa"</para><para>"Πρόσωπο"</para></remarks>
    ...
    /// <summary>
    ///   <para>cidoc:E22_Human-Made_Object</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/E22_Human-Made_Object">http://www.cidoc-crm.org/cidoc-crm/E22_Human-Made_Object</seealso>
    let E22_Human_Made_Object =
        Prefixed_Name(cidoc, "E22_Human-Made_Object") |> PrefixedName
    ...
    /// "</para>
    /// labels<para>"Ανθρωπογενές Αντικείμενο"</para><para>"Рукотворный Объект"</para><para>"Man-Made Object"</para><para>"Objeto Fabricado"</para><para>"Objet fabriqué"</para><para>"Künstlicher Gegenstand"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Coisa Material Fabricada"</para><para>"Физическая Рукотворная Вещь"</para><para>"Hergestelltes"</para><para>"Physical Man-Made Thing"</para><para>"Chose matérielle fabriquée"</para><para>"Ανθρωπογενές Υλικό Πράγμα"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Искусственный Признак"</para><para>"Característica Fabricada"</para><para>"Ανθρωπογενές Μόρφωμα"</para><para>"Caractéristique fabriquée"</para><para>"Man-Made Feature"</para><para>"Hergestelltes Merkmal"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Физический Признак"</para><para>"Materielles Merkmal"</para><para>"Physical Feature"</para><para>"Caractéristique matérielle"</para><para>"Υλικό Μόρφωμα"</para><para>"Característica Material"</para></remarks>
    ...
    /// labels<para>"Site"</para><para>"Gelände"</para><para>"Lugar"</para><para>"Участок"</para><para>"Φυσικός Χώρος"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Концептуальный Объект"</para><para>"Begrifflicher Gegenstand"</para><para>"Objeto Conceitual"</para><para>"Νοητικό Αντικείμενο"</para><para>"Objet conceptuel"</para><para>"Conceptual Object"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Entwurf oder Verfahren"</para><para>"Σχέδιο"</para><para>"Conception ou procédure"</para><para>"Design or Procedure"</para><para>"Проект или Процедура"</para><para>"Projeto ou Procedimento"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Temporal Entity"</para><para>"Entidade Temporal"</para><para>"Έγχρονη  Οντότητα"</para><para>"Entité temporelle"</para><para>"Временная Сущность"</para><para>"Geschehendes"</para></remarks>
    ...
    /// labels<para>"Right"</para><para>"Δικαίωμα"</para><para>"Droit"</para><para>"Direitos"</para><para>"Recht"</para><para>"Право"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Документ"</para><para>"Document"</para><para>"Documento"</para><para>"Τεκμήριο"</para><para>"Dokument"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Authority Document"</para><para>"Document de référence"</para><para>"Πηγή Καθιερωμένων Όρων"</para><para>"Documento de Referência"</para><para>"Официальный Документ"</para><para>"Referenzdokument"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Objeto Lingüístico"</para><para>"Sprachlicher Gegenstand"</para><para>"Γλωσσικό Αντικείμενο"</para><para>"Линвистический Объект"</para><para>"Objet linguistique"</para><para>"Linguistic Object"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Надпись"</para><para>"Inscription"</para><para>"Inschrift"</para><para>"Inscrição"</para><para>"Επιγραφή"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Título"</para><para>"Titre"</para><para>"Title"</para><para>" Τίτλος"</para><para>"Заголовок"</para><para>"Titel"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Οπτικό Στοιχείο"</para><para>"Visual Item"</para><para>"Item visuel"</para><para>"Item Visual"</para><para>"Визуальный Предмет"</para><para>"Bildliches"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Пометка"</para><para>"Mark"</para><para>"Marke"</para><para>"Marque"</para><para>"Σήμανση"</para><para>"Marca"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Image"</para><para>"Εικόνα"</para><para>"Изображение"</para><para>"Imagem"</para><para>"Bild"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"This class comprises people, either individually or in groups, who have the potential to perform intentional actions of kinds for which someone may be held responsible."</para>
    ...
    /// "</para>
    /// labels<para>"å‚ä¸Žè€…"</para><para>"Agent"</para><para>"ÐÐ³ÐµÐ½Ñ‚"</para><para>"Агент"</para><para>"Î”ÏÎ¬ÏƒÏ„Î·Ï‚"</para><para>"Akteur"</para><para>"Actor"</para><para>"Agente"</para><para>"Δράστης"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Estado Material"</para><para>"État matériel"</para><para>"Condition State"</para><para>"Κατάσταση"</para><para>"Zustandsphase"</para><para>"Состояние"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Juristische Person"</para><para>"Pessoa Jurídica"</para><para>"Юридическое Лицо"</para><para>"Νομικό Πρόσωπο"</para><para>"Legal Body"</para><para>"Collectivité"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Appellation"</para><para>"Обозначение"</para><para>"Ονομασία"</para><para>"Designação"</para><para>"Benennung"</para></remarks>
    ...
    /// labels<para>"Identificateur d'objet"</para><para>"Identificador de Objeto"</para><para>"Kennung"</para><para>"Κωδικός Αναγνώρισης"</para><para>"Идентификатор Объекта"</para><para>"Identifier"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Appellation de lieu"</para><para>"Place Appellation"</para><para>"Обозначение Места"</para><para>"Ortsbenennung"</para><para>"Ονομασία Τόπου"</para><para>"Designação de Local"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Διεύθυνση"</para><para>"Address"</para><para>"Adresse"</para><para>"Адрес"</para><para>"Endereço"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Designação de Seção"</para><para>"Определение Района"</para><para>"Désignation de section"</para><para>"Abschnittsdefinition"</para><para>"Ονομασία Τμήματος"</para><para>"Section Definition"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Пространственные Координаты"</para><para>"Coordonnées spatiales"</para><para>"Χωρικές Συντεταγμένες"</para><para>"Raumkoordinaten"</para><para>"Coordenadas Espaciais"</para><para>"Spatial Coordinates"</para></remarks>
    ...
    /// labels<para>"Place Name"</para><para>"Τοπωνύμιο"</para><para>"Название Места"</para><para>"Toponyme"</para><para>"Orts- oder Flurname"</para><para>"Nome de Local"</para></remarks>
    ...
    /// labels<para>"Appellation temporelle"</para><para>"Обозначение Времени"</para><para>"Time Appellation"</para><para>"Designação de Tempo"</para><para>"Ονομασία Χρόνου"</para><para>"Zeitbenennung"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Περίοδος"</para><para>"Period"</para><para>"Période"</para><para>"Phase"</para><para>"Период"</para><para>"Período"</para></remarks>
    ...
    /// labels<para>"Date"</para><para>"Дата"</para><para>"Ημερομηνία"</para><para>"Data"</para><para>"Datum"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Στοιχείο Επικοινωνίας"</para><para>"Kontaktpunkt"</para><para>"Contact Point"</para><para>"Контакт"</para><para>"Coordonnées individuelles"</para><para>"Ponto de Contato"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Интервал Времени"</para><para>"Χρονικό Διάστημα"</para><para>"Durée"</para><para>"Time-Span"</para><para>"Zeitspanne"</para><para>"Período de Tempo"</para></remarks>
    ...
    /// labels<para>"Место"</para><para>"Τόπος"</para><para>"Lieu"</para><para>"Place"</para><para>"Ort"</para><para>"Local"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Dimensions"</para><para>"Величина"</para><para>"Dimension"</para><para>"Dimensão"</para><para>"Μέγεθος"</para><para>"Maß"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Τύπος"</para><para>"Tipo"</para><para>"Тип"</para><para>"Type"</para><para>"Typus"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Язык"</para><para>"Language"</para><para>"Γλώσσα"</para><para>"Langue"</para><para>"Sprache"</para><para>"Língua"</para></remarks>
    ...
    /// labels<para>"Material"</para><para>"Υλικό"</para><para>"Материал"</para><para>"Matériau"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Maßeinheit"</para><para>"Unidade de Medida"</para><para>"Единица Измерения"</para><para>"Measurement Unit"</para><para>"Unité de mesure"</para><para>"Μονάδα Μέτρησης"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Evento"</para><para>"Ereignis"</para><para>"Событие"</para><para>"Event"</para><para>"Συμβάν"</para><para>"Événement"</para></remarks>
    ...
    /// labels<para>"Начало Существования"</para><para>"Beginning of Existence"</para><para>"Début d'existence"</para><para>"Daseinsbeginn"</para><para>"Início da Existência"</para><para>"Αρχή Ύπαρξης"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Τέλος Ύπαρξης"</para><para>"Fim da Existência"</para><para>"Daseinsende"</para><para>"Конец Существования"</para><para>"Fin d'existence"</para><para>"End of Existence"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Création"</para><para>"Событие Творения"</para><para>"Begriffliche Schöpfung"</para><para>"Creation"</para><para>"Δημιουργία"</para><para>"Criação"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Συγκρότηση Ομάδας"</para><para>"Formação"</para><para>"Gruppenbildung"</para><para>"Formation"</para><para>"Событие Формирования"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Γέννηση"</para><para>"Geburt"</para><para>"Nascimento"</para><para>"Naissance"</para><para>"Рождение"</para><para>"Birth"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Dissolução"</para><para>"Роспуск"</para><para>"Dissolution"</para><para>"Gruppenauflösung"</para><para>"Διάλυση Ομάδας"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Death"</para><para>"Mort"</para><para>"Tod"</para><para>"Morte"</para><para>"Θάνατος"</para><para>"Смерть"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Καταστροφή"</para><para>"Destruction"</para><para>"Разрушение"</para><para>"Zerstörung"</para><para>"Destruição"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Πράγμα"</para><para>"Chose"</para><para>""</para><para>"Coisa"</para><para>"Thing"</para><para>"Sache"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Künstliches"</para><para>"Ανθρώπινο Δημιούργημα"</para><para>"Coisa Fabricada"</para><para>"Chose fabriquée"</para><para>"Man-Made Thing"</para><para>"Рукотворная Вещь"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Νομικό Αντικείμενο"</para><para>"Objet juridique"</para><para>"Legal Object"</para><para>"Rechtsobjekt"</para><para>"Objeto Jurídico"</para><para>"Объект Права"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Information Object"</para><para>"Informationsgegenstand"</para><para>"Πληροφοριακό Αντικείμενο"</para><para>"Objeto de Informação"</para><para>"Информационный Объект"</para><para>"Objet d'information"</para></remarks>
    ...
    /// A gathering of people becomes an instance of E74 Group when it exhibits organizational characteristics usually typified by a set of ideas or beliefs held in common, or actions performed together. These might be communication, creating some common artifact, a common purpose such as study, worship, business, sports, etc. Nationality can be modelled as membership in an instance of E74 Group. Married couples and other concepts of family are regarded as particular examples of E74 Group."</para>
    /// labels<para>"Ð“Ñ€ÑƒÐ¿Ð¿Ð°"</para><para>"Grupo"</para><para>"å›¢ä½“"</para><para>"Menschliche Gruppe"</para><para>"Group"</para><para>"Группа"</para><para>"Ομάδα"</para><para>"ÎŸÎ¼Î¬Î´Î±"</para><para>"Groupe"</para></remarks>
    ...
    /// labels<para>"Ονομασία Νοητικού Αντικειμένου"</para><para>"Designação de Objeto Conceitual"</para><para>"Conceptual Object Appellation"</para><para>"Обозначение Концептуального Объекта"</para><para>"Begriff- oder Konzeptbenennung "</para><para>"Appellation d'objet conceptuel"</para></remarks>
    ...
    /// labels<para>"Persistent Item"</para><para>"Постоянная Сущность"</para><para>"Ον"</para><para>"Seiendes"</para><para>"Entidade Persistente"</para><para>"Entité persistante"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Coleção"</para><para>"Коллекция"</para><para>"Collection"</para><para>"Συλλογή"</para><para>"Sammlung"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Adição de Parte"</para><para>"Προσθήκη Μερών"</para><para>"Addition d'élément"</para><para>"Teilhinzufügung"</para><para>"Part Addition"</para><para>"Добавление Части"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Activity"</para><para>"Деятельность"</para><para>"Δράση"</para><para>"Handlung"</para><para>"Atividade"</para><para>"Activité"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Soustraction d'élément"</para><para>"Αφαίρεση Μερών"</para><para>"Удаление Части"</para><para>"Teilentfernung"</para><para>"Remoção de Parte"</para><para>"Part Removal"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Umwandlung"</para><para>"Transformation"</para><para>"Μετατροπή"</para><para>"Transformação"</para><para>"Трансформация"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Akteurbenennung"</para><para>"Ονομασία Δράστη"</para><para>"Обозначение Агента"</para><para>"Actor Appellation"</para><para>"Designação de Agente"</para><para>"Appellation d'agent"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Création de type"</para><para>"Typuserfindung"</para><para>"Type Creation"</para><para>"Δημιουργία Τύπου"</para><para>"Criação de Tipo"</para><para>"Создание Типа"</para></remarks>
    ...
    /// labels<para>"Informationsträger"</para><para>"Носитель Информации"</para><para>"Information Carrier"</para><para>"Support d'information"</para><para>"Suporte de Informação"</para><para>"Φορέας Πληροφορίας"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Joining"</para><para>"Beitritt"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Aussagenobjekt"</para><para>"Propositional Object"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Aquisição"</para><para>"Acquisition"</para><para>"Событие Приобретения"</para><para>"Erwerb"</para><para>"Απόκτηση"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Symbolic Object"</para><para>"Symbolisches Objekt"</para></remarks>
    ...
    /// <summary>
    ///   <para>cidoc:E97_Monetary_Amount</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/E97_Monetary_Amount">http://www.cidoc-crm.org/cidoc-crm/E97_Monetary_Amount</seealso>
    let E97_Monetary_Amount =
        Prefixed_Name(cidoc, "E97_Monetary_Amount") |> PrefixedName
    ...
    /// "</para>
    /// labels<para>"Μετακίνηση"</para><para>"Move"</para><para>"Objektbewegung"</para><para>"Перемещение"</para><para>"Déplacement"</para><para>"Locomoção"</para></remarks>
    ...
    /// labels<para>"a été la mort de"</para><para>"foi a morte para "</para><para>"Tod von"</para><para>"was death of"</para><para>"был смертью для"</para><para>"ήταν θάνατος του/της"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"имел основное применение"</para><para>"είχε ως γενική χρήση"</para><para>"hatte die allgemeine Verwendung"</para><para>"tem como uso geral"</para><para>"had as general use"</para><para>"avait comme utilisation générale"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"был применением для"</para><para>"war die Verwendung von"</para><para>"foi uso de"</para><para>"ήταν χρήση του/της"</para><para>"était l’utilisation de"</para><para>"was use of"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"έχει τίτλο"</para><para>"a pour titre"</para><para>"trägt den Titel"</para><para>"tem título"</para><para>"имеет заголовок"</para><para>"has title"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"est le titre de"</para><para>"é título de"</para><para>"является заголовком для"</para><para>"is title of"</para><para>"είναι τίτλος του/της"</para><para>"ist der Titel von"</para></remarks>
    ...
    /// labels<para>"era destinado à"</para><para>"был задуман для"</para><para>"προοριζόταν για"</para><para>"bestimmt für"</para><para>"était destiné à"</para><para>"was intended for"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"ήταν προορισμός του"</para><para>"war Bestimmung von"</para><para>"was intention of"</para><para>"était la raison d'être de"</para><para>"был интенцией для"</para><para>"era a destinação de"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"является объектом для"</para><para>"est sujet à"</para><para>"υπόκειται σε"</para><para>"está sujeito à"</para><para>"is subject to"</para><para>"Gegenstand von"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"s’applique à"</para><para>"ισχύει για"</para><para>"se aplicam à"</para><para>"applies to"</para><para>"применяется к"</para><para>"findet Anwendung auf"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Rechte stehen zu"</para><para>"right held by"</para><para>"право принадлежит"</para><para>"δικαίωμα κατέχεται από"</para><para>"droit détenu par"</para><para>"são direitos de "</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"hat Rechte an"</para><para>"possui direitos sobre"</para><para>"владеет правом на"</para><para>"détient un droit sur"</para><para>"έχει δικαίωμα σε"</para><para>"has right on"</para></remarks>
    ...
    /// "</para>
    /// labels<para>" ist zusammengesetzt aus"</para><para>"est composé de"</para><para>"составлен из"</para><para>"é composto de"</para><para>"αποτελείται από"</para><para>"is composed of"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"αποτελεί μέρος του/της"</para><para>"bildet Teil von"</para><para>"fait partie de"</para><para>"формирует часть"</para><para>"faz parte de"</para><para>"forms part of"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"έχει ή είχε μέλος"</para><para>"имеет действующего или бывшего члена"</para><para>"has current or former member"</para><para>"hat derzeitiges oder früheres Mitglied"</para><para>"tem ou teve membro"</para><para>"a pour membre actuel ou ancien"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"é ou foi membro de"</para><para>"is current or former member of"</para><para>"είναι ή ήταν μέλος του/της"</para><para>"является действующим или бывшим членом"</para><para>"ist derzeitiges oder früheres Mitglied von"</para><para>"est actuel ou ancien membre de"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"παρήγαγε"</para><para>"produziu"</para><para>"hat hergestellt"</para><para>"a produit"</para><para>"произвел"</para><para>"has produced"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"παρήχθη από"</para><para>"foi produzido por"</para><para>"a été produit par"</para><para>"was produced by"</para><para>"был произведен посредством"</para><para>"wurde hergestellt durch"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"tem ou teve curador"</para><para>"hat derzeitigen oder früheren Kurator"</para><para>"a pour conservateur actuel ou ancien"</para><para>"имеет действующего или бывшего хранителя"</para><para>"έχει ή είχε επιμελητή"</para><para>"has current or former curator"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"είναι ή ήταν επιμελητής του/της"</para><para>"est ou a été le conservateur de"</para><para>"é ou foi curador de"</para><para>"является действующим или бывшим хранителем"</para><para>"ist derzeitiger oder früherer Kurator von"</para><para>"is current or former curator of"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"находится в пределах"</para><para>"falls within"</para><para>"fällt in"</para><para>"εμπίπτει"</para><para>"está contido em"</para><para>"s’insère dans le cours de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"περιλαμβάνει"</para><para>"содержит"</para><para>"enthält"</para><para>"contains"</para><para>"contient"</para><para>"contém"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"увеличил"</para><para>"augmented"</para><para>"erweiterte"</para><para>"a augmenté"</para><para>"επαύξησε"</para><para>"aumentou"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"foi aumentada por"</para><para>"был увеличен посредством"</para><para>"was augmented by"</para><para>"a été augmenté par"</para><para>"επαυξήθηκε από"</para><para>"wurde erweitert durch"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"fügte hinzu"</para><para>"adicionou"</para><para>"добавил"</para><para>"a ajouté"</para><para>"προσέθεσε"</para><para>"added"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"был добавлен посредством"</para><para>"a été ajouté par"</para><para>"foi adicionado por"</para><para>"was added by"</para><para>"προστέθηκε από"</para><para>"wurde hinzugefügt durch"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"diminished"</para><para>"уменьшил"</para><para>"verminderte"</para><para>"a diminué"</para><para>"diminuiu"</para><para>"εξάλειψε"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"был уменьшен посредством"</para><para>"was diminished by"</para><para>"a été diminué par"</para><para>"εξαλείφθηκε από"</para><para>"foi diminuído por"</para><para>"wurde vermindert durch"</para></remarks>
    ...
    /// labels<para>"removed"</para><para>"a enlevé"</para><para>"αφαίρεσε"</para><para>"removeu"</para><para>"удален"</para><para>"entfernte"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"был удален посредством"</para><para>"a été enlevée par"</para><para>"was removed by"</para><para>"wurde entfernt durch"</para><para>"foi removido por"</para><para>"αφαιρέθηκε από"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"zeitgleich zu"</para><para>"est temporellement égale à"</para><para>"is equal in time to"</para><para>"равен по времени"</para><para>"é temporalmente igual a"</para><para>"συμπίπτει χρονικά με"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"termine"</para><para>"finaliza"</para><para>"finishes"</para><para>"заканчивает"</para><para>"περατώνει"</para><para>"beendet"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"заканчивается"</para><para>"περατώνεται με"</para><para>"é finalizada por"</para><para>"is finished by"</para><para>"est terminée par"</para><para>"wurde beendet mit"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"starts"</para><para>"начинает"</para><para>"beginnt"</para><para>"αρχίζει"</para><para>"inicia"</para><para>"commence"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"est commencée par"</para><para>"wurde begonnen mit"</para><para>"αρχίζει με"</para><para>"начинается"</para><para>"is started by"</para><para>"é iniciada por"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"появляется во течение"</para><para>"occurs during"</para><para>"εμφανίζεται κατά τη διάρκεια"</para><para>"a lieu pendant"</para><para>"ocorre durante"</para><para>"fällt in"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"inclui"</para><para>"περιλαμβάνει"</para><para>"comporte"</para><para>"включает"</para><para>"includes"</para><para>"beinhaltet"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"προηγείται μερικώς επικαλύπτοντας"</para><para>"перекрывает во времени"</para><para>"überlappt zeitlich mit"</para><para>"est partiellement recouverte dans le temps par"</para><para>"sobrepõe temporalmente"</para><para>"overlaps in time with"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is overlapped in time by"</para><para>"перекрывается во времени"</para><para>"recouvre partiellement dans le temps"</para><para>"wird zeitlich überlappt von"</para><para>"έπεται μερικώς επικαλυπτόμενο"</para><para>"é sobreposto temporalmente por"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"est temporellement contiguë avec"</para><para>"trifft zeitlich auf"</para><para>"é temporalmente contíguo com"</para><para>"meets in time with"</para><para>"следует во времени за"</para><para>"προηγείται"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"έπεται"</para><para>"is met in time by"</para><para>"est immédiatement précédé par"</para><para>"предшествует во времени"</para><para>"wird zeitlich getroffen von"</para><para>"é imediatamente precedido por"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"имел участника"</para><para>"tem participante"</para><para>"had participant"</para><para>"hatte Teilnehmer"</para><para>"a eu pour participant"</para><para>"είχε συμμέτοχο"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"participa em"</para><para>"a participé à"</para><para>"participated in"</para><para>"участвовал в"</para><para>"nahm Teil an"</para><para>"συμμετείχε σε"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"a lieu avant"</para><para>"появляется до"</para><para>"occurs before"</para><para>"εμφανίζεται πριν"</para><para>"ocorre antes"</para><para>"kommt vor"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"a lieu après"</para><para>"ocorre depois"</para><para>"kommt nach"</para><para>"εμφανίζεται μετά"</para><para>"появляется после"</para><para>"occurs after"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"chevauche"</para><para>"overlaps with"</para><para>"sobrepõe com"</para><para>"пересекается с"</para><para>"überlappt mit"</para><para>"επικαλύπτεται με"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"jouxte"</para><para>"grenzt an"</para><para>"fronteira com"</para><para>"borders with"</para><para>"συνορεύει με"</para><para>"граничит с"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"повлек появление"</para><para>"resulted in"</para><para>"a eu pour résultat"</para><para>"ergab"</para><para>"είχε ως αποτέλεσμα"</para><para>"resultou em"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"был результатом"</para><para>"ergab sich aus"</para><para>"resulted from"</para><para>"resultado de"</para><para>"est le résultat de"</para><para>"προέκυψε από"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"transformed"</para><para>"μετέτρεψε"</para><para>"transformou"</para><para>"wandelte um"</para><para>"трансформировал"</para><para>"a transformé"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"wurde umgewandelt durch"</para><para>"was transformed by"</para><para>"был трансформирован посредством"</para><para>"foi transformado por"</para><para>"μετατράπηκε από"</para><para>"a été transformé par"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"usou objeto do tipo"</para><para>"benutzte Objekt des Typus"</para><para>"χρησιμοποίησε αντικείμενο τύπου"</para><para>"использовал объект типа"</para><para>"a employé un objet du type"</para><para>"used object of type"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"foi tipo do objeto usado em"</para><para>"ήταν o τύπος αντικείμενου που χρησιμοποιήθηκε σε"</para><para>"был типом объекта использованного в"</para><para>"Objekt des Typus ... wurde benutzt in"</para><para>"était le type d’objet employé par"</para><para>"was type of object used in"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"χρησιμοποίησε"</para><para>"empregou"</para><para>"verwendete"</para><para>"использовал"</para><para>"employed"</para><para>"a employé"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"foi empregado em"</para><para>"was employed in"</para><para>"использовался в"</para><para>"χρησιμοποιήθηκε σε"</para><para>"a été employé dans"</para><para>"wurde verwendet bei"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"a pour terme générique"</para><para>"έχει ευρύτερο όρο"</para><para>"имеет вышестоящий термин"</para><para>"tem termo genérico"</para><para>"has broader term"</para><para>"hat den Oberbegriff"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"hat den Unterbegriff"</para><para>"tem termo específico"</para><para>"has narrower term"</para><para>"έχει στενότερο όρο"</para><para>"a pour terme spécifique"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"est le support de"</para><para>"é o suporte de"</para><para>"φέρει"</para><para>"несет"</para><para>"trägt"</para><para>"carries"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"переносится посредством"</para><para>"a pour support"</para><para>"wird getragen von"</para><para>"is carried by"</para><para>"é suportado por"</para><para>"φέρεται από"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"is about"</para><para>"handelt über"</para><para>"έχει ως θέμα"</para><para>"é sobre"</para><para>"est au sujet de"</para><para>"касается"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"είναι θέμα  του/της"</para><para>"é assunto de"</para><para>"is subject of"</para><para>"wird behandelt in"</para><para>"est le sujet de"</para><para>"является предметом для"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"est arrivé en présence de"</para><para>"появился в присутствии"</para><para>"ocorreu na presença de"</para><para>"fand statt im Beisein von"</para><para>"occurred in the presence of"</para><para>"συνέβη παρουσία του/της"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"присутствовал при"</para><para>"était présent à"</para><para>"ήταν παρών/παρούσα/παρόν σε"</para><para>"estava presente no"</para><para>"was present at"</para><para>"war anwesend bei"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"демонстрирует признаки"</para><para>"zeigt Merkmale von"</para><para>"παρουσιάζει χαρακτηριστικά του/της"</para><para>"apresenta características de"</para><para>"présente des caractéristiques de"</para><para>"shows features of"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"χαρακτηριστικά του βρίσκονται επίσης σε"</para><para>"a des caractéristiques se trouvant aussi sur"</para><para>"features are also found on"</para><para>"признаки также найдены на"</para><para>"características são também encontradas em"</para><para>"Merkmale auch auf"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"est identifié par"</para><para>"αναγνωρίζεται ως"</para><para>"wird identifziert durch"</para><para>"идентифицируется посредством"</para><para>"is identified by"</para><para>"é identificado por"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"identifie"</para><para>"identifica"</para><para>"identifiziert"</para><para>"идентифицирует"</para><para>"είναι αναγνωριστικό"</para><para>"identifies"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"sobrepõe"</para><para>"chevauche"</para><para>"пересекается с"</para><para>"επικαλύπτεται με"</para><para>"overlaps with"</para><para>"überlappt mit"</para></remarks>
    ...
    /// This property does not imply any ordering or sequence between the two periods either spatial or temporal.
    /// "</para>
    /// labels<para>"est séparée de"</para><para>"is separated from"</para><para>"getrennt von"</para><para>"é separado de"</para><para>"διαχωρίζεται από"</para><para>"отделен от"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"продолжил"</para><para>"continuou"</para><para>"setzte sich fort in"</para><para>"συνέχισε"</para><para>"continued"</para><para>"est la suite de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"был продолжен"</para><para>"a été continuée par"</para><para>"wurde fortgesetzt durch"</para><para>"συνεχίστηκε από"</para><para>"foi continuada por"</para><para>"was continued by"</para></remarks>
    ...
    /// labels<para>"δημιούργησε τύπο"</para><para>"a créé le type"</para><para>"criou tipo"</para><para>"created type"</para><para>"создал тип"</para><para>"erschuf Typus"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"was created by"</para><para>"был создан посредством"</para><para>"a été créé par"</para><para>"δημιουργήθηκε από"</para><para>"foi criado por"</para><para>"wurde geschaffen durch"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"stützte sich auf"</para><para>"s’est fondée sur"</para><para>"foi baseado em"</para><para>"был основан на"</para><para>"βασίστηκε σε"</para><para>"was based on"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"supported type creation"</para><para>"поддержал создание типа"</para><para>"υποστήριξε τη δημιουργία τύπου"</para><para>"belegte"</para><para>"suportou a criação de tipo"</para><para>"a justifié la création de type"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"erläutert"</para><para>"é exemplificado por"</para><para>"поясняет"</para><para>"exemplifies"</para><para>"δειγματίζει"</para><para>"exemplifie"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"est exemplifié par"</para><para>"поясняется посредством"</para><para>"exemplifica"</para><para>"δειγματίζεται από"</para><para>"erläutert durch Beispiel"</para><para>"is exemplified by"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"represents"</para><para>"stellt dar"</para><para>"παριστάνει"</para><para>"представляет"</para><para>"representa"</para><para>"représente"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has representation"</para><para>"tem representação"</para><para>"est représentée par"</para><para>"имеет представление"</para><para>"παριστάνεται από"</para><para>"wird dargestellt durch"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"a pour autre forme"</para><para>"имеет альтернативную форму"</para><para>"has alternative form"</para><para>"hat alternative Form"</para><para>"έχει εναλλακτική μορφή"</para><para>"tem forma alternativa"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"уничтожил"</para><para>"destroyed"</para><para>"κατέστρεψε"</para><para>"a détruit"</para><para>"zerstörte"</para><para>"destruiu"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"foi destruído por"</para><para>"a été détruite par"</para><para>"was destroyed by"</para><para>"wurde zerstört durch"</para><para>"καταστράφηκε από"</para><para>"был уничтожен посредством"</para></remarks>
    ...
    /// labels<para>"присвоил атрибут для"</para><para>"a affecté un attribut à"</para><para>"assigned attribute to"</para><para>"απέδωσε ιδιότητα σε"</para><para>"wies Merkmal zu"</para><para>"atribuiu atributo para"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"bekam Merkmal zugewiesen durch"</para><para>"was attributed by"</para><para>"a reçu un attribut par"</para><para>"χαρακτηρίστηκε από"</para><para>"получил атрибут посредством"</para><para>"foi atribuído por"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"a attribué"</para><para>"присвоил"</para><para>"atribuiu"</para><para>"wies zu"</para><para>"assigned"</para><para>"απέδωσε"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"αποδόθηκε από"</para><para>"foi atribuído por"</para><para>"wurde zugewiesen durch"</para><para>"was assigned by"</para><para>"был присвоен посредством"</para><para>"a été attribué par"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"was used in"</para><para>"wurde benutzt in"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"was joined by"</para><para>"wurde verbunden durch"</para></remarks>
    ...
    /// The property P144.1 kind of member can be used to specify the type of membership or the role the member has in the group."</para>
    /// labels<para>"joined with"</para><para>"verband mit"</para><para>"åŠ å…¥"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"gained member by"</para><para>"erwarb Mitglied durch"</para></remarks>
    ...
    /// labels<para>"entließ"</para><para>"separated"</para></remarks>
    ...
    /// Although a leaving activity normally concerns only one instance of E74 Group, it is possible to imagine circumstances under which leaving one E74 Group implies leaving another E74 Group as well."</para>
    ///   <para>"This property identifies the instance of E74 Group an instance of E39 Actor leaves through an instance of E86 Leaving.
    ...
    /// "</para>
    /// labels<para>"è„±ç¦»"</para><para>"entlieÃŸ von"</para><para>"entließ von"</para><para>"separated from"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"lost member by"</para><para>"verlor Mitglied durch"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"curated"</para><para>"betreute kuratorisch"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"was curated by"</para><para>"wurde kuratorisch betreut durch"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is component of"</para><para>"ist Bestandteil von"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"wurde ausgeführt von"</para><para>"realizada por"</para><para>"carried out by"</para><para>"πραγματοποιήθηκε από"</para><para>"выполнялся"</para><para>"réalisée par"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"a exécuté"</para><para>"πραγματοποίησε"</para><para>"executou"</para><para>"выполнял"</para><para>"performed"</para><para>"führte aus"</para></remarks>
    ...
    /// <summary>
    ///   <para>cidoc:P151_was_formed_from</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"This property associates an instance of E66 Formation with an instance of E74 Group from which the new group was formed preserving a sense of continuity such as in mission, membership or tradition."</para>
    /// labels<para>"was formed from"</para></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P151_was_formed_from">http://www.cidoc-crm.org/cidoc-crm/P151_was_formed_from</seealso>
    let P151_was_formed_from =
        Prefixed_Name(cidoc, "P151_was_formed_from") |> PrefixedName
    ...
    /// "</para>
    /// labels<para>"foi influenciado por "</para><para>"находился под влиянием"</para><para>"επηρεάστηκε από"</para><para>"a été influencée par"</para><para>"was influenced by"</para><para>"wurde beeinflußt durch"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"оказал влияние на"</para><para>"influenciou"</para><para>"επηρέασε"</para><para>"beeinflußte"</para><para>"influenced"</para><para>"a influencé"</para></remarks>
    ...
    /// <summary>
    ///   <para>cidoc:P168_place_is_defined_by</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"This property associates an instance of E53 Place with an instance of E94 Space Primitive that defines it. Syntactic variants or use of different scripts may result in multiple instances of E94 Space Primitive defining exactly the same place. Transformations between different reference systems always result in new definitions of places approximating each other and not in alternative definitions."</para>
    /// labels<para>"place is defined by"</para></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P168_place_is_defined_by">http://www.cidoc-crm.org/cidoc-crm/P168_place_is_defined_by</seealso>
    let P168_place_is_defined_by =
        Prefixed_Name(cidoc, "P168_place_is_defined_by") |> PrefixedName

    /// <summary>
    ///   <para>cidoc:P169i_spacetime_volume_is_defined_by</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Scope note for 'P169': This property associates an instance of E95 Spacetime Primitive with the instance of E92 Spacetime Volume it defines."</para>
    /// labels<para>"spacetime volume is defined by"</para></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P169i_spacetime_volume_is_defined_by">http://www.cidoc-crm.org/cidoc-crm/P169i_spacetime_volume_is_defined_by</seealso>
    let P169i_spacetime_volume_is_defined_by =
        Prefixed_Name(cidoc, "P169i_spacetime_volume_is_defined_by") |> PrefixedName
    ...
    /// "</para>
    /// labels<para>"usou objeto específico"</para><para>"χρησιμοποίησε αντικείμενο"</para><para>"использовал особый объект"</para><para>"benutzte das bestimmte Objekt"</para><para>"a utilisé l'objet spécifique"</para><para>"used specific object"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"был использован для"</para><para>"was used for"</para><para>"wurde benutzt für"</para><para>"χρησιμοποιήθηκε για"</para><para>"foi usado por"</para><para>"a été utilisé pour"</para></remarks>
    ...
    /// <summary>
    ///   <para>cidoc:P170i_time_is_defined_by</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Scope note for 'P170': This property associates an instance of E61 Time Primitive with the instance of E52 Time-Span that constitutes the interpretation of the terms of the time primitive as an extent in absolute, real time.
    /// The quantification allows several instances of E61 Time Primitive that are each expressed in different syntactic forms, to define the same instance of E52 Time-Span."</para>
    /// labels<para>"time is defined by"</para></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P170i_time_is_defined_by">http://www.cidoc-crm.org/cidoc-crm/P170i_time_is_defined_by</seealso>
    let P170i_time_is_defined_by =
        Prefixed_Name(cidoc, "P170i_time_is_defined_by") |> PrefixedName

    /// <summary>
    ///   <para>cidoc:P171_at_some_place_within</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"This property describes the maximum spatial extent within which an instance of E53 Place falls. Since instances of E53 Places may not have precisely known spatial extents, the CIDOC CRM supports statements about maximum spatial extents of instances of E53 Place. This property allows an instance of E53 Placeâ€™s maximum spatial extent (i.e., its outer boundary) to be assigned an instance of E94 Space Primitive value.
    /// This property is a shortcut of the fully developed path from E53 Place, P89 falls within, E53 Place, P168 place is defined by to E94 Space Primitive through a declarative Place that is not explicitly documented, to a Space Primitive: declarative places are defined in CRMgeo (Doerr and Hiebel 2013)."</para>
    /// labels<para>"at some place within"</para></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P171_at_some_place_within">http://www.cidoc-crm.org/cidoc-crm/P171_at_some_place_within</seealso>
    let P171_at_some_place_within =
        Prefixed_Name(cidoc, "P171_at_some_place_within") |> PrefixedName

    /// <summary>
    ///   <para>cidoc:P172_contains</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"This property describes a minimum spatial extent which is contained within an instance of E53 Place. Since instances of E53 Place may not have precisely known spatial extents, the CIDOC CRM supports statements about minimum spatial extents of instances of E53 Place. This property allows an instance of E53 Placesâ€™s minimum spatial extent (i.e., its inner boundary or a point being within a Place) to be assigned an instance of E94 Space Primitive value.
    /// This property is a shortcut of the fully developed path from E53 Place, P89i contains, E53 Place, P168 place is defined by to E94 Space Primitive"</para>
    /// labels<para>"contains"</para></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P172_contains">http://www.cidoc-crm.org/cidoc-crm/P172_contains</seealso>
    let P172_contains = Prefixed_Name(cidoc, "P172_contains") |> PrefixedName

    /// <summary>
    ///   <para>cidoc:P175_starts_before_or_with_the_start_of</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P175_starts_before_or_with_the_start_of">http://www.cidoc-crm.org/cidoc-crm/P175_starts_before_or_with_the_start_of</seealso>
    let P175_starts_before_or_with_the_start_of =
        Prefixed_Name(cidoc, "P175_starts_before_or_with_the_start_of") |> PrefixedName

    /// <summary>
    ///   <para>cidoc:P175i_starts_after_or_with_the_start_of</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P175i_starts_after_or_with_the_start_of">http://www.cidoc-crm.org/cidoc-crm/P175i_starts_after_or_with_the_start_of</seealso>
    let P175i_starts_after_or_with_the_start_of =
        Prefixed_Name(cidoc, "P175i_starts_after_or_with_the_start_of") |> PrefixedName
    ...
    /// "</para>
    /// labels<para>"wurde angeregt durch"</para><para>"был обусловлен посредством"</para><para>"foi motivado por"</para><para>"a été motivée par"</para><para>"είχε ως αφορμή"</para><para>"was motivated by"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"regte an"</para><para>"motivou"</para><para>"обусловил"</para><para>"a motivé"</para><para>"motivated"</para><para>"ήταν αφορμή"</para></remarks>
    ...
    /// <summary>
    ///   <para>cidoc:P184_ends_before_or_with_the_end_of</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P184_ends_before_or_with_the_end_of">http://www.cidoc-crm.org/cidoc-crm/P184_ends_before_or_with_the_end_of</seealso>
    let P184_ends_before_or_with_the_end_of =
        Prefixed_Name(cidoc, "P184_ends_before_or_with_the_end_of") |> PrefixedName

    /// <summary>
    ///   <para>cidoc:P184i_ends_with_or_after_the_end_of</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P184i_ends_with_or_after_the_end_of">http://www.cidoc-crm.org/cidoc-crm/P184i_ends_with_or_after_the_end_of</seealso>
    let P184i_ends_with_or_after_the_end_of =
        Prefixed_Name(cidoc, "P184i_ends_with_or_after_the_end_of") |> PrefixedName

    /// <summary>
    ///   <para>cidoc:P190_has_symbolic_content</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"This property associates an instance of E90 Symbolic Object with a complete, identifying representation of its content in the form of an instance of E62 String.
    ...
    /// As another example, if the represented object has type "English words sequence", American English or British English spelling variants may be chosen to represent the English word "colour" without defining a different symbolic object. If a name has type "European traditional name", no particular string may define its content."</para>
    /// labels<para>"has symbolic content"</para></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P190_has_symbolic_content">http://www.cidoc-crm.org/cidoc-crm/P190_has_symbolic_content</seealso>
    let P190_has_symbolic_content =
        Prefixed_Name(cidoc, "P190_has_symbolic_content") |> PrefixedName

    /// <summary>
    ///   <para>cidoc:P191_had_duration</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P191_had_duration">http://www.cidoc-crm.org/cidoc-crm/P191_had_duration</seealso>
    let P191_had_duration = Prefixed_Name(cidoc, "P191_had_duration") |> PrefixedName

    /// <summary>
    ///   <para>cidoc:P191i_was_duration_of</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P191i_was_duration_of">http://www.cidoc-crm.org/cidoc-crm/P191i_was_duration_of</seealso>
    let P191i_was_duration_of =
        Prefixed_Name(cidoc, "P191i_was_duration_of") |> PrefixedName
    ...
    /// labels<para>"era prevista a utilização de"</para><para>"was intended use of"</para><para>"était l'utilisation prévue de"</para><para>"был предполагаемым использованием для"</para><para>"war beabsichtigteter Gebrauch von "</para><para>"ήταν προορισμένη χρήση του"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"wurde hergestellt für"</para><para>"был создан для"</para><para>"foi feito para"</para><para>"έγινε για"</para><para>"a été fabriquée pour"</para><para>"was made for"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"est identifiée par"</para><para>"αναγνωρίζεται ως"</para><para>"is identified by"</para><para>"é identificado por"</para><para>"идентифицируется посредством"</para><para>"wird bezeichnet als"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"identifies"</para><para>"identifie"</para><para>"identifica"</para><para>"идентифицирует"</para><para>"bezeichnet"</para><para>"είναι αναγνωριστικό"</para></remarks>
    ...
    /// labels<para>"had specific purpose"</para><para>"hatte den bestimmten Zweck"</para><para>"имел конкретную цель"</para><para>"είχε συγκεκριμένο σκοπό"</para><para>"tinha propósito específico"</para><para>"avait pour but spécifique"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"был целью для"</para><para>"ήταν σκοπός του/της"</para><para>"era o propósito de"</para><para>"war Zweck von"</para><para>"was purpose of"</para><para>"était le but de"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"tinha propósito geral"</para><para>"hatte den allgemeinen Zweck"</para><para>"avait pour but général"</para><para>"имел общую цель"</para><para>"had general purpose"</para><para>"είχε γενικό σκοπό"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"был целью для"</para><para>"era o propósito de"</para><para>"était le but de"</para><para>"ήταν σκοπός του/της"</para><para>"war Zweck von"</para><para>"was purpose of"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"передал право собственности"</para><para>"übertrug Besitztitel auf"</para><para>"a fait passer le droit de propriété à"</para><para>"transferred title to"</para><para>"transferiu os direitos de propriedade para"</para><para>"μετεβίβασε τον τίτλο σε"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"получил право собственности через"</para><para>"erwarb Besitztitel durch"</para><para>"απέκτησε τον τίτλο μέσω"</para><para>"a acquis le droit de propriété du fait de"</para><para>"adquiriu os direitos de propriedade por meio da"</para><para>"acquired title through"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"a fait passer le droit de propriété de"</para><para>"transferiu os direitos de propriedade de"</para><para>"μετεβίβασε τον τίτλο από"</para><para>"передал право собственности от"</para><para>"transferred title from"</para><para>"übertrug Besitztitel von"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"perdeu os direitos de propriedade por meio da"</para><para>"surrendered title through"</para><para>"παρέδωσε τον τίτλο μέσω"</para><para>"право собственности отдано через"</para><para>"a perdu le droit de propriété du fait de"</para><para>"trat Besitztitel ab in"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"übertrug Besitz über"</para><para>"a fait passer le droit de propriété sur"</para><para>"передал право собственности на"</para><para>"transferiu os direitos de propriedade sobre o"</para><para>"μετεβίβασε τον τίτλο του/της"</para><para>"transferred title of"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"a changé de mains du fait de"</para><para>"άλλαξε ιδιοκτησία μέσω"</para><para>"сменил владельца через"</para><para>"ging über in Besitz durch"</para><para>"changed ownership through"</para><para>"mudou de proprietário por meio de"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"locomoveu"</para><para>"moved"</para><para>"μετεκίνησε"</para><para>"переместил"</para><para>"bewegte"</para><para>"a déplacé"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"wurde bewegt durch"</para><para>"перемещен посредством"</para><para>"moved by"</para><para>"μετακινήθηκε από"</para><para>"a été déplacé par"</para><para>"foi locomovido por"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"a déplacé vers"</para><para>"перемещен в"</para><para>"bewegte bis zu"</para><para>"μετακινήθηκε προς"</para><para>"locomoveu para"</para><para>"moved to"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"был пунктом назначения для"</para><para>"a été la destination de"</para><para>"era destinação de"</para><para>"war Zielort von"</para><para>"was destination of"</para><para>"ήταν προορισμός του/της"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"μετακινήθηκε από"</para><para>"bewegte weg von"</para><para>"locomoveu de"</para><para>"перемещен из"</para><para>"a retiré de"</para><para>"moved from"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"war Ausgangsort von"</para><para>"was origin of"</para><para>"ήταν αφετηρία του/της"</para><para>"era origem de"</para><para>"был исходной точкой для"</para><para>"a été l'origine de"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"custódia concedida por"</para><para>"опека отдана"</para><para>"μετεβίβασε κατοχή από"</para><para>"übergab Gewahrsam an"</para><para>"custody surrendered by"</para><para>"changement de détenteur au détriment de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"wurde Gewahrsam übergeben durch"</para><para>"опека отдана через"</para><para>"a cessé d’être détenteur à cause de"</para><para>"παρέδωσε κατοχή μέσω"</para><para>"surrendered custody through"</para><para>"final da custódia por meio de"</para></remarks>
    ...
    /// In reality, custody is either transferred to someone or from someone, or both.
    /// "</para>
    /// labels<para>"changement de détenteur au profit de"</para><para>"custódia recebida por"</para><para>"опека получена"</para><para>"übertrug Gewahrsam auf"</para><para>"custody received by"</para><para>"μετεβίβασε κατοχή σε"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"παρέλαβε κατοχή μέσω"</para><para>"est devenu détenteur grâce à"</para><para>"início da custódia por meio de"</para><para>"получил опеку через"</para><para>"erhielt Gewahrsam durch"</para><para>"received custody through"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"hat den Typus"</para><para>"est de type"</para><para>"é do tipo"</para><para>"имеет тип"</para><para>"έχει τύπο"</para><para>"has type"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"est le type de"</para><para>"является типом для"</para><para>"ist Typus von"</para><para>"είναι ο τύπος του/της"</para><para>"is type of"</para><para>"é o tipo de"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"changement de détenteur concernant"</para><para>"übertrug Gewahrsam über"</para><para>"передало опеку на"</para><para>"μετεβίβασε κατοχή του/της/των"</para><para>"transferida custódia de"</para><para>"transferred custody of"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"άλλαξε κατοχή μέσω"</para><para>"опека передана через"</para><para>"custódia transferida por meio de"</para><para>"wechselte Gewahrsam durch"</para><para>"a changé de détenteur du fait de"</para><para>"custody transferred through"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"a modifié"</para><para>"veränderte"</para><para>"τροποποίησε"</para><para>"изменил"</para><para>"has modified"</para><para>"modificou"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"был изменен посредством"</para><para>"foi modificada por"</para><para>"τροποποιήθηκε από"</para><para>"a été modifié par"</para><para>"wurde verändert durch"</para><para>"was modified by"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"a employé comme technique générique"</para><para>"used general technique"</para><para>"χρησιμοποίησε γενική τεχνική"</para><para>"usou técnica geral"</para><para>"benutzte das allgemeine Verfahren"</para><para>"использовал общую технику"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"foi técnica da"</para><para>"was technique of"</para><para>"a été la technique mise en œuvre dans"</para><para>"был техникой для"</para><para>"ήταν τεχνική του/της"</para><para>"war Verfahren von"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"usou técnica específica"</para><para>"used specific technique"</para><para>"использовал особую технику"</para><para>"χρησιμοποίησε συγκεκριμένη τεχνική"</para><para>"benutzte das bestimmte Verfahren"</para><para>"a employé comme technique spécifique"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"was used by"</para><para>"foi usada por"</para><para>"a été employée par"</para><para>"был использован посредством"</para><para>"χρησιμοποιήθηκε για"</para><para>"wurde benutzt von"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"αφορούσε σε"</para><para>"имел дело с"</para><para>"a concerné"</para><para>"interessada"</para><para>"concerned"</para><para>"betraf"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"was assessed by"</para><para>"был оценен посредством"</para><para>"expertisé par le biais de"</para><para>"εκτιμήθηκε από"</para><para>"foi avaliada por"</para><para>"wurde beurteilt durch"</para></remarks>
    ...
    /// labels<para>"a identifié"</para><para>"идентифицировал"</para><para>"έχει διαπιστώσει"</para><para>"has identified"</para><para>"identificou"</para><para>"hat identifiziert"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"foi identificado por"</para><para>"wurde identifiziert durch"</para><para>"έχει διαπιστωθεί από"</para><para>"идентифицирован посредством"</para><para>"was identified by"</para><para>"est identifié par"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"a attribué"</para><para>"assigned"</para><para>"назначил"</para><para>"απέδωσε"</para><para>"wies zu"</para><para>"atribuiu"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"a désattribué"</para><para>"deassigned"</para><para>"отменил назначение"</para><para>" hob Zuweisung auf von"</para><para>"retirou a atribuição do"</para><para>"ακύρωσε"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"wurde aufgehoben durch"</para><para>"was deassigned by"</para><para>"ακυρώθηκε από"</para><para>"a été désattribué par"</para><para>"foi retirada a atribuição por"</para><para>"был отменен посредством"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"a mesuré"</para><para>"μέτρησε"</para><para>"измерил"</para><para>"vermaß"</para><para>"mediu"</para><para>"measured"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"a été mesuré par"</para><para>"был измерен посредством"</para><para>"foi medida por"</para><para>"μετρήθηκε από"</para><para>"was measured by"</para><para>"wurde vermessen durch"</para></remarks>
    ...
    /// "</para>
    ///   <para>"This property is a container for all informal descriptions about an object that have not been expressed in terms of CIDOC CRM constructs.
    /// In particular, it captures the characterisation of the item itself, its internal structures, appearance etc.
    /// Like property P2 has type (is type of), this property is a consequence of the restricted focus of the CIDOC CRM. The aim is not to capture, in a structured form, everything that can be said about an item; indeed, the CIDOC CRM formalism is not regarded as sufficient to express everything that can be said. Good practice requires use of distinct note fields for different aspects of a characterisation. The P3.1 has type property of P3 has note allows differentiation of specific notes, e.g., â€œconstructionâ€, â€œdecorationâ€ etc.
    /// An item may have many notes, but a note is attached to a specific item."</para>
    /// labels<para>"æœ‰æ³¨é‡Š"</para><para>"имеет примечание"</para><para>"Ð¸Ð¼ÐµÐµÑ‚ Ð¿Ñ€Ð¸Ð¼ÐµÑ‡Ð°Ð½Ð¸Ðµ"</para><para>"tem nota"</para><para>"Î­Ï‡ÎµÎ¹ ÎµÏ€ÎµÎ¾Î®Î³Î·ÏƒÎ·"</para><para>"a pour note"</para><para>"has note"</para><para>"έχει επεξήγηση"</para><para>"hat Anmerkung"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"παρατήρησε"</para><para>"verificou a dimensão"</para><para>"beobachtete Dimension"</para><para>"a relevé comme dimension"</para><para>"определил величину"</para><para>"observed dimension"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"was observed in"</para><para>"foi verificada durante"</para><para>"παρατηρήθηκε από"</para><para>"наблюдался в"</para><para>"a été relevée au cours de"</para><para>"wurde beobachtet in"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"a classifié"</para><para>"classificou"</para><para>"классифицировал"</para><para>"χαρακτήρισε"</para><para>"klassifizierte"</para><para>"classified"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"wurde klassifiziert durch"</para><para>"foi classificada por"</para><para>"χαρακτηρίσθηκε από"</para><para>"был классифицирован посредством"</para><para>"was classified by"</para><para>"a été classifiée par le biais de"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"wies zu"</para><para>"a attribué"</para><para>"assigned"</para><para>"atribuiu"</para><para>"назначил"</para><para>"απέδωσε ως ιδιότητα"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"a été attribué par"</para><para>"wurde zugewiesen durch"</para><para>"αποδόθηκε από"</para><para>"был присвоен посредством"</para><para>"was assigned by"</para><para>"foi atribuído por"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"έχει μέγεθος"</para><para>"has dimension"</para><para>"hat Dimension"</para><para>"tem dimensão"</para><para>"имеет величину"</para><para>"a pour dimension"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"είναι μέγεθος του"</para><para>"é dimensão de"</para><para>"est dimension de"</para><para>"ist Dimension von"</para><para>"is dimension of"</para><para>"является величиной для"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"tem estado material "</para><para>"has condition"</para><para>"имеет условие"</para><para>"έχει κατάσταση"</para><para>"hat Zustand"</para><para>"a pour état matériel"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"état matériel de"</para><para>"ist Zustand von"</para><para>"είναι κατάσταση του"</para><para>"is condition of"</para><para>"estado material de"</para><para>"является условием для"</para></remarks>
    ...
    /// labels<para>"consiste de"</para><para>"составлен из"</para><para>"consiste en"</para><para>"consists of"</para><para>"besteht aus"</para><para>"αποτελείται από"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"está presente em"</para><para>"is incorporated in"</para><para>"est présent dans"</para><para>"ist enthalten in"</para><para>"είναι ενσωματωμένος/η/ο σε"</para><para>"входит в состав"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"est composée de"</para><para>"составлен из"</para><para>"αποτελείται από"</para><para>"é composto de"</para><para>"ist zusammengesetzt aus"</para><para>"is composed of"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"forms part of"</para><para>"формирует часть"</para><para>"faz parte de"</para><para>"fait partie de"</para><para>"αποτελεί μέρος του/της"</para><para>"bildet Teil von"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"έχει προτιμώμενο αναγνωριστικό"</para><para>"has preferred identifier"</para><para>"имеет предпочтительный идентификатор"</para><para>"hat bevorzugtes Kennzeichen"</para><para>"tem identificador preferido"</para><para>"a pour identificateur retenu"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"é o identificador preferido de"</para><para>"ist bevorzugtes Kennzeichen für"</para><para>"est l’identificateur retenu de"</para><para>"είναι προτιμώμενο αναγνωριστικό"</para><para>"is preferred identifier of"</para><para>"является предпочтительным идентификатором для"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"hat früheren oder derzeitigen Betreuer"</para><para>"имеет бывшего или текущего смотрителя"</para><para>"é ou foi guardada por"</para><para>"has former or current keeper"</para><para>"είναι ή ήταν στην κατοχή του"</para><para>"est ou a été détenu par"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"является бывшим или текущим смотрителем для"</para><para>"is former or current keeper of"</para><para>"é ou foi guardador de"</para><para>"ist früherer oder derzeitiger Betreuer von"</para><para>"κατέχει ή κατείχε"</para><para>"est ou a été détenteur de"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"βρισκόταν σε εξέλιξη"</para><para>"имеет временной отрезок"</para><para>"a pour durée"</para><para>"tem período de tempo"</para><para>"has time-span"</para><para>"hat Zeitspanne"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"é o período de tempo de"</para><para>"είναι χρονικό διάστημα του/της"</para><para>"ist Zeitspanne von"</para><para>"est la durée de"</para><para>"is time-span of"</para><para>"является временным отрезком для"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"hat derzeitigen Betreuer"</para><para>"é guardada por"</para><para>"est actuellement détenu par"</para><para>"has current keeper"</para><para>"имеет текущего смотрителя"</para><para>"είναι στην κατοχή του"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"ist derzeitiger Betreuer von"</para><para>"é guardador de"</para><para>"is current keeper of"</para><para>"является текущим смотрителем для"</para><para>"κατέχει"</para><para>"est actuel détenteur de"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"has former or current owner"</para><para>"hat früheren oder derzeitigen Besitzer "</para><para>"имеет бывшего или текущего владельца"</para><para>"έχει ή είχε ιδιοκτήτη"</para><para>"é ou foi propriedade de"</para><para>"est ou a été possédée par"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"είναι ή ήταν ιδιοκτήτης του/της"</para><para>"est ou a été propriétaire de"</para><para>"é ou foi proprietário de"</para><para>"является бывшим или текущим владельцем для"</para><para>"is former or current owner of"</para><para>"ist früherer oder derzeitiger Besitzer von"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"é propriedade de"</para><para>"has current owner"</para><para>"имеет текущего владельца"</para><para>"έχει ιδιοκτήτη"</para><para>"hat derzeitigen Besitzer"</para><para>"est actuellement possédée par"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"является текущим владельцем для"</para><para>"est le propriétaire actuel de"</para><para>"είναι ιδιοκτήτης του"</para><para>"ist derzeitiger Besitzer von"</para><para>"é proprietário de"</para><para>"is current owner of"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"has former or current location"</para><para>"имеет текущее или бывшее местоположение"</para><para>"é ou foi localizada em"</para><para>"a ou a eu pour localisation"</para><para>"βρίσκεται ή βρισκόταν σε"</para><para>"hat früheren oder derzeitigen Standort"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"est ou a été localisation de"</para><para>"is former or current location of"</para><para>"é ou foi localização de"</para><para>"ist früherer oder derzeitiger Standort von"</para><para>"является текущим или бывшим местоположением для"</para><para>"είναι ή ήταν θέση του"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"hat derzeitigen permanenten Standort"</para><para>"έχει μόνιμη θέση"</para><para>"имеет текущее постоянное местоположение"</para><para>"has current permanent location"</para><para>"a actuellement pour localisation à demeure"</para><para>"é localizado permanentemente em"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"é localização permanente de"</para><para>"ist derzeitiger permanenter Standort von"</para><para>"est actuellement localisation à demeure de"</para><para>"является текущим постоянным местоположением для"</para><para>"είναι μόνιμη θέση του/της"</para><para>"is current permanent location of"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"has current location"</para><para>"в данный момент находится в"</para><para>"βρίσκεται σε"</para><para>"hat derzeitigen Standort"</para><para>"é localizado em"</para><para>"a pour localisation actuelle"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"é localização atual de"</para><para>"hält derzeitig"</para><para>"в данный момент содержит"</para><para>"currently holds"</para><para>"est localisation actuelle de"</para><para>"είναι θέση του"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"φέρει μόρφωμα"</para><para>"trägt Merkmal"</para><para>"possui característica"</para><para>"несет признак"</para><para>"bears feature"</para><para>"présente pour caractéristique"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"wird gefunden auf"</para><para>"βρίσκεται σε"</para><para>"é encontrada em"</para><para>"se trouve sur"</para><para>"is found on"</para><para>"найден на"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"This property documents the number of parts, an instance of E60 Number, of which an instance of E19 Physical Object is composed.
    ...
    /// For a more complete description, objects may be decomposed into their components and constituents using P46 is composed of (forms parts of) and P45 consists of (is incorporated in). This allows each element to be described individually."</para>
    ...
    /// "</para>
    /// labels<para>"έχει αριθμό μερών"</para><para>"æœ‰ç»„æˆéƒ¨åˆ†æ•°"</para><para>"tem número de partes"</para><para>"hat Anzahl Teile"</para><para>"имеет число частей"</para><para>"Î­Ï‡ÎµÎ¹ Î±ÏÎ¹Î¸Î¼ÏŒ Î¼ÎµÏÏŽÎ½"</para><para>"Ð¸Ð¼ÐµÐµÑ‚ Ñ‡Ð¸ÑÐ»Ð¾ Ñ‡Ð°ÑÑ‚ÐµÐ¹"</para><para>"a pour nombre de parties"</para><para>"tem nÃºmero de partes"</para><para>"has number of parts"</para></remarks>
    ...
    /// labels<para>"έχει ορισμό τμήματος"</para><para>"a pour désignation de section"</para><para>"hat Abschittsdefinition"</para><para>"имеет определение района"</para><para>"has section definition"</para><para>"tem designação de seção"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"определяет район"</para><para>"définit une section de"</para><para>"ορίζει τμήμα σε"</para><para>"definiert Abschitt auf oder von"</para><para>"defines section"</para><para>"define uma seção de"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"tem seção"</para><para>"a pour section"</para><para>"hat Bereich"</para><para>"имеет район"</para><para>"has section"</para><para>"έχει τομέα"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"befindet sich auf oder in"</para><para>"is located on or within"</para><para>"está localizada sobre ou dentro de"</para><para>"se situe sur ou dans"</para><para>"находится на или внутри"</para><para>"βρίσκεται σε ή εντός"</para></remarks>
    ...
    /// labels<para>"besteht aus"</para><para>"consists of"</para><para>"consiste en"</para><para>"αποτελείται από"</para><para>"состоит из"</para><para>"consiste de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"forms part of"</para><para>"формирует часть"</para><para>"bildet Teil von"</para><para>"faz parte de"</para><para>"αποτελεί μέρος του/της"</para><para>"fait partie de"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"απεικονίζει"</para><para>"bildet ab"</para><para>"figure"</para><para>"depicts"</para><para>"retrata"</para><para>"описывает"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"é retratada por"</para><para>"is depicted by"</para><para>"описан посредством"</para><para>"απεικονίζεται σε"</para><para>"wird abgebildet durch"</para><para>"est figurée sur"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"shows visual item"</para><para>"εμφανίζει οπτικό στοιχείο"</para><para>"apresenta item visual"</para><para>"zeigt Bildliches"</para><para>"présente l'item visuel"</para><para>"показывает визуальный предмет"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"é apresentado por"</para><para>"is shown by"</para><para>"est présenté par"</para><para>"εμφανίζεται σε"</para><para>"показан посредством"</para><para>"wird gezeigt durch"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"verweist auf"</para><para>"αναφέρεται σε"</para><para>"ссылается на"</para><para>"refers to"</para><para>"referencia"</para><para>"fait référence à"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"wird angeführt von"</para><para>"é referenciado por"</para><para>"is referred to by"</para><para>"αναφέρεται από"</para><para>"имеет ссылку на себя от"</para><para>"est référencé par"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"foresees use of"</para><para>"обычно применяет"</para><para>"normalmente emprega"</para><para>" sieht den Gebrauch vor von"</para><para>"συνήθως χρησιμοποιεί"</para><para>"utilise habituellement"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"συνήθως χρησιμοποιείται από"</para><para>"est habituellement utilisé par"</para><para>"é empregado por"</para><para>"vorgesehen für Gebrauch durch defined"</para><para>"обычно используется посредством"</para><para>"use foreseen by"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"σχετίζεται με"</para><para>"est associée à"</para><para>"ist verbunden mit"</para><para>"é associado com"</para><para>"ассоциирован с"</para><para>"is associated with"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"belegt"</para><para>"mentionne"</para><para>"документирует"</para><para>"documenta"</para><para>"documents"</para><para>"τεκμηριώνει"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"é documentado em"</para><para>"est mentionnée dans"</para><para>"is documented in"</para><para>"wird belegt in"</para><para>"τεκμηριώνεται σε"</para><para>"документирован в"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"listet"</para><para>"περιλαμβάνει"</para><para>"définit"</para><para>"перечисляет"</para><para>"lists"</para><para>"define"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"перечислен в"</para><para>"est défini par"</para><para>"is listed in"</para><para>"é definido por"</para><para>"wird aufgelistet in"</para><para>"περιλαμβάνεται σε"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"hat Sprache"</para><para>"имеет язык"</para><para>"έχει γλώσσα"</para><para>"est en langue"</para><para>"has language"</para><para>"é da língua "</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"é a língua de"</para><para>"is language of"</para><para>"является языком для"</para><para>"ist Sprache von"</para><para>"είναι γλώσσα του/της"</para><para>"est la langue de"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"a pour traduction"</para><para>"hat Übersetzung"</para><para>"έχει μετάφραση"</para><para>"tem tradução"</para><para>"has translation"</para><para>"имеет перевод"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"является переводом"</para><para>"είναι μετάφραση του/της"</para><para>"est la traduction de"</para><para>"is translation of"</para><para>"é tradução de"</para><para>"ist Übersetzung von"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"hat derzeitigen oder früheren Sitz"</para><para>"reside ou residiu em"</para><para>"has current or former residence"</para><para>"имеет текущее или бывшее местожительства"</para><para>"έχει ή είχε κατοικία"</para><para>"réside ou a résidé à"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"является текущим или бывшим местом жительства для"</para><para>"είναι ή ήταν κατοικία του/της"</para><para>"est ou a été la résidence de"</para><para>"is current or former residence of"</para><para>"é ou foi residência de"</para><para>"ist derzeitiger oder früherer Sitz von"</para></remarks>
    ...
    /// labels<para>"владеет"</para><para>"besitzt"</para><para>"κατέχει"</para><para>"possesses"</para><para>"é detentor de"</para><para>"est détenteur de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"est détenu par"</para><para>"принадлежит"</para><para>"κατέχεται από"</para><para>"são detidos por"</para><para>"is possessed by"</para><para>"sind im Besitz von"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"has contact point"</para><para>"a pour coordonnées individuelles"</para><para>"hat Kontaktpunkt"</para><para>"possui ponto de contato"</para><para>"έχει σημείο επικοινωνίας"</para><para>"имеет контакт"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"permettent de contacter"</para><para>"é ponto de contado de"</para><para>"bietet Zugang zu"</para><para>"παρέχει πρόσβαση σε"</para><para>"предоставляет доступ к"</para><para>"provides access to"</para></remarks>
    ...
    /// labels<para>"est identifiée par"</para><para>"αναγνωρίζεται ως"</para><para>"идентифицируется посредством"</para><para>"is identified by"</para><para>"é identificado por "</para><para>"wird bezeichnet als"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"identifies"</para><para>"identifie"</para><para>"bezeichnet"</para><para>"identifica"</para><para>"идентифицирует"</para><para>"είναι αναγνωριστικό"</para></remarks>
    ...
    /// "</para>
    ///   <para>"This property associates an instance of E52 Time-Span with a note detailing the scholarly or scientific opinions and justifications about the certainty, precision, sources etc. of its beginning. Such notes may also be used to elaborate arguments about constraints or to give explanations of alternatives."</para>
    /// labels<para>"beginning is qualified by"</para><para>"начало ограничено"</para><para>"hat AnfangsbegrÃ¼ndung"</para><para>"Ð½Ð°Ñ‡Ð°Ð»Ð¾ Ð¾Ð³Ñ€Ð°Ð½Ð¸Ñ‡ÐµÐ½Ð¾"</para><para>"início é qualificado por"</para><para>"Î±ÏÏ‡Î® Ï€ÏÎ¿ÏƒÎ´Î¹Î¿ÏÎ¯Î¶ÎµÏ„Î±Î¹ Î±Ï€ÏŒ"</para><para>"αρχή προσδιορίζεται από"</para><para>"début est qualifié par"</para><para>"hat Anfangsbegründung"</para><para>"inÃ­cio Ã© qualificado por"</para><para>"èµ·å§‹é™å®š"</para><para>"dÃ©but est qualifiÃ© par"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"took place at"</para><para>"совершался на"</para><para>"ocorreu em"</para><para>"a eu lieu dans"</para><para>"fand statt in"</para><para>"έλαβε χώρα σε"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"witnessed"</para><para>"bezeugte"</para><para>"был местом совершения"</para><para>"testemunhou"</para><para>"υπήρξε τόπος του"</para><para>"a été témoin de"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"This property associates an instance of E52 Time-Span with a note detailing the scholarly or scientific opinions and justifications about the end of this time-span concerning certainty, precision, sources etc. This property may also be used to describe arguments constraining possible dates and to distinguish reasons for alternative dates."</para>
    ///   <para>"This property qualifies the end of an E52 Time-Span in some way.
    /// The nature of the qualification may be certainty, precision, source etc.
    /// "</para>
    /// labels<para>"конец ограничен"</para><para>"final Ã© qualificado por"</para><para>"fin est qualifiée par"</para><para>"ç»“æŸé™å®š"</para><para>"Ï„Î­Î»Î¿Ï‚ Ï€ÏÎ¿ÏƒÎ´Î¹Î¿ÏÎ¯Î¶ÎµÏ„Î±Î¹ Î±Ï€ÏŒ"</para><para>"fin est qualifiÃ©e par"</para><para>"ÐºÐ¾Ð½ÐµÑ† Ð¾Ð³Ñ€Ð°Ð½Ð¸Ñ‡ÐµÐ½"</para><para>"final é qualificado por"</para><para>"τέλος προσδιορίζεται από"</para><para>"hat Begründung des Endes"</para><para>"hat BegrÃ¼ndung des Endes"</para><para>"end is qualified by"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"abrange no mÃ­nimo"</para><para>"couvre au moins"</para><para>"ÎºÎ±Î¸ÏŒÎ»Î· Ï„Î· Î´Î¹Î¬ÏÎºÎµÎ¹Î± Ï„Î¿Ï…/Ï„Î·Ï‚"</para><para>"andauernd wÃ¤hrend"</para><para>"καθόλη τη διάρκεια του/της"</para><para>"abrange no mínimo"</para><para>"Ð´Ð»Ð¸Ñ‚ÑÑ Ð² Ñ‚ÐµÑ‡ÐµÐ½Ð¸Ðµ"</para><para>"andauernd während"</para><para>"ongoing throughout"</para><para>"длится в течение"</para><para>"æœ€çŸ­èŒƒå›´æ˜¯"</para></remarks>
    ...
    /// <summary>
    ///   <para>cidoc:P81a_end_of_the_begin</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Ende des Anfangs"</para><para>"end of the begin"</para><para>"fin du dÃ©but"</para><para>"fim do inÃ­cio"</para><para>"Ï„Î­Î»Î¿Ï‚ Ï„Î·Ï‚ Î±ÏÏ‡Î®Ï‚"</para><para>"ÐºÐ¾Ð½ÐµÑ† Ð½Ð°Ñ‡Ð°Ð»Ð°"</para></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P81a_end_of_the_begin">http://www.cidoc-crm.org/cidoc-crm/P81a_end_of_the_begin</seealso>
    let P81a_end_of_the_begin =
        Prefixed_Name(cidoc, "P81a_end_of_the_begin") |> PrefixedName

    /// <summary>
    ///   <para>cidoc:P81b_begin_of_the_end</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"dÃ©but de la fin"</para><para>"comeÃ§ar do fim"</para><para>"Î±ÏÏ‡Î® Ï„Î¿Ï… Ï„Î­Î»Î¿Ï…Ï‚"</para><para>"Ð½Ð°Ñ‡Ð°Ñ‚ÑŒ Ð² ÐºÐ¾Ð½Ñ†Ðµ"</para><para>"Anfang vom Ende"</para><para>"begin of the end"</para></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P81b_begin_of_the_end">http://www.cidoc-crm.org/cidoc-crm/P81b_begin_of_the_end</seealso>
    let P81b_begin_of_the_end =
        Prefixed_Name(cidoc, "P81b_begin_of_the_end") |> PrefixedName
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>rdf:Property</para>
    ///   <para>"This property describes the maximum period of time within which an E52 Time-Span falls. Since Time-Spans may not have precisely known temporal extents, the CIDOC CRM supports statements about the minimum and maximum temporal extents of Time-Spans. This property allows a Time-Spanâ€™s maximum temporal extent (i.e., its outer boundary) to be assigned an E61 Time Primitive value. Time Primitives are treated by the CIDOC CRM as application or system specific date intervals, and are not further analysed. If different sources of evidence justify different maximum extents without contradicting each other, the resulting intersection of all these extents will be the best estimate. This should be taken into account for information integration."</para>
    ///   <para>"This property describes the maximum period of time within which an E52 Time-Span falls.
    /// Since Time-Spans may not have precisely known temporal extents, the CRM supports statements about the minimum and maximum temporal extents of Time-Spans. This property allows a Time-Span’s maximum temporal extent (i.e. its outer boundary) to be assigned an E61 Time Primitive value. Time Primitives are treated by the CRM as application or system specific date intervals, and are not further analysed.
    /// "</para>
    /// labels<para>"некоторое время в течение"</para><para>"couvre au plus"</para><para>"irgendwann innerhalb von"</para><para>"abrange no mÃ¡ximo"</para><para>"æœ€é•¿èŒƒå›´æ˜¯"</para><para>"ÎºÎ¬Ï€Î¿Ï„Îµ ÎµÎ½Ï„ÏŒÏ‚"</para><para>"Ð½ÐµÐºÐ¾Ñ‚Ð¾Ñ€Ð¾Ðµ Ð²Ñ€ÐµÐ¼Ñ Ð² Ñ‚ÐµÑ‡ÐµÐ½Ð¸Ðµ"</para><para>"abrange no máximo"</para><para>"κάποτε εντός"</para><para>"at some time within"</para></remarks>
    ...
    /// <summary>
    ///   <para>cidoc:P82a_begin_of_the_begin</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"dÃ©but du dÃ©but"</para><para>"Ð½Ð°Ñ‡Ð°Ñ‚ÑŒ Ñ Ð½Ð°Ñ‡Ð°Ð»Ð°"</para><para>"comeÃ§ar do inÃ­cio"</para><para>"Î±ÏÏ‡Î® Ï„Î·Ï‚ Î±ÏÏ‡Î®Ï‚"</para><para>"begin of the begin"</para><para>"Anfang des Anfangs"</para></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P82a_begin_of_the_begin">http://www.cidoc-crm.org/cidoc-crm/P82a_begin_of_the_begin</seealso>
    let P82a_begin_of_the_begin =
        Prefixed_Name(cidoc, "P82a_begin_of_the_begin") |> PrefixedName

    /// <summary>
    ///   <para>cidoc:P82b_end_of_the_end</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"fim do fim"</para><para>"end of the end"</para><para>"ÐºÐ¾Ð½ÐµÑ† ÐºÐ¾Ð½ÐµÑ†"</para><para>"Ende vom Ende"</para><para>"fin de la fin"</para><para>"Ï„Î­Î»Î¿Ï‚ Ï„Î¿Ï… Ï„Î­Î»Î¿Ï…Ï‚"</para></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P82b_end_of_the_end">http://www.cidoc-crm.org/cidoc-crm/P82b_end_of_the_end</seealso>
    let P82b_end_of_the_end =
        Prefixed_Name(cidoc, "P82b_end_of_the_end") |> PrefixedName
    ...
    /// "</para>
    /// labels<para>"durou no mínimo"</para><para>"hatte Mindestdauer"</para><para>"είχε ελάχιστη διάρκεια"</para><para>"a duré au moins"</para><para>"had at least duration"</para><para>"имеет длительность по крайней мере больше чем"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"был минимальной длительностью для"</para><para>"was minimum duration of"</para><para>"war Mindestdauer von"</para><para>"foi a duração mínima de"</para><para>"a été la durée minimum de"</para><para>"είναι ελάχιστη διάρκεια του/της"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"a duré au plus"</para><para>"hatte Höchstdauer"</para><para>"durou no máximo"</para><para>"είχε μέγιστη διάρκεια"</para><para>"had at most duration"</para><para>"имеет длительность меньше чем"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"foi a duração máxima de"</para><para>"είναι μέγιστη διάρκεια του/της"</para><para>"was maximum duration of"</para><para>"war längste Dauer von"</para><para>"был максимальной длительностью для"</para><para>"a été la durée maximum de"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"περιέχεται σε"</para><para>"está contido em"</para><para>"fällt in"</para><para>"falls within"</para><para>"s’insère dans"</para><para>"содержится в"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"содержит"</para><para>"contains"</para><para>"περιέχει"</para><para>"enthält"</para><para>"contém"</para><para>"inclut"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"is identified by"</para><para>"αναγνωρίζεται ως"</para><para>"é identificado por"</para><para>"est identifié par"</para><para>"идентифицируется посредством"</para><para>"wird bezeichnet als"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"identifie"</para><para>"identifica"</para><para>"είναι αναγνωριστικό"</para><para>"bezeichnet"</para><para>"идентифицирует"</para><para>"identifies"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"consiste de"</para><para>"αποτελείται από"</para><para>"est en"</para><para>"сделан из"</para><para>"consists of"</para><para>"besteht aus"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"faz parte de"</para><para>"είναι τμήμα του"</para><para>"bildet Teil von"</para><para>"формирует часть"</para><para>"fait partie de"</para><para>"forms part of"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"s’insère dans"</para><para>"fällt in"</para><para>"falls within"</para><para>"περιέχεται σε"</para><para>"содержится в"</para><para>"está contido em"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"содержит"</para><para>"enthält"</para><para>"contém"</para><para>"περιέχει"</para><para>"contains"</para><para>"inclut"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"έλαβε χώρα σε ή εντός"</para><para>"ocorreu em ou dentro"</para><para>"имел место на или в"</para><para>"a eu lieu sur ou dans"</para><para>"took place on or within"</para><para>"fand statt auf oder innerhalb von "</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"testemunhou"</para><para>"a été témoin de"</para><para>"bezeugte"</para><para>"witnessed"</para><para>"являлся местом для"</para><para>"υπήρξε τόπος του"</para></remarks>
    ...
    ///   <para>"This property allows an instance of E54 Dimension to be approximated by an instance of E60 Number primitive."</para>
    /// labels<para>"Î­Ï‡ÎµÎ¹ Ï„Î¹Î¼Î®"</para><para>"æœ‰æ•°å€¼"</para><para>"имеет значение"</para><para>"Ð¸Ð¼ÐµÐµÑ‚ Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ðµ"</para><para>"έχει τιμή"</para><para>"a la valeur"</para><para>"has value"</para><para>"hat Wert"</para><para>"tem valor"</para></remarks>
    ...
    /// <summary>
    ///   <para>cidoc:P90a_has_lower_value_limit</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"has lower value limit"</para></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P90a_has_lower_value_limit">http://www.cidoc-crm.org/cidoc-crm/P90a_has_lower_value_limit</seealso>
    let P90a_has_lower_value_limit =
        Prefixed_Name(cidoc, "P90a_has_lower_value_limit") |> PrefixedName

    /// <summary>
    ///   <para>cidoc:P90b_has_upper_value_limit</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"has upper value limit"</para></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/P90b_has_upper_value_limit">http://www.cidoc-crm.org/cidoc-crm/P90b_has_upper_value_limit</seealso>
    let P90b_has_upper_value_limit =
        Prefixed_Name(cidoc, "P90b_has_upper_value_limit") |> PrefixedName
    ...
    /// labels<para>"has unit"</para><para>"hat Einheit"</para><para>"имеет единицу"</para><para>"a pour unité"</para><para>"έχει μονάδα μέτρησης"</para><para>"tem unidade"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"ist Einheit von"</para><para>"является единицей для"</para><para>"est l'unité de"</para><para>"αποτελεί μονάδα μέτρησης του/της"</para><para>"is unit of"</para><para>"é unidade de"</para></remarks>
    ...
    /// labels<para>"a fait exister"</para><para>"brought into existence"</para><para>"brachte in Existenz"</para><para>"создал"</para><para>"γέννησε"</para><para>"trouxe à existência"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"a commencé à exister du fait de"</para><para>"γεννήθηκε από"</para><para>"was brought into existence by"</para><para>"wurde in Existenz gebracht durch"</para><para>"был создан посредством"</para><para>"passou a existir por"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"cessou a existência de"</para><para>"a fait cesser d’exister"</para><para>"αναίρεσε"</para><para>"took out of existence"</para><para>"beendete die Existenz von"</para><para>"положил конец существованию"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"was taken out of existence by"</para><para>"deixou de existir"</para><para>"a cessé d’exister du fait de"</para><para>"αναιρέθηκε από"</para><para>"wurde seiner Existenz beraubt durch"</para><para>"прекратил существование посредством"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"has created"</para><para>"hat erschaffen"</para><para>"δημιούργησε"</para><para>"criou"</para><para>"a créé"</para><para>"создал"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"foi criado por"</para><para>"was created by"</para><para>"a été créé par"</para><para>"δημιουργήθηκε από"</para><para>"wurde erschaffen durch"</para><para>"был создан посредством"</para></remarks>
    ...
    ///   <para>"This property associates the instance of E66 Formation with the instance of E74 Group that it founded."</para>
    /// labels<para>"has formed"</para><para>"ÏƒÏ‡Î·Î¼Î¬Ï„Î¹ÏƒÎµ"</para><para>"hat gebildet"</para><para>"σχημάτισε"</para><para>"formou"</para><para>"a fondÃ©"</para><para>"å·²ç»ç»„æˆ"</para><para>"a fondé"</para><para>"сформировал"</para><para>"ÑÑ„Ð¾Ñ€Ð¼Ð¸Ñ€Ð¾Ð²Ð°Ð»"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"a été fondé par"</para><para>"wurde gebildet von"</para><para>"was formed by"</para><para>"foi formado por"</para><para>"σχηματίστηκε από"</para><para>"была сформирована посредством"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"by mother"</para><para>"de mère"</para><para>"durch Mutter"</para><para>"pela mãe"</para><para>"είχε μητέρα"</para><para>"посредством матери"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"gave birth"</para><para>"a donné naissance à"</para><para>"дал рождение"</para><para>"gebar"</para><para>"deu nascimento"</para><para>"ήταν μητέρα του/της"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"pelo pai"</para><para>"είχε πατέρα"</para><para>"de père"</para><para>"от отца"</para><para>"gab Vaterschaft"</para><para>"from father"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"war Vater für"</para><para>"a été père dans"</para><para>"foi pai para"</para><para>"ήταν πατέρας του/της"</para><para>"was father for"</para><para>"был отцом для"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"породил"</para><para>"brought into life"</para><para>"trouxe à vida"</para><para>"a donné vie à"</para><para>"brachte zur Welt"</para><para>"έφερε στη ζωή"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"wurde geboren durch"</para><para>"was born"</para><para>"γεννήθηκε"</para><para>"был рожден"</para><para>"est né"</para><para>"veio à vida pelo"</para></remarks>
    ...
    ///   <para>"This property associates the instance of E68 Dissolution with the instance of E74 Group that it disbanded."</para>
    /// labels<para>"Ñ€Ð°ÑÐ¿ÑƒÑÑ‚Ð¸Ð»"</para><para>"lÃ¶ste auf"</para><para>"dissolved"</para><para>"è§£æ•£äº†"</para><para>"dissolveu"</para><para>"a dissous"</para><para>"löste auf"</para><para>"διέλυσε"</para><para>"Î´Î¹Î­Î»Ï…ÏƒÎµ"</para><para>"распустил"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"foi dissolvido por"</para><para>"был распущен посредством"</para><para>"διαλύθηκε από"</para><para>"was dissolved by"</para><para>"a été dissous par"</para><para>"wurde aufgelöst durch"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"consiste en"</para><para>"consists of"</para><para>"consiste de"</para><para>"αποτελείται από"</para><para>"setzt sich zusammen aus"</para><para>"состоит из"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"формирует часть"</para><para>"faz parte de"</para><para>"forms part of"</para><para>"bildet Teil von"</para><para>"fait partie de"</para><para>"αποτελεί μέρος του/της"</para></remarks>
    ...
    /// <summary>
    ///   <para>cidoc:PC0_Typed_CRM_Property</para>
    /// </summary>
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"PC0 Typed CRM Property"</para></remarks>
    /// <seealso href="http://www.cidoc-crm.org/cidoc-crm/PC0_Typed_CRM_Property">http://www.cidoc-crm.org/cidoc-crm/PC0_Typed_CRM_Property</seealso>
    let PC0_Typed_CRM_Property =
        Prefixed_Name(cidoc, "PC0_Typed_CRM_Property") |> PrefixedName
