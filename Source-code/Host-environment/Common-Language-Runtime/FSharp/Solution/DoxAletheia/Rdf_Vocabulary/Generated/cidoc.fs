...
module cidoc =
    ...
    /// </para>
    /// labels<para>Событие Изменения</para><para>Modification</para><para>Modification</para><para>Τροποποίηση</para><para>Bearbeitung</para><para>Modificação</para></remarks>
    ...
    /// </para>
    /// labels<para>Appellation</para><para>Appellation</para><para>Обозначение</para><para>Designação</para><para>Benennung</para><para>Ονομασία</para></remarks>
    ...
    /// </para>
    /// labels<para>Estado Material</para><para>Condition State</para><para>Zustandsphase</para><para>État matériel</para><para>Состояние</para><para>Κατάσταση</para></remarks>
    ...
    /// </para>
    /// labels<para>Menschliche Gruppe</para><para>Groupe</para><para>Группа</para><para>Grupo</para><para>Group</para><para>Ομάδα</para></remarks>
    ...
    /// labels<para>Suporte de Informação</para><para>Support d'information</para><para>Носитель Информации</para><para>Information Carrier</para><para>Informationsträger</para><para>Φορέας Πληροφορίας</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>wurde beendet mit</para><para>é finalizada por</para><para>est terminée par</para><para>περατώνεται με</para><para>is finished by</para><para>заканчивается</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>περιλαμβάνει</para><para>beinhaltet</para><para>comporte</para><para>includes</para><para>включает</para><para>inclui</para></remarks>
    ...
    /// </para>
    /// labels<para>est partiellement recouverte dans le temps par</para><para>προηγείται μερικώς επικαλύπτοντας</para><para>sobrepõe temporalmente</para><para>überlappt zeitlich mit</para><para>перекрывает во времени</para><para>overlaps in time with</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>recouvre partiellement dans le temps</para><para>é sobreposto temporalmente por</para><para>έπεται μερικώς επικαλυπτόμενο</para><para>wird zeitlich überlappt von</para><para>перекрывается во времени</para><para>is overlapped in time by</para></remarks>
    ...
    /// </para>
    /// labels<para>a eu pour participant</para><para>tem participante</para><para>hatte Teilnehmer</para><para>had participant</para><para>είχε συμμέτοχο</para><para>имел участника</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>оказал влияние на</para><para>influenciou</para><para>beeinflußte</para><para>a influencé</para><para>influenced</para><para>επηρέασε</para></remarks>
    ...
    /// labels<para>δημιούργησε τύπο</para><para>a créé le type</para><para>erschuf Typus</para><para>created type</para><para>criou tipo</para><para>создал тип</para></remarks>
    ...
    /// labels<para>tinha propósito específico</para><para>hatte den bestimmten Zweck</para><para>avait pour but spécifique</para><para>είχε συγκεκριμένο σκοπό</para><para>had specific purpose</para><para>имел конкретную цель</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>mudou de proprietário por meio de</para><para>a changé de mains du fait de</para><para>changed ownership through</para><para>ging über in Besitz durch</para><para>άλλαξε ιδιοκτησία μέσω</para><para>сменил владельца через</para></remarks>
    ...
    /// </para>
    /// labels<para>μετακινήθηκε προς</para><para>locomoveu para</para><para>bewegte bis zu</para><para>a déplacé vers</para><para>перемещен в</para><para>moved to</para></remarks>
    ...
    /// </para>
    /// labels<para>a eu lieu dans</para><para>took place at</para><para>совершался на</para><para>fand statt in</para><para>έλαβε χώρα σε</para><para>ocorreu em</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>был исходной точкой для</para><para>ήταν αφετηρία του/της</para><para>war Ausgangsort von</para><para>a été l'origine de</para><para>era origem de</para><para>was origin of</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>является бывшим или текущим владельцем для</para><para>ist früherer oder derzeitiger Besitzer von</para><para>είναι ή ήταν ιδιοκτήτης του/της</para><para>is former or current owner of</para><para>est ou a été propriétaire de</para><para>é ou foi proprietário de</para></remarks>
    ...
    /// </para>
    /// labels<para>est actuellement possédée par</para><para>имеет текущего владельца</para><para>hat derzeitigen Besitzer</para><para>has current owner</para><para>é propriedade de</para><para>έχει ιδιοκτήτη</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>est localisation actuelle de</para><para>в данный момент содержит</para><para>é localização atual de</para><para>currently holds</para><para>είναι θέση του</para><para>hält derzeitig</para></remarks>
    ...
    /// </para>
    /// labels<para>présente pour caractéristique</para><para>possui característica</para><para>несет признак</para><para>bears feature</para><para>φέρει μόρφωμα</para><para>trägt Merkmal</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>был максимальной длительностью для</para><para>είναι μέγιστη διάρκεια του/της</para><para>a été la durée maximum de</para><para>foi a duração máxima de</para><para>was maximum duration of</para><para>war längste Dauer von</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>contains</para><para>περιέχει</para><para>содержит</para><para>enthält</para><para>contém</para><para>inclut</para></remarks>
    ...
    /// </para>
    /// labels<para>αποτελείται από</para><para>besteht aus</para><para>consists of</para><para>consiste de</para><para>сделан из</para><para>est en</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>είναι τμήμα του</para><para>формирует часть</para><para>bildet Teil von</para><para>fait partie de</para><para>forms part of</para><para>faz parte de</para></remarks>
    ...
    /// labels<para>имеет значение</para><para>a la valeur</para><para>has value</para><para>έχει τιμή</para><para>tem valor</para><para>hat Wert</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>была сформирована посредством</para><para>wurde gebildet von</para><para>σχηματίστηκε από</para><para>foi formado por</para><para>a été fondé par</para><para>was formed by</para></remarks>
    ...
    /// </para>
    /// labels<para>gab Vaterschaft</para><para>from father</para><para>είχε πατέρα</para><para>pelo pai</para><para>от отца</para><para>de père</para></remarks>
    ...
    /// labels<para>löste auf</para><para>dissolveu</para><para>распустил</para><para>a dissous</para><para>dissolved</para><para>διέλυσε</para></remarks>
    ...
    /// </para>
    /// labels<para>Деятельность</para><para>Atividade</para><para>Activity</para><para>Activité</para><para>Handlung</para><para>Δράση</para></remarks>
    ...
    /// </para>
    /// labels<para>Atribuição de Característica</para><para>Affectation d'attribut</para><para>Attribute Assignment</para><para>Присвоение Атрибута</para><para>Απόδοση Ιδιοτήτων</para><para>Merkmalszuweisung</para></remarks>
    ...
    /// </para>
    /// labels<para>Inscription</para><para>Inscription</para><para>Inschrift</para><para>Inscrição</para><para>Επιγραφή</para><para>Надпись</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>περιλαμβάνει</para><para>contains</para><para>содержит</para><para>contient</para><para>enthält</para><para>contém</para></remarks>
    ...
    /// </para>
    /// labels<para>fait référence à</para><para>αναφέρεται σε</para><para>verweist auf</para><para>ссылается на</para><para>referencia</para><para>refers to</para></remarks>
    ...
    /// </para>
    /// labels<para>имеет текущее или бывшее местожительства</para><para>hat derzeitigen oder früheren Sitz</para><para>has current or former residence</para><para>reside ou residiu em</para><para>έχει ή είχε κατοικία</para><para>réside ou a résidé à</para></remarks>
    ...
    /// </para>
    /// labels<para>Expertise de l'état matériel</para><para>Avaliação do Estado Material</para><para>Zustandsfeststellung</para><para>Condition Assessment</para><para>Εκτίμηση Κατάστασης</para><para>Оценка Состояния</para></remarks>
    ...
    /// </para>
    /// labels<para>Событие Измерения</para><para>Measurement</para><para>Mesurage</para><para>Μέτρηση</para><para>Messung</para><para>Medição</para></remarks>
    ...
    /// </para>
    /// labels<para>Νομικό Αντικείμενο</para><para>Objeto Jurídico</para><para>Objet juridique</para><para>Объект Права</para><para>Rechtsobjekt</para><para>Legal Object</para></remarks>
    ...
    /// </para>
    /// labels<para>Изображение</para><para>Εικόνα</para><para>Imagem</para><para>Image</para><para>Image</para><para>Bild</para></remarks>
    ...
    /// </para>
    /// labels<para>Designação de Local</para><para>Appellation de lieu</para><para>Place Appellation</para><para>Обозначение Места</para><para>Ονομασία Τόπου</para><para>Ortsbenennung</para></remarks>
    ...
    /// </para>
    /// labels<para>Пространственные Координаты</para><para>Coordonnées spatiales</para><para>Χωρικές Συντεταγμένες</para><para>Coordenadas Espaciais</para><para>Spatial Coordinates</para><para>Raumkoordinaten</para></remarks>
    ...
    /// labels<para>Appellation temporelle</para><para>Designação de Tempo</para><para>Обозначение Времени</para><para>Time Appellation</para><para>Ονομασία Χρόνου</para><para>Zeitbenennung</para></remarks>
    ...
    /// labels<para>Ημερομηνία</para><para>Datum</para><para>Date</para><para>Data</para><para>Date</para><para>Дата</para></remarks>
    ...
    /// labels<para>Τόπος</para><para>Место</para><para>Local</para><para>Place</para><para>Lieu</para><para>Ort</para></remarks>
    ...
    /// </para>
    /// labels<para>Τύπος</para><para>Typus</para><para>Tipo</para><para>Type</para><para>Type</para><para>Тип</para></remarks>
    ...
    /// labels<para>Material</para><para>Material</para><para>Matériau</para><para>Материал</para><para>Material</para><para>Υλικό</para></remarks>
    ...
    /// </para>
    /// labels<para>Destruction</para><para>Destruction</para><para>Разрушение</para><para>Zerstörung</para><para>Destruição</para><para>Καταστροφή</para></remarks>
    ...
    /// </para>
    /// labels<para>Πράγμα</para><para>Sache</para><para>Thing</para><para>Coisa</para><para>Chose</para><para></para></remarks>
    ...
    /// labels<para>Обозначение Концептуального Объекта</para><para>Designação de Objeto Conceitual</para><para>Begriff- oder Konzeptbenennung </para><para>Ονομασία Νοητικού Αντικειμένου</para><para>Appellation d'objet conceptuel</para><para>Conceptual Object Appellation</para></remarks>
    ...
    /// </para>
    /// labels<para>Collection</para><para>Collection</para><para>Коллекция</para><para>Sammlung</para><para>Συλλογή</para><para>Coleção</para></remarks>
    ...
    /// </para>
    /// labels<para>Soustraction d'élément</para><para>Remoção de Parte</para><para>Αφαίρεση Μερών</para><para>Teilentfernung</para><para>Удаление Части</para><para>Part Removal</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>wurde seiner Existenz beraubt durch</para><para>прекратил существование посредством</para><para>was taken out of existence by</para><para>a cessé d’exister du fait de</para><para>deixou de existir</para><para>αναιρέθηκε από</para></remarks>
    ...
    /// </para>
    /// labels<para>avait comme utilisation générale</para><para>hatte die allgemeine Verwendung</para><para>имел основное применение</para><para>είχε ως γενική χρήση</para><para>tem como uso geral</para><para>had as general use</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>war die Verwendung von</para><para>était l’utilisation de</para><para>был применением для</para><para>ήταν χρήση του/της</para><para>was use of</para><para>foi uso de</para></remarks>
    ...
    /// </para>
    /// labels<para>trägt den Titel</para><para>имеет заголовок</para><para>a pour titre</para><para>tem título</para><para>έχει τίτλο</para><para>has title</para></remarks>
    ...
    /// </para>
    /// labels<para>идентифицируется посредством</para><para>wird bezeichnet als</para><para>est identifiée par</para><para>é identificado por</para><para>is identified by</para><para>αναγνωρίζεται ως</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>является заголовком для</para><para>είναι τίτλος του/της</para><para>ist der Titel von</para><para>est le titre de</para><para>is title of</para><para>é título de</para></remarks>
    ...
    /// labels<para>was intended for</para><para>был задуман для</para><para>era destinado à</para><para>était destiné à</para><para>προοριζόταν για</para><para>bestimmt für</para></remarks>
    ...
    /// </para>
    /// labels<para>δικαίωμα κατέχεται από</para><para>право принадлежит</para><para>droit détenu par</para><para>são direitos de </para><para>Rechte stehen zu</para><para>right held by</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>ist derzeitiges oder früheres Mitglied von</para><para>является действующим или бывшим членом</para><para>is current or former member of</para><para>est actuel ou ancien membre de</para><para>είναι ή ήταν μέλος του/της</para><para>é ou foi membro de</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>был изменен посредством</para><para>wurde verändert durch</para><para>foi modificada por</para><para>a été modifié par</para><para>τροποποιήθηκε από</para><para>was modified by</para></remarks>
    ...
    /// </para>
    /// labels<para>hat früheren oder derzeitigen Betreuer</para><para>имеет бывшего или текущего смотрителя</para><para>has former or current keeper</para><para>είναι ή ήταν στην κατοχή του</para><para>est ou a été détenu par</para><para>é ou foi guardada por</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>является действующим или бывшим хранителем</para><para>ist derzeitiger oder früherer Kurator von</para><para>είναι ή ήταν επιμελητής του/της</para><para>est ou a été le conservateur de</para><para>is current or former curator of</para><para>é ou foi curador de</para></remarks>
    ...
    /// </para>
    /// labels<para>s’insère dans le cours de</para><para>находится в пределах</para><para>está contido em</para><para>falls within</para><para>fällt in</para><para>εμπίπτει</para></remarks>
    ...
    /// </para>
    /// labels<para>a augmenté</para><para>erweiterte</para><para>augmented</para><para>aumentou</para><para>увеличил</para><para>επαύξησε</para></remarks>
    ...
    /// </para>
    /// labels<para>fügte hinzu</para><para>adicionou</para><para>προσέθεσε</para><para>a ajouté</para><para>добавил</para><para>added</para></remarks>
    ...
    /// </para>
    /// labels<para>benutzte das bestimmte Objekt</para><para>a utilisé l'objet spécifique</para><para>χρησιμοποίησε αντικείμενο</para><para>использовал особый объект</para><para>usou objeto específico</para><para>used specific object</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>participated in</para><para>συμμετείχε σε</para><para>a participé à</para><para>участвовал в</para><para>nahm Teil an</para><para>participa em</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>появляется после</para><para>εμφανίζεται μετά</para><para>ocorre depois</para><para>a lieu après</para><para>occurs after</para><para>kommt nach</para></remarks>
    ...
    /// </para>
    /// labels<para>επικαλύπτεται με</para><para>пересекается с</para><para>overlaps with</para><para>überlappt mit</para><para>sobrepõe com</para><para>chevauche</para></remarks>
    ...
    /// </para>
    /// labels<para>трансформировал</para><para>a transformé</para><para>transformou</para><para>wandelte um</para><para>transformed</para><para>μετέτρεψε</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>был трансформирован посредством</para><para>wurde umgewandelt durch</para><para>foi transformado por</para><para>a été transformé par</para><para>was transformed by</para><para>μετατράπηκε από</para></remarks>
    ...
    /// </para>
    /// labels<para>χρησιμοποίησε</para><para>использовал</para><para>verwendete</para><para>a employé</para><para>employed</para><para>empregou</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>wurde verwendet bei</para><para>a été employé dans</para><para>χρησιμοποιήθηκε σε</para><para>foi empregado em</para><para>использовался в</para><para>was employed in</para></remarks>
    ...
    /// </para>
    /// labels<para>est au sujet de</para><para>έχει ως θέμα</para><para>handelt über</para><para>is about</para><para>касается</para><para>é sobre</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>имеет ссылку на себя от</para><para>wird angeführt von</para><para>é referenciado por</para><para>is referred to by</para><para>est référencé par</para><para>αναφέρεται από</para></remarks>
    ...
    /// </para>
    /// labels<para>идентифицируется посредством</para><para>wird identifziert durch</para><para>é identificado por</para><para>est identifié par</para><para>αναγνωρίζεται ως</para><para>is identified by</para></remarks>
    ...
    /// </para>
    /// labels<para>setzte sich fort in</para><para>est la suite de</para><para>continued</para><para>continuou</para><para>продолжил</para><para>συνέχισε</para></remarks>
    ...
    /// </para>
    /// labels<para>находился под влиянием</para><para>wurde beeinflußt durch</para><para>foi influenciado por </para><para>a été influencée par</para><para>was influenced by</para><para>επηρεάστηκε από</para></remarks>
    ...
    /// </para>
    /// labels<para>hat erschaffen</para><para>δημιούργησε</para><para>has created</para><para>a créé</para><para>создал</para><para>criou</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>wurde geschaffen durch</para><para>был создан посредством</para><para>δημιουργήθηκε από</para><para>foi criado por</para><para>a été créé par</para><para>was created by</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>был создан посредством</para><para>wurde erschaffen durch</para><para>δημιουργήθηκε από</para><para>foi criado por</para><para>a été créé par</para><para>was created by</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>a justifié la création de type</para><para>υποστήριξε τη δημιουργία τύπου</para><para>suportou a criação de tipo</para><para>supported type creation</para><para>поддержал создание типа</para><para>belegte</para></remarks>
    ...
    /// </para>
    /// labels<para>hat den Typus</para><para>est de type</para><para>имеет тип</para><para>έχει τύπο</para><para>é do tipo</para><para>has type</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>erläutert durch Beispiel</para><para>поясняется посредством</para><para>est exemplifié par</para><para>δειγματίζεται από</para><para>is exemplified by</para><para>exemplifica</para></remarks>
    ...
    /// </para>
    /// labels<para>представляет</para><para>stellt dar</para><para>represents</para><para>representa</para><para>παριστάνει</para><para>représente</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>wird dargestellt durch</para><para>имеет представление</para><para>est représentée par</para><para>has representation</para><para>tem representação</para><para>παριστάνεται από</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>bekam Merkmal zugewiesen durch</para><para>получил атрибут посредством</para><para>a reçu un attribut par</para><para>χαρακτηρίστηκε από</para><para>was attributed by</para><para>foi atribuído por</para></remarks>
    ...
    /// </para>
    /// labels<para>a attribué</para><para>assigned</para><para>atribuiu</para><para>присвоил</para><para>απέδωσε</para><para>wies zu</para></remarks>
    ...
    /// </para>
    /// labels<para>wurde ausgeführt von</para><para>πραγματοποιήθηκε από</para><para>carried out by</para><para>realizada por</para><para>réalisée par</para><para>выполнялся</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>ήταν αφορμή</para><para>обусловил</para><para>motivated</para><para>a motivé</para><para>regte an</para><para>motivou</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>a été la technique mise en œuvre dans</para><para>ήταν τεχνική του/της</para><para>war Verfahren von</para><para>был техникой для</para><para>was technique of</para><para>foi técnica da</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>идентифицирован посредством</para><para>wurde identifiziert durch</para><para>foi identificado por</para><para>έχει διαπιστωθεί από</para><para>est identifié par</para><para>was identified by</para></remarks>
    ...
    /// </para>
    /// labels<para>a attribué</para><para>assigned</para><para>atribuiu</para><para>назначил</para><para>απέδωσε</para><para>wies zu</para></remarks>
    ...
    /// </para>
    /// labels<para>measured</para><para>a mesuré</para><para>μέτρησε</para><para>измерил</para><para>vermaß</para><para>mediu</para></remarks>
    ...
    /// </para>
    /// labels<para>имеет примечание</para><para>έχει επεξήγηση</para><para>hat Anmerkung</para><para>a pour note</para><para>has note</para><para>tem nota</para></remarks>
    ...
    /// </para>
    /// labels<para>a relevé comme dimension</para><para>beobachtete Dimension</para><para>verificou a dimensão</para><para>определил величину</para><para>observed dimension</para><para>παρατήρησε</para></remarks>
    ...
    /// </para>
    /// labels<para>απέδωσε ως ιδιότητα</para><para>a attribué</para><para>назначил</para><para>assigned</para><para>atribuiu</para><para>wies zu</para></remarks>
    ...
    /// </para>
    /// labels<para>a pour dimension</para><para>имеет величину</para><para>hat Dimension</para><para>has dimension</para><para>έχει μέγεθος</para><para>tem dimensão</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>является величиной для</para><para>ist Dimension von</para><para>είναι μέγεθος του</para><para>est dimension de</para><para>is dimension of</para><para>é dimensão de</para></remarks>
    ...
    /// </para>
    /// labels<para>a pour état matériel</para><para>tem estado material </para><para>έχει κατάσταση</para><para>имеет условие</para><para>has condition</para><para>hat Zustand</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>является условием для</para><para>είναι κατάσταση του</para><para>estado material de</para><para>état matériel de</para><para>is condition of</para><para>ist Zustand von</para></remarks>
    ...
    /// labels<para>αποτελείται από</para><para>составлен из</para><para>consiste en</para><para>consiste de</para><para>consists of</para><para>besteht aus</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>είναι ενσωματωμένος/η/ο σε</para><para>is incorporated in</para><para>está presente em</para><para>est présent dans</para><para>ist enthalten in</para><para>входит в состав</para></remarks>
    ...
    /// </para>
    /// labels<para>ist zusammengesetzt aus</para><para>est composée de</para><para>αποτελείται από</para><para>is composed of</para><para>é composto de</para><para>составлен из</para></remarks>
    ...
    /// </para>
    /// labels<para>a pour section</para><para>has section</para><para>hat Bereich</para><para>имеет район</para><para>έχει τομέα</para><para>tem seção</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>está localizada sobre ou dentro de</para><para>befindet sich auf oder in</para><para>находится на или внутри</para><para>is located on or within</para><para>βρίσκεται σε ή εντός</para><para>se situe sur ou dans</para></remarks>
    ...
    /// labels<para>αποτελείται από</para><para>consiste de</para><para>consiste en</para><para>consists of</para><para>besteht aus</para><para>состоит из</para></remarks>
    ...
    /// </para>
    /// labels<para>απεικονίζει</para><para>bildet ab</para><para>описывает</para><para>depicts</para><para>retrata</para><para>figure</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>wird abgebildet durch</para><para>описан посредством</para><para>απεικονίζεται σε</para><para>est figurée sur</para><para>é retratada por</para><para>is depicted by</para></remarks>
    ...
    /// </para>
    /// labels<para>документирует</para><para>τεκμηριώνει</para><para>mentionne</para><para>documents</para><para>documenta</para><para>belegt</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>est mentionnée dans</para><para>is documented in</para><para>é documentado em</para><para>документирован в</para><para>τεκμηριώνεται σε</para><para>wird belegt in</para></remarks>
    ...
    /// </para>
    /// labels<para>περιλαμβάνει</para><para>перечисляет</para><para>définit</para><para>define</para><para>listet</para><para>lists</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>wird aufgelistet in</para><para>περιλαμβάνεται σε</para><para>est défini par</para><para>é definido por</para><para>перечислен в</para><para>is listed in</para></remarks>
    ...
    /// </para>
    /// labels<para>est en langue</para><para>é da língua </para><para>has language</para><para>έχει γλώσσα</para><para>hat Sprache</para><para>имеет язык</para></remarks>
    ...
    /// </para>
    /// labels<para>a pour traduction</para><para>hat Übersetzung</para><para>has translation</para><para>έχει μετάφραση</para><para>имеет перевод</para><para>tem tradução</para></remarks>
    ...
    /// labels<para>est détenteur de</para><para>é detentor de</para><para>possesses</para><para>besitzt</para><para>владеет</para><para>κατέχει</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>sind im Besitz von</para><para>is possessed by</para><para>são detidos por</para><para>est détenu par</para><para>κατέχεται από</para><para>принадлежит</para></remarks>
    ...
    /// labels<para>идентифицируется посредством</para><para>é identificado por </para><para>wird bezeichnet als</para><para>est identifiée par</para><para>αναγνωρίζεται ως</para><para>is identified by</para></remarks>
    ...
    /// </para>
    /// labels<para>Временная Сущность</para><para>Entidade Temporal</para><para>Entité temporelle</para><para>Έγχρονη  Οντότητα</para><para>Temporal Entity</para><para>Geschehendes</para></remarks>
    ...
    /// labels<para>Δικαίωμα</para><para>Direitos</para><para>Droit</para><para>Recht</para><para>Right</para><para>Право</para></remarks>
    ...
    /// </para>
    /// labels<para>Documento</para><para>Документ</para><para>Dokument</para><para>Τεκμήριο</para><para>Document</para><para>Document</para></remarks>
    ...
    /// </para>
    /// labels<para>Language</para><para>Sprache</para><para>Língua</para><para>Langue</para><para>Γλώσσα</para><para>Язык</para></remarks>
    ...
    /// </para>
    /// labels<para>Единица Измерения</para><para>Unidade de Medida</para><para>Measurement Unit</para><para>Unité de mesure</para><para>Μονάδα Μέτρησης</para><para>Maßeinheit</para></remarks>
    ...
    /// In reality, custody is either transferred to someone or from someone, or both.
    /// </para>
    /// labels<para>changement de détenteur au détriment de</para><para>custody surrendered by</para><para>custódia concedida por</para><para>μετεβίβασε κατοχή από</para><para>übergab Gewahrsam an</para><para>опека отдана</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>vorgesehen für Gebrauch durch defined</para><para>обычно используется посредством</para><para>est habituellement utilisé par</para><para>συνήθως χρησιμοποιείται από</para><para>use foreseen by</para><para>é empregado por</para></remarks>
    ...
    /// </para>
    /// labels<para>is associated with</para><para>ist verbunden mit</para><para>é associado com</para><para>ассоциирован с</para><para>est associée à</para><para>σχετίζεται με</para></remarks>
    ...
    /// </para>
    /// labels<para>Attribution de type</para><para>Atribuição de Tipo</para><para>Присвоение Типа</para><para>Type Assignment</para><para>Typuszuweisung</para><para>Απόδοση Τύπου</para></remarks>
    ...
    /// </para>
    /// labels<para>Οντότητα CIDOC CRM</para><para>Entidade CRM</para><para>CRM Сущность</para><para>CRM Entität</para><para>CRM Entity</para><para>Entité CRM</para></remarks>
    ...
    /// </para>
    /// labels<para>Sprachlicher Gegenstand</para><para>Линвистический Объект</para><para>Γλωσσικό Αντικείμενο</para><para>Objeto Lingüístico</para><para>Objet linguistique</para><para>Linguistic Object</para></remarks>
    ...
    /// </para>
    /// labels<para>Σήμανση</para><para>Пометка</para><para>Marque</para><para>Marca</para><para>Marke</para><para>Mark</para></remarks>
    ...
    /// </para>
    /// labels<para>Визуальный Предмет</para><para>Οπτικό Στοιχείο</para><para>Item Visual</para><para>Visual Item</para><para>Item visuel</para><para>Bildliches</para></remarks>
    ...
    /// labels<para>entfernte</para><para>a enlevé</para><para>αφαίρεσε</para><para>removed</para><para>removeu</para><para>удален</para></remarks>
    ...
    /// </para>
    /// labels<para>Materieller Gegenstand</para><para>Физический Объект</para><para>Υλικό Αντικείμενο</para><para>Objeto Material</para><para>Physical Object</para><para>Objet matériel</para></remarks>
    ...
    /// </para>
    /// labels<para>Personne</para><para>Личность</para><para>Πρόσωπο</para><para>Person</para><para>Pessoa</para><para>Person</para></remarks>
    ...
    /// </para>
    /// labels<para>Δράστης</para><para>Akteur</para><para>Agente</para><para>Agent</para><para>Actor</para><para>Агент</para></remarks>
    ...
    /// </para>
    /// labels<para>Ανθρώπινο Δημιούργημα</para><para>Рукотворная Вещь</para><para>Chose fabriquée</para><para>Coisa Fabricada</para><para>Man-Made Thing</para><para>Künstliches</para></remarks>
    ...
    /// </para>
    /// labels<para>Περίοδος</para><para>Período</para><para>Période</para><para>Period</para><para>Период</para><para>Phase</para></remarks>
    ...
    /// </para>
    /// labels<para>has modified</para><para>τροποποίησε</para><para>veränderte</para><para>a modifié</para><para>modificou</para><para>изменил</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>был произведен посредством</para><para>wurde hergestellt durch</para><para>a été produit par</para><para>foi produzido por</para><para>was produced by</para><para>παρήχθη από</para></remarks>
    ...
    /// </para>
    /// labels<para>χρησιμοποίησε αντικείμενο τύπου</para><para>a employé un objet du type</para><para>benutzte Objekt des Typus</para><para>использовал объект типа</para><para>used object of type</para><para>usou objeto do tipo</para></remarks>
    ...
    /// </para>
    /// labels<para>καθόλη τη διάρκεια του/της</para><para>ongoing throughout</para><para>andauernd während</para><para>abrange no mínimo</para><para>длится в течение</para><para>couvre au moins</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>был уменьшен посредством</para><para>wurde vermindert durch</para><para>foi diminuído por</para><para>was diminished by</para><para>a été diminué par</para><para>εξαλείφθηκε από</para></remarks>
    ...
    /// </para>
    /// labels<para>fronteira com</para><para>borders with</para><para>συνορεύει με</para><para>граничит с</para><para>grenzt an</para><para>jouxte</para></remarks>
    ...
    /// </para>
    /// labels<para>κατέστρεψε</para><para>destroyed</para><para>a détruit</para><para>zerstörte</para><para>уничтожил</para><para>destruiu</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>ήταν πατέρας του/της</para><para>a été père dans</para><para>was father for</para><para>был отцом для</para><para>war Vater für</para><para>foi pai para</para></remarks>
    ...
    /// </para>
    /// labels<para>заканчивает</para><para>περατώνει</para><para>finishes</para><para>finaliza</para><para>beendet</para><para>termine</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>перемещен посредством</para><para>wurde bewegt durch</para><para>foi locomovido por</para><para>a été déplacé par</para><para>μετακινήθηκε από</para><para>moved by</para></remarks>
    ...
    /// </para>
    /// labels<para>está contido em</para><para>s’insère dans</para><para>περιέχεται σε</para><para>falls within</para><para>содержится в</para><para>fällt in</para></remarks>
