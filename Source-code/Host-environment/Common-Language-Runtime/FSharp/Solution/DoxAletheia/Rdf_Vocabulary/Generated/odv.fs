...
module odv =
    ...
    ///   <para>"The structure of a cube containing data about the number of junior staff of different grades that report to a particular post from within a particular unit, with a particular job and a particular profession, on a particular day."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdfs:Resource</para>
    ///   <para>qb:DataStructureDefinition</para>
    ///   <para>"The structure of a cube containing data about the number of posts of different grades that report to a particular post on a particular day."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>qb:DataStructureDefinition</para>
    ///   <para>rdfs:Resource</para>
    ///   <para>"The structure of a cube containing data about the salary costs of the reports to a particular post on a particular day."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>rdfs:Resource</para>
    ///   <para>qb:DataStructureDefinition</para>
    ///   <para>"The structure of a cube containing data about the total pay received for a particular tenure (a person in a post) on a particular day."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
