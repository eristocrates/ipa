...
module owl_time =
    ...
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.w3.org/2006/time#">http://www.w3.org/2006/time#</seealso>
    let _prefix_iri = Prefixed_Name(owl_time, "") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"Duration"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Time duration"</para></remarks>
    ...
    /// <summary>
    ///   <para>owl_time:Instance</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.w3.org/2006/time#Instance">http://www.w3.org/2006/time#Instance</seealso>
    let Instance = Prefixed_Name(owl_time, "Instance") |> PrefixedName
    /// <summary>
    ...
    ///   <para>"See http://www.w3.org/TR/owl-time/"</para>
    ///   <para>"A temporal entity with zero extent or duration"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"An gufo:AbstractIndividual that reifies time instants. It is used as a target of the gufo:hasBeginPoint and gufo:hasEndPoint object properties."</para>
    /// labels<para>"Instant"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Instant"</para><para>"Time instant"</para><para>"Time instant"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>"A temporal entity with an extent or duration."</para>
    ///   <para>"Una entidad temporal con una extensiÃ³n o duraciÃ³n."</para>
    /// labels<para>"Interval"</para><para>"Interval"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"intervalo de tiempo"</para><para>"A temporal entity with an extent or duration"</para><para>"Time interval"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"January"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>"A TemporalEntity describes the temporal dimension of a WeatherState. This can either be a specific moment (an Instant that has a specific time) or a period of time (an Interval having a start time and an end time)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"Un intervalo temporal o un instante."</para>
    ///   <para>"Un instante o intervalo temporal"</para>
    ///   <para>"See http://www.w3.org/TR/owl-time/"</para>
    ///   <para>"A temporal interval or instant."^^&lt;http://www.w3.org/2001/XMLSchema#anyURI&gt;</para>
    ///   <para>"A temporal interval or instant."</para>
    /// labels<para>"Entidad temporal"</para><para>"entidad temporal"</para><para>"Temporal entity"^^&lt;http://www.w3.org/2001/XMLSchema#anyURI&gt;</para><para>"Temporal entity"</para><para>"Temporal Entity"</para></remarks>
    ...
    ///   <para>"A temporal unit of measure, which provides a scale factor for a time quantity."</para>
    /// labels<para>"Temporal unit"</para><para>"Temporal Unit"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>owl:DeprecatedClass</para>
    ///   <para>"Year duration"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>"Comienzo de una entidad temporal."</para>
    ///   <para>"Fecha en la que finaliza la pertenicia al puesto"</para>
    ///   <para>"Beginning of a temporal entity."^^&lt;http://www.w3.org/2001/XMLSchema#anyURI&gt;</para>
    /// labels<para>"Fecha de inicio"</para><para>"tiene principio"</para><para>"has beginning"^^&lt;http://www.w3.org/2001/XMLSchema#anyURI&gt;</para><para>"start time"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"has beginning"</para></remarks>
    ...
    ///   <para>"Final de una entidad temporal."</para>
    /// labels<para>"Fecha de fin"</para><para>"has end"</para><para>"end time"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"tiene fin"</para></remarks>
    ...
    ///   <para>"Proporciona soporte a la asociación de una entidad temporal (instante o intervalo) a cualquier cosa."</para>
    /// labels<para>"has time"</para><para>"tiene tiempo"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Position of an instant, expressed using xsd:date"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"Position of an instant, expressed using xsd:date"</para>
    /// labels<para>"in XSD date"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"in XSD date"</para><para>"date"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>"See hhttp://www.w3.org/TR/owl-time/"</para>
    ///   <para>"It is the property relating Time Instant with the datetime value"</para>
    /// labels<para>"In XSD DateTime"</para><para>"in XSD Date-Time"</para></remarks>
    ...
    /// labels<para>"Months"</para><para>"months duration"</para></remarks>
    ...
    /// labels<para>"numeric duration"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Numeric value of temporal duration"</para></remarks>
    ...
    /// labels<para>"in time zone"</para><para>"fuso orario"</para><para>"time zone"</para></remarks>
    /// <seealso href="http://www.w3.org/2006/time#timeZone">http://www.w3.org/2006/time#timeZone</seealso>
    let timeZone = Prefixed_Name(owl_time, "timeZone") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"unit type"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"temporal unit type"</para></remarks>
    ...
    /// labels<para>"Years"</para><para>"years duration"</para></remarks>
