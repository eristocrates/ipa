...
module fresnel =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>This is a convenience class for the OWL specification of Fresnel (an rdf:List of resource selectors only).</para>
    /// </remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Abstract class of pseudo properties.</para>
    /// labels<para>Convenience Property</para></remarks>
    ...
    ///   <para>Assign content formatting to a set of values (only works in conjunction with propertyFormatDomain).</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Assign content formatting to a set of resources (only works in conjunction with classFormatDomain and instanceFormatDomain).</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The Format should be applied to this set of instances.</para>
    /// labels<para>instance format domain</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Description of fresnel:Format content separators and content replacement if values are missing.</para>
    /// labels<para>Format Description Substitution</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Specifies how a property value is displayed (only works in conjunction with propertyFormatDomain).</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Abstract superclass of all property value display styles.</para>
    /// labels<para>Property value display style</para></remarks>
    ...
    ///   <para>Attaching a symbol appropriate for styling labels (only works in conjunction with propertyFormatDomain).</para>
    /// labels<para>label style</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Specifies the format group to which a format or a lens belongs.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The Format should be used for the specified properties.</para>
    /// labels<para>property format domain</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Specifies a purpose for which a lens or format might be appropriate.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Propose in which a specific lens might be appropriate.</para>
    /// labels<para>Purpose</para></remarks>
    /// <seealso href="http://www.w3.org/2004/09/fresnel#Purpose">http://www.w3.org/2004/09/fresnel#Purpose</seealso>
    let Purpose = Prefixed_Name(fresnel, "Purpose") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Attaching a symbol appropriate for styling properties (only works in conjunction with propertyFormatDomain).</para>
    /// labels<para>property style</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Assign content formatting to a set of labels (theoretically, this does not make much sense, but it does round out the set of formatting properties; only works in conjunction with propertyFormatDomain).</para>
    /// labels<para>label format</para></remarks>
    ...
    /// <remarks>
    ///   <para>fresnel:Purpose</para>
    ///   <para>Lens for providing a label for a resource.</para>
    /// labels<para>Label Lens</para></remarks>
    ...
    /// <remarks>
    ///   <para>fresnel:ConvienceProperty</para>
    ///   <para>A special token to indicate the relationship between any RDF container or collection (rdf:List) and its member items.  Do not use as anything other than an individual.</para>
    ...
    ///   <para>Show the RDFS Label of the property. This is the default and doesn't have to be declared.</para>
    /// labels<para>Show Label</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The lens is usable for the specified set of instances.</para>
    /// labels<para>instance lens domain</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Specifies that the lens is usable for the specified class and its subclasses.</para>
    /// labels<para>class lens domain</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Explicit definition of fresnel:Group containing formats that should be used to render the lens or sublens.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Fresnel Group is used for grouping formats and lenses together.</para>
    /// labels<para>Group</para></remarks>
    /// <seealso href="http://www.w3.org/2004/09/fresnel#Group">http://www.w3.org/2004/09/fresnel#Group</seealso>
    let Group = Prefixed_Name(fresnel, "Group") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Specifies how a property is labelled (only works in conjunction with propertyFormatDomain).</para>
    ...
    ///   <para>Set of all properties of the current instance, which have not be explicitly named before.</para>
    /// labels<para>All Properties</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Attaching a symbol appropriate for styling a resource.  resourceStyle is ignored if not used with :classFormatDomain or :instanceFormatDomain.</para>
    /// labels<para>resource style</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>This is a convenience class for the OWL specification of Fresnel.</para>
    /// labels<para>Hide Property List</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>This is a convenience class for the OWL specification of Fresnel.</para>
    /// labels<para>Show Property List</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Abstract superclass of all labelling formats.</para>
    /// labels<para>Labelling Format</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Abstract class for expressing shorthands a browser must understand how to expand.</para>
    /// labels<para>Convenience Token</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Fresnel format class for displaying RDF data; the domain property can be only one of :formatDomain, :classFormatDomain, :instanceFormatDomain.</para>
    /// labels<para>Format Class</para></remarks>
    ...
    /// <remarks>
    ///   <para>fresnel:LabellingFormat</para>
    ///   <para>Do not show any label for the property.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>List of all properties which should be shown.</para>
    /// labels<para>show properties</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Description of fresnel:Format content separators only; contentNoValue will not be recognized in conjunction with this class.</para>
    /// labels<para>Format Description No Substitution</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Assign content formatting to a set of properties (only works in conjunction with propertyFormatDomain).</para>
    /// labels<para>property format</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>More detailed description of the property, e.g. for specifing sublenses or merging properties.</para>
    /// labels<para>Property Description</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Sublens which should be used for displaying property values.</para>
    /// labels<para>sublens</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>List of all properties which should be hidden.  Must be used together with 'fresnel:showProperties fresnel:allProperties.'</para>
    /// labels<para>hide properties</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The RDF property, which is described.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Closure mechanism, if lenses are recursively used; the recursive depth limit.</para>
    ...
    /// <remarks>
    ///   <para>fresnel:PropertyValueStyle</para>
    ///   <para>Show the property value as an URI.</para>
    ...
    /// <remarks>
    ///   <para>fresnel:PropertyValueStyle</para>
    ///   <para>Show the property value as an image, such as PNG or JPEG .</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Abstract class of property sets.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Attaching a symbol appropriate for styling the values of a property (only works in conjunction with propertyFormatDomain).</para>
    /// labels<para>value style</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The Format should be applied to instances of this class.</para>
    /// labels<para>class format domain</para></remarks>
    ...
    /// <remarks>
    ///   <para>fresnel:Purpose</para>
    ///   <para>Provides the browser with a starting point which lens to show.</para>
    /// labels<para>Default Lens</para></remarks>
    ...
    /// <remarks>
    ///   <para>fresnel:PropertyValueStyle</para>
    ///   <para>Show the property value as a dereferenceable URL.</para>
    /// labels<para>External Link</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Lens for viewing RDF data.</para>
    /// labels<para>Lens</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Content that should be displayed before the content of the current box.</para>
    /// labels<para>content before</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Description of fresnel:Format content separators; super class, not to be used directly.</para>
    /// labels<para>Format Description</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Content that should be displayed before the content of the current box.</para>
    /// labels<para>content after</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Content that should be displayed after the content of the last element in a list of boxes; takes over the last :contentAfter element in case of a conflict.</para>
    /// labels<para>content last</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Content that should be displayed before the content of the first element in a list of boxes; takes over the first :contentBefore element in case of a conflict.</para>
    /// labels<para>content first</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Specifies the classes that should be considered primaries, or first class results; secondary resources not matching the primaries will only be shown as sublenses.  The range is a list of resource selectors.</para>
    /// labels<para>primaryClasses</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>Content that should be displayed if the current property is missing.</para>
    /// labels<para>content no value</para></remarks>
