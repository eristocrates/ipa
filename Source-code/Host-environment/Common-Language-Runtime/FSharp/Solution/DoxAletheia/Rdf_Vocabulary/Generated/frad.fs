...
module frad =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Identifier"</para><para>"Identificador"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"aplica"</para><para>"applies"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"govern"</para><para>"regula"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"crea"</para><para>"creates"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"modifica"</para><para>"modifies"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"tiene derivada"</para><para>"has derivative"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is owner (family) of"</para><para>"es propietaria (familia) de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is produced by (family)"</para><para>"es producida por (familia)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is realizer (family) of"</para><para>"es realizadora (familia) de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has shared characteristic (item) relationship"</para><para>"tiene relación de característica compartida (ejemplar)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has descriptive work"</para><para>"tiene obra descriptiva"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has undifferentiated access point "</para><para>"tiene punto de acceso no diferenciado"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has language of cataloguing"</para><para>"tiene lengua de catalogación"</para></remarks>
    ...
    /// labels<para>"has addition"</para><para>"tiene adición"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"tiene cita de reglas"</para><para>"has citation for rules"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has type of identifier"</para><para>"tiene tipo de identificador"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has type of name"</para><para>"tiene tipo de nombre"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has dates of usage"</para><para>"tiene fechas de uso"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has transliteration scheme of name"</para><para>"tiene esquema de transliteración del nombre"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has gender"</para><para>"tiene género"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has place of birth"</para><para>"tiene lugar de nacimiento"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has place of death"</para><para>"tiene lugar de fallecimiento"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"tiene país"</para><para>"has country"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has place of residence"</para><para>"tiene lugar de residencia"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has address (person)"</para><para>"tiene dirección (persona)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has biography or history"</para><para>"tiene biografía o historia"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has field of activity (corporate body)"</para><para>"tiene campo de actividad (entidad corporativa)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has history (work)"</para><para>"tiene historia (obra)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is owner of"</para><para>"es propietario de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has owner"</para><para>"tiene propietario"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has subordinate"</para><para>"tiene subordinado"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"is subordinate of"</para><para>"es subordinado de"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"es sucesora de"</para><para>"is successor of"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has related identifier"</para><para>"tiene identificador relacionado"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has later name"</para><para>"tiene nombre posterior"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has acronym or initials or abbreviation"</para><para>"tiene acrónimo o iniciales o abreviaturas"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has alternative linguistic form (work) "</para><para>"tiene forma lingüística alternativa (obra)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has conventional name"</para><para>"tiene nombre convencional"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has alternative linguistic form (person)"</para><para>"tiene forma lingüística alternativa (persona)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has secular identity"</para><para>"tiene identidad secular"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has official identity"</para><para>"tiene identidad oficial"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has collaborative relationship"</para><para>"tiene relación colaborativa con"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"has as subject (family)"</para><para>"tiene como materia (familia)"</para></remarks>
