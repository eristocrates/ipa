...
module cis =
    ...
    /// labels<para>"Access condition"</para><para>"Condizioni di accesso"</para></remarks>
    ...
    /// labels<para>"Address"</para><para>"Indirizzo"</para></remarks>
    ...
    /// labels<para>"Agent"</para><para>"Agente"</para></remarks>
    ...
    /// labels<para>"Attributo"</para><para>"Attribute"</para></remarks>
    ...
    /// labels<para>"Type of Booking"</para><para>"Tipo prenotazione"</para></remarks>
    ...
    /// labels<para>"Card"</para><para>"Carta d'ingresso"</para></remarks>
    ...
    /// labels<para>"Clerical Administrative Area"</para><para>"Area amministrativa ecclesiastica"</para></remarks>
    ...
    /// <summary>
    ///   <para>cis:CollectionCulEnt</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    /// </remarks>
    /// <seealso href="http://dati.beniculturali.it/cis/CollectionCulEnt">http://dati.beniculturali.it/cis/CollectionCulEnt</seealso>
    let CollectionCulEnt = Prefixed_Name(cis, "CollectionCulEnt") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"Contact Point"</para><para>"Punto di Contatto"</para></remarks>
    ...
    /// labels<para>"Creative Work"</para><para>"Lavoro Creativo"</para></remarks>
    ...
    /// labels<para>"Cultural Reseach and Promotion Center"</para><para>"Centri di ricerca e promozione culturale"</para></remarks>
    ...
    /// <summary>
    ///   <para>cis:CulturalEvent</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    /// </remarks>
    /// <seealso href="http://dati.beniculturali.it/cis/CulturalEvent">http://dati.beniculturali.it/cis/CulturalEvent</seealso>
    let CulturalEvent = Prefixed_Name(cis, "CulturalEvent") |> PrefixedName
    ...
    /// labels<para>"Cultural Institute or Site"</para><para>"Istituto e Luogo Della Cultura"</para></remarks>
    ...
    /// labels<para>"Day of the Week"</para><para>"Giorno della settimana "</para></remarks>
    ...
    /// labels<para>"Area Geografica"</para><para>"Geographical Area"</para></remarks>
    ...
    /// labels<para>"Holder of Archives"</para><para>"Conservatore di archivi"</para></remarks>
    ...
    /// labels<para>"ISIL identifier"</para><para>"Identificativo ISIL"</para></remarks>
    ...
    /// labels<para>"Image Object"</para><para>"Oggetto immagine"</para></remarks>
    ...
    /// labels<para>"Library"</para><para>"Biblioteca"</para></remarks>
    ...
    /// labels<para>"Unità di misura"</para><para>"Measurement Unit"</para></remarks>
    ...
    /// labels<para>"Complesso Monumentale"</para><para>"Monumental Area or Complex"</para></remarks>
    ...
    /// labels<para>"Name in Time"</para><para>"Nome Nel Tempo"</para></remarks>
    ...
    /// labels<para>" Articolo"</para><para>"News Article"</para></remarks>
    ...
    /// labels<para>"Offer"</para><para>"Offerta"</para></remarks>
    ...
    /// labels<para>"Role in Time"</para><para>"Ruolo Nel Tempo"</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>"Sabato"</para><para>"Saturday"</para></remarks>
    ...
    /// labels<para>"Site"</para><para>"Sede"</para></remarks>
    ...
    /// labels<para>"Temporary Closure"</para><para>"Chiusura Temporanea"</para></remarks>
    ...
    /// labels<para>"Teatro"</para><para>"Theatre"</para></remarks>
    ...
    /// labels<para>"Video Object"</para><para>"Oggetto video"</para></remarks>
    ...
    /// labels<para>"access condition for"</para><para>"condizione di accesso per"</para></remarks>
    ...
    /// labels<para>"address identifier"</para><para>"identificativo dell'indirizzo"</para></remarks>
    ...
    /// labels<para>"administrative unit level 1"</para><para>"unità amministrativa di livello 1"</para></remarks>
    ...
    /// labels<para>"administrative unit level 2"</para><para>"unità amministrativa di livello 2"</para></remarks>
    ...
    /// labels<para>"alternative label"</para><para>"nome alternativo dell'istituto e luogo della cultura"</para></remarks>
    ...
    /// labels<para>"at time"</para><para>"al tempo"</para></remarks>
    ...
    /// labels<para>"catalogo"</para><para>"catalogue"</para></remarks>
    /// <seealso href="http://dati.beniculturali.it/cis/catalogue">http://dati.beniculturali.it/cis/catalogue</seealso>
    let catalogue = Prefixed_Name(cis, "catalogue") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"full address"</para><para>"indirizzo completo"</para></remarks>
    ...
    /// labels<para>"geometry type"</para><para>"tipo di geometria"</para></remarks>
    ...
    /// labels<para>"has admission type"</para><para>"ha tipo di apertura"</para></remarks>
    ...
    /// labels<para>"ha tipo"</para><para>"has type"</para></remarks>
    ...
    /// labels<para>"has certified email"</para><para>"ha posta elettronica certificata (PEC)"</para></remarks>
    ...
    /// labels<para>"has contact point"</para><para>"ha punto di contatto"</para></remarks>
    ...
    /// labels<para>"ha prezzo"</para><para>"has currency value"</para></remarks>
    ...
    /// labels<para>"ha data"</para><para>"has date"</para></remarks>
    ...
    /// labels<para>"has day of week "</para><para>"ha giorno della settimana "</para></remarks>
    ...
    /// labels<para>"ha categoria"</para><para>"has discipline"</para></remarks>
    ...
    /// labels<para>"ha durata"</para><para>"has duration"</para></remarks>
    ...
    /// labels<para>"ha email"</para><para>"has email"</para></remarks>
    ...
    /// labels<para>"ha fax"</para><para>"has fax"</para></remarks>
    ...
    /// labels<para>"has ISTAT code"</para><para>"ha codice ISTAT"</para></remarks>
    ...
    /// labels<para>"ha unità di misura"</para><para>"has measurement unit"</para></remarks>
    ...
    /// labels<para>"has name in time"</para><para>"ha nome nel tempo"</para></remarks>
    ...
    /// labels<para>"has reason"</para><para>"ha motivazione"</para></remarks>
    ...
    /// labels<para>"has site description"</para><para>"ha descrizione della sede"</para></remarks>
    ...
    /// labels<para>"has sub event"</para><para>"ha sotto eventi"</para></remarks>
    ...
    /// labels<para>"ha telefono"</para><para>"has telephone"</para></remarks>
    ...
    /// labels<para>"has temporary closure type"</para><para>"ha tipo di chiusura temporanea"</para></remarks>
    ...
    /// labels<para>"has ticket"</para><para>"ha biglietto"</para></remarks>
    ...
    /// labels<para>"ha validità"</para><para>"has validity"</para></remarks>
    ...
    /// labels<para>"has value"</para><para>"ha valore"</para></remarks>
    ...
    /// labels<para>"hosts"</para><para>"ospita"</para></remarks>
    ...
    /// labels<para>"include"</para><para>"includes"</para></remarks>
    ...
    /// labels<para>"Nome Istituzionale"</para><para>"Institutional Name"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"is about"</para><para>"tratta di"</para></remarks>
    ...
    /// labels<para>"è catalogo di"</para><para>"is catalogue of"</para></remarks>
    ...
    /// labels<para>"is held by"</para><para>"è svolto da"</para></remarks>
    ...
    /// labels<para>"è fornito da"</para><para>"is provided by"</para></remarks>
    ...
    /// labels<para>"is related to role in time"</para><para>"è relativo a ruolo nel tempo"</para></remarks>
    ...
    /// labels<para>"è sede di"</para><para>"è contenitore fisico di"</para><para>"is site of"</para></remarks>
    ...
    /// labels<para>"is sub-event of"</para><para>"è sotto evento di"</para></remarks>
    ...
    /// labels<para>"name"</para><para>"nome"</para></remarks>
    ...
    /// labels<para>"apre "</para><para>"opens "</para></remarks>
    ...
    /// labels<para>"riporta a"</para><para>"reports to"</para></remarks>
    ...
    /// labels<para>"role for"</para><para>"ruolo per"</para></remarks>
    ...
    /// labels<para>"start Date"</para><para>"Data di inizio"</para></remarks>
    ...
    /// labels<para>"si tiene durante"</para><para>"takes place during"</para></remarks>
    ...
    /// labels<para>"with Role"</para><para>"con ruolo"</para></remarks>
