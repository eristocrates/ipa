...
module odrl =
    ...
    ///   <para>skos:Concept</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"A non-empty group of Permissions and/or Prohibitions."</para>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>skos:Concept</para>
    ///   <para>"Identifies an ODRL Policy for which the identified Asset is the target Asset to all the Rules."</para>
    /// labels<para>"has policy"</para><para>"Target Policy"</para></remarks>
    ...
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://www.w3.org/ns/odrl/2/null">http://www.w3.org/ns/odrl/2/null</seealso>
    let null_ = Prefixed_Name(odrl, "null") |> PrefixedName
    /// <summary>
