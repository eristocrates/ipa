...
module igeo =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>NUTS 1</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>La valeur par défaut 'true' indique que le territoire existe actuellement. La valeur 'false' indique un territoire mort suite à un événement de modification.</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Une subdivision du territoire</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>owl:TransitiveProperty</para>
    ///   <para>Un territoire dont le sujet est une subdivision</para>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>LAU 1</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>NUTS 2</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>LAU 2</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>NUTS 3</para></remarks>
