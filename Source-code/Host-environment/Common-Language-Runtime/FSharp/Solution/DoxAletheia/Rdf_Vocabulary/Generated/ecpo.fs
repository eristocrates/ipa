...
module ecpo =
    ...
    /// labels<para>"enumeration and chronology"</para><para>"Chronology"</para><para>"Bestandsverlauf"</para></remarks>
    ...
    /// labels<para>"closed chronology"</para><para>"Bestandsverlauf abgeschlossen"</para></remarks>
    ...
    /// labels<para>"laufend"</para><para>"current"</para></remarks>
    ...
    /// labels<para>"has begin issue caption"</para><para>"hat beginnende Ausgabenbeschriftung"</para></remarks>
    ...
    /// labels<para>"has begin issue extension"</para><para>"hat beginnende Ausgabenergänzung"</para></remarks>
    ...
    /// labels<para>"has begin issue numbering"</para><para>"hat beginnende Ausgabenzählung"</para></remarks>
    ...
    /// labels<para>"has begin temporal"</para><para>"hat beginnende Zeit"</para></remarks>
    ...
    /// labels<para>"has begin volume extension"</para><para>"has beginnende Bandergänzung"</para></remarks>
    ...
    /// labels<para>"has begin volume numbering"</para><para>"hat beginnende Bandzählung"</para></remarks>
    ...
    /// labels<para>"has chronology"</para><para>"hat Bestandsverlauf"</para></remarks>
    ...
    /// labels<para>"has end volume extension"</para><para>"hat endende Bandergänzung"</para></remarks>
    ...
    /// labels<para>"hat einzelne"</para><para>"has itemized"</para></remarks>
    ...
    /// labels<para>"has itemized volume caption"</para><para>"hat einzelne Bandbeschriftung"</para></remarks>
    ...
    /// labels<para>"hat einzelne Bandergänzung"</para><para>"has itemized volume extension"</para></remarks>
    ...
    /// labels<para>"hat einzelne Bandzählung"</para><para>"has itemized volume numbering"</para></remarks>
