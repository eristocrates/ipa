...
module lmm1 =
    ...
    /// given a certain statistical threshold), etc."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Cotesto {it}"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Co-text"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A description of how to build an entity. For example, a logical rule, a productive rule, a statistical algorithm, etc."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// Contexts can also emerge based on what relations are considered "context triggers". For example, in this ontology very different relations: part, participation, setting, membership, acting for, localization, etc. are considered context triggers by adding owl:subPropertyOf axioms to the property: isContextOf. Since the class Context has an equivalent axiom to isContextOf someValuesFrom dul:Entity, everything has a property that is declared subPropertyOf isContextOf, will be inferred to be a Context as well."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Contesto {it}"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Context"</para><para>"Contesto"</para></remarks>
    ...
    /// labels<para>"Expression"</para><para>"Expression"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"The context of agents that conceptualize a same Paradigm. This restriction cannot be represented in OWL in general, but should be encoded for specific knowledge communities by stating the specific paradigm that agents acting for it must conceptualize."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Knowledge community"</para><para>"Comunità di conoscenza {it}"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Any conceptualization that dul:isExpressedBy an Expression, or isInterpretationOf a Reference"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Meaning"</para><para>"Meaning"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"The context of an expressed Meaning"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Paradigma {it}"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Paradigm"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Any Entity that isDenotedBy an Expression, or that hasInterpretation some Meaning"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Reference"</para><para>"Reference"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"A catch-all property for all notions of Context considered in LMM."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// The interpretant relation is here taken as very broad, also accepting InformationRealization(s) as interpretants."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// This relation allows to generalize over the following DOLCE-Ultralite relations: dul:isClassifedBy, dul:isCoveredBy, dul:isDescribedBy, dul:isUnifiedBy, and dul:satisfies"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// Synonymy, associativity, and even topical proximity are all sources for interpretants, e.g.: domestic dog isInterpretantFor dog (synonymy); bark isInterpretantFor dog (associativity); veterinary isInterpretantFor dog (topical proximity).
    /// Semantic mechanisms such as metonymy depend on the interpretant relation.
    /// The interpretant relation is here taken as very broad, also accepting realization of information as interpretants."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// A same Reference can be given different interpretations, for example, an old cradle can be given a unifying Meaning based on the original aesthetic design, the functionality it was built for, or a new aesthetic functionality in which it can be used as a flower pot.
    /// This relation allows to generalize over the following DOLCE-Ultralite relations: dul:classifies, dul:covers, dul:describes, dul:unifies, and dul:isSatisfiedBy"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>"A relation between any two meanings."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
