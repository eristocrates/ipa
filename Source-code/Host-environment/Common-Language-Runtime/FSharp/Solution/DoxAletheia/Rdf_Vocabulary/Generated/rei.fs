...
module rei =
    ...
    /// 	no nested formulae, no literals as subject, etc."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"RDF symbol, identified by a URI"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// labels<para>"for all"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Shorhand for object!uri"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"object URI"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Shorhand for object!Literal"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"object value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Shorhand for predicate!uri"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"predicate URI"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Shorhand for predicate!Literal. Not RDF 1.0."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"predicate value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// 	"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"statements"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Shorhand for subject!uri"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"subject URI"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Shorhand for subject!Literal. Not in RDF 1.0"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"subject value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// 	This is the name string."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"symbol URI, not arbitray"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// 	Value is the relation between a node (which happens to be a literal, list etc,..) and the value it takes."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
