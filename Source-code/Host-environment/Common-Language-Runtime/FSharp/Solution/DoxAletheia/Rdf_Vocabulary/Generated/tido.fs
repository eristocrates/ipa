...
module tido =
    ...
    let PieceOfInformation =
        Namespaced_IRI.parse _namespace_name "PieceOfInformation" |> NamespacedName
    ...
    let answers = Namespaced_IRI.parse _namespace_name "answers" |> NamespacedName
    /// <summary>
    ...
    let providesInsightsInto =
        Namespaced_IRI.parse _namespace_name "providesInsightsInto" |> NamespacedName
    ...
    let hasConsideration =
        Namespaced_IRI.parse _namespace_name "hasConsideration" |> NamespacedName
    ...
    let informs = Namespaced_IRI.parse _namespace_name "informs" |> NamespacedName
    /// <summary>
    ...
    let wasRecalledBy =
        Namespaced_IRI.parse _namespace_name "wasRecalledBy" |> NamespacedName
    ...
    let wasSelectedBy =
        Namespaced_IRI.parse _namespace_name "wasSelectedBy" |> NamespacedName
