...
module saont =
    ...
    /// <summary>
    ///   <para>saont:AccountabilityPlan</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A plan which describes a specification of the information that should be collected, so as to support accountability of systems.</para>
    /// labels<para>Accountability Plan</para></remarks>
    ...
    /// <summary>
    ///   <para>saont:InformationElement</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A member of the collection of type Information Realization. Information Realizations may have multiple Information Elements.  Information Element describes in more detail a specific type of information contained by the Information Realization collection.</para>
    ...
    /// <summary>
    ///   <para>saont:AccountableAction</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A planned step which is deemed to be important for accountability purposes and produces AccountableResult.</para>
    /// labels<para>Accountable Action</para></remarks>
    ...
    /// <summary>
    ///   <para>saont:AccountableObject</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An accountable object models an abstract representation of a thing that should be documented for accountability. This may reference the whole system, its logical part, or associated process.  For example, a larger system may be described as a group of sub-systems or a single system may be broken down into a number of layers/components (e.g., a decision logic layer).</para>
    /// labels<para>Accountable Object</para></remarks>
    ...
    /// <summary>
    ///   <para>saont:System</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A system that the collected accountability information is about.</para>
    ...
    /// <summary>
    ///   <para>saont:hasAccountableAgent</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Inverse of is accountable for</para>
    /// labels<para>has accountable agent</para></remarks>
    ...
    /// <summary>
    ///   <para>saont:isAccountableFor</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relation that links accountable agents to entities they are accountable for.</para>
    /// labels<para>is accountable for</para></remarks>
    ...
    /// <summary>
    ///   <para>saont:hasRelatedAccountableResult</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>has related accountable result</para></remarks>
    ...
    /// <summary>
    ///   <para>saont:relatesToAccountableObject</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relation which describes the information described by an accountable result relates to an accountable object.</para>
    /// labels<para>relates to accountable object</para></remarks>
    ...
    /// <summary>
    ///   <para>saont:hasSpecifiedAccountabiltyPlan</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Inverse of specified for system.</para>
    /// labels<para>has specified accountability plan</para></remarks>
    ...
    /// <summary>
    ///   <para>saont:isImpactedBy</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Inverse of impacts.</para>
    /// labels<para>is impacted by</para></remarks>
    ...
    /// <summary>
    ///   <para>saont:AccountableAgent</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An agent (typically a human)  that can be held accountable for his/her actions.</para>
    /// labels<para>Accountable Agent</para></remarks>
    ...
    /// <summary>
    ///   <para>saont:AccountableResult</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An output variable which is produced by an Accountable Action, for example,  a decision made by a human or a specification produced by a team. The variable is part of the accountability plan and has a corresponding InformationRealization collection in the execution trace.</para>
    /// labels<para>Accountable Result</para></remarks>
    ...
    /// <summary>
    ///   <para>saont:InformationRealization</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A collection of pieces of information (InformationElements) which corresponds to a variable of type  AccountableResult. The collection represents the actual piece of provenance information documenting a specific AccountableResult during a single plan execution.</para>
    ...
    /// <summary>
    ///   <para>saont:specifiedForSystem</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relation that links the accountability plan to the system it was specified for.</para>
    /// labels<para>specified for system</para></remarks>
    ...
    /// <summary>
    ///   <para>saont:impacts</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relation which describes that an accountable object have some effect on the system's accountability.</para>
