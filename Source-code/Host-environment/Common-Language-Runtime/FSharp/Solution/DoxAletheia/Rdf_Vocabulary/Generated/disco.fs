...
module disco =
    ...
    /// labels<para>"Instrument"</para><para>"Instrument de collecte"</para></remarks>
    ...
    /// labels<para>"Fragebogen"</para><para>"Questionnaire"</para></remarks>
    ...
    /// labels<para>"Data element"</para><para>"Élément de donnée"</para></remarks>
    ...
    /// labels<para>"Étude"</para><para>"Study"</para></remarks>
    ...
    /// labels<para>"Study Group"</para><para>"Studiengruppe"</para></remarks>
    ...
    /// labels<para>"Univers"</para><para>"Universe"</para></remarks>
    ...
    /// labels<para>"number of cases"</para><para>"nombre d'observations"</para></remarks>
    ...
    /// labels<para>"collection mode"</para><para>"Datenerfassungsmodus"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"frequency"</para>
    /// labels<para>"fréquence"</para><para>"frequency"</para></remarks>
    ...
    /// labels<para>"is public"</para><para>"ist öffentlich"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>owl:Class</para>
    ///   <para>"The general kind of data (e.g. geospatial, register, survey) collected in this study, given either as a skos:Concept, or as a blank node with attached free-text rdfs:label."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"percentage"</para><para>"pourcentage"</para></remarks>
    ...
    /// labels<para>"product"</para><para>"Produkt"</para></remarks>
    ...
    /// labels<para>"representation"</para><para>"a pour représentation"</para></remarks>
    /// <seealso href="http://rdf-vocabulary.ddialliance.org/discovery#representation">http://rdf-vocabulary.ddialliance.org/discovery#representation</seealso>
    let representation = Prefixed_Name(disco, "representation") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"statistics data file"</para><para>"a pour fichier statistique"</para></remarks>
