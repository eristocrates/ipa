...
module ecfo =
    ...
    /// <summary>
    ///   <para>w3id:ecfo#ChemicalCompound</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// <summary>
    ///   <para>w3id:ecfo#EmissionConversionFactor</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A concept representing the coefficient value used in greenhouse gas (GHG) emission calculations (activity data x emission conversion factor = GHG emissions)  and additional metadata (e.g., applicable location, publisher, etc.)."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Emission Conversion Factor"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Type of emissions a company creates in its own operations and in its wider 'value chain'. Typically emissions fall under three categories - Scope 1, Scope 2 and Scope 3."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <summary>
    ///   <para>w3id:ecfo#Scope2</para>
    /// </summary>
    /// <remarks>
    ///   <para>w3id:ecfo#Scope</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>"Scope 2 (energy indirect) emissions are those released into the atmosphere that are associated with your consumption of purchased electricity, heat, steam and cooling. These indirect emissions are a consequence of your organisation’s energy use, but occur at sources you do not own or control."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"scope 2"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <summary>
    ///   <para>w3id:ecfo#hasAdditionalContext</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///   <para>w3id:ecfo#hasApplicableLocation</para>
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///   <para>w3id:ecfo#hasApplicablePeriod</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ...
    /// <summary>
    ///   <para>w3id:ecfo#hasEmissionSource</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ...
    /// <summary>
    ///   <para>w3id:ecfo#hasEmissionTarget</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ...
    /// <summary>
    ///   <para>w3id:ecfo#hasSourceUnit</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ...
    /// <summary>
    ///   <para>w3id:ecfo#hasTargetUnit</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ...
    /// <summary>
    ///   <para>w3id:ecfo#hasUsageNotes</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
