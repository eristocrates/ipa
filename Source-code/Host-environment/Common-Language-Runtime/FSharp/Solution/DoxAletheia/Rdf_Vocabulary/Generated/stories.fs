...
module stories =
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Facts asserted by this assertion, in the form of an RDF graph."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"facts"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
