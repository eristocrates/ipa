...
module geom =
    ...
    /// labels<para>"Curve"</para><para>"Courbe"</para></remarks>
    ...
    /// labels<para>"Geometry"</para><para>"Géométrie"</para></remarks>
    ...
    /// labels<para>"Polyligne"</para><para>"Line string"</para></remarks>
    ...
    /// labels<para>"Multipolyligne"</para><para>"Multi line string"</para></remarks>
    ...
    /// labels<para>"Multipoint"</para><para>"Multi point"</para></remarks>
    ...
    /// labels<para>"Multi polygon"</para><para>"Multipolygone"</para></remarks>
    ...
    /// labels<para>"List of points"</para><para>"Liste de points"</para></remarks>
    ...
    /// labels<para>"boundary"</para><para>"frontière"</para></remarks>
    ...
    /// labels<para>"système de coordonnées"</para><para>"coordinate reference system"</para></remarks>
    ...
    /// labels<para>"exterior"</para><para>"extérieur"</para></remarks>
    ...
    /// labels<para>"has geometry"</para><para>"a pour géométrie"</para></remarks>
    /// <seealso href="http://data.ign.fr/def/geometrie#geometry">http://data.ign.fr/def/geometrie#geometry</seealso>
    let geometry = Prefixed_Name(geom, "geometry") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"polyligne membre"</para><para>"line string member"</para></remarks>
    ...
    /// labels<para>"point membre"</para><para>"point member"</para></remarks>
    ...
    /// labels<para>"points"</para></remarks>
    ...
    /// labels<para>"polygon member"</para><para>"polygone membre"</para></remarks>
    ...
    /// labels<para>"upper corner"</para><para>"coin supérieur"</para></remarks>
