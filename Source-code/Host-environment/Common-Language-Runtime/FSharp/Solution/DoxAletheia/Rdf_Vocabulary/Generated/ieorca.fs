...
module ieorca =
    ...
    ///   <para>Indicates the basis of the knowledge</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>Indicates how certain the knowledge is</para>
    ...
    ///
    /// labels<para>directlyMoreCertainThan</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>lessCertain</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Indicates the source of the knowledge.</para>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>directlyLessCertainThan</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>moreCertain</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>Indicates the basis of the knowledge.</para>
    /// labels<para>hasBasis</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Indicates the confidence/certainty level of the knowledge.</para>
    /// labels<para>hasConfidenceLevel</para></remarks>
