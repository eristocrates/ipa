...
module td =
    ...
    /// labels<para>"ActionAffordance"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"EventAffordance"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"Affordance that represents a Service."</para>
    ...
    /// labels<para>"Interaction Affordance"</para><para>"InteractionAffordance"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"OperationType"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"PropertyAffordance"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"hasActionAffordance"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"hasCancellationSchema"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"hasEventAffordance"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>"Interaction affordance has form."</para>
    /// labels<para>"hasForm"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"has form"</para></remarks>
    ...
    /// labels<para>"hasInputSchema"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"hasInteractionAffordance"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"hasLink"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"hasNotificationSchema"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"hasOutputSchema"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"hasPropertyAffordance"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"hasSecurityConfiguration"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"hasSubscriptionSchema"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Interaction affordance has an URI template schema."</para>
    ///   <para>"Define URI template variables as collection based on schema specifications."</para>
    /// labels<para>"hasUriTemplateSchema"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"has uri template schema"</para></remarks>
    ...
    /// labels<para>"invokeAction"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"isIdempotent"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"isObservable"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"isSafe"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>td:OperationType</para>
    ///   <para>"Operation type of forms used to read a property value"</para>
    /// labels<para>"observeProperty"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>td:OperationType</para>
    ///   <para>"Operation type of forms used to read a property value"</para>
    /// labels<para>"readAllProperties"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>td:OperationType</para>
    ///   <para>"Operation type of forms used to read a property value"</para>
    /// labels<para>"readMultipleProperties"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>td:OperationType</para>
    ///   <para>"Operation type of forms used to read a property value"</para>
    /// labels<para>"readProperty"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>td:OperationType</para>
    ///   <para>"Operation type of forms used to read a property value"</para>
    /// labels<para>"subscribeEvent"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"supportContact"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>td:OperationType</para>
    ///   <para>"Operation type of forms used to read a property value"</para>
    /// labels<para>"unobserveProperty"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>td:OperationType</para>
    ///   <para>"Operation type of forms used to read a property value"</para>
    /// labels<para>"unsubscribeEvent"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>td:OperationType</para>
    ///   <para>"Operation type of forms used to read a property value"</para>
    /// labels<para>"writeAllProperties"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>td:OperationType</para>
    ///   <para>"Operation type of forms used to read a property value"</para>
    /// labels<para>"writeMultipleProperties"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>td:OperationType</para>
    ///   <para>"Operation type of forms used to read a property value"</para>
    /// labels<para>"writeProperty"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
