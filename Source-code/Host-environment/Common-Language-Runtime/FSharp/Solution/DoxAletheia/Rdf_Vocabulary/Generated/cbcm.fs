...
module cbcm =
    ...
    /// labels<para>"Behaviour"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"EU country"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"Geo-political region"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"Member State Official Journal"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// labels<para>"Austria"</para><para>"Österreich"</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>"България"</para><para>"Bǎlgariya"</para><para>"Bulgaria"</para></remarks>
    ...
    ///   <para>cbcm:EUCountry</para>
    ///
    /// labels<para>"Croatia"</para><para>"Hrvatska"</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>"Czechia"</para><para>"Česká republika"</para><para>"Czech Republic"</para></remarks>
    ...
    ///   <para>cbcm:EUCountry</para>
    ///
    /// labels<para>"Eesti"</para><para>"Estonia"</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>"Suomi"</para><para>"Finland"</para></remarks>
    ...
    ///   <para>cbcm:EUCountry</para>
    ///
    /// labels<para>"République française"</para><para>"France"</para><para>"French Republic"</para></remarks>
    ...
    ///   <para>cbcm:EUCountry</para>
    ///
    /// labels<para>"Ελλάδα"</para><para>"Ellada"</para><para>"Greece"</para></remarks>
    ...
    ///   <para>cbcm:EEACountry</para>
    ///
    /// labels<para>"Ísland"</para><para>"Iceland"</para></remarks>
    ...
    ///   <para>cbcm:EUCountry</para>
    ///
    /// labels<para>"Italian Republic"</para><para>"Italia"</para><para>"Repubblica Italiana"</para><para>"Italy"</para></remarks>
    ...
    ///   <para>cbcm:EUCountry</para>
    ///
    /// labels<para>"Republic of Latvia"</para><para>"Latvija"</para><para>"Latvijas Republika"</para><para>"Latvia"</para></remarks>
    ...
    ///   <para>cbcm:EEACountry</para>
    ///
    /// labels<para>"Fürstentum Liechtenstein"</para><para>"Principality of Liechtenstein"</para><para>"Liechtenstein"</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>"Lietuva"</para><para>"Republic of Lithuania"</para><para>"Lithuania"</para><para>"Lietuvos Respublika"</para></remarks>
    ...
    ///   <para>cbcm:EUCountry</para>
    ///
    /// labels<para>"Grand-Duché de Luxembourg"</para><para>"Grand Duchy of Luxembourg"</para><para>"Großherzogtum Luxemburg​"</para><para>"Luxembourg"</para><para>"Groussherzogtum Lëtzebuerg"</para><para>"Lëtzebuerg"</para></remarks>
    ...
    ///   <para>cbcm:EUCountry</para>
    ///
    /// labels<para>"The Netherlands"</para><para>"Nederland"</para><para>"Holland"</para><para>"Netherlands"</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>"Norge"</para><para>"Noreg"</para><para>"Kongeriket Norge"</para><para>"Vuona"</para><para>"Kongeriket Noreg"</para><para>"Norgga gonagasriika"</para><para>"Norgga"</para><para>"Norway"</para><para>"Kingdom of Norway"</para><para>"Nöörjen"</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>"Rzeczpospolita Polska"</para><para>"Republic of Poland"</para><para>"Polska"</para><para>"Poland"</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>"Portuguese Republic"</para><para>"República Portuguesa"</para><para>"Portugal"</para></remarks>
    ...
    ///   <para>cbcm:EUCountry</para>
    ///
    /// labels<para>"Slovak Republic"</para><para>"Slovenská republika"</para><para>"Slovensko"</para><para>"Slovakia"</para></remarks>
