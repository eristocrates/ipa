...
module parl =
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>A seat in a Parliament</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>A Political party such as The Conservative Party or The Labour Party.</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>Defines the chambers with instances like The House of Commons and The House of Lords.</para>
