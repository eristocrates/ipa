...
module sam =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Location, expressed as either a spatial object or geographic identifier"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Complement of SamplingFeature"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Not a sampling feature"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"In many applications, specimen preparation procedures are applied to the material prior to its use in an observation. The class PreparationStep (Figure 13) shall link an SF_Specimen to an SF_Process that describes a phase of the specimen preparation."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"Discrete stage in specimen-preparation process"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"In many applications, specimen preparation procedures are applied to the material prior to its use in an observation. The class PreparationStep (Figure 13) shall link an SF_Specimen to an SF_Process that describes a phase of the specimen preparation."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"Process involved in sampling. This may include specimen retrieval or processing, surveying a spatial sampling feature, excavation to provide access to a sampling feature, or any other process whose outcome is a new sampling feature."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Spatial sampling feature whose shape is a 1-D manifold (Curve)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// A sampling feature is intended to sample some feature-of-interest in an application domain. However, in some cases the identity, and even the exact type, of the sampled feature may not be known when observations are made using the sampling features."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"Feature on which observations may be made, that is intended to be representative of a different (usually larger) feature that is not fully accessible for some reason. "^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"The class SF_SamplingFeatureCollection (Figure 9) is an instance of the «metaclass» GF_FeatureType (ISO 19109), which therefore represents a feature type. SF_SamplingFeatureCollection shall support one association."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"Collection of sampling features"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Set of sampling features related to each other in a specific and deliberate way."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"Sampling features are frequently related to each other, as parts of complexes, through sub-sampling, and in other ways. If present, the association class SamplingFeatureComplex (Figure 9) shall link an SF_SamplingFeature to another SF_SamplingFeature."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Spatial sampling feature whose shape is a 0-D manifold (Point)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Spatial sampling feature whose shape is a 2-D manifold (Surface)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Sampling feature whose defining characteristic is that it samples the intended feature by geometric subsetting."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"material class"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"member sampling feature"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"sampling feature parameter"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"preparation step"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://def.seegrid.csiro.au/isotc211/iso19156/2011/sampling#preparationStep">http://def.seegrid.csiro.au/isotc211/iso19156/2011/sampling#preparationStep</seealso>
    let preparationStep = Prefixed_Name(sam, "preparationStep") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"process operator"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"processing details"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"related observation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"specimen type"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"preparation step time"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
