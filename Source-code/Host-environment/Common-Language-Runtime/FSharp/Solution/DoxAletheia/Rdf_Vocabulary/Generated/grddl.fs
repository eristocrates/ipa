...
module grddl =
    ...
    ///   <para>"A resource which has the property that all of its essential characteristics can be conveyed in a message"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"InformationResource"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>"a
    ///     set of RDF triples"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"RDF graphs"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"RDFGraph"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///     model"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"XML document root nodes"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"RootNode"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///     a transformation from a set of XML documents to RDF graphs"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///     RDF graphs"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"TransformationProperty"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///     all documents in that namespace"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"namespaceTransformation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///     transformation for all documents bearing that profile"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"profileTransformation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///     nominated by the document"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///     to the RDF graph syntax"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"transformation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://www.w3.org/2003/g/data-view#transformation">http://www.w3.org/2003/g/data-view#transformation</seealso>
    let transformation = Prefixed_Name(grddl, "transformation") |> PrefixedName
    ...
    ///     document node"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"transformationProperty"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://www.w3.org/2003/g/data-view#transformationProperty">http://www.w3.org/2003/g/data-view#transformationProperty</seealso>
    let transformationProperty =
        Prefixed_Name(grddl, "transformationProperty") |> PrefixedName
