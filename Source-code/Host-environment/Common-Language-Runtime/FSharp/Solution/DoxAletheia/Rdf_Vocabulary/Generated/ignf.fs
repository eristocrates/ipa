...
module ignf =
    ...
    /// labels<para>Système de coordonnées de référence geodésique</para><para>Geodetic coordinate reference system</para></remarks>
    ...
    /// labels<para>Système de coordonnées de référence simple</para><para>Single coordinate reference system</para></remarks>
    ...
    /// labels<para>longitude ouest minimale</para><para>west bound longitude</para></remarks>
    ...
    /// labels<para>Opération simple sur les coordonnées</para><para>Single coordinate operation</para></remarks>
    ...
    /// labels<para>est une sphère</para><para>is sphere</para></remarks>
    ...
    /// labels<para>Liste d'axes</para><para>List of axes</para></remarks>
    ...
    /// labels<para>Axis</para><para>Axe</para></remarks>
    ...
    /// labels<para>Liste de systèmes de coordonnées de référence simples</para><para>List of single coordinate reference systems</para></remarks>
    ...
    /// labels<para>Conversion</para><para>Conversion</para></remarks>
    /// <seealso href="http://data.ign.fr/def/ignf#Conversion">http://data.ign.fr/def/ignf#Conversion</seealso>
    let Conversion = Prefixed_Name(ignf, "Conversion") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>formule de la méthode</para><para>method formula</para></remarks>
    ...
    /// labels<para>version de l'opération</para><para>operation version</para></remarks>
    ...
    /// labels<para>Référentiel</para><para>Datum</para></remarks>
    ...
    /// labels<para>dimension du système de coordonnées de référence source</para><para>source coordinate reference system dimension</para></remarks>
    ...
    /// labels<para>utilise le paramètre</para><para>uses parameter</para></remarks>
    ...
    /// labels<para>utilise le système vertical de coordonnées</para><para>uses vertical coordinate system</para></remarks>
    ...
    /// labels<para>Ellipsoïde</para><para>Ellipsoid</para></remarks>
    ...
    /// labels<para>utilise le référentiel</para><para>uses datum</para></remarks>
    /// <seealso href="http://data.ign.fr/def/ignf#datum">http://data.ign.fr/def/ignf#datum</seealso>
    let datum = Prefixed_Name(ignf, "datum") |> PrefixedName
    /// <summary>
    ///   <para>ignf:ellipsoid</para>
    ...
    /// labels<para>utilise l'ellipsoïde</para><para>uses ellipsoid</para></remarks>
    /// <seealso href="http://data.ign.fr/def/ignf#ellipsoid">http://data.ign.fr/def/ignf#ellipsoid</seealso>
    let ellipsoid = Prefixed_Name(ignf, "ellipsoid") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>Référentiel géodésique</para><para>Geodetic datum</para></remarks>
    /// <seealso href="http://data.ign.fr/def/ignf#GeodeticDatum">http://data.ign.fr/def/ignf#GeodeticDatum</seealso>
    let GeodeticDatum = Prefixed_Name(ignf, "GeodeticDatum") |> PrefixedName
    /// <summary>
    ///   <para>ignf:primeMeridian</para>
    ...
    /// labels<para>utilise le méridien origine</para><para>uses prime meridian</para></remarks>
    /// <seealso href="http://data.ign.fr/def/ignf#primeMeridian">http://data.ign.fr/def/ignf#primeMeridian</seealso>
    let primeMeridian = Prefixed_Name(ignf, "primeMeridian") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>longitude est maximale</para><para>east bound longitude</para></remarks>
    ...
    /// labels<para>Operation method</para><para>Méthode</para></remarks>
    ...
    /// labels<para>Operation parameter</para><para>Paramètre</para></remarks>
    ...
    /// labels<para>Operation parameter value</para><para>Valeur de paramètre</para></remarks>
    ...
    /// labels<para>Système de coordonnées de référence projeté</para><para>Projected coordinate reference system</para></remarks>
    ...
    /// labels<para>Système de coordonnées de référence vertical</para><para>Vertical coordinate reference system</para></remarks>
    ...
    /// labels<para>Système de coordonnées vertical</para><para>Vertical coordinate system</para></remarks>
    /// <seealso href="http://data.ign.fr/def/ignf#VerticalCS">http://data.ign.fr/def/ignf#VerticalCS</seealso>
    let VerticalCS = Prefixed_Name(ignf, "VerticalCS") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>Transformation</para><para>Transformation</para></remarks>
    ...
    /// labels<para>Référentiel vertical</para><para>Vertical datum</para></remarks>
    ...
    /// labels<para>utilise la valeur</para><para>uses value</para></remarks>
