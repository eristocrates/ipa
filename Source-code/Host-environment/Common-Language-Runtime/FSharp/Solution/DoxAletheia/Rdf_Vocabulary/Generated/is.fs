...
module is =
    ...
    /// labels<para>"is info service of"</para><para>"has info service"</para></remarks>
    ...
    /// labels<para>"has info service contributor type"</para><para>"is info service contributor type of"</para></remarks>
    ...
    /// labels<para>"is info service quality of"</para><para>"has info service quality"</para></remarks>
    ...
    /// labels<para>"is info service type of"</para><para>"has info service type"</para></remarks>
    ...
    /// labels<para>"is main subject of"</para><para>"has main subject"</para></remarks>
