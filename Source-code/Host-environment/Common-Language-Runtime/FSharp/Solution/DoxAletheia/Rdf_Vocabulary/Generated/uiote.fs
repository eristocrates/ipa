...
module uiote =
    ...
    /// labels<para>"Charging Service"</para><para>"Servizio di Ricarica"</para></remarks>
    ...
    /// labels<para>"Charging Service Offer"</para><para>"Tariffa per Servizi di Ricarica"</para></remarks>
    ...
    /// labels<para>"Charging Session"</para><para>"Sessione di Ricarica"</para></remarks>
    ...
    /// labels<para>"Charging Station"</para><para>"Stazione di Ricarica"</para></remarks>
    ...
    /// labels<para>"EVSE state"</para><para>"stato dell'EVSE"</para></remarks>
    ...
    /// labels<para>"charging session duration"</para><para>"durata sessione di ricarica"</para></remarks>
    ...
    /// labels<para>"charging station used in"</para><para>"stazione di ricarica usata in"</para></remarks>
    ...
    /// labels<para>"eMobility Service Provider"</para><para>"Gestore di Servizi per la Ricarica Elettica"</para></remarks>
    ...
    /// labels<para>"has connector"</para><para>"ha un connettore"</para></remarks>
    ...
    /// labels<para>"has EVSE"</para><para>"ha un EVSE"</para></remarks>
    ...
    /// labels<para>"has EVSE Charge Category"</para><para>"ha una categoria di ricarica per EVSE"</para></remarks>
    ...
    /// labels<para>"has parking restriction"</para><para>"ha restrizioni di parcheggio"</para></remarks>
    ...
    ///   <para>"Associates a Connector to an Electric Vehicle Supply Equipment (EVSE)."</para>
    ///   <para>"Associa un Connettore ad una Colonnina di Ricarica per Veicoli Elettrici (EVSE)."</para>
    /// labels<para>"is connector of"</para><para>"è connettore di"</para></remarks>
    ...
    /// labels<para>"è EVSE di"</para><para>"is EVSE of"</para></remarks>
    ...
    /// labels<para>"makes station available"</para><para>"rende la stazione disponibile"</para></remarks>
    ...
    /// labels<para>"max voltage in V"</para><para>"massimo voltaggio in V"</para></remarks>
    ...
    /// labels<para>"min voltage in V"</para><para>"minimo voltaggio in V"</para></remarks>
    ...
    /// labels<para>"operato da"</para><para>"operated by"</para></remarks>
    ...
    /// labels<para>"opera sessione"</para><para>"operates session"</para></remarks>
    ...
    /// labels<para>"price per kWh charge"</para><para>"prezzo al kWh di ricarica"</para></remarks>
    ...
    /// labels<para>"recharge time in min"</para><para>"tempo di ricarica in minuti"</para></remarks>
    ...
    /// labels<para>"registered user"</para><para>"utente registrato"</para></remarks>
    ...
    /// labels<para>"renewable sources"</para><para>"sorgenti rinnovabili"</para></remarks>
    ...
    /// labels<para>"sessione operata da"</para><para>"session operated by"</para></remarks>
    ...
    /// labels<para>"uses charging station"</para><para>"stazione di ricarica utilizzata"</para></remarks>
