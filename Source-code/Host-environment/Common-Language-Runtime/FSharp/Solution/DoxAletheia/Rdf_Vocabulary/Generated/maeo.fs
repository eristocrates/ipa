...
module maeo =
    ...
    ///   <para></para>
    /// labels<para>languageLevel</para></remarks>
    ...
    ///   <para></para>
    /// labels<para>knowsLanguage</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para></para>
    /// labels<para>hasExpertise</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>profileEmail</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>profileUsername</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>remunerationCurrency</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para></para>
    /// labels<para>worksAt</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It is meant to model the details of the company, institution, organization an expert may be working at/with.</para>
    /// labels<para>Organizational Detail</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It represents the expertise possessed by a generic knowledge provider, by which users of the MarketPlace application can look for experts and such (and vice versa).</para>
    /// labels<para>Expertise</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It represents a connection with an external profile for a given experts, e.g. a social network profile on LinkedIn, Facebook, etc.</para>
    /// labels<para>External Profile</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It models a generic seeker of knowledge as a user of the MarketPlace application.</para>
    /// labels<para>Knowledge Seeker</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It includes the details of a human expert's profile.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It models the remuneration value and currency of the daily rate requested by a human expert, as well as the one associated with an existing contract a human expert may be under.</para>
    /// labels<para>Remuneration</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A knowledge-providing group of people.</para>
    /// labels<para>Knowledge-providing Team</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>maeoDatatypeProperty</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para></para>
    /// labels<para>amountsTo</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>certificationTitle</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>contractType</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>externalProfileName</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>externalProfileUrl</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para></para>
    /// labels<para>hasCertification</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para></para>
    /// labels<para>hasExternalProfile</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It is meant to describe the details of certifications possessed by a human expert.</para>
    /// labels<para>Certification Detail</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It models the authority that has issued a certification.</para>
    /// labels<para>Certification Authority</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para></para>
    /// labels<para>isUnderContract</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para></para>
    /// labels<para>hasRemuneration</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It describes the details about the contract a human experts is currently under.</para>
    /// labels<para>Contractual Detail</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>languageType</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It models the daily rate a human experts requests.</para>
    /// labels<para>Daily Rate</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It is meant to encompass the professional details of a human expert, e.g. title, role, qualifications, languages spoken, current or desired daily rate for hiring and its corresponding remuneration, etc.</para>
    /// labels<para>Professional Detail</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>languageName</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para></para>
    /// labels<para>hasProfile</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It describes a language known by a human expert. By reification (via the rdf:Statement construct), the datatype properties languageType and languageLevel are associated with a 'Expert knowsLanguage Language' triple.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It models a generic provider of knowledge that possesses a certain expertise.</para>
    /// labels<para>Knowledge Provider</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A knowledge-providing human expert that possesses a certain expertise and whose information can be stored and accessed within the MarketPlace application. It sports datatype properties like experienceInYears and yearsOnMarketPlace, and it is the domain of several object properties.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It is meant to represent the superclass of subjective properties that may be possessed by entities modeled in the MAEO ontology.</para>
    /// labels<para>Expert Subjective Property</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It models the personal details (name, address, contacts, etc.) of a human expert.</para>
    /// labels<para>Personal Detail</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It models a generic Agent in the MarketPlace, i.e. any entity (Knowledge Seeker, Knowledge Provider) that can act on the MarketPlace</para>
    /// labels<para>MarketPlace Agent</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>a knowledge-providing laboratory.</para>
    /// labels<para>Knowledge-providing Lab</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It describes the physical address of an organization.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A knowledge-providing juridical entity that possesses a certain expertise, and may or may not have something to do with Experts</para>
    /// labels<para>Knowledge-providing Organization</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>profileName</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para></para>
    /// labels<para>maeoObjectProperty</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>experienceInYears</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>certificationAuthorityName</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>contractConstraint</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>expirationDate</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para></para>
    /// labels<para>isLocatedAt</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>profileAddress</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para></para>
    /// labels<para>refersToOrganizationWithExpertise</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>remunerationValue</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para></para>
    /// labels<para>yearsOnMarketPlace</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It describes an actual certification a human expert may possess, with datatype properties like certificationTitle and expirationDate.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>It is meant to represent the superclass of all of the objective properties potentially possessed by the entities of the MAEO ontology.</para>
    /// labels<para>Expert Objective Property</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>This is the root class of the MAEO ontology, introduced for providing the ontology itself with a tree-like structure, with all of its other explicitly defined internal classes being subclasses of this class at various hierarchical levels.</para>
    /// labels<para>MarketPlace Agent and Expert Ontology</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para></para>
    /// labels<para>expertiseOn</para></remarks>
