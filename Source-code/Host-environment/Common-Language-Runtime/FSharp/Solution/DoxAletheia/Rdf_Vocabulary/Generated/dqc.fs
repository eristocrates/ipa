...
module dqc =
    ...
    let SyntaxConstraints = _prefix "SyntaxConstraints"
    /// <summary>
    ...
    let ``EAN-13Class`` = _prefix "EAN-13Class"
    /// <summary>
    ...
    let ExclusiveFunctionalDependencyAll = _prefix "ExclusiveFunctionalDependencyAll"
    /// <summary>
    ...
    let FunctionalDependencyConstraints = _prefix "FunctionalDependencyConstraints"
    ...
    let ExclusiveFunctionalDependencyClass =
        _prefix "ExclusiveFunctionalDependencyClass"
    ...
    let FiveDigitNumericAll = _prefix "FiveDigitNumericAll"
    ...
    let FunctionalDependencyTrustedReferenceAll =
        _prefix "FunctionalDependencyTrustedReferenceAll"
    ...
    let FunctionalDependencyTrustedReferenceClass =
        _prefix "FunctionalDependencyTrustedReferenceClass"
    ...
    let FunctionalDependencyTrustedReference_ClassOverBlankNode =
        _prefix "FunctionalDependencyTrustedReference_ClassOverBlankNode"
    ...
    let FunctionalDependentEmptyValueAll = _prefix "FunctionalDependentEmptyValueAll"
    /// <summary>
    ...
    let InconsistentValueRangeAll = _prefix "InconsistentValueRangeAll"
    /// <summary>
    ...
    let ValueRangeConstraints = _prefix "ValueRangeConstraints"
    /// <summary>
    ...
    let LegalValueConstraints = _prefix "LegalValueConstraints"
    /// <summary>
    ...
    let LettersAll = _prefix "LettersAll"
    /// <summary>
    ...
    let LettersAndDotsAll = _prefix "LettersAndDotsAll"
    /// <summary>
    ...
    let ListedIllegalValueAll = _prefix "ListedIllegalValueAll"
    /// <summary>
    ...
    let ListedIllegalValueClass = _prefix "ListedIllegalValueClass"
    /// <summary>
    ...
    let ListedLegalValueAll = _prefix "ListedLegalValueAll"
    /// <summary>
    ...
    let ListedLegalValueClass = _prefix "ListedLegalValueClass"
    ...
    let ListedLegalValueClassOverBlankNode =
        _prefix "ListedLegalValueClassOverBlankNode"
    ...
    let LowerLimitAll = _prefix "LowerLimitAll"
    /// <summary>
    ...
    let LowerLimitClass = _prefix "LowerLimitClass"
    /// <summary>
    ...
    let MissingElementConstraints = _prefix "MissingElementConstraints"
    /// <summary>
    ...
    let MissingLiterals = _prefix "MissingLiterals"
    /// <summary>
    ...
    let MissingLiteralsAndProperties = _prefix "MissingLiteralsAndProperties"
    /// <summary>
    ...
    let MissingProperties = _prefix "MissingProperties"
    /// <summary>
    ...
    let NumbersAll = _prefix "NumbersAll"
    /// <summary>
    ...
    let UniqueValueAll = _prefix "UniqueValueAll"
    /// <summary>
    ...
    let UniquenessConstraints = _prefix "UniquenessConstraints"
    /// <summary>
    ...
    let UniqueValueClass = _prefix "UniqueValueClass"
    /// <summary>
    ...
    let UpperLimitAll = _prefix "UpperLimitAll"
    /// <summary>
    ...
    let UpperLimitClass = _prefix "UpperLimitClass"
