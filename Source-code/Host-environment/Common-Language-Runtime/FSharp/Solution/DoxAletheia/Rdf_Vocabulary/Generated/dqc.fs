...
module dqc =
    ...
    /// <remarks>
    ///   <para>spin:Template</para>
    ///   <para>Syntax constraints identify values that do not adhere to syntactical rules. {@en} </para>
    ...
    /// labels<para>EAN-13 Class</para></remarks>
    ...
    /// labels<para>data quality constraint templates</para></remarks>
    ...
    /// labels<para>Inconsistent value range all</para></remarks>
    ...
    /// labels<para>EAN-13 All</para></remarks>
