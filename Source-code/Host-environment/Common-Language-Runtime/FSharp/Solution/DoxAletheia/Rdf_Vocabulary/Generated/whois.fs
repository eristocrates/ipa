...
module whois =
    ...
    ///   <para>A period of education in one's academic career, as a stage of life. NOT an activity of learning.</para>
    /// labels<para>Educaton (stage)</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A stage of life. A distinct time period in a sequence of one's life cycle.</para>
    ...
    ///   <para>A period of job in one's professional career, as a stage of life. NOT an activity of working.</para>
    /// labels<para>Job (stage)</para></remarks>
    ...
    ///   <para>A job, education or any achievement in one's life, which can be specific to a stage of life (object = #Stage) or in general (object = any).</para>
    ///   <para>人生における職業、教育、業績などを記述する</para>
    /// labels<para>Career</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>場所を表すクラス</para>
    ///   <para>A place -- this can be the domain of both contact: vocab and geo: vocab.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>a one's achievement in general. Note you can use foaf:pastProject for a specific achievement.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>an educational career in one's personal history.</para>
    ///   <para>学歴を記述する。careerのサブプロパティ</para>
    /// labels<para>Academic Career</para></remarks>
    ...
    ///   <para>One's birthday. This can be used in place of 'whois:since' where the 'whois:Stage' is one's first stage.</para>
    ///   <para>誕生日を記述する。sinceのサブプロパティ（人生の最初のステージの始まり）</para>
    /// labels<para>Born</para></remarks>
    ...
    ///   <para>General description of a person's activities. Use to describe something that does not fit into a Stage.</para>
    ...
    ///   <para>an honor that one has been rewarded.</para>
    /// labels<para>Honor</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>date when a stage of life started. </para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>General description of a person's future activities. Note past activity can be described with #career.</para>
    ...
    ///   <para>Describes an aspect of one's personal history. </para>
    /// labels<para>Stage</para></remarks>
    /// <seealso href="http://www.kanzaki.com/ns/whois#stage">http://www.kanzaki.com/ns/whois#stage</seealso>
    let stage = Prefixed_Name(whois, "stage") |> PrefixedName
    /// <summary>
    ...
    ///   <para>Place which relates to a stage of life. The range is whois:Place to have structured description. Use bio:place for literal value</para>
    ...
    ///   <para>Place which relates to a stage of life. Literal version of 'where'. ":x whois:place 'y'." implies ":x whois:where [rdfs:label 'y'].".</para>
    /// labels<para>Place</para></remarks>
    /// <seealso href="http://www.kanzaki.com/ns/whois#place">http://www.kanzaki.com/ns/whois#place</seealso>
    let place = Prefixed_Name(whois, "place") |> PrefixedName
    /// <summary>
    ...
    ///   <para>a one's publication in general. Note foaf:publications describes publication list page.</para>
    ...
    ///   <para>date/time which is related to a stage of life. Super property of since and until. W3C-DTF format value is assumed (i.e. can be yyyy, yyyy-mm, yyyy-mm-dd etc).</para>
    /// labels<para>When</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>a professional or business career in one's personal history.</para>
    ///   <para>職歴を記述する。careerのサブプロパティ</para>
    /// labels<para>Professional Career</para></remarks>
    ...
    ///   <para>date when a stage of life ended.</para>
    ...
    ///   <para>Specifies a topic in a stage of life. The range is owl:Thing to have structured description. Use dc:description for literal description, or dc:subject for keywords.</para>
    /// labels<para>What</para></remarks>
