...
module openwemi =
    ...
    ///   <para>"Relates any two resources that are or contain the same endeavor."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Relates any two resources that are or contain the same Expression."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Relates any two resources that are or contain the same Item."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Relates any two resources that are or contain the same Manifestation."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"Relates any two resources that are or contain the same Work."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
