...
module rdam =
    ...
    /// <summary>
    ///   <para>rdam:exemplarOfManifestation</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://rdaregistry.info/Elements/m/exemplarOfManifestation">http://rdaregistry.info/Elements/m/exemplarOfManifestation</seealso>
    let exemplarOfManifestation =
        Prefixed_Name(rdam, "exemplarOfManifestation") |> PrefixedName
