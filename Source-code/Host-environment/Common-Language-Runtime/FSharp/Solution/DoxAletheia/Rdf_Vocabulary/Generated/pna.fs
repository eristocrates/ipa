...
module pna =
    ...
    ///   <para>"The Asset Ontology describes news assets (text, images, video, data, etc), the relationships between them and how assets can be classified and semantically annotated."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
