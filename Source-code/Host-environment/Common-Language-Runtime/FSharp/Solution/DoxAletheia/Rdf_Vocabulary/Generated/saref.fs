...
module saref =
    ...
    ///  - The saref:hasTask property has been removed from the saref:Profile class to resolve an ambiguity with the saref:Task class."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    ///   <para>"A device responsible for moving or controlling a mechanism or system"</para>
    ///   <para>"A device responsible for moving or controlling a mechanism or system."</para>
    ///   <para>"A device responsible for moving or controlling a mechanism or system by performing an actuating function."</para>
    ...
    ///   <para>"A tangible object designed to accomplish a particular task in households, common public buildings or offices. In order to accomplish this task, the device performs one or more functions. For example, a washing machine is designed to wash (task) and to accomplish this task it performs a start and stop function. Devices can be structured in categories (subclasses) that reflect the different domain in which a device is used, e.g., smart appliances domain (subclass FunctionRelated) vs. building domain (subclass BuildingRelated) vs. smart grid domain (subclass EnergyRelated). New categories can be defined,if needed, to reflect other differences, for example different points of view, such as the point of view of the device's user vs. the point of view of the device's manufacturer. We propose a list of devices that are relevant for the purpose of SAREF, but this list can be extended."</para>
    ///   <para>"A tangible object designed to accomplish a particular task. In order to accomplish this task, the device performs one or more functions. For example, a washing machine is designed to wash (task) and to accomplish this task it performs a start and stop function."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A feature of interest represents any real world entity from which a property is measured."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"A feature of interest represents any real world entity from which a property is measured."</para>
    /// labels<para>"Feature of interest"</para><para>"Feature of interest"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"Humidity"</para><para>"Humidiy"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Represents the measured value made over a property. It is also linked to the unit of measure in which the value is expressed and the timestamp of the measurement."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <summary>
    ///   <para>saref:Observation</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Observation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="https://saref.etsi.org/core/Observation">https://saref.etsi.org/core/Observation</seealso>
    let Observation = Prefixed_Name(saref, "Observation") |> PrefixedName
    /// <summary>
    ...
    /// <summary>
    ///   <para>saref:ProcedureExecution</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Procedure Execution"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="https://saref.etsi.org/core/ProcedureExecution">https://saref.etsi.org/core/ProcedureExecution</seealso>
    let ProcedureExecution = Prefixed_Name(saref, "ProcedureExecution") |> PrefixedName
    /// <summary>
    ...
    ///   <para>"An aspect of an entity that can be observable by a sensor."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"Anything that can be sensed, measured or controlled in households, common public buildings or offices. We propose here a list of properties that are relevant for the purpose of SAREF, but this list can be extended."</para>
    ///   <para>"An aspect of an entity that can be observable by a sensor."</para>
    ///   <para>"A quality of a feature of interest that can be measured; an aspect of a feature of interest that is intrinsic to and cannot exist without the feature"</para>
    ///   <para>"Anything that can be sensed, measured or controlled in households, common public buildings or offices. We propose here a list of properties that are relevant for the purpose of SAREF, but this list can be extended."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Property"</para><para>"Property"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <summary>
    ///   <para>saref:PropertyValue</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Property Value"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="https://saref.etsi.org/core/PropertyValue">https://saref.etsi.org/core/PropertyValue</seealso>
    let PropertyValue = Prefixed_Name(saref, "PropertyValue") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A device that detects and responds to events or changes in the physical environment such as light, motion, or temperature changes. A device that has category saref:Sensor and performs a saref:SensingFunction."</para>
    ...
    ///   <para>"A device that detects and responds to events or changes in the physical environment such as light, motion, or temperature changes.
    /// A device that has category saref:Sensor and performs a saref:SensingFunction."</para>
    ...
    /// labels<para>"State"</para><para>"State"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>"The goal for which a device is designed (from a user perspective). For example, a washing machine is designed for the task of washing. We propose here a list of tasks that are relevant for the purpose of SAREF, but this list can be extended."</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"A saref:Property that allows to specify the time concept in terms of instants or intervals according to the imported W3C Time ontology."</para>
    ...
    ///   <para>"The unit of measure is a standard for measurement of a quantity, such as a Property. For example,  Power is a property and Watt is a unit of power that represents a definite predetermined power: when we say 10 Watt, we actually mean 10 times the definite predetermined power called "watt". Our definition is based on the definition of unit of measure in the Ontology of units of Measure (OM). We propose here a list of some units of measure that are relevant for the purpose of SAREF, but this list can be extended, also using some other ontologies rather than the Ontology of units of Measure (OM)."</para>
    /// labels<para>"Unit Of Measure"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"Unit of measure"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"A relationship between an entity (such as a function) and a command"</para>
    ...
    ///   <para>"A relationship providing a description of an entity (e.g., device)"</para>
    ...
    ///   <para>"A relationship identifying the function of a device"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"A relationship identifying the type of function of a device"</para>
    ///   <para>"A relationship identifying the function of a device."</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"A relationship identifying the manufacturer of an entity (e.g., device)"</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Relation betwwen a feature of interest and the measurments that are about it."</para>
    ///   <para>"A relationship between a feature of interest and a measurement about it"</para>
    /// labels<para>"is feature of interest of"</para><para>"has measurement"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"A relationship identifying the model of an entity (e.g., device)"</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Relation between a feature of interest and its properties."</para>
    ...
    /// <summary>
    ///   <para>saref:hasResult</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"has result"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="https://saref.etsi.org/core/hasResult">https://saref.etsi.org/core/hasResult</seealso>
    let hasResult = Prefixed_Name(saref, "hasResult") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"A relationship for identifying the state of a production equipment"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"A relationship identifying the type of state of a device"</para>
    /// labels<para>"has state"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"has state"</para></remarks>
    ...
    ///   <para>"A relationship defining the value of a certain property, e.g., energy or power"</para>
    ...
    ///   <para>"A relationship indentifying the task accomplished by a certain entity (e.g., a device)"</para>
    ...
    ///   <para>"A relation between a measurement and the unit of measure in which the measurement value is expressed."</para>
    ///   <para>"is measured in"</para>
    /// labels<para>"is measured in"</para><para>"is measured in"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Relation between a measurement and the feature of interest being measured."</para>
    ///   <para>"A relationship between a measurement and the feature of interest whose quality was measured"</para>
    /// labels<para>"is measurement of"</para><para>"has feature of interest"</para><para>"isMeasurementOf"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Relation between a property and a feature of interest in which such property appears."</para>
    ...
    /// <summary>
    ///   <para>saref:madeBy</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"made by"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="https://saref.etsi.org/core/madeBy">https://saref.etsi.org/core/madeBy</seealso>
    let madeBy = Prefixed_Name(saref, "madeBy") |> PrefixedName
    /// <summary>
    ///   <para>saref:makesMeasurement</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"A relation between a device and the measurements it makes. Such measurement will link together the value of the measurement, its unit of measure and the property to which it relates."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>"A relation between a sensor and the measurements it makes. Such measurement will link together the valur of the measurement, its unit of measure and the property to which it relates."</para>
    ...
    ///   <para>"Relation between a measurement and the device that made it."</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"A relation between a sensor and the property o properties it can take measurement about."</para>
    ///   <para>"A relationship specifying the property that can be measured by a certain device."</para>
    ///   <para>"A relationship specifying the property that can be measured by a certain device"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"A relationship specifying the property that can be measured by a certain device"</para>
    ...
    /// <summary>
    ///   <para>saref:observes</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"observes"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="https://saref.etsi.org/core/observes">https://saref.etsi.org/core/observes</seealso>
    let observes = Prefixed_Name(saref, "observes") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"A relation between a measurement and the property such measurement is about."</para>
    ...
    /// <summary>
    ///   <para>saref:v3.1.1/#saref:Measurement</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Measurement"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="https://saref.etsi.org/core/v3.1.1/#saref:Measurement">https://saref.etsi.org/core/v3.1.1/#saref:Measurement</seealso>
    let ``v3.1.1/#saref:Measurement`` =
        Prefixed_Name(saref, "v3.1.1/#saref:Measurement") |> PrefixedName

    /// <summary>
    ///   <para>saref:v3.1.1/#saref:Service</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Service"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="https://saref.etsi.org/core/v3.1.1/#saref:Service">https://saref.etsi.org/core/v3.1.1/#saref:Service</seealso>
    let ``v3.1.1/#saref:Service`` =
        Prefixed_Name(saref, "v3.1.1/#saref:Service") |> PrefixedName
