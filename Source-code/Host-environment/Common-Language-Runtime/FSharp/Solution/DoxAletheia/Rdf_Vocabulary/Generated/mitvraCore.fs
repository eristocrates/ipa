...
module mitvraCore =
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>"Entities are creators e.g. people or organisations"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>"An image record is used for the visual surrogates of objects"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>"A work"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>"A record is the superclass for Works and Images"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>"A Series"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>"A work record is used for physical or created objects"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
