...
module space =
    ...
    /// </para>
    /// labels<para>access controlled storage</para></remarks>
    ...
    ///     As a user, you normally don't have to worry about it.</para>
    ...
    /// </summary>
    /// <remarks>
    ///   <para>Access is to some but not all people.</para>
    /// labels<para>Shared workspace</para></remarks>
    ...
    /// </summary>
    /// <remarks>
    ///   <para>Access only by the you, the user.</para>
    /// labels<para>Private workspace</para></remarks>
    ...
    /// </para>
    /// labels<para>public storage</para></remarks>
    ...
    /// </summary>
    /// <remarks>
    ///   <para>Aceess may not be open to the public. Contains preferences resources.</para>
    /// labels<para>Preferences workspace</para></remarks>
    ...
    ///
    /// labels<para>preferences file</para></remarks>
    ...
    /// contains this resource, or a storage available to this agent to use.</para>
    ...
    /// </para>
    /// labels<para>URI prefix</para></remarks>
    ...
    /// </para>
    /// labels<para>personal storage</para></remarks>
    ...
    ///     can be accesed by anyone.</para>
    /// labels<para>Public workspace</para></remarks>
