...
module va =
    ...
    ///   <para>rdf:Property</para>
    ///   <para>This class can be used as a fallback for nominal dimensions. It should be avoided in favor of more specific dimension properties.</para>
    /// labels<para>Nominal cube dimension</para></remarks>
