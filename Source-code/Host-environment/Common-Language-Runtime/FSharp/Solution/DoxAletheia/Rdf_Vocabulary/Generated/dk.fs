...
module dk =
    ...
    /// labels<para>Business Rule Assessment</para><para>Geschäftsregelauswertung</para></remarks>
    ...
    /// labels<para>illustriert</para><para>illustrates</para></remarks>
