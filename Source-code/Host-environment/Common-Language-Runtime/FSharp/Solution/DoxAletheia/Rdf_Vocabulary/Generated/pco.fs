...
module pco =
    ...
    /// labels<para>Kritérium pro zadání zakázky.</para><para>Criterion for contract award.</para><para>Critères d'attribution</para><para>Vergabekriterien</para></remarks>
