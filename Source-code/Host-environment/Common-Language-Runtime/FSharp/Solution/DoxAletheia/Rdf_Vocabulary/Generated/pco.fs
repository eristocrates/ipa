...
module pco =
    ...
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://purl.org/procurement/public-contracts#">http://purl.org/procurement/public-contracts#</seealso>
    let _prefix_iri = Prefixed_Name(pco, "") |> PrefixedName
    ...
    /// labels<para>"Combination of contract award criteria"</para><para>"Kombinace kritérií pro hodnocení dodaných nabídek"</para><para>"Award criteria combination"</para><para>"Combinación de criterios para la adjudicación"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Award criterion"</para><para>"Criterio de adjudicación"</para></remarks>
    ...
    /// <summary>
    ///   <para>pco:CompetitiveDialogue</para>
    /// </summary>
    /// <remarks>
    ///   <para>skos:Concept</para>
    ///   <para>owl:NamedIndividual</para>
    ///
    /// labels<para>"Diálogo competitvo"</para><para>"Competitive dialogue"</para></remarks>
    /// <seealso href="http://purl.org/procurement/public-contracts#CompetitiveDialogue">http://purl.org/procurement/public-contracts#CompetitiveDialogue</seealso>
    let CompetitiveDialogue = Prefixed_Name(pco, "CompetitiveDialogue") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"Contrato"</para><para>"Contract"</para><para>"Veřejná zakázka"</para><para>"Public contract"</para></remarks>
    ...
    /// labels<para>"Contract award weighted criterion"</para><para>"Vážené kritérium pro udělení zakázky"</para></remarks>
    ...
    /// <summary>
    ///   <para>pco:Negotiated</para>
    /// </summary>
    /// <remarks>
    ///   <para>skos:Concept</para>
    ///   <para>owl:NamedIndividual</para>
    /// </remarks>
    /// <seealso href="http://purl.org/procurement/public-contracts#Negotiated">http://purl.org/procurement/public-contracts#Negotiated</seealso>
    let Negotiated = Prefixed_Name(pco, "Negotiated") |> PrefixedName
    /// <summary>
    ///   <para>pco:Open</para>
    /// </summary>
    /// <remarks>
    ...
    ///   <para>skos:Concept</para>
    /// </remarks>
    /// <seealso href="http://purl.org/procurement/public-contracts#Open">http://purl.org/procurement/public-contracts#Open</seealso>
    let Open = Prefixed_Name(pco, "Open") |> PrefixedName
    /// <summary>
    ///   <para>pco:Restricted</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Restringido"</para><para>"Restricted"</para></remarks>
    /// <seealso href="http://purl.org/procurement/public-contracts#Restricted">http://purl.org/procurement/public-contracts#Restricted</seealso>
    let Restricted = Prefixed_Name(pco, "Restricted") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"Nabídka"</para><para>"Tender"</para><para>"Oferta de licitación"</para></remarks>
    ...
    /// labels<para>"Actual end date of contract realization"</para><para>"Actual end date"</para><para>"Fecha de finalización final"</para><para>"Skutečné datum konce realizace zakázky"</para></remarks>
    ...
    /// labels<para>"Precio final"</para><para>"Actual price"</para><para>"Skutečná cena po realizaci zakázky"</para><para>"Actual price after contract realization"</para></remarks>
    ...
    /// labels<para>"Další předmět zakázky"</para><para>"Additional object of contract"</para></remarks>
    ...
    /// labels<para>"Agreed price"</para><para>"Smluvní cena"</para></remarks>
    ...
    /// labels<para>"Contract agreement"</para><para>"Smlouva na veřejnou zakázku"</para></remarks>
    ...
    /// labels<para>"Druh zadavatele"</para><para>"Kind of contracting authority"</para></remarks>
    ...
    /// labels<para>"Criteria combination for tender evaluation."</para><para>"Award criteria combination"</para><para>"Kombinace kritérií pro hodnocení nabídek zájemců o zakázku."</para><para>"Combinación de criterios para la adjudicación"</para></remarks>
    /// <seealso href="http://purl.org/procurement/public-contracts#awardCriteriaCombination">http://purl.org/procurement/public-contracts#awardCriteriaCombination</seealso>
    let awardCriteriaCombination =
        Prefixed_Name(pco, "awardCriteriaCombination") |> PrefixedName
    ...
    /// labels<para>"Vergabekriterien"</para><para>"Criterion for contract award."</para><para>"Criterio de adjudicación"</para><para>"Award criterion"</para><para>"Kritérium pro zadání zakázky."</para><para>"Critères d'attribution"</para></remarks>
    /// <seealso href="http://purl.org/procurement/public-contracts#awardCriterion">http://purl.org/procurement/public-contracts#awardCriterion</seealso>
    let awardCriterion = Prefixed_Name(pco, "awardCriterion") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"Date of contract award"</para><para>"Datum přidělení zakázky"</para></remarks>
    ...
    /// labels<para>"Tender bidder"</para><para>"Zájemce o zakázku"</para></remarks>
    ...
    /// labels<para>"Contact person"</para><para>"Kontaktní osoba"</para></remarks>
    ...
    /// labels<para>"Zadavatel"</para><para>"Entidad contratante"</para><para>"Contracting authority"</para></remarks>
    ...
    /// labels<para>"Contract award criterion weight"</para><para>"Váha kritéria pro výběr dodavatele zakázky"</para><para>"Peso del criterio"</para><para>"Criterion weight"</para></remarks>
    ...
    /// <summary>
    ///   <para>pco:criteronName</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Criterion name"</para><para>"Nombre del criterio"</para></remarks>
    /// <seealso href="http://purl.org/procurement/public-contracts#criteronName">http://purl.org/procurement/public-contracts#criteronName</seealso>
    let criteronName = Prefixed_Name(pco, "criteronName") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"Cena zadávací dokumentace k zakázce"</para><para>"Price of documentation for public contract"</para></remarks>
    ...
    /// labels<para>"Doba trvání zakázky"</para><para>"Duration of contract"</para></remarks>
    ...
    /// labels<para>"Estimated end date of contract"</para><para>"Očekávané datum konce realizace zakázky"</para></remarks>
    ...
    /// labels<para>"Exact estimated price"</para><para>"Odhadovaná cena zakázky"</para></remarks>
    ...
    /// labels<para>"Contract kind"</para><para>"Kategorie zakázky"</para></remarks>
    ...
    /// labels<para>"Lote"</para><para>"Contract lot"</para><para>"Část zakázky"</para><para>"Lot"</para></remarks>
    ...
    /// labels<para>"Hlavní aktivita"</para></remarks>
    ...
    /// labels<para>"Počet obdržených nabídek"</para><para>"Number of tenders received"</para></remarks>
    ...
    /// labels<para>"Offered price in tender"</para><para>"Nabídnutá cena v nabídce"</para><para>"Precio ofrecido"</para><para>"Offered price"</para></remarks>
    ...
    /// labels<para>"Jménem"</para><para>"On behalf of"</para><para>"En nombre de"</para></remarks>
    ...
    /// labels<para>"Profilová stránka zadavatele"</para><para>"Profile web site of contracting authority"</para></remarks>
    ...
    /// labels<para>"Contract specification"</para><para>"Zadávací dokumentace zakázky"</para></remarks>
    ...
    /// <summary>
    ///   <para>pco:supplier</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Supplier"</para><para>"Proveedor"</para></remarks>
    /// <seealso href="http://purl.org/procurement/public-contracts#supplier">http://purl.org/procurement/public-contracts#supplier</seealso>
    let supplier = Prefixed_Name(pco, "supplier") |> PrefixedName
    /// <summary>
    ///   <para>pco:tender</para>
    /// </summary>
    /// <remarks>
    ...
    /// labels<para>"Nabídka"</para><para>"Submitted tender"</para><para>"Tender"</para><para>"Oferta presentada"</para></remarks>
    /// <seealso href="http://purl.org/procurement/public-contracts#tender">http://purl.org/procurement/public-contracts#tender</seealso>
    let tender = Prefixed_Name(pco, "tender") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"Lhůta pro doručení nabídek nebo přijetí žádostí o účast"</para><para>"Time-limit for receipt of tenders or requests to participate"</para></remarks>
    ...
    /// labels<para>"Vážené kritérium"</para><para>"Weighted criterion"</para></remarks>
