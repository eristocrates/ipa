...
module dba =
    ...
    /// labels<para>Minutes</para><para>Verbale</para></remarks>
    ...
    /// <summary>
    ///   <para>dba:PreliminaryAssessment</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// labels<para>Preliminary assessment</para><para>Istruttoria</para></remarks>
    ...
    /// labels<para>Pratica bancaria</para><para>File</para></remarks>
    ...
    /// <summary>
    ///   <para>dba:SeizureEvent</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Execution of the seizure</para>
    ///   <para>Esecuzione del sequestro</para>
    /// labels<para>Sequestro</para><para>Seizure</para></remarks>
    ...
    /// labels<para>Finanziamento</para><para>Financing</para></remarks>
    ...
    /// labels<para>Credit line</para><para>Fido</para></remarks>
    ...
    /// <summary>
    ///   <para>dba:hasFollowingEvent</para>
    /// </summary>
    /// <remarks>
    ...
    /// labels<para>evento successivo</para><para>following event</para></remarks>
    ...
    /// <summary>
    ///   <para>dba:outcome</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>outcome</para><para>esito</para></remarks>
    ...
    /// <summary>
    ///   <para>dba:requiredAmount</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>importo richiesto</para><para>required amount</para></remarks>
    ...
    /// <summary>
    ///   <para>dba:requiredDuration</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    /// </remarks>
    ...
    /// labels<para>Restituzione</para><para>Restitution</para></remarks>
    ...
    /// <summary>
    ///   <para>dba:DeedOfResolution</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// <summary>
    ///   <para>dba:ConfiscationEvent</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// labels<para>Conclusion</para><para>Stipula</para></remarks>
    ...
    /// labels<para>Sponsorizzazioni</para><para>Sponsorships</para></remarks>
    ...
    /// labels<para>Crediti</para><para>Credit</para></remarks>
    ...
    /// <summary>
    ///   <para>dba:ImmovableProperty</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// labels<para>Immovable property</para><para>Bene immobile</para></remarks>
    ...
    /// labels<para>Sussidio</para><para>Subsidy</para></remarks>
    ...
    /// <summary>
    ///   <para>dba:approvedDuration</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>approval duration</para><para>durata deliberata</para></remarks>
    ...
    /// <summary>
    ///   <para>dba:duration</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>duration</para><para>durata</para></remarks>
    ...
    /// labels<para>is approved by</para><para>approvato da</para></remarks>
    ...
    /// labels<para>si compone di</para><para>consists of</para></remarks>
    ...
    /// labels<para>Relazione</para><para>Report</para></remarks>
    ...
    /// labels<para>Alienazione</para><para>Alienation</para></remarks>
    ...
    /// labels<para>Movable property</para><para>Bene mobile</para></remarks>
    ...
    /// labels<para>documentato da</para><para>documented by</para></remarks>
    ...
    /// labels<para>preparato da</para><para>prepared by</para></remarks>
    ...
    /// labels<para>istruisce</para><para>prepares</para></remarks>
    ...
    /// labels<para>mentions</para><para>cita</para></remarks>
