...
module dba =
    ...
    let Restitution =
        Namespaced_IRI.parse _namespace_name "Restitution" |> NamespacedName

    /// <summary>
    /// Execution of the confiscation
    /// <see href="https://w3id.org/dba/ontology/ConfiscationEvent"></see></summary>
    let ConfiscationEvent =
        Namespaced_IRI.parse _namespace_name "ConfiscationEvent" |> NamespacedName
    ...
    let DeedOfResolution =
        Namespaced_IRI.parse _namespace_name "DeedOfResolution" |> NamespacedName
    ...
    let Guarantee = Namespaced_IRI.parse _namespace_name "Guarantee" |> NamespacedName
    ...
    let PreliminaryAssessment =
        Namespaced_IRI.parse _namespace_name "PreliminaryAssessment" |> NamespacedName
    ...
    let Alienation = Namespaced_IRI.parse _namespace_name "Alienation" |> NamespacedName
    /// <summary>
    ...
    let SeizureEvent =
        Namespaced_IRI.parse _namespace_name "SeizureEvent" |> NamespacedName
    ...
    let Confiscation =
        Namespaced_IRI.parse _namespace_name "Confiscation" |> NamespacedName
    ...
    let CreditLine = Namespaced_IRI.parse _namespace_name "CreditLine" |> NamespacedName
    ...
    let ImmovableProperty =
        Namespaced_IRI.parse _namespace_name "ImmovableProperty" |> NamespacedName
    ...
    let Mortage = Namespaced_IRI.parse _namespace_name "Mortage" |> NamespacedName
    ...
    let MovableProperty =
        Namespaced_IRI.parse _namespace_name "MovableProperty" |> NamespacedName
    ...
    let Seizure = Namespaced_IRI.parse _namespace_name "Seizure" |> NamespacedName
    ...
    let Sponsorships =
        Namespaced_IRI.parse _namespace_name "Sponsorships" |> NamespacedName
    ...
    /// </summary>
    let approvedAmount =
        Namespaced_IRI.parse _namespace_name "approvedAmount" |> NamespacedName

    /// <summary>
    ///   <see href="https://w3id.org/dba/ontology/approvedDuration"></see>
    /// </summary>
    let approvedDuration =
        Namespaced_IRI.parse _namespace_name "approvedDuration" |> NamespacedName
    ...
    /// </summary>
    let fileNumber = Namespaced_IRI.parse _namespace_name "fileNumber" |> NamespacedName

    /// <summary>
    /// An event that starts at some time after this event.
    /// <see href="https://w3id.org/dba/ontology/hasFollowingEvent"></see></summary>
    let hasFollowingEvent =
        Namespaced_IRI.parse _namespace_name "hasFollowingEvent" |> NamespacedName
    ...
    let isPreparedBy =
        Namespaced_IRI.parse _namespace_name "isPreparedBy" |> NamespacedName
    ...
    let isSubjectTo =
        Namespaced_IRI.parse _namespace_name "isSubjectTo" |> NamespacedName
    ...
    let regards = Namespaced_IRI.parse _namespace_name "regards" |> NamespacedName

    /// <summary>
    ///   <see href="https://w3id.org/dba/ontology/requiredAmount"></see>
    /// </summary>
    let requiredAmount =
        Namespaced_IRI.parse _namespace_name "requiredAmount" |> NamespacedName

    /// <summary>
    ///   <see href="https://w3id.org/dba/ontology/requiredDuration"></see>
    /// </summary>
    let requiredDuration =
        Namespaced_IRI.parse _namespace_name "requiredDuration" |> NamespacedName

    /// <summary>
    ///   <see href="https://w3id.org/dba/ontology/restitutionDate"></see>
    /// </summary>
    let restitutionDate =
        Namespaced_IRI.parse _namespace_name "restitutionDate" |> NamespacedName

    /// <summary>
    ///   <see href="https://w3id.org/dba/ontology/seizureDate"></see>
    /// </summary>
    let seizureDate =
        Namespaced_IRI.parse _namespace_name "seizureDate" |> NamespacedName
