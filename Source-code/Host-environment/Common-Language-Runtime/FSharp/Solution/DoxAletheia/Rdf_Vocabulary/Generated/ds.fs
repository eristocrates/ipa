...
module ds =
    ...
    /// labels<para>"Taxonomy of the information access mode"</para><para>"Taxonomía de los tipos de acceso a la información"</para></remarks>
    ...
    /// labels<para>"Taxonomy of the catalog statuses"</para><para>"Taxonomía de los estados de un catálogo"</para></remarks>
