...
module gm =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Orientable primitive</para></remarks>
    ...
    /// NOTE As a type, GM_Object does not have a well-defined default state or value representation as a data type. Instantiated subclasses of GM_Object will.</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>upper corner</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Geometry Aggregate</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>geometric position</para></remarks>
    /// <seealso href="http://def.seegrid.csiro.au/isotc211/iso19107/2003/geometry#position">http://def.seegrid.csiro.au/isotc211/iso19107/2003/geometry#position</seealso>
    let position = Prefixed_Name(gm, "position") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>lower corner</para></remarks>
