...
module gtfs =
    ...
    /// labels<para>Destination Stop</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdfs:Class</para>
    ///   <para>An alternative to defining departures and arrivals as StopTimes: define frequencies for transit vehicle</para>
    ...
    /// labels<para>Origin Stop</para></remarks>
