...
module bbccore =
    ...
    /// labels<para>eventPerson</para></remarks>
    ...
    /// labels<para>placeOfDeath</para></remarks>
    ...
    /// labels<para>eventOrganisation</para></remarks>
    ...
    /// labels<para>eventPlace</para></remarks>
    ...
    /// labels<para>dateOfDeath</para></remarks>
    ...
    /// labels<para>eventTheme</para></remarks>
    ...
    /// labels<para>placeOfBirth</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Represents the fact that a thing (usually concept, e.g., Tom Daley) is the primary topic of a web document.</para>
    /// labels<para>primaryTopic</para></remarks>
