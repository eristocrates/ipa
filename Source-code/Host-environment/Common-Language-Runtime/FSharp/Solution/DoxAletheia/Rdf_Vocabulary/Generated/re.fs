...
module re =
    ...
    /// 	and building a formula from them."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// 	from).
    /// 	"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"Conjunction elimination"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///
    /// labels<para>"GMP Inference"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// 	"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"proof"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// 	"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"proof step"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// 	    on the command line"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"gives the step whose data was input to this step."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// 	"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"bound to"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"A step whose data was used in building this conjunction"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///     result of making the given substitution in the antecedent of the rule."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"antecedents"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// 	and so the proof can still be checked if the reason:gives ars"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"gives"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///     given."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// 	would be treated as a variable."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
