...
module muto =
    ...
    let PrivateTagging = _prefix "PrivateTagging"
    /// <summary>
    ...
    let autoMeaning = _prefix "autoMeaning"
    /// <summary>
    ...
    let grantAccess = _prefix "grantAccess"
    /// <summary>
    ...
    let meaningOf = _prefix "meaningOf"
    /// <summary>
    ...
    let previousTag = _prefix "previousTag"
    /// <summary>
    ...
    let tagCreated = _prefix "tagCreated"
    /// <summary>
    ...
    let taggingCreated = _prefix "taggingCreated"
    /// <summary>
    ...
    let taggingModified = _prefix "taggingModified"
