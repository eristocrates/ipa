...
module kanzaki =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical group of singers.</para>
    /// labels<para>Chorus</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An event of musical performance by players or singers not involving theatrical staging</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A composition for orchestra (and a soloist or soloists, optionally with chorus)</para>
    /// labels<para>Orchestral Work</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A person or group (or any agent) who creates or performs art works</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A wind musical instrument, in which sound is produced by the vibration of reeds in the mouthpiece, or by the passing of air across the mouthpiece.</para>
    /// labels<para>Woodwind Instrument</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical instrument that has a set of keys that consist of scale.</para>
    /// labels<para>Keyboard Instrument</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Contrabass player</para>
    /// labels<para>Contrabassist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Contrafagotto player</para>
    /// labels<para>ContrafagottoPlayer</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Countertenor singer</para>
    /// labels<para>Countertenor</para></remarks>
    ...
    ///   <para>Major key based on D, whose key signature has 2 sharps.</para>
    /// labels<para>D dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Major key based on E, whose key signature has 4 sharps.</para>
    /// labels<para>E dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A woodwind instrument with a conical bore and a double-reed mouthpiece.</para>
    /// labels<para>Oboe</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An English Horn player</para>
    /// labels<para>English Horn player</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An Oboe player</para>
    /// labels<para>Oboist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical group which perfroms in relatively small size, particularly chamber music</para>
    /// labels<para>Ensemble</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Major key based on F, whose key signature has 1 flat.</para>
    /// labels<para>F dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Major key based on F sharp, whose key signature has 6 sharps.</para>
    /// labels<para>Fis dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A high-pitched woodwind instrument; a slender tube closed at one end with finger holes on one end and an opening near the closed end across which the breath is blown</para>
    /// labels<para>Flute</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Flute player</para>
    /// labels<para>Flutist</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Major key based on G, whose key signature has 1 sharp.</para>
    /// labels<para>G dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical instrument having a large flat-backed sound box, a long fretted neck, and usually six strings, played by strumming or plucking.</para>
    /// labels<para>Guitar</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Major key based on D flat, whose key signature has 5 flats.</para>
    /// labels<para>Des dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A double-reed woodwind instrument, larger member of the oboe family.</para>
    /// labels<para>English Horn</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Major key based on E flat, whose key signature has 3 flats.</para>
    /// labels<para>Es dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Major key based on G flat, whose key signature has 6 flats.</para>
    /// labels<para>Ges dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Major key based on B, whose key signature has 5 sharps.</para>
    /// labels<para>H dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Harp player</para>
    /// labels<para>Harpist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A brass instrument with a long narrow tube that is coiled in a circle before ending in a flaring bell, usually being equipped with valves. A French Horn.</para>
    /// labels<para>Horn</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Horn player</para>
    /// labels<para>Hornist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A pear-shaped small stringed instrument descended from the lute, played with a pick.</para>
    /// labels<para>Mandolin</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical work in any form, e.g. a composition, its movement, phrase, theme etc.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>The person who leads a musical group</para>
    /// labels<para>Music Director</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Guitar player</para>
    /// labels<para>Guitarist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An instrument with usually 46 or 47 strings that are played by plucking with the fingers.</para>
    /// labels<para>Harp</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A keyboard instrument whose strings are plucked by means of quills or plectrums. Cembalo.</para>
    /// labels<para>Harpsichord</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Mezzo Soprano singer</para>
    /// labels<para>Mezzo Soprano</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Representation of a musical work, such as a score, sheet music, perfornamce, recoding, etc.</para>
    /// labels<para>Musical Representation</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A subsection of a musical work. Typically a movement of a symphony, but also a piece of suit, etc.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical work with drama, song, chorus and orchestral music. Note 'Opera_Event' in this vocabulary describes the performance of an opera.</para>
    /// labels<para>Opera (Work)</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical group that performs opera works.</para>
    /// labels<para>Opera Company</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A large musical composition for orchestra, vocal soloists and chorus</para>
    /// labels<para>Oratorio</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An orchestral music composed for the opening of an opera or oratorio, often played as an independend work in concerts</para>
    /// labels<para>Overture</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A music for a particular instrument or voice taken from a full score (Note: in this ontology, Part is not a division of an orchestra).</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Representation of a musical work in the form of a written expression, e.g. score, parts, autograph, printed music, sketch, etc.</para>
    /// labels<para>Written Representation</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical instrument that produces sound by striking the body.</para>
    /// labels<para>Percussion</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Percussion player</para>
    /// labels<para>Percussionist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Piano player</para>
    /// labels<para>Pianist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical instrument with a manual keyboard actuating hammers that strike wire strings. A pianoforte.</para>
    /// labels<para>Pian</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Piccolo flute player</para>
    /// labels<para>Piccolo player</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An event of musical performance especially by soloists</para>
    /// labels<para>Recital</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A genre of music composed for performance as part of religious ceremonies</para>
    /// labels<para>Religious Music</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A woodwind instrument with a single-reed mouthpiece and a (usually curved) conical metal tube, including soprano, alto, tenor, and baritone sizes.</para>
    /// labels<para>Saxophone</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A full score or piano-vocal score of a work, either published or manuscript.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A sketch, or a brief prelimary composition of a work.</para>
    /// labels<para>Sketch</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Soprano singer</para>
    /// labels<para>Soprano</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A smaller member of the clarinet family, commonly in key E-flat.</para>
    /// labels<para>Soprano Clarinet</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical group of four string players. Note 'String_Quartette' is SQ as musical work in this vocabulary.</para>
    /// labels<para>Qtring Quartet</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A music composed for instrumental quartet with 2 violins and a viola and a cello. Note 'StringQuartetEnsemble' is SQ ensemble in this vocabulary.</para>
    /// labels<para>String Quartet</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical composition of several movements only loosely connected</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An orchestral composition based on a thematic subject</para>
    /// labels<para>Symphonic Poem</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A large and complex work for symphony orchestra</para>
    /// labels<para>Symphony</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Text of a musical work (e.g. lyric or verse)</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A set of large copper or brass hemispherical drums with a parchment head that can be tuned by adjusting the tension.</para>
    /// labels<para>Timpani</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Trombone player</para>
    /// labels<para>Trombonist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A A soprano brass instrument consisting of a long metal tube looped once and ending in a flared bell, usually being equipped with valves or pistons.</para>
    /// labels<para>Trumpet</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A large, valved, brass instrument with a bass pitch.</para>
    /// labels<para>Tuba</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Tuba player</para>
    /// labels<para>TubaPlayer</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical instrument played with a bow, having four strings. Usually plays the highest part of the string section.</para>
    /// labels<para>Violin</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Violn player</para>
    /// labels<para>Violinist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Viola player</para>
    /// labels<para>Violist</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Minor key based on A sharp, whose key signature has 7 sharps.</para>
    /// labels<para>ais moll</para></remarks>
    ...
    ///   <para>A description of the subject artist or agent. Super-property of #plays, #performs.</para>
    /// labels<para>Artist Description</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Minor key based on A flat, whose key signature has 7 flats.</para>
    /// labels<para>as moll</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Minor key based on C, whose key signature has 3 flats.</para>
    /// labels<para>c moll</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Minor key based on C sharp, whose key signature has 4 sharps.</para>
    /// labels<para>cis moll</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject musical work is composed by a person, a group, a software program etc.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A description of the subject musical work. Super-property of some properties in this vocabulary, as well as description of a general descriptive resource such as time-line of composing process.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Describes the composition process of the subject. Composition period or completion date, place, revision etc. can be described as properties of the object composition process.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject has a performer (an artist, a group, a machine etc.). The preferred domain of this property is #Performance, so as to model that "a concert presents a performance (of a musical work) that is realized by this performer". However, in natural language, we often say that "a concert has performers who play these musical works", i.e. the domain of 'performer' is #Musical_Event in this case, and it would be more intuitive model. Hence, the domain is leave unrestricted here for a moment. </para>
    ...
    ///   <para>The subject musical event has a conductor. Literal version of #conductor.</para>
    /// labels<para>Conductor Name</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The subject musical event has a performer. Literal version of #performer.</para>
    /// labels<para>PerformerName</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Minor key based on D, whose key signature has 1 flat.</para>
    /// labels<para>d moll</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject is (was) derived from the object, e.g a copy score is derived from the composer manuscript (or, possibly, a CD recording is derived from a performance at a concert).</para>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Minor key based on E, whose key signature has 1 sharp.</para>
    /// labels<para>e moll</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Minor key based on E flat, whose key signature has 6 flats.</para>
    /// labels<para>es moll</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A description of the subject musical event. Super-property of #program, #presents, #venue.</para>
    /// labels<para>Event Description</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Minor key based on F, whose key signature has 4 flats.</para>
    /// labels<para>f moll</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Minor key based on G, whose key signature has 2 flats.</para>
    /// labels<para>g moll</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Minor key based on G sharp, whose key signature has 5 sharps.</para>
    /// labels<para>gis moll</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Minor key based on B, whose key signature has 2 sharps.</para>
    /// labels<para>h moll</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject musical work or its movement has a key, such as C major, d minor, etc.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The subject musical work or its movement has instruction mark(s) of tempo and/or expression</para>
    /// labels<para>Marks</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The subject musical work or its movement has a time measure such as 3/4, 4/4, 6/8 etc</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The subject musical composition has an identifier assigned by a composer (e.g. 'op.131') or other editor (e.g. 'KV.551')</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject artist (or group, machine, etc) performs a musical work.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject musical work was first performed at an concert</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject musical event presents a performance of a musical work. An experiment to have better model to describe musical work, its representation and an event to present the representation.</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The subject musical event presents a musical work as its program. Literal version of #program.</para>
    /// labels<para>Program Line</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject musical work is published as a score or sheet music (still not sure what kind of class is appropriate as the range)</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject (performance, score, etc) is a representation of the object musical work. An experiment to have better model.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject musical work has subsections such as movements. Current model recommends RDF Collection as the object.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject performance is performed by this soloist (or the subject musical event has a soloist. See comment of #performer.</para>
    /// labels<para>Soloist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject musical work has a historical source, such as sketch, autograph score or published score.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject musical event is presented at the object venue.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An Alto singer</para>
    /// labels<para>Alto</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Major key based on B flat, whose key signature has 2 flats.</para>
    /// labels<para>B dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A (complete) musical work by a composer.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical group that performs ballet works.</para>
    /// labels<para>Ballet Company</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An event of musical performance by players or singers, including theatrical staging. Typically the event has date and location. Note this is different from Performance, which is a 'representation' of a musical work realized at a musical event or recording, etc.</para>
    /// labels<para>Musical Event</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A larger member of the clarinet family, usually in key B-flat.</para>
    /// labels<para>Bass Clarinet</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject artist (or group, machine, etc) plays an musical instrument. If :me :plays :Violin, then :me a :Violininst.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject performance is coducted by the object (or the subject musical event has a conductor). See comment of #performer.</para>
    /// labels<para>Conductor</para></remarks>
    /// <seealso href="http://www.kanzaki.com/ns/music#conductor">http://www.kanzaki.com/ns/music#conductor</seealso>
    let conductor = Prefixed_Name(kanzaki, "conductor") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A key of a musical work (e.g. C-dur, b-moll)</para>
    /// labels<para>Key</para></remarks>
    /// <seealso href="http://www.kanzaki.com/ns/music#Key">http://www.kanzaki.com/ns/music#Key</seealso>
    let Key = Prefixed_Name(kanzaki, "Key") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Representation of a musical work in the form of performace, e.g. playing instruments, singing etc. Note a concert is a Musical_Event where a Performance is presented.</para>
    /// labels<para>Peroformance</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A piccolo flute, smaller member of the flute family.</para>
    /// labels<para>Piccolo</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Major key based on A, whose key signature has 3 sharps.</para>
    /// labels<para>A dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An event of opera performance (not an opera as a musical work, which is defined here as 'Opera')</para>
    /// labels<para>Opera Event</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical group which perfroms large scale symphonic works</para>
    /// labels<para>Orchestra</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An artist who sings a song</para>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Major key based on A flat, whose key signature has 4 flats.</para>
    /// labels<para>As dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical work for a dance form featuring a staged presentation of group or solo dancing. Note 'Ballet_Event' in this vocabulary describes the performance of a ballet.</para>
    /// labels<para>Ballet (Work)</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A group that performs art works</para>
    /// labels<para>Musical Group</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Baritone singer</para>
    /// labels<para>Baritone</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A stringed instrument of the violin family, slightly larger than a violin, tuned a fifth lower, and having a deeper, more sonorous tone.</para>
    /// labels<para>Viola</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Tenor singer</para>
    /// labels<para>Tenor</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Timpani player</para>
    /// labels<para>Timpanist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A brass instrument consisting of a long cylindrical tube, and having a movable U-shaped slide for producing different pitches.</para>
    /// labels<para>Trombone</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Trumpet player</para>
    /// labels<para>Trumpeter</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A venue for musical performance, e.g. concert hall, opera house, recital hall, etc.</para>
    /// labels<para>Venue</para></remarks>
    /// <seealso href="http://www.kanzaki.com/ns/music#Venue">http://www.kanzaki.com/ns/music#Venue</seealso>
    let Venue = Prefixed_Name(kanzaki, "Venue") |> PrefixedName
    /// <summary>
    ...
    ///   </para>
    /// labels<para>Ballet Event</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Bass Clarinet player</para>
    /// labels<para>Bass_Clarinettist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Clarinet player</para>
    /// labels<para>Clarinettist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A low-pitched woodwind instrument with a double reed, having a long wooden body attached to a U-shaped lateral tube that leads to the mouthpiece. A Fagotto.</para>
    /// labels<para>Bassoon</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Minor key based on D sharp, whose key signature has 6 sharps.</para>
    /// labels<para>dis moll</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Minor key based on F sharp, whose key signature has 3 sharps.</para>
    /// labels<para>fis moll</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The subject musical work or its movement has a form, such as sonata, minuet, etc. Would be better defined as ObjectProperty.</para>
    ...
    ///   <para>kanzaki:Key</para>
    ///   <para></para>
    /// labels<para>a moll</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Minor key based on B flat, whose key signature has 5 flats.</para>
    /// labels<para>b moll</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An artist who performs a musical instrument</para>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Major key based on C, whose key signature has no sharp or flat.</para>
    /// labels<para>C dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The subject musical work or its movement has a key. Textual version of #key.</para>
    /// labels<para>Key Name</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Fagotto player</para>
    /// labels<para>Bassoonist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An instrument to play music</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A genre of music composed for performance by a chorus or choir</para>
    /// labels<para>Choral Music</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A wind musical instrument, that consists of a brass tube  blown by means of a cup-shaped or funnel-shaped mouthpiece.</para>
    /// labels<para>Brass Instrument</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A vocal composition accompanied by instruments and generally containing more than one movement.</para>
    /// labels<para>Cantata</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A musical instrument with a keyboard and metal plates struck by hammers that produce bell-like tones.</para>
    /// labels<para>Celesta</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Celesta player</para>
    /// labels<para>CelestaPlayer</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The subject musical event presents a musical work as its program</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Cello player</para>
    /// labels<para>Cellist</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A stringed instrument of the violin family, with bass to tenor tone. Usually played in sitting position.</para>
    /// labels<para>Cello</para></remarks>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Major key based on C flat, whose key signature has 7 flats.</para>
    /// labels<para>Ces dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A genre of music composed for performance by small ensemble</para>
    /// labels<para>Chamber Music</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A stringed musical instrument, in which sound is produced by plucking, striking, or bowing taut strings.</para>
    /// labels<para>String Instrument</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>someone who creates new dances, or directs an opera</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An artist who directs a musical group</para>
    ...
    /// <remarks>
    ///   <para>kanzaki:Key</para>
    ///   <para>Major key based on C sharp, whose key signature has 7 sharps.</para>
    /// labels<para>Cis dur</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A person (or any agent) who composed art works</para>
    /// labels<para>Composer</para></remarks>
    /// <seealso href="http://www.kanzaki.com/ns/music#Composer">http://www.kanzaki.com/ns/music#Composer</seealso>
    let Composer = Prefixed_Name(kanzaki, "Composer") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A composition for orchestra and a soloist</para>
    /// labels<para>Concerto</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An artist who performs, composes or conducts music</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>The largest member of string insrtument, usually with four or five strings.</para>
    /// labels<para>Contrabass</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A larger mebmer of the basoon family, producing the lowest tone in the woodwind section.</para>
    /// labels<para>Contrafagotto</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A woodwind instrument having a straight cylindrical tube with a flaring bell and a single-reed mouthpiece.</para>
    /// labels<para>Clarinet</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A larger member of the clarinet family, typically in lower F, and has darker and less brilliant timbre.</para>
    /// labels<para>Basset Horn</para></remarks>
