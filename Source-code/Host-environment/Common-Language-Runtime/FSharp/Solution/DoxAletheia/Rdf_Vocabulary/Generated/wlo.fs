...
module wlo =
    ...
    let AnimalIntelligence = _prefix "AnimalIntelligence"
    /// <summary>
    ...
    let BehaviouralPattern = _prefix "BehaviouralPattern"
    /// <summary>
    ...
    let CommunicationAdaptation = _prefix "CommunicationAdaptation"
    /// <summary>
    ...
    let EcosystemRole = _prefix "EcosystemRole"
    /// <summary>
    ...
    let ExtremesAdaptation = _prefix "ExtremesAdaptation"
    /// <summary>
    ...
    let FeedingHabit = _prefix "FeedingHabit"
    /// <summary>
    ...
    let LocomotionAdaptation = _prefix "LocomotionAdaptation"
    /// <summary>
    ...
    let MorphologyAdaptation = _prefix "MorphologyAdaptation"
    /// <summary>
    ...
    let ReproductionStrategy = _prefix "ReproductionStrategy"
    /// <summary>
    ...
    let SocialBehaviour = _prefix "SocialBehaviour"
    /// <summary>
    ...
    let SurvivalStrategy = _prefix "SurvivalStrategy"
    /// <summary>
    ...
    let taxonomicName = _prefix "taxonomicName"
    /// <summary>
    ...
    let distributionMap = _prefix "distributionMap"
    /// <summary>
    ...
    let genusName = _prefix "genusName"
    /// <summary>
    ...
    let kingdomName = _prefix "kingdomName"
    /// <summary>
    ...
    let orderName = _prefix "orderName"
    /// <summary>
    ...
    let phylumName = _prefix "phylumName"
    /// <summary>
    ...
    let populationTrend = _prefix "populationTrend"
    /// <summary>
    ...
    let speciesName = _prefix "speciesName"
    /// <summary>
