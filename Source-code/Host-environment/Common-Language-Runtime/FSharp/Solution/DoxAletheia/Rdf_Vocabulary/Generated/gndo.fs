...
module gndo =
    ...
    /// labels<para>Later name of the person</para><para>Späterer Name der Person</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>Associated place</para><para>Assoziierter Ort</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>Gefeiertes Thema</para><para>Celebrated topic</para></remarks>
    ...
    /// labels<para>Thema</para><para>Topic</para></remarks>
    ...
    /// labels<para>Bookbinder</para><para>Buchbinder</para></remarks>
    ...
    /// labels<para>Copist</para><para>Kopist</para></remarks>
