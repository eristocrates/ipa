...
module gndo =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Building or memorial"</para><para>"Bauwerk oder Denkmal"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Sammlung"</para><para>"Collection"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Sammelhandschrift"</para><para>"Collective manuscript"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Sammelpseudonym"</para><para>"Collective pseudonym"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Conference or Event"</para><para>"Konferenz oder Veranstaltung"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Körperschaft"</para><para>"Corporate Body"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Country"</para><para>"Land oder Staat"</para></remarks>
    ...
    /// labels<para>"Früherer Name der Person"</para><para>"Earlier name of the person"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Extraterrestrikum"</para><para>"Extraterrestrial territory"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Family"</para><para>"Familie"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Fiktive Körperschaft"</para><para>"Fictive corporate body"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Fictive term"</para><para>"Fiktiver Sachbegriff"</para></remarks>
    ...
    /// labels<para>"Vollständiger Name der Person"</para><para>"Fuller form of the name of the person"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Personengruppe"</para><para>"Group of persons"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Sprache"</para><para>"Language"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Literarische oder Sagengestalt"</para><para>"Literary or legendary character"</para></remarks>
    ...
    /// labels<para>"Verkehrsmittel mit Individualnamen"</para><para>"Means of transport with individual name"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Musical corporate body"</para><para>"Musikalische Körperschaft"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Musical work"</para><para>"Werk der Musik"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Kleinräumiges Geografikum innerhalb eines Ortes"</para><para>"Name of small geographic unit lying within another geographic
    ///       unit"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Personenname"</para><para>"Name of the person"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Nomenklatur Biologie - Chemie"</para><para>"Nomenclature in biology or chemistry"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Organ of corporate body"</para><para>"Organ einer Körperschaft"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Bevorzugter Name der Person"</para><para>"Preferred name of the person"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Project or program"</para><para>"Projekt oder Programm"</para></remarks>
    ...
    /// 			gewählt wird."</para>
    /// labels<para>"Pseudonym"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Pseudonym der Person"</para><para>"Pseudonym name of the person"</para></remarks>
    ...
    /// labels<para>"Real name of the person"</para><para>"Wirklicher Name der Person"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Religiöse Körperschaft"</para><para>"Religious corporate body"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Religious territory"</para><para>"Religiöses Territorium"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Spirits"</para><para>"Geister"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Schlagwort senso stricto"</para><para>"Subject heading senso stricto"</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"Undifferentiated person"</para><para>"Nicht-individualisierte Person"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Werk"</para><para>"Work"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Abgekürzter Name des Geografikum"</para><para>"Abbreviated name for the place or geographic name"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"According work"</para><para>"Zugehöriges Werk"</para></remarks>
    ...
    /// labels<para>"Accredited artist"</para><para>"Zugeschriebener Künstler"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"An author, artist, etc., relating him/her to a resource for which there is or once was substantial authority for designating that person as author, creator, etc. of the work"</para>
    /// labels<para>"Accredited author"</para><para>"Zugeschriebener Verfasser"</para></remarks>
    ...
    /// labels<para>"Acquaintanceship or friendship"</para><para>"Beziehung, Bekanntschaft, Freundschaft"</para></remarks>
    ...
    /// 		a URI."</para>
    /// labels<para>"Affiliation (Literal)"</para></remarks>
    ...
    ///
    /// labels<para>"Alexander Haffner"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"Arranger"</para><para>"Arrangeur"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Associated date"</para><para>"Assoziierte Zeit"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Begin einer Periode"</para><para>"Beginning of a period"</para></remarks>
    ...
    /// labels<para>"Stifter"</para><para>"Benefactor"</para></remarks>
    ...
    /// labels<para>"Oberbegriff"</para><para>"Broader term"</para></remarks>
    ...
    /// labels<para>"Oberbegriff allgemein"</para><para>"Broader term (general)"</para></remarks>
    ...
    /// labels<para>"Oberbegriff partitiv"</para><para>"Broader term (partitive)"</para></remarks>
    ...
    /// labels<para>"Bauherr"</para><para>"Building owner"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Gefeierte Person"</para><para>"Celebrated person"</para></remarks>
    ...
    /// labels<para>"Cited artist"</para><para>"Zitierter Künstler"</para></remarks>
    ...
    /// labels<para>"Compiler"</para><para>"Kompilator"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Relationierter Deskriptor"</para><para>"Complex see reference - subject"</para></remarks>
    ...
    /// labels<para>"Conferrer"</para><para>"Leihgeber"</para></remarks>
    ...
    /// labels<para>"Beteiligte Familie"</para><para>"Contributing family"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Beteiligte Person"</para><para>"Contributing person"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Koordinaten"</para><para>"Coordinates"</para></remarks>
    ...
    /// labels<para>"Creator"</para><para>"Urheber"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Date of birth and death"</para><para>"Geburts- und Sterbedatum"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Sterbedatum"</para><para>"Date of death"</para></remarks>
    ...
    /// labels<para>"Erscheinungszeit"</para><para>"Date of publication"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Auflösungsdatum"</para><para>"Date of termination"</para></remarks>
    ...
    /// labels<para>"Dedicatee"</para><para>"Widmungsempfänger"</para></remarks>
    ...
    /// labels<para>"Doubtful artist"</para><para>"Angezweifelter Künstler"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"A person or organization to which authorship has been dubiously or incorrectly ascribed"</para>
    /// labels<para>"Doubtful author"</para><para>"Angezweifelter Verfasser"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///   <para>"A person or organization to which authorship has been dubiously or incorrectly ascribed"</para>
    /// labels<para>"Doubtful composer"</para><para>"Angezweifelter Komponist"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Easternmost longitude"</para><para>"Östlichster Längengrad"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"End of a period"</para><para>"Ende einer Periode"</para></remarks>
    ...
    /// labels<para>"Graveur"</para><para>"Engraver"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Epithet, generic name, title or territory"</para><para>"Beiname, Gattungsname, Titulatur, Territorium"</para></remarks>
    ...
    /// labels<para>"Familiäre Beziehung"</para><para>"Familial relationship"</para></remarks>
    ...
    /// labels<para>"Tätigkeitsbereich"</para><para>"Field of activity"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Erste Verfasserschaft"</para><para>"First author"</para><para>"A person or organization that takes primary responsibility for a
    ...
    /// 		oder der erste Autor einer Publikation bekannt ist."</para></remarks>
    ...
    /// labels<para>"First composer"</para><para>"Erster Komponist"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Vorname"</para><para>"Forename"</para></remarks>
    ...
    /// labels<para>"Function or role (Literal)"</para><para>"Funktion oder Rolle (Literal)"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Gender"</para><para>"Geschlecht"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Ländercode"</para><para>"Geographic Area Code"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Hierarchical superior"</para><para>"Administrative Überordnung"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Administrative Überordnung der Körperschaft"</para><para>"Hierarchical superior of the corporate body"</para></remarks>
    ...
    /// labels<para>"Illustrator or illuminator"</para><para>"Illustrator oder Illuminator"</para></remarks>
    ...
    /// labels<para>"Initiator"</para><para>"Veranlasser"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Key of the work"</para><para>"Tonart des Werks"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Sprachencode"</para><para>"Language code"</para></remarks>
    ...
    ///       wieder."</para>
    /// labels<para>"MARC 21 equivalent"</para><para>"MARC 21 Entsprechung"</para></remarks>
    ...
    /// labels<para>"Musiker"</para><para>"Musician"</para></remarks>
    ...
    /// labels<para>"Sprecher"</para><para>"Narrator"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Unterbegriff allgemein"</para><para>"Narrower term (general)"</para></remarks>
    ...
    ///       Klasse von Dingen oder Ereignissen mit einem individuellen Exemplar dieser Klasse, das oft
    ///       durch einen Eigennamen repräsentiert wird."</para>
    /// labels<para>"Unterbegriff instantiell"</para><para>"Narrower term (instantial)"</para></remarks>
    ...
    /// 	Relation die Beziehung zwischen einer einzelnen Person (besonders
    /// 	Gottheiten) und übergeordneten Gruppen von Göttern und mythologische Gestalten."</para>
    /// labels<para>"Unterbegriff partitiv"</para><para>"Narrower term (partitive)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Northernmost latitude"</para><para>"Nördlichster Breitengrad"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Anlass des Schlagworts"</para><para>"Occasion of the subject heading"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Anlass des Werkes"</para><para>"Occasion of the work"</para></remarks>
    ...
    /// labels<para>"Ort"</para><para>"Place"</para></remarks>
    ...
    /// labels<para>"Geburtsort"</para><para>"Place of Birth"</para></remarks>
    ...
    /// labels<para>"Geburtsort (Literal)"</para><para>"Place of Birth (Literal)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Sitz"</para><para>"Place of business"</para></remarks>
    ...
    /// labels<para>"Veranstaltungsort"</para><para>"Place of conference or event"</para></remarks>
    ...
    /// labels<para>"Sterbeort"</para><para>"Place of death"</para></remarks>
    ...
    /// 		statt einer Referenz zu einer geografischen Entität"</para>
    /// labels<para>"Sterbeort (Literal)"</para><para>"Place of death (Literal)"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Geografikum ist Mitglied"</para><para>"Place or geographic name is member"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Vorherige Körperschaft"</para><para>"Preceding corporate body"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Vorheriges Geografikum"</para><para>"Preceding place or geographic name"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Bevorzugte Namensentität der Person"</para><para>"Preferred name entity for the person"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Bevorzugter Name der Familie"</para><para>"Preferred name for the family"</para></remarks>
    ...
    /// labels<para>"Profession or occupation (Literal)"</para><para>"Beruf oder Beschäftigung (Literal)"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Publication"</para><para>"Titelangabe"</para></remarks>
    ...
    /// labels<para>"Real identity"</para><para>"Echte Identität"</para></remarks>
    ...
    /// labels<para>"Related Dewey Decimal Classification with degree of determinacy
    ///       2"</para><para>"In Beziehung stehende Dewey-Dezimalklassifikation mit
    ///       Determiniertheitsgrad 2"</para></remarks>
    ...
    /// labels<para>"Related Dewey Decimal Classification with degree of determinacy
    ///       4"</para><para>"In Beziehung stehende Dewey-Dezimalklassifikation mit
    ///       Determiniertheitsgrad 4"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Related subject heading"</para><para>"In Beziehung stehendes Schlagwort"</para></remarks>
    ...
    /// labels<para>"Related Term"</para><para>"Verwandter Begriff"</para></remarks>
    ...
    /// labels<para>"Screenwriter"</para><para>"Drehbuchautor"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Fortlaufende Zählung des Musikwerks"</para><para>"Serial numeric designation of musical work"</para></remarks>
    ...
    /// labels<para>"Singer"</para><para>"Sänger"</para></remarks>
    ...
    /// labels<para>"Sponsor or patron"</para><para>"Sponsor oder Mäzen"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Succeeding corporate body"</para><para>"Nachfolgende Körperschaft"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Temporary name of the conference or event"</para><para>"Zeitweiser Name der Konferenz oder Veranstaltung"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Zeitweiser Name der Körperschaft"</para><para>"Temporary name of the corporate body"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Zeitweiser Name des Geografikums"</para><para>"Temporary name of the place or geographic name"</para></remarks>
    ...
    /// labels<para>"Adelstitel (Literal)"</para><para>"Title of nobility (Literal)"</para></remarks>
    ...
    /// labels<para>"UDK-Code"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Variant name"</para><para>"Varianter Name"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"Variante Namensentität der Person"</para><para>"Variant name entity for the person"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Variant name for the conference or event"</para><para>"Varianter Name der Konferenz oder Veranstaltung"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"Varianter Name der Familie"</para><para>"Variant name for the family"</para></remarks>
    ...
    ///   <para>owl:AnnotationProperty</para>
    ///
    /// labels<para>"Varianter Name des Geografikum"</para><para>"Variant name for the place or geographic name"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Westernmost longitude"</para><para>"Westlichster Längengrad"</para></remarks>
    ...
    /// labels<para>"Kommentator (schriftlich)"</para><para>"Writer of added commentary"</para></remarks>
