...
module dady =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>update source</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>an update source offering updates as Triplify's Updates</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>the dataset is updated in irregular, non-predictable time intervals</para>
    /// labels<para>irregular updates</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>the dataset is updated low-frequently, i.e., once a year or less frequent</para>
    /// labels<para>low-frequent updates</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>update regularity</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>the dataset is never updated</para>
    /// labels<para>no updates</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>the dataset is updated mid-frequently, i.e., from once a week to a couple of months</para>
    /// labels<para>mid-frequent updates</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>the dataset is updated in regular time intervals</para>
    /// labels<para>regular updates</para></remarks>
    ...
    ///
    /// labels<para>dataset has update dynamics</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>dataset update dynamics</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has update notification</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>offers update source</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>an update source offering updates as Atom feeds</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>an update source offering updates as Talis' Changesets</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>the dataset is updated high-frequently, i.e., once a day or more frequent</para>
    /// labels<para>high-frequent updates</para></remarks>
