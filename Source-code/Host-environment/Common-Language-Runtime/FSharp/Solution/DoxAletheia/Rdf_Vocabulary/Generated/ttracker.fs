...
module ttracker =
    ...
    ///   <para>External reference to online services</para>
    /// labels<para>External reference</para></remarks>
    ...
    ///
    /// labels<para>Tracker extractor data source</para></remarks>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Identifier of the external reference</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>Source of the external reference (eg. 'Musicbrainz')</para>
