...
module bevon =
    ...
    ///   <para>"
    ///     &lt;pre&gt;&lt;code&gt;beverage:Glenfiddich12YearOld
    ...
    ///   <para>"
    ///     &lt;pre&gt;&lt;code&gt;beverage:WhiskyAndSoda
    ...
    ///   ] .&lt;/code&gt;&lt;/pre&gt;
    ///     "^^&lt;http://www.w3.org/1999/02/22-rdf-syntax-ns#XMLLiteral&gt;</para>
    /// labels<para>"Whisky &amp; Soda"</para><para>"Glenfiddich 12 Year Old"</para></remarks>
    ...
    /// </summary>
    /// <remarks>
    ///   <para>planet:ontology/Colour</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>bevon:DilutedSoju</para>
    ///   <para>gr:ProductOrServiceModel</para>
    /// </remarks>
    ...
    ///   <para>bevon:Aging</para>
    ///   <para>bevon:Distillery</para>
    ///   <para>&lt;http://purl.org/vocab/whisky/terms/WaterSource&gt;</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>bevon:SpeysideSingleMalt</para>
