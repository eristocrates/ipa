...
module sosa =
    ...
    ///   <para>owl:Class</para>
    ///   <para>"The thing whose property is being estimated or calculated in the course of an Observation to arrive at a Result or whose property is being manipulated by an Actuator, or which is being sampled or transformed in an act of Sampling"</para>
    ///   <para>"La entidad cuya propiedad está siendo estimada o calculada en el curso de una Observation como parte de una recogida de datos"</para>
    /// labels<para>"Feature of Interest"</para><para>"Característica de interés"</para></remarks>
    /// <seealso href="http://www.w3.org/ns/sosa/Featureofinterest">http://www.w3.org/ns/sosa/Featureofinterest</seealso>
    let Featureofinterest = Prefixed_Name(sosa, "Featureofinterest") |> PrefixedName
    /// <summary>
    ...
    ///   <para>"Enlace observacion"</para>
    /// labels<para>"Proprietà Campionabile"</para><para>"Observable Property"</para><para>"observacion"</para></remarks>
    ...
    ///   <para>"Act of carrying out an (Observation) Procedure to estimate or calculate a value of a property of a FeatureOfInterest. Links to a Sensor to describe what made the Observation and how; links to an ObservableProperty to describe what the result is an estimate of, and to a FeatureOfInterest to detail what that property was associated with."</para>
    ///   <para>"Observation - Act of carrying out an (Observation) Procedure to estimate or calculate a value of a property of a FeatureOfInterest. Links to a Sensor to describe what made the Observation and how; links to an ObservableProperty to describe what the result is an estimate of, and to a FeatureOfInterest to detail what that property was associated with."</para>
    ///   <para>"Acto de llevar a cabo una observación. Procedimiento para estimar o calcular el valor de una propiedad de un FeatureOfInterest. Enlaza con un Sensor para describir que hizo la Observación y cómo, enlaza con una ObservableProperty para describir de que estimación es el resultado y con un FeatureOfInterest para detallar con que propiedad estaba asociada"</para>
    /// labels<para>"Observación"</para><para>"Campionamento"</para><para>"Observation"</para></remarks>
    ...
    ///   <para>"A Platform is an entity that hosts other entities, particularly Sensors, Actuators, Samplers, and other Platforms (definition taken from http://www.w3.org/ns/sosa/Platform)"</para>
    ...
    ///   <para>"A Sample is the result from an act of Sampling."</para>
    ...
    ///   <para>"Device, agent (including humans), or software (simulation) involved in, or implementing, a Procedure. Sensors respond to a stimulus, e.g., a change in the environment, or input data composed from the results of prior Observations, and generate a Result. Sensors can be hosted by Platforms."</para>
    /// labels<para>"Sensore"</para><para>"Sensor"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>"Enlace a hasFEatureOfInterest"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Resultado"</para>
    ///   <para>"Relation linking an Observation or Actuation or act of Sampling and a Result or Sample."</para>
    ...
    /// labels<para>"ha risultato"</para><para>"has result"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"The simple value of an Observation or Actuation or act of Sampling."</para>
    ///   <para>"The value of the observations of a CPSWatch#ContinuousMonitoringSensor or CPSWatch#EventMonitoringSensor monitoring sensor are made in."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"The simple value of an Observation or Actuation."</para>
    /// labels<para>"ha valore semplice"</para><para>"hasSimpleResult"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para><para>"has simple result"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Relation between a platform and the systems it hosts."</para>
    ///   <para>"Relation between a Platform and a Sensor, Actuator, Sampler, or Platform, hosted or mounted on it."</para>
    /// labels<para>"host"</para><para>"hosts"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Relation between a system and its hosting platform."</para>
    ...
    ///   <para>"Relation linking a Result to the Observation or Actuation or act of Sampling that created or caused it."</para>
    ...
    /// <summary>
    ///   <para>sosa:madeByActuator</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Relation linking an Actuation to the Actuator that made that Actuation."</para>
    /// labels<para>"made by actuator"</para></remarks>
    /// <seealso href="http://www.w3.org/ns/sosa/madeByActuator">http://www.w3.org/ns/sosa/madeByActuator</seealso>
    let madeByActuator = Prefixed_Name(sosa, "madeByActuator") |> PrefixedName
    /// <summary>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>"Connection between a CPSWatch#Observation and a CPSWatch#MonitoringSensor. "</para>
    ///   <para>"Relation between an Observation and the Sensor which made the Observation."</para>
    /// labels<para>"eseguita dal sensore"</para><para>"made by sensor"</para><para>"madeBySensor"</para></remarks>
    ...
    /// labels<para>"ha eseguito campionamento"</para><para>"made observation"</para></remarks>
    ...
    /// labels<para>"proprietà campionata"</para><para>"observed property"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>"Connection between a CPSWatch#MonitoringSensor and a sosa#ObservableProperty. "</para>
    ///   <para>"Relation between a Sensor and an ObservableProperty that it is capable of sensing."</para>
    /// labels<para>"observes"</para><para>"osserva"</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>"Enlace con sosa:phenomenonTime"</para>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"The dateTime of the observations of a CPSWatch#ContinuousMonitoringSensor or CPSWatch#EventMonitoringSensor monitoring sensor."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"The result time is the instant of time when the Observation, Actuation or Sampling activity was completed."</para>
    /// labels<para>"result time"</para><para>"resultTime"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
