...
module isbd =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Esquema de codificación del área de notas</para><para>Note Area Encoding Scheme</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Esquema de codificación de mención de impresión o fabricación</para><para>Statement Of Printing Or Manufacture Encoding Scheme</para></remarks>
    ...
    ///
    /// labels<para>tiene aclaración de contenido</para><para>has content qualification</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nota sobre tipo de material o tipo específico de recurso</para><para>has note on material type or resource specific type</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has note on series and multipart monographic resources</para><para>tiene nota de serie o recurso monográfico multiparte</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene configuración de pistas</para><para>has track configuration</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene reducción de ruido</para><para>has noise reduction</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has parallel statement of responsibility relating to edition</para><para>tiene mención de responsabilidad paralela relativa a edición</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene mención de edición adicional paralela</para><para>has parallel additional edition statement</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Esquema de codificación de sintaxis ISBD</para><para>ISBD Syntax Encoding Scheme</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Esquema de codificación del área de descripción material</para><para>Material Description Area Encoding Scheme</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Esquema de codificación de mención del nombre del editor, productor o distribuidor</para><para>Name Of Publisher, Producer, Distributor Statement Encoding Scheme</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Esquema de codificación de la mención de coordenadas y equinoccio</para><para>Statement Of Coordinates And Equinox Encoding Scheme</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Esquema de codificación del área de numeración</para><para>Numbering Area Encoding Scheme</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Esquema de codificación del área de datos matemáticos</para><para>Mathematical Data Area Encoding Scheme</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene información complementaria del título paralela de serie o de recurso monográfico multiparte </para><para>has parallel other title information of series or multipart monographic resource</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tienen mención de responsabilidad relativa al título</para><para>has statement of responsibility relating to title</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nota sobre base de descripción</para><para>has note on basis of description</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nota de cambio en edición</para><para>has note on change to edition</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nota sobre mención de responsabilidad</para><para>has note on statement of responsibility</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nota sobre forma del contenido y tipo de medio</para><para>has note on content form and media type</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>Incluye notas relativas a las características físicas del ejemplar, notas relativas a ejemplares “encuadernados con”, notas de procedencia y notas de acción.</para><para>tiene nota sobre el ejemplar que se describe</para><para>has note on copy in hand</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene tipo de medio</para><para>has media type</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene información complementaria del título</para><para>has other title information</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene mención de edición</para><para>has edition statement</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene mención de responsabilidad relativa a edición</para><para>has statement of responsibility relating to edition</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has note on relationship between continuing resources</para><para>tiene nota de relación entre recursos continuados</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has note on relationship to other resources</para><para>tiene nota de relación con otros recursos</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nota de frecuencia</para><para>has note on frequency</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nota de suplemento a o de insertado en</para><para>has note on supplement to or insert in</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nota sobre naturaleza, alcance, forma, propósito o lengua</para><para>has note on nature, scope, form, purpose or language</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has right ascension and declination</para><para>tiene ascensión recta y declinación</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene extensión</para><para>has extent</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene título común de serie o recurso monográfico multiparte</para><para>has common title of series or multipart monographic resource</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene título dependiente de serie o recurso monográfico multiparte</para><para>has dependent title of series or multipart monographic resource</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene título compueso de propiamente dicho</para><para>has compound title of title proper</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nota sobre la encuadernación</para><para>has note on binding</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene título dependiente de título propiamente dicho</para><para>has dependent title of title proper</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has chronological designation</para><para>tiene designación cronológica</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nota de reproducción</para><para>has note on reproduction</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nota de suplementos, insertos, etc.</para><para>has note on supplements, inserts, etc.</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nota de uso o destinatario</para><para>has note on use or audience</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene mención de coordenadas y equinoccio</para><para>has statement of coordinates and equinox</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene equinoccio</para><para>has equinox</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene paginación</para><para>has pagination</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has playing time</para><para>tiene duración</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene composición de material</para><para>has composition of material</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene mención de responsabilidad paralela relativa a una mención de edición adicional</para><para>has parallel statement of responsibility relating to an additional edition statement</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has note on other relationships</para><para>tiene nota de otras relaciones</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene proceso o método de reproducción de imagen fija</para><para>has process or method of reproduction of still image</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene lugar paralelo de publicación, producción, distribución</para><para>has parallel place of publication, production, distribution</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene mención del nombre del editor, productor o distribuidor</para><para>has name of publisher, producer, distributor statement</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene mención de edición adicional</para><para>has additional edition statement</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene fecha de publicación, producción, distribución</para><para>has date of publication, production, distribution</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nombre de impresor o fabricante</para><para>has name of printer or manufacturer</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene designación específica del material y extensión</para><para>has specific material designation and extent</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene dimensiones</para><para>has dimensions</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene título paralelo de serie o recurso monográfico multiparte</para><para>has parallel title of series or multipart monographic resource</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has statement of responsibility of series or multipart monographic resource</para><para>tiene mención de responsabilidad de serie o recurso monográfico multiparte</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has numbering within series or multipart monographic resource</para><para>tiene numeración de serie o recurso monográfico multiparte</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene título clave</para><para>has key title</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nota sobre el área de edición e historia bibliográfica</para><para>has note on edition area and bibliographic history</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene sistema sucesivo de numeración</para><para>has subsequent numbering system</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nombre paralelo de editor, productor, distribuidor</para><para>has parallel name of publisher, producer, distributor</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene título dependiente paralelo de serie o recurso monográfico multiparte </para><para>has parallel dependent title of series or multipart monographic resource</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene título compuesto de título paralelo</para><para>has compound title of parallel title</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene título común de título paralelo</para><para>has common title of parallel title</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene título dependiente de título paralelo</para><para>has dependent title of parallel title</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene mención de forma del contenido y de tipo de medio</para><para>has content form and media type statement</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Title Proper (Compound) Of Series Or Multipart Monographic Resource Encoding Scheme</para><para>Esquema de codificación del título propiamente dicho (compuesto) de serie</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Esquema de codificación del título paralelo (compuesto) de serie o recurso monográfico multiparte</para><para>Parallel Title (Compound) Of Series Or Multipart Monographic Resource Encoding Scheme</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Esquema de codificación de designación específica del material y extensión</para><para>Specific Material Designation And Extent Encoding Scheme</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Esquema de codificación del área de mención de formato musical </para><para>Music Format Statement Area Encoding Scheme</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Esquema de codificación del área de identificador del recurso y condiciones de disponibilidad</para><para>Resource Identifier And Terms Of Availability Area Encoding Scheme</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene título de obra individual de diferente autor</para><para>has title of individual work by different author</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene nombre de editor, productor, distribuidor</para><para>has name of publisher, producer, distributor</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>has accompanying material statement</para><para>tiene mención de material anejo</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene número normalizado internacional de serie o recurso monográfico multiparte</para><para>has international standard number of series or multipart monographic resource</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene identificador del recurso</para><para>has resource identifier</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene mención de responsabilidad relativa a una mención de edición adicional</para><para>has statement of responsibility relating to an additional edition statement</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene presencia de color</para><para>has presence of colour</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene proporción de reducción</para><para>has reduction ratio</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene presencia o ausencia de sonido</para><para>has presence or absence of sound</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene alineación de los fotogramas</para><para>has frame alignment</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene designación de título dependiente de serie o recurso monográfico multiparte</para><para>has dependent title designation of series or multipart monographic resource</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene mención de responsabilidad paralela de serie o recurso monográfico multiparte </para><para>has parallel statement of responsibility of series or multipart monographic resource</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene área de forma del contenido y de tipo de medio</para><para>has content form and media type area</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene área de publicación, producción, distribución, etc.</para><para>has publication, production, distribution, etc area</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene área de serie y recurso monográfico multiparte</para><para>has series and multipart monographic resource area</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene área de mención de formato musical</para><para>has music format statement area</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>tiene mención de impresión o fabricación</para><para>has statement of printing or manufacture</para></remarks>
