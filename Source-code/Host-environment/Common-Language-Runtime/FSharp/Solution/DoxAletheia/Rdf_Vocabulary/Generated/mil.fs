...
module mil =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Grade Intérimaire (Militare)"</para><para>"Handelnden Rang (Militärischen)"</para><para>"Acting Rank (Military)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>""</para><para>"Command (Air Force)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>" "</para><para>""</para><para>"Detail (Air Force)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Group (military aviation unit)"</para><para>"Gruppe (Luftfahrt)"</para><para>"Groupe (Force Aérienne)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Force aérienne (Service Militare)"</para><para>"Luftstreitkräfte (Service)"</para><para>"Air Force (Service Branch)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Squadron"</para><para>"Squadron (aviation)"</para><para>"Ð­ÑÐºÐ°Ð´ÑÐ¸Ð»ÑÑ"</para><para>"Phi ÄoÃ n"</para><para>"Esquadrilha"</para><para>"Esquadrilla"</para><para>"Skvadron"</para><para>"Staffel (Militär)"</para><para>"Laivue (ilmavoimat)"</para><para>"Escuadrilla"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Station (Air Force)"</para><para>"Station (Force Aérienne)"</para><para>"Station (Luftfahrt)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"ÐÐ²Ð¸Ð°ÑÐ¸Ð¾Ð½Ð½Ð¾Ðµ ÐºÑÑÐ»Ð¾"</para><para>"Flygflottilj"</para><para>"Wing (luchtmacht)"</para><para>"Ving (militær enhet)"</para><para>"Wing (military aviation unit)"</para><para>"Ala (militar)"</para><para>"Geschwader"</para><para>"SkrzydÅo (oddziaÅ lotnictwa)"</para><para>"KhÃ´ng ÄoÃ n"</para><para>"Stormo (unità militare)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Appointment (Civil)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"?"</para><para>"Arms Type(Military)"</para><para>"Type Armes (Military)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Kompanie (Militär)"</para><para>"Compagnie (militaire)"</para><para>"Company (Military Unit)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ðµ ÑÑÐ¾Ð½ÑÑ Ð²Ð¾ Ð²ÑÐµÐ¼Ñ ÐÐµÐ»Ð¸ÐºÐ¾Ð¹ ÐÑÐµÑÐµÑÑÐ²ÐµÐ½Ð½Ð¾Ð¹ Ð²Ð¾Ð¹Ð½Ñ"</para><para>"Fronty radzieckie"</para><para>"Front (Großverband)"</para><para>"Front (seregtest)"</para><para>"Front (unité soviétique)"</para><para>"Front (forband)"</para><para>"Rintama (puna-armeija)"</para><para>"Front (military formation)"</para><para>"Front (Röda armén)"</para><para>"Front"</para><para>"PhÆ°Æ¡ng diá»n quÃ¢n (LiÃªn XÃ´)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Section (Military Unit)"</para><para>"Section (Militaire)"</para><para>"Abschnitt (Militär)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Armée (Service)"</para><para>"Armee (Service)"</para><para>"Army (Service Branch)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Squad (Military Unit)"</para><para>"Gruppe (Militär)"</para><para>"Équipe (Militaire)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Truppe (Militär)"</para><para>"Troupe (Militare)"</para><para>"Troop (Military)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Artillery Battery"</para><para>"Batterie (armement)"</para><para>"Batterie (Militär)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Batterie Division (Militär)"</para><para>"Divisional Artillery"</para><para>"Division de Batterie (armement)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Bataillon"</para><para>"Battalion (Military)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>""</para><para>"Espace de Battaille"</para><para>"Battle Space"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Brevet Rank (Military)"</para><para>"Grade Brevet (Militare)"</para><para>"Brevet Rang (Militärischen)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Brigade (Militare)"</para><para>"Brigade"</para><para>"Brigade (Military)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Carrier Strike Group"</para><para>"Groupe aéronaval"</para><para>"Flugzeugträgerkampfgruppe"</para><para>"ÐÐ²Ð¸Ð°Ð½Ð¾ÑÐ½Ð°Ñ ÑÐ´Ð°ÑÐ½Ð°Ñ Ð³ÑÑÐ¿Ð¿Ð°"</para><para>"Carrier battle group"</para><para>"Gruppo da battaglia di una portaerei"</para></remarks>
    ...
    ///   <para>mil:ArmsType</para>
    ///
    /// labels<para>"Kavallerie"</para><para>"Cavalry"</para><para>"Equitata"</para><para>"Cavalerie"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Kavallerie Schwadron"</para><para>"Escadron de Cavalerie"</para><para>"Cavalry Squadron"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Kavallerie Truppe"</para><para>"Troupe de Cavalerie"</para><para>"Cavalry Troop"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Civilian"</para><para>"Civil"</para><para>"Zivilist"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Combatant"</para><para>""</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Corps (Formation)"</para><para>"Korps (Großverband)"</para><para>"Corps d'armée"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Korps (Unit)"</para><para>"Corps (Unité d'armée)"</para><para>"Corps (Unit)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Demi-brigade"</para><para>"Halbbrigade"</para><para>"Half-Brigade"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Depot (Military)"</para><para>"Depot (Militär)"</para><para>"Dépot (Military)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Détachement (Militare)"</para><para>"Detachement"</para><para>"Detachment (military)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Division (Militär)"</para><para>"Division (Military)"</para><para>"Division (Militaire)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Division (Navy)"</para><para>"Division (Marine)"</para><para>"Division"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Division"</para><para>"Division de Navire (Marine)"</para><para>"Ship's Division (Navy)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Soldier (Drafted)"</para><para>"Soldat (eingezogen)"</para><para>"Soldat (Rédigé)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Enlisted Soldier"</para><para>"Hommes de Troupes"</para><para>"angeworbenen Soldaten"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Officier d'échange"</para><para>"Exchange Officer"</para><para>"Austausch-Offizier"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Armée (Unité)"</para><para>"Field Army"</para><para>"Armee (Großverband)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Field Artillery"</para><para>"Berittene Kampagne"</para><para>"Artillerie de campagne"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Flottielje"</para><para>"Flotilla"</para><para>"Ð¤Ð»Ð¾ÑÐ¸Ð»Ð¸Ñ"</para><para>"Flotilha"</para><para>"Flottille"</para><para>"Flottilj"</para><para>"Flotylla okrÄtÃ³w"</para><para>"Flotila"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Fregate"</para><para>"Frigate"</para><para>""</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Front (militar)"</para><para>"Frontlinje"</para><para>"Front (military)"</para><para>"VÃ¡leÄnÃ¡ fronta"</para><para>"Kriegsfront"</para><para>"Frente (término militar)"</para><para>"Front militaire"</para><para>"Frente de batalha"</para><para>"Front (oorlog)"</para><para>"Kampfront"</para><para>"Fronte (guerra)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Garnison (Militär)"</para><para>"Garnison (Militaire)"</para><para>"Garrison (military)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Grande Batterie"</para><para>"Grand Battery"</para><para>"Grand-Batterie"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Berittene Artillerie"</para><para>"Horse Artillery"</para><para>"Artillerie à cheval"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Liaison Officer"</para><para>"Verbindungsoffizier"</para><para>"Officier de Liason"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Schwarm (Luftfahrt)"</para><para>"Escadrille"</para><para>"Aviation Flight (Military Unit)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Phi Äá»i"</para><para>"Escadrille"</para><para>"Schwarm"</para><para>"Flight (military unit)"</para><para>"Flight (luchtmacht)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Escadrille de terra"</para><para>"Ground Flight (Military Unit)"</para><para>"Schwarm Boden(Luftfahrt)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Rank (Military)"</para><para>"Grade (Militare)"</para><para>"Rang (Militärischen)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Teilstreitkraft"</para><para>"Branche du service militaire"</para><para>"Service Branch (Military)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Trade (Military)"</para><para>"Occupation Professionelle (Militare)"</para></remarks>
    ...
    ///   <para>geovocab:spatial#Feature</para>
    ///
    /// labels<para>"Military Trench"</para><para>"Tranchée Militaire"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Gebirgsgeschütz"</para><para>"Mountain Artillery"</para><para>"Artillerie de Montagnecampagne"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Luftflotten der United States Air Force"</para><para>"Numbered Air Force"</para><para>"KhÃ´ng lá»±c mang sá»"</para><para>"Força Aérea Numerada"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Ranks of NATO"</para><para>"NATO Rangcode"</para><para>"Grades de l'OTAN"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Laivasto (sotilasyksikkö)"</para><para>"Flåte (marine)"</para><para>"Háº¡m Äá»i"</para><para>"Flota"</para><para>"Flotta"</para><para>"Flotte"</para><para>"Naval fleet"</para><para>"LoÄstvo"</para><para>"Frota"</para><para>"Ð¤Ð»Ð¾Ñ"</para><para>"Flotte (Marine)"</para><para>"Vloot"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Naval Officer"</para><para>"Officier (Marine)"</para><para>"Offiziere (Deutsche Marine)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Naval Rating"</para><para>"Unteroffiziere (Deutsche Marine)"</para><para>"Maître (Marine de Guerre)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Eskadra (marynarka wojenna)"</para><para>"Geschwader (Marine)"</para><para>"Esquadra naval"</para><para>"Laivue (laivasto)"</para><para>"Ð­ÑÐºÐ°Ð´ÑÐ°"</para><para>"Eskadre"</para><para>"Háº£i ÄoÃ n"</para><para>"Eskader"</para><para>"Escadre"</para><para>"Eskadra"</para><para>"Squadron (naval)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Task Force (Naval)"</para><para>"Force opérationnelle (Marine)"</para><para>"Task Force (Marine)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>""</para><para>"Station (Naval Aircraft)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Marine (Boot-Gruppe)"</para><para>"Marine (Groupe de batiment naval)"</para><para>"Navy (Named or Numbered)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Non-Combatant"</para><para>""</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Non Commissioned Officer"</para><para>"Soldatenlaufbahnverordnung"</para><para>"Sous-Officier Subalternes"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Officer"</para><para>"Offizier"</para><para>"Officier"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Platoon"</para><para>"Peloton (militaire)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Able Seaman (Commonwealth of Nations)"</para><para>"Able Seaman (Commonwealth)"</para><para>"Able Seaman (Wspólnota Narodów)"</para><para>"Able Seaman (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Able Seaman (Commonwealth delle nazioni)"</para><para>"Able Seaman (Gemenebest van Naties)"</para><para>"Able Seaman (Samveldet av nasjoner)"</para><para>"Able Seaman (Mancomunidad de Naciones)"</para><para>"Able Seaman (Kansainyhteisö)"</para><para>"Able Seaman (Samväldet)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Komandor"</para><para>"Captain (naval)"</para><para>"Capitaine de vaisseau"</para><para>"Kapitän zur See"</para><para>"Capitão de mar e guerra"</para><para>"Capitano di vascello"</para><para>"Kapitein-ter-zee"</para><para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½ 1-Ð³Ð¾ ÑÐ°Ð½Ð³Ð°"</para><para>"Kommandør"</para><para>"Kommodori"</para><para>"Capitán de navío"</para><para>"Kommendör"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Capitão de mar e guerra (Austrália)"</para><para>"Kommandør (Australia)"</para><para>"Capitaine de vaisseau (Australie)"</para><para>"Capitano di vascello (Australia)"</para><para>"Kapitein-ter-zee (Australië (land))"</para><para>"Kommendör (Australien)"</para><para>"Capitán de navío (Australia)"</para><para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½ 1-Ð³Ð¾ ÑÐ°Ð½Ð³Ð° (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Captain (naval) (Australia)"</para><para>"Kommodori (Australia)"</para><para>"Kapitän zur See (Australien)"</para><para>"Komandor (Australia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Captain (naval, Canada)"</para><para>"Capitaine de vaisseau (Canada)"</para><para>"Capitão de mar e guerra (Canada)"</para><para>"Capitano di vascello (Canada)"</para><para>"Kapitän zur See (Canada)"</para><para>"Kapitein-ter-zee (Canada)"</para><para>"Kommodori (Canada)"</para><para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½ 1-Ð³Ð¾ ÑÐ°Ð½Ð³Ð° (Canada)"</para><para>"Kommandør (Canada)"</para><para>"Kommendör (Canada)"</para><para>"Komandor (Canada)"</para><para>"Capitán de navío (Canada)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Combat (military rank) (Russland)"</para><para>"Combat (military rank) (Venäjä)"</para><para>"Combat (military rank) (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Combat (military rank) (Rússia)"</para><para>"Combat (military rank) (Ryssland)"</para><para>"Combat (military rank) (Rusia)"</para><para>"Combat (military rank) (Russia)"</para><para>"Combat (military rank) (Rosja)"</para><para>"Combat (military rank) (Russie)"</para><para>"Combat (military rank) (Rusland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Combat (military rank) (União Soviética)"</para><para>"Combat (military rank) (Unión Soviética)"</para><para>"Combat (military rank) (Union des républiques socialistes soviétiques)"</para><para>"Combat (military rank) (Sovjet-Unie)"</para><para>"Combat (military rank) (Soviet Union)"</para><para>"Combat (military rank) (Unione Sovietica)"</para><para>"Combat (military rank) (Sovjetunionen)"</para><para>"Combat (military rank) (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Combat (military rank) (Neuvostoliitto)"</para><para>"Combat (military rank) (Sowjetunion)"</para><para>"Combat (military rank) (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Driver (rank) (Australia)"</para><para>"Driver (rank) (Australie)"</para><para>"Driver (rank) (Austrália)"</para><para>"Driver (rank) (Australien)"</para><para>"Driver (rank) (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Driver (rank) (Australië (land))"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Admiral"</para><para>"Amiral"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Admiral of the Fleet (Russia) (Ryssland)"</para><para>"Admiral of the Fleet (Russia) (Russland)"</para><para>"Admiral of the Fleet (Russia) (Russia)"</para><para>"Admiral of the Fleet (Russia) (Rosja)"</para><para>"Admiral of the Fleet (Russia) (Rusland)"</para><para>"Ammiraglio della flotta (Russia) (Russia)"</para><para>"Admiral of the Fleet (Russia) (Russie)"</para><para>"Admiral of the Fleet (Russia) (Rusia)"</para><para>"Admiral of the Fleet (Russia) (Venäjä)"</para><para>"Admiral of the Fleet (Russia) (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Admiral of the Fleet (Russia) (Rússia)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Admiral of the Fleet (Russia) (Sowjetunion)"</para><para>"Admiral of the Fleet (Russia) (Sovjetunionen)"</para><para>"Admiral of the Fleet (Russia) (Unión Soviética)"</para><para>"Admiral of the Fleet (Russia) (Soviet Union)"</para><para>"Ammiraglio della flotta (Russia) (Unione Sovietica)"</para><para>"Admiral of the Fleet (Russia) (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Admiral of the Fleet (Russia) (Union des républiques socialistes soviétiques)"</para><para>"Admiral of the Fleet (Russia) (Neuvostoliitto)"</para><para>"Admiral of the Fleet (Russia) (Sovjet-Unie)"</para><para>"Admiral of the Fleet (Russia) (União Soviética)"</para><para>"Admiral of the Fleet (Russia) (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Agha"</para><para>"Agha (Ottoman Empire)"</para><para>"Aga (wojsko)"</para><para>"Agha (Titel)"</para><para>"ÐÐ³Ð° (ÑÐ¸ÑÑÐ» Ð²Ð¾ÐµÐ½Ð°ÑÐ°Ð»ÑÐ½Ð¸ÐºÐ¾Ð²)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Agha (Hetmanat cosaque)"</para><para>"Aga (wojsko) (HetmaÅszczyzna)"</para><para>"Agha (Titel) (Hetmanat)"</para><para>"ÐÐ³Ð° (ÑÐ¸ÑÑÐ» Ð²Ð¾ÐµÐ½Ð°ÑÐ°Ð»ÑÐ½Ð¸ÐºÐ¾Ð²) (ÐÐµÑÐ¼Ð°Ð½ÑÐ¸Ð½Ð°)"</para><para>"Agha (Cossack Hetmanate)"</para><para>"Agha (Ottoman Empire) (Cossack Hetmanate)"</para><para>"Agha (Ottoman Empire) (Hetmanato cosaco)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Agha (Ottoman Empire) (Ottomaanse Rijk)"</para><para>"Agha (Ottoman Empire) (Ottoman Empire)"</para><para>"Aga (wojsko) (Imperium osmaÅskie)"</para><para>"Agha (Titel) (Osmanisches Reich)"</para><para>"Agha (Impero ottomano)"</para><para>"Agha (Osmanien valtakunta)"</para><para>"Agha (Ottoman Empire) (Imperio otomano)"</para><para>"Agha (Osmanska riket)"</para><para>"ÐÐ³Ð° (ÑÐ¸ÑÑÐ» Ð²Ð¾ÐµÐ½Ð°ÑÐ°Ð»ÑÐ½Ð¸ÐºÐ¾Ð²) (ÐÑÐ¼Ð°Ð½ÑÐºÐ°Ñ Ð¸Ð¼Ð¿ÐµÑÐ¸Ñ)"</para><para>"Agha (Ottoman Empire) (Império Otomano)"</para><para>"Agha (Det osmanske rike)"</para><para>"Agha (Empire ottoman)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Agha (Ottoman Empire) (República de las Islas Jónicas)"</para><para>"Agha (Ottoman Empire) (Republiek van de Zeven Eilanden)"</para><para>"ÐÐ³Ð° (ÑÐ¸ÑÑÐ» Ð²Ð¾ÐµÐ½Ð°ÑÐ°Ð»ÑÐ½Ð¸ÐºÐ¾Ð²) (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° Ð¡ÐµÐ¼Ð¸ ÐÑÑÑÐ¾Ð²Ð¾Ð²)"</para><para>"Agha (Titel) (Septinsular Republic)"</para><para>"Agha (Ottoman Empire) (Septinsular Republic)"</para><para>"Agha (République des Sept-Îles)"</para><para>"Agha (Repubblica delle Sette Isole Unite)"</para><para>"Agha (Septinsular Republic)"</para><para>"Aga (wojsko) (Republika Siedmiu Wysp)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Air chief marshal (Australia)"</para><para>"Air chief marshal (Austrália)"</para><para>"Air chief marshal (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Air Chief Marshal (Australien)"</para><para>"Air Chief Marshal (Australia)"</para><para>"Air Chief Marshal (Australie)"</para><para>"Air Chief Marshal (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Air Chief Marshal (Australië (land))"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Air chief marshal (Kansainyhteisö)"</para><para>"Air chief marshal (Commonwealth of Nations)"</para><para>"Air chief marshal (Commonwealth delle nazioni)"</para><para>"Air chief marshal (Samveldet av nasjoner)"</para><para>"Air chief marshal (Commonwealth)"</para><para>"Air chief marshal (Samväldet)"</para><para>"Air chief marshal (Wspólnota Narodów)"</para><para>"Air chief marshal (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Air chief marshal (Gemenebest van Naties)"</para><para>"Air chief marshal (Mancomunidad de Naciones)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Air vice-marshal (Australia)"</para><para>"Air vice-marshal (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Air vice-marshal (Australien)"</para><para>"Air vice-marshal (Austrália)"</para><para>"Air vice-marshal (Australië (land))"</para><para>"Air vice-marshal (Australie)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Air vice-marshal (Kansainyhteisö)"</para><para>"Air vice-marshal (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Air vice-marshal (Commonwealth of Nations)"</para><para>"Air vice-marshal (Mancomunidad de Naciones)"</para><para>"Air vice-marshal (Gemenebest van Naties)"</para><para>"Air vice-marshal (Samveldet av nasjoner)"</para><para>"Air vice-marshal (Samväldet)"</para><para>"Air vice-marshal (Wspólnota Narodów)"</para><para>"Air vice-marshal (Commonwealth)"</para><para>"Air vice-marshal (Commonwealth delle nazioni)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Anthypolochagos (Grèce)"</para><para>"Anthypolochagos (Grecia)"</para><para>"Anthypolochagos (Kreikka)"</para><para>"Anthypolochagos (Grekland)"</para><para>"Anthypolochagos (Griekenland)"</para><para>"Anthypolochagos (Griechenland)"</para><para>"Anthypolochagos (Grécia)"</para><para>"Anthypolochagos (Grecja)"</para><para>"Anthypolochagos (Hellas)"</para><para>"Anthypolochagos (ÐÑÐµÑÐ¸Ñ)"</para><para>"Anthypolochagos (Greece)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Appointee (Italien)"</para><para>"Appointee (Italia)"</para><para>"Appointee (WÅochy)"</para><para>"Appointé (Italie)"</para><para>"Appointee (Italy)"</para><para>"Appointee (Itália)"</para><para>"Appointee (Italië)"</para><para>"Appuntato (Italia)"</para><para>"Appointee (ÐÑÐ°Ð»Ð¸Ñ)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Appointee (Ð¨Ð²ÐµÐ¹ÑÐ°ÑÐ¸Ñ)"</para><para>"Appointee (Zwitserland)"</para><para>"Appointee (Sveitsi)"</para><para>"Appointee (Schweiz)"</para><para>"Appointee (Szwajcaria)"</para><para>"Appointee (Suíça)"</para><para>"Appointee (Suiza)"</para><para>"Appuntato (Svizzera)"</para><para>"Appointé (Suisse)"</para><para>"Appointee (Switzerland)"</para><para>"Appointee (Sveits)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Army General (Russia) (Venäjä)"</para><para>"ÐÐµÐ½ÐµÑÐ°Ð» Ð°ÑÐ¼Ð¸Ð¸ (Ð Ð¾ÑÑÐ¸Ñ) (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Army General (Russia) (Russland)"</para><para>"Army General (Russia) (Russia)"</para><para>"Army General (Russia) (Rusland)"</para><para>"Army General (Russia) (Russie)"</para><para>"Army General (Russia) (Rusia)"</para><para>"Army General (Russia) (Rússia)"</para><para>"Army General (Russia) (Ryssland)"</para><para>"Army General (Russia) (Rosja)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Army General (Russia) (Sovjetunionen)"</para><para>"Army General (Russia) (Union des républiques socialistes soviétiques)"</para><para>"Army General (Russia) (Unione Sovietica)"</para><para>"Army General (Russia) (União Soviética)"</para><para>"Army General (Russia) (Unión Soviética)"</para><para>"Army General (Russia) (Sovjet-Unie)"</para><para>"Army General (Russia) (Neuvostoliitto)"</para><para>"Army General (Russia) (Sowjetunion)"</para><para>"Army General (Russia) (Soviet Union)"</para><para>"ÐÐµÐ½ÐµÑÐ°Ð» Ð°ÑÐ¼Ð¸Ð¸ (Ð Ð¾ÑÑÐ¸Ñ) (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Army General (Russia) (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Aspirant (Rumänien)"</para><para>"Aspirant (Rumunia)"</para><para>"Aspirant (Romania)"</para><para>"Aspirant (Roménia)"</para><para>"Aspirant (Ð ÑÐ¼ÑÐ½Ð¸Ñ)"</para><para>"Aspirant (Roumanie)"</para><para>"Aspirant (Roemenië)"</para><para>"Aspirant (Rumania)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Aspirant (Romania) (Roménia)"</para><para>"Aspirant (Romania) (Ð ÑÐ¼ÑÐ½Ð¸Ñ)"</para><para>"Aspirant (Romania) (Romania)"</para><para>"Aspirant (Romania) (Rumania)"</para><para>"Aspirant (Romania) (Rumunia)"</para><para>"Aspirant (Romania) (Roumanie)"</para><para>"Aspirant (Romania) (Roemenië)"</para><para>"Aspirant (Romania) (Rumänien)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Ataman / Otaman"</para><para>"Ataman"</para><para>"ÐÑÐ°Ð¼Ð°Ð½"</para><para>"Atamán"</para><para>"Atamaani"</para><para>"Atamano"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"ÐÑÐ°Ð¼Ð°Ð½ (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Atamaani (Venäjä)"</para><para>"Ataman (Rusland)"</para><para>"Ataman (Russland)"</para><para>"Ataman (Ryssland)"</para><para>"Atamano (Russia)"</para><para>"Ataman / Otaman (Russie)"</para><para>"Ataman (Rosja)"</para><para>"Atamán (Rusia)"</para><para>"Ataman (Russia)"</para><para>"Ataman (Rússia)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Ataman (União Soviética)"</para><para>"Ataman (Soviet Union)"</para><para>"Ataman / Otaman (Union des républiques socialistes soviétiques)"</para><para>"Ataman (Sowjetunion)"</para><para>"Ataman (Sovjetunionen)"</para><para>"Atamán (Unión Soviética)"</para><para>"Atamaani (Neuvostoliitto)"</para><para>"Atamano (Unione Sovietica)"</para><para>"Ataman (Sovjet-Unie)"</para><para>"ÐÑÐ°Ð¼Ð°Ð½ (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Ataman (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Ataman (Ukraine)"</para><para>"Ataman (Ucrânia)"</para><para>"Atamán (Ucrania)"</para><para>"Atamano (Ucraina)"</para><para>"ÐÑÐ°Ð¼Ð°Ð½ (Ð£ÐºÑÐ°Ð¸Ð½Ð°)"</para><para>"Ataman (Ukraina)"</para><para>"Atamaani (Ukraina)"</para><para>"Ataman (Oekraïne)"</para><para>"Ataman / Otaman (Ukraine)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Birinci Ferik (Hetmanat cosaque)"</para><para>"Birinci Ferik (ÐÐµÑÐ¼Ð°Ð½ÑÐ¸Ð½Ð°)"</para><para>"Birinci Ferik (Hetmanato cosaco)"</para><para>"Birinci Ferik (HetmaÅszczyzna)"</para><para>"Birinci Ferik (Cossack Hetmanate)"</para><para>"Birinci Ferik (Hetmanat)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Birinci Ferik (Imperium osmaÅskie)"</para><para>"Birinci Ferik (Impero ottomano)"</para><para>"Birinci Ferik (Det osmanske rike)"</para><para>"Birinci Ferik (Osmanien valtakunta)"</para><para>"Birinci Ferik (Império Otomano)"</para><para>"Birinci Ferik (Imperio otomano)"</para><para>"Birinci Ferik (Osmanisches Reich)"</para><para>"Birinci Ferik (ÐÑÐ¼Ð°Ð½ÑÐºÐ°Ñ Ð¸Ð¼Ð¿ÐµÑÐ¸Ñ)"</para><para>"Birinci Ferik (Osmanska riket)"</para><para>"Birinci Ferik (Empire ottoman)"</para><para>"Birinci Ferik (Ottomaanse Rijk)"</para><para>"Birinci Ferik (Ottoman Empire)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Birinci Ferik (Septinsular Republic)"</para><para>"Birinci Ferik (Republika Siedmiu Wysp)"</para><para>"Birinci Ferik (Republiek van de Zeven Eilanden)"</para><para>"Birinci Ferik (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° Ð¡ÐµÐ¼Ð¸ ÐÑÑÑÐ¾Ð²Ð¾Ð²)"</para><para>"Birinci Ferik (République des Sept-Îles)"</para><para>"Birinci Ferik (República de las Islas Jónicas)"</para><para>"Birinci Ferik (Repubblica delle Sette Isole Unite)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Bombardier (rank) (Australien)"</para><para>"Bombardier (rank) (Australia)"</para><para>"Bombardier (rank) (Australie)"</para><para>"Bombardier (stopieÅ) (Australia)"</para><para>"Bombardier (rank) (Austrália)"</para><para>"ÐÐ¾Ð¼Ð±Ð°ÑÐ´Ð¸Ñ (Ð²Ð¾Ð¸Ð½ÑÐºÐ¾Ðµ Ð·Ð²Ð°Ð½Ð¸Ðµ) (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Bombardier (rank) (Australië (land))"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Bombardier (rank) (Commonwealth)"</para><para>"Bombardier (rank) (Samveldet av nasjoner)"</para><para>"Bombardier (rank) (Commonwealth of Nations)"</para><para>"Bombardier (rank) (Gemenebest van Naties)"</para><para>"Bombardier (rank) (Commonwealth delle nazioni)"</para><para>"Bombardier (rank) (Samväldet)"</para><para>"Bombardier (rank) (Kansainyhteisö)"</para><para>"Bombardier (rank) (Mancomunidad de Naciones)"</para><para>"ÐÐ¾Ð¼Ð±Ð°ÑÐ´Ð¸Ñ (Ð²Ð¾Ð¸Ð½ÑÐºÐ¾Ðµ Ð·Ð²Ð°Ð½Ð¸Ðµ) (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Bombardier (stopieÅ) (WspÃ³lnota NarodÃ³w)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"ÐÐ¾ÑÐ¼Ð°Ð½"</para><para>"Bootsmann"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"ÐÐ¾ÑÐ¼Ð°Ð½ (Germany)"</para><para>"Bootsmann (Germany)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Bootsmann (Venäjä)"</para><para>"Bootsmann (Rússia)"</para><para>"Bootsmann (Rusland)"</para><para>"Bootsmann (Russie)"</para><para>"Bootsmann (Russia)"</para><para>"ÐÐ¾ÑÐ¼Ð°Ð½ (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Bootsmann (Russland)"</para><para>"Bootsmann (Rosja)"</para><para>"Bootsmann (Rusia)"</para><para>"Bootsmann (Ryssland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Bootsmann (Sowjetunion)"</para><para>"Bootsmann (União Soviética)"</para><para>"Bootsmann (Sovjet-Unie)"</para><para>"ÐÐ¾ÑÐ¼Ð°Ð½ (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Bootsmann (Union des républiques socialistes soviétiques)"</para><para>"Bootsmann (Unión Soviética)"</para><para>"Bootsmann (Soviet Union)"</para><para>"Bootsmann (Sovjetunionen)"</para><para>"Bootsmann (Unione Sovietica)"</para><para>"Bootsmann (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Bootsmann (Neuvostoliitto)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Brigade General (Australië (land))"</para><para>"Brigade General (Australien)"</para><para>"Brigade General (Australia)"</para><para>"Brigade General (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Brigade General (Austrália)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Brigadier"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Brigadier general (Australia)"</para><para>"Brigadier general (Australië (land))"</para><para>"Brigadier general (Australie)"</para><para>"Brigadier general (Australien)"</para><para>"Brigadier general (Austrália)"</para><para>"Brigadier general (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Buffer (navy) (Australien)"</para><para>"Buffer (navy) (Australia)"</para><para>"Buffer (navy) (Australië (land))"</para><para>"Buffer (navy) (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Buffer (navy) (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Buffer (navy) (Samväldet)"</para><para>"Buffer (navy) (Commonwealth of Nations)"</para><para>"Buffer (navy) (Commonwealth delle nazioni)"</para><para>"Buffer (navy) (Gemenebest van Naties)"</para><para>"Buffer (navy) (Samveldet av nasjoner)"</para><para>"Buffer (navy) (Mancomunidad de Naciones)"</para><para>"Buffer (navy) (Wspólnota Narodów)"</para><para>"Buffer (navy) (Kansainyhteisö)"</para><para>"Buffer (navy) (Commonwealth)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Hauptmann (Offizier)"</para><para>"Capitaine"</para><para>"Captain (OF-2)"</para><para>"Capitano"</para><para>"Kapitein (rang)"</para><para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½ (Ð²Ð¾Ð¸Ð½ÑÐºÐ¾Ðµ Ð·Ð²Ð°Ð½Ð¸Ðµ)"</para><para>"Kaptein (grad)"</para><para>"Capitán"</para><para>"Kapteeni (sotilasarvo)"</para><para>"Kapten"</para><para>"Capitão (militar)"</para><para>"Kapitan (ranga)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Hauptmann (Offizier) (Australien)"</para><para>"Captain (OF-2) (Australia)"</para><para>"Capitán (Australia)"</para><para>"Kapitein (rang) (Australië (land))"</para><para>"Capitão (militar) (Austrália)"</para><para>"Kapten (Australien)"</para><para>"Kapitan (ranga) (Australia)"</para><para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½ (Ð²Ð¾Ð¸Ð½ÑÐºÐ¾Ðµ Ð·Ð²Ð°Ð½Ð¸Ðµ) (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Capitaine (Australie)"</para><para>"Kaptein (grad) (Australia)"</para><para>"Kapteeni (sotilasarvo) (Australia)"</para><para>"Capitano (Australia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Kapitein (rang, Canada)"</para><para>"Capitaine (Canada)"</para><para>"Kapten (Canada)"</para><para>"Capitão (militar, Canada)"</para><para>"Captain (OF-2, Canada)"</para><para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½ (Ð²Ð¾Ð¸Ð½ÑÐºÐ¾Ðµ Ð·Ð²Ð°Ð½Ð¸Ðµ, Canada)"</para><para>"Capitán (Canada)"</para><para>"Capitano (Canada)"</para><para>"Kapitan (ranga, Canada)"</para><para>"Hauptmann (Offizier, Canada)"</para><para>"Kapteeni (sotilasarvo, Canada)"</para><para>"Kaptein (grad, Canada)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Kapteinløytnant"</para><para>"Kapitänleutnant"</para><para>"Captain Lieutenant"</para><para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½-Ð»ÐµÐ¹ÑÐµÐ½Ð°Ð½Ñ"</para><para>"Kaptenlöjtnant"</para><para>"Kapteeniluutnantti"</para><para>"Capitaine-lieutenant"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Kapitänleutnant (Germany)"</para><para>"Kapteeniluutnantti (Germany)"</para><para>"Kaptenlöjtnant (Germany)"</para><para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½-Ð»ÐµÐ¹ÑÐµÐ½Ð°Ð½Ñ (Germany)"</para><para>"Captain Lieutenant (Germany)"</para><para>"Capitaine-lieutenant (Germany)"</para><para>"Kapteinløytnant (Germany)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Captain Lieutenant (Rússia)"</para><para>"Captain Lieutenant (Rusland)"</para><para>"Captain Lieutenant (Russia)"</para><para>"Kapteeniluutnantti (Venäjä)"</para><para>"Captain Lieutenant (Rosja)"</para><para>"Kaptenlöjtnant (Ryssland)"</para><para>"Kapteinløytnant (Russland)"</para><para>"Kapitänleutnant (Russland)"</para><para>"Captain Lieutenant (Rusia)"</para><para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½-Ð»ÐµÐ¹ÑÐµÐ½Ð°Ð½Ñ (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Capitaine-lieutenant (Russie)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Kapitänleutnant (Sowjetunion)"</para><para>"Captain Lieutenant (Unión Soviética)"</para><para>"Capitaine-lieutenant (Union des républiques socialistes soviétiques)"</para><para>"Captain Lieutenant (Soviet Union)"</para><para>"Kapteinløytnant (Sovjetunionen)"</para><para>"Captain Lieutenant (Unione Sovietica)"</para><para>"Captain Lieutenant (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Captain Lieutenant (Sovjet-Unie)"</para><para>"Kaptenlöjtnant (Sovjetunionen)"</para><para>"Captain Lieutenant (União Soviética)"</para><para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½-Ð»ÐµÐ¹ÑÐµÐ½Ð°Ð½Ñ (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Kapteeniluutnantti (Neuvostoliitto)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Kaptein (grad) (Irland)"</para><para>"Capitão (militar) (República da Irlanda)"</para><para>"Kapitan (ranga) (Irlandia)"</para><para>"Capitaine (Irlande (pays))"</para><para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½ (Ð²Ð¾Ð¸Ð½ÑÐºÐ¾Ðµ Ð·Ð²Ð°Ð½Ð¸Ðµ) (ÐÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Capitano (Irlanda)"</para><para>"Hauptmann (Offizier) (Irland)"</para><para>"Kapteeni (sotilasarvo) (Irlanti)"</para><para>"Captain (OF-2) (Republic of Ireland)"</para><para>"Kapitein (rang) (Ierland (land))"</para><para>"Kapten (Irland)"</para><para>"Capitán (Irlanda)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Capitano (Russia)"</para><para>"Capitão (militar) (Rússia)"</para><para>"Kapitein (rang) (Rusland)"</para><para>"Capitaine (Russie)"</para><para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½ (Ð²Ð¾Ð¸Ð½ÑÐºÐ¾Ðµ Ð·Ð²Ð°Ð½Ð¸Ðµ) (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Hauptmann (Offizier) (Russland)"</para><para>"Kaptein (grad) (Russland)"</para><para>"Capitán (Rusia)"</para><para>"Kapitan (ranga) (Rosja)"</para><para>"Kapteeni (sotilasarvo) (Venäjä)"</para><para>"Captain (OF-2) (Russia)"</para><para>"Kapten (Ryssland)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Kapteeni (sotilasarvo) (Singapore)"</para><para>"Hauptmann (Offizier) (Singapur)"</para><para>"Capitaine (Singapour)"</para><para>"Capitão (militar) (Singapura)"</para><para>"Kaptein (grad) (Singapore)"</para><para>"Captain (OF-2) (Singapore)"</para><para>"Capitán (Singapur)"</para><para>"Kapitein (rang) (Singapore)"</para><para>"Kapitan (ranga) (Singapur)"</para><para>"Kapten (Singapore)"</para><para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½ (Ð²Ð¾Ð¸Ð½ÑÐºÐ¾Ðµ Ð·Ð²Ð°Ð½Ð¸Ðµ) (Ð¡Ð¸Ð½Ð³Ð°Ð¿ÑÑ)"</para><para>"Capitano (Singapore)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½ (Ð²Ð¾Ð¸Ð½ÑÐºÐ¾Ðµ Ð·Ð²Ð°Ð½Ð¸Ðµ) (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Capitano (Unione Sovietica)"</para><para>"Capitão (militar) (União Soviética)"</para><para>"Kaptein (grad) (Sovjetunionen)"</para><para>"Capitaine (Union des républiques socialistes soviétiques)"</para><para>"Hauptmann (Offizier) (Sowjetunion)"</para><para>"Captain (OF-2) (Soviet Union)"</para><para>"Kapitein (rang) (Sovjet-Unie)"</para><para>"Kapitan (ranga) (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Capitán (Unión Soviética)"</para><para>"Kapten (Sovjetunionen)"</para><para>"Kapteeni (sotilasarvo) (Neuvostoliitto)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Kapten (Sverige)"</para><para>"Capitán (Suecia)"</para><para>"Kapitan (ranga) (Szwecja)"</para><para>"Kapteeni (sotilasarvo) (Ruotsi)"</para><para>"Hauptmann (Offizier) (Schweden)"</para><para>"Captain (OF-2) (Sweden)"</para><para>"Capitano (Svezia)"</para><para>"Capitaine (Suède)"</para><para>"ÐÐ°Ð¿Ð¸ÑÐ°Ð½ (Ð²Ð¾Ð¸Ð½ÑÐºÐ¾Ðµ Ð·Ð²Ð°Ð½Ð¸Ðµ) (Ð¨Ð²ÐµÑÐ¸Ñ)"</para><para>"Kaptein (grad) (Sverige)"</para><para>"Capitão (militar) (Suécia)"</para><para>"Kapitein (rang) (Zweden)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Captain lieutenant (Russia)"</para><para>"Captain lieutenant (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Captain lieutenant (Russland)"</para><para>"Captain lieutenant (Ryssland)"</para><para>"Captain lieutenant (Rosja)"</para><para>"Captain lieutenant (Venäjä)"</para><para>"Captain lieutenant (Rusland)"</para><para>"Captain lieutenant (Rusia)"</para><para>"Captain lieutenant (Rússia)"</para><para>"Captain lieutenant (Russie)"</para></remarks>
    /// <seealso href="http://rdf.muninn-project.org/ontologies/military#Rank_Captain_lieutenant_Russia">http://rdf.muninn-project.org/ontologies/military#Rank_Captain_lieutenant_Russia</seealso>
    let Rank_Captain_lieutenant_Russia =
        Prefixed_Name(mil, "Rank_Captain_lieutenant_Russia") |> PrefixedName
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Captain lieutenant (Sovjetunionen)"</para><para>"Captain lieutenant (Neuvostoliitto)"</para><para>"Captain lieutenant (Unión Soviética)"</para><para>"Captain lieutenant (Unione Sovietica)"</para><para>"Captain lieutenant (Soviet Union)"</para><para>"Captain lieutenant (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Captain lieutenant (Union des républiques socialistes soviétiques)"</para><para>"Captain lieutenant (Sovjet-Unie)"</para><para>"Captain lieutenant (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Captain lieutenant (Sowjetunion)"</para><para>"Captain lieutenant (União Soviética)"</para></remarks>
    /// <seealso href="http://rdf.muninn-project.org/ontologies/military#Rank_Captain_lieutenant_Soviet_Union">http://rdf.muninn-project.org/ontologies/military#Rank_Captain_lieutenant_Soviet_Union</seealso>
    let Rank_Captain_lieutenant_Soviet_Union =
        Prefixed_Name(mil, "Rank_Captain_lieutenant_Soviet_Union") |> PrefixedName
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Chief Marshal"</para><para>"ÐÐ»Ð°Ð²Ð½ÑÐ¹ Ð¼Ð°ÑÑÐ°Ð» ÑÐ¾Ð´Ð° Ð²Ð¾Ð¹ÑÐº"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Chief Marshal (Russland)"</para><para>"Chief Marshal (Venäjä)"</para><para>"Chief Marshal (Russia)"</para><para>"Chief Marshal (Russie)"</para><para>"Chief Marshal (Rusland)"</para><para>"Chief Marshal (Rosja)"</para><para>"Chief Marshal (Rusia)"</para><para>"Chief Marshal (Ryssland)"</para><para>"Chief Marshal (Rússia)"</para><para>"ÐÐ»Ð°Ð²Ð½ÑÐ¹ Ð¼Ð°ÑÑÐ°Ð» ÑÐ¾Ð´Ð° Ð²Ð¾Ð¹ÑÐº (Ð Ð¾ÑÑÐ¸Ñ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Chief Marshal (Sovjetunionen)"</para><para>"Chief Marshal (Soviet Union)"</para><para>"Chief Marshal (Unione Sovietica)"</para><para>"ÐÐ»Ð°Ð²Ð½ÑÐ¹ Ð¼Ð°ÑÑÐ°Ð» ÑÐ¾Ð´Ð° Ð²Ð¾Ð¹ÑÐº (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Chief Marshal (Neuvostoliitto)"</para><para>"Chief Marshal (Unión Soviética)"</para><para>"Chief Marshal (Union des républiques socialistes soviétiques)"</para><para>"Chief Marshal (Sowjetunion)"</para><para>"Chief Marshal (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Chief Marshal (Sovjet-Unie)"</para><para>"Chief Marshal (União Soviética)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Chief petty officer (Australia)"</para><para>"Chief petty officer (Australien)"</para><para>"Chief petty officer (Austrália)"</para><para>"Chief petty officer (Australie)"</para><para>"Chief petty officer (Australië (land))"</para><para>"Chief petty officer (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Chief petty officer (Commonwealth delle nazioni)"</para><para>"Chief petty officer (Commonwealth of Nations)"</para><para>"Chief petty officer (Commonwealth)"</para><para>"Chief petty officer (Samveldet av nasjoner)"</para><para>"Chief petty officer (Samväldet)"</para><para>"Chief petty officer (Gemenebest van Naties)"</para><para>"Chief petty officer (Wspólnota Narodów)"</para><para>"Chief petty officer (Mancomunidad de Naciones)"</para><para>"Chief petty officer (Kansainyhteisö)"</para><para>"Chief petty officer (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Chiliarca"</para><para>"Chiliarcha"</para><para>"Chiliarch"</para><para>"Quiliarca"</para><para>"Chiliarque"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Chiliarch (Achaean League)"</para><para>"Quiliarca (Liga Aquea)"</para><para>"Chiliarcha (ZwiÄzek Achajski)"</para><para>"Chiliarque (Ligue achéenne)"</para><para>"Chiliarch (Liga Aqueia)"</para><para>"Chiliarch (Achaeïsche Bond)"</para><para>"Chiliarch (Achaiska förbundet)"</para><para>"Chiliarch (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para><para>"Chiliarca (Lega achea)"</para><para>"Chiliarch (Det akhaiske forbund)"</para><para>"Chiliarch (Akhaian liitto)"</para><para>"Chiliarch (Achaiischer Bund)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Chiliarch (Byzantijnse Rijk)"</para><para>"Chiliarch (Império Bizantino)"</para><para>"Chiliarch (Byzantine Empire)"</para><para>"Chiliarcha (Cesarstwo BizantyÅskie)"</para><para>"Chiliarch (ÐÐ¸Ð·Ð°Ð½ÑÐ¸Ð¹ÑÐºÐ°Ñ Ð¸Ð¼Ð¿ÐµÑÐ¸Ñ)"</para><para>"Chiliarch (Østromerriket)"</para><para>"Chiliarque (Empire byzantin)"</para><para>"Chiliarch (Bysantinska riket)"</para><para>"Chiliarch (Bysantin valtakunta)"</para><para>"Chiliarca (Impero bizantino)"</para><para>"Chiliarch (Byzantinisches Reich)"</para><para>"Quiliarca (Imperio bizantino)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Quiliarca (Grecia)"</para><para>"Chiliarcha (Grecja)"</para><para>"Chiliarch (Kreikka)"</para><para>"Chiliarch (Grekland)"</para><para>"Chiliarque (Grèce)"</para><para>"Chiliarch (Hellas)"</para><para>"Chiliarch (Grécia)"</para><para>"Chiliarch (Griechenland)"</para><para>"Chiliarch (Griekenland)"</para><para>"Chiliarch (Greece)"</para><para>"Chiliarch (ÐÑÐµÑÐ¸Ñ)"</para><para>"Chiliarca (Grecia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Chiliarca (Regno di Macedonia)"</para><para>"Quiliarca (Reino de Macedonia)"</para><para>"Chiliarch (Macedonië (oudheid))"</para><para>"Chiliarch (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para><para>"Chiliarch (Macedonia (ancient kingdom))"</para><para>"Chiliarch (Oldtidens Makedonia)"</para><para>"Chiliarcha (StaroÅ¼ytna Macedonia)"</para><para>"Chiliarch (Macedónia Antiga)"</para><para>"Chiliarch (Makedonian valtakunta)"</para><para>"Chiliarque (Royaume de Macédoine)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Chiliarcha (Timocracy of Sapinetia)"</para><para>"Chiliarch (Timocracy of Sapinetia)"</para><para>"Chiliarque (Timocracy of Sapinetia)"</para><para>"Chiliarca (Timocracy of Sapinetia)"</para><para>"Quiliarca (Timocracy of Sapinetia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"ÃorbacÄ±"</para><para>"Ð§Ð¾ÑÐ±Ð°Ð´Ð¶Ð¸"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"ÃorbacÄ± (Hetmanato cosaco)"</para><para>"Ð§Ð¾ÑÐ±Ð°Ð´Ð¶Ð¸ (ÐÐµÑÐ¼Ð°Ð½ÑÐ¸Ð½Ð°)"</para><para>"ÃorbacÄ± (Hetmanat cosaque)"</para><para>"ÃorbacÄ± (Cossack Hetmanate)"</para><para>"ÃorbacÄ± (HetmaÅszczyzna)"</para><para>"ÃorbacÄ± (Hetmanat)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"ÃorbacÄ± (Impero ottomano)"</para><para>"ÃorbacÄ± (Osmanien valtakunta)"</para><para>"ÃorbacÄ± (Imperium osmaÅskie)"</para><para>"ÃorbacÄ± (ImpÃ©rio Otomano)"</para><para>"ÃorbacÄ± (Ottomaanse Rijk)"</para><para>"Ð§Ð¾ÑÐ±Ð°Ð´Ð¶Ð¸ (ÐÑÐ¼Ð°Ð½ÑÐºÐ°Ñ Ð¸Ð¼Ð¿ÐµÑÐ¸Ñ)"</para><para>"ÃorbacÄ± (Ottoman Empire)"</para><para>"ÃorbacÄ± (Imperio otomano)"</para><para>"ÃorbacÄ± (Det osmanske rike)"</para><para>"ÃorbacÄ± (Osmanisches Reich)"</para><para>"ÃorbacÄ± (Osmanska riket)"</para><para>"ÃorbacÄ± (Empire ottoman)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Ð§Ð¾ÑÐ±Ð°Ð´Ð¶Ð¸ (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° Ð¡ÐµÐ¼Ð¸ ÐÑÑÑÐ¾Ð²Ð¾Ð²)"</para><para>"ÃorbacÄ± (RepÃºblica de las Islas JÃ³nicas)"</para><para>"ÃorbacÄ± (Republiek van de Zeven Eilanden)"</para><para>"ÃorbacÄ± (Septinsular Republic)"</para><para>"ÃorbacÄ± (Repubblica delle Sette Isole Unite)"</para><para>"ÃorbacÄ± (RÃ©publique des Sept-Ãles)"</para><para>"ÃorbacÄ± (Republika Siedmiu Wysp)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"ChorÄÅ¼y"</para><para>"Ð¥Ð¾ÑÑÐ½Ð¶Ð¸Ð¹"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"ChorÄÅ¼y (Poland)"</para><para>"Ð¥Ð¾ÑÑÐ½Ð¶Ð¸Ð¹ (Poland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"ChorÄÅ¼y (Rusland)"</para><para>"ChorÄÅ¼y (Rosja)"</para><para>"ChorÄÅ¼y (RÃºssia)"</para><para>"Ð¥Ð¾ÑÑÐ½Ð¶Ð¸Ð¹ (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"ChorÄÅ¼y (Rusia)"</para><para>"ChorÄÅ¼y (Russland)"</para><para>"ChorÄÅ¼y (VenÃ¤jÃ¤)"</para><para>"ChorÄÅ¼y (Russia)"</para><para>"ChorÄÅ¼y (Russie)"</para><para>"ChorÄÅ¼y (Ryssland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Ð¥Ð¾ÑÑÐ½Ð¶Ð¸Ð¹ (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"ChorÄÅ¼y (Sowjetunion)"</para><para>"ChorÄÅ¼y (Sovjet-Unie)"</para><para>"ChorÄÅ¼y (Unione Sovietica)"</para><para>"ChorÄÅ¼y (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"ChorÄÅ¼y (Sovjetunionen)"</para><para>"ChorÄÅ¼y (Neuvostoliitto)"</para><para>"ChorÄÅ¼y (UniÃ£o SoviÃ©tica)"</para><para>"ChorÄÅ¼y (Union des rÃ©publiques socialistes soviÃ©tiques)"</para><para>"ChorÄÅ¼y (UniÃ³n SoviÃ©tica)"</para><para>"ChorÄÅ¼y (Soviet Union)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"ChorÄÅ¼y (Ukraine)"</para><para>"ChorÄÅ¼y (Ukraina)"</para><para>"Ð¥Ð¾ÑÑÐ½Ð¶Ð¸Ð¹ (Ð£ÐºÑÐ°Ð¸Ð½Ð°)"</para><para>"ChorÄÅ¼y (UcrÃ¢nia)"</para><para>"ChorÄÅ¼y (Ucraina)"</para><para>"ChorÄÅ¼y (OekraÃ¯ne)"</para><para>"ChorÄÅ¼y (Ucrania)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Oberst"</para><para>"Colonel"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Komandarm"</para><para>"Komandarm av 2. klasse"</para><para>"Comandarm"</para><para>"Sowjetische Generalsränge"</para><para>"Komandarm av 1. klasse"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Comandarm (Rússia)"</para><para>"Komandarm (Rosja)"</para><para>"Comandarm (Venäjä)"</para><para>"Comandarm (Rusia)"</para><para>"Comandarm (Russia)"</para><para>"Comandarm (Ryssland)"</para><para>"Komandarm av 1. klasseKomandarm av 2. klasse (Russland)"</para><para>"Comandarm (Rusland)"</para><para>"Sowjetische GeneralsrängeKomandarm (Russland)"</para><para>"Comandarm (Russie)"</para><para>"Comandarm (Ð Ð¾ÑÑÐ¸Ñ)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Comandarm (Unión Soviética)"</para><para>"Komandarm av 1. klasseKomandarm av 2. klasse (Sovjetunionen)"</para><para>"Comandarm (União Soviética)"</para><para>"Komandarm (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Comandarm (Soviet Union)"</para><para>"Sowjetische GeneralsrängeKomandarm (Sowjetunion)"</para><para>"Comandarm (Sovjetunionen)"</para><para>"Comandarm (Neuvostoliitto)"</para><para>"Comandarm (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Comandarm (Unione Sovietica)"</para><para>"Comandarm (Union des républiques socialistes soviétiques)"</para><para>"Comandarm (Sovjet-Unie)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Kombrig"</para><para>"Prikaatinkomentaja"</para><para>"Combrig"</para><para>"ÐÐ¾Ð¼Ð±ÑÐ¸Ð³"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Combrig (Ryssland)"</para><para>"Combrig (Russland)"</para><para>"Combrig (Russie)"</para><para>"Kombrig (Rosja)"</para><para>"Combrig (Russia)"</para><para>"ÐÐ¾Ð¼Ð±ÑÐ¸Ð³ (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Kombrig (Rusia)"</para><para>"Kombrig (Russland)"</para><para>"Combrig (Rússia)"</para><para>"Kombrig (Russia)"</para><para>"Prikaatinkomentaja (Venäjä)"</para><para>"Combrig (Rusland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Kombrig (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Combrig (Sovjet-Unie)"</para><para>"Combrig (Soviet Union)"</para><para>"Combrig (Sovjetunionen)"</para><para>"Combrig (Union des républiques socialistes soviétiques)"</para><para>"Combrig (União Soviética)"</para><para>"ÐÐ¾Ð¼Ð±ÑÐ¸Ð³ (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Prikaatinkomentaja (Neuvostoliitto)"</para><para>"Kombrig (Unione Sovietica)"</para><para>"Kombrig (Sowjetunion)"</para><para>"Kombrig (Unión Soviética)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Comcor"</para><para>"Komkor"</para><para>"Armeijakunnankomentaja"</para><para>"ÐÐ¾Ð¼ÐºÐ¾Ñ"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Comcor (Rússia)"</para><para>"Comcor (Ryssland)"</para><para>"Armeijakunnankomentaja (Venäjä)"</para><para>"Comcor (Rusland)"</para><para>"Komkor (Rusia)"</para><para>"Comcor (Russia)"</para><para>"Comcor (Russie)"</para><para>"Komkor (Russland)"</para><para>"Komkor (Rosja)"</para><para>"ÐÐ¾Ð¼ÐºÐ¾Ñ (Ð Ð¾ÑÑÐ¸Ñ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Comcor (Sovjet-Unie)"</para><para>"Komkor (Sowjetunion)"</para><para>"Komkor (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Komkor (Unión Soviética)"</para><para>"ÐÐ¾Ð¼ÐºÐ¾Ñ (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Armeijakunnankomentaja (Neuvostoliitto)"</para><para>"Comcor (Soviet Union)"</para><para>"Comcor (Unione Sovietica)"</para><para>"Komkor (Sovjetunionen)"</para><para>"Comcor (Union des républiques socialistes soviétiques)"</para><para>"Comcor (União Soviética)"</para><para>"Comcor (Sovjetunionen)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Divisioonankomentaja"</para><para>"Komdiv"</para><para>"Comdiv"</para><para>"ÐÐ¾Ð¼Ð´Ð¸Ð²"</para><para>"Komdiw"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Komdiv (Russland)"</para><para>"Comdiv (Rússia)"</para><para>"Divisioonankomentaja (Venäjä)"</para><para>"Komdiw (Rosja)"</para><para>"Komdiv (Rusia)"</para><para>"ÐÐ¾Ð¼Ð´Ð¸Ð² (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Comdiv (Ryssland)"</para><para>"Comdiv (Rusland)"</para><para>"Comdiv (Russia)"</para><para>"Comdiv (Russie)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Komdiv (Sowjetunion)"</para><para>"Comdiv (Sovjetunionen)"</para><para>"Komdiv (Unión Soviética)"</para><para>"ÐÐ¾Ð¼Ð´Ð¸Ð² (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Divisioonankomentaja (Neuvostoliitto)"</para><para>"Comdiv (Unione Sovietica)"</para><para>"Comdiv (Sovjet-Unie)"</para><para>"Komdiv (Sovjetunionen)"</para><para>"Comdiv (Soviet Union)"</para><para>"Comdiv (União Soviética)"</para><para>"Comdiv (Union des républiques socialistes soviétiques)"</para><para>"Komdiw (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Fregattenkapitän"</para><para>"Capitaine de frégate"</para><para>"Commander"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Commandeur"</para><para>"Commandeur (marine)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Commandeur (France)"</para><para>"Commandeur (marine, France)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Commandeur (Alankomaat)"</para><para>"Commandeur (Pays-Bas)"</para><para>"Commandeur (Nederländerna)"</para><para>"Commandeur (marine) (Nederland)"</para><para>"Commandeur (ÐÐ¸Ð´ÐµÑÐ»Ð°Ð½Ð´Ñ)"</para><para>"Commandeur (Países Bajos)"</para><para>"Commandeur (Holandia)"</para><para>"Commandeur (Paesi Bassi)"</para><para>"Commandeur (Netherlands)"</para><para>"Commandeur (Nederland)"</para><para>"Commandeur (Países Baixos)"</para><para>"Commandeur (Niederlande)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Company Quartermaster Sergeant (Commonwealth delle nazioni)"</para><para>"Company Quartermaster Sergeant (Commonwealth of Nations)"</para><para>"Company Quartermaster Sergeant (Kansainyhteisö)"</para><para>"Company Quartermaster Sergeant (Commonwealth)"</para><para>"Company Quartermaster Sergeant (Gemenebest van Naties)"</para><para>"Company Quartermaster Sergeant (Mancomunidad de Naciones)"</para><para>"Company Quartermaster Sergeant (Samväldet)"</para><para>"Company Quartermaster Sergeant (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Company Quartermaster Sergeant (Samveldet av nasjoner)"</para><para>"Company Quartermaster Sergeant (Wspólnota Narodów)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Company Quartermaster Sergeant (República da Irlanda)"</para><para>"Company Quartermaster Sergeant (Irlanda)"</para><para>"Company Quartermaster Sergeant (ÐÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Company Quartermaster Sergeant (Irlande (pays))"</para><para>"Company Quartermaster Sergeant (Irland)"</para><para>"Company Quartermaster Sergeant (Ierland (land))"</para><para>"Company Quartermaster Sergeant (Republic of Ireland)"</para><para>"Company Quartermaster Sergeant (Irlandia)"</para><para>"Company Quartermaster Sergeant (Irlanti)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Company Quartermaster Sergeant (Scotland)"</para><para>"Company Quartermaster Sergeant (Skottland)"</para><para>"Company Quartermaster Sergeant (Escocia)"</para><para>"Company Quartermaster Sergeant (Écosse)"</para><para>"Company Quartermaster Sergeant (Escócia)"</para><para>"Company Quartermaster Sergeant (Skotlanti)"</para><para>"Company Quartermaster Sergeant (Schottland)"</para><para>"Company Quartermaster Sergeant (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Company Quartermaster Sergeant (Szkocja)"</para><para>"Company Quartermaster Sergeant (Scozia)"</para><para>"Company Quartermaster Sergeant (Schotland)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Company Quartermaster Sergeant (Wales)"</para><para>"Company Quartermaster Sergeant (Galles)"</para><para>"Company Quartermaster Sergeant (Gales)"</para><para>"Company Quartermaster Sergeant (Ð£ÑÐ»ÑÑ)"</para><para>"Company Quartermaster Sergeant (Walia)"</para><para>"Company Quartermaster Sergeant (Pays de Galles)"</para><para>"Company Quartermaster Sergeant (País de Gales)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Company sergeant major (Australia)"</para><para>"Company sergeant major (Australien)"</para><para>"Company sergeant major (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Company sergeant major (Australie)"</para><para>"Company sergeant major (Austrália)"</para><para>"Company sergeant major (Australië (land))"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Company sergeant major (Singapore)"</para><para>"Company sergeant major (Ð¡Ð¸Ð½Ð³Ð°Ð¿ÑÑ)"</para><para>"Company sergeant major (Singapur)"</para><para>"Company sergeant major (Singapour)"</para><para>"Company sergeant major (Singapura)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Conductor (Army) (Australie)"</para><para>"Conductor (Army) (Australien)"</para><para>"Conductor (Army) (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Conductor (Army) (Australia)"</para><para>"Conductor (Army) (Australië (land))"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Conductor (Army) (Wales)"</para><para>"Conductor (Army) (País de Gales)"</para><para>"Conductor (Army) (Pays de Galles)"</para><para>"Conductor (Army) (Gales)"</para><para>"Conductor (Army) (Walia)"</para><para>"Conductor (Army) (Galles)"</para><para>"Conductor (Army) (Ð£ÑÐ»ÑÑ)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Korporal"</para><para>"Caporal"</para><para>"Corporal"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Daejang (Nord-Korea)"</para><para>"Daejang (North Korea)"</para><para>"Daejang (Korean demokraattinen kansantasavalta)"</para><para>"Daejang (Coreia do Norte)"</para><para>"Daejang (Corea del Norte)"</para><para>"Daejang (Corea del Nord)"</para><para>"Daejang (Noord-Korea)"</para><para>"Daejang (Nordkorea)"</para><para>"Daejang (Korea PÃ³Ånocna)"</para><para>"Daejang (Corée du Nord)"</para><para>"Daejang (ÐÐ¾ÑÐµÐ¹ÑÐºÐ°Ñ ÐÐ°ÑÐ¾Ð´Ð½Ð¾-ÐÐµÐ¼Ð¾ÐºÑÐ°ÑÐ¸ÑÐµÑÐºÐ°Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ°)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Daejang (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° ÐÐ¾ÑÐµÑ)"</para><para>"Daejang (South Korea)"</para><para>"Daejang (Zuid-Korea)"</para><para>"Daejang (Korea PoÅudniowa)"</para><para>"Daejang (Sør-Korea)"</para><para>"Daejang (Corea del Sur)"</para><para>"Daejang (Sydkorea)"</para><para>"Daejang (Coreia do Sul)"</para><para>"Daejang (Corea del Sud)"</para><para>"Daejang (Südkorea)"</para><para>"Daejang (Korean tasavalta)"</para><para>"Daejang (Corée du Sud)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Divisional Admiral"</para><para>"Amiral de division"</para><para>"Ammiraglio di divisione"</para><para>"Divisieadmiraal"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Divisional Admiral (Italia)"</para><para>"Ammiraglio di divisione (Italia)"</para><para>"Divisional Admiral (ÐÑÐ°Ð»Ð¸Ñ)"</para><para>"Divisional Admiral (Italien)"</para><para>"Divisional Admiral (Itália)"</para><para>"Amiral de division (Italie)"</para><para>"Divisional Admiral (WÅochy)"</para><para>"Divisional Admiral (Italy)"</para><para>"Divisieadmiraal (Italië)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Divisioonakenraali"</para><para>"Général de division"</para><para>"Generale di divisione"</para><para>"Divisional General"</para><para>"General de divisão"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Général de division (France)"</para><para>"Divisional General (France)"</para><para>"General de divisão (France)"</para><para>"Divisioonakenraali (France)"</para><para>"Generale di divisione (France)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Generale di divisione (Poland)"</para><para>"Divisional General (Poland)"</para><para>"Divisioonakenraali (Poland)"</para><para>"Général de division (Poland)"</para><para>"General de divisão (Poland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Drum Major General (Commonwealth of Nations)"</para><para>"Drum Major General (Gemenebest van Naties)"</para><para>"Drum Major General (Commonwealth delle nazioni)"</para><para>"Drum Major General (Samveldet av nasjoner)"</para><para>"Drum Major General (Mancomunidad de Naciones)"</para><para>"Drum Major General (Kansainyhteisö)"</para><para>"Drum Major General (Wspólnota Narodów)"</para><para>"Drum Major General (Samväldet)"</para><para>"Drum Major General (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Drum Major General (Commonwealth)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Drum Major General (Schottland)"</para><para>"Drum Major General (Écosse)"</para><para>"Drum Major General (Szkocja)"</para><para>"Drum Major General (Skottland)"</para><para>"Drum Major General (Scozia)"</para><para>"Drum Major General (Escocia)"</para><para>"Drum Major General (Escócia)"</para><para>"Drum Major General (Scotland)"</para><para>"Drum Major General (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Drum Major General (Skotlanti)"</para><para>"Drum Major General (Schotland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Drum Major General (Wales)"</para><para>"Drum Major General (Galles)"</para><para>"Drum Major General (País de Gales)"</para><para>"Drum Major General (Pays de Galles)"</para><para>"Drum Major General (Walia)"</para><para>"Drum Major General (Gales)"</para><para>"Drum Major General (Ð£ÑÐ»ÑÑ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Drum major (rank) (Samväldet)"</para><para>"Drum major (rank) (Commonwealth)"</para><para>"Drum major (rank) (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Drum major (rank) (Commonwealth of Nations)"</para><para>"Drum major (rank) (Kansainyhteisö)"</para><para>"Drum major (rank) (Samveldet av nasjoner)"</para><para>"Drum major (rank) (Mancomunidad de Naciones)"</para><para>"Drum major (rank) (Wspólnota Narodów)"</para><para>"Drum major (rank) (Gemenebest van Naties)"</para><para>"Drum major (rank) (Commonwealth delle nazioni)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Drum major (rank) (Escocia)"</para><para>"Drum major (rank) (Écosse)"</para><para>"Drum major (rank) (Scotland)"</para><para>"Drum major (rank) (Schotland)"</para><para>"Drum major (rank) (Escócia)"</para><para>"Drum major (rank) (Skotlanti)"</para><para>"Drum major (rank) (Skottland)"</para><para>"Drum major (rank) (Schottland)"</para><para>"Drum major (rank) (Scozia)"</para><para>"Drum major (rank) (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Drum major (rank) (Szkocja)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Drum major (rank) (Wales)"</para><para>"Drum major (rank) (Pays de Galles)"</para><para>"Drum major (rank) (Gales)"</para><para>"Drum major (rank) (Ð£ÑÐ»ÑÑ)"</para><para>"Drum major (rank) (País de Gales)"</para><para>"Drum major (rank) (Galles)"</para><para>"Drum major (rank) (Walia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Epihipparch (Achaean League)"</para><para>"Epihipparch (Achaiischer Bund)"</para><para>"Epihipparch (ZwiÄzek Achajski)"</para><para>"Epihipparch (Achaeïsche Bond)"</para><para>"Epihipparch (Det akhaiske forbund)"</para><para>"Epihipparch (Lega achea)"</para><para>"Epihipparch (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para><para>"Epihipparch (Achaiska förbundet)"</para><para>"Epihipparch (Ligue achéenne)"</para><para>"Epihipparch (Liga Aquea)"</para><para>"Epihipparch (Akhaian liitto)"</para><para>"Epihipparch (Liga Aqueia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Epihipparch (Makedonian valtakunta)"</para><para>"Epihipparch (Macedónia Antiga)"</para><para>"Epihipparch (Regno di Macedonia)"</para><para>"Epihipparch (StaroÅ¼ytna Macedonia)"</para><para>"Epihipparch (Macedonië (oudheid))"</para><para>"Epihipparch (Reino de Macedonia)"</para><para>"Epihipparch (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para><para>"Epihipparch (Oldtidens Makedonia)"</para><para>"Epihipparch (Macedonia (ancient kingdom))"</para><para>"Epihipparch (Royaume de Macédoine)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Ferik (rank) (Hetmanato cosaco)"</para><para>"Ferik (rank) (HetmaÅszczyzna)"</para><para>"Ferik (rank) (Hetmanat)"</para><para>"Ferik (rank) (Hetmanat cosaque)"</para><para>"Ferik (rank) (Cossack Hetmanate)"</para><para>"Ferik (rank) (ÐÐµÑÐ¼Ð°Ð½ÑÐ¸Ð½Ð°)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Ferik (rank) (Ottomaanse Rijk)"</para><para>"Ferik (rank) (Osmanien valtakunta)"</para><para>"Ferik (rank) (Empire ottoman)"</para><para>"Ferik (rank) (ÐÑÐ¼Ð°Ð½ÑÐºÐ°Ñ Ð¸Ð¼Ð¿ÐµÑÐ¸Ñ)"</para><para>"Ferik (rank) (Imperio otomano)"</para><para>"Ferik (rank) (Imperium osmaÅskie)"</para><para>"Ferik (rank) (Império Otomano)"</para><para>"Ferik (rank) (Impero ottomano)"</para><para>"Ferik (rank) (Osmanska riket)"</para><para>"Ferik (rank) (Det osmanske rike)"</para><para>"Ferik (rank) (Osmanisches Reich)"</para><para>"Ferik (rank) (Ottoman Empire)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Ferik (rank) (Repubblica delle Sette Isole Unite)"</para><para>"Ferik (rank) (République des Sept-Îles)"</para><para>"Ferik (rank) (República de las Islas Jónicas)"</para><para>"Ferik (rank) (Republiek van de Zeven Eilanden)"</para><para>"Ferik (rank) (Republika Siedmiu Wysp)"</para><para>"Ferik (rank) (Septinsular Republic)"</para><para>"Ferik (rank) (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° Ð¡ÐµÐ¼Ð¸ ÐÑÑÑÐ¾Ð²Ð¾Ð²)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Fleet Board (Skottland)"</para><para>"Fleet Board (Scozia)"</para><para>"Fleet Board (Scotland)"</para><para>"Fleet Board (Szkocja)"</para><para>"Fleet Board (Escocia)"</para><para>"Fleet Board (Schotland)"</para><para>"Fleet Board (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Fleet Board (Écosse)"</para><para>"Fleet Board (Escócia)"</para><para>"Fleet Board (Schottland)"</para><para>"Fleet Board (Skotlanti)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Fleet Board (Pays de Galles)"</para><para>"Fleet Board (Wales)"</para><para>"Fleet Board (Ð£ÑÐ»ÑÑ)"</para><para>"Fleet Board (Gales)"</para><para>"Fleet Board (País de Gales)"</para><para>"Fleet Board (Walia)"</para><para>"Fleet Board (Galles)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Flight sergeant (Australia)"</para><para>"Flight sergeant (Australien)"</para><para>"Flight sergeant (Australie)"</para><para>"Flight sergeant (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Flight sergeant (Australië (land))"</para><para>"Flight sergeant (Austrália)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Flight sergeant (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Flight sergeant (Wspólnota Narodów)"</para><para>"Flight sergeant (Mancomunidad de Naciones)"</para><para>"Flight sergeant (Commonwealth delle nazioni)"</para><para>"Flight sergeant (Gemenebest van Naties)"</para><para>"Flight sergeant (Samväldet)"</para><para>"Flight sergeant (Kansainyhteisö)"</para><para>"Flight sergeant (Commonwealth)"</para><para>"Flight sergeant (Commonwealth of Nations)"</para><para>"Flight sergeant (Samveldet av nasjoner)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Flight sergeant (Irland)"</para><para>"Flight sergeant (Republic of Ireland)"</para><para>"Flight sergeant (Irlandia)"</para><para>"Flight sergeant (Irlanda)"</para><para>"Flight sergeant (República da Irlanda)"</para><para>"Flight sergeant (ÐÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Flight sergeant (Irlande (pays))"</para><para>"Flight sergeant (Irlanti)"</para><para>"Flight sergeant (Ierland (land))"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Gefreiter"</para><para>"ÐÑÑÐµÐ¹ÑÐ¾Ñ"</para><para>"Gefrajter"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Gefreiter (Germany)"</para><para>"ÐÑÑÐµÐ¹ÑÐ¾Ñ (Germany)"</para><para>"Gefrajter (Germany)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Gefreiter (Venäjä)"</para><para>"Gefreiter (Russland)"</para><para>"Gefreiter (Russie)"</para><para>"Gefreiter (Rusia)"</para><para>"Gefreiter (Rusland)"</para><para>"Gefreiter (Rússia)"</para><para>"Gefreiter (Ryssland)"</para><para>"Gefrajter (Rosja)"</para><para>"ÐÑÑÐµÐ¹ÑÐ¾Ñ (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Gefreiter (Russia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Gefreiter (Sowjetunion)"</para><para>"Gefreiter (Unione Sovietica)"</para><para>"Gefreiter (Neuvostoliitto)"</para><para>"Gefreiter (Soviet Union)"</para><para>"ÐÑÑÐµÐ¹ÑÐ¾Ñ (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Gefreiter (União Soviética)"</para><para>"Gefrajter (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Gefreiter (Sovjet-Unie)"</para><para>"Gefreiter (Union des républiques socialistes soviétiques)"</para><para>"Gefreiter (Unión Soviética)"</para><para>"Gefreiter (Sovjetunionen)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"General-in-Chief"</para><para>"ÐÐµÐ½ÐµÑÐ°Ð»-Ð°Ð½ÑÐµÑ"</para><para>"General en chef"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"General-in-Chief (Russia)"</para><para>"General-in-Chief (Rusland)"</para><para>"ÐÐµÐ½ÐµÑÐ°Ð»-Ð°Ð½ÑÐµÑ (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"General-in-Chief (Russie)"</para><para>"General-in-Chief (Russland)"</para><para>"General-in-Chief (Venäjä)"</para><para>"General-in-Chief (Rússia)"</para><para>"General en chef (Ryssland)"</para><para>"General-in-Chief (Rosja)"</para><para>"General-in-Chief (Rusia)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"General-in-Chief (União Soviética)"</para><para>"General-in-Chief (Sowjetunion)"</para><para>"General-in-Chief (Soviet Union)"</para><para>"General-in-Chief (Sovjet-Unie)"</para><para>"General-in-Chief (Unione Sovietica)"</para><para>"ÐÐµÐ½ÐµÑÐ°Ð»-Ð°Ð½ÑÐµÑ (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"General-in-Chief (Sovjetunionen)"</para><para>"General-in-Chief (Unión Soviética)"</para><para>"General-in-Chief (Union des républiques socialistes soviétiques)"</para><para>"General-in-Chief (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"General en chef (Sovjetunionen)"</para><para>"General-in-Chief (Neuvostoliitto)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Kenraaliamiraali"</para><para>"Almirante General"</para><para>"Generaladmiral"</para><para>"General Admiral"</para><para>"Admiraal-generaal"</para><para>"ÐÐµÐ½ÐµÑÐ°Ð»-Ð°Ð´Ð¼Ð¸ÑÐ°Ð»"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Generaladmiral (Germany)"</para><para>"Kenraaliamiraali (Germany)"</para><para>"Admiraal-generaal (Germany)"</para><para>"General Admiral (Germany)"</para><para>"Almirante General (Germany)"</para><para>"ÐÐµÐ½ÐµÑÐ°Ð»-Ð°Ð´Ð¼Ð¸ÑÐ°Ð» (Germany)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Admiraal-generaal (Rusland)"</para><para>"General Admiral (Russia)"</para><para>"ÐÐµÐ½ÐµÑÐ°Ð»-Ð°Ð´Ð¼Ð¸ÑÐ°Ð» (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"General Admiral (Russland)"</para><para>"Almirante General (Rusia)"</para><para>"General Admiral (Rússia)"</para><para>"Generaladmiral (Russland)"</para><para>"General Admiral (Ryssland)"</para><para>"General Admiral (Rosja)"</para><para>"General Admiral (Russie)"</para><para>"Kenraaliamiraali (Venäjä)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"General Admiral (Sovjetunionen)"</para><para>"Kenraaliamiraali (Neuvostoliitto)"</para><para>"Almirante General (Unión Soviética)"</para><para>"General Admiral (União Soviética)"</para><para>"General Admiral (Unione Sovietica)"</para><para>"General Admiral (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"ÐÐµÐ½ÐµÑÐ°Ð»-Ð°Ð´Ð¼Ð¸ÑÐ°Ð» (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Admiraal-generaal (Sovjet-Unie)"</para><para>"Generaladmiral (Sowjetunion)"</para><para>"General Admiral (Union des républiques socialistes soviétiques)"</para><para>"General Admiral (Soviet Union)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"General"</para><para>"Général"</para><para>"General officer"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Hasa (Korean military) (Korean demokraattinen kansantasavalta)"</para><para>"Hasa (Korean military) (Corée du Nord)"</para><para>"Hasa (Korean military) (Nord-Korea)"</para><para>"Hasa (Korean military) (Corea del Nord)"</para><para>"Hasa (Korean military) (ÐÐ¾ÑÐµÐ¹ÑÐºÐ°Ñ ÐÐ°ÑÐ¾Ð´Ð½Ð¾-ÐÐµÐ¼Ð¾ÐºÑÐ°ÑÐ¸ÑÐµÑÐºÐ°Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ°)"</para><para>"Hasa (Korean military) (North Korea)"</para><para>"Hasa (Korean military) (Corea del Norte)"</para><para>"Hasa (Korean military) (Nordkorea)"</para><para>"Hasa (Korean military) (Noord-Korea)"</para><para>"Hasa (Korean military) (Coreia do Norte)"</para><para>"Hasa (Korean military) (Korea PÃ³Ånocna)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Hasa (Korean military) (Südkorea)"</para><para>"Hasa (Korean military) (Corea del Sud)"</para><para>"Hasa (Korean military) (Korean tasavalta)"</para><para>"Hasa (Korean military) (Sydkorea)"</para><para>"Hasa (Korean military) (Sør-Korea)"</para><para>"Hasa (Korean military) (Corea del Sur)"</para><para>"Hasa (Korean military) (Coreia do Sul)"</para><para>"Hasa (Korean military) (Korea PoÅudniowa)"</para><para>"Hasa (Korean military) (South Korea)"</para><para>"Hasa (Korean military) (Corée du Sud)"</para><para>"Hasa (Korean military) (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° ÐÐ¾ÑÐµÑ)"</para><para>"Hasa (Korean military) (Zuid-Korea)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Havildar"</para><para>"à¤¹à¤µà¤¿à¤²à¤¦à¤¾à¤°"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Hetman"</para><para>"Hetmani"</para><para>"ÐÐµÑÐ¼Ð°Ð½"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Hetman (Hviterussland)"</para><para>"ÐÐµÑÐ¼Ð°Ð½ (ÐÐµÐ»Ð¾ÑÑÑÑÐ¸Ñ)"</para><para>"Hetman (Bielorrusia)"</para><para>"Hetman (Weißrussland)"</para><para>"Hetman (Vitryssland)"</para><para>"Hetman (Belarus)"</para><para>"Hetman (Bielorrússia)"</para><para>"Hetman (BiaÅoruÅ)"</para><para>"Hetman (Bielorussia)"</para><para>"Hetman (Biélorussie)"</para><para>"Hetman (Wit-Rusland)"</para><para>"Hetmani (Valko-Venäjä)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Hetman (Litwa)"</para><para>"ÐÐµÑÐ¼Ð°Ð½ (ÐÐ¸ÑÐ²Ð°)"</para><para>"Hetman (Lituânia)"</para><para>"Hetman (Lituania)"</para><para>"Hetman (Litauen)"</para><para>"Hetman (Lithuania)"</para><para>"Hetman (Litouwen)"</para><para>"Hetman (Lituanie)"</para><para>"Hetmani (Liettua)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Hetman (Poland)"</para><para>"Hetmani (Poland)"</para><para>"ÐÐµÑÐ¼Ð°Ð½ (Poland)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Hetman (Ukraine)"</para><para>"Hetman (Ukraina)"</para><para>"Hetman (Ucrânia)"</para><para>"Hetman (Oekraïne)"</para><para>"ÐÐµÑÐ¼Ð°Ð½ (Ð£ÐºÑÐ°Ð¸Ð½Ð°)"</para><para>"Hetman (Ucraina)"</para><para>"Hetmani (Ukraina)"</para><para>"Hetman (Ucrania)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Hiparco (oficial de caballería)"</para><para>"ÐÐ¸Ð¿Ð¿Ð°ÑÑ (Ð²Ð¾ÐµÐ½Ð°ÑÐ°Ð»ÑÐ½Ð¸Ðº)"</para><para>"Hipparchus (cavalry officer)"</para><para>"Hipparchos"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Hipparchus (cavalry officer) (Achaiischer Bund)"</para><para>"Hipparchos (Achaeïsche Bond)"</para><para>"Hipparchus (cavalry officer) (Det akhaiske forbund)"</para><para>"Hipparchus (cavalry officer) (Lega achea)"</para><para>"Hipparchus (cavalry officer) (Akhaian liitto)"</para><para>"Hipparchus (cavalry officer) (Ligue achéenne)"</para><para>"ÐÐ¸Ð¿Ð¿Ð°ÑÑ (Ð²Ð¾ÐµÐ½Ð°ÑÐ°Ð»ÑÐ½Ð¸Ðº) (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para><para>"Hipparchus (cavalry officer) (Liga Aqueia)"</para><para>"Hiparco (oficial de caballería) (Liga Aquea)"</para><para>"Hipparchus (cavalry officer) (Achaiska förbundet)"</para><para>"Hipparchus (cavalry officer) (Achaean League)"</para><para>"Hipparchus (cavalry officer) (ZwiÄzek Achajski)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Hipparchus (cavalry officer) (Regno di Macedonia)"</para><para>"Hipparchus (cavalry officer) (Makedonian valtakunta)"</para><para>"ÐÐ¸Ð¿Ð¿Ð°ÑÑ (Ð²Ð¾ÐµÐ½Ð°ÑÐ°Ð»ÑÐ½Ð¸Ðº) (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para><para>"Hipparchus (cavalry officer) (Macedonia (ancient kingdom))"</para><para>"Hipparchus (cavalry officer) (StaroÅ¼ytna Macedonia)"</para><para>"Hipparchus (cavalry officer) (Royaume de Macédoine)"</para><para>"Hipparchus (cavalry officer) (Oldtidens Makedonia)"</para><para>"Hipparchos (Macedonië (oudheid))"</para><para>"Hiparco (oficial de caballería) (Reino de Macedonia)"</para><para>"Hipparchus (cavalry officer) (Macedónia Antiga)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Jungsa (Nord-Korea)"</para><para>"Jungsa (North Korea)"</para><para>"Jungsa (ÐÐ¾ÑÐµÐ¹ÑÐºÐ°Ñ ÐÐ°ÑÐ¾Ð´Ð½Ð¾-ÐÐµÐ¼Ð¾ÐºÑÐ°ÑÐ¸ÑÐµÑÐºÐ°Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ°)"</para><para>"Jungsa (Korean demokraattinen kansantasavalta)"</para><para>"Jungsa (Korea PÃ³Ånocna)"</para><para>"Jungsa (Corea del Norte)"</para><para>"Jungsa (Noord-Korea)"</para><para>"Jungsa (Corea del Nord)"</para><para>"Jungsa (Corée du Nord)"</para><para>"Jungsa (Nordkorea)"</para><para>"Jungsa (Coreia do Norte)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Jungsa (Korea PoÅudniowa)"</para><para>"Jungsa (South Korea)"</para><para>"Jungsa (Südkorea)"</para><para>"Jungsa (Corée du Sud)"</para><para>"Jungsa (Zuid-Korea)"</para><para>"Jungsa (Corea del Sud)"</para><para>"Jungsa (Corea del Sur)"</para><para>"Jungsa (Sydkorea)"</para><para>"Jungsa (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° ÐÐ¾ÑÐµÑ)"</para><para>"Jungsa (Sør-Korea)"</para><para>"Jungsa (Coreia do Sul)"</para><para>"Jungsa (Korean tasavalta)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Jungwi"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Jungwi (Noord-Korea)"</para><para>"Jungwi (Corea del Nord)"</para><para>"Jungwi (Corée du Nord)"</para><para>"Jungwi (Korea PÃ³Ånocna)"</para><para>"Jungwi (Nordkorea)"</para><para>"Jungwi (Coreia do Norte)"</para><para>"Jungwi (Korean demokraattinen kansantasavalta)"</para><para>"Jungwi (ÐÐ¾ÑÐµÐ¹ÑÐºÐ°Ñ ÐÐ°ÑÐ¾Ð´Ð½Ð¾-ÐÐµÐ¼Ð¾ÐºÑÐ°ÑÐ¸ÑÐµÑÐºÐ°Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ°)"</para><para>"Jungwi (North Korea)"</para><para>"Jungwi (Nord-Korea)"</para><para>"Jungwi (Corea del Norte)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Jungwi (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° ÐÐ¾ÑÐµÑ)"</para><para>"Jungwi (Südkorea)"</para><para>"Jungwi (South Korea)"</para><para>"Jungwi (Sydkorea)"</para><para>"Jungwi (Corea del Sur)"</para><para>"Jungwi (Korean tasavalta)"</para><para>"Jungwi (Korea PoÅudniowa)"</para><para>"Jungwi (Zuid-Korea)"</para><para>"Jungwi (Corea del Sud)"</para><para>"Jungwi (Corée du Sud)"</para><para>"Jungwi (Sør-Korea)"</para><para>"Jungwi (Coreia do Sul)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Junior Sergeant (Estónia)"</para><para>"Junior Sergeant (Viro)"</para><para>"Junior Sergeant (Estonia)"</para><para>"Junior Sergeant (Ð­ÑÑÐ¾Ð½Ð¸Ñ)"</para><para>"Junior Sergeant (Estland)"</para><para>"Junior Sergeant (Estonie)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Junjang (Corea del Norte)"</para><para>"Junjang (Coreia do Norte)"</para><para>"Junjang (Nord-Korea)"</para><para>"Junjang (Noord-Korea)"</para><para>"Junjang (Corée du Nord)"</para><para>"Junjang (Nordkorea)"</para><para>"Junjang (ÐÐ¾ÑÐµÐ¹ÑÐºÐ°Ñ ÐÐ°ÑÐ¾Ð´Ð½Ð¾-ÐÐµÐ¼Ð¾ÐºÑÐ°ÑÐ¸ÑÐµÑÐºÐ°Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ°)"</para><para>"Junjang (Korea PÃ³Ånocna)"</para><para>"Junjang (Korean demokraattinen kansantasavalta)"</para><para>"Junjang (North Korea)"</para><para>"Junjang (Corea del Nord)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Junjang (Corea del Sud)"</para><para>"Junjang (Südkorea)"</para><para>"Junjang (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° ÐÐ¾ÑÐµÑ)"</para><para>"Junjang (Sør-Korea)"</para><para>"Junjang (Korean tasavalta)"</para><para>"Junjang (Korea PoÅudniowa)"</para><para>"Junjang (Coreia do Sul)"</para><para>"Junjang (Corea del Sur)"</para><para>"Junjang (Zuid-Korea)"</para><para>"Junjang (Corée du Sud)"</para><para>"Junjang (South Korea)"</para><para>"Junjang (Sydkorea)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Capitan pacha"</para><para>"Kapudan Pasha"</para><para>"Kapudan Pascha"</para><para>"ÐÐ°Ð¿ÑÐ´Ð°Ð½-Ð¿Ð°ÑÐ°"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Kapudan Pasha (Cossack Hetmanate)"</para><para>"Kapudan Pasha (Hetmanato cosaco)"</para><para>"Kapudan Pasha (HetmaÅszczyzna)"</para><para>"Capitan pacha (Hetmanat cosaque)"</para><para>"Kapudan Pascha (Hetmanat)"</para><para>"ÐÐ°Ð¿ÑÐ´Ð°Ð½-Ð¿Ð°ÑÐ° (ÐÐµÑÐ¼Ð°Ð½ÑÐ¸Ð½Ð°)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Kapudan Pascha (Osmanisches Reich)"</para><para>"ÐÐ°Ð¿ÑÐ´Ð°Ð½-Ð¿Ð°ÑÐ° (ÐÑÐ¼Ð°Ð½ÑÐºÐ°Ñ Ð¸Ð¼Ð¿ÐµÑÐ¸Ñ)"</para><para>"Kapudan Pasha (Ottomaanse Rijk)"</para><para>"Kapudan Pasha (Imperium osmaÅskie)"</para><para>"Capitan pacha (Empire ottoman)"</para><para>"Kapudan Pasha (Osmanska riket)"</para><para>"Kapudan Pasha (Imperio otomano)"</para><para>"Kapudan Pasha (Ottoman Empire)"</para><para>"Kapudan Pasha (Osmanien valtakunta)"</para><para>"Kapudan Pasha (Det osmanske rike)"</para><para>"Kapudan Pasha (Impero ottomano)"</para><para>"Kapudan Pasha (Império Otomano)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Kapudan Pasha (Repubblica delle Sette Isole Unite)"</para><para>"Capitan pacha (République des Sept-Îles)"</para><para>"Kapudan Pasha (República de las Islas Jónicas)"</para><para>"Kapudan Pasha (Republiek van de Zeven Eilanden)"</para><para>"ÐÐ°Ð¿ÑÐ´Ð°Ð½-Ð¿Ð°ÑÐ° (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° Ð¡ÐµÐ¼Ð¸ ÐÑÑÑÐ¾Ð²Ð¾Ð²)"</para><para>"Kapudan Pasha (Septinsular Republic)"</para><para>"Kapudan Pasha (Republika Siedmiu Wysp)"</para><para>"Kapudan Pascha (Septinsular Republic)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Kindral (Estónia)"</para><para>"Kindral (Estland)"</para><para>"Kindral (Estonia)"</para><para>"Kindral (Viro)"</para><para>"Kindral (Estonie)"</para><para>"Kindral (Ð­ÑÑÐ¾Ð½Ð¸Ñ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"KolaÄasÄ± (Hetmanat cosaque)"</para><para>"KolaÄasÄ± (ÐÐµÑÐ¼Ð°Ð½ÑÐ¸Ð½Ð°)"</para><para>"KolaÄasÄ± (Cossack Hetmanate)"</para><para>"KolaÄasÄ± (Hetmanat)"</para><para>"KolaÄasÄ± (Hetmanato cosaco)"</para><para>"KolaÄasÄ± (HetmaÅszczyzna)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"KolaÄasÄ± (Empire ottoman)"</para><para>"KolaÄasÄ± (Ottomaanse Rijk)"</para><para>"KolaÄasÄ± (Osmanska riket)"</para><para>"KolaÄasÄ± (ÐÑÐ¼Ð°Ð½ÑÐºÐ°Ñ Ð¸Ð¼Ð¿ÐµÑÐ¸Ñ)"</para><para>"KolaÄasÄ± (Osmanien valtakunta)"</para><para>"KolaÄasÄ± (ImpÃ©rio Otomano)"</para><para>"KolaÄasÄ± (Imperium osmaÅskie)"</para><para>"KolaÄasÄ± (Ottoman Empire)"</para><para>"KolaÄasÄ± (Impero ottomano)"</para><para>"KolaÄasÄ± (Det osmanske rike)"</para><para>"KolaÄasÄ± (Osmanisches Reich)"</para><para>"KolaÄasÄ± (Imperio otomano)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"KolaÄasÄ± (Republiek van de Zeven Eilanden)"</para><para>"KolaÄasÄ± (Septinsular Republic)"</para><para>"KolaÄasÄ± (RepÃºblica de las Islas JÃ³nicas)"</para><para>"KolaÄasÄ± (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° Ð¡ÐµÐ¼Ð¸ ÐÑÑÑÐ¾Ð²Ð¾Ð²)"</para><para>"KolaÄasÄ± (Repubblica delle Sette Isole Unite)"</para><para>"KolaÄasÄ± (Republika Siedmiu Wysp)"</para><para>"KolaÄasÄ± (RÃ©publique des Sept-Ãles)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Kolonel (Belgium)"</para><para>"Kolonel (Belgia)"</para><para>"Kolonel (Belgien)"</para><para>"Kolonel (ÐÐµÐ»ÑÐ³Ð¸Ñ)"</para><para>"Kolonel (België)"</para><para>"Kolonel (Bélgica)"</para><para>"Kolonel (Belgio)"</para><para>"Kolonel (Belgique)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Kolonel (Estonia)"</para><para>"Kolonel (Ð­ÑÑÐ¾Ð½Ð¸Ñ)"</para><para>"Kolonel (Estland)"</para><para>"Kolonel (Viro)"</para><para>"Kolonel (Estónia)"</para><para>"Kolonel (Estonie)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Lance Corporal of Horse (Szkocja)"</para><para>"Lance Corporal of Horse (Skottland)"</para><para>"Lance Corporal of Horse (Schotland)"</para><para>"Lance Corporal of Horse (Scotland)"</para><para>"Lance Corporal of Horse (Scozia)"</para><para>"Lance Corporal of Horse (Escocia)"</para><para>"Lance Corporal of Horse (Schottland)"</para><para>"Lance Corporal of Horse (Skotlanti)"</para><para>"Lance Corporal of Horse (Escócia)"</para><para>"Lance Corporal of Horse (Écosse)"</para><para>"Lance Corporal of Horse (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Lance Corporal of Horse (Ð£ÑÐ»ÑÑ)"</para><para>"Lance Corporal of Horse (Wales)"</para><para>"Lance Corporal of Horse (Gales)"</para><para>"Lance Corporal of Horse (Pays de Galles)"</para><para>"Lance Corporal of Horse (País de Gales)"</para><para>"Lance Corporal of Horse (Walia)"</para><para>"Lance Corporal of Horse (Galles)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Lance corporal (Australia)"</para><para>"Lance corporal (Australien)"</para><para>"Lance corporal (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Lance corporal (Australië (land))"</para><para>"Lance corporal (Austrália)"</para><para>"Lance corporal (Australie)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Lance corporal (Commonwealth of Nations)"</para><para>"Lance corporal (Kansainyhteisö)"</para><para>"Lance corporal (Samveldet av nasjoner)"</para><para>"Lance corporal (Commonwealth delle nazioni)"</para><para>"Lance corporal (Wspólnota Narodów)"</para><para>"Lance corporal (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Lance corporal (Commonwealth)"</para><para>"Lance corporal (Gemenebest van Naties)"</para><para>"Lance corporal (Mancomunidad de Naciones)"</para><para>"Lance corporal (Samväldet)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Lance corporal (Scozia)"</para><para>"Lance corporal (Skotlanti)"</para><para>"Lance corporal (Escocia)"</para><para>"Lance corporal (Schottland)"</para><para>"Lance corporal (Scotland)"</para><para>"Lance corporal (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Lance corporal (Écosse)"</para><para>"Lance corporal (Escócia)"</para><para>"Lance corporal (Skottland)"</para><para>"Lance corporal (Schotland)"</para><para>"Lance corporal (Szkocja)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Lance corporal (Singapur)"</para><para>"Lance corporal (Singapore)"</para><para>"Lance corporal (Ð¡Ð¸Ð½Ð³Ð°Ð¿ÑÑ)"</para><para>"Lance corporal (Singapura)"</para><para>"Lance corporal (Singapour)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Lance corporal (Wales)"</para><para>"Lance corporal (Gales)"</para><para>"Lance corporal (Pays de Galles)"</para><para>"Lance corporal (País de Gales)"</para><para>"Lance corporal (Ð£ÑÐ»ÑÑ)"</para><para>"Lance corporal (Walia)"</para><para>"Lance corporal (Galles)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Lance Sergeant (Australia)"</para><para>"Lance Sergeant (Australien)"</para><para>"Lance Sergeant (Austrália)"</para><para>"Lance Sergeant (Australie)"</para><para>"Lance Sergeant (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Lance Sergeant (Australië (land))"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Lance Sergeant (Wspólnota Narodów)"</para><para>"Lance Sergeant (Commonwealth of Nations)"</para><para>"Lance Sergeant (Samveldet av nasjoner)"</para><para>"Lance Sergeant (Kansainyhteisö)"</para><para>"Lance Sergeant (Mancomunidad de Naciones)"</para><para>"Lance Sergeant (Samväldet)"</para><para>"Lance Sergeant (Commonwealth delle nazioni)"</para><para>"Lance Sergeant (Gemenebest van Naties)"</para><para>"Lance Sergeant (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Lance Sergeant (Commonwealth)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Lance Sergeant (Szkocja)"</para><para>"Lance Sergeant (Skottland)"</para><para>"Lance Sergeant (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Lance Sergeant (Skotlanti)"</para><para>"Lance Sergeant (Écosse)"</para><para>"Lance Sergeant (Escócia)"</para><para>"Lance Sergeant (Scotland)"</para><para>"Lance Sergeant (Schotland)"</para><para>"Lance Sergeant (Escocia)"</para><para>"Lance Sergeant (Schottland)"</para><para>"Lance Sergeant (Scozia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Lance Sergeant (Galles)"</para><para>"Lance Sergeant (Ð£ÑÐ»ÑÑ)"</para><para>"Lance Sergeant (Wales)"</para><para>"Lance Sergeant (País de Gales)"</para><para>"Lance Sergeant (Gales)"</para><para>"Lance Sergeant (Pays de Galles)"</para><para>"Lance Sergeant (Walia)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Leading aircraftman (Australia)"</para><para>"Leading aircraftman (Australië (land))"</para><para>"Leading aircraftman (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Leading aircraftman (Australien)"</para><para>"Leading aircraftman (Austrália)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Leading aircraftman (Commonwealth)"</para><para>"Leading aircraftman (Wspólnota Narodów)"</para><para>"Leading aircraftman (Gemenebest van Naties)"</para><para>"Leading aircraftman (Samveldet av nasjoner)"</para><para>"Leading aircraftman (Commonwealth of Nations)"</para><para>"Leading aircraftman (Kansainyhteisö)"</para><para>"Leading aircraftman (Mancomunidad de Naciones)"</para><para>"Leading aircraftman (Samväldet)"</para><para>"Leading aircraftman (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Leading aircraftman (Commonwealth delle nazioni)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Lieutenant"</para><para>"Lieutenant (grade militaire)"</para><para>"Leutnant"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Lochagos (Lega achea)"</para><para>"Lochagos (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para><para>"Lochagos (Ligue achéenne)"</para><para>"Lochagos (Achaiischer Bund)"</para><para>"Lochagos (Achaean League)"</para><para>"Lochagos (ZwiÄzek Achajski)"</para><para>"Lochagos (Achaeïsche Bond)"</para><para>"Lochagos (Liga Aqueia)"</para><para>"Lochagos (Achaiska förbundet)"</para><para>"Lochagos (Liga Aquea)"</para><para>"Lochagos (Det akhaiske forbund)"</para><para>"Lochagos (Akhaian liitto)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Lochagos (Grecia)"</para><para>"Lochagos (Grekland)"</para><para>"Lochagos (Greece)"</para><para>"Lochagos (Grécia)"</para><para>"Lochagos (Grecja)"</para><para>"Lochagos (Grèce)"</para><para>"Lochagos (ÐÑÐµÑÐ¸Ñ)"</para><para>"Lochagos (Hellas)"</para><para>"Lochagos (Griechenland)"</para><para>"Lochagos (Kreikka)"</para><para>"Lochagos (Griekenland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Lochagos (Regno di Macedonia)"</para><para>"Lochagos (Reino de Macedonia)"</para><para>"Lochagos (Oldtidens Makedonia)"</para><para>"Lochagos (Macedonië (oudheid))"</para><para>"Lochagos (Macedonia (ancient kingdom))"</para><para>"Lochagos (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para><para>"Lochagos (Makedonian valtakunta)"</para><para>"Lochagos (Macedónia Antiga)"</para><para>"Lochagos (Royaume de Macédoine)"</para><para>"Lochagos (StaroÅ¼ytna Macedonia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Lord High Admiral of the Wash (Écosse)"</para><para>"Lord High Admiral of the Wash (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Lord High Admiral of the Wash (Szkocja)"</para><para>"Lord High Admiral of the Wash (Skottland)"</para><para>"Lord High Admiral of the Wash (Skotlanti)"</para><para>"Lord High Admiral of the Wash (Escocia)"</para><para>"Lord High Admiral of the Wash (Scotland)"</para><para>"Lord High Admiral of the Wash (Escócia)"</para><para>"Lord High Admiral of the Wash (Schottland)"</para><para>"Lord High Admiral of the Wash (Scozia)"</para><para>"Lord High Admiral of the Wash (Schotland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Lord High Admiral of the Wash (Wales)"</para><para>"Lord High Admiral of the Wash (Walia)"</para><para>"Lord High Admiral of the Wash (Gales)"</para><para>"Lord High Admiral of the Wash (País de Gales)"</para><para>"Lord High Admiral of the Wash (Ð£ÑÐ»ÑÑ)"</para><para>"Lord High Admiral of the Wash (Pays de Galles)"</para><para>"Lord High Admiral of the Wash (Galles)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Major general (Australia)"</para><para>"Major general (Australië (land))"</para><para>"Major general (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Major general (Australie)"</para><para>"Major general (Australien)"</para><para>"Major general (Austrália)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Maréchal (armée)"</para><para>"Marshal"</para><para>"Marschall"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Mariscal de la Unión Soviética"</para><para>"Neuvostoliiton marsalkka"</para><para>"MarszaÅkowie ZSRR"</para><para>"ÐÐ°ÑÑÐ°Ð» Ð¡Ð¾Ð²ÐµÑÑÐºÐ¾Ð³Ð¾ Ð¡Ð¾ÑÐ·Ð°"</para><para>"Marschall der Sowjetunion"</para><para>"Maarschalk van de Sovjet-Unie"</para><para>"Marshal of the Soviet Union"</para><para>"Marskalk av Sovjetunionen"</para><para>"Maresciallo dell'Unione Sovietica"</para><para>"Marechal da União Soviética"</para><para>"Maréchal de l'Union soviétique"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"MarszaÅkowie ZSRR (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Marskalk av Sovjetunionen (Sovjetunionen)"</para><para>"Marshal of the Soviet Union (Soviet Union)"</para><para>"Mariscal de la Unión Soviética (Unión Soviética)"</para><para>"Maarschalk van de Sovjet-Unie (Sovjet-Unie)"</para><para>"Marschall der Sowjetunion (Sowjetunion)"</para><para>"Neuvostoliiton marsalkka (Neuvostoliitto)"</para><para>"Marechal da União Soviética (União Soviética)"</para><para>"Maresciallo dell'Unione Sovietica (Unione Sovietica)"</para><para>"Maréchal de l'Union soviétique (Union des républiques socialistes soviétiques)"</para><para>"ÐÐ°ÑÑÐ°Ð» Ð¡Ð¾Ð²ÐµÑÑÐºÐ¾Ð³Ð¾ Ð¡Ð¾ÑÐ·Ð° (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Master Warrant Officer (Singapur)"</para><para>"Master Warrant Officer (Singapura)"</para><para>"Master Warrant Officer (Singapore)"</para><para>"Master Warrant Officer (Ð¡Ð¸Ð½Ð³Ð°Ð¿ÑÑ)"</para><para>"Master Warrant Officer (Singapour)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Midshipman"</para><para>"Seekadett"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Mirliva (Hetmanato cosaco)"</para><para>"Mirliva (ÐÐµÑÐ¼Ð°Ð½ÑÐ¸Ð½Ð°)"</para><para>"Mirliva (Hetmanat cosaque)"</para><para>"Mirliva (HetmaÅszczyzna)"</para><para>"Mirliva (Hetmanat)"</para><para>"Mirliva (Cossack Hetmanate)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Mirliva (Imperium osmaÅskie)"</para><para>"Mirliva (Império Otomano)"</para><para>"Mirliva (Impero ottomano)"</para><para>"Mirliva (Osmanisches Reich)"</para><para>"Mirliva (Osmanska riket)"</para><para>"Mirliva (Ottomaanse Rijk)"</para><para>"Mirliva (Det osmanske rike)"</para><para>"Mirliva (ÐÑÐ¼Ð°Ð½ÑÐºÐ°Ñ Ð¸Ð¼Ð¿ÐµÑÐ¸Ñ)"</para><para>"Mirliva (Osmanien valtakunta)"</para><para>"Mirliva (Empire ottoman)"</para><para>"Mirliva (Ottoman Empire)"</para><para>"Mirliva (Imperio otomano)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Mirliva (Republika Siedmiu Wysp)"</para><para>"Mirliva (Republiek van de Zeven Eilanden)"</para><para>"Mirliva (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° Ð¡ÐµÐ¼Ð¸ ÐÑÑÑÐ¾Ð²Ð¾Ð²)"</para><para>"Mirliva (República de las Islas Jónicas)"</para><para>"Mirliva (Repubblica delle Sette Isole Unite)"</para><para>"Mirliva (Septinsular Republic)"</para><para>"Mirliva (République des Sept-Îles)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"MÃ¼Åir (HetmaÅszczyzna)"</para><para>"MÃ¼Åir (Hetmanat)"</para><para>"MÃ¼Åir (Hetmanat cosaque)"</para><para>"MÃ¼Åir (ÐÐµÑÐ¼Ð°Ð½ÑÐ¸Ð½Ð°)"</para><para>"MÃ¼Åir (Cossack Hetmanate)"</para><para>"MÃ¼Åir (Hetmanato cosaco)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"MÃ¼Åir (Impero ottomano)"</para><para>"MÃ¼Åir (Osmanisches Reich)"</para><para>"MÃ¼Åir (ImpÃ©rio Otomano)"</para><para>"MÃ¼Åir (Osmanska riket)"</para><para>"MÃ¼Åir (Det osmanske rike)"</para><para>"MÃ¼Åir (Imperium osmaÅskie)"</para><para>"MÃ¼Åir (Imperio otomano)"</para><para>"MÃ¼Åir (Empire ottoman)"</para><para>"MÃ¼Åir (ÐÑÐ¼Ð°Ð½ÑÐºÐ°Ñ Ð¸Ð¼Ð¿ÐµÑÐ¸Ñ)"</para><para>"MÃ¼Åir (Osmanien valtakunta)"</para><para>"MÃ¼Åir (Ottoman Empire)"</para><para>"MÃ¼Åir (Ottomaanse Rijk)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"MÃ¼Åir (Republiek van de Zeven Eilanden)"</para><para>"MÃ¼Åir (RepÃºblica de las Islas JÃ³nicas)"</para><para>"MÃ¼Åir (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° Ð¡ÐµÐ¼Ð¸ ÐÑÑÑÐ¾Ð²Ð¾Ð²)"</para><para>"MÃ¼Åir (RÃ©publique des Sept-Ãles)"</para><para>"MÃ¼Åir (Republika Siedmiu Wysp)"</para><para>"MÃ¼Åir (Septinsular Republic)"</para><para>"MÃ¼Åir (Repubblica delle Sette Isole Unite)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Nauarch"</para><para>"Navarch"</para><para>"Navarque"</para><para>"ÐÐ°Ð²Ð°ÑÑ"</para><para>"Navarco"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Nauarch (Achaiischer Bund)"</para><para>"Navarco (Liga Aquea)"</para><para>"Nauarch (ZwiÄzek Achajski)"</para><para>"Navarque (Ligue achéenne)"</para><para>"Navarch (Akhaian liitto)"</para><para>"Navarch (Achaeïsche Bond)"</para><para>"Navarch (Achaiska förbundet)"</para><para>"Navarch (Det akhaiske forbund)"</para><para>"Navarch (Liga Aqueia)"</para><para>"Navarch (Lega achea)"</para><para>"ÐÐ°Ð²Ð°ÑÑ (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para><para>"Navarch (Achaean League)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"ÐÐ°Ð²Ð°ÑÑ (ÐÑÐµÑÐ¸Ñ)"</para><para>"Navarch (Grecia)"</para><para>"Navarch (Grekland)"</para><para>"Navarch (Greece)"</para><para>"Navarco (Grecia)"</para><para>"Nauarch (Grecja)"</para><para>"Navarch (Hellas)"</para><para>"Navarch (Griekenland)"</para><para>"Navarch (Kreikka)"</para><para>"Nauarch (Griechenland)"</para><para>"Navarque (Grèce)"</para><para>"Navarch (Grécia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Navarch (Regno di Macedonia)"</para><para>"Nauarch (StaroÅ¼ytna Macedonia)"</para><para>"Navarch (Oldtidens Makedonia)"</para><para>"Navarch (Macedonië (oudheid))"</para><para>"Navarque (Royaume de Macédoine)"</para><para>"Navarch (Makedonian valtakunta)"</para><para>"Navarch (Macedónia Antiga)"</para><para>"Navarco (Reino de Macedonia)"</para><para>"Nauarch (Macedonia (ancient kingdom))"</para><para>"Navarch (Macedonia (ancient kingdom))"</para><para>"ÐÐ°Ð²Ð°ÑÑ (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para></remarks>
    ...
    ///   <para>owl:DeprecatedClass</para>
    ///
    /// labels<para>"Nauarch (Timocracy of Sapinetia)"</para><para>"Navarque (Timocracy of Sapinetia)"</para><para>"Navarco (Timocracy of Sapinetia)"</para><para>"ÐÐ°Ð²Ð°ÑÑ (Timocracy of Sapinetia)"</para><para>"Navarch (Timocracy of Sapinetia)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Ylikorpraali"</para><para>"Obergefreiter"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Obergefreiter (Germany)"</para><para>"Ylikorpraali (Germany)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Obergefreiter (Sveits)"</para><para>"Ylikorpraali (Sveitsi)"</para><para>"Obergefreiter (Svizzera)"</para><para>"Obergefreiter (Szwajcaria)"</para><para>"Obergefreiter (Suíça)"</para><para>"Obergefreiter (Suiza)"</para><para>"Obergefreiter (Zwitserland)"</para><para>"Obergefreiter (Schweiz)"</para><para>"Obergefreiter (Suisse)"</para><para>"Obergefreiter (Ð¨Ð²ÐµÐ¹ÑÐ°ÑÐ¸Ñ)"</para><para>"Obergefreiter (Switzerland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Oberst"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Oberst (Oostenrijk)"</para><para>"Oberst (Österreich)"</para><para>"Oberst (Austria)"</para><para>"Oberst (Autriche)"</para><para>"Oberst (ÐÐ²ÑÑÑÐ¸Ñ)"</para><para>"Oberst (Österrike)"</para><para>"Oberst (Itävalta)"</para><para>"Oberst (Østerrike)"</para><para>"Oberst (Áustria)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Oberst (Danemark)"</para><para>"Oberst (Dänemark)"</para><para>"Oberst (Dinamarca)"</para><para>"Oberst (Denemarken)"</para><para>"Oberst (Denmark)"</para><para>"Oberst (Dania)"</para><para>"Oberst (ÐÐ°Ð½Ð¸Ñ)"</para><para>"Oberst (Danmark)"</para><para>"Oberst (Tanska)"</para><para>"Oberst (Danimarca)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Oberst (Finlandia)"</para><para>"Oberst (Suomi)"</para><para>"Oberst (Finnland)"</para><para>"Oberst (Finlande)"</para><para>"Oberst (Ð¤Ð¸Ð½Ð»ÑÐ½Ð´Ð¸Ñ)"</para><para>"Oberst (Finland)"</para><para>"Oberst (Finlândia)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Oberst (Germany)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Oberst (Kungariket Danmark)"</para><para>"Oberst (ÐÐ¾ÑÐ¾Ð»ÐµÐ²ÑÑÐ²Ð¾ ÐÐ°Ð½Ð¸Ñ)"</para><para>"Oberst (Reino da Dinamarca)"</para><para>"Oberst (Tanskan kuningaskunta)"</para><para>"Oberst (Reino de Dinamarca)"</para><para>"Oberst (Kingdom of Denmark)"</para><para>"Oberst (Regno Unito di Danimarca)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Oberst (Noorwegen)"</para><para>"Oberst (Noruega)"</para><para>"Oberst (Norwegen)"</para><para>"Oberst (Norge)"</para><para>"Oberst (Norway)"</para><para>"Oberst (Norvège)"</para><para>"Oberst (Norja)"</para><para>"Oberst (ÐÐ¾ÑÐ²ÐµÐ³Ð¸Ñ)"</para><para>"Oberst (Norvegia)"</para><para>"Oberst (Norwegia)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Oberst (Suécia)"</para><para>"Oberst (Zweden)"</para><para>"Oberst (Suède)"</para><para>"Oberst (Ð¨Ð²ÐµÑÐ¸Ñ)"</para><para>"Oberst (Svezia)"</para><para>"Oberst (Ruotsi)"</para><para>"Oberst (Szwecja)"</para><para>"Oberst (Sverige)"</para><para>"Oberst (Schweden)"</para><para>"Oberst (Sweden)"</para><para>"Oberst (Suecia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Oberst (Schweiz)"</para><para>"Oberst (Zwitserland)"</para><para>"Oberst (Suisse)"</para><para>"Oberst (Switzerland)"</para><para>"Oberst (Sveitsi)"</para><para>"Oberst (Szwajcaria)"</para><para>"Oberst (Svizzera)"</para><para>"Oberst (Suíça)"</para><para>"Oberst (Sveits)"</para><para>"Oberst (Suiza)"</para><para>"Oberst (Ð¨Ð²ÐµÐ¹ÑÐ°ÑÐ¸Ñ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Oberstleutnant (Germany)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Ordinary Seaman (Australien)"</para><para>"Ordinary Seaman (Austrália)"</para><para>"Ordinary Seaman (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Ordinary Seaman (Australia)"</para><para>"Ordinary Seaman (Australië (land))"</para><para>"Ordinary Seaman (Australie)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Ordinary Seaman (Wspólnota Narodów)"</para><para>"Ordinary Seaman (Commonwealth of Nations)"</para><para>"Ordinary Seaman (Commonwealth)"</para><para>"Ordinary Seaman (Kansainyhteisö)"</para><para>"Ordinary Seaman (Gemenebest van Naties)"</para><para>"Ordinary Seaman (Mancomunidad de Naciones)"</para><para>"Ordinary Seaman (Samväldet)"</para><para>"Ordinary Seaman (Samveldet av nasjoner)"</para><para>"Ordinary Seaman (Commonwealth delle nazioni)"</para><para>"Ordinary Seaman (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Petty officer"</para><para>"Maître (grade)"</para><para>"Petty Officer"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Phrourarch (Liga Aquea)"</para><para>"Phrourarch (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para><para>"Phrourarch (Ligue achéenne)"</para><para>"Phrourarch (Akhaian liitto)"</para><para>"Phrourarch (ZwiÄzek Achajski)"</para><para>"Phrourarch (Det akhaiske forbund)"</para><para>"Phrourarch (Achaeïsche Bond)"</para><para>"Phrourarch (Achaean League)"</para><para>"Phrourarch (Achaiischer Bund)"</para><para>"Phrourarch (Liga Aqueia)"</para><para>"Phrourarch (Lega achea)"</para><para>"Phrourarch (Achaiska förbundet)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Phrourarch (Griechenland)"</para><para>"Phrourarch (Greece)"</para><para>"Phrourarch (Grecia)"</para><para>"Phrourarch (Griekenland)"</para><para>"Phrourarch (Hellas)"</para><para>"Phrourarch (Grecja)"</para><para>"Phrourarch (Grèce)"</para><para>"Phrourarch (Grécia)"</para><para>"Phrourarch (Kreikka)"</para><para>"Phrourarch (ÐÑÐµÑÐ¸Ñ)"</para><para>"Phrourarch (Grekland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Phrourarch (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para><para>"Phrourarch (Macedonië (oudheid))"</para><para>"Phrourarch (Macedonia (ancient kingdom))"</para><para>"Phrourarch (Oldtidens Makedonia)"</para><para>"Phrourarch (Regno di Macedonia)"</para><para>"Phrourarch (StaroÅ¼ytna Macedonia)"</para><para>"Phrourarch (Makedonian valtakunta)"</para><para>"Phrourarch (Macedónia Antiga)"</para><para>"Phrourarch (Reino de Macedonia)"</para><para>"Phrourarch (Royaume de Macédoine)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Pipe Major (Commonwealth of Nations)"</para><para>"Pipe Major (Commonwealth)"</para><para>"Pipe Major (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Pipe Major (Gemenebest van Naties)"</para><para>"Pipe Major (Mancomunidad de Naciones)"</para><para>"Pipe Major (Samveldet av nasjoner)"</para><para>"Pipe Major (Samväldet)"</para><para>"Pipe Major (Wspólnota Narodów)"</para><para>"Pipe Major (Kansainyhteisö)"</para><para>"Pipe Major (Commonwealth delle nazioni)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Pipe Major (Skotlanti)"</para><para>"Pipe Major (Escócia)"</para><para>"Pipe Major (Skottland)"</para><para>"Pipe Major (Écosse)"</para><para>"Pipe Major (Schotland)"</para><para>"Pipe Major (Scotland)"</para><para>"Pipe Major (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Pipe Major (Scozia)"</para><para>"Pipe Major (Escocia)"</para><para>"Pipe Major (Schottland)"</para><para>"Pipe Major (Szkocja)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Pipe Major (Ð£ÑÐ»ÑÑ)"</para><para>"Pipe Major (Pays de Galles)"</para><para>"Pipe Major (Galles)"</para><para>"Pipe Major (Wales)"</para><para>"Pipe Major (País de Gales)"</para><para>"Pipe Major (Walia)"</para><para>"Pipe Major (Gales)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Podpolkovnik"</para><para>"PodpuÅkownik"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Podpolkovnik (Poland)"</para><para>"PodpuÅkownik (Poland)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Podpolkovnik (Russland)"</para><para>"Podpolkovnik (Rusia)"</para><para>"Podpolkovnik (Rússia)"</para><para>"Podpolkovnik (Russia)"</para><para>"Podpolkovnik (Russie)"</para><para>"Podpolkovnik (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Podpolkovnik (Rusland)"</para><para>"Podpolkovnik (Venäjä)"</para><para>"PodpuÅkownik (Rosja)"</para><para>"Podpolkovnik (Ryssland)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Podpolkovnik (Sovjetunionen)"</para><para>"Podpolkovnik (Sowjetunion)"</para><para>"Podpolkovnik (Neuvostoliitto)"</para><para>"Podpolkovnik (União Soviética)"</para><para>"PodpuÅkownik (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Podpolkovnik (Union des républiques socialistes soviétiques)"</para><para>"Podpolkovnik (Unión Soviética)"</para><para>"Podpolkovnik (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Podpolkovnik (Sovjet-Unie)"</para><para>"Podpolkovnik (Soviet Union)"</para><para>"Podpolkovnik (Unione Sovietica)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Podpolkovnik (Ucraina)"</para><para>"Podpolkovnik (Ukraine)"</para><para>"Podpolkovnik (Ð£ÐºÑÐ°Ð¸Ð½Ð°)"</para><para>"Podpolkovnik (Ucrania)"</para><para>"PodpuÅkownik (Ukraina)"</para><para>"Podpolkovnik (Ukraina)"</para><para>"Podpolkovnik (Ucrânia)"</para><para>"Podpolkovnik (Oekraïne)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Podpraporshchik (Russland)"</para><para>"Podpraporshchik (Rusia)"</para><para>"Podpraporshchik (Russie)"</para><para>"Podpraporshchik (Ryssland)"</para><para>"Podpraporshchik (Venäjä)"</para><para>"Podpraporshchik (Russia)"</para><para>"Podpraporshchik (Rusland)"</para><para>"Podpraporshchik (Rússia)"</para><para>"ÐÐ¾Ð´Ð¿ÑÐ°Ð¿Ð¾ÑÑÐ¸Ðº (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Podpraporshchik (Rosja)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Podpraporshchik (Union des républiques socialistes soviétiques)"</para><para>"Podpraporshchik (Neuvostoliitto)"</para><para>"Podpraporshchik (Unione Sovietica)"</para><para>"Podpraporshchik (Sowjetunion)"</para><para>"ÐÐ¾Ð´Ð¿ÑÐ°Ð¿Ð¾ÑÑÐ¸Ðº (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Podpraporshchik (Soviet Union)"</para><para>"Podpraporshchik (Sovjetunionen)"</para><para>"Podpraporshchik (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Podpraporshchik (Unión Soviética)"</para><para>"Podpraporshchik (União Soviética)"</para><para>"Podpraporshchik (Sovjet-Unie)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Polemarkos"</para><para>"ÐÐ¾Ð»ÐµÐ¼Ð°ÑÑ"</para><para>"Polemarchos"</para><para>"Polemarca"</para><para>"Polemarch"</para><para>"Polemarco"</para><para>"Polemark"</para><para>"Polémarque"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Polemarch (Achaiischer Bund)"</para><para>"Polemarkos (Det akhaiske forbund)"</para><para>"Polemarch (Lega achea)"</para><para>"Polemark (Achaiska förbundet)"</para><para>"Polemarch (Akhaian liitto)"</para><para>"Polemarch (Achaean League)"</para><para>"Polemarco (Liga Aqueia)"</para><para>"Polemarca (Liga Aquea)"</para><para>"Polemarch (ZwiÄzek Achajski)"</para><para>"Polémarque (Ligue achéenne)"</para><para>"Polemarchos (Achaeïsche Bond)"</para><para>"ÐÐ¾Ð»ÐµÐ¼Ð°ÑÑ (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Polemarch (Regno di Macedonia)"</para><para>"Polemarchos (Macedonië (oudheid))"</para><para>"Polemark (Macedonia (ancient kingdom))"</para><para>"Polemarch (Macedonia (ancient kingdom))"</para><para>"Polemarca (Reino de Macedonia)"</para><para>"Polemarch (StaroÅ¼ytna Macedonia)"</para><para>"Polemarkos (Oldtidens Makedonia)"</para><para>"Polemarco (Macedónia Antiga)"</para><para>"Polemarch (Makedonian valtakunta)"</para><para>"ÐÐ¾Ð»ÐµÐ¼Ð°ÑÑ (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para><para>"Polémarque (Royaume de Macédoine)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Polkovnik (Russland)"</para><para>"Polkovnik (Russia)"</para><para>"Polkovnik (Rússia)"</para><para>"Polkovnik (Rusia)"</para><para>"Polkovnik (Rosja)"</para><para>"Polkovnik (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Polkovnik (Russie)"</para><para>"Polkovnik (Ryssland)"</para><para>"Polkovnik (Venäjä)"</para><para>"Polkovnik (Rusland)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Polkovnik (Ukraina)"</para><para>"Polkovnik (Ukraine)"</para><para>"Polkovnik (Ucraina)"</para><para>"Polkovnik (Oekraïne)"</para><para>"Polkovnik (Ucrania)"</para><para>"Polkovnik (Ð£ÐºÑÐ°Ð¸Ð½Ð°)"</para><para>"Polkovnik (Ucrânia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Poruchik"</para><para>"Poroetsjik"</para><para>"ÐÐ¾ÑÑÑÐ¸Ðº"</para><para>"Porutschik"</para><para>"PoruÄik"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Poruchik (Poland)"</para><para>"PoruÄik (Poland)"</para><para>"Poroetsjik (Poland)"</para><para>"Porutschik (Poland)"</para><para>"ÐÐ¾ÑÑÑÐ¸Ðº (Poland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Poroetsjik (Rusland)"</para><para>"Porutschik (Russland)"</para><para>"Poruchik (Rusia)"</para><para>"ÐÐ¾ÑÑÑÐ¸Ðº (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Poruchik (Russland)"</para><para>"Poruchik (Russia)"</para><para>"Poruchik (Rússia)"</para><para>"Poruchik (Ryssland)"</para><para>"PoruÄik (Russia)"</para><para>"Poruchik (Russie)"</para><para>"Poruchik (Rosja)"</para><para>"Poruchik (Venäjä)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Poruchik (Neuvostoliitto)"</para><para>"PoruÄik (Unione Sovietica)"</para><para>"Poruchik (Unión Soviética)"</para><para>"ÐÐ¾ÑÑÑÐ¸Ðº (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Porutschik (Sowjetunion)"</para><para>"Poruchik (Sovjetunionen)"</para><para>"Poroetsjik (Sovjet-Unie)"</para><para>"Poruchik (Union des républiques socialistes soviétiques)"</para><para>"Poruchik (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Poruchik (União Soviética)"</para><para>"Poruchik (Soviet Union)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Praporshchik (Rússia)"</para><para>"Praporshchik (Russland)"</para><para>"Praporshchik (Russie)"</para><para>"Praporshchik (Ryssland)"</para><para>"Praporshchik (Russia)"</para><para>"Praporshchik (Rusia)"</para><para>"ÐÑÐ°Ð¿Ð¾ÑÑÐ¸Ðº (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Praporshchik (Rusland)"</para><para>"Praporshchik (Rosja)"</para><para>"Praporshchik (Venäjä)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Praporshchik (Union des républiques socialistes soviétiques)"</para><para>"Praporshchik (Unione Sovietica)"</para><para>"Praporshchik (Soviet Union)"</para><para>"Praporshchik (Sowjetunion)"</para><para>"Praporshchik (Unión Soviética)"</para><para>"Praporshchik (Neuvostoliitto)"</para><para>"Praporshchik (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"ÐÑÐ°Ð¿Ð¾ÑÑÐ¸Ðº (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Praporshchik (União Soviética)"</para><para>"Praporshchik (Sovjet-Unie)"</para><para>"Praporshchik (Sovjetunionen)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Sotamies"</para><para>"Soldat (grade)"</para><para>"Ð ÑÐ´Ð¾Ð²Ð¾Ð¹"</para><para>"Menig (grad)"</para><para>"Menig 1kl"</para><para>"Deuxième classe"</para><para>"Menig"</para><para>"Soldado raso"</para><para>"Private (rank)"</para><para>"Soldat (Dienstgrad)"</para><para>"Private (Dienstgrad)"</para><para>"Szeregowy"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Menig 1klMenig (Australien)"</para><para>"Deuxième classeSoldat (grade) (Australie)"</para><para>"Private (rank) (Australia)"</para><para>"Private (Dienstgrad)Soldat (Dienstgrad) (Australien)"</para><para>"Szeregowy (Australia)"</para><para>"Private (rank) (Austrália)"</para><para>"Menig (grad)Menig (Australia)"</para><para>"Soldado raso (Australia)"</para><para>"Private (rank) (Australië (land))"</para><para>"Sotamies (Australia)"</para><para>"Ð ÑÐ´Ð¾Ð²Ð¾Ð¹ (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Menig 1klMenig (Canada)"</para><para>"Sotamies (Canada)"</para><para>"Deuxième classeSoldat (grade, Canada)"</para><para>"Soldat (Dienstgrad, Canada)"</para><para>"Menig (grad, Canada)"</para><para>"Ð ÑÐ´Ð¾Ð²Ð¾Ð¹ (Canada)"</para><para>"Private (rank, Canada)"</para><para>"Szeregowy (Canada)"</para><para>"Soldado raso (Canada)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Ð ÑÐ´Ð¾Ð²Ð¾Ð¹ (England)"</para><para>"Deuxième classeSoldat (grade) (England)"</para><para>"Menig (grad, England)"</para><para>"Sotamies (England)"</para><para>"Szeregowy (England)"</para><para>"Private (rank, England)"</para><para>"Soldado raso (England)"</para><para>"Menig 1klMenig (England)"</para><para>"Private (Dienstgrad)Soldat (Dienstgrad, England)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Private (rank) (República da Irlanda)"</para><para>"Menig (grad)Menig (Irland)"</para><para>"Soldado raso (Irlanda)"</para><para>"Menig 1klMenig (Irland)"</para><para>"Szeregowy (Irlandia)"</para><para>"Sotamies (Irlanti)"</para><para>"Private (Dienstgrad)Soldat (Dienstgrad) (Irland)"</para><para>"Ð ÑÐ´Ð¾Ð²Ð¾Ð¹ (ÐÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Deuxième classeSoldat (grade) (Irlande (pays))"</para><para>"Private (rank) (Ierland (land))"</para><para>"Private (rank) (Republic of Ireland)"</para><para>"Private (rank) (Irlanda)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Sotamies (Skotlanti)"</para><para>"Private (rank) (Scotland)"</para><para>"Private (Dienstgrad)Soldat (Dienstgrad) (Schottland)"</para><para>"Soldado raso (Escocia)"</para><para>"Menig (grad)Menig (Skottland)"</para><para>"Deuxième classeSoldat (grade) (Écosse)"</para><para>"Private (rank) (Escócia)"</para><para>"Private (rank) (Schotland)"</para><para>"Private (rank) (Scozia)"</para><para>"Szeregowy (Szkocja)"</para><para>"Menig 1klMenig (Skottland)"</para><para>"Ð ÑÐ´Ð¾Ð²Ð¾Ð¹ (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Ð ÑÐ´Ð¾Ð²Ð¾Ð¹ (Ð£ÑÐ»ÑÑ)"</para><para>"Private (rank) (País de Gales)"</para><para>"Private (Dienstgrad)Soldat (Dienstgrad) (Wales)"</para><para>"Menig 1klMenig (Wales)"</para><para>"Szeregowy (Walia)"</para><para>"Private (rank) (Wales)"</para><para>"Private (rank) (Galles)"</para><para>"Menig (grad)Menig (Wales)"</para><para>"Deuxième classeSoldat (grade) (Pays de Galles)"</para><para>"Soldado raso (Gales)"</para><para>"Sotamies (Wales)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Rear admiral (Australia)"</para><para>"Rear admiral (Australië (land))"</para><para>"Rear admiral (Australien)"</para><para>"Rear admiral (Australie)"</para><para>"Rear admiral (Austrália)"</para><para>"Rear admiral (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Regimental Quartermaster Sergeant (Australia)"</para><para>"Regimental Quartermaster Sergeant (Australien)"</para><para>"Regimental Quartermaster Sergeant (Austrália)"</para><para>"Regimental Quartermaster Sergeant (Australie)"</para><para>"Regimental Quartermaster Sergeant (Australië (land))"</para><para>"Regimental Quartermaster Sergeant (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Regimental Quartermaster Sergeant (Wspólnota Narodów)"</para><para>"Regimental Quartermaster Sergeant (Mancomunidad de Naciones)"</para><para>"Regimental Quartermaster Sergeant (Commonwealth of Nations)"</para><para>"Regimental Quartermaster Sergeant (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Regimental Quartermaster Sergeant (Commonwealth)"</para><para>"Regimental Quartermaster Sergeant (Samveldet av nasjoner)"</para><para>"Regimental Quartermaster Sergeant (Commonwealth delle nazioni)"</para><para>"Regimental Quartermaster Sergeant (Samväldet)"</para><para>"Regimental Quartermaster Sergeant (Kansainyhteisö)"</para><para>"Regimental Quartermaster Sergeant (Gemenebest van Naties)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Regimental Quartermaster Sergeant (Irland)"</para><para>"Regimental Quartermaster Sergeant (Irlanti)"</para><para>"Regimental Quartermaster Sergeant (Irlanda)"</para><para>"Regimental Quartermaster Sergeant (Irlandia)"</para><para>"Regimental Quartermaster Sergeant (República da Irlanda)"</para><para>"Regimental Quartermaster Sergeant (Irlande (pays))"</para><para>"Regimental Quartermaster Sergeant (Ierland (land))"</para><para>"Regimental Quartermaster Sergeant (ÐÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Regimental Quartermaster Sergeant (Republic of Ireland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Regimental Quartermaster Sergeant (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Regimental Quartermaster Sergeant (Escócia)"</para><para>"Regimental Quartermaster Sergeant (Scozia)"</para><para>"Regimental Quartermaster Sergeant (Skottland)"</para><para>"Regimental Quartermaster Sergeant (Szkocja)"</para><para>"Regimental Quartermaster Sergeant (Scotland)"</para><para>"Regimental Quartermaster Sergeant (Escocia)"</para><para>"Regimental Quartermaster Sergeant (Écosse)"</para><para>"Regimental Quartermaster Sergeant (Schotland)"</para><para>"Regimental Quartermaster Sergeant (Skotlanti)"</para><para>"Regimental Quartermaster Sergeant (Schottland)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Regimental Quartermaster Sergeant (Wales)"</para><para>"Regimental Quartermaster Sergeant (Galles)"</para><para>"Regimental Quartermaster Sergeant (Walia)"</para><para>"Regimental Quartermaster Sergeant (País de Gales)"</para><para>"Regimental Quartermaster Sergeant (Pays de Galles)"</para><para>"Regimental Quartermaster Sergeant (Gales)"</para><para>"Regimental Quartermaster Sergeant (Ð£ÑÐ»ÑÑ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Regimental sergeant major (Singapur)"</para><para>"Regimental sergeant major (Singapour)"</para><para>"Regimental sergeant major (Singapura)"</para><para>"Regimental sergeant major (Singapore)"</para><para>"Regimental sergeant major (Ð¡Ð¸Ð½Ð³Ð°Ð¿ÑÑ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Sangsa (Korean demokraattinen kansantasavalta)"</para><para>"Sangsa (Corea del Nord)"</para><para>"Sangsa (Noord-Korea)"</para><para>"Sangsa (ÐÐ¾ÑÐµÐ¹ÑÐºÐ°Ñ ÐÐ°ÑÐ¾Ð´Ð½Ð¾-ÐÐµÐ¼Ð¾ÐºÑÐ°ÑÐ¸ÑÐµÑÐºÐ°Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ°)"</para><para>"Sangsa (Korea PÃ³Ånocna)"</para><para>"Sangsa (Nord-Korea)"</para><para>"Sangsa (Corea del Norte)"</para><para>"Sangsa (Nordkorea)"</para><para>"Sangsa (North Korea)"</para><para>"Sangsa (Coreia do Norte)"</para><para>"Sangsa (Corée du Nord)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Sangsa (Korea PoÅudniowa)"</para><para>"Sangsa (Korean tasavalta)"</para><para>"Sangsa (Sør-Korea)"</para><para>"Sangsa (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° ÐÐ¾ÑÐµÑ)"</para><para>"Sangsa (Südkorea)"</para><para>"Sangsa (South Korea)"</para><para>"Sangsa (Coreia do Sul)"</para><para>"Sangsa (Sydkorea)"</para><para>"Sangsa (Corea del Sud)"</para><para>"Sangsa (Corea del Sur)"</para><para>"Sangsa (Corée du Sud)"</para><para>"Sangsa (Zuid-Korea)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Schout-bij-nacht"</para><para>"Schoutbynacht"</para><para>"Ð¨Ð°ÑÑÐ±ÐµÐ½Ð°ÑÑ"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Ð¨Ð°ÑÑÐ±ÐµÐ½Ð°ÑÑ (ÐÐ¸Ð´ÐµÑÐ»Ð°Ð½Ð´Ñ)"</para><para>"Schoutbynacht (Nederland)"</para><para>"Schout-bij-nacht (Netherlands)"</para><para>"Schout-bij-nacht (Alankomaat)"</para><para>"Schout-bij-nacht (Holandia)"</para><para>"Schout-bij-nacht (Paesi Bassi)"</para><para>"Schout-bij-nacht (Nederland)"</para><para>"Schout-bij-nacht (Países Bajos)"</para><para>"Schout-bij-nacht (Pays-Bas)"</para><para>"Schoutbynacht (Nederländerna)"</para><para>"Schout-bij-nacht (Países Baixos)"</para><para>"Schout-bij-nacht (Niederlande)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Schout-bij-nacht (Venäjä)"</para><para>"Schout-bij-nacht (Rusland)"</para><para>"Schout-bij-nacht (Russland)"</para><para>"Schout-bij-nacht (Rússia)"</para><para>"Schout-bij-nacht (Russia)"</para><para>"Schoutbynacht (Russland)"</para><para>"Schout-bij-nacht (Russie)"</para><para>"Schoutbynacht (Ryssland)"</para><para>"Schout-bij-nacht (Rusia)"</para><para>"Ð¨Ð°ÑÑÐ±ÐµÐ½Ð°ÑÑ (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Schout-bij-nacht (Rosja)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Schout-bij-nacht (Unión Soviética)"</para><para>"Schoutbynacht (Sovjetunionen)"</para><para>"Schout-bij-nacht (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Schout-bij-nacht (Sovjet-Unie)"</para><para>"Schout-bij-nacht (União Soviética)"</para><para>"Schout-bij-nacht (Union des républiques socialistes soviétiques)"</para><para>"Ð¨Ð°ÑÑÐ±ÐµÐ½Ð°ÑÑ (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Schout-bij-nacht (Neuvostoliitto)"</para><para>"Schout-bij-nacht (Soviet Union)"</para><para>"Schout-bij-nacht (Unione Sovietica)"</para><para>"Schout-bij-nacht (Sowjetunion)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Matelot"</para><para>"Seaman"</para><para>"Seemann"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Second Corporal (Escocia)"</para><para>"Second Corporal (Scozia)"</para><para>"Second Corporal (Escócia)"</para><para>"Second Corporal (Szkocja)"</para><para>"Second Corporal (Schottland)"</para><para>"Second Corporal (Scotland)"</para><para>"Second Corporal (Schotland)"</para><para>"Second Corporal (Skottland)"</para><para>"Second Corporal (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Second Corporal (Écosse)"</para><para>"Second Corporal (Skotlanti)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Second Corporal (Wales)"</para><para>"Second Corporal (Galles)"</para><para>"Second Corporal (Gales)"</para><para>"Second Corporal (Ð£ÑÐ»ÑÑ)"</para><para>"Second Corporal (Walia)"</para><para>"Second Corporal (Pays de Galles)"</para><para>"Second Corporal (País de Gales)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Sergeant"</para><para>"Sergent"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Fältflygare (Australien)"</para><para>"Sergeant Pilot (Australie)"</para><para>"Sergeant Pilot (Australia)"</para><para>"Sergeant Pilot (Australië (land))"</para><para>"Sergeant Pilot (Australien)"</para><para>"Sergeant Pilot (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Sergeant Pilot (Austrália)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Fältflygare (Canada)"</para><para>"Sergeant Pilot (Canada)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Sergeant Pilot (Wales)"</para><para>"Sergeant Pilot (Ð£ÑÐ»ÑÑ)"</para><para>"Sergeant Pilot (País de Gales)"</para><para>"Sergeant Pilot (Galles)"</para><para>"Fältflygare (Wales)"</para><para>"Sergeant Pilot (Pays de Galles)"</para><para>"Sergeant Pilot (Gales)"</para><para>"Sergeant Pilot (Walia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Skeuophoros (Liga Aquea)"</para><para>"Skeuophoros (ZwiÄzek Achajski)"</para><para>"Skeuophoros (Achaiska förbundet)"</para><para>"Skeuophoros (Lega achea)"</para><para>"Skeuophoros (Achaeïsche Bond)"</para><para>"Skeuophoros (Achaiischer Bund)"</para><para>"Skeuophoros (Akhaian liitto)"</para><para>"Skeuophoros (Ligue achéenne)"</para><para>"Skeuophoros (Achaean League)"</para><para>"Skeuophoros (Liga Aqueia)"</para><para>"Skeuophoros (Det akhaiske forbund)"</para><para>"Skeuophoros (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Skeuophoros (StaroÅ¼ytna Macedonia)"</para><para>"Skeuophoros (Royaume de Macédoine)"</para><para>"Skeuophoros (Macedónia Antiga)"</para><para>"Skeuophoros (Oldtidens Makedonia)"</para><para>"Skeuophoros (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para><para>"Skeuophoros (Makedonian valtakunta)"</para><para>"Skeuophoros (Macedonië (oudheid))"</para><para>"Skeuophoros (Reino de Macedonia)"</para><para>"Skeuophoros (Macedonia (ancient kingdom))"</para><para>"Skeuophoros (Regno di Macedonia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Somatophylax"</para><para>"Somatophylakes"</para><para>"Sômatophylaques"</para><para>"Somatofilachie"</para><para>"Somatofylakes"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Somatophylax (Achaeïsche Bond)"</para><para>"Somatophylakes (Achaiska förbundet)"</para><para>"Somatophylakes (Achaean League)"</para><para>"Somatophylakes (Liga Aqueia)"</para><para>"Somatophylakes (ZwiÄzek Achajski)"</para><para>"Sômatophylaques (Ligue achéenne)"</para><para>"Somatophylakes (Achaiischer Bund)"</para><para>"Somatofylakes (Akhaian liitto)"</para><para>"Somatophylakes (Liga Aquea)"</para><para>"Somatophylakes (Det akhaiske forbund)"</para><para>"Somatophylakes (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para><para>"Somatofilachie (Lega achea)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Somatofilachie (Regno di Macedonia)"</para><para>"Somatophylakes (Macedonia (ancient kingdom))"</para><para>"Somatophylakes (Oldtidens Makedonia)"</para><para>"Somatophylakes (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para><para>"Somatophylakes (StaroÅ¼ytna Macedonia)"</para><para>"Sômatophylaques (Royaume de Macédoine)"</para><para>"Somatofylakes (Makedonian valtakunta)"</para><para>"Somatophylakes (Reino de Macedonia)"</para><para>"Somatophylakes (Macedónia Antiga)"</para><para>"Somatophylax (Macedonië (oudheid))"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Sotnik"</para><para>"Sótnik"</para><para>"Ð¡Ð¾ÑÐ½Ð¸Ðº"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Sotnik (Russland)"</para><para>"Sotnik (Russie)"</para><para>"Sotnik (Rusland)"</para><para>"Ð¡Ð¾ÑÐ½Ð¸Ðº (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Sotnik (Rosja)"</para><para>"Sotnik (Russia)"</para><para>"Sotnik (Venäjä)"</para><para>"Sotnik (Ryssland)"</para><para>"Sótnik (Rússia)"</para><para>"Sotnik (Rusia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Sotnik (Union des républiques socialistes soviétiques)"</para><para>"Sotnik (Unione Sovietica)"</para><para>"Sotnik (Soviet Union)"</para><para>"Sotnik (Sovjet-Unie)"</para><para>"Sotnik (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Ð¡Ð¾ÑÐ½Ð¸Ðº (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Sotnik (Sovjetunionen)"</para><para>"Sotnik (Unión Soviética)"</para><para>"Sotnik (Sowjetunion)"</para><para>"Sótnik (União Soviética)"</para><para>"Sotnik (Neuvostoliitto)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Sotnik (Ucrania)"</para><para>"Sótnik (Ucrânia)"</para><para>"Sotnik (Ukraina)"</para><para>"Sotnik (Ukraine)"</para><para>"Sotnik (Oekraïne)"</para><para>"Sotnik (Ucraina)"</para><para>"Ð¡Ð¾ÑÐ½Ð¸Ðº (Ð£ÐºÑÐ°Ð¸Ð½Ð°)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Sowi (ÐÐ¾ÑÐµÐ¹ÑÐºÐ°Ñ ÐÐ°ÑÐ¾Ð´Ð½Ð¾-ÐÐµÐ¼Ð¾ÐºÑÐ°ÑÐ¸ÑÐµÑÐºÐ°Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ°)"</para><para>"Sowi (Corea del Nord)"</para><para>"Sowi (Coreia do Norte)"</para><para>"Sowi (Corée du Nord)"</para><para>"Sowi (Nordkorea)"</para><para>"Sowi (North Korea)"</para><para>"Sowi (Noord-Korea)"</para><para>"Sowi (Korea PÃ³Ånocna)"</para><para>"Sowi (Corea del Norte)"</para><para>"Sowi (Nord-Korea)"</para><para>"Sowi (Korean demokraattinen kansantasavalta)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Sowi (Zuid-Korea)"</para><para>"Sowi (Sydkorea)"</para><para>"Sowi (Coreia do Sul)"</para><para>"Sowi (Südkorea)"</para><para>"Sowi (South Korea)"</para><para>"Sowi (Korean tasavalta)"</para><para>"Sowi (Sør-Korea)"</para><para>"Sowi (Korea PoÅudniowa)"</para><para>"Sowi (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° ÐÐ¾ÑÐµÑ)"</para><para>"Sowi (Corée du Sud)"</para><para>"Sowi (Corea del Sur)"</para><para>"Sowi (Corea del Sud)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Staabikapten (Estland)"</para><para>"Staabikapten (Estonia)"</para><para>"Staabikapten (Ð­ÑÑÐ¾Ð½Ð¸Ñ)"</para><para>"Staabikapten (Estónia)"</para><para>"Staabikapten (Viro)"</para><para>"Staabikapten (Estonie)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Sztabskapitan"</para><para>"Stabskapitän"</para><para>"Ð¨ÑÐ°Ð±Ñ-ÐºÐ°Ð¿Ð¸ÑÐ°Ð½"</para><para>"Alikapteeni"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Alikapteeni (Germany)"</para><para>"Stabskapitän (Germany)"</para><para>"Sztabskapitan (Germany)"</para><para>"Ð¨ÑÐ°Ð±Ñ-ÐºÐ°Ð¿Ð¸ÑÐ°Ð½ (Germany)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Stabskapitän (Rusia)"</para><para>"Stabskapitän (Rusland)"</para><para>"Sztabskapitan (Rosja)"</para><para>"Alikapteeni (Venäjä)"</para><para>"Stabskapitän (Rússia)"</para><para>"Stabskapitän (Russland)"</para><para>"Stabskapitän (Russie)"</para><para>"Ð¨ÑÐ°Ð±Ñ-ÐºÐ°Ð¿Ð¸ÑÐ°Ð½ (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Stabskapitän (Russia)"</para><para>"Stabskapitän (Ryssland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Sztabskapitan (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Ð¨ÑÐ°Ð±Ñ-ÐºÐ°Ð¿Ð¸ÑÐ°Ð½ (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Stabskapitän (Unión Soviética)"</para><para>"Stabskapitän (Unione Sovietica)"</para><para>"Stabskapitän (Soviet Union)"</para><para>"Stabskapitän (Sovjetunionen)"</para><para>"Stabskapitän (União Soviética)"</para><para>"Alikapteeni (Neuvostoliitto)"</para><para>"Stabskapitän (Sowjetunion)"</para><para>"Stabskapitän (Union des républiques socialistes soviétiques)"</para><para>"Stabskapitän (Sovjet-Unie)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Stabskapitänleutnant (Germany)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Staff Corporal (Écosse)"</para><para>"Staff Corporal (Skottland)"</para><para>"Staff Corporal (Escocia)"</para><para>"Staff Corporal (Szkocja)"</para><para>"Staff Corporal (Schotland)"</para><para>"Staff Corporal (Scozia)"</para><para>"Staff Corporal (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Staff Corporal (Escócia)"</para><para>"Staff Corporal (Scotland)"</para><para>"Staff Corporal (Schottland)"</para><para>"Staff Corporal (Skotlanti)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Staff Corporal (Ð£ÑÐ»ÑÑ)"</para><para>"Staff Corporal (Wales)"</para><para>"Staff Corporal (Pays de Galles)"</para><para>"Staff Corporal (Galles)"</para><para>"Staff Corporal (Walia)"</para><para>"Staff Corporal (País de Gales)"</para><para>"Staff Corporal (Gales)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Staff Sergeant Major (Wales)"</para><para>"Staff Sergeant Major (Galles)"</para><para>"Staff Sergeant Major (Pays de Galles)"</para><para>"Staff Sergeant Major (Walia)"</para><para>"Staff Sergeant Major (Gales)"</para><para>"Staff Sergeant Major (País de Gales)"</para><para>"Staff Sergeant Major (Ð£ÑÐ»ÑÑ)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Staff sergeant (Australien)"</para><para>"Staff sergeant (Australia)"</para><para>"Staff sergeant (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Staff sergeant (Australie)"</para><para>"Staff sergeant (Austrália)"</para><para>"Staff sergeant (Australië (land))"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Staff sergeant (Wspólnota Narodów)"</para><para>"Staff sergeant (Commonwealth)"</para><para>"Staff sergeant (Mancomunidad de Naciones)"</para><para>"Staff sergeant (Commonwealth of Nations)"</para><para>"Staff sergeant (Gemenebest van Naties)"</para><para>"Staff sergeant (Samväldet)"</para><para>"Staff sergeant (Commonwealth delle nazioni)"</para><para>"Staff sergeant (Samveldet av nasjoner)"</para><para>"Staff sergeant (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Staff sergeant (Kansainyhteisö)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Staff sergeant (Singapore)"</para><para>"Staff sergeant (Singapura)"</para><para>"Staff sergeant (Ð¡Ð¸Ð½Ð³Ð°Ð¿ÑÑ)"</para><para>"Staff sergeant (Singapour)"</para><para>"Staff sergeant (Singapur)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Starshiná"</para><para>"Starshina"</para><para>"Ð¡ÑÐ°ÑÑÐ¸Ð½Ð°"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Starshina (Russland)"</para><para>"Starshina (Russia)"</para><para>"Starshiná (Rusia)"</para><para>"Starshina (Rosja)"</para><para>"Starshina (Venäjä)"</para><para>"Starshina (Rússia)"</para><para>"Ð¡ÑÐ°ÑÑÐ¸Ð½Ð° (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Starshina (Rusland)"</para><para>"Starshina (Ryssland)"</para><para>"Starshina (Russie)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Starshina (Sovjetunionen)"</para><para>"Starshina (Union des républiques socialistes soviétiques)"</para><para>"Starshina (Sowjetunion)"</para><para>"Starshina (União Soviética)"</para><para>"Starshina (Neuvostoliitto)"</para><para>"Starshina (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Starshina (Soviet Union)"</para><para>"Ð¡ÑÐ°ÑÑÐ¸Ð½Ð° (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Starshina (Sovjet-Unie)"</para><para>"Starshina (Unione Sovietica)"</para><para>"Starshiná (Unión Soviética)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Starshina (Ukraine)"</para><para>"Starshina (Ukraina)"</para><para>"Starshina (Ucraina)"</para><para>"Starshiná (Ucrania)"</para><para>"Starshina (Oekraïne)"</para><para>"Starshina (Ucrânia)"</para><para>"Ð¡ÑÐ°ÑÑÐ¸Ð½Ð° (Ð£ÐºÑÐ°Ð¸Ð½Ð°)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Stratarches (Bysantin valtakunta)"</para><para>"Stratarches (Byzantijnse Rijk)"</para><para>"Stratarches (Bysantinska riket)"</para><para>"Stratarches (Byzantinisches Reich)"</para><para>"Stratarches (Império Bizantino)"</para><para>"Stratarches (Cesarstwo BizantyÅskie)"</para><para>"Stratarches (Imperio bizantino)"</para><para>"Stratarches (Empire byzantin)"</para><para>"Stratarches (ÐÐ¸Ð·Ð°Ð½ÑÐ¸Ð¹ÑÐºÐ°Ñ Ð¸Ð¼Ð¿ÐµÑÐ¸Ñ)"</para><para>"Stratarches (Byzantine Empire)"</para><para>"Stratarches (Impero bizantino)"</para><para>"Stratarches (Østromerriket)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Stratarches (ÐÑÐµÑÐ¸Ñ)"</para><para>"Stratarches (Griekenland)"</para><para>"Stratarches (Grecia)"</para><para>"Stratarches (Griechenland)"</para><para>"Stratarches (Greece)"</para><para>"Stratarches (Grecja)"</para><para>"Stratarches (Grèce)"</para><para>"Stratarches (Kreikka)"</para><para>"Stratarches (Grécia)"</para><para>"Stratarches (Hellas)"</para><para>"Stratarches (Grekland)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Strategos"</para><para>"Strateg (Grecja)"</para><para>"Stratège"</para><para>"Ð¡ÑÑÐ°ÑÐµÐ³"</para><para>"Estratego"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Strategos (Achaiska förbundet)"</para><para>"Stratège (Ligue achéenne)"</para><para>"Strategos (Lega achea)"</para><para>"Strategos (Liga Aquea)"</para><para>"Strategos (Akhaian liitto)"</para><para>"Strategos (Achaeïsche Bond)"</para><para>"Estratego (Liga Aqueia)"</para><para>"Strategos (Det akhaiske forbund)"</para><para>"Strategos (Achaiischer Bund)"</para><para>"Strateg (Grecja) (ZwiÄzek Achajski)"</para><para>"Ð¡ÑÑÐ°ÑÐµÐ³ (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para><para>"Strategos (Achaean League)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Stratège (Empire byzantin)"</para><para>"Strategos (Østromerriket)"</para><para>"Strategos (Byzantine Empire)"</para><para>"Strateg (Grecja) (Cesarstwo BizantyÅskie)"</para><para>"Strategos (Byzantinisches Reich)"</para><para>"Estratego (Império Bizantino)"</para><para>"Strategos (Bysantinska riket)"</para><para>"Strategos (Bysantin valtakunta)"</para><para>"Strategos (Byzantijnse Rijk)"</para><para>"Strategos (Imperio bizantino)"</para><para>"Ð¡ÑÑÐ°ÑÐµÐ³ (ÐÐ¸Ð·Ð°Ð½ÑÐ¸Ð¹ÑÐºÐ°Ñ Ð¸Ð¼Ð¿ÐµÑÐ¸Ñ)"</para><para>"Strategos (Impero bizantino)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Strategos (Griekenland)"</para><para>"Strategos (Hellas)"</para><para>"Strategos (Grekland)"</para><para>"Strategos (Grecia)"</para><para>"Ð¡ÑÑÐ°ÑÐµÐ³ (ÐÑÐµÑÐ¸Ñ)"</para><para>"Strategos (Kreikka)"</para><para>"Strategos (Greece)"</para><para>"Stratège (Grèce)"</para><para>"Strateg (Grecja) (Grecja)"</para><para>"Estratego (Grécia)"</para><para>"Strategos (Griechenland)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Strateg (Grecja) (StaroÅ¼ytna Macedonia)"</para><para>"Strategos (Makedonian valtakunta)"</para><para>"Strategos (Macedonia (ancient kingdom))"</para><para>"Strategos (Reino de Macedonia)"</para><para>"Strategos (Regno di Macedonia)"</para><para>"Strategos (Macedonië (oudheid))"</para><para>"Stratège (Royaume de Macédoine)"</para><para>"Ð¡ÑÑÐ°ÑÐµÐ³ (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para><para>"Estratego (Macedónia Antiga)"</para><para>"Strategos (Oldtidens Makedonia)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Strateg (Grecja) (Timocracy of Sapinetia)"</para><para>"Strategos (Timocracy of Sapinetia)"</para><para>"Estratego (Timocracy of Sapinetia)"</para><para>"Stratège (Timocracy of Sapinetia)"</para><para>"Ð¡ÑÑÐ°ÑÐµÐ³ (Timocracy of Sapinetia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Strategos autokrator (Bysantinska riket)"</para><para>"Strategos autokrator (Byzantinisches Reich)"</para><para>"Strategos autokrator (Imperio bizantino)"</para><para>"Strategos autokrator (ÐÐ¸Ð·Ð°Ð½ÑÐ¸Ð¹ÑÐºÐ°Ñ Ð¸Ð¼Ð¿ÐµÑÐ¸Ñ)"</para><para>"Strategos autokrator (Byzantine Empire)"</para><para>"Strategos autokrator (Byzantijnse Rijk)"</para><para>"Strategos autokrator (Império Bizantino)"</para><para>"Strategos autokrator (Impero bizantino)"</para><para>"Strategos autokrator (Østromerriket)"</para><para>"Strategos autokrator (Bysantin valtakunta)"</para><para>"Strategos autokrator (Empire byzantin)"</para><para>"Strategos autokrator (Cesarstwo BizantyÅskie)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Subalternofficer"</para><para>"Subalternoffiser"</para><para>"Ð¡ÑÐ±Ð°Ð»ÑÐµÑÐ½-Ð¾ÑÐ¸ÑÐµÑ"</para><para>"Subaltern"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Subalternoffiser (England)"</para><para>"Ð¡ÑÐ±Ð°Ð»ÑÐµÑÐ½-Ð¾ÑÐ¸ÑÐµÑ (England)"</para><para>"Subalternofficer (England)"</para><para>"Subaltern (England)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Subaltern (Szkocja)"</para><para>"Subaltern (Scozia)"</para><para>"Subaltern (Schotland)"</para><para>"Subalternoffiser (Skottland)"</para><para>"Subaltern (Scotland)"</para><para>"Subalternofficer (Skottland)"</para><para>"Subaltern (Skotlanti)"</para><para>"Subaltern (Schottland)"</para><para>"Ð¡ÑÐ±Ð°Ð»ÑÐµÑÐ½-Ð¾ÑÐ¸ÑÐµÑ (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Subaltern (Escócia)"</para><para>"Subaltern (Écosse)"</para><para>"Subaltern (Escocia)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Subaltern (Wales)"</para><para>"Subaltern (Pays de Galles)"</para><para>"Subalternoffiser (Wales)"</para><para>"Subalternofficer (Wales)"</para><para>"Subaltern (Galles)"</para><para>"Subaltern (País de Gales)"</para><para>"Subaltern (Walia)"</para><para>"Subaltern (Gales)"</para><para>"Ð¡ÑÐ±Ð°Ð»ÑÐµÑÐ½-Ð¾ÑÐ¸ÑÐµÑ (Ð£ÑÐ»ÑÑ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"SubaÅi (HetmaÅszczyzna)"</para><para>"SubaÅi (ÐÐµÑÐ¼Ð°Ð½ÑÐ¸Ð½Ð°)"</para><para>"SubaÅi (Hetmanato cosaco)"</para><para>"SubaÅi (Hetmanat)"</para><para>"SubaÅi (Cossack Hetmanate)"</para><para>"SubaÅi (Hetmanat cosaque)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"SubaÅi (ImpÃ©rio Otomano)"</para><para>"SubaÅi (Imperium osmaÅskie)"</para><para>"SubaÅi (Impero ottomano)"</para><para>"SubaÅi (Ottomaanse Rijk)"</para><para>"SubaÅi (Det osmanske rike)"</para><para>"SubaÅi (Osmanska riket)"</para><para>"SubaÅi (Osmanisches Reich)"</para><para>"SubaÅi (ÐÑÐ¼Ð°Ð½ÑÐºÐ°Ñ Ð¸Ð¼Ð¿ÐµÑÐ¸Ñ)"</para><para>"SubaÅi (Osmanien valtakunta)"</para><para>"SubaÅi (Empire ottoman)"</para><para>"SubaÅi (Ottoman Empire)"</para><para>"SubaÅi (Imperio otomano)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"SubaÅi (RÃ©publique des Sept-Ãles)"</para><para>"SubaÅi (RepÃºblica de las Islas JÃ³nicas)"</para><para>"SubaÅi (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° Ð¡ÐµÐ¼Ð¸ ÐÑÑÑÐ¾Ð²Ð¾Ð²)"</para><para>"SubaÅi (Septinsular Republic)"</para><para>"SubaÅi (Republiek van de Zeven Eilanden)"</para><para>"SubaÅi (Republika Siedmiu Wysp)"</para><para>"SubaÅi (Repubblica delle Sette Isole Unite)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Syntagmatarchis (Liga Aqueia)"</para><para>"Syntagmatarchis (Akhaian liitto)"</para><para>"Syntagmatarchis (Ligue achéenne)"</para><para>"Syntagmatarchis (Det akhaiske forbund)"</para><para>"Syntagmatarchis (Achaiischer Bund)"</para><para>"Syntagmatarchis (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para><para>"Syntagmatarchis (Achaiska förbundet)"</para><para>"Syntagmatarchis (Liga Aquea)"</para><para>"Syntagmatarchis (ZwiÄzek Achajski)"</para><para>"Syntagmatarchis (Achaeïsche Bond)"</para><para>"Syntagmatarchis (Lega achea)"</para><para>"Syntagmatarchis (Achaean League)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Syntagmatarchis (Grèce)"</para><para>"Syntagmatarchis (Hellas)"</para><para>"Syntagmatarchis (Greece)"</para><para>"Syntagmatarchis (Kreikka)"</para><para>"Syntagmatarchis (Griekenland)"</para><para>"Syntagmatarchis (ÐÑÐµÑÐ¸Ñ)"</para><para>"Syntagmatarchis (Grecia)"</para><para>"Syntagmatarchis (Grecja)"</para><para>"Syntagmatarchis (Grécia)"</para><para>"Syntagmatarchis (Griechenland)"</para><para>"Syntagmatarchis (Grekland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Syntagmatarchis (Makedonian valtakunta)"</para><para>"Syntagmatarchis (Royaume de Macédoine)"</para><para>"Syntagmatarchis (Macedonië (oudheid))"</para><para>"Syntagmatarchis (Oldtidens Makedonia)"</para><para>"Syntagmatarchis (Macedónia Antiga)"</para><para>"Syntagmatarchis (Macedonia (ancient kingdom))"</para><para>"Syntagmatarchis (Regno di Macedonia)"</para><para>"Syntagmatarchis (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para><para>"Syntagmatarchis (Reino de Macedonia)"</para><para>"Syntagmatarchis (StaroÅ¼ytna Macedonia)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Tagmatarchis (Achaiischer Bund)"</para><para>"Tagmatarchis (Achaeïsche Bond)"</para><para>"Tagmatarchis (Liga Aquea)"</para><para>"Tagmatarchis (Lega achea)"</para><para>"Tagmatarchis (Akhaian liitto)"</para><para>"Tagmatarchis (Ligue achéenne)"</para><para>"Tagmatarchis (Achaean League)"</para><para>"Tagmatarchis (ZwiÄzek Achajski)"</para><para>"Tagmatarchis (Achaiska förbundet)"</para><para>"Tagmatarchis (Liga Aqueia)"</para><para>"Tagmatarchis (Det akhaiske forbund)"</para><para>"Tagmatarchis (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Tagmatarchis (Grekland)"</para><para>"Tagmatarchis (Greece)"</para><para>"Tagmatarchis (Grecia)"</para><para>"Tagmatarchis (Kreikka)"</para><para>"Tagmatarchis (Grecja)"</para><para>"Tagmatarchis (Hellas)"</para><para>"Tagmatarchis (Grèce)"</para><para>"Tagmatarchis (Griechenland)"</para><para>"Tagmatarchis (Griekenland)"</para><para>"Tagmatarchis (Grécia)"</para><para>"Tagmatarchis (ÐÑÐµÑÐ¸Ñ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Tagmatarchis (Regno di Macedonia)"</para><para>"Tagmatarchis (Oldtidens Makedonia)"</para><para>"Tagmatarchis (StaroÅ¼ytna Macedonia)"</para><para>"Tagmatarchis (Macedonië (oudheid))"</para><para>"Tagmatarchis (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para><para>"Tagmatarchis (Macedonia (ancient kingdom))"</para><para>"Tagmatarchis (Makedonian valtakunta)"</para><para>"Tagmatarchis (Royaume de Macédoine)"</para><para>"Tagmatarchis (Macedónia Antiga)"</para><para>"Tagmatarchis (Reino de Macedonia)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Taxiarch (Ligue achéenne)"</para><para>"Taxiarch (Achaiischer Bund)"</para><para>"Taxiarch (Achaiska förbundet)"</para><para>"Taxiarch (Liga Aquea)"</para><para>"Taxiarch (ZwiÄzek Achajski)"</para><para>"Taxiarch (Det akhaiske forbund)"</para><para>"Taxiarch (Akhaian liitto)"</para><para>"Taxiarch (Achaeïsche Bond)"</para><para>"Taxiarch (Liga Aqueia)"</para><para>"Taxiarch (Achaean League)"</para><para>"Taxiarch (Lega achea)"</para><para>"Ð¢Ð°ÐºÑÐ¸Ð°ÑÑ (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Taxiarch (Cesarstwo BizantyÅskie)"</para><para>"Taxiarch (Byzantinisches Reich)"</para><para>"Taxiarch (Østromerriket)"</para><para>"Taxiarch (Empire byzantin)"</para><para>"Taxiarch (Bysantin valtakunta)"</para><para>"Taxiarch (Byzantijnse Rijk)"</para><para>"Ð¢Ð°ÐºÑÐ¸Ð°ÑÑ (ÐÐ¸Ð·Ð°Ð½ÑÐ¸Ð¹ÑÐºÐ°Ñ Ð¸Ð¼Ð¿ÐµÑÐ¸Ñ)"</para><para>"Taxiarch (Impero bizantino)"</para><para>"Taxiarch (Império Bizantino)"</para><para>"Taxiarch (Bysantinska riket)"</para><para>"Taxiarch (Imperio bizantino)"</para><para>"Taxiarch (Byzantine Empire)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Taxiarch (Grecia)"</para><para>"Taxiarch (Greece)"</para><para>"Taxiarch (Grèce)"</para><para>"Taxiarch (Grekland)"</para><para>"Ð¢Ð°ÐºÑÐ¸Ð°ÑÑ (ÐÑÐµÑÐ¸Ñ)"</para><para>"Taxiarch (Grecja)"</para><para>"Taxiarch (Griechenland)"</para><para>"Taxiarch (Griekenland)"</para><para>"Taxiarch (Grécia)"</para><para>"Taxiarch (Kreikka)"</para><para>"Taxiarch (Hellas)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Taxiarch (StaroÅ¼ytna Macedonia)"</para><para>"Taxiarch (Royaume de Macédoine)"</para><para>"Taxiarch (Macedonia (ancient kingdom))"</para><para>"Taxiarch (Oldtidens Makedonia)"</para><para>"Taxiarch (Macedónia Antiga)"</para><para>"Ð¢Ð°ÐºÑÐ¸Ð°ÑÑ (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para><para>"Taxiarch (Makedonian valtakunta)"</para><para>"Taxiarch (Regno di Macedonia)"</para><para>"Taxiarch (Macedonië (oudheid))"</para><para>"Taxiarch (Reino de Macedonia)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Taxiarch (Timocracy of Sapinetia)"</para><para>"Ð¢Ð°ÐºÑÐ¸Ð°ÑÑ (Timocracy of Sapinetia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Ð¢ÐµÑÑÐ°ÑÑ (Ð·Ð½Ð°ÑÐµÐ½Ð¸Ñ)"</para><para>"Tetrarch"</para><para>"Tetrarkki"</para><para>"Tetrark"</para><para>"Tetrarca"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Tetrarca (Liga Aqueia)"</para><para>"Ð¢ÐµÑÑÐ°ÑÑ (Ð·Ð½Ð°ÑÐµÐ½Ð¸Ñ) (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para><para>"Tetrarch (Achaeïsche Bond)"</para><para>"Tetrarch (Achaean League)"</para><para>"Tetrarch (Det akhaiske forbund)"</para><para>"Tetrarch (Ligue achéenne)"</para><para>"Tetrarkki (Akhaian liitto)"</para><para>"Tetrarch (ZwiÄzek Achajski)"</para><para>"Tetrarch (Achaiischer Bund)"</para><para>"Tetrarch (Liga Aquea)"</para><para>"Tetrarch (Lega achea)"</para><para>"Tetrark (Achaiska förbundet)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Tetrarca (Macedónia Antiga)"</para><para>"Ð¢ÐµÑÑÐ°ÑÑ (Ð·Ð½Ð°ÑÐµÐ½Ð¸Ñ) (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para><para>"Tetrarch (Macedonia (ancient kingdom))"</para><para>"Tetrarch (Regno di Macedonia)"</para><para>"Tetrarch (Reino de Macedonia)"</para><para>"Tetrarkki (Makedonian valtakunta)"</para><para>"Tetrarch (Macedonië (oudheid))"</para><para>"Tetrark (Macedonia (ancient kingdom))"</para><para>"Tetrarch (StaroÅ¼ytna Macedonia)"</para><para>"Tetrarch (Royaume de Macédoine)"</para><para>"Tetrarch (Oldtidens Makedonia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Trierarchie"</para><para>"Trierark"</para><para>"Triérarchie"</para><para>"Ð¢ÑÐ¸ÐµÑÐ°ÑÑÐ¸Ñ"</para><para>"Trierarca"</para><para>"Trierarch"</para><para>"Trierarchia"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Trierarca (Liga Aquea)"</para><para>"Trierarch (Akhaian liitto)"</para><para>"Trierark (Det akhaiske forbund)"</para><para>"Trierarchie (Achaiischer Bund)"</para><para>"Trierarch (Achaeïsche Bond)"</para><para>"Trierarch (Achaiska förbundet)"</para><para>"Trierarchia (Lega achea)"</para><para>"Ð¢ÑÐ¸ÐµÑÐ°ÑÑÐ¸Ñ (ÐÑÐµÐ¹ÑÐºÐ¸Ð¹ ÑÐ¾ÑÐ·)"</para><para>"Trierarch (Achaean League)"</para><para>"Trierarch (Liga Aqueia)"</para><para>"Trierarch (ZwiÄzek Achajski)"</para><para>"Triérarchie (Ligue achéenne)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Trierarch (StaroÅ¼ytna Macedonia)"</para><para>"Trierarch (Macedónia Antiga)"</para><para>"Trierark (Oldtidens Makedonia)"</para><para>"Trierarch (Macedonia (ancient kingdom))"</para><para>"Ð¢ÑÐ¸ÐµÑÐ°ÑÑÐ¸Ñ (ÐÑÐµÐ²Ð½ÑÑ ÐÐ°ÐºÐµÐ´Ð¾Ð½Ð¸Ñ)"</para><para>"Trierarchie (Macedonia (ancient kingdom))"</para><para>"Trierarca (Reino de Macedonia)"</para><para>"Triérarchie (Royaume de Macédoine)"</para><para>"Trierarch (Macedonië (oudheid))"</para><para>"Trierarchia (Regno di Macedonia)"</para><para>"Trierarch (Makedonian valtakunta)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Trooper (rank) (Australie)"</para><para>"Trooper (rank) (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Trooper (rank) (Australia)"</para><para>"Trooper (rank) (Austrália)"</para><para>"Trooper (rank) (Australië (land))"</para><para>"Trooper (rank) (Australien)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Trooper (rank) (Commonwealth of Nations)"</para><para>"Trooper (rank) (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Trooper (rank) (Samväldet)"</para><para>"Trooper (rank) (Wspólnota Narodów)"</para><para>"Trooper (rank) (Kansainyhteisö)"</para><para>"Trooper (rank) (Gemenebest van Naties)"</para><para>"Trooper (rank) (Commonwealth)"</para><para>"Trooper (rank) (Commonwealth delle nazioni)"</para><para>"Trooper (rank) (Mancomunidad de Naciones)"</para><para>"Trooper (rank) (Samveldet av nasjoner)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Trumpet Major (Wales)"</para><para>"Trumpet Major (Ð£ÑÐ»ÑÑ)"</para><para>"Trumpet Major (País de Gales)"</para><para>"Trumpet Major (Pays de Galles)"</para><para>"Trumpet Major (Walia)"</para><para>"Trumpet Major (Galles)"</para><para>"Trumpet Major (Gales)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Tysjatski"</para><para>"Tysjackij"</para><para>"Ð¢ÑÑÑÑÐºÐ¸Ð¹"</para><para>"Tysyatsky"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Tysyatsky (Venäjä)"</para><para>"Ð¢ÑÑÑÑÐºÐ¸Ð¹ (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Tysyatsky (Rusia)"</para><para>"Tysjatski (Rusland)"</para><para>"Tysyatsky (Rosja)"</para><para>"Tysyatsky (Russie)"</para><para>"Tysjackij (Russia)"</para><para>"Tysyatsky (Russland)"</para><para>"Tysyatsky (Russia)"</para><para>"Tysyatsky (Rússia)"</para><para>"Tysyatsky (Ryssland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Tysyatsky (Unión Soviética)"</para><para>"Tysyatsky (Neuvostoliitto)"</para><para>"Tysyatsky (Sovjetunionen)"</para><para>"Tysyatsky (Sowjetunion)"</para><para>"Ð¢ÑÑÑÑÐºÐ¸Ð¹ (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Tysyatsky (Soviet Union)"</para><para>"Tysjatski (Sovjet-Unie)"</para><para>"Tysyatsky (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Tysyatsky (União Soviética)"</para><para>"Tysyatsky (Union des républiques socialistes soviétiques)"</para><para>"Tysjackij (Unione Sovietica)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Under Officer (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Under Officer (Australië (land))"</para><para>"Under Officer (Australia)"</para><para>"Under Officer (Australien)"</para><para>"Under Officer (Australie)"</para><para>"Under Officer (Austrália)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Under Officer (Kansainyhteisö)"</para><para>"Under Officer (Mancomunidad de Naciones)"</para><para>"Under Officer (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Under Officer (Samveldet av nasjoner)"</para><para>"Under Officer (Commonwealth)"</para><para>"Under Officer (Samväldet)"</para><para>"Under Officer (Commonwealth delle nazioni)"</para><para>"Under Officer (Gemenebest van Naties)"</para><para>"Under Officer (Commonwealth of Nations)"</para><para>"Under Officer (Wspólnota Narodów)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Under Officer (Écosse)"</para><para>"Under Officer (Schottland)"</para><para>"Under Officer (Skotlanti)"</para><para>"Under Officer (Szkocja)"</para><para>"Under Officer (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Under Officer (Scotland)"</para><para>"Under Officer (Scozia)"</para><para>"Under Officer (Skottland)"</para><para>"Under Officer (Escocia)"</para><para>"Under Officer (Schotland)"</para><para>"Under Officer (Escócia)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Under Officer (País de Gales)"</para><para>"Under Officer (Gales)"</para><para>"Under Officer (Wales)"</para><para>"Under Officer (Ð£ÑÐ»ÑÑ)"</para><para>"Under Officer (Walia)"</para><para>"Under Officer (Galles)"</para><para>"Under Officer (Pays de Galles)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Vääpeli (Finland)"</para><para>"VÃ¤Ã¤peli (Ð¤Ð¸Ð½Ð»ÑÐ½Ð´Ð¸Ñ)"</para><para>"Vääpeli (Finlandia)"</para><para>"Vääpeli (Finlândia)"</para><para>"Vääpeli (Finnland)"</para><para>"Vääpeli (Finlande)"</para><para>"Vääpeli (Suomi)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"VÃ¤Ã¤peli (Ð¨Ð²ÐµÑÐ¸Ñ)"</para><para>"Vääpeli (Sweden)"</para><para>"Vääpeli (Sverige)"</para><para>"Vääpeli (Zweden)"</para><para>"Vääpeli (Szwecja)"</para><para>"Vääpeli (Suède)"</para><para>"Vääpeli (Suecia)"</para><para>"Vääpeli (Suécia)"</para><para>"Vääpeli (Svezia)"</para><para>"Vääpeli (Ruotsi)"</para><para>"Vääpeli (Schweden)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Veebel (Estonia)"</para><para>"Veebel (Viro)"</para><para>"Veebel (Estónia)"</para><para>"Veebel (Ð­ÑÑÐ¾Ð½Ð¸Ñ)"</para><para>"Veebel (Estland)"</para><para>"Veebel (Estonie)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Vice-Admiral of the Coast (Szkocja)"</para><para>"Vice-Admiral of the Coast (Schottland)"</para><para>"Vice-Admiral of the Coast (Skottland)"</para><para>"Vice-Admiral of the Coast (Écosse)"</para><para>"Vice-Admiral of the Coast (Scozia)"</para><para>"Vice-Admiral of the Coast (Escócia)"</para><para>"Vice-Admiral of the Coast (Scotland)"</para><para>"Vice-Admiral of the Coast (Schotland)"</para><para>"Vice-Admiral of the Coast (Escocia)"</para><para>"Vice-Admiral of the Coast (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Vice-Admiral of the Coast (Skotlanti)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Vice-Admiral of the Coast (Pays de Galles)"</para><para>"Vice-Admiral of the Coast (Wales)"</para><para>"Vice-Admiral of the Coast (País de Gales)"</para><para>"Vice-Admiral of the Coast (Ð£ÑÐ»ÑÑ)"</para><para>"Vice-Admiral of the Coast (Walia)"</para><para>"Vice-Admiral of the Coast (Gales)"</para><para>"Vice-Admiral of the Coast (Galles)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Vice-Admiral of the West (Escocia)"</para><para>"Vice-Admiral of the West (Écosse)"</para><para>"Vice-Admiral of the West (Schotland)"</para><para>"Vice-Admiral of the West (Skotlanti)"</para><para>"Vice-Admiral of the West (Szkocja)"</para><para>"Vice-Admiral of the West (Escócia)"</para><para>"Vice-Admiral of the West (Scotland)"</para><para>"Vice-Admiral of the West (Skottland)"</para><para>"Vice-Admiral of the West (Scozia)"</para><para>"Vice-Admiral of the West (Schottland)"</para><para>"Vice-Admiral of the West (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Vice-Admiral of the West (País de Gales)"</para><para>"Vice-Admiral of the West (Wales)"</para><para>"Vice-Admiral of the West (Walia)"</para><para>"Vice-Admiral of the West (Gales)"</para><para>"Vice-Admiral of the West (Galles)"</para><para>"Vice-Admiral of the West (Ð£ÑÐ»ÑÑ)"</para><para>"Vice-Admiral of the West (Pays de Galles)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Vice admiral (Austrália)"</para><para>"Vice admiral (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Vice admiral (Australie)"</para><para>"Vice admiral (Australia)"</para><para>"Vice admiral (Australien)"</para><para>"Vice admiral (Australië (land))"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Vice Admiral (Australien)"</para><para>"Vice Admiral (Australia)"</para><para>"Vice Admiral (Australie)"</para><para>"Vice Admiral (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Vice Admiral (Australië (land))"</para><para>"Vice Admiral (Austrália)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Wachtmeister"</para><para>"Wachmistrz"</para><para>"ÐÐ°ÑÐ¼Ð¸ÑÑÑ"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Wachtmeister (Germany)"</para><para>"ÐÐ°ÑÐ¼Ð¸ÑÑÑ (Germany)"</para><para>"Wachmistrz (Germany)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Wachtmeister (Rusia)"</para><para>"Wachmistrz (Rosja)"</para><para>"Wachtmeister (Russland)"</para><para>"Wachtmeister (Russia)"</para><para>"Wachtmeister (Rusland)"</para><para>"Wachtmeister (Ryssland)"</para><para>"ÐÐ°ÑÐ¼Ð¸ÑÑÑ (Ð Ð¾ÑÑÐ¸Ñ)"</para><para>"Wachtmeister (Russie)"</para><para>"Wachtmeister (Venäjä)"</para><para>"Wachtmeister (Rússia)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Wachtmeister (União Soviética)"</para><para>"Wachtmeister (Sovjet-Unie)"</para><para>"Wachtmeister (Neuvostoliitto)"</para><para>"Wachmistrz (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"ÐÐ°ÑÐ¼Ð¸ÑÑÑ (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Wachtmeister (Soviet Union)"</para><para>"Wachtmeister (Union des républiques socialistes soviétiques)"</para><para>"Wachtmeister (Sovjetunionen)"</para><para>"Wachtmeister (Unione Sovietica)"</para><para>"Wachtmeister (Unión Soviética)"</para><para>"Wachtmeister (Sowjetunion)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Warrant Officer (Australia)"</para><para>"Warrant Officer (Australien)"</para><para>"Warrant Officer (Austrália)"</para><para>"Warrant Officer (Australie)"</para><para>"Warrant Officer (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para><para>"Warrant Officer (Australië (land))"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Warrant Officer (Commonwealth delle nazioni)"</para><para>"Warrant Officer (Gemenebest van Naties)"</para><para>"Warrant Officer (Wspólnota Narodów)"</para><para>"Warrant Officer (Ð¡Ð¾Ð´ÑÑÐ¶ÐµÑÑÐ²Ð¾ Ð½Ð°ÑÐ¸Ð¹)"</para><para>"Warrant Officer (Commonwealth of Nations)"</para><para>"Warrant Officer (Commonwealth)"</para><para>"Warrant Officer (Mancomunidad de Naciones)"</para><para>"Warrant Officer (Kansainyhteisö)"</para><para>"Warrant Officer (Samveldet av nasjoner)"</para><para>"Warrant Officer (Samväldet)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Warrant Officer (Scotland)"</para><para>"Warrant Officer (Scozia)"</para><para>"Warrant Officer (Schottland)"</para><para>"Warrant Officer (Skottland)"</para><para>"Warrant Officer (Escocia)"</para><para>"Warrant Officer (Escócia)"</para><para>"Warrant Officer (Skotlanti)"</para><para>"Warrant Officer (Ð¨Ð¾ÑÐ»Ð°Ð½Ð´Ð¸Ñ)"</para><para>"Warrant Officer (Écosse)"</para><para>"Warrant Officer (Schotland)"</para><para>"Warrant Officer (Szkocja)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Warrant Officer (Galles)"</para><para>"Warrant Officer (Wales)"</para><para>"Warrant Officer (País de Gales)"</para><para>"Warrant Officer (Gales)"</para><para>"Warrant Officer (Walia)"</para><para>"Warrant Officer (Ð£ÑÐ»ÑÑ)"</para><para>"Warrant Officer (Pays de Galles)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Wing commander (rank) (Australien)"</para><para>"Wing commander (rank) (Australia)"</para><para>"Wing commander (rank) (Australië (land))"</para><para>"Wing commander (rank) (Australie)"</para><para>"Wing commander (rank) (Austrália)"</para><para>"Wing commander (rank) (ÐÐ²ÑÑÑÐ°Ð»Ð¸Ñ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Wojski"</para><para>"ÐÐ¾Ð¹ÑÐºÐ¸Ð¹"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"ÐÐ¾Ð¹ÑÐºÐ¸Ð¹ (ÐÐ¸ÑÐ²Ð°)"</para><para>"Wojski (Litauen)"</para><para>"Wojski (Liettua)"</para><para>"Wojski (Litwa)"</para><para>"Wojski (Lithuania)"</para><para>"Wojski (Litouwen)"</para><para>"Wojski (Lituânia)"</para><para>"Wojski (Lituania)"</para><para>"Wojski (Lituanie)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Wojski (Poland)"</para><para>"ÐÐ¾Ð¹ÑÐºÐ¸Ð¹ (Poland)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Wonsu (Noord-Korea)"</para><para>"ÐÐ¾Ð½ÑÑ (ÐÐ¾ÑÐµÐ¹ÑÐºÐ°Ñ ÐÐ°ÑÐ¾Ð´Ð½Ð¾-ÐÐµÐ¼Ð¾ÐºÑÐ°ÑÐ¸ÑÐµÑÐºÐ°Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ°)"</para><para>"Wonsu (Coreia do Norte)"</para><para>"Wonsu (Corea del Nord)"</para><para>"Wonsu (Korean demokraattinen kansantasavalta)"</para><para>"Wonsu (Corée du Nord)"</para><para>"Wonsu (North Korea)"</para><para>"Wonsu (Korea PÃ³Ånocna)"</para><para>"Wonsu (Nord-Korea)"</para><para>"Wonsu (Corea del Norte)"</para><para>"Wonsu (Nordkorea)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Wonsu (Sør-Korea)"</para><para>"Wonsu (Corea del Sur)"</para><para>"Wonsu (Sydkorea)"</para><para>"Wonsu (Corée du Sud)"</para><para>"Wonsu (Coreia do Sul)"</para><para>"Wonsu (Zuid-Korea)"</para><para>"Wonsu (South Korea)"</para><para>"Wonsu (Corea del Sud)"</para><para>"ÐÐ¾Ð½ÑÑ (Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸ÐºÐ° ÐÐ¾ÑÐµÑ)"</para><para>"Wonsu (Korea PoÅudniowa)"</para><para>"Wonsu (Korean tasavalta)"</para><para>"Wonsu (Südkorea)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"EsauÅ"</para><para>"ÐÑÐ°ÑÐ»"</para><para>"Jesaul"</para><para>"Jessaul"</para><para>"Yesaul"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"EsauÅ (Rosja)"</para><para>"Yesaul (Venäjä)"</para><para>"Yesaul (Russia)"</para><para>"Yesaul (Russie)"</para><para>"Yesaul (Rusia)"</para><para>"Jessaul (Russland)"</para><para>"Yesaul (Russland)"</para><para>"Yesaul (Rússia)"</para><para>"Yesaul (Rusland)"</para><para>"Jesaul (Ryssland)"</para><para>"ÐÑÐ°ÑÐ» (Ð Ð¾ÑÑÐ¸Ñ)"</para></remarks>
    ...
    ///   <para>mil:MilitaryRank</para>
    ///
    /// labels<para>"Yesaul (Sovjetunionen)"</para><para>"Yesaul (Neuvostoliitto)"</para><para>"Yesaul (Union des républiques socialistes soviétiques)"</para><para>"Yesaul (Soviet Union)"</para><para>"Jesaul (Sovjetunionen)"</para><para>"Yesaul (Unión Soviética)"</para><para>"ÐÑÐ°ÑÐ» (Ð¡Ð¾ÑÐ· Ð¡Ð¾Ð²ÐµÑÑÐºÐ¸Ñ Ð¡Ð¾ÑÐ¸Ð°Ð»Ð¸ÑÑÐ¸ÑÐµÑÐºÐ¸Ñ Ð ÐµÑÐ¿ÑÐ±Ð»Ð¸Ðº)"</para><para>"Yesaul (União Soviética)"</para><para>"Yesaul (Unione Sovietica)"</para><para>"EsauÅ (ZwiÄzek Socjalistycznych Republik Radzieckich)"</para><para>"Yesaul (Sovjet-Unie)"</para><para>"Jessaul (Sowjetunion)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Yesaul (Ucrânia)"</para><para>"Yesaul (Ukraina)"</para><para>"Yesaul (Ucraina)"</para><para>"ÐÑÐ°ÑÐ» (Ð£ÐºÑÐ°Ð¸Ð½Ð°)"</para><para>"Jesaul (Ukraina)"</para><para>"Yesaul (Ukraine)"</para><para>"Jessaul (Ukraine)"</para><para>"Yesaul (Oekraïne)"</para><para>"Yesaul (Ucrania)"</para><para>"EsauÅ (Ukraina)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Ypolochagos (Griekenland)"</para><para>"Ypolochagos (Griechenland)"</para><para>"Ypolochagos (ÐÑÐµÑÐ¸Ñ)"</para><para>"Ypolochagos (Greece)"</para><para>"Ypolochagos (Grecja)"</para><para>"Ypolochagos (Kreikka)"</para><para>"Ypolochagos (Grécia)"</para><para>"Ypolochagos (Hellas)"</para><para>"Ypolochagos (Grekland)"</para><para>"Ypolochagos (Grecia)"</para><para>"Ypolochagos (Grèce)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Regiment"</para><para>"Régiment"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>""</para><para>"Regimental Colours"</para><para>"Drapeau du Regiment"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"regulärer Soldat"</para><para>"Soldat Régulier"</para><para>"Regular Soldier"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Reservist (Soldat)"</para><para>"Reservist (Soldier)"</para><para>"Soldat Réserviste"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Matrose (Militär)"</para><para>"Seaman (Military)"</para><para>"Matelot (Militare)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Ship"</para><para>"Navire"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Ufer Gründung (Kriegsmarine)"</para><para>"Shore Establishment (Navy)"</para><para>"Etablishment de Terre (Marine)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Soldat"</para><para>"Soldier"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Schwadron"</para><para>"Squadron (unit)"</para><para>"Escadron"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Supply Train (Military)"</para><para>"liefern dem Zug (Militär)"</para><para>"Train D'alimentation (Military)"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Tactical Air Force"</para><para>"Luftstreitkräfte (taktisch)"</para><para>"Force Aérienne Tactique "</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"unprivilegierten Kämpfer"</para><para>"Combatant non-privilégié"</para><para>"Unprivileged Combatant"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Soldier (Volunteer)"</para><para>"Soldat (Volontaire)"</para><para>"Soldat (freiwilliger)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Théâtre militaire"</para><para>"Kriegsschauplatz"</para><para>"Theater (warfare)"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Warrant Officer"</para><para>"?"</para><para>"Officiers Mariniers"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Warship"</para><para>"Navire Militare"</para></remarks>
    ...
    ///   <para>skos:Concept</para>
    ///
    /// labels<para>"Waffe (Militär)"</para><para>"Arme (Military)"</para><para>"Weapon (Military)"</para></remarks>
