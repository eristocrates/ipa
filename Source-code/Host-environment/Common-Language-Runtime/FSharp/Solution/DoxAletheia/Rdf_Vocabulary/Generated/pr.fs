...
module pr =
    ...
    let PropertyReification = _prefix "PropertyReification"
    /// <summary>
    ...
    let object_property = _prefix "object_property"
    /// <summary>
    ...
    let reification_class = _prefix "reification_class"
    /// <summary>
    ...
    let shortcut_property = _prefix "shortcut_property"
    /// <summary>
    ...
    let subject_property = _prefix "subject_property"
