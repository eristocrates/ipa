...
module moat =
    ...
    /// labels<para>"Tag Meaning"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"Tag URI"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"tag meaning object - global context"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"local Meaning"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"tag meaning URI - global context"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"tag meaning - tagging context"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    /// labels<para>"tagging type"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://moat-project.org/ns#tagType">http://moat-project.org/ns#tagType</seealso>
    let tagType = Prefixed_Name(moat, "tagType") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"tagged with"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
