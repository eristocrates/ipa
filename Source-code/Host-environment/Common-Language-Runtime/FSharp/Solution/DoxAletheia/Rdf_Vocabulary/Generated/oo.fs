...
module oo =
    ...
    let NoLicenseDefined =
        Namespaced_IRI.parse _namespace_name "NoLicenseDefined" |> NamespacedName
    ...
    let OrganizationProfileDocument =
        Namespaced_IRI.parse _namespace_name "OrganizationProfileDocument" |> NamespacedName
    ...
    let contactForm =
        Namespaced_IRI.parse _namespace_name "contactForm" |> NamespacedName
    ...
    let corrections =
        Namespaced_IRI.parse _namespace_name "corrections" |> NamespacedName
    ...
    let mapIcon = Namespaced_IRI.parse _namespace_name "mapIcon" |> NamespacedName
    ...
    let primaryContact =
        Namespaced_IRI.parse _namespace_name "primaryContact" |> NamespacedName
    ...
    let twitterHashtag =
        Namespaced_IRI.parse _namespace_name "twitterHashtag" |> NamespacedName
