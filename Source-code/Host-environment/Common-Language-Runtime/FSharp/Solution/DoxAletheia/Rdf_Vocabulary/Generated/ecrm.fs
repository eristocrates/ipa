...
module ecrm =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Note for SAWS: this includes any human being, named or otherwise"</para>
    ///   <para>"Scope note:
    ...
    /// E21(x) ⊃ E20(x)
    /// E21(x) ⊃ E39(x)"</para>
    /// labels<para>"person"</para><para>"E21 Person"</para></remarks>
    ...
    /// E35(x) ⊃ E33(x)
    /// E35(x) ⊃ E41(x)"</para>
    /// labels<para>"title"</para><para>"E35 Title"</para></remarks>
    ...
    /// <summary>
    ///   <para>ecrm:E39.Actor</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://erlangen-crm.org/current/E39.Actor">http://erlangen-crm.org/current/E39.Actor</seealso>
    let ``E39.Actor`` = Prefixed_Name(ecrm, "E39.Actor") |> PrefixedName
    /// <summary>
    ...
    /// In First Order Logic:
    /// E39(x) ⊃ E77(x)"</para>
    ///   <para>"Note for SAWS: we can use Actor to refer to any living being (not necessarily a person, not necessarily still alive) who is identified/named/referred to within a linguistic object, though we may wish to use a more specific class such as Person, AttributedAuthor, Scribe etc."</para>
    /// labels<para>"E39 Actor"</para><para>"actor"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Note for SAWS: we can use Appellation to state a person’s name or other name of interest e.g. of a church"</para>
    ///   <para>"Scope note:
    ...
    /// In First Order Logic:
    /// E41(x) ⊃ E90(x)"</para>
    /// labels<para>"appellation"</para><para>"E41 Appellation"</para></remarks>
    ...
    /// <summary>
    ///   <para>ecrm:E5.Event</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://erlangen-crm.org/current/E5.Event">http://erlangen-crm.org/current/E5.Event</seealso>
    let ``E5.Event`` = Prefixed_Name(ecrm, "E5.Event") |> PrefixedName
    /// <summary>
    ...
    /// In First Order Logic:
    /// E51(x) ⊃ E41(x)"</para>
    /// labels<para>"contact point"</para><para>"E51 Contact Point"</para></remarks>
    ...
    /// In First Order Logic:
    /// E53(x) ⊃ E1(x)"</para>
    /// labels<para>"place"</para><para>"E53 Place"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"Note for SAWS: This represents language in which a material is written - this is put in the TEI header.
    ///
    /// NB in the TEI header we should use standards for languages, e.g. the more detailed ISO standards at http://www.loc.gov/standards/iso639-2/ , so use “http://id.loc.gov/vocabulary/iso639-2/grc” for Ancient Greek rather than “Greek”"</para>
    ///   <para>"Scope note:
    ...
    /// In First Order Logic:
    /// E56(x) ⊃ E55(x)"</para>
    /// labels<para>"E56 Language"</para><para>"language"</para></remarks>
    ...
    ///
    /// In First Order Logic:
    /// E92(x) ⊃ E1(x)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// In First Order Logic:
    /// E93(x) ⊃ E92(x)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// In First Order Logic:
    /// P150(x,y) ⊃ (E55 Type)
    /// P150(x,y) ⊃ E55(y)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// P151(x,y) ⊃ E66(x)
    /// P151(x,y) ⊃ E74(y)
    /// P151(x,y) ⊃ P11(x,y)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// In First Order Logic:
    /// P152(x,y) ⊃ E21(x)
    /// P152(x,y) ⊃ E21(y)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///
    /// In First Order Logic:
    /// P156 (x,y) = [E18(x) ∧ E53(y) ∧ P161(x,y) ∧ P157(y,x)]"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// In First Order Logic:
    /// P157(x,y) ⊃ E53(x)
    /// P157(x,y) ⊃ E18(y)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// In First Order Logic:
    /// P160(x,y) ⊃ E92(x)
    /// P160(x,y)⊃ E52(y)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// In First Order Logic:
    /// P161(x,y) ⊃ E92(x)
    /// P161(x,y) ⊃ E53(y)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// In First Order Logic:
    /// P164 (x,y) ⊃ E93(x)
    /// P164 (x,y) ⊃ E52(y)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// P165(x,y) ⊃ E73(x)
    /// P165(x,y) ⊃ E90(y)
    /// P165(x,y) ⊃ P106(x,y)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// In First Order Logic:
    /// P166(x,y) ⊃ E93(x)
    /// P166(x,y) ⊃ E92(y)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// In First Order Logic:
    /// P167(x,y) ⊃ E93(x)
    /// P167(x,y) ⊃ E53(y)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// In First Order Logic:
    /// P168(x,y) ⊃ E53(x)
    /// P168(x,y) ⊃ E94(y)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// P25(x,y) ⊃ E9(x)
    /// P25(x,y) ⊃ E19(y)
    /// P25(x,y) ⊃ P12(x,y)"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
