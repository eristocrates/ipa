...
module rec_ =
    ...
    ///   <para>"A ranked recommendation that includes an ordered list of recommendations."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ///   <para>"A ranked recommendation that includes an ordered list of recommendations."</para>
    /// labels<para>"Ranked Recommendation"</para><para>"Ranked Recommendation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>"A ranked recommendation object in a ranked recommendation."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"ranked recommendation object"</para><para>"ranked recommendation object"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>"Relates a recommendation to someone or something."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"has recommendation"</para><para>"recommendation"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://purl.org/ontology/rec/core#recommendation">http://purl.org/ontology/rec/core#recommendation</seealso>
    let recommendation = Prefixed_Name(rec_, "recommendation") |> PrefixedName
    ...
    ///   <para>"An agent, which provided/calculated this recommendation."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"has recommender"</para><para>"recommender"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
