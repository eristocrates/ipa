...
module aos =
    ...
    /// labels<para>Está causado por</para><para>Est causée par</para><para>Is caused by</para><para>вызывается</para><para>由...引起</para><para>هو سبب</para></remarks>
    ...
    /// labels<para>то, из чего состоит</para><para>تتكون Y من </para><para>Compose</para><para>Compone</para><para>Compose</para><para>组成</para></remarks>
    ...
    /// </para>
    /// labels<para>Está compuesto de</para><para>Est composé de</para><para>Is composed of</para><para>состоит из</para><para>يتكون من</para><para>由...组成</para></remarks>
    ...
    /// labels<para>включает</para><para>Comprend</para><para>Includes</para><para>Incluye</para><para>يشمل</para><para>包含</para></remarks>
    ...
    /// labels<para>Est réalisée au moyen de</para><para>Se consigue por medio de</para><para>Is achieved by means of</para><para>достигается с помощью</para><para>يتم تحقيقه عن طريق</para><para>通过…手段实现</para></remarks>
    ...
    /// labels<para>измеряет</para><para>Measures</para><para>س يقيس ص</para><para>Medidas</para><para>Mesure</para><para>测量</para></remarks>
    ...
    /// labels<para>является старым названием</para><para>Es nombre antiguo de</para><para>Est nom ancien de</para><para>هو الاسم القديم ل</para><para>Is old name of</para><para>是...的曾用名</para></remarks>
    ...
    /// </para>
    /// labels<para>У ... имеется вредитель ...</para><para>Tiene plaga</para><para>Has pest</para><para>لديه آفة</para><para>A peste</para><para>有有害生物</para></remarks>
    ...
    /// labels<para>Es una plaga de</para><para>Est peste de</para><para>Is a pest of</para><para>是...的有害生物</para><para>вредитель</para><para>هي الآفة</para></remarks>
    ...
    /// labels<para>Tiene el producto</para><para>имеет продукт</para><para>A le produit</para><para>Has product</para><para>لديه المنتج</para><para>有产品</para></remarks>
    ...
    /// labels<para>обладает свойством</para><para>Tiene propriedad</para><para>A la propriété</para><para>Has property</para><para>لديه ممتلكات</para><para>有属性</para></remarks>
    ...
    /// labels<para>Est le nom scientifique de</para><para>Es el nombre científico de</para><para>является научным названием</para><para>Scientific name of</para><para>هو الاسم العلمي ل</para><para>是...的学名</para></remarks>
    ...
    /// labels<para>هو رمز كيميائي لـ</para><para>Est le symbole de</para><para>Es símbolo de</para><para>Is symbol for</para><para>символ для</para><para>是...的符号</para></remarks>
    ...
    /// labels<para>является источником</para><para>Est source de</para><para>Es fuente de</para><para>Is source of</para><para>是...的来源</para><para>هو مصدر</para></remarks>
    ...
    /// labels<para>поражает</para><para>Afflicts</para><para>Afflige</para><para>لهجمات</para><para>Aflige</para><para>损伤</para></remarks>
    ...
    /// labels<para>está afligido por</para><para>تتأثر ... بـ ...</para><para>est affligé par</para><para>Is afflicted by</para><para>поражается</para><para>受...损伤</para></remarks>
    ...
    /// labels<para>Quantitative relationship</para><para>Relations quantitatives </para><para>количественные отношения</para><para>Relaciones cuantitativas</para><para>العلاقات الكمية</para><para>数量关系</para></remarks>
    ...
    /// labels<para>химеет синоним</para><para>Tiene sinónimo</para><para>A le synonyme</para><para>Has synonym</para><para>له مرادف</para><para>有同义词</para></remarks>
    ...
    /// </para>
    /// labels<para>Tiene nombre común del concepto</para><para>имеет обиходное название</para><para>Has common name concept</para><para>A nom commun de concept</para><para>له مفهوم الاسم الشائع</para><para>有常用名概念</para></remarks>
    ...
    /// labels<para>таксономические отношения</para><para>Taxonomic relationship</para><para>Relaciones taxonómicas</para><para>Relations taxonomiques</para><para>العلاقات التصنيفية</para><para>分类学关系</para></remarks>
    ...
    /// labels<para>يتم قياس x بواسطة y</para><para>Si mide mediante</para><para>Is measured by</para><para>Est mesuré par</para><para>измеряется</para><para>由...测量</para></remarks>
    ...
    /// labels<para>Est empêché par</para><para>Se previene con</para><para>предотвращается</para><para>Is prevented by</para><para>تم منعه بواسطة</para><para>由...防止</para></remarks>
    ...
    /// labels<para>предотвращает</para><para>Prévient</para><para>Prevents</para><para>Previene</para><para>يمنع</para><para>防止</para></remarks>
    ...
    /// labels<para>производит</para><para>ينتج عنه</para><para>Produces</para><para>Produit</para><para>Produce</para><para>生产</para></remarks>
    ...
    /// labels<para>имеет таксономическое понятие</para><para>Tiene concepto taxonómico</para><para>Has taxonomic concept</para><para>A concept taxonomique</para><para>مفهوم التصنيف</para><para>有分类学概念</para></remarks>
    ...
    /// labels<para>Partitive relationship</para><para>партитивные отношения</para><para>Relaciones partitivas</para><para>Relations partitives</para><para>العلاقات الجزئية</para><para>整体部分关系</para></remarks>
    ...
    /// labels<para>является переносчиком или хозяином для</para><para>Est vecteur ou est hôte de</para><para>Es vector o es huésped de</para><para>Is vector or host for</para><para>是...的寄主</para><para>مضيف لـ</para></remarks>
    ...
    /// labels<para>является объектом деятельности</para><para>Est l'objet de l'activité</para><para>Es objeto de la actividad</para><para>Is object of activity</para><para>هو محور النشاط</para><para>是活动...的对象</para></remarks>
    ...
    /// </para>
    /// labels<para>имеет старое название</para><para>tiene nombre antiguo</para><para>a nom ancien</para><para>Has old name</para><para>له اسم قديم</para><para>有曾用名</para></remarks>
    ...
    /// labels<para>имеет часть</para><para>Tiene parte</para><para>Has part</para><para>لديه جزء</para><para>A partie</para><para>有部分</para></remarks>
