...
module aos =
    ...
    /// labels<para>"يؤثر"</para><para>"影响"</para><para>"Affecte"</para><para>"Affects"</para><para>"Afecta"</para><para>"влияет на"</para></remarks>
    ...
    /// labels<para>"损伤"</para><para>"поражает"</para><para>"Afflige"</para><para>"Afflicts"</para><para>"Aflige"</para><para>"لهجمات"</para></remarks>
    ...
    /// labels<para>"Relaciones causales "</para><para>"العلاقات السببية"</para><para>"причинно-следственная связь"</para><para>"Relations causales "</para><para>"引起关系"</para><para>"Causative relationship"</para></remarks>
    ...
    /// labels<para>"Causes"</para><para>"Cause"</para><para>"الأسباب"</para><para>"Causa"</para><para>"引起关系"</para><para>"вызывает"</para></remarks>
    ...
    /// labels<para>"Compone"</para><para>"组成"</para><para>"Compose"</para><para>"تتكون Y من "</para><para>"то, из чего состоит"</para></remarks>
    ...
    /// labels<para>"имеет акроним"</para><para>"有缩略语"</para><para>"Tiene acrónimo"</para><para>"له اختصار"</para><para>"A l'acronyme"</para><para>"Has acronym"</para></remarks>
    ...
    /// labels<para>"A le code pays ISO3"</para><para>"لديه رمز البلد ISO3 "</para><para>"Has ISO 3 country code"</para><para>"有ISO3国家码"</para><para>"Tiene código ISO3 de país "</para><para>"Имеет код страны ISO3"</para></remarks>
    ...
    /// labels<para>"له مفهوم الاسم الشائع"</para><para>"A nom commun de concept"</para><para>"Has common name concept"</para><para>"有常用名概念"</para><para>"Tiene nombre común del concepto"</para><para>"имеет обиходное название"</para></remarks>
    ...
    /// labels<para>"A le composant"</para><para>"Has component"</para><para>"有组成部分"</para><para>"имеет компонент"</para><para>"Tiene componente"</para><para>"مكون"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Tiene la enfermedad"</para><para>"имеет болезнь"</para><para>"A la maladie"</para><para>"Has disease"</para><para>"有疾病"</para><para>"لديه مرض"</para></remarks>
    ...
    /// labels<para>"направлен на"</para><para>"有目标或过程"</para><para>"A le but ou le processus"</para><para>"Tiene el objetivo o el proceso"</para><para>"لديه الهدف"</para><para>"Has goal or process"</para></remarks>
    ...
    /// labels<para>"有寄主"</para><para>"لديه مضيف"</para><para>"Has vector or host "</para><para>"Tiene huésped u vector"</para><para>"A le vecteur ou l'hôte "</para><para>"имеет переносчика или хозяина"</para></remarks>
    ...
    /// labels<para>"لديه عضو"</para><para>"有成员"</para><para>"A un membre"</para><para>"Tiene miembro"</para><para>"имеет члена"</para><para>"Has member"</para></remarks>
    ...
    /// labels<para>"له هدف النشاط"</para><para>"Has object of activity"</para><para>"A objet d'activité"</para><para>"Tiene objeto de la actividad"</para><para>"有活动对象"</para><para>"имеет объект деятельности"</para></remarks>
    ...
    /// labels<para>"有曾用名"</para><para>"имеет старое название"</para><para>"له اسم قديم"</para><para>"tiene nombre antiguo"</para><para>"Has old name"</para><para>"a nom ancien"</para></remarks>
    ...
    /// labels<para>"لديه جزء"</para><para>"A partie"</para><para>"有部分"</para><para>"Has part"</para><para>"имеет часть"</para><para>"Tiene parte"</para></remarks>
    ...
    /// labels<para>"A l'agent pathogène"</para><para>"Tiene patógeno"</para><para>"有病原体"</para><para>"имеет патоген"</para><para>"لديه مسببات الأمراض"</para><para>"Has pathogen"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"A peste"</para><para>"لديه آفة"</para><para>"有有害生物"</para><para>"У ... имеется вредитель ..."</para><para>"Has pest"</para><para>"Tiene plaga"</para></remarks>
    ...
    /// labels<para>"有产品"</para><para>"Tiene el producto"</para><para>"Has product"</para><para>"имеет продукт"</para><para>"لديه المنتج"</para><para>"A le produit"</para></remarks>
    ...
    /// labels<para>"обладает свойством"</para><para>"Tiene propriedad"</para><para>"有属性"</para><para>"Has property"</para><para>"A la propriété"</para><para>"لديه ممتلكات"</para></remarks>
    ...
    /// labels<para>"Tiene nombre científico"</para><para>"له اسم علمي"</para><para>"имеет научное название"</para><para>"有学名"</para><para>"Has scientific name"</para><para>"A nom scientifique"</para></remarks>
    ...
    /// labels<para>"لها الرمز الكيميائي"</para><para>"Has symbol"</para><para>"有符号"</para><para>"A le symbole"</para><para>"обозначается символом"</para><para>"Tiene símbolo"</para></remarks>
    ...
    /// labels<para>"A symptôme"</para><para>"له أعراض"</para><para>"Has symptom"</para><para>"有症状"</para><para>"Tiene síntoma"</para><para>"имеет симптом"</para></remarks>
    ...
    /// labels<para>"له مرادف"</para><para>"A le synonyme"</para><para>"Tiene sinónimo"</para><para>"химеет синоним"</para><para>"Has synonym"</para><para>"有同义词"</para></remarks>
    ...
    /// يستخدم على مستوى المفهوم عندما يكون الاسم الشائع والاسم العلمي مفهومين منفصلين.
    ///  لعلاقة التسمية إلى التسمية للاستخدام ضمن المفهوم ، استخدم &lt;له اسم علمي / اسم علمي لـ&gt;. "</para>
    /// labels<para>"Tiene concepto taxonómico"</para><para>"مفهوم التصنيف"</para><para>"A concept taxonomique"</para><para>"Has taxonomic concept"</para><para>"有分类学概念"</para><para>"имеет таксономическое понятие"</para></remarks>
    ...
    /// labels<para>"имеет таксономический ранг"</para><para>"A le rang taxonomique"</para><para>"有分类等级"</para><para>"لديها المرتبة التصنيفية"</para><para>"Tiene el rango taxonómico"</para><para>"Has taxonomic rank"</para></remarks>
    ...
    /// labels<para>"Has type"</para><para>"有类型"</para><para>"A le type"</para><para>"Tiene tipo"</para><para>"имеет разновидность"</para><para>"لديه نوع"</para></remarks>
    ...
    /// labels<para>"Incluye"</para><para>"Comprend"</para><para>"يشمل"</para><para>"Includes"</para><para>"включает"</para><para>"包含"</para></remarks>
    ...
    /// labels<para>"Indicates"</para><para>"является симптомом"</para><para>"指示"</para><para>"يُظهر"</para><para>"Indica"</para><para>"Indique"</para></remarks>
    ...
    /// labels<para>"достигается с помощью"</para><para>"يتم تحقيقه عن طريق"</para><para>"Est réalisée au moyen de"</para><para>"通过…手段实现"</para><para>"Se consigue por medio de"</para><para>"Is achieved by means of"</para></remarks>
    ...
    /// labels<para>"является акронимом"</para><para>"هو اختصار"</para><para>"Est l'acronyme de"</para><para>"是...的缩略语"</para><para>"Is acronym of"</para><para>"Es acrónimo de"</para></remarks>
    ...
    /// labels<para>"Est affecté par"</para><para>"Is affected by"</para><para>"يتأثر بها"</para><para>"受...影响"</para><para>"на ... влияет ...."</para><para>"Está afectado por"</para></remarks>
    ...
    /// labels<para>"Is afflicted by"</para><para>"受...损伤"</para><para>"está afligido por"</para><para>"تتأثر ... بـ ..."</para><para>"поражается"</para><para>"est affligé par"</para></remarks>
    ...
    /// labels<para>"هو سبب"</para><para>"由...引起"</para><para>"Est causée par"</para><para>"Is caused by"</para><para>"вызывается"</para><para>"Está causado por"</para></remarks>
    ...
    /// labels<para>"是...的组成部分"</para><para>"Est un composant de"</para><para>"Es componente de"</para><para>"является компонентом"</para><para>"Is component of"</para><para>"هو مكون من"</para></remarks>
    ...
    /// labels<para>"Is composed of"</para><para>"состоит из"</para><para>"يتكون من"</para><para>"Est composé de"</para><para>"由...组成"</para><para>"Está compuesto de"</para></remarks>
    ...
    /// labels<para>"Is derived from"</para><para>"получен из"</para><para>"مشتق من"</para><para>"Est dérivé de"</para><para>"Es derivado de"</para><para>"源自"</para></remarks>
    ...
    /// labels<para>"Is disease for"</para><para>"Est maladie de"</para><para>"هو مرض"</para><para>"是...的疾病"</para><para>"является болезнью для"</para><para>"Es la enfermedad por"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"Is vector or host for"</para><para>"是...的寄主"</para><para>"مضيف لـ"</para><para>"Es vector o es huésped de"</para><para>"Est vecteur ou est hôte de"</para><para>"является переносчиком или хозяином для"</para></remarks>
    ...
    /// labels<para>"включен в"</para><para>"Est inclus dans"</para><para>"包含于"</para><para>"مدرج في"</para><para>"Incluido en"</para><para>"Is included in"</para></remarks>
    ...
    /// "</para>
    /// labels<para>"مصنوعه من"</para><para>"由...制成"</para><para>"Est fait de"</para><para>"сделан из"</para><para>"Está hecho de"</para><para>"Is made from"</para></remarks>
    ...
    /// labels<para>"Is measured by"</para><para>"Si mide mediante"</para><para>"يتم قياس x بواسطة y"</para><para>"Est mesuré par"</para><para>"измеряется"</para><para>"由...测量"</para></remarks>
    ...
    /// labels<para>"Est membre de  "</para><para>"هو عضو في"</para><para>"是...的成员"</para><para>"является членом"</para><para>"Is member of"</para><para>"Es miembro de"</para></remarks>
    ...
    /// labels<para>"Est l'objet de l'activité"</para><para>"Es objeto de la actividad"</para><para>"是活动...的对象"</para><para>"является объектом деятельности"</para><para>"Is object of activity"</para><para>"هو محور النشاط"</para></remarks>
    ...
    /// labels<para>"是...的曾用名"</para><para>"Es nombre antiguo de"</para><para>"Est nom ancien de"</para><para>"Is old name of"</para><para>"هو الاسم القديم ل"</para><para>"является старым названием"</para></remarks>
    ...
    /// labels<para>"وهو جزء من"</para><para>"是...的部分"</para><para>"Fait partie de"</para><para>"Es parte de"</para><para>"Is part of"</para><para>"является частью"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"ЯВЛЯЕТСЯ ЧАСТЬЮ МИКРОТЕЗАУРУСА"</para><para>"ES PARTE DE UN SUBVOCABULARIO"</para><para>"Is part of subvocabulary"</para><para>"FAIT PARTIE DU SOUS-VOCABULAIRE"</para></remarks>
    ...
    /// labels<para>"является патогеном"</para><para>"Es patógeno de"</para><para>"Is pathogen of"</para><para>"هو أحد مسببات الأمراض"</para><para>"是...的病原体"</para><para>"Est pathogène de"</para></remarks>
    ...
    /// labels<para>"Se previene con"</para><para>"Is prevented by"</para><para>"Est empêché par"</para><para>"предотвращается"</para><para>"تم منعه بواسطة"</para><para>"由...防止"</para></remarks>
    ...
    /// labels<para>"вляется процессом для"</para><para>"Es un proceso para"</para><para>"Est un processus pour"</para><para>"是…的过程"</para><para>"Is process for"</para><para>"هي العملية ل"</para></remarks>
    ...
    /// labels<para>"من إنتاج"</para><para>"Est produit par"</para><para>"производится"</para><para>"Is produced by"</para><para>"Es producido por"</para><para>"由...生产"</para></remarks>
    ...
    /// labels<para>"Est une propriété de"</para><para>"是...的属性"</para><para>"является свойством"</para><para>"هي ملكية لـ"</para><para>"Is property of"</para><para>"Es propriedad de"</para></remarks>
    ...
    /// labels<para>"является источником"</para><para>"是...的来源"</para><para>"Es fuente de"</para><para>"Is source of"</para><para>"Est source de"</para><para>"هو مصدر"</para></remarks>
    ...
    /// labels<para>"مدرج مكانيًا في"</para><para>"Is spatially included in"</para><para>"空间包含于"</para><para>"Est spatialement inclus dans"</para><para>"Se incluye espacialmente en"</para><para>"пространственно включен в"</para></remarks>
    ...
    /// labels<para>"تدرس من قبل"</para><para>"&lt;изучается&gt;"</para><para>"Is studied by
    /// "</para><para>"被...研究"</para><para>"Es estudiado por "</para><para>"Est étudié par "</para></remarks>
    ...
    /// labels<para>"هو رمز كيميائي لـ"</para><para>"Is symbol for"</para><para>"Es símbolo de"</para><para>"是...的符号"</para><para>"Est le symbole de"</para><para>"символ для"</para></remarks>
    ...
    /// labels<para>"是...的分类等级"</para><para>"Est le rang taxonomique de"</para><para>"является таксономическим рангом"</para><para>"Is taxonomic rank of"</para><para>"هي رتبة تصنيفية"</para><para>"Es el rango taxonómico de"</para></remarks>
    ...
    /// labels<para>"Is use of"</para><para>"Est l'utilisation de"</para><para>"это использование"</para><para>"هو استخدام"</para><para>"是使用"</para><para>"Es el uso de"</para></remarks>
    ...
    /// labels<para>"用作"</para><para>"مستعمل ك"</para><para>"Est utilisé comme"</para><para>"Is used as"</para><para>"Se utiliza como"</para><para>"используется как"</para></remarks>
    ...
    /// labels<para>"يستخدم في"</para><para>"Est utilisé dans"</para><para>"Is used in"</para><para>"被用于"</para><para>"Es utilizado en"</para><para>"используется в"</para></remarks>
    ...
    /// labels<para>"Is used to make"</para><para>"Est utilisé pour fabriquer"</para><para>"用于制作"</para><para>"يستخدم لصنع"</para><para>"Se utiliza para hacer"</para><para>"используется для производства"</para></remarks>
    ...
    /// labels<para>"Código M49"</para><para>"M49 code"</para><para>"M49码"</para><para>"UN M49"</para><para>"M.49"</para><para>"Code M49"</para></remarks>
    ...
    /// labels<para>"يستفاد من"</para><para>"Fait usage de"</para><para>"Make use of"</para><para>"использует"</para><para>"利用"</para><para>"Hace uso de"</para></remarks>
    ...
    /// labels<para>"Medidas"</para><para>"Measures"</para><para>"测量"</para><para>"Mesure"</para><para>"измеряет"</para><para>"س يقيس ص"</para></remarks>
    ...
    /// labels<para>"партитивные отношения"</para><para>"العلاقات الجزئية"</para><para>"Partitive relationship"</para><para>"Relations partitives"</para><para>"Relaciones partitivas"</para><para>"整体部分关系"</para></remarks>
    ...
    /// labels<para>"Es una plaga de"</para><para>"Est peste de"</para><para>"是...的有害生物"</para><para>"هي الآفة"</para><para>"вредитель"</para><para>"Is a pest of"</para></remarks>
    ...
    /// labels<para>"Prévient"</para><para>"يمنع"</para><para>"Prevents"</para><para>"Previene"</para><para>"防止"</para><para>"предотвращает"</para></remarks>
    ...
    /// labels<para>"Relaciones de procesos "</para><para>"Process relationships"</para><para>"过程关系"</para><para>"процессные отношения"</para><para>"Relations de processus"</para><para>"علاقات العملية"</para></remarks>
    ...
    /// labels<para>"Produce"</para><para>"производит"</para><para>"Produces"</para><para>"生产"</para><para>"ينتج عنه"</para><para>"Produit"</para></remarks>
    ...
    /// labels<para>"是...的产品"</para><para>"هو نتاج"</para><para>"Product of"</para><para>"Est le produit de"</para><para>"Producto de"</para><para>"является продуктом"</para></remarks>
    ...
    /// labels<para>"العلاقات الكمية"</para><para>"Quantitative relationship"</para><para>"数量关系"</para><para>"Relations quantitatives "</para><para>"количественные отношения"</para><para>"Relaciones cuantitativas"</para></remarks>
    ...
    /// labels<para>"является научным названием"</para><para>"هو الاسم العلمي ل"</para><para>"Es el nombre científico de"</para><para>"Est le nom scientifique de"</para><para>"Scientific name of"</para><para>"是...的学名"</para></remarks>
    ...
    /// labels<para>"العلاقات المكانية"</para><para>"Spatial relationship"</para><para>"пространственные отношения
    /// "</para><para>"空间关系"</para><para>"Relations spatiales "</para><para>"Relaciones espaciales "</para></remarks>
    ...
    /// labels<para>"空间包含"</para><para>"Incluye espacialmente"</para><para>"пространственно включает"</para><para>"Spatially includes"</para><para>"x مكانيًا يشمل y"</para><para>"Spatialement inclut"</para></remarks>
    ...
    /// labels<para>"研究"</para><para>"изучает"</para><para>"Estudia"</para><para>"Étude"</para><para>"دراسات"</para><para>"Study"</para></remarks>
    ...
    /// labels<para>"окружен"</para><para>"Rodeado de"</para><para>"وتحيط به"</para><para>"Est entouré par"</para><para>"Surrounded by"</para><para>"被...围绕"</para></remarks>
    ...
    /// labels<para>"Entoure"</para><para>"围绕"</para><para>"окружает"</para><para>"Alrededor de"</para><para>"يحيط"</para><para>"Surrounds"</para></remarks>
    ...
    /// labels<para>"Relaciones taxonómicas"</para><para>"таксономические отношения"</para><para>"Relations taxonomiques"</para><para>"العلاقات التصنيفية"</para><para>"分类学关系"</para><para>"Taxonomic relationship"</para></remarks>
    ...
    /// labels<para>"Type of"</para><para>"Es tipo de"</para><para>"هو نوع من"</para><para>"是...的类型"</para><para>"является разновидностью"</para><para>"Est un type de"</para></remarks>
    ...
    /// labels<para>"Utiliza el proceso"</para><para>"يستخدم العملية"</para><para>"Utilise le processus"</para><para>"使用过程"</para><para>"Uses process"</para><para>"использует процесс "</para></remarks>
