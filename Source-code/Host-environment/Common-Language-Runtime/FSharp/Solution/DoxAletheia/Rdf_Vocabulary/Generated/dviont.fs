...
module dviont =
    ...
    /// labels<para>domain d'usage</para><para>scope</para></remarks>
    ...
    /// labels<para>navigateur alternatif</para><para>alternative navigator</para></remarks>
    ...
    /// labels<para>valeur commerciale</para><para>businessValue</para></remarks>
    ...
    /// labels<para>impl�menter par</para><para>design By</para></remarks>
    ...
    /// labels<para>consumes</para><para>consomme</para></remarks>
    ...
    /// labels<para>url de la librairie</para><para>library url</para></remarks>
    ...
    /// labels<para>syst�me</para><para>system</para></remarks>
    ...
    /// labels<para>Application</para><para>Application</para></remarks>
