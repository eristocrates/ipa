...
module gtm =
    ...
    /// labels<para>"Buurt"</para><para>"Neighbourhood"</para></remarks>
    ...
    /// labels<para>"Constructie"</para><para>"Construction"</para></remarks>
    ...
    /// labels<para>"Geo temporal object"</para><para>"Geo-temporeel object"</para></remarks>
    ...
    /// labels<para>"Hofje"</para><para>"Courtyard"</para></remarks>
    ...
    /// labels<para>"Kunstwerk"</para><para>"Work of art"</para></remarks>
    ...
    /// labels<para>"Quarter"</para><para>"Kwartier"</para></remarks>
    ...
    /// labels<para>"Plot"</para><para>"Perceel"</para></remarks>
    ...
    /// labels<para>"Place"</para><para>"Plaats"</para></remarks>
    ...
    /// labels<para>"Place designation"</para><para>"Plaatselijke aanduiding"</para></remarks>
    ...
    /// labels<para>"Straatnummer aanduiding"</para><para>"Street number designation"</para></remarks>
    ...
    /// labels<para>"Structure"</para><para>"Structuur"</para></remarks>
    ...
    /// labels<para>"Wijk"</para><para>"District"</para></remarks>
    ...
    /// labels<para>"addresses"</para><para>"adresseert"</para></remarks>
    ...
    /// labels<para>"heeft adres"</para><para>"has address"</para></remarks>
    ...
    /// labels<para>"ligt in wijk"</para><para>"is located in district"</para></remarks>
