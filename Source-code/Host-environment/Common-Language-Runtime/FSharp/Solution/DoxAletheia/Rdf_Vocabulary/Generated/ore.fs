...
module ore =
    ...
    let AggregatedResource =
        Namespaced_IRI.parse _namespace_name "AggregatedResource" |> NamespacedName
    ...
    let isAggregatedBy =
        Namespaced_IRI.parse _namespace_name "isAggregatedBy" |> NamespacedName
