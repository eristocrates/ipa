...
module turismo =
    ...
    ///
    /// labels<para>Estilo contemporâneo</para><para>Estilo contemporáneo</para><para>Stile contemporaneo</para><para>Contemporary style</para><para>Style contemporain</para></remarks>
    ...
    ///   <para>turismo:Estilo-artistico</para>
    ///
    /// labels<para>Style de la Renaissance</para><para>Stile del Renascimento</para><para>Estilo renascentista</para><para>Estilo renacentista</para><para>Renaissance style</para></remarks>
    ...
    ///
    /// labels<para>Interés en arquitectura urbana</para><para>Interesse per l'architettura</para><para>Intérêt pour l'architecture</para><para>Interesse pela arquitectura</para><para>Interest in architecture</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Intérêt pour le style gothique</para><para>Interesse per lo stile gotico</para><para>Interesse pelo estilo gótico</para><para>Interés en estilo gótico</para><para>Interest in gothic style</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Interesse per lo stile del Renascimento</para><para>Intérêt pour le style de la Renaissance</para><para>Interesse pelo estilo renascentista</para><para>Interés en estilo renacentista</para><para>Interest in Renaissance style</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Interés en conocer la EXPO 2008</para><para>Interesse per l'EXPO 2008</para><para>Intérêt pour l'EXPO 2008</para><para>Interesse pela EXPO 2008</para><para>Interest in EXPO 2008</para></remarks>
    ...
    ///   <para>turismo:Accesibilidad-de-movilidad-reducida</para>
    ///
    /// labels<para>Accessible avec accompagnateur</para><para>Acessível com acompanhante</para><para>Accesible con acompañante</para><para>Accessible with attendant</para><para>Accessibile con addetto</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///   <para></para>
    /// labels<para>Intérêt pour les espaces et les environements naturaux</para><para>Interesse per gli spazi e ambienti naturali</para><para>Interest in natural spaces and environment</para><para>Interesse por áreas e ambientes naturais</para><para>Interés en espacios y entornos naturales</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Interesse per lo stile modernista</para><para>Intérêt pour le style moderniste</para><para>Interesse pelo estilo modernista</para><para>Interest in modernistic style</para><para>Interés en estilo modernista</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Intérêt pour les bâtiments historiques</para><para>Interesse pelos edifícios históricos</para><para>Interest in historical buildings</para><para>Interesse per i edifici storici</para><para>Interés en edificios historicos</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Interés por los edificios religiosos</para><para>Interesse pelos edifícios religiosos</para><para>Intérêt pour les bâtiments religieux</para><para>Interesse per i edifici religiosi</para><para>Interest in religious buildings</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Interesse per i acquisti e per guardare le vetrine dei negozi</para><para>Intérêt pour faire du shopping et faire du lèche-vitrines</para><para>Interesse pelas compras e por ver vitrines</para><para>Interés en ir de compras</para><para>Interest in shopping</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Interesse per lo stile mudéjar</para><para>Interesse pelo estilo mudéjar</para><para>Intérêt pour le style mudéjar</para><para>Interés en estilo mudéjar</para><para>Interest in mudéjar style</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Intérêt pour la sculpture</para><para>Interesse per la scultura</para><para>Interesse pela escultura</para><para>Interés en esculturas</para><para>Interest in sculpture</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Interés en edificios fortificados</para><para>Intérêt pour les forteresses</para><para>Interesse per le fortezze</para><para>Interesse por fortalezas</para><para>Interest in fortress</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Intérêt pour les musées</para><para>Interesse pelos museus</para><para>Interesse per i musei</para><para>Interest in museums</para><para>Interés en museos</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Intérêt pour les palais</para><para>Interesse per i palazzi</para><para>Interesse pelos paços</para><para>Interés en palacios</para><para>Interest in palaces</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Interesse per lo stile romano</para><para>Interesse pelo estilo romano</para><para>Intérêt pour le style romain</para><para>Interés en estilo romano</para><para>Interest in roman style</para></remarks>
    ...
    ///   <para>turismo:Accesibilidad-de-movilidad-reducida</para>
    ///
    /// labels<para>Acessibilidade completa</para><para>Accesibilidad completa</para><para>Accessibilità completa</para><para>Accessibilité complète</para><para>Voll Zugänglichkeit</para><para>Full accessibility</para></remarks>
    ...
    ///   <para>turismo:Estilo-artistico</para>
    ///
    /// labels<para>Estilo barroco</para><para>Estilo barroco</para><para>Stile barocco</para><para>Baroque style</para><para>Style baroque</para></remarks>
    ...
    ///   <para>turismo:Estilo-artistico</para>
    ///
    /// labels<para>Estilo mudéjar</para><para>Estilo mudéjar</para><para>Style mudéjar</para><para>Stile mudéjar</para><para>Mudéjar style</para></remarks>
    ...
    ///   <para>turismo:Accesibilidad-de-movilidad-reducida</para>
    ///
    /// labels<para>Accessible avec des béquilles</para><para>Zugänglichkeit auf Krücken</para><para>Accesibile con le gruccie</para><para>Accesible with crutches</para><para>Acessível com muletas</para><para>Accesible con muletas</para></remarks>
    ...
    ///   <para>turismo:Estilo-artistico</para>
    ///
    /// labels<para>Style gothique</para><para>Estilo gótico</para><para>Estilo gótico</para><para>Gothic style</para><para>Stile gotico</para></remarks>
    ...
    ///   <para>turismo:Estilo-artistico</para>
    ///
    /// labels<para>Estilo modernista</para><para>Estilo modernista</para><para>Style moderniste</para><para>Stile modernista</para><para>Modernist style</para></remarks>
    ...
    ///   <para>turismo:Estilo-artistico</para>
    ///
    /// labels<para>Estilo romano</para><para>Estilo romano</para><para>Style romain</para><para>Stile romano</para><para>Roman style</para></remarks>
    ...
    ///   <para>turismo:Estilo-artistico</para>
    ///
    /// labels<para>Estilo neoclássico</para><para>Style néoclassique</para><para>Neoclassical style</para><para>Estilo neoclásico</para><para>Stile neoclassico</para></remarks>
    ...
    /// labels<para>Relevancia de los intereses turísticos</para></remarks>
    ...
    ///   <para>turismo:Preferencia-de-ruta</para>
    ///
    /// labels<para>Velocidade lenta de passeio</para><para>Velocità bassa di passeggio</para><para>Velocidad de paseo lenta</para><para>Vitesse lente de marche</para><para>Slow walking</para></remarks>
    ...
    ///   <para>turismo:Preferencia-de-ruta</para>
    ///
    /// labels<para>Velocità leggera di passeggio</para><para>Velocidade ligeira de passeio</para><para>Velocidad de paseo rápida</para><para>Vitesse légère de marche</para><para>Fast walking</para></remarks>
    ...
    /// labels<para>Relevancia de las preferencias de ruta</para></remarks>
    ...
    /// labels<para>Fecha de inicio</para></remarks>
    ...
    /// labels<para>Fecha de finalización</para></remarks>
    ...
    ///   <para>turismo:Preferencia-de-ruta</para>
    ///
    /// labels<para>Tiempo de visita corto</para><para>Tempo di visita breve</para><para>Durée breve de visite</para><para>Tempo de visita breve</para><para>Short time of visit</para></remarks>
    ...
    ///   <para>turismo:Preferencia-de-ruta</para>
    ///
    /// labels<para>Tiempo de visita largo</para><para>Durée longue de visite</para><para>Tempo longo de visita</para><para>Tempo di visita lungo</para><para>Long time of visit</para></remarks>
    ...
    ///   <para>Guarda la dirección postal del recurso</para>
    /// labels<para>Dirección Postal</para></remarks>
    ...
    /// labels<para>Día final</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:AnnotationProperty</para>
    ///   <para>Guarda el texto con el horario de visita del recurso.</para>
    /// labels<para>Horario</para></remarks>
    ...
    /// labels<para>Identificador de IDEZar</para></remarks>
    ...
    /// labels<para>Día inicial</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Interés en monumentos con medidas de accesibilidad</para><para>Intérêt pour les monuments accessibles</para><para>Interesse per i monumenti accessibili</para><para>Interesse por monumentos acessíveis</para><para>Interest in accessible monuments</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Interés en arte de la ciudad</para><para>Interesse per l'arte</para><para>Interesse pela arte</para><para>Intérêt pour l'art</para><para>Interest in art</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///   <para></para>
    /// labels<para>Interesse per lo stile barocco</para><para>Intérêt pour le style baroque</para><para>Interesse pelo estilo barroco</para><para>Interés en estilo barroco</para><para>Interest in baroque style</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Interesse per lo stile contemporaneo</para><para>Interesse pelo estilo contemporâneo</para><para>Intérêt pour le style contemporain</para><para>Interés en estilo contemporáneo</para><para>Interest in contemporary style</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Interesse per lo stile neoclassico</para><para>Intérêt pour le style néoclassique</para><para>Interesse pelo estilo neoclássico</para><para>Interest in neoclassical style</para><para>Interés en estilo neoclásico</para></remarks>
    ...
    ///   <para>turismo:Interes-turistico</para>
    ///
    /// labels<para>Interest in green spaces (parks, public gardens, etc)</para><para>Interesse per gli spazi verdi (giardini, parchi, etc)</para><para>Intérêt pour les espaces verts (parcs, jardins, etc)</para><para>Interesse pelas áreas verdes (parques, jardins, etc)</para><para>Interés en zonas verdes (parques, jardines, etc.)</para></remarks>
