...
module imo =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Color Layout Descriptor"</para><para>"Descriptor de la Distribución del Color"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"Image"</para><para>"Imagen"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"La URL de la imagen en Wikimedia Commons"</para><para>"The URL of the image in Wikimedia Commons"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"Image height in pixels"</para><para>"Altura de la imagen en unidades de pixel"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"The target of an image relation"</para><para>"El objeto de la relación entre imágenes"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"El descriptor usado en la relación"</para><para>"The descriptor used in the relation"</para></remarks>
