...
module frapo =
    ...
    ///   <para>"FRAPO, the Funding, Research Administration and Projects Ontology, is a CERIF-compliant ontology  written in OWL 2 DL for describing research project administrative information.  This ontology is available at http://purl.org/cerif/frapo/, and uses the namespace prefix 'frapo'."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    /// <summary>
    ///   <para>frapo:Project</para>
    /// </summary>
    /// <remarks></remarks>
    /// <seealso href="http://purl.org/cerif/frapo/Project">http://purl.org/cerif/frapo/Project</seealso>
    let Project = Prefixed_Name(frapo, "Project") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"Cotains the country code name of a party involved in the invoice"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    /// labels<para>"hasCountryCode"</para><para>"has country code"</para></remarks>
    ...
    ///   <para>"Date/time on which the goods are or are expected to be despatched or shipped"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"has dispatch date"</para><para>"hasDispatchDate"</para></remarks>
    ...
    ///   <para>"Date when a Commercial Invoice is issued"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"hasInvoiceDate"</para><para>"has invoice date"</para></remarks>
