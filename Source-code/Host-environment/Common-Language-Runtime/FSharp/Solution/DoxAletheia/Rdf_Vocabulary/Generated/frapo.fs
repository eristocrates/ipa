...
module frapo =
    ...
    let AdmissionApplication = _prefix "AdmissionApplication"
    /// <summary>
    ...
    let AnnualTurnover = _prefix "AnnualTurnover"
    /// <summary>
    ...
    let ArticleProcessingCharge = _prefix "ArticleProcessingCharge"
    /// <summary>
    ...
    let BudgetCategory = _prefix "BudgetCategory"
    /// <summary>
    ...
    let BudgetedAmount = _prefix "BudgetedAmount"
    /// <summary>
    ...
    /// </summary>
    let Business_angel = _prefix "Business_angel"
    /// <summary>
    ...
    let Commitments = _prefix "Commitments"
    /// <summary>
    ...
    let ComputationalService = _prefix "ComputationalService"
    /// <summary>
    ...
    let ConferenceFee = _prefix "ConferenceFee"
    /// <summary>
    ...
    let ConsortiumAgreement = _prefix "ConsortiumAgreement"
    /// <summary>
    ...
    let ConsultancyAgreement = _prefix "ConsultancyAgreement"
    /// <summary>
    ...
    let EmploymentApplication = _prefix "EmploymentApplication"
    /// <summary>
    ...
    let Expenditure = _prefix "Expenditure"
    /// <summary>
    ...
    let ExpenditureToDate = _prefix "ExpenditureToDate"
    /// <summary>
    ...
    let FinancialControlSystem = _prefix "FinancialControlSystem"
    /// <summary>
    ...
    let FundingApplication = _prefix "FundingApplication"
    /// <summary>
    ...
    let FundingProgramme = _prefix "FundingProgramme"
    /// <summary>
    ...
    let Investigation = _prefix "Investigation"
    /// <summary>
    ...
    let Investment = _prefix "Investment"
    /// <summary>
    ...
    let MaterialOutput = _prefix "MaterialOutput"
    /// <summary>
    ...
    let ProjectBudget = _prefix "ProjectBudget"
    /// <summary>
    ...
    let ResearchInformationSystem = _prefix "ResearchInformationSystem"
    /// <summary>
    ...
    let ScholarshipApplication = _prefix "ScholarshipApplication"
    /// <summary>
    ...
    let ServiceContractFee = _prefix "ServiceContractFee"
    /// <summary>
    ...
    let SpinOffCompany = _prefix "SpinOffCompany"
    /// <summary>
    ...
    let ``consultancy-costs`` = _prefix "consultancy-costs"
    /// <summary>
    ...
    let ``consumables-costs`` = _prefix "consumables-costs"
    /// <summary>
    ...
    let ``contributions-in-kind`` = _prefix "contributions-in-kind"
    /// <summary>
    ...
    let ``directly-allocated-costs`` = _prefix "directly-allocated-costs"
    /// <summary>
    ...
    /// </summary>
    let entrepreneur = _prefix "entrepreneur"
    /// <summary>
    ...
    let ``estates-costs`` = _prefix "estates-costs"
    /// <summary>
    ...
    let ``facilities-costs`` = _prefix "facilities-costs"
    /// <summary>
    ...
    let familyNameInitial = _prefix "familyNameInitial"
    /// <summary>
    ...
    let ``full-economic-costs`` = _prefix "full-economic-costs"
    /// <summary>
    ...
    let givenNameInitial = _prefix "givenNameInitial"
    /// <summary>
    ...
    let hasAccountNumber = _prefix "hasAccountNumber"
    /// <summary>
    ...
    let hasAgentInformation = _prefix "hasAgentInformation"
    /// <summary>
    ...
    let hasApplicationDeadline = _prefix "hasApplicationDeadline"
    /// <summary>
    ...
    let hasApplicationOutcome = _prefix "hasApplicationOutcome"
    /// <summary>
    ...
    let hasBatchNumber = _prefix "hasBatchNumber"
    /// <summary>
    ...
    let hasCityOrTown = _prefix "hasCityOrTown"
    /// <summary>
    ...
    let hasCompletionDate = _prefix "hasCompletionDate"
    /// <summary>
    ...
    let hasCurrencyCode = _prefix "hasCurrencyCode"
    /// <summary>
    ...
    let hasCurriculumVitae = _prefix "hasCurriculumVitae"
    /// <summary>
    ...
    let hasCustomerNumber = _prefix "hasCustomerNumber"
    /// <summary>
    ...
    let hasDegreeSuffix = _prefix "hasDegreeSuffix"
    /// <summary>
    ...
    let hasDeliverable = _prefix "hasDeliverable"
    /// <summary>
    ...
    let hasDeliveryDate = _prefix "hasDeliveryDate"
    /// <summary>
    ...
    let hasDispatchDate = _prefix "hasDispatchDate"
    /// <summary>
    ...
    let hasDomainName = _prefix "hasDomainName"
    /// <summary>
    ...
    let hasExchangeRate = _prefix "hasExchangeRate"
    /// <summary>
    ...
    let hasFunderIdentifier = _prefix "hasFunderIdentifier"
    /// <summary>
    ...
    let hasFundingAgency = _prefix "hasFundingAgency"
    /// <summary>
    ...
    let hasGrantNumber = _prefix "hasGrantNumber"
    /// <summary>
    ...
    let hasHeadcount = _prefix "hasHeadcount"
    /// <summary>
    ...
    let hasOrganizationalInformation = _prefix "hasOrganizationalInformation"
    /// <summary>
    ...
    let hasIPROwner = _prefix "hasIPROwner"
    /// <summary>
    ...
    let hasInvoiceDate = _prefix "hasInvoiceDate"
    /// <summary>
    ...
    let hasJobTitle = _prefix "hasJobTitle"
    /// <summary>
    ...
    let hasPersonalInformation = _prefix "hasPersonalInformation"
    /// <summary>
    ...
    let hasLanguageCode = _prefix "hasLanguageCode"
    /// <summary>
    ...
    let hasManufactureDate = _prefix "hasManufactureDate"
    /// <summary>
    ...
    let hasMilestone = _prefix "hasMilestone"
    /// <summary>
    ...
    let hasMonetaryValue = _prefix "hasMonetaryValue"
    /// <summary>
    ...
    let hasPostCode = _prefix "hasPostCode"
    /// <summary>
    ...
    let hasPostalAddressLine = _prefix "hasPostalAddressLine"
    /// <summary>
    ...
    let hasProfessionalName = _prefix "hasProfessionalName"
    /// <summary>
    ...
    let hasProjectIdentifier = _prefix "hasProjectIdentifier"
    /// <summary>
    ...
    let hasPurchaseDate = _prefix "hasPurchaseDate"
    /// <summary>
    ...
    let hasPurchaseOrderNumber = _prefix "hasPurchaseOrderNumber"
    /// <summary>
    ...
    let hasQualification = _prefix "hasQualification"
    /// <summary>
    ...
    let hasReferenceNumber = _prefix "hasReferenceNumber"
    /// <summary>
    ...
    let hasRegistrationDeadline = _prefix "hasRegistrationDeadline"
    /// <summary>
    ...
    let hasSupplierNumber = _prefix "hasSupplierNumber"
    /// <summary>
    ...
    let ``indirect-costs`` = _prefix "indirect-costs"
    /// <summary>
    ...
    let isAppliedForBy = _prefix "isAppliedForBy"
    /// <summary>
    ...
    let isDonatedBy = _prefix "isDonatedBy"
    /// <summary>
    ...
    let isEnabledBy = _prefix "isEnabledBy"
    /// <summary>
    ...
    let isFundingAgencyFor = _prefix "isFundingAgencyFor"
    /// <summary>
    ...
    let isManufacturedBy = _prefix "isManufacturedBy"
    /// <summary>
    ...
    let manufactures = _prefix "manufactures"
    /// <summary>
    ...
    let isOutputOf = _prefix "isOutputOf"
    /// <summary>
    ...
    let isPurchasedBy = _prefix "isPurchasedBy"
    /// <summary>
    ...
    let ``non-staff-costs`` = _prefix "non-staff-costs"
    /// <summary>
    ...
    let ``other-costs`` = _prefix "other-costs"
    /// <summary>
    ...
    let ``overhead-costs`` = _prefix "overhead-costs"
    /// <summary>
    ///   <see href="http://purl.org/cerif/frapo/owl:sameAs"></see>
    /// </summary>
    let ``owl:sameAs`` = _prefix "owl:sameAs"
    /// <summary>
    ...
    let ownsIRPOf = _prefix "ownsIRPOf"
    /// <summary>
    ...
    let providesFractionOfTotalFunding = _prefix "providesFractionOfTotalFunding"
    /// <summary>
    ...
    let purchasesFrom = _prefix "purchasesFrom"
    /// <summary>
    ...
    let ``service-costs`` = _prefix "service-costs"
    /// <summary>
    ...
    let ``software-costs`` = _prefix "software-costs"
    /// <summary>
    ...
    let specifiesExpediture = _prefix "specifiesExpediture"
    /// <summary>
    ...
    let ``travel-and-subsistence-costs`` = _prefix "travel-and-subsistence-costs"
    /// <summary>
    ...
    let usesEquipment = _prefix "usesEquipment"
    /// <summary>
    ...
    let usesFacility = _prefix "usesFacility"
    /// <summary>
