...
module ofrd =
    ...
    /// labels<para>Congelador</para><para>Freezer</para></remarks>
    ...
    /// labels<para>Frigorífico/Congelador</para><para>FridgeFreezer</para><para>Kühlschrank</para></remarks>
    ...
    /// labels<para>Frigorífico</para><para>Kühlschrank</para><para>Fridge</para></remarks>
