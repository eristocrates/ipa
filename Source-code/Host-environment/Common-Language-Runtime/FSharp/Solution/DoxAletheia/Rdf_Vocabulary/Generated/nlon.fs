...
module nlon =
    ...
    ///   <para>"This specification describes National Library of Korea Ontology vocaburaries using W3C's RDF and OWL technology."^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// </remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"해외수집기록물"</para><para>"Archives"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"분류"</para><para>"Classification"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"복합자료"</para><para>"Complex document"</para></remarks>
    ...
    /// labels<para>"연속자료구분"</para><para>"Continuous data type"</para></remarks>
    ...
    /// labels<para>"자료구분"</para><para>"Data type"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"사서"</para><para>"librarian"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>"지역"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"비도서"</para><para>"Non book"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"오프라인 자료"</para><para>"Offline material"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"고서"</para><para>"Old book"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"온라인 자료"</para><para>"Online material"</para></remarks>
    ...
    /// labels<para>"간행빈도구분"</para><para>"Publication frequency type"</para></remarks>
    ...
    /// labels<para>"간행상태구분"</para><para>"Publication status type"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"원시자료의 정보원"</para><para>"antecedent source"</para></remarks>
    ...
    /// labels<para>"이용대상자 주기"</para><para>"audience note"</para></remarks>
    ...
    /// labels<para>"학위수여 기관"</para><para>"awarded from"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"생년"</para>
    /// labels<para>"출생연도"</para><para>"birth year"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"확인 날짜"</para><para>"confirm date"</para></remarks>
    ...
    /// labels<para>"현재 간행빈도"</para><para>"current publication frequency"</para></remarks>
    ...
    /// labels<para>"현재 간행빈도 시작 연월"</para><para>"date of current publication frequency"</para></remarks>
    ...
    /// labels<para>"권,연차 또는 발행년 표시"</para><para>"date of publication sequential designation"</para></remarks>
    ...
    /// labels<para>"표제변동 권연차표시"</para><para>"date sequential designation"</para></remarks>
    ...
    /// labels<para>"듀이십진분류기호"</para><para>"Dewey Decimal Classification Number"</para></remarks>
    ...
    /// labels<para>"학위수여연도"</para><para>"degree year"</para></remarks>
    ...
    /// labels<para>"학과, 전공"</para><para>"department"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"배포지"</para>
    /// labels<para>"배포지"</para><para>"distribution place"</para></remarks>
    ...
    /// labels<para>"듀이십진분류기호 판표시"</para><para>"edition of DDC"</para></remarks>
    ...
    /// labels<para>"한국십진분류기호 판표시"</para><para>"edition of KDC"</para></remarks>
    ...
    /// labels<para>"전시"</para><para>"exhibition"</para></remarks>
    ...
    /// labels<para>"gpo"</para><para>"미국정부간행물번호"</para></remarks>
    ...
    /// labels<para>"소장기관"</para><para>"holding institution"</para></remarks>
    ...
    /// labels<para>"소장본 주기"</para><para>"holding item note"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"입력 날짜"</para><para>"input date"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"폐관여부"</para><para>"is closed"</para></remarks>
    ...
    /// labels<para>"다른 분류기호 도서기호"</para><para>"item number of other number"</para></remarks>
    ...
    /// labels<para>"한국십진분류기호"</para><para>"Korean Decimal Classification Number"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"키워드"</para><para>"keyword"</para></remarks>
    ...
    /// labels<para>"언어주기"</para><para>"language note"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"관종구분"</para><para>"library type"</para></remarks>
    ...
    /// labels<para>"원본/복제본 소재 주기"</para><para>"Location of Originals/Duplicates Note"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"식별기호 ▾a는 관련 레코드 100(기본표목-개인명) 필드, 110(기본표목-단체명) 필드, 111(기본표목-회의명) 필드의 기본표목 데이터를 포함한다. 하지만 식별기호에서는 1XX 필드에서 사용하는 개별적인 이름의 요소나 통일표제는 기술되지 않는다."</para>
    /// labels<para>"상위총서 기본표목"</para><para>"main entry heading"</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>"제작지"</para>
    /// labels<para>"제작지"</para><para>"manufacturing place"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"회의 정보"</para><para>"meeting information"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"수정 날짜"</para><para>"modification date"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"시군구 레벨"</para><para>"municipal level"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"개관연도"</para><para>"opening year"</para></remarks>
    ...
    /// labels<para>"원본주기"</para><para>"original version note"</para></remarks>
    ...
    /// labels<para>"이용가능한 다른 형태자료 주기"</para><para>"physical form available note"</para></remarks>
    ...
    /// labels<para>"도법"</para><para>"projection"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"광역시도 레벨"</para><para>"provincial level"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"발행지"</para>
    /// labels<para>"발행지"</para><para>"publication place"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"발행되다"</para><para>"published in"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"등급"</para><para>"rank"</para></remarks>
    ...
    /// labels<para>"복제기관"</para><para>"reproduction institution"</para></remarks>
    ...
    /// labels<para>"이용제한사항"</para><para>"restriction"</para></remarks>
    ...
    /// labels<para>"축척"</para><para>"scale"</para></remarks>
    ...
    /// labels<para>"확인자료명"</para><para>"source of information"</para></remarks>
    ...
    /// labels<para>"표준기술보고서번호"</para><para>"Standard Technical Report Number"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"식별기호 ▾a는 관련 레코드 100(기본표목-개인명) 필드, 110(기본표목-단체명) 필드, 111(기본표목-회의명) 필드의 기본표목 데이터를 포함한다. 하지만 식별기호에서는 1XX 필드에서 사용하는 개별적인 이름의 요소나 통일표제는 기술되지 않는다."</para>
    /// labels<para>"하위총서저록 기본표목"</para><para>"subseries entry heading"</para></remarks>
    ...
    ///   <para>rdf:Property</para>
    ///
    /// labels<para>"부제목"</para><para>"subtitle"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>"하절기 개관시간"</para><para>"summer open time"</para></remarks>
    ...
    /// labels<para>"부록주기"</para><para>"supplement note"</para></remarks>
    ...
    /// labels<para>"기타형태저록 표제"</para><para>"title of additional physical form"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"식별기호 ▾t는 관련 레코드의 245(표제와 책임표시사항) 필드 또는 130(기본표목-통일표제) 필드의 식별기호 ▾a, ▾f, ▾g, ▾k, ▾n, ▾p로부터 표제정보를 기술한다. 표제의 개별적인 구성요소들은 별도의 식별기호로 부호화되지 않는다."</para>
    /// labels<para>"구성단위저록 표제"</para><para>"title of constituent unit"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"식별기호 ▾t는 관련 레코드의 245(표제와 책임표시사항) 필드 또는 130(기본표목-통일표제) 필드의 식별기호 ▾a, ▾f, ▾g, ▾k, ▾n, ▾p로부터 표제정보를 기술한다. 표제의 개별적인 구성요소들은 별도의 식별기호로 부호화되지 않는다."</para>
    /// labels<para>"이판저록 표제"</para><para>"title of other edition"</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"식별기호 ▾t는 관련 레코드의 245(표제와 책임표시사항) 필드 또는 130(기본표목-통일표제) 필드의 식별기호 ▾a, ▾f, ▾g, ▾k, ▾n, ▾p로부터 표제정보를 기술한다. 표제의 개별적인 구성요소들은 별도의 식별기호로 부호화되지 않는다."</para>
    /// labels<para>"선행저록 표제"</para><para>"title of preceding"</para></remarks>
    ...
    /// labels<para>"총서표제"</para><para>"title of series"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"연속자료유형"</para><para>"type of continuous data"</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>"자료유형"</para><para>"type of data"</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>"한국형 URN 식별 체계"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"국가디지털콘텐츠식별체계"</para><para>"Universal Content Identifier"</para></remarks>
    ...
    /// labels<para>"통일표제"</para><para>"uniform title of series"</para></remarks>
    ...
    /// labels<para>"volume of NLK"</para><para>"국립중앙도서관 청구기호 권연차기호"</para></remarks>
    ...
    /// labels<para>"총서번호"</para><para>"volume of series"</para></remarks>
