...
module submit =
    ...
    /// labels<para>"Circularity Performance"</para><para>"Performance Circularité"</para></remarks>
    ...
    /// labels<para>"Identifiant Composé"</para><para>"Compound Identifier"</para></remarks>
    ...
    /// labels<para>"Critère"</para><para>"Criterion"</para></remarks>
    ...
    /// labels<para>"Diagnostic"</para></remarks>
    ...
    /// labels<para>"Economic Operator"</para><para>"Opérateur Économique"</para></remarks>
    ...
    /// labels<para>"Emissions Performance"</para><para>"Performance Émissions"</para></remarks>
    ...
    /// labels<para>"Product Lifecycle Stage"</para><para>"Étape du Cycle de Vie du Produit"</para></remarks>
    ...
    /// labels<para>"Product Passport"</para><para>"Passeport Produit"</para></remarks>
    ...
    /// labels<para>"Product Status"</para><para>"Statut Produit"</para></remarks>
    ...
    /// labels<para>"Repairer"</para><para>"Réparateur"</para></remarks>
    ...
    /// labels<para>"Secure Link"</para><para>"Lien Sécurisé"</para></remarks>
    ...
    /// labels<para>"Service Request"</para><para>"Demande de Service"</para></remarks>
    ...
    /// labels<para>"Traceability Event"</para><para>"Événement de Traçabilité"</para></remarks>
    ...
    /// labels<para>"Verifiable Credential"</para><para>"Credential Vérifiable"</para></remarks>
    ...
    /// labels<para>"Verifiable Product Passport"</para><para>"Passeport Produit Vérifiable"</para></remarks>
    ...
    /// labels<para>"Warranty Claim"</para><para>"Réclamation de Garantie"</para></remarks>
    ...
    /// labels<para>"accuracy"</para><para>"précision"</para></remarks>
    ...
    /// labels<para>"belongs to"</para><para>"appartient à"</para></remarks>
    ...
    /// labels<para>"carbon footprint"</para><para>"empreinte carbone"</para></remarks>
    ...
    /// labels<para>"claim description"</para><para>"description de la réclamation"</para></remarks>
    ...
    /// labels<para>"conformity topic"</para><para>"thème de conformité"</para></remarks>
    ...
    /// labels<para>"data integrity hash"</para><para>"hash d'intégrité des données"</para></remarks>
    ...
    /// labels<para>"declared value"</para><para>"valeur déclarée"</para></remarks>
    ...
    /// labels<para>"diagnostic description"</para><para>"description du diagnostic"</para></remarks>
    ...
    /// labels<para>"encryption method"</para><para>"méthode de cryptage"</para></remarks>
    ...
    /// labels<para>"European Unique Identifier (EUID)"</para><para>"Identifiant Unique Européen (EUID)"</para></remarks>
    ...
    /// labels<para>"URI GS1 Digital Link"</para><para>"GS1 Digital Link URI"</para></remarks>
    ...
    /// labels<para>"has conformity claim"</para><para>"a pour déclaration de conformité"</para></remarks>
    ...
    /// labels<para>"has constituent product"</para><para>"a pour produit constituant"</para></remarks>
    ...
    /// labels<para>"has economic operator"</para><para>"a pour opérateur économique"</para></remarks>
    ...
    /// labels<para>"has emissions scorecard"</para><para>"a pour tableau de bord émissions"</para></remarks>
    ...
    /// labels<para>"Global Location Number (GLN)"</para><para>"Code Lieu International (GLN)"</para></remarks>
    ...
    /// labels<para>"has repairer"</para><para>"a pour réparateur"</para></remarks>
    ...
    /// labels<para>"has replacement part"</para><para>"a pour pièce de rechange"</para></remarks>
    ...
    /// labels<para>"has retailer"</para><para>"a pour distributeur"</para></remarks>
    ...
    /// labels<para>"has secure data share"</para><para>"a pour partage de données sécurisé"</para></remarks>
    ...
    /// labels<para>"has verifiable credential"</para><para>"a pour credential vérifiable"</para></remarks>
    ...
    /// labels<para>"a identité vérifiée"</para><para>"has verified identity"</para></remarks>
    ...
    /// labels<para>"has warranty"</para><para>"a pour garantie"</para></remarks>
    ...
    /// labels<para>"has warranty claim"</para><para>"a pour réclamation"</para></remarks>
    ...
    /// labels<para>"hash method"</para><para>"méthode de hash"</para></remarks>
    ...
    /// labels<para>"intervention type"</para><para>"type d'intervention"</para></remarks>
    ...
    /// labels<para>"labor cost"</para><para>"coût main d'œuvre"</para></remarks>
    ...
    /// labels<para>"lifecycle stage date"</para><para>"date de l'étape du cycle de vie"</para></remarks>
    ...
    /// labels<para>"link type"</para><para>"type de lien"</para></remarks>
    ...
    /// labels<para>"link URL"</para><para>"URL du lien"</para></remarks>
    ...
    /// labels<para>"manufacturing date"</para><para>"date de fabrication"</para></remarks>
    ...
    /// labels<para>"mass fraction"</para><para>"fraction massique"</para></remarks>
    ...
    /// labels<para>"material name"</para><para>"nom du matériau"</para></remarks>
    ...
    /// labels<para>"pays d'origine"</para><para>"origin country"</para></remarks>
    ...
    /// labels<para>"part name"</para><para>"nom de la pièce"</para></remarks>
    ...
    /// labels<para>"primary sourced ratio"</para><para>"ratio de sourcing primaire"</para></remarks>
    ...
    /// labels<para>"product status"</para><para>"statut du produit"</para></remarks>
    /// <seealso href="https://ns.verisav.fr/dpp#productStatus">https://ns.verisav.fr/dpp#productStatus</seealso>
    let productStatus = Prefixed_Name(submit, "productStatus") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>"product status date"</para><para>"date du statut produit"</para></remarks>
    ...
    /// labels<para>"recyclable content"</para><para>"contenu recyclable"</para></remarks>
    ...
    /// labels<para>"contenu recyclé"</para><para>"recycled content"</para></remarks>
    ...
    /// labels<para>"repair information"</para><para>"information réparation"</para></remarks>
    ...
    /// labels<para>"repair status"</para><para>"statut de réparation"</para></remarks>
    ...
    /// labels<para>"shared with"</para><para>"partagé avec"</para></remarks>
    ...
    /// labels<para>"ID standard"</para><para>"standard ID"</para></remarks>
    ...
    /// labels<para>"durée de garantie en mois"</para><para>"warranty duration in months"</para></remarks>
    ...
    /// labels<para>"warranty start date"</para><para>"date de début de garantie"</para></remarks>
    ...
    /// labels<para>"warranty type"</para><para>"type de garantie"</para></remarks>
    ...
    /// labels<para>"work order number"</para><para>"numéro d'ordre de travail"</para></remarks>
    ...
    /// labels<para>"work order priority"</para><para>"priorité de l'ordre de travail"</para></remarks>
    ...
    /// labels<para>"work order status"</para><para>"statut de l'ordre de travail"</para></remarks>
