...
module submit =
    ...
    /// labels<para>référence standard</para><para>reference standard</para></remarks>
    ...
    /// labels<para>Consignes de Recyclage</para><para>Recycling Instructions</para></remarks>
    ...
    /// labels<para>nom du critère</para><para>criterion name</para></remarks>
