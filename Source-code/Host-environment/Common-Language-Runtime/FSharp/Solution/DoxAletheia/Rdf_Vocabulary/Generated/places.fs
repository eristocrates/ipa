...
module places =
    ...
    /// labels<para>Lake</para><para>Lake</para><para>Lake</para><para>Lago</para><para>Lake</para><para>湖</para></remarks>
    ...
    /// labels<para>Municipality</para><para>Municipalité</para><para>Municipality</para><para>Municipio</para><para>Gemeinde</para><para>市</para></remarks>
    ...
    /// labels<para>Parroquia</para><para>Gemeinde</para><para>Paroisse</para><para>Parish</para><para>Parish</para><para>教区</para></remarks>
    ...
    /// labels<para>Halbinsel</para><para>Péninsule</para><para>Peninsula</para><para>Península</para><para>Peninsula</para><para>半岛</para></remarks>
    ...
    /// labels<para>Plate</para><para>Placa</para><para>Plate</para><para>Plate</para><para>Tafel</para><para>板</para></remarks>
    ...
    /// labels<para>Reservoir</para><para>Réservoir</para><para>Reservoir</para><para>Reservoir</para><para>Depósito</para><para>水库</para></remarks>
    ...
    /// labels<para>Mer</para><para>Sea</para><para>Sea</para><para>Mar</para><para>Sea</para><para>海</para></remarks>
    ...
    /// labels<para>Estado</para><para>State</para><para>Staat</para><para>State</para><para>État</para><para>国家</para></remarks>
    ...
    /// labels<para>Estrecho</para><para>Meerenge</para><para>Détroit</para><para>Strait</para><para>Strait</para><para>海峡</para></remarks>
    ...
    /// labels<para>Playa</para><para>Beach</para><para>Beach</para><para>Beach</para><para>Beach</para><para>海滩</para></remarks>
    ...
    /// labels<para>Cabo</para><para>Cape</para><para>Cape</para><para>Cape</para><para>Cap</para><para>披肩</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>A region of governance.</para>
    /// labels<para>District</para><para>Distrito</para><para>District</para><para>District</para><para>Bezirk</para><para>区</para></remarks>
    ...
    /// labels<para>Path</para><para>Ruta</para><para>Path</para><para>Path</para><para>Path</para><para>路径</para></remarks>
    ...
    /// labels<para>Région</para><para>Region</para><para>Región</para><para>Region</para><para>Region</para><para>区</para></remarks>
    ...
    /// labels<para>Estuaire</para><para>Estuario</para><para>Mündung</para><para>Estuary</para><para>Estuary</para><para>河口</para></remarks>
    ...
    /// labels<para>Golfo</para><para>Golfe</para><para>Gulf</para><para>Gulf</para><para>Gulf</para><para>海湾</para></remarks>
    ...
    /// labels<para>Hamlet</para><para>Hamlet</para><para>Hamlet</para><para>Weiler</para><para>Aldea</para><para>村庄</para></remarks>
    ...
    /// labels<para>Valley</para><para>Vallée</para><para>Valley</para><para>Valley</para><para>Valle</para><para>谷</para></remarks>
    ...
    /// labels<para>Volcano</para><para>Volcano</para><para>Volcan</para><para>Volcán</para><para>Vulkan</para><para>火山</para></remarks>
    ...
    /// labels<para>dans</para><para>in</para><para>en</para><para>in</para><para>in</para><para>在</para></remarks>
    ...
    /// labels<para>Gletscher</para><para>Glacier</para><para>Glacier</para><para>Glacier</para><para>Glaciar</para><para>冰川</para></remarks>
