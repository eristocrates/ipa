...
module appear =
    ...
    ///
    /// labels<para>"RIDDELL, W. J. B.. STUDIES IN THE CLASSIFICATION OF EYE COLOUR. Annals of Eugenics 11(1), Blackwell Publishing Ltd, 1941"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>swrc:Publication</para>
    ///
    /// labels<para>"GRIEVE, J., MORANT, G. M.. RECORDS OF EYE COLOURS FOR BRITISH POPULATIONS AND A DESCRIPTION OF A NEW EYE-COLOUR SCALE. Annals of Eugenics 13(1), Blackwell Publishing Ltd, 1946"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>appear:EyeColorICCS</para>
    ///
    /// labels<para>"Blue with Brown Specks (ICCS #1)"</para><para>"Blue with Yellow Specks (ICCS #1)"</para><para>"Gray with Yellow Specks (ICCS #1)"</para><para>"Gray with Brown Specks (ICCS #1)"</para></remarks>
    ...
    ///   <para>appear:EyeColorICCS</para>
    ///
    /// labels<para>"Gray with Yellow Specks (ICCS #2)"</para><para>"Green with Brown Specks (ICCS #2)"</para><para>"Gray with Brown Specks (ICCS #2)"</para><para>"Blue with Brown Specks (ICCS #2)"</para><para>"Green with Yellow Specks (ICCS #2)"</para><para>"Blue with Yellow Specks (ICCS #2)"</para></remarks>
    ...
    ///   <para>appear:EyeColorICCS</para>
    ///
    /// labels<para>"Green with Brown Specks (ICCS #3)"</para><para>"Light Brown with Yellow Specks (ICCS #3)"</para><para>"Green with Yellow Specks (ICCS #3)"</para><para>"Light Brown with Brown Specks (ICCS #3)"</para></remarks>
    ...
    ///   <para>appear:EyeColorPetrequin</para>
    ///
    /// labels<para>"Blue (Pétrequin)"</para><para>"Bleus (Pétrequin)"</para></remarks>
    ...
    ///   <para>appear:EyeColorPetrequin</para>
    ///
    /// labels<para>"Bruns (Pétrequin)"</para><para>"Brown (Pétrequin)"</para></remarks>
    ...
    ///   <para>appear:EyeColorPetrequin</para>
    ///
    /// labels<para>"Gris (Pétrequin)"</para><para>"Gray (Pétrequin)"</para><para>"Grey (Pétrequin)"</para></remarks>
    ...
    ///   <para>appear:GenderSimple</para>
    ///
    /// labels<para>"Frau"</para><para>"Woman"</para><para>"Femme"</para></remarks>
    ...
    ///   <para>appear:HairColorAtlas</para>
    ///
    /// labels<para>"Gray (Human Hair Atlas)"</para><para>"White (Human Hair Atlas)"</para></remarks>
    ...
    ///   <para>swrc:Book</para>
    ///
    /// labels<para>"Ogle, Robert R, Fox, Michelle J. Atlas of human hair microscopic characteristics, CRC Press, 1999"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>appear:SexISO5218</para>
    ///
    /// labels<para>"Sex Inconnu"</para><para>"Mann"</para><para>"Gender Unknown"</para></remarks>
    ...
    ///   <para>appear:SexISO5218</para>
    ///
    /// labels<para>"Mann"</para><para>"Man"</para><para>"Homme"</para></remarks>
    ...
    ///   <para>appear:SexISO5218</para>
    ///
    /// labels<para>"Frau"</para><para>"Femme"</para><para>"Woman"</para></remarks>
    ...
    ///   <para>appear:SkinColorFitzpatrickType</para>
    ///
    /// labels<para>"Albino"</para><para>"Very Fair"</para><para>"Freckles"</para><para>"White"</para></remarks>
    ...
    ///   <para>appear:SkinColorFitzpatrickType</para>
    ///
    /// labels<para>"Light intermediate"</para><para>"Dark-skinned European"</para></remarks>
    ...
    ///   <para>appear:SkinColorFitzpatrickType</para>
    ///
    /// labels<para>"Olive Skin"</para><para>"Dark intermediate"</para><para>"Beige with a brown tint"</para><para>"Mediterranean"</para><para>"Mediterranean Caucasian"</para></remarks>
    ...
    ///   <para>appear:SkinColorFitzpatrickType</para>
    ///
    /// labels<para>"Dark brown"</para><para>"Dark"</para><para>"Brown"</para></remarks>
    ...
    ///   <para>appear:SkinColorFitzpatrickType</para>
    ///
    /// labels<para>"Black"</para><para>"Very Dark"</para></remarks>
    ...
    ///   <para>swrc:Article</para>
    ///
    /// labels<para>"J. Petrequin. Sur les diverses couleurs de l'iris et leurs proportions dens nos climats.. Annales D'oculistique 10, Florent Cunier, 1843"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>swrc:Publication</para>
    ///
    /// labels<para>"J. M. Seddon, C. R. Sahagian, R. J. Glynn, R. D. Sperduto, E. S. Gragoudas. Evaluation of an iris color classification system. The Eye Disorders Case-Control Study Group.. Investigative Ophthalmology &amp; Visual Science 31(8), August, 1990"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>swrc:Book</para>
    ///
    /// labels<para>"William Robert Wilde. An Essay on the malformations and congenital diseases of the organs of sight, John Churchill, 1862"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
