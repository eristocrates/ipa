...
module coo =
    ...
    let ConfigurationInfo = _prefix "ConfigurationInfo"
    /// <summary>
    ...
    let ChoiceOrComponent = _prefix "ChoiceOrComponent"
    /// <summary>
    ...
    let RelativePriceSpecification = _prefix "RelativePriceSpecification"
    /// <summary>
    ...
    let CompleteCarModel = _prefix "CompleteCarModel"
    /// <summary>
    ...
    let SpecItemCollection = _prefix "SpecItemCollection"
    /// <summary>
    ...
    let availableChoice = _prefix "availableChoice"
    /// <summary>
    ...
    let displayPos = _prefix "displayPos"
    /// <summary>
    ...
    let featureOverride = _prefix "featureOverride"
    /// <summary>
    ...
    let hasCompleteCarModel = _prefix "hasCompleteCarModel"
    /// <summary>
    /// Links a Derivative to a Trim
    /// <see href="http://purl.org/coo/ns#hasDerivative"></see></summary>
    let hasDerivative = _prefix "hasDerivative"
    /// <summary>
    ...
    let includesChoices = _prefix "includesChoices"
    /// <summary>
    ...
    let priceModifier = _prefix "priceModifier"
    /// <summary>
