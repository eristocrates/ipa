...
module foaf =
    ...
    let currentProject =
        Prefixed_Name(foaf, "currentProject")
        |> PrefixedName
    ...
    let primaryTopic =
        Prefixed_Name(foaf, "primaryTopic")
        |> PrefixedName
    ...
    let Organization =
        Prefixed_Name(foaf, "Organization")
        |> PrefixedName
    ...
    let LabelProperty =
        Prefixed_Name(foaf, "LabelProperty")
        |> PrefixedName
    ...
    let OnlineEcommerceAccount =
        Prefixed_Name(foaf, "OnlineEcommerceAccount")
        |> PrefixedName
    ...
    let OnlineAccount =
        Prefixed_Name(foaf, "OnlineAccount")
        |> PrefixedName
    ...
    let PersonalProfileDocument =
        Prefixed_Name(foaf, "PersonalProfileDocument")
        |> PrefixedName
    ...
    let accountServiceHomepage =
        Prefixed_Name(foaf, "accountServiceHomepage")
        |> PrefixedName
    ...
    let mbox_sha1sum =
        Prefixed_Name(foaf, "mbox_sha1sum")
        |> PrefixedName
    ...
    let membershipClass =
        Prefixed_Name(foaf, "membershipClass")
        |> PrefixedName
    ...
    let publications =
        Prefixed_Name(foaf, "publications")
        |> PrefixedName
    ...
    let schoolHomepage =
        Prefixed_Name(foaf, "schoolHomepage")
        |> PrefixedName
    ...
    let topic_interest =
        Prefixed_Name(foaf, "topic_interest")
        |> PrefixedName
    ...
    let workplaceHomepage =
        Prefixed_Name(foaf, "workplaceHomepage")
        |> PrefixedName
    ...
    let OnlineChatAccount =
        Prefixed_Name(foaf, "OnlineChatAccount")
        |> PrefixedName
    ...
    let OnlineGamingAccount =
        Prefixed_Name(foaf, "OnlineGamingAccount")
        |> PrefixedName
    ...
    let holdsAccount =
        Prefixed_Name(foaf, "holdsAccount")
        |> PrefixedName
    ...
    let isPrimaryTopicOf =
        Prefixed_Name(foaf, "isPrimaryTopicOf")
        |> PrefixedName
    ...
    let workInfoHomepage =
        Prefixed_Name(foaf, "workInfoHomepage")
        |> PrefixedName
