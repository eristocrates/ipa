...
module rma =
    ...
    /// labels<para>"Verisav RMA Vocabulary"</para><para>"Vocabulaire RMA Verisav"</para></remarks>
    ...
    /// labels<para>"Approval"</para><para>"Approbation"</para></remarks>
    ...
    /// labels<para>"Résolution"</para><para>"Resolution"</para></remarks>
    ...
    /// labels<para>"Return Request"</para><para>"Demande de Retour"</para></remarks>
    ...
    /// labels<para>"Shipping Label"</para><para>"Étiquette d'Expédition"</para></remarks>
    ...
    /// labels<para>"approval comment"</para><para>"commentaire d'approbation"</para></remarks>
    ...
    /// labels<para>"approved by"</para><para>"approuvé par"</para></remarks>
    ...
    /// labels<para>"carrier service"</para><para>"service transporteur"</para></remarks>
    ...
    /// labels<para>"concerns product"</para><para>"concerne le produit"</para></remarks>
    ...
    /// labels<para>"dispute date"</para><para>"date du litige"</para></remarks>
    ...
    /// labels<para>"estimated delivery date"</para><para>"date de livraison estimée"</para></remarks>
    ...
    /// labels<para>"expected return date"</para><para>"date de retour attendue"</para></remarks>
    ...
    /// labels<para>"traité par"</para><para>"handled by"</para></remarks>
    ...
    /// labels<para>"has resolution"</para><para>"a pour résolution"</para></remarks>
    ...
    /// labels<para>"has shipping label"</para><para>"a pour étiquette d'expédition"</para></remarks>
    ...
    /// labels<para>"has ticket"</para><para>"a pour ticket"</para></remarks>
    ...
    /// labels<para>"label expiry date"</para><para>"date d'expiration de l'étiquette"</para></remarks>
    ...
    /// labels<para>"message type"</para><para>"type de message"</para></remarks>
    ...
    /// labels<para>"resolution amount"</para><para>"montant de résolution"</para></remarks>
    ...
    /// labels<para>"resolution currency"</para><para>"devise de résolution"</para></remarks>
    ...
    /// labels<para>"resolution date"</para><para>"date de résolution"</para></remarks>
    ...
    /// labels<para>"resolution description"</para><para>"description de résolution"</para></remarks>
    ...
    /// labels<para>"resolution status"</para><para>"statut de résolution"</para></remarks>
    ...
    /// labels<para>"results in work order"</para><para>"résulte en ordre de travail"</para></remarks>
    ...
    /// labels<para>"return reason"</para><para>"raison du retour"</para></remarks>
    ...
    /// labels<para>"return request date"</para><para>"date de demande de retour"</para></remarks>
    ...
    /// labels<para>"return request number"</para><para>"numéro de demande de retour"</para></remarks>
    ...
    /// labels<para>"ticket created date"</para><para>"date de création du ticket"</para></remarks>
    ...
    /// labels<para>"ticket number"</para><para>"numéro de ticket"</para></remarks>
    ...
    /// labels<para>"ticket priority"</para><para>"priorité du ticket"</para></remarks>
    ...
    /// labels<para>"ticket status"</para><para>"statut du ticket"</para></remarks>
    ...
    /// labels<para>"numéro de suivi"</para><para>"tracking number"</para></remarks>
    ...
    /// labels<para>"URL de suivi"</para><para>"tracking URL"</para></remarks>
