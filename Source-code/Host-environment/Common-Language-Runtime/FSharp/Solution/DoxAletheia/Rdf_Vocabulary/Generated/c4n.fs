...
module c4n =
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>"a call"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"a condition under which the call event has to be understood"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"a condition"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"a temporal condition that must be met to comply the call"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"a deadline"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///   <para>owl:Class</para>
    ///   <para>"an event a call refers to"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"an event"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>rdfs:Class</para>
    ///
    /// labels<para>"the issuer of the call"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///   <para>rdfs:Class</para>
    ///   <para>"a geographic condition that must be met to comply the call"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"a spatial scope"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    ...
    ///
    /// labels<para>"must meet condition"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
    /// <seealso href="http://vocab.deri.ie/c4n#condition">http://vocab.deri.ie/c4n#condition</seealso>
    let condition = Prefixed_Name(c4n, "condition") |> PrefixedName
    /// <summary>
    ///   <para>c4n:for</para>
    ...
    /// <remarks>
    ///   <para>rdf:Property</para>
    ///   <para>"restricts the call to a certain event"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para>
    /// labels<para>"for"^^&lt;http://www.w3.org/2001/XMLSchema#string&gt;</para></remarks>
