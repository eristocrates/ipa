...
module vgo =
    ...
    let Curiosity = _prefix "Curiosity"
    /// <summary>
    ...
    let GainEvent = _prefix "GainEvent"
    /// <summary>
    ...
    let GameProduct = _prefix "GameProduct"
    /// <summary>
    ...
    let PlayingArea = _prefix "PlayingArea"
    /// <summary>
    ...
    let InAppPurchaseEvent = _prefix "InAppPurchaseEvent"
    /// <summary>
    ...
    let Leaderboard = _prefix "Leaderboard"
    /// <summary>
    ...
    let LoseEvent = _prefix "LoseEvent"
    /// <summary>
    ...
    let MenuEvent = _prefix "MenuEvent"
    /// <summary>
    ...
    let PlayerEvent = _prefix "PlayerEvent"
    /// <summary>
    ...
    let SpecialPlayStyle = _prefix "SpecialPlayStyle"
    /// <summary>
    ...
    let Virtuosity = _prefix "Virtuosity"
    /// <summary>
    ...
    let hasAchievement = _prefix "hasAchievement"
    /// <summary>
    ...
    let hasGameGenre = _prefix "hasGameGenre"
    /// <summary>
    ...
    let hasLeaderboard = _prefix "hasLeaderboard"
    /// <summary>
    ...
    let isLeaderboardInGame = _prefix "isLeaderboardInGame"
    /// <summary>
    ...
    let hasPlayingArea = _prefix "hasPlayingArea"
    /// <summary>
    ...
    let involvesAchievement = _prefix "involvesAchievement"
    /// <summary>
    ...
    let involvesCharacter = _prefix "involvesCharacter"
    /// <summary>
    /// The vgo:involvesPlayer property specifies that a session involves a specific player. A session may involve more than one player.
    /// optional
    /// <see href="http://purl.org/net/VideoGameOntology#involvesPlayer"></see></summary>
    let involvesPlayer = _prefix "involvesPlayer"
    /// <summary>
    ...
    let isAchievedInSession = _prefix "isAchievedInSession"
    /// <summary>
    ...
    let isAchievementInGame = _prefix "isAchievementInGame"
    /// <summary>
    ...
    let isCharacterInGame = _prefix "isCharacterInGame"
    /// <summary>
    ...
    let isCharacterInSession = _prefix "isCharacterInSession"
    /// <summary>
    ...
    let isEventAssociatedToPlayer = _prefix "isEventAssociatedToPlayer"
    /// <summary>
    ...
    let isEventInGame = _prefix "isEventInGame"
    /// <summary>
    ...
    let isEventInSession = _prefix "isEventInSession"
    /// <summary>
    ...
    let isEventRelatedToItem = _prefix "isEventRelatedToItem"
    /// <summary>
    ...
    let isEventTriggeredByCharacter = _prefix "isEventTriggeredByCharacter"
    /// <summary>
    ...
    let isFriendWithPlayer = _prefix "isFriendWithPlayer"
    /// <summary>
    ...
    let isItemInGame = _prefix "isItemInGame"
    /// <summary>
    ...
    let isPlayerInSession = _prefix "isPlayerInSession"
    /// <summary>
    ...
    let isSessionInGame = _prefix "isSessionInGame"
    /// <summary>
    ...
    let ownsAchievement = _prefix "ownsAchievement"
    /// <summary>
    ...
    let ownsCharacter = _prefix "ownsCharacter"
    /// <summary>
    ...
    let playsGame = _prefix "playsGame"
    /// <summary>
    ...
    let purchasesGameOffering = _prefix "purchasesGameOffering"
    /// <summary>
    ...
    let unlocksAchievement = _prefix "unlocksAchievement"
    /// <summary>
