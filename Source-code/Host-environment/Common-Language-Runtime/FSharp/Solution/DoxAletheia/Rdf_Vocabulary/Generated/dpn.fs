...
module dpn =
    ...
    let DataServiceInterface = _prefix "DataServiceInterface"
    /// <summary>
    ...
    let ServiceInterface = _prefix "ServiceInterface"
    /// <summary>
    ...
    let FeatureTypeCatalogue = _prefix "FeatureTypeCatalogue"
    /// <summary>
    /// An abstract interface for information model services
    /// <see href="http://purl.org/dpn#InfoModelServiceInterface"></see></summary>
    let InfoModelServiceInterface = _prefix "InfoModelServiceInterface"
    /// <summary>
    ...
    let IdentifierService = _prefix "IdentifierService"
    /// <summary>
    ...
    let LinkedDataApiOperation = _prefix "LinkedDataApiOperation"
    /// <summary>
    ...
    /// </summary>
    let MessageContent_1 = _prefix "MessageContent_1"
    /// <summary>
    /// An abstract interface for metadata services
    /// <see href="http://purl.org/dpn#MetadataServiceInterface"></see></summary>
    let MetadataServiceInterface = _prefix "MetadataServiceInterface"
    /// <summary>
    ...
    let exposesService = _prefix "exposesService"
    /// <summary>
    ///   <see href="http://purl.org/dpn#providesServiceInterface"></see>
    /// </summary>
    let providesServiceInterface = _prefix "providesServiceInterface"
    /// <summary>
    /// An abstract interface for provenance services
    /// <see href="http://purl.org/dpn#ProvenanceServiceInterface"></see></summary>
    let ProvenanceServiceInterface = _prefix "ProvenanceServiceInterface"
    /// <summary>
    ...
    let hostsDataset = _prefix "hostsDataset"
    /// <summary>
    ...
    let VocabularyServiceInterface = _prefix "VocabularyServiceInterface"
    /// <summary>
    ...
    let hostsNode = _prefix "hostsNode"
    /// <summary>
