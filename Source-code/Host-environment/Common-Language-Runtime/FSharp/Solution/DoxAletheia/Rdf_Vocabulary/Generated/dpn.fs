...
module dpn =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An abstract class of data service interfaces</para>
    /// labels<para>Data Service Interface</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A catalog is a curated set of metadata about datasets</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Property to express relationship between resources in a data provider node context</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Class to represent datasets, which are collections of data. Datasets are accessed via a means of a Distribution, e.g. via a service which can be defined as a type of distribution method or a direct download.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Property to describe who the manager of the resource is.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A Feature Type Catalogue (FTC) gives an informative overview of the spatial object types (features) and data types. Generally an FTC implements a registry of feature types which allow features to be described.</para>
    /// labels<para>Feature Type Catalogue</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Persistent Identifier Service allows registry and deferencing identifier handles.</para>
    /// labels<para>Persistent Identifier Service</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Lightweight description for a Web Service through which data may be accessed</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>This property allows a resource to specify the services that it exposes. e.g. a Data provider node may expose a data service. The complement of this could be dpn:node to specify a Service's data provider node</para>
    /// labels<para>exposes service</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An abstract interface for provenance services</para>
    /// labels<para>Provenance Service Interface</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>This property captures the association between a service and its interface specification. This is the inverse to hasImplementation.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An abstract class for defining service interface standards for which services may implement</para>
    /// labels<para>Service Interface Standard</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Property to express the entity which hosts a given resource. This is the inverse of dpn:hosts</para>
    /// labels<para>hosted by</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An abstract interface for metadata services</para>
    /// labels<para>Metadata Service Interface</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A data provider node is a class of things that exposes concrete service implementations and/or describes a number of service interfaces that it supports. This allows discovery of services or service capabilities for a given data provider node.</para>
    /// labels<para>Data provider node</para></remarks>
    /// <seealso href="http://purl.org/dpn#Node">http://purl.org/dpn#Node</seealso>
    let Node = Prefixed_Name(dpn, "Node") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>This property allows association of a service to datasets that it hosts.</para>
    /// labels<para>hosts dataset</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Property to associate a resource with a resolvable endpoint URL. e.g. to a URL of a catalog or a GetCapabilities description.</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An abstract interface or API for a vocabulary service, which typically hosts a set of well-governed controlled vocabularies.</para>
    /// labels<para>Vocabulary Service Interface</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>Link a resource to a relevant contact provided using VCard</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>This property captures the association between a service interface specification and resources that has its service implementations</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A property to describe what entities are managed by a resource</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Property to express what is owned by a resource in the context of a data provider node and its datasets. This is the inverse of dpn:owner</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Property to express the resource which the entity hosts. This is the inverse of dpn:hostedBy.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>An organisation can host a data provider node</para>
    /// labels<para>hosts node</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Property to express the owner of a resource. This is the inverse to dpn:owns</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Property to express the related service resource</para>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>An abstract interface for information model services</para>
    /// labels<para>Information Model Service Interface</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>Description of a Linked Data API operation</para>
    /// labels<para>Linked Data API Operation</para></remarks>
