...
module rains =
    ...
    /// <summary>
    ///   <para>rains:ApprovalDecision</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of a planned human decision representing approvals and sign offs.</para>
    /// labels<para>Approval Decision</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:SystemExplanationMechanism</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A type of :RealizableObjectCharacteristic detailing how :AI_System produces human readable clarifications and justifications of its inner processes and outputs produced.</para>
    /// labels<para>System Explanation Mechanism</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:SystemSecurityMechanism</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A type of :RealizableObjectCharacteristic detailing how :AI_System may be safeguarded against adversarial attacks or potential breaches of security.</para>
    /// labels<para>System Security Mechanism</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:SupportingInfrastructure</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A type of :RealizableObject detailing the hardware and software 'plumbing' that is not generally considered part of the AI processes, however, may also be source of erroneous behaviour in :AI_System.</para>
    /// labels<para>Supporting Infrastructure</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:RealizableObjectCharacteristic</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A sao:InformationElement  which records  information detailing  a specific quality of :RealizableObject.</para>
    /// labels<para>Realizable Object Characteristic</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:ExcludedObject</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    ///
    /// For example, assume the dataset design specification specifies that dataset foorbar is to be realised (to be used to train the model), but the implementation team realises dataset xyzzy instead. In this case, the dataset foobar should be indicated by the implementation team as an Excluded Object - whereas the dataset xyzzy should be created as an instance of :RealizedObject.</para>
    /// labels<para>Excluded Object</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:RealizededObject</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    ///
    /// For example, assume the dataset design specification specifies that dataset foorbar is to be realised (to be used to train the model), but the implementation team realises dataset xyzzy. In this case, only dataset xyzzy is created as an instance of Realized Object.</para>
    /// labels<para>Realized Object</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:EvaluationProcedure</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A sao:InformationElement  which records a specific piece of  information detailing procedure by which some aspects of an :AI_Sytem were evaluated. This is broader than mls:EvaluationProcedure which relates to model evaluation.</para>
    /// labels<para>Evaluation Procedure</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:FitnessConfirmationDecision</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of planned human decision representing confirmation of fitness of some sao:AccountableResult t to its purpose.</para>
    /// labels<para>Fitness Confirmation Decision</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:SystemHumanOversightMechanism</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A type of :RealizableObjectCharacteristic detailing how :AI_System integrates human operators in its decision processes to offer them the opportunity to stop, review, or alter the outputs produced by the system.</para>
    /// labels<para>System Human Oversight Mechanism</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:SystemAuditMechanism</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A type of :RealizableObjectCharacteristic detailing how :AI_System may be interrogated about its inner processes and outputs produced.</para>
    /// labels<para>System Audit Mechanism</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:UseCase</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A sao:InformationElement which records a specific piece of information detailing a situation in which any component of :AI_System or the system as whole could potentially be used.</para>
    /// labels<para>Use Case</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:Limitation</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A sao:InformationElement  which records a specific piece of  information detailing the limitations of any aspect related to an :AI_System including the system as whole, its components (e.g., ML model),  or associated processes (e.g., evaluation).</para>
    ...
    /// <summary>
    ///   <para>rains:SystemDeploymentGuidance</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of :Guidance which records a specific piece of information about the guidance to how the :AI_System should be deployed.</para>
    /// labels<para>System Deployment Guidance</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:SystemDocumentationGuidance</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of :Guidance which records a specific piece of information about the guidance to how the :AI_System should be documented.</para>
    /// labels<para>System Documentation Guidance</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:SystemIntegrationGuidance</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of :Guidance which records a specific piece of information about the guidance to how the :AI_System should be integrated with other systems or services.</para>
    /// labels<para>System Integration Guidance</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:SystemMaintenanceGuidance</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of :Guidance which records a specific piece of information about the guidance to how the :AI_System should be maintained.</para>
    /// labels<para>System Maintenance Guidance</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:SystemUsageGuidance</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of :Guidance which records a specific piece of information about the guidance to how the :AI_System should be used.</para>
    /// labels<para>System Usage Guidance</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:TradeOff</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A sao:InformationElement  which records a specific piece of  information detailing tradeoffs to mitigate possible undesired or dangerous outcomes caused by any aspects of :AI_Sytem.</para>
    /// labels<para>TradeOff</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:computedOnDecisionThreshold</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>The decision threshold the metric that produced evaluation result was computed on. Inspired by the Model Card Toolkit schema https://github.com/tensorflow/model-card-toolkit/blob/master/model_card_toolkit/schema/v0.0.1/model_card.schema.json</para>
    /// labels<para>computedOnDecisionThreshold</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:computedOnSlice</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The description of slice that the metric which  produced evaluation result was computed on. Inspired by the Model Card Toolkit schema https://github.com/tensorflow/model-card-toolkit/blob/master/model_card_toolkit/schema/v0.0.1/model_card.schema.json</para>
    /// labels<para>computedOnSlice</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:hasBase64Image</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>A value indicating what an :InformationElement's base 64 image is in String format. Inspired by the Model Card Toolkit schema https://github.com/tensorflow/model-card-toolkit/blob/master/model_card_toolkit/schema/v0.0.1/model_card.schema.json</para>
    /// labels<para>hasBase64Image</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:hasEvaluationResult</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relation that links some evaluation measure to one or more results produced for this measure.</para>
    /// labels<para>hasEvaluationResult</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:isEvaluationResultOf</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relation that links a result to some evaluation measure for which the result was produced.</para>
    ...
    /// <summary>
    ///   <para>rains:hasInputFormat</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>A value describing the format of an input. Inspired by the Model Card Toolkit schema https://github.com/tensorflow/model-card-toolkit/blob/master/model_card_toolkit/schema/v0.0.1/model_card.schema.json</para>
    /// labels<para>hasInputFormat</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:hasMitigationStrategy</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>A value indicating what a :Risk's mitigation strategy is, expressed in String format. Inspired by the Model Card Toolkit schema https://github.com/tensorflow/model-card-toolkit/blob/master/model_card_toolkit/schema/v0.0.1/model_card.schema.json</para>
    /// labels<para>hasMitigationStrategy</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:hasOutputFormat</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>A value describing the format of an output. Inspired by the Model Card Toolkit schema https://github.com/tensorflow/model-card-toolkit/blob/master/model_card_toolkit/schema/v0.0.1/model_card.schema.json</para>
    /// labels<para>hasOutputFormat</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:hasRealizableObjectCharacteristic</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A relation that links a realizable object (e.g., model) to the information element describing its characteristic.</para>
    /// labels<para>hasRealizableObjectCharacteristic</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:hasResultValue</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>The description of the result value.</para>
    /// labels<para>hasResultValue</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:isReusedObject</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>A value indicating whether the :RealizableObject is a third party resource.</para>
    /// labels<para>isReusedObject</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:version</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>A value indicating what a :RealizableObject's version is. Inspired by the Model Card Toolkit schema https://github.com/tensorflow/model-card-toolkit/blob/master/model_card_toolkit/schema/v0.0.1/model_card.schema.json</para>
    ...
    /// <summary>
    ///   <para>rains:versionDate</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>A value indicating what the version date of a :RealizableObject's is. Inspired by the Model Card Toolkit schema https://github.com/tensorflow/model-card-toolkit/blob/master/model_card_toolkit/schema/v0.0.1/model_card.schema.json</para>
    /// labels<para>versionDate</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:versionNote</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>A value describing a note about the version date of a :RealizableObject. Inspired by the Model Card Toolkit schema https://github.com/tensorflow/model-card-toolkit/blob/master/model_card_toolkit/schema/v0.0.1/model_card.schema.json</para>
    /// labels<para>versionNote</para></remarks>
    ...
    ///
    /// If a mitigation strategy is used to abate the risk, then these can be indicated using the property :hasMitigationStrategy. It is advisable that information about the risk before and after mitigation is included.</para>
    ...
    ///
    /// It is advisable that the information realization corresponding to the Evaluation contains the following information element ChangeJustification.</para>
    ...
    /// <summary>
    ///   <para>rains:RealizeComponent</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A planned step describing the realization of a component. This includes implementing a component or retrieving it from a different (or third party) source. The realization of the component has some impact on the AI System, e.g. the implementation of the ML model or importing a third party dataset.</para>
    /// labels<para>Realize Component</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:ModelComponent</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// 9. SystemUsageGuidance</para>
    /// labels<para>Model Component</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:DatasetComponent</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// 12. Algorithm</para>
    /// labels<para>Dataset Component</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:DataPreprocessingSoftware</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A sao:InformationElement (which is also an osw:Software and a prov:SoftwareAgent)  which records  information detailing  a software  that was used to preprocess the dataset using to train the ML Model</para>
    /// labels<para>Data Preprocessing Software</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:RealizableObject</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// labels<para>Realizable Object</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:EvaluationMeassure</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A  sao:InformationElement which records a specific piece of  information detailing some measure used as part of an evaluation process. This is broader than mls:EvaluationMeassure which describes a measure related to a model performance.</para>
    /// labels<para>Evaluation Measure</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:Parameter</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A  sao:InformationElement which records a specific piece of  information describing a model's parameter. This is broader than mls:HyperParameter which describes only a hyperparameter of a model.</para>
    ...
    /// <summary>
    ///   <para>rains:EvaluationResult</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A  sao:InformationElement which records a specific piece of  information detailing the result of an evaluation process. This is broader than mls:EvaluationMeassure which describes a result related to a specific model evaluation.</para>
    /// labels<para>Evaluation Result</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:GenerateGuideline</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A planned step describing the creation of a guideline that has some impact on the AI System, e.g. the production of the deployment guideline describing how the AI System is to be deployed on-site or the production of the maintenance guideline describing how the AI System is to be maintained.</para>
    /// labels<para>Generate Guideline</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:AI_System</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>The AI System for which the accountability plan is specified.</para>
    ...
    /// <summary>
    ///   <para>rains:Funding</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A sao:InformationElement  which records a specific piece of  information detailing a funding source.</para>
    ...
    /// <summary>
    ///   <para>rains:SystemDeploymentGuideline</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// 3. SystemDocumentationGuidance</para>
    /// labels<para>System Deployment Guideline</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:SystemOperationGuideline</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// Guidance.
    /// 1. SystemIntegrationGuidance
    /// 2. SystemUsageGuidance</para>
    /// labels<para>System Operation Guideline</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:ThirdPartyEvaluation</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of :Evaluation which represents an evaluation performed by a third party independent of the developers of the AI System.</para>
    /// labels<para>Third Party Evaluation</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:ImplementationStageAccountabilityPlan</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A plan that identifies sao:AccountableAction(s) and sao:AccountableResult(s) relevant to the implementation stage of an AI system and  which are required to be documented for accountability purposes. The Accountable Actions that can be done at this stage are: Realize Component, Merge and Split Dataset, Evaluate, Generate Guideline, Grant Certification, and Decide.</para>
    /// labels<para>Implementation Stage Accountability Plan</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:Decide</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A planned step describing a decision to be taken by a human when incorporating accountability in AI Systems, e.g. approve the design of an ML Model.</para>
    /// labels<para>Decide</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:HumanDecision</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of a planned sao:AccountableResult which represents a decision made by a human.</para>
    /// labels<para>Human Decision</para></remarks>
    ...
    ///
    /// If a mitigation strategy is used to abate the bias, then these can be indicated using the property :hasMitigationStrategy. It is advisable that information about the bias before and after mitigation is included.</para>
    ...
    /// <summary>
    ///   <para>rains:AutoConstraint</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of planned Constraint that describes a constraint which can be evaluated automatically against corresponding accountability trace. Such constraint would normally link to its implementation (e.g., a SHACL rule) using the  https://w3id.org/ep-plan#hasConstraintImplementation property.</para>
    /// labels<para>Auto Constraint</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:Certificate</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A sao:InformnationElement which records information describing a certificate (e.g. an ISO certificate) that is granted during the implementation (or deployment or use and maintenance) life cycle stages.</para>
    ...
    /// <summary>
    ///   <para>rains:TrainingDataset</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of a Dataset Component  which represents a subset of the whole collected and pre-processed datasets after they were merged then split to be fed into the ML Model. This specific type represents the data used to train the ML Model. The other subsets are used to validate and evaluate the model.</para>
    /// labels<para>Training Dataset</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:IncorrectUseCase</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A type of :UseCase detailing a situation in which any component of :AI_System or the system as whole should not be used.</para>
    /// labels<para>Incorrect Use Case</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:IntendedUseCase</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A type of :UseCase detailing a situation in which any component of :AI_System or the system as whole is expected to be used.</para>
    /// labels<para>Intended Use Case</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:IntendedUserGroup</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A sao:InformationElement  which records a specific piece of  information detailing the target user audience for the functionality of the overall :AI_System or the components used to develop such system (e.g., a reused public training dataset or a model would be associated with this information).</para>
    /// labels<para>Intended User Group</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:CertificationDecision</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of a planned human compliance assurance decision representing certification granting. This is usually done by third parties, but may also be done inhouse to prove that the AI System abides by internal policies.</para>
    /// labels<para>Certification Decision</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:Evaluate</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A planned step describing an evaluation, i.e, testing  and producing evaluation metrics, that has some impact on the AI System, e.g. the evaluation of the ML model using a specified Dataset or the :AI_System undergoing a third party evaluation.</para>
    ...
    /// <summary>
    ///   <para>rains:DesignSpecification</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of planned sao:AccountableResult which represents a high level reference to a specification  (e.g. a specification report) that is expected to be produced during the design stage in order to inform the future AI system lifecycle stages (e.g. implementation).</para>
    ...
    /// <summary>
    ///   <para>rains:ComplianceEntity</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of sao:InformationElement which records a specific piece of  information about  a compliance requirement that is to be complied with as part of an information realization collection.</para>
    /// labels<para>Compliance Entity</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:ProduceSpecification</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A planned step describing the creation of a specification that has some impact on the AI System, e.g. the production of the design specification describing the training dataset to be used. This step is typically part of the Design stage of an AI System's life cycle.</para>
    /// labels<para>Produce Specification</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:isCharacteristicOfRealizableObject</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Inverse of hasRealizableObjectCharacteristic</para>
    /// labels<para>isCharacteristicOfRealizableObject</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:hasResultUpperBound</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>owl:FunctionalProperty</para>
    ...
    ///
    /// Inspired by the Model Card Toolkit schema https://github.com/tensorflow/model-card-toolkit/blob/master/model_card_toolkit/schema/v0.0.1/model_card.schema.json</para>
    /// labels<para>hasResultUpperBound</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:SupportingInfrastructureComponent</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// 10. HardLaw
    /// 11. SoftLaw</para>
    /// labels<para>Supporting Infrastructure Component</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:Guideline</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of planned sao:AccountableResult which represents a high level reference to a guideline (e.g. a guideline document) that is expected to be produced during the implementation in order to inform on the correct procedure for deploying, using and maintaining the system or any of its components.</para>
    ...
    /// <summary>
    ///   <para>rains:ComplianceSpecification</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// 1. HardLaw
    /// 2. SoftLaw</para>
    /// labels<para>Compliance Specification</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:EvaluationSpecification</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// 4. SystemIntegrationGuidance
    /// 5. SystemUsageGuidance</para>
    /// labels<para>Evaluation Specification</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:DatasetSpecification</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// <summary>
    ///   <para>rains:SupportingInfrastructureSpecification</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// 10. HardLaw
    /// 11. SoftLaw</para>
    /// labels<para>Supporting Infrastructure Specification</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:DataCollectionProcedure</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    ///
    /// There is a separate concept that represents the data collection software see rainsDataCollectionSoftware.</para>
    /// labels<para>Data Collection Procedure</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:GrantCertification</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A planned step describing a certification granting decision to be taken by a human when incorporating accountability in AI Systems, e.g. grant an ISO certificate.</para>
    /// labels<para>Grant Certification</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:EvaluationDataset</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// labels<para>Evaluation Dataset</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:FairnessOrBiasDetectionSoftware</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A sao:InformationElement (which is also an osw:Software and a prov:SoftwareAgent)  which records  information detailing  a software that was used to detect bias or check for fairness in both the dataset which was used to train the ML Model as well as the ML model itself</para>
    /// labels<para>Fairness Or Bias Detection Software</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:hasResultLowerBound</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>owl:DatatypeProperty</para>
    ///   <para>The lower bound of the confidence interval. Inspired by the Model Card Toolkit schema https://github.com/tensorflow/model-card-toolkit/blob/master/model_card_toolkit/schema/v0.0.1/model_card.schema.json</para>
    /// labels<para>hasResultLowerBound</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:SystemPurposeSpecification</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// 1. IntendedUserGroup
    /// 2. IntendedUseCase
    /// 3. IncorrectUseCase</para>
    /// labels<para>System Purpose Specification</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:ModelSpecification</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    /// <summary>
    ///   <para>rains:DataCollectionSoftware</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A sao:InformationElement (which is also an osw:Software and a prov:SoftwareAgent)  which records  information detailing  a software that was used to collect data that formed the dataset which was used to train the ML Model</para>
    /// labels<para>Data Collection Software</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:DataPreprocessingProcedure</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ...
    ///
    /// There is a separate concept that represents the data preprocessing software.</para>
    /// labels<para>Data Preprocessing Procedure</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:ComplianceAssuranceDecision</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A specific type of a planned human decision representing confirmation of compliance of some sao:AccountableResult (e.g., a model specification) with its compliance requirements.</para>
    /// labels<para>Compliance Assurance Decision</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:DesignStageAccountabilityPlan</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A plan that identifies sao:AccountableAction(s) and sao:AccountableResult(s) relevant to the design stage of an AI system and  which are required to be documented for accountability purposes. The Accountable Actions that can be done at this stage are: Produce Specification and Decide.</para>
    /// labels<para>Design Stage Accountability Plan</para></remarks>
    ...
    /// <summary>
    ///   <para>rains:Guidance</para>
    /// </summary>
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>A sao:InformationElement  which records a specific piece of  information detailing instructions that should be followed during the deployment or operation stage of the :AI_System lifecycle.</para>
    ...
    ///
    /// When used as part of an information realization corresponding to a design specification, it describes the hard laws that must be complied with. When used as part of an information realization corresponding to an realized component, it describes the hard laws that the component complies with.</para>
    /// labels<para>Hard Law</para></remarks>
    ...
    ///
    /// When used as part of an information realization corresponding to a design specification, it describes the soft laws that are to be complied with. When used as part of an information realization corresponding to an realized component, it describes the soft laws that the component complies with.</para>
    /// labels<para>Soft Law</para></remarks>
