...
module drammar =
    ...
    ///             executable plans); - Timeline: sequence of units.</para>
    ...
    ///             members (hasMember property)</para>
    /// labels<para>ConsistentStateSet</para></remarks>
    ...
    ///
    /// labels<para>isPlanEffectOf</para></remarks>
    ...
    ///
    /// labels<para>isTimelineEffectOf</para></remarks>
    ...
    ///             "Colgate" A specific utterance in a communication action.</para>
    ...
    ///             effect of a plan (ConsistentStateSet).</para>
    /// labels<para>hasPlanEffect</para></remarks>
    ...
    ///             precondition.</para>
    /// labels<para>hasPlanPrecondition</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The property hasValue connects an agent to her/his values</para>
    /// labels<para>hasValueEngaged</para></remarks>
    ...
    ///             plans are observable.</para>
    /// labels<para>inConflictWith</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The support relation over goals (parallel to inConflictWith)</para>
    /// labels<para>inSupportOf</para></remarks>
    ...
    ///             references)</para>
    /// labels<para>isExtRefRoleOfExtRefSchema</para></remarks>
    ...
    ///             propositional content). BELIEVES = KNOWS.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A Timeline orders Unit.</para>
    /// labels<para>orders</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///
    /// labels<para>isSpannedBy</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>love_appraisingAgent</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>love_target</para></remarks>
    ...
    ///             between scenes (property hasChild), which are actually tree nodes.</para>
    ...
    ///             plans or actions as their data.</para>
    /// labels<para>OrderedListElement</para></remarks>
    ...
    ///             cannot be motivated by more plans.</para>
    /// labels<para>isMotivationFor</para></remarks>
    ...
    ///             the ADTComponent class as its range.</para>
    /// labels<para>ADTComponent</para></remarks>
    ...
    ///             access to Verbnet. This happens when the access to Framenet fails.</para>
    /// labels<para>quale_verbnetRoleLabel</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>shame_appraisingAgent</para></remarks>
    ...
    ///             DramaEntity (DramaEndurant or DramaPerdurant) that fills that Role.</para>
    /// labels<para>hasFiller</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>shame_target</para></remarks>
    ...
    ///   <para>Last OLE of a
    ///             List.</para>
    /// labels<para>containsLastOLE</para></remarks>
    ...
    ///   <para>First OLE of a
    ///             List.</para>
    /// labels<para>containsFirstOLE</para></remarks>
    ...
    ///             ontology. E.g. "parlare" "eleganza"</para>
    /// labels<para>originalTerm</para></remarks>
    ...
    ///             respectively.</para>
    /// labels<para>quale</para></remarks>
    ...
    ///   <para>owl:DatatypeProperty</para>
    ///
    /// labels<para>quale_MWNSense</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isTimelinePreconditionOf</para></remarks>
    ...
    ///             objective state of the story world.</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isExtRefOf</para></remarks>
    ...
    ///             contained).</para>
    /// labels<para>hasMotivationIn</para></remarks>
    ...
    ///             external knowledge source via a specific data type property.</para>
    /// labels<para>DescriptionTemplate</para></remarks>
    ...
    ///             science.</para>
    /// labels<para>DramaEntity</para></remarks>
    ...
    ///             Web (pp. 166-181). Springer Berlin Heidelberg.</para>
    /// labels<para>DramaPerdurant</para></remarks>
    ...
    /// Refs: Gangemi, A., &amp; Presutti, V. (2009). Ontology design patterns. In Handbook on ontologies (pp. 221-243). Springer Berlin, Heidelberg.</para>
    /// labels<para>SituationSchema</para></remarks>
    ...
    ///             connects the DrammarScene with the Conflict Set.</para>
    /// labels<para>DrammarScene</para></remarks>
    ...
    ///             (represented by the Timeline class).</para>
    /// labels<para>Scene</para></remarks>
    ...
    ///             shame_target, love_target, etc.).</para>
    ...
    ///             Drammar.</para>
    /// labels<para>ExternalRefEmotionType</para></remarks>
    ...
    ///             grouping, but do not represent specific issues in support.</para>
    /// labels<para>ExternalReference</para></remarks>
    ...
    ///             ExternalReference class.</para>
    /// labels<para>ExternalRefEntity</para></remarks>
    ...
    ///             the corresponding role in VerdNet (a string) - role_ID_resource</para>
    /// labels<para>ExternalRefRole</para></remarks>
    ...
    ///             the appropriate frame.</para>
    /// labels<para>FrameNetSchema</para></remarks>
    ...
    ///             state (FactualState class).</para>
    /// labels<para>GoalSchema</para></remarks>
    ...
    ///             "Maintainance" "Perform" "Query"</para>
    /// labels<para>Goal_type</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isMentalStateOf</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>Inverse of intends.</para>
    /// labels<para>isIntendedBy</para></remarks>
    ...
    ///             respectively for FrameNet and VerbNet).</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isRoleOf</para></remarks>
    ...
    ///             commitment to the notion of 'drama as a tree'.</para>
    /// labels<para>TreeNode</para></remarks>
    ...
    ///   <para>owl:InverseFunctionalProperty</para>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>The coincidence relation of a Scene on a Timeline.</para>
    ...
    ///             through some external resources such as FrameNet.</para>
    /// labels<para>StateOfAffairs</para></remarks>
    ...
    ///             effects.</para>
    /// labels<para>hasTimelineEffect</para></remarks>
    ...
    ///   <para>Property that connect a Timeline with the ConsistentStateState which forms its
    ///             precondition.</para>
    /// labels<para>hasTimelinePrecondition</para></remarks>
    ...
    ///             the TreeNode that is its Root.</para>
    /// labels<para>hasRoot</para></remarks>
    ...
    ///             Executable Plans.</para>
    /// labels<para>UnderspecifiedPlan</para></remarks>
    ...
    ///             with each Role of the schema.</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isOrderedBy</para></remarks>
    ...
    ///             Hamlet's value of honesty.</para>
    ...
    ///             if the value is balanced.</para>
    /// labels<para>atStake</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isValueEngagedOf</para></remarks>
    ...
    ///             the string "value".</para>
    /// labels<para>ValueSchema</para></remarks>
    ...
    ///             nothing is said about execution.</para>
    /// labels<para>accomplished</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>This property connects a goal with the plan that achieves it.</para>
    ...
    ///             there are 22 emotion types such as Love or Shame)</para>
    /// labels<para>appraisingAgent</para></remarks>
    ...
    ///             same Scene.</para>
    /// labels<para>coOccurInScene</para></remarks>
    ...
    ///             structure type and its components.</para>
    /// labels<para>hasADTComponent</para></remarks>
    ...
    ///             (hasData).</para>
    /// labels<para>DirectlyExecutablePlan</para></remarks>
    ...
    ///             content of the belief or the goal.</para>
    /// labels<para>hasPropositionalContent</para></remarks>
    ...
    ///             a State or Process.</para>
    /// labels<para>isPropositionalContentOf</para></remarks>
    ...
    ///   <para>owl:InverseFunctionalProperty</para>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A DrammarScene hinges on some ConflictSet</para>
    /// labels<para>hingesOn</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Inverse of hingesOn.</para>
    /// labels<para>isHingedOnBy</para></remarks>
    ...
    ///             reference theory of emotions.</para>
    /// labels<para>EmotionSchema</para></remarks>
    ...
    ///             of Linked Data.</para>
    /// labels<para>ExternalRefSchema</para></remarks>
    ...
    ///             executable plans.</para>
    /// labels<para>AbstractPlan</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>achieves links a Plan to the Goal it aims at achieving</para>
    ...
    ///             is a Process with the property isIntentional that values FALSE.</para>
    /// labels<para>UnintentionalProcess</para></remarks>
    ...
    ///             as its members (hasMember property).</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>feels</para></remarks>
    ...
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Connects an emotion with the agent who feels it.</para>
    /// labels<para>isEmotionOf</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Inverse of precedes. Sequential order in an ordered list.</para>
    ...
    ///             YAGO.</para>
    /// labels<para>quale_YAGOSUMOConcept</para></remarks>
    ...
    ///             of choice in the list of frames returned. E.g. "1"</para>
    /// labels<para>quale_framenetFrame</para></remarks>
    ...
    ///             Element. </para>
    /// labels<para>quale_framenetRoleID</para></remarks>
    ...
    ///             and trees) and data type components.</para>
    /// labels<para>DataStructure</para></remarks>
    ...
    ///             and trees (more precisely, tree nodes).</para>
    /// labels<para>AbstractDataType</para></remarks>
    ...
    ///             nodes.</para>
    /// labels<para>containsTN</para></remarks>
    ...
    ///         </para>
    /// labels<para>containsOLE</para></remarks>
    ...
    ///             Action.</para>
    /// labels<para>SetMember</para></remarks>
    ...
    ///             OrderedListElement) of which it is the content.</para>
    /// labels<para>isDataOf</para></remarks>
    ...
    ///             distinguish Action from an UnintentionalProcess.</para>
    /// labels<para>isIntentional</para></remarks>
    ...
    ///             formally disjoint from Agents (Disjoint property).</para>
    ...
    ///             ConsistentStateSet which precedes or follows a timeline.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Sequential order in an ordered list.</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>HappyFor_appraisingAgent</para></remarks>
    ...
    ///             each emotion type (see appraisingAgent property).</para>
    ...
    ///             for Artificial Agents. In ICMAS (Vol. 95, pp. 65-72).</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Intends has as domain an Agent and as range a Plan.</para>
    /// labels<para>intends</para></remarks>
    ...
    ///             for the right trait of the mental schema.</para>
    /// labels<para>MentalState</para></remarks>
    ...
    ///             or state (FactualState class).</para>
    /// labels<para>BeliefSchema</para></remarks>
    ...
    ///             Framenet.</para>
    /// labels<para>Schema_type</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>happyFor_target</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>The parent/child relation for modelling tree structures.</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasDoneState</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>owl:FunctionalProperty</para>
    ///   <para>Connects the element of an ordered list to the ordered list.</para>
    /// labels<para>isOleContained</para></remarks>
    ...
    ///             describing processes and states.</para>
    ...
    ///             166-181). Springer Berlin Heidelberg.</para>
    /// labels<para>DramaEndurant</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isKnownBy</para></remarks>
    ...
    ///             with the SituationSchema that describes it.</para>
    /// labels<para>isDescribedBy</para></remarks>
    ...
    ///             states (F_MentalState class).</para>
    /// labels<para>MentalStateSchema</para></remarks>
    ...
    ///             here we reduce the notion of conflict to this single class.</para>
    /// labels<para>ConflictSet</para></remarks>
    ...
    ///             Drammar, can be a member of a Set.</para>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>isPlanPreconditionOf</para></remarks>
    ...
    ///             done state, that holds whether the process has terminated. </para>
    /// labels<para>isDoneStateOf</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasEmotionType</para></remarks>
    ...
    ///             string. This is why Range is empty. </para>
    /// labels<para>hasExtRef</para></remarks>
    ...
    ///             SituationSchema</para>
    /// labels<para>isFillerOf</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>The property which connects an agent with her/his goals.</para>
    ...
    ///             of a novel).</para>
    /// labels<para>hasManifestation</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///
    /// labels<para>hasMentalState</para></remarks>
    ...
    ///             right boundaries of timelines and plans). - Units: sets of actions.</para>
