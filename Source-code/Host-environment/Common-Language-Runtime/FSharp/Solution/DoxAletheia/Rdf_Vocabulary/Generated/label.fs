...
module label =
    ...
    /// labels<para>inverst flertal</para><para>inverse plural</para></remarks>
    ...
    /// labels<para>singular</para><para>singular</para><para>ental</para></remarks>
    ...
    /// labels<para>inverse singular</para><para>inverst ental</para></remarks>
    ...
    /// labels<para>flertal</para><para>plural</para><para>plural</para></remarks>
