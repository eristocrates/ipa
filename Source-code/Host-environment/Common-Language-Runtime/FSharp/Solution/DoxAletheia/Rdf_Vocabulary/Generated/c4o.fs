...
module c4o =
    ...
    /// labels<para>has global count source</para></remarks>
    ...
    /// labels<para>bibliographic information source</para></remarks>
    ...
    /// labels<para>global citation count</para></remarks>
    ...
    /// labels<para>has global count value</para></remarks>
    ...
    /// labels<para>has global citation frequency</para></remarks>
    ...
    /// labels<para>has global count date</para></remarks>
