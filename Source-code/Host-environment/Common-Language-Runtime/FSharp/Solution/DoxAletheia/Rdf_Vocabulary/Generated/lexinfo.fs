...
module lexinfo =
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>owl:Thing</para>
    ///   <para>A noun or adjective denoting a single object.</para>
    ///   <para>Noun that is the name of a specific individual, place, or object.</para>
    /// labels<para>proper noun</para><para>properNoun</para></remarks>
    /// <seealso href="http://www.lexinfo.net/ontology/2.0/lexinfo#properNoun">http://www.lexinfo.net/ontology/2.0/lexinfo#properNoun</seealso>
    let properNoun = Prefixed_Name(lexinfo, "properNoun") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>неопределенный</para><para>indefinite</para></remarks>
    ...
    /// labels<para>indefinite article</para></remarks>
    ...
    /// labels<para>indefinite determiner</para></remarks>
    ...
    /// labels<para>indefinite pronoun</para></remarks>
    ...
    /// labels<para>изъявительное</para><para>indicative</para></remarks>
    ...
    /// labels<para>неопределенная форма</para><para>infinitive</para></remarks>
    ...
    /// labels<para>infinitive particle</para></remarks>
    ...
    /// labels<para>inflectionElement</para></remarks>
    ...
    /// labels<para>нечастоиспользуемый</para><para>infrequently used</para><para>infrequentlyUsed</para></remarks>
    ...
    /// labels<para>initialism</para><para>инициалы</para></remarks>
    ...
    /// labels<para>initialismFor</para></remarks>
    ...
    /// labels<para>допустимый термин</para><para>admitted term</para></remarks>
    ...
    /// labels<para>nucleus</para><para>ядро</para></remarks>
    ...
    /// labels<para>транслятивный падеж</para><para>translative case</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>lexinfo:PartOfSpeech</para>
    ///   <para>Noun that signifies a non-specific member of a group.</para>
    ///   <para>A noun or adjective denoting a class of objects.</para>
    /// labels<para>common noun</para><para>commonNoun</para></remarks>
    ...
    /// labels<para>легальный термин</para><para>legal term</para></remarks>
    ...
    /// labels<para>light verb</para></remarks>
    ...
    /// labels<para>locative case</para><para>местный падеж</para></remarks>
    ...
    /// labels<para>main verb</para></remarks>
    ...
    /// labels<para>masculine</para><para>мужской</para></remarks>
    ...
    /// labels<para>mass noun</para><para>massNoun</para></remarks>
    ...
    /// labels<para>медиальный залог</para><para>средний залог</para><para>middle voice</para></remarks>
    ...
    /// labels<para>морфологическая часть слова</para><para>morphological element</para></remarks>
    ...
    /// labels<para>negative particle</para></remarks>
    ...
    /// labels<para>negative pronoun</para></remarks>
    ...
    /// labels<para>нет</para><para>no</para></remarks>
    ...
    /// labels<para>именительный падеж</para><para>nominative case</para></remarks>
    ...
    /// labels<para>non-finite</para><para>переходный</para></remarks>
    ...
    /// labels<para>имя существительное</para><para>noun</para></remarks>
    /// <seealso href="http://www.lexinfo.net/ontology/2.0/lexinfo#noun">http://www.lexinfo.net/ontology/2.0/lexinfo#noun</seealso>
    let noun = Prefixed_Name(lexinfo, "noun") |> PrefixedName
    /// <summary>
    ///   <para>lexinfo:number</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>In many languages, the grammatical distinction that indicates the number of objects referred to by the term or word.</para>
    ///   <para>Grammatical category for the variation in form of nouns, pronouns, and any words agreeing with them, depending on how many persons or things are referred to.</para>
    /// labels<para>grammatical number</para></remarks>
    /// <seealso href="http://www.lexinfo.net/ontology/2.0/lexinfo#number">http://www.lexinfo.net/ontology/2.0/lexinfo#number</seealso>
    let number = Prefixed_Name(lexinfo, "number") |> PrefixedName
    /// <summary>
    ///   <para>lexinfo:numeral</para>
    ...
    /// labels<para>имя числительное</para><para>numeral</para></remarks>
    /// <seealso href="http://www.lexinfo.net/ontology/2.0/lexinfo#numeral">http://www.lexinfo.net/ontology/2.0/lexinfo#numeral</seealso>
    let numeral = Prefixed_Name(lexinfo, "numeral") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>optionalElement</para></remarks>
    ...
    /// labels<para>ordinal adjective</para></remarks>
    ...
    /// labels<para>other animacy</para><para>otherAnimacy</para></remarks>
    ...
    /// labels<para>otherGender</para></remarks>
    ...
    /// labels<para>otherNumber</para></remarks>
    ...
    /// labels<para>номер детали</para><para>part number</para></remarks>
    ...
    /// labels<para>participle</para><para>причастие</para></remarks>
    ...
    /// labels<para>participle adjective</para></remarks>
    ...
    /// labels<para>particle</para><para>частица</para></remarks>
    /// <seealso href="http://www.lexinfo.net/ontology/2.0/lexinfo#particle">http://www.lexinfo.net/ontology/2.0/lexinfo#particle</seealso>
    let particle = Prefixed_Name(lexinfo, "particle") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>количественный падеж</para><para>partitive case</para></remarks>
    ...
    /// labels<para>пассивный залог</para><para>passive voice</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Term used to describe how a particular word is used in a sentence.</para>
    ///   <para>A category assigned to a word based on its grammatical and semantic properties.</para>
    /// labels<para>part of speech</para></remarks>
    ...
    /// labels<para>урегулированный термин</para><para>regulated term</para></remarks>
    ...
    ///   <para>owl:Class</para>
    ///
    /// labels<para>Дополнение</para><para>Объект</para></remarks>
    ...
    /// labels<para>lexTermElement</para></remarks>
    ...
    /// labels<para>словосочетание в CJKV</para><para>compound(cjkv)</para></remarks>
    ...
    /// labels<para>relatedTerm</para></remarks>
    ...
    /// labels<para>корень слова</para><para>baseElement</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>Register of terms used in applications-oriented as opposed to theoretical or academic levels of language.</para>
    ///   <para>The register of terms used in applications-oriented as opposed to theoretical or academic levels of language.</para>
    ...
    /// labels<para>порядковое числительное</para><para>cardinal numeral</para></remarks>
    ...
    /// labels<para>завершенный</para><para>cessative</para></remarks>
    ...
    /// labels<para>circumposition</para></remarks>
    ...
    /// labels<para>clippedTermFor</para></remarks>
    ...
    /// labels<para>общепринятое название</para><para>common name</para></remarks>
    ...
    /// labels<para>сравнительная</para><para>comparative</para></remarks>
    ...
    /// labels<para>comparative particle</para></remarks>
    ...
    /// labels<para>составное слово</para><para>сложная форма</para><para>compound</para></remarks>
    ...
    /// labels<para>compound preposition</para></remarks>
    ...
    /// labels<para>conditional</para><para>условное</para></remarks>
    ...
    /// labels<para>contraction</para><para>сокращение</para></remarks>
    ...
    /// labels<para>coordinateConcept</para></remarks>
    ...
    /// labels<para>coordinating conjunction</para></remarks>
    ...
    /// labels<para>deficient verb</para></remarks>
    ...
    /// labels<para>определенный</para><para>definite</para></remarks>
    ...
    /// labels<para>творительный падеж</para><para>instrumental case</para></remarks>
    ...
    /// labels<para>international scientific term</para><para>международный научный термин</para></remarks>
    ...
    /// labels<para>интернационализм</para><para>internationalism</para></remarks>
    ...
    /// labels<para>interrogative particle</para></remarks>
    ...
    /// labels<para>устойчивое словосочетание</para><para>set phrase</para></remarks>
    ...
    /// labels<para>сокращенная форма</para><para>short form</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>owl:Thing</para>
    ///   <para>Value that expresses one element.</para>
    ///   <para>The form of a term or word (usually of a noun) used to designate one object.</para>
    /// labels<para>единственное</para><para>singular</para></remarks>
    ...
    /// labels<para>slash</para></remarks>
    ...
    /// labels<para>стандартное выражение</para><para>standard text</para></remarks>
    ...
    /// labels<para>стандартный термин</para><para>standardized term</para></remarks>
    ...
    /// labels<para>string</para><para>строка</para></remarks>
    ...
    ///   <para>...</para>
    /// labels<para>сослагательное</para><para>subjunctive</para></remarks>
    ...
    /// labels<para>sublative case</para><para>сублатив</para></remarks>
    ...
    /// labels<para>subordinating conjunction</para></remarks>
    ...
    /// labels<para>превосходная</para><para>superlative</para></remarks>
    ...
    /// labels<para>вытесненный термин</para><para>superseded term</para></remarks>
    ...
    /// labels<para>suspension points</para></remarks>
    ...
    /// labels<para>syllable</para><para>слог</para></remarks>
    ...
    /// labels<para>third person</para><para>третье лицо</para></remarks>
    ...
    /// labels<para>transcribed form</para><para>текстовая форма</para></remarks>
    ...
    /// labels<para>связанная</para><para>bound</para></remarks>
    ...
    /// labels<para>causallyRelatedConcept</para></remarks>
    ...
    /// labels<para>прошлое</para><para>past</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Word that sounds the same and is written the same as another word but is different in meaning.</para>
    ///   <para>A word that is pronounced like another word and that can be spelled the same way (homograph) or can merely sound the same (homophone).</para>
    ...
    /// labels<para>двоеточие</para><para>colon</para></remarks>
    ...
    /// labels<para>урезанная форма</para><para>clipped term</para></remarks>
    ...
    /// labels<para>plain verb</para></remarks>
    ...
    /// labels<para>винительный падеж</para><para>accusative case</para></remarks>
    ...
    /// labels<para>conditional particule</para></remarks>
    ...
    /// labels<para>pronoun</para></remarks>
    /// <seealso href="http://www.lexinfo.net/ontology/2.0/lexinfo#pronoun">http://www.lexinfo.net/ontology/2.0/lexinfo#pronoun</seealso>
    let pronoun = Prefixed_Name(lexinfo, "pronoun") |> PrefixedName
    /// <summary>
    ///   <para>lexinfo:declarativeClause</para>
    ...
    /// labels<para>запятая</para><para>comma</para></remarks>
    ...
    /// labels<para>definite article</para></remarks>
    ...
    /// labels<para>interrogative pronoun</para></remarks>
    ...
    /// labels<para>частоиспользуемый</para><para>commonly used</para><para>commonlyUsed</para></remarks>
    ...
    /// labels<para>impersonal pronoun</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///   <para>lexinfo:Register</para>
    ///   <para>The register of terms that are company-specific and not readily recognized outside this environment.</para>
    ///   <para>Register of terms that are company-specific and not readily recognized outside this environment.</para>
    ...
    /// labels<para>неодушевленный</para><para>inanimate</para></remarks>
    ...
    /// labels<para>unaccomplished</para><para>незавершенный</para></remarks>
    ...
    /// labels<para>глагол</para><para>verb</para></remarks>
    ...
    /// labels<para>звательный падеж</para><para>vocative  case</para></remarks>
    ...
    ///   <para>owl:NamedIndividual</para>
    ///   <para>owl:Thing</para>
    ///   <para>The register of a term or text type that can be characterized as profane or socially unacceptable.</para>
    ///   <para>Register of a term or text type that can be characterized as profane or socially unacceptable.</para>
    ...
    /// labels<para>часть слова</para><para>wordElement</para></remarks>
    ...
    /// labels<para>yes</para><para>да</para></remarks>
    ...
    /// labels<para>родительный падеж</para><para>genitive case</para></remarks>
    ...
    /// labels<para>сокращенная форма</para><para>abbreviated form</para></remarks>
    /// <seealso href="http://www.lexinfo.net/ontology/2.0/lexinfo#abbreviatedForm">http://www.lexinfo.net/ontology/2.0/lexinfo#abbreviatedForm</seealso>
    let abbreviatedForm = Prefixed_Name(lexinfo, "abbreviatedForm") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>abbreviationFor</para></remarks>
    ...
    /// labels<para>contractionFor</para></remarks>
    ...
    /// labels<para>acronymFor</para></remarks>
    ...
    /// labels<para>активный залог</para><para>active voice</para></remarks>
    ...
    /// labels<para>affirmative particule</para></remarks>
    ...
    /// labels<para>animacy</para></remarks>
    /// <seealso href="http://www.lexinfo.net/ontology/2.0/lexinfo#animacy">http://www.lexinfo.net/ontology/2.0/lexinfo#animacy</seealso>
    let animacy = Prefixed_Name(lexinfo, "animacy") |> PrefixedName
    ...
    /// labels<para>одушевленный</para><para>animate</para></remarks>
    ...
    /// labels<para>antonym term</para></remarks>
    ...
    /// labels<para>appellation</para><para>название</para></remarks>
    ...
    ///   <para>...</para>
    /// labels<para>артикль</para><para>article</para></remarks>
    /// <seealso href="http://www.lexinfo.net/ontology/2.0/lexinfo#article">http://www.lexinfo.net/ontology/2.0/lexinfo#article</seealso>
    let article = Prefixed_Name(lexinfo, "article") |> PrefixedName
    /// <summary>
    ///   <para>lexinfo:aspect</para>
    ...
    /// labels<para>concept relation</para></remarks>
    ...
    /// labels<para>past participle adjective</para></remarks>
    ...
    /// labels<para>совершенный</para><para>perfective</para></remarks>
    ...
    /// labels<para>personal pronoun</para></remarks>
    ...
    /// labels<para>фразеологическая единица</para><para>phraseological unit</para></remarks>
    ...
    ///   <para>owl:Thing</para>
    ///   <para>lexinfo:Number</para>
    ///   <para>The form of a term or word (usually of a noun) used to designate more than one object.</para>
    ///   <para>Value that expresses more than one element.</para>
    /// labels<para>множественное</para><para>plural</para></remarks>
    ...
    /// labels<para>положительная</para><para>positive</para></remarks>
    ...
    /// labels<para>possessive adjective</para></remarks>
    ...
    /// labels<para>possessive determiner</para></remarks>
    ...
    /// labels<para>possessive pronoun</para></remarks>
    ...
    /// labels<para>premodifier</para></remarks>
    ...
    /// labels<para>предпочтительный термин</para><para>preferred term</para></remarks>
    ...
    /// labels<para>prepositional adverb</para></remarks>
    ...
    /// labels<para>настоящее</para><para>present</para></remarks>
    ...
    /// labels<para>present participle adjective</para></remarks>
    ...
    /// labels<para>название продукта</para><para>productName</para></remarks>
    ...
    /// labels<para>pronominal adverb</para></remarks>
    ...
    /// labels<para>пословица</para><para>proverb</para></remarks>
    ...
    /// labels<para>punctuation</para></remarks>
    ...
    /// labels<para>question mark</para></remarks>
    ...
    /// labels<para>редкоиспользуемый</para><para>rarely used</para><para>rarelyUsed</para></remarks>
    ...
    /// labels<para>reciprocal pronoun</para></remarks>
    ...
    /// labels<para>reflexive adjective</para></remarks>
    ...
    /// labels<para>reflexive personal pronoun</para></remarks>
    ...
    /// labels<para>register</para></remarks>
    /// <seealso href="http://www.lexinfo.net/ontology/2.0/lexinfo#register">http://www.lexinfo.net/ontology/2.0/lexinfo#register</seealso>
    let register = Prefixed_Name(lexinfo, "register") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>relation noun</para></remarks>
    ...
    /// labels<para>relative pronoun</para></remarks>
    ...
    /// labels<para>second person</para><para>второе лицо</para></remarks>
    ...
    /// labels<para>логическое выражение</para><para>logical expression</para></remarks>
    ...
    /// labels<para>единица складского учета</para><para>артикул</para><para>sku</para></remarks>
    ...
    /// labels<para>stringCategory</para></remarks>
    ...
    /// labels<para>diminutive noun</para></remarks>
    ...
    /// labels<para>emphatic pronoun</para></remarks>
    ...
    /// labels<para>акроним</para><para>acronym</para></remarks>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Completely correct in every detail</para>
    ...
    /// labels<para>superessive case</para><para>суперессив</para></remarks>
    ...
    /// labels<para>feminine</para><para>женский</para></remarks>
    ...
    /// labels<para>lexTermType</para></remarks>
    /// <seealso href="http://www.lexinfo.net/ontology/2.0/lexinfo#termType">http://www.lexinfo.net/ontology/2.0/lexinfo#termType</seealso>
    let termType = Prefixed_Name(lexinfo, "termType") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>терминативный падеж</para><para>terminative case</para></remarks>
    ...
    /// labels<para>средний</para><para>neuter</para></remarks>
    ...
    /// labels<para>definiteness</para></remarks>
    /// <seealso href="http://www.lexinfo.net/ontology/2.0/lexinfo#definiteness">http://www.lexinfo.net/ontology/2.0/lexinfo#definiteness</seealso>
    let definiteness = Prefixed_Name(lexinfo, "definiteness") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>demonstrative determiner</para></remarks>
    ...
    /// labels<para>demonstrative pronoun</para></remarks>
    ...
    /// labels<para>устаревший термин</para><para>deprecated term</para></remarks>
    ...
    ///   <para>lexinfo:Number</para>
    ///   <para>owl:NamedIndividual</para>
    ///   <para>Form used in some languages to designate two persons or things.</para>
    ///   <para>The form used in some languages to designate two persons or things.</para>
    ...
    /// labels<para>уравнение</para><para>equation</para></remarks>
    ...
    /// labels<para>exclamative pronoun</para></remarks>
    ...
    /// labels<para>expression</para><para>выражение</para></remarks>
    ...
    /// labels<para>конечный</para><para>finite</para></remarks>
    ...
    /// labels<para>finitness</para></remarks>
    /// <seealso href="http://www.lexinfo.net/ontology/2.0/lexinfo#finiteness">http://www.lexinfo.net/ontology/2.0/lexinfo#finiteness</seealso>
    let finiteness = Prefixed_Name(lexinfo, "finiteness") |> PrefixedName
    /// <summary>
    ...
    /// labels<para>first person</para><para>первое лицо</para></remarks>
    ...
    /// labels<para>formula</para><para>формула</para></remarks>
    ...
    /// labels<para>несокращенная форма</para><para>full form</para></remarks>
    ...
    /// labels<para>fullFormFor</para></remarks>
    ...
    /// labels<para>будущее</para><para>future</para></remarks>
    ...
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A grammatical category that indicates grammatical relationships between words in sentences.</para>
    /// labels<para>grammatical gender</para></remarks>
    /// <seealso href="http://www.lexinfo.net/ontology/2.0/lexinfo#gender">http://www.lexinfo.net/ontology/2.0/lexinfo#gender</seealso>
    let gender = Prefixed_Name(lexinfo, "gender") |> PrefixedName
    /// <summary>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>Word that is written like another, but that has a different pronunciation, meaning, and/or origin.</para>
    ///   <para>A word that is spelled like another, but that has a different pronunciation, meaning, and/or origin.</para>
    ...
    /// <remarks>
    ///   <para>owl:ObjectProperty</para>
    ///   <para>A word that is pronounced in the same way as another word but that is spelled differently.</para>
    ///   <para>Word that sounds like another word, but is different in writiing or meaning.</para>
    ...
    /// labels<para>идиома</para><para>idiom</para></remarks>
    ...
    /// labels<para>императивное</para><para>imperative</para></remarks>
    ...
    /// labels<para>несовершенная</para><para>imperfect</para></remarks>
    ...
    /// labels<para>несовершенный</para><para>imperfective</para></remarks>
