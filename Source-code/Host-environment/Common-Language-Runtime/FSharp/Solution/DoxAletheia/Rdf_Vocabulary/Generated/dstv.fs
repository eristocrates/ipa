...
module dstv =
    ...
    /// <remarks>
    ///   <para>owl:Class</para>
    ///   <para>The element hljob is an optional element of hl. It is created for each through hole of the corresponding reference plane.</para>
    ///   <para>hljob</para>
    /// </remarks>
