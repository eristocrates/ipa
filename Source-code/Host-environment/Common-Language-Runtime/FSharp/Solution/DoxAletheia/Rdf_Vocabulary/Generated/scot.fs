...
module scot =
    ...
    ///   <para>More than two tags are assigned to one resource. This class defines cooccurring tags and the cooccurring frequency between the tags</para>
    /// labels<para>Cooccurrence</para></remarks>
